 ...
 * 
 */
public class OfflineMoOrderInfo implements FuncService
{
        ...
        for (String formId : formIds){
            ...
            if (null != ids && ids.length > 0){
                for (String dataId : ids){
                    ...
                    String sql="delete from T_CO_MATERIAL_ONLINE t where t.cmo_mo_number in (select a.PM_MO_NUMBER from t_pm_mo_base a where a.id = ? )";
                    res=modelService.execSql(sql, new Object[]{dataId});
