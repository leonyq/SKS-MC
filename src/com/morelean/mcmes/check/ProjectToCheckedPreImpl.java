 ...
 **/
public class ProjectToCheckedPreImpl implements FuncService {
    ...
    public String exeFunc(ModelAction modelAction, ModelService modelService) {
       ...
       int countSql = modelService.countSql(feedDetailSql, new Object[]{dataId});
        ...
        String sql = "SELECT A.PROJECT_ID,A.LOT_NUMBER,A.PROJECT_SORT,A.PROJECT_STATUS FROM T_PM_PROJECT_BASE A WHERE 1=1 AND A.ID = ? ";
