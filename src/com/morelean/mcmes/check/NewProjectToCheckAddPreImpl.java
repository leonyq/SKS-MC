 ...
 * 新增质检-视图前执行类
 **/
public class NewProjectToCheckAddPreImpl implements FuncService {
    ...
    public String exeFunc(ModelAction modelAction, ModelService modelService) {
       ...
       int countSql = modelService.countSql(feedDetailSql, new Object[]{dataId});
        ...
        String sql = "select PROJECT_ID ,LOT_NUMBER,PROJECT_STATUS,PRODUCT_MATERIAL,PRODUCT_NAME,PRODUCT_COUNT,FINISH_COUNT from T_PM_PROJECT_BASE WHERE 1=1 AND ID = ?";
