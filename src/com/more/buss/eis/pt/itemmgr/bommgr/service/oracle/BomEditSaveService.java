package com.more.buss.eis.pt.itemmgr.bommgr.service.oracle;
...
public class BomEditSaveService implements FuncService {
	...
	String cbItemCode =CommMethod.escapeJs(request.getParameter("paraMapObj.CB_ITEM_CODE")) ;
	String cbVer =CommMethod.escapeJs(request.getParameter("paraMapObj.CB_VER")) ;
