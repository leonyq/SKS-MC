 ...
 * @Company: morelean
 */
public class GetAreaSereice implements FuncService {
  /**
   * @param modelAction
   *          modelAction
   * @param modelService
...
String dataAuth = String.valueOf(modelAction.getRequest().getSession().getAttribute("mcDataAuth"));
    ...
    String sqlArea = "select t.CA_ID as caid,t.CA_PARENTAREAID as parentareaid,t.CA_NAME as areaname from t_co_area t where CA_TYPE=? and data_auth=? order by t.CA_NAME";
