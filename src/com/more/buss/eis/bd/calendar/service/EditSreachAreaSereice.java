 ...
 * @see EditSreachAreaSereice
 * @since 2017-3-8
 * @Copyright: Copyright (c) 2017
 * @Company: morelean
 */
public class EditSreachAreaSereice implements FuncService {
  /**
   * @param modelAction
   *          modelAction
   * @param modelService
  ...
  public String exeFunc(ModelAction modelAction, ModelService modelService) {
    ...
    /*String sqlArea = "select t.CA_ID as areaid,(select CA_NAME as areaname from t_co_area where CA_ID = '" + searchArea
        + "' ) as area,t.CA_NAME as areaname from t_co_area t where t.CA_TYPE='1'";*/
         /*
     if (areaId.isEmpty() && areaName.isEmpty()) {
      ...
      if (!searchArea.isEmpty()) {
        sqlArea = sqlArea + "and t.CA_PARENTAREAID=:searchArea";
    ...
    if (areaId.isEmpty() && !areaName.isEmpty()) {
      ...
      sqlArea = sqlArea + "and t.CA_NAME like '%'||:areaName||'%'";
    ...
    if (areaName.isEmpty() && !areaId.isEmpty()) {
      ...
      sqlArea = sqlArea + "and t.CA_ID like '%'||:areaId||'%'";
