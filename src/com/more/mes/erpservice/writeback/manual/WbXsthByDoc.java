...
import com.more.mes.erpservice.writeback.WbXsthServiceJob;
 ...
 * 
 */
public class WbXsthByDoc implements FuncService {
	...
	public String exeFunc(ModelAction modelAction, ModelService modelService) {
		try {
			...
			WbXsthServiceJob xsth = new WbXsthServiceJob();
			String result = xsth.xsth(wriDocNum,loginName);//回写结果，成功返回空
