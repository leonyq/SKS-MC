...
import com.more.mes.erpservice.writeback.WbXsfhServiceJob;
 ...
 * 
 */
public class WbXsfbByDoc implements FuncService {
	...
	public String exeFunc(ModelAction modelAction, ModelService modelService) {
		try {
			...
			WbXsfhServiceJob xsfh = new WbXsfhServiceJob();
			String result = xsfh.xsfh(wriDocNum,LOGIN_NAME);//回写结果，成功返回空
