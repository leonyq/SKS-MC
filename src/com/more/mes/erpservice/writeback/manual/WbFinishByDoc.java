...
import com.more.mes.erpservice.writeback.WbFinishServiceJob;
 ...
 * 
 */
public class WbFinishByDoc implements FuncService {
	...
	public String exeFunc(ModelAction modelAction, ModelService modelService) {
		try {
			...
			WbFinishServiceJob finish = new WbFinishServiceJob();
			String result = finish.finish(wriDocNum,loginName);//回写结果，成功返回空
