...
public class QXFHSyncMesFromErp implements IJobx{
	...
	public void exec(Args arg0) {
		...
		String objectType=ConstantClass.CANCELOUT;
		
		String xmlType=ConstantClass.MES_TO_ERP_SO_CANCEL;
		...
		List<Map> list = ConstantClass.getDocList(modelService, type, docType);
