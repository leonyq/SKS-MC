...
public class CGRKSyncMesFromErp implements IJobx{

	private final Log log = LogFactory.getLog(this.getClass());
	private ModelService modelService = (ModelService) SpringContextUtil.getBean("CGRKSyncMesFromErp");
	...
	public void exec(Args arg0) {
		...
		String objectType=ConstantClass.PURCHASE;
		
		String xmlType=ConstantClass.PUT_IN_DOC;
