...
public class GetItemNumY extends InterfaceLog implements IhttpServiceJosn{
	@Override
	public String exeFunc(HttpCoreService service) {
		...
		try {
			...
			String ITEM_CODE = StringUtils.toString(service.getParamTo().get("ITEM_CODE"));
			PdaServiceUtils serviceUtils=new PdaServiceUtils();
			List<Map> list = serviceUtils.getItemNumY(ITEM_CODE, ITEM_SN, strOrgCode);
			String jsonStr = "";
