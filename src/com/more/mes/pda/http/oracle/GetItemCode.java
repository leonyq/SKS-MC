...
public class GetItemCode extends InterfaceLog implements IhttpServiceJosn {
	...
	public String exeFunc(HttpCoreService service) {
		...
		try {
			...
			List<Map> list = serviceUtils.getItemCode(ITEM_SN, strOrgCode);
			String jsonStr = "";
			if(null==list || list.size()<=0){
				  jsonStr=PdaBaseServiceUtils.foundNoItemCodeData;
