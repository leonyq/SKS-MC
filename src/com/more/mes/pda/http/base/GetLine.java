...
public class GetLine extends InterfaceLog implements IhttpServiceJosn{
	...
	public String exeFunc(HttpCoreService service) {
		...
		try {
			...
			String sqlStr="select CA_ID as areaid,CA_NAME AS areaname from T_CO_AREA WHERE CA_TYPE ='1' and data_auth=?  order by CA_NAME";
			...
			if (list!=null&&list.size()>0) {
				...
				jsonStr=PdaBaseServiceUtils.foundNoLineData;
