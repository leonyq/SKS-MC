 ...
 *
 */
public class GetAuthDocType  extends InterfaceLog implements IhttpServiceJosn{
	...
	public String exeFunc(HttpCoreService service) {
		...
		try {
			...
			String sqlStr="SELECT \r\n" + 
					...
					"WHERE T.WDT_PDA_FLAG='Y' AND T.DATA_AUTH=?\r\n" + 
					"ORDER BY WDT_OPERATE_TYPE,T.WDT_TYPE_SN";
			...
			if (list!=null&&list.size()>0) {
				...
				jsonStr=PdaBaseServiceUtils.dataNotFound;
