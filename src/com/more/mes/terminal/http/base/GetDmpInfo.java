 ...
 *                          super.log(map);
 */
public class GetDmpInfo extends InterfaceLog implements IhttpServiceJosn {
	  ...
	  public String exeFunc(HttpCoreService service)
	  {
		  ...
		  try
	      {
			  String dmpId=service.getParamTo().get("dmpId");
			  List dataList= TerminalService.getDmpInfo(dmpId);
