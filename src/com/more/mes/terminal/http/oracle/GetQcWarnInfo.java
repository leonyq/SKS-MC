...
public class GetQcWarnInfo extends InterfaceLog implements IhttpServiceJosn {
	  ...
	  public String exeFunc(HttpCoreService service)
	  {
	    // TODO Auto-generated method stub
		  ...
		  try
	      {
			  ...
			  String event=service.getParamTo().get("event");
			  String dataAuth=service.getParamTo().get("dataAuth");
			  List dataList= TerminalService.GetQcWarnInfo(workStation,event,dataAuth);
