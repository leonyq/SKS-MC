...
public class GetLanguage extends InterfaceLog implements IhttpServiceJosn {
	...
	/**
	  ...
	  public String exeFunc(HttpCoreService service)
	  {
	    // TODO Auto-generated method stub
		  ...
		  try
	      {
			  String type=service.getParamTo().get("lanType");
			  List dataList= TerminalService.GetLanguage(type);
