...
public class GetEsopInfo extends InterfaceLog implements IhttpServiceJosn {
	...
	/**
	  ...
	  public String exeFunc(HttpCoreService service)
	  {
	    // TODO Auto-generated method stub
		  ...
		  try
	      {
			  String moNumber=service.getParamTo().get("monumber");
			  String groupCode=service.getParamTo().get("groupcode");
			  String dataAuth=service.getParamTo().get("dataAuth");
			  List dataList= TerminalService.GetEsopInfo(moNumber, groupCode,dataAuth);
