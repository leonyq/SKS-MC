...
public class GetUserInfoWithoutPhoto extends InterfaceLog implements IhttpServiceJosn {
	  ...
	  public String exeFunc(HttpCoreService service)
	  {
	    // TODO Auto-generated method stub
		  ...
		  try
	      {
			  ...
			  String userCode=service.getParamTo().get("usercode");
			  List dataList= TerminalService.GetUserInfoWithoutPhoto(workStation,userCode);
