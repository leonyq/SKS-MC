 ...
 *                          super.log(map);
 */
public class GetWorkstationBelongInfo extends InterfaceLog implements IhttpServiceJosn {
	  ...
	  public String exeFunc(HttpCoreService service)
	  {
		  ...
		  try
	      {
			  ...
			  List dataList= TerminalService.getWorkstationBelongInfo(workStation);
