...
public class GetMoNumberBySn extends InterfaceLog implements IhttpServiceJosn {
	...
	/**
	  ...
	  public String exeFunc(HttpCoreService service)
	  {
	    // TODO Auto-generated method stub
		  ...
		  try
	      {
			  String sn=service.getParamTo().get("sn");
			  String dataAuth=service.getParamTo().get("dataAuth");
			  List dataList= TerminalService.GetMoNumberBySn(sn,dataAuth);
