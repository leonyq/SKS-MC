...
public class GetGroupQulityNum extends InterfaceLog implements IhttpServiceJosn {
	  ...
	  public String exeFunc(HttpCoreService service)
	  {
	    // TODO Auto-generated method stub
		  ...
		  try
	      {
			  ...
			  List dataList= TerminalService.GetGroupQulityNum(workStation,dataAuth,moNumber);
