...
public class GetDictVal extends InterfaceLog implements IhttpServiceJosn {
	...
	/**
	  ...
	  public String exeFunc(HttpCoreService service)
	  {
	    // TODO Auto-generated method stub
		  ...
		  try
	      {
			  String dictCode=service.getParamTo().get("dictcode");
			  List dataList=TerminalService.GetDictVal(dictCode);
