...
{
	private static final Log log = LogFactory.getLog("com.more.mes.aps.calendar.base.MultiAdd");
	...
	public String exeFunc(ModelAction modelAction, ModelService modelService) {
		...
		if("saveMulti".equals(opt)){
			...
			if(isSuc){
				return modelAction.reloadIframeByIds(iframeId, modelAction.getText("批量生成成功"), isCloseWin);
			}
			else {
	 ...
	 * @return
	 */
    private Boolean saveMulti(HttpServletRequest httpServletRequest,ModelService modelService,ModelAction modelAction){
