...
public class GetFindGroupStatistic implements FuncService {

	@SuppressWarnings("unchecked")
	@Override
	public String exeFunc(ModelAction modelAction, ModelService modelService) {
		HttpServletRequest request = modelAction.getRequest();
		String findMoNumber = request.getParameter("findMoNumber");
		String findGroupCode = request.getParameter("findGroupCode");
		String findGroupSeq = request.getParameter("findGroupSeq");
		//根据制令单获取序生产统计数据
		...
		String sqlWhere=" and T.MGS_MO_NUMBER = ? and T.MGS_GROUP_CODE = ? AND T.MGS_GROUP_SEQ = ?";
        List listParam = new ArrayList();
        listParam.add(findMoNumber);
        listParam.add(findGroupCode);
        listParam.add(findGroupSeq);
        ...
        String countSql = "SELECT SUM(WT_NUM) WIP_NUM FROM T_WIP_TRACKING B " +
