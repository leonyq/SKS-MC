...
import com.more.mes.smt.autoupdate.GetUpdateInfo;
...
public class GetJsonDataItem extends InterfaceLog implements IhttpServiceJosn
{
  ...
  public String exeFunc(HttpCoreService service)
  {
    ...
    type = StringUtils.toString(service.getParamTo().get("type"));
    GetUpdateInfo lis = new GetUpdateInfo();
    JSONArray json = new JSONArray();
    List list = lis.getUpdateFile(type);
