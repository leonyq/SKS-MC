 ...
 *
 */
public class HttpClientMethod implements IJobx{

	    public static String JSESSIONID;// cookie的id
...
//			}
         ...
         */
		public static void printResponse(HttpResponse httpResponse) throws ParseException {
			// 获取响应消息实体
		...
		public static String printCookies() {
			...
			for (Cookie cookie : cookies) {
				...
				//CloudLabelInf.JSESSIONID=cookie.getValue();
			//	System.out.println(CloudLabelInf.JSESSIONID+"HttpText3.JSESSIONID");
