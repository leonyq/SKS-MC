 ...
 * @author development
 */
public class SaveReturnItemInfo implements FuncService {
	...
	public String exeFunc(ModelAction modelAction, ModelService modelService) {
		...
		try {
			...
			String supCode = request.getParameter("paraMap1@0#WOD_SUP_CODE");// 供应商
			...
			String wodDocNum = gss.getSnForDocNum("DJ13", wodDispatchSn, userId, dataAuth);
			...
			wms.getColMap().put("WDI_DOC_TYPE", "DJ13");
			...
			for (int i = 0; i < iNum; i++) {
				...
				outStockItem.getColMap().put("WOI_PLAN_NUM", returnNum);// 计划数量v
				outStockItem.getColMap().put("WOI_REQUEST_NUM", returnNum);
				outStockItem.getColMap().put("WOI_RETURN_NUM", returnNum);
