...
public class EditDetailInfo implements FuncService
{
  ...
  public String exeFunc(ModelAction modelAction, ModelService modelService)
  {
    ...
    try
    {
      ...
      saveExt.getColMap().put("QII_ITEM_CODE", qiiItemCode2);
      saveExt.getColMap().put("QII_ITEM_NAME", qiiItemName);
      saveExt.getColMap().put("QII_ITEM_TYPE", qiiItemType);
      saveExt.getColMap().put("QII_EFFECTIVE_FLAG", qiiEffectiveFlag);
      saveExt.getColMap().put("QII_TEST_CONTENT", qiiTestContent);
