 ...
 */
public class EditGetCurName implements FuncService
{
  ...
  public String exeFunc(ModelAction modelAction, ModelService modelService)
  {
	...
	String name = modelAction.getSessionUser().getName();
	nameMap.put("name", name);
	modelAction.setDataMap(nameMap);
	return modelAction.ActionForwardExeid(modelAction.getExeid());//转向原来视图页面  ${DA}
  }
}
