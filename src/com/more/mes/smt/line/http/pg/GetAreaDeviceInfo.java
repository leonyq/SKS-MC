...
public class GetAreaDeviceInfo extends InterfaceLog implements IhttpServiceJosn
{
  ...
  public String exeFunc(HttpCoreService service)
  {
    ...
    String areaType= service.getParamTo().get("areaType");
    System.out.println();

    LineListService lls = new LineListService();

    JSONArray json = new JSONArray();
    List list = lls.getAreaDeviceInfo(areaSn,areaType);
