 ...
 * @author development
 */
public class SaveTallyStockInfo implements FuncService
{
  ...
  public String exeFunc(ModelAction modelAction, ModelService modelService)
  {
    ...
    try
    {
      ...
      String wodDocNum = getReceiveNo(dataAuth, "DJ15", wodDispatchSn, modelService);// 出库单号
      ...
      wms.getColMap().put("WDI_DOC_TYPE", "DJ15");
      ...
      outStock.getColMap().put("WOD_DOC_TYPE", "DJ15");// 单据类型
