    ...
    try
    {
      for (int i = 0; i < mulitSampleInfo.length; i++ )
      {
        ...
        if (!"".equals(id))
        {
          ...
          float actualNum = 0;
          if (!StringUtils.isBlank(actualVal))
          {
            actualNum = Float.parseFloat(actualVal);
          }
          int errNum = 0;
          if (!StringUtils.isBlank(errorNum))
          {
            errNum = Integer.parseInt(errorNum);
          }
        ...
        else
        {
          // 保存
          float minNum = 0;
          if (!StringUtils.isBlank(minVal))
          {
            minNum = Float.parseFloat(minVal);
          }
          float maxNum = 0;
          if (!StringUtils.isBlank(maxVal))
          {
            maxNum = Float.parseFloat(maxVal);
          }
          float actualNum = 0;
          if (!StringUtils.isBlank(actualVal))
          {
