package com.more.mes.smt.problemFeedback.base;
...
public class SaveAnswerInfo implements FuncService{
	...
	public String exeFunc(ModelAction modelAction, ModelService modelService) {
	    ...
	    try{
	        String cpfPriority =CommMethod.escapeJs(request.getParameter("paraMapObj.CPF_PRIORITY")) ;// 优先级
	        String cpfProblemBelong =CommMethod.escapeJs(request.getParameter("paraMapObj.CPF_PROBLEM_BELONG")) ;// 问题归属
	        String cpfProposalScheme =CommMethod.escapeJs(request.getParameter("paraMapObj.CPF_PROPOSAL_SCHEME")) ;// 建议方案
	        String cpfAbstract =CommMethod.escapeJs(request.getParameter("paraMapObj.CPF_ABSTRACT")) ;// 问题摘要
	        String cpfstatus =CommMethod.escapeJs(request.getParameter("paraMapObj.CPF_STATUS")) ;// 问题类型
	        String cpfType =CommMethod.escapeJs(request.getParameter("paraMapObj.CPF_TYPE")) ;// 状态
	        String cpfHandleEmp =CommMethod.escapeJs(request.getParameter("paraMapObj.CPF_HANDLE_EMP")) ;// 责任人
	        String cpfExpectedCompletionTime =CommMethod.escapeJs(request.getParameter("paraMapObj.CPF_EXPECTED_COMPLETION_TIME")) ;// 预计完成时间
	        String cpfLiabilityDept =CommMethod.escapeJs(request.getParameter("paraMapObj.CPF_LIABILITY_DEPT")) ;// 责任部门
	        String cpfRequestDate =CommMethod.escapeJs(request.getParameter("paraMapObj.CPF_REQUEST_DATE")) ;// 需求时间
	        String cpfHandleDate =CommMethod.escapeJs(request.getParameter("paraMapObj.CPF_HANDLE_DATE")) ;// 处理时间
	        String cpfHandleWay =CommMethod.escapeJs(request.getParameter("paraMapObj.CPF_HANDLE_WAY")) ;// 处理对策
			...
			*/
	        ...
	        saveExt.setSqlWhere("and id='"+dataId+"'");
