package com.more.mes.smt.alarmtimer.service.pg;
    ...
    if (timeList != null && !timeList.isEmpty())
    {
        ...
        for (int i = 0; i < timeListSize; i++ )
        {
          ...
          if ("2".equals(qiType))
          {
            String alarmSql = " select t1.cmo_mo_number    as mo_number, "
                              ...
                              + " where to_char(t2.qol_orerate_time,'yyyy-MM-dd') = to_char(clock_timestamp(),'yyyy-MM-dd') "
      ...
      else if ("2".equals(qiModel))
      {
        ...
        String sql = "select t.pmo_number       as mo_number, "
                     ...
                     + " t.pmo_model_code   as model_code, " + " t.pmo_area_sn      as area_sn, "
                     + " t.pmo_time +  ? as end_time " + " from T_PM_MO_ONLINE t "
                     + " where TO_CHAR(t.pmo_time + ?,'yyyy-MM-dd HH24:mi') = ? ";
        ...
        {
          // 预警
          String tempInputTimeStr = tempInputTime + " minute";
          tempList = modelService.listDataSql(sql, new Object[] {tempInputTimeStr,
            tempInputTimeStr, nowDate});
        ...
        // 报警
        String inputTimeStr = inputTime + " minute";
        tempList2 = modelService.listDataSql(sql, new Object[] {inputTimeStr, inputTimeStr,
          nowDate});
