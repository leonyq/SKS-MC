package com.more.mes.smt.planquotiety.base;
...
public class GetProject implements FuncService
{
	private static final Log log = LogFactory
			.getLog("com.more.mes.smt.planquotiety.GetProject");
  @Override
  public String exeFunc(ModelAction modelAction, ModelService modelService)
  {
    ...
    try{
      ...
      /*List<Map> taskMaps = CommonMethod.Common.jsonStr2Map(exsitPorjectIds);
      String expProjects=null;
      Object vP=null;
      for(Map map:taskMaps){
      	vP=map.get("projectid");
      	if(null==vP || StringUtils.isEmpty(vP.toString())){
      		continue;
      	}
    ...
    String sqlWhere = " AND A.PROJECT_STATUS='0'\r\n" + 
    		" AND A.PROLEPSIS_START_DATE>=TO_DATE('"+planStartDate+"','YYYY-MM-DD HH24:MI:SS')\r\n" + 
    		" AND A.PROLEPSIS_START_DATE<=TO_DATE('"+planEndDate+"','YYYY-MM-DD HH24:MI:SS')";
    //过滤处于T_PM_PLAN_INFO表中且计划数量已达标的工单
    sqlWhere+=" AND A.PRODUCT_COUNT>NVL(I.SUM_NOW_NUM,0)";
    ...
    sqlWhere+=" AND A.DATA_AUTH IN (\r\n" + 
    		...
    		"WHERE A.ID='"+modelAction.getCurrUser().getId()+"'\r\n" + 
    		")";
