 ...
 *
 */
public class SaveAnalysisProposal implements FuncService{
	...
	public String exeFunc(ModelAction modelAction, ModelService modelService) {
	    ...
	    try {
	    	...
	    	String cipBenefitAnalysis = request.getParameter("paraMapObj.CIP_BENEFIT_ANALYSIS");//效益分析
			//插入改善提案信息
			...
			imp.setTableName("T_CO_IMPROVE_PROPOSAL");
		 	...
		 	imp.getColMap().put("CIP_BENEFIT_ANALYSIS", cipBenefitAnalysis);
		 	imp.getColMap().put("CIP_ANALYSIS_EMP", CommMethod.getSessionUser().getLoginName());
		 	imp.getColMap().put("CIP_ANALYSIS_DATE", sdf1.parse(sdf1.format(new Date())));
		 	imp.getColMap().put("CIP_STATUS", "4");
		 	if(dataAuth!=null){
