 ...
 * @author development
 */
public class AddFinishReceive implements FuncService
{
  ...
  public String exeFunc(ModelAction modelAction, ModelService modelService)
  {
    ...
    try
    {
      ...
      // String WRD_DOC_NUM = getReceiveNo(dataAuth,"DJ05",WRD_DISPATCH_SN,modelService);//入库单号
      GetSnService gss = new GetSnService();
      String userId = StringUtils.toString(CommMethod.getSessionUser().getId());
      String wrdDocNum = gss.getSnForDocNum("DJ05", wrdDispatchSn, userId, dataAuth);
