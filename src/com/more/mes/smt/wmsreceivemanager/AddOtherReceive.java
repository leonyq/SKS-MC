 ...
 * @author development
 */
public class AddOtherReceive implements FuncService
{
  ...
  public String exeFunc(ModelAction modelAction, ModelService modelService)
  {
    ...
    try
    {
      ...
      // String WRD_DOC_NUM = getReceiveNo(dataAuth, "DJ06", WRD_DISPATCH_SN, modelService);// 入库单号
      String userId = StringUtils.toString(CommMethod.getSessionUser().getId());
      GetSnService gss = new GetSnService();
      String wrdDocNum = gss.getSnForDocNum("DJ06", wrdDispatchSn, userId, dataAuth);
      ...
      //receive.getColMap().put("ACCOUNT_ID", accountId);// 账户别名ID
      receive.getColMap().put("DEPT_ID", deptId);// 部门
      if (dataAuth != null)
      {
