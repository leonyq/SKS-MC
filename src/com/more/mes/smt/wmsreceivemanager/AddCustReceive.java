 ...
 * @author development
 */
public class AddCustReceive implements FuncService
{
  ...
  public String exeFunc(ModelAction modelAction, ModelService modelService)
  {
    ...
    try
    {
      ...
      String wrdSupCode = request.getParameter("paraMap1@0#WRD_CUST_CODE");// 客户
      ...
      // String WRD_DOC_NUM = getReceiveNo(dataAuth, "DJ04", WRD_DISPATCH_SN, modelService);// 入库单号
      GetSnService gss = new GetSnService();
      String userId = StringUtils.toString(CommMethod.getSessionUser().getId());
      String wrdDocNum = gss.getSnForDocNum("DJ04", wrdDispatchSn, userId, dataAuth);
      ...
      wms.getColMap().put("WDI_DOC_TYPE", "DJ04");
      ...
      receive.getColMap().put("WRD_DOC_TYPE", "DJ04");
