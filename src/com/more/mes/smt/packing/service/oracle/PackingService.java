...
//   }
   ...
   static private Map<String, String > mapSql = new HashMap<String, String>(){{  
	      ...
	      put("PACK_002", "SELECT\r\n" + 
	      		"NVL(SUM(A.PSI_SN_NUM),0) AS PACKEDNUM\r\n" + 
	      		"FROM T_PACK_SN_INFO A\r\n" + 
	      		"WHERE A.PSI_MO_NUMBER=?\r\n" + 
	     ...
	     //<editor-fold desc="判定是否存在工单BOM ">
	      ...
	      put("PACK_007", "SELECT\r\n" + 
	      		...
	      		"A.PTD_CAPACITY,\r\n" + 
	      		"A.PTD_CREATE_RULE, \r\n"+
	      		"DECODE(A.PTD_TITLE_FLAG,'Y','是','N','否','') PTD_TITLE_FLAG,\r\n"+
	      		"C.TBR_NAME AS PTD_LABLE_RULE,\r\n" + 
	      		"DECODE(A.PTD_LABLE_PRINT,'Y','是','N','否','') PTD_LABLE_PRINT,\r\n" + 
	      		"(SELECT  B.LABEL_NAME FROM ML_TEMPLATE B WHERE B.ID=A.PTD_LABLE_TEMPLATE) AS PTD_LABLE_TEMPLATE, \r\n" + 
	      		"(SELECT  B.LABEL_NAME FROM ML_TEMPLATE B WHERE B.ID=A.PTD_LIST_TEMPLATE) AS PTD_LIST_TEMPLATE,  \r\n"+
	      		"DECODE(A.PTD_LIST_PRINT,'Y','是','N','否','') PTD_LIST_PRINT \r\n" + 
	    ...
	    //<editor-fold desc="根据容器名称获取当前容器及其所有子容器中的产品SN">
	      put("PACK_009", "SELECT\n" +
	    		  "A.PSI_SN,\n" +
	    		  "A.PSI_TAKEPLACE,\r\n" + 
	    		  "DECODE(A.PSI_SN,NULL,0,A.PSI_SN_NUM) AS PSI_SN_NUM,\r\n" + 
		      	  "DECODE(A.PSI_SN,NULL,NULL,B.NAME) AS PSI_EMP,\r\n" + 
		      	  "DECODE(A.PSI_SN,NULL,NULL,TO_CHAR(A.PSI_TIME,'YYYY-MM-DD HH24:MI:SS')) AS PSI_TIME\r\n" +
	    		  "FROM T_PACK_SN_INFO A\n" +
	    		  ...
	    		  "START WITH B.PSI_CONTAINER_SN=?\n" +
	    		  "CONNECT BY PRIOR B.PSI_CONTAINER_SN=B.PCI_PARENT_SN\n" +
	    		  ")\n" +
	      ...
	      put("PACK_010", "SELECT\n" +
                            ...
                            "START WITH A.PSI_CONTAINER_SN=?\n" +
                            "CONNECT BY PRIOR A.PCI_PARENT_SN=A.PSI_CONTAINER_SN");
	      //</editor-fold>
              
	      //<editor-fold desc="获取容器当前容量">
	      put("PACK_011", "SELECT\r\n" + 
	      		"SUM(T.PACK_NUM) AS PACK_NUM,\r\n" + 
	      		"SUM(COALESCE(T.REAL_NUM,0)) AS REAL_NUM\r\n" + 
	      		"FROM (\r\n" + 
	      		"SELECT\r\n" + 
	      		"A.PCI_PACK_NUM AS PACK_NUM,\r\n" + 
	      		"0 AS REAL_NUM\r\n" + 
	      		"FROM T_PACK_CONTAINER_INFO A\r\n" + 
	      		...
	      		"SELECT\r\n" + 
	      		"0 AS PACK_NUM,\r\n" + 
	      		"SUM(COALESCE(A.PSI_SN_NUM,0)) AS REAL_NUM\r\n" + 
	      		"FROM T_PACK_SN_INFO A\r\n" + 
	      		"WHERE A.PSI_CONTAINER_SN=?\r\n" + 
	      		"AND A.PSI_SN IS NOT NULL\r\n" + 
	      		") T");
	      ...
	      put("PACK_013", "SELECT\n" +
	    		  "NVL(A.PTD_IS_ONLINE,'N') PTD_IS_ONLINE\n" +
	    		  "FROM T_PACK_TACTICS_DETAIL A\n" +
	    		  "WHERE A.PTD_SN=?\n" +
	    		  "AND A.PTD_LEVEL=?\n" +
	    		  "AND ROWNUM=1");
	...
	static private Map<String,String> mapSqlWhere=new HashMap<String,String>(){{
	    ...
	    //<editor-fold desc="获取容器信息 ">
	      ...
	      put("PACK_W_006", "SELECT\r\n" + 
	      		...
	      		"NVL(T.PCI_REAL_NUM,A.PCI_PACK_NUM) AS PCI_REAL_NUM\r\n" + 
	      		"FROM T_PACK_CONTAINER_INFO A\r\n" + 
	      		"LEFT JOIN (\r\n" + 
	      		"SELECT\r\n" + 
	      		"B.PSI_CONTAINER_SN,\r\n" + 
	      		"SUM(NVL(B.PSI_SN_NUM,0)) AS PCI_REAL_NUM\r\n" + 
	      		...
	      		"WHERE 1=1 %s\r\n" +
	      		"START WITH 1=1 %s \r\n" + 
	      		"CONNECT BY PRIOR A.PSI_CONTAINER_SN=A.PCI_PARENT_SN" );
	      //</editor-fold>
    ...
    static private Map<String,String> mapSqlExceSql=new HashMap<String,String>(){{
	     ...
	     put("PACK_EXEC_001",  "UPDATE T_PACK_CONTAINER_INFO A\n" +
	    		  "SET A.PCI_CONTAINER_FLAG=?\n" +
	    		  "WHERE A.PSI_CONTAINER_SN=?");
	     //</editor-fold>
    }};
