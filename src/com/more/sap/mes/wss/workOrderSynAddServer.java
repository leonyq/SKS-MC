 ...
 **/
@WebService(serviceName = "workOrderSynAddServer", targetNamespace = "http://services")
public class workOrderSynAddServer{
     ...
     * @return sflag Y/N
     */
    public String getOrderBase(String AUFNR, String AUART, String PLNBEZ, String GAMNG, String CHARG,
     ...
     * @return sflag Y/N
     */
    public String getOrderProcess(String AUFNR, String VORNR, String ARBPL, String STEXT, String BMSCH,
     ...
     * @return sflag Y/N
     */
    public String getReserved(String AUFNR, String POSNR, String POSTP, String MATNR, String NOMNG,
     ...
     * @return  sflag Y/N
     */
    public String getSalesOrder(String KDAUF, String KDPOS, String KDEIN, String VDATU, String EDATU,
     ...
     * @return sflag Y/N
     */
    public String getOrderAllParam(String AUFNR, String AUART, String PLNBEZ, String GAMNG, String CHARG, String GSTRP, String GLTRP, String FTRMI, String TYPE, String GMEIN, String LGORT,
    ...
    public static void main(String[] args) {
         ...
         * Endpoint 会重新启动一个线程
         */
        Endpoint.publish("http://localhost:8080/wss/services/VoidWss", new workOrderSynAddServer());
