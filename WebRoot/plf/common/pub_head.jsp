...
<%
	...
	if (!UNLOAD.equals(jquery)) { 
      ...
      "/jquery/jquery-1.7.2.js?_mc_res_version=").append(PlfStaticRes.JQUERY_172_JS).append("\"></script>").append("\n");
 ...
 // 框架默认引入
  ...
  outSb.append("<script type=\"text/javascript\" src=\"").append(JS_PATH).append(
    ...
    if (!UNLOAD.equals(serializeForm))
	 ...
	 //富文本编辑器
	 String uEditor = formatNullStr(request.getParameter("uEditor"), UNLOAD);
