...
<%@page import="com.more.fw.core.staticresource.PlfStaticRes"%>
	<head>
		...
		<title><dict:lang value="修改岗位关联" /></title>
...
<body>
	...
	<form id="edit_form" name="editForm" action="" method="post" target="submitFrame">
	<s:token />
		<input type="hidden" id="iframeId" name="iframeId"/>
<input type="hidden" id="deptPositionId" value="<c:out value='${paraMap.id }' />" name="paraMap.id"/>
...
<script type="text/javascript">
	...
	$("#position_type").val("<c:out value='${paraMap.position_type}' />");
	$("#position_type").trigger("chosen:updated");
	...
	function edit(thisObj){
		...
		jQuery.ajax({
				type : "POST",
				dataType : "json",
				url :"sys/PostMgrAction_editDeptPost.ms",
				data:{'id':$("#deptPositionId").val(),'position_id':$("#position_id").val(),'position_type':$("#position_type").val(),'dept_id':parentWindows.nodeId},
