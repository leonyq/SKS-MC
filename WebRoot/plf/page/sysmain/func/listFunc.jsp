...
<div >
	...
	<!-- left start -->
	<div class="mc-table-left" style="padding-right: 190px;">
	<!-- left content start -->
	...
	<!-- left end -->
	<!-- right start -->
	<div class="mc-table-right " style="width:190px;">
		<table class="table_list">
			<thead>
				<tr class="tdcolor">
					<th style="width:190px;"><dict:lang value="操作" /></th>
				</tr>
			</thead>
			<tbody>
				<s:iterator value="funcLs" status="index">
...
<script type="text/javascript">
	...
	function add(){
		var url = "${path}sys/FuncAction_showAddFunc.ms?funcDto.upId="+$("#funcDtoSh_upId").val()+"&isCsMenu="+false+"&path=<c:out value='${paraMap.path}' />&mcIframeName="+window.parent.name;
		showPopWin(url, 900, 600,null,"<dict:lang value="新增" />");
	}
	
	function update(url,id){
		var url = "${path}"+url + "&funcDtoSh.id="+id+"&mcIframeName="+window.parent.name;
