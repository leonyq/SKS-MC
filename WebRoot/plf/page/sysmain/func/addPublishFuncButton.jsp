...
<body>
			...
			<form id="add_form" class="layui-form" name="addForm" action="${path}sys/FuncAction_addFunc.ms" method="post">
				...
				<table class="add_table">
					...
					<tr>
						...
						<td class="widget">
							<dict:radioDict id="funcDto_isAuth" bindEvent="radioChange"  name="funcDto.isAuth" dictCode="YESNO" style="width:20px;" onclick="showRole(this.value)"/>
					...
					<tr id="roleTrId">
						...
						<td  colspan="3"><%--
							<input type="text" id="role_name" lay-verify="role_name_rge" name="role_name" readOnly class="readonly"/>
    ...
    function showMenuTree(){
		...
		var url = "${path}sys/FuncAction_listFpFuncTree.ms?curIframeName="+curIframeName;
      	showPopWin(url, 300, 500,null,"<dict:lang value="上级功能选择" />");
    }
