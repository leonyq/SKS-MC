...
<%--					</tr>--%>
					...
					<tr>
						...
						<td class="widget" >
							<input type="text" name="funcDto.viewId" id="funcDto_viewId" maxlength="33" onkeyup="javascript:util.replaceLikeVal(this)" /> 
						</td>
						<td>&nbsp;</td>
						<td  class="tr1 mc_form_title title ">
						...
						<td class="widget" >
							<input type="text" name="funcDto.funcMId" id="funcDto_funcMId" maxlength="33" />
						</td>
					</tr>
					<tr>
						<td  class="tr1 mc_form_title title ">
