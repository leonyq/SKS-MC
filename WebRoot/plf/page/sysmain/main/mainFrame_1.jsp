...
<link rel="stylesheet" href="../../../style/layui/layuiadmin/layui/css/layui.css" media="all">
<link rel="stylesheet" href="../../../style/layui/layuiadmin/style/admin.css" media="all">
...
<body class="layui-layout-body">
		...
		<div class="layui-layout layui-layout-admin">
				...
				<div class="layui-side-scroll">
					...
					<ul class="layui-nav layui-nav-tree" lay-shrink="all"
						...
						<li data-name="home" class="layui-nav-item layui-nav-itemed">
							<a href="javascript:;" lay-tips="主页" lay-direction="2"> <i
								class="layui-icon layui-icon-home"></i> <cite>主页</cite> </a>
							<dl class="layui-nav-child">
								<dd data-name="console" class="layui-this">
									<a lay-href="/mc/sys/FuncAction_showDevUserFunc.ms?funcDtoSh.id=6bae77008ad746b5986b6267729f7689&MENU_FC=F10000461">控制台</a>
								</dd>
								<dd data-name="console">
									<a lay-href="/mc/sys/FuncAction_showDevUserFunc.ms?funcDtoSh.id=2c25685bd15546219476e66f25bda47e&MENU_FC=F10000460">主页一</a>
								</dd>
								<dd data-name="console">
						...
						<li data-name="component" class="layui-nav-item"><a
							href="javascript:;" lay-tips="组件" lay-direction="2"> <i
								class="layui-icon layui-icon-component"></i> <cite>组件</cite> </a>
							<dl class="layui-nav-child">
								<dd data-name="grid">
								...
								<dd data-name="layer">
									<a href="javascript:;">通用弹层<span class="layui-nav-more"></span>
									</a>
									<dl class="layui-nav-child">
										<dd data-name="list">
										...
										<dd data-name="theme">
											<a lay-href="component/layer/theme.html"
												lay-text="layer 风格定制">风格定制</a>
										</dd>
									</dl>
								</dd>
								<dd data-name="laydate">
									...
									<dl class="layui-nav-child">
										<dd data-name="demo1">
											<a lay-href="component/laydate/demo1.html"
												lay-text="layDate 功能演示一">功能演示一</a>
										</dd>
										<dd data-name="demo2">
											<a lay-href="component/laydate/demo2.html"
												lay-text="layDate 功能演示二">功能演示二</a>
										</dd>
										<dd data-name="theme">
											<a lay-href="component/laydate/theme.html"
								...
								<dd data-name="laypage">
									...
									<dl class="layui-nav-child">
										<dd data-name="demo1">
											<a lay-href="component/laypage/demo1.html"
												lay-text="layPage 功能演示一">功能演示一</a>
										</dd>
										<dd data-name="demo2">
											<a lay-href="component/laypage/demo2.html"
						...
						<li data-name="template" class="layui-nav-item"><a
							href="javascript:;" lay-tips="页面" lay-direction="2"> <i
								class="layui-icon layui-icon-template"></i> <cite>页面</cite> </a>
							<dl class="layui-nav-child">
								<dd>
						...
						<li data-name="app" class="layui-nav-item"><a
							href="javascript:;" lay-tips="应用" lay-direction="2"> <i
						...
						<li data-name="senior" class="layui-nav-item"><a
							href="javascript:;" lay-tips="高级" lay-direction="2"> <i
								class="layui-icon layui-icon-senior"></i> <cite>高级</cite> </a>
							<dl class="layui-nav-child">
								<dd>
			...
			<div class="layui-body" id="LAY_app_body">
				<div class="layadmin-tabsbody-item layui-show">
					<iframe src="/mc/plf/common/welcome.jsp" frameborder="0"
	...
	<script src="../../../style/layui/layuiadmin/layui/layui.js"></script>
	<script>
  layui.config({
    base: '../../../style/layui/layuiadmin/' //静态资源所在路径
  }).extend({
    index: 'lib/index' //主入口模块
  }).use('index',function(){
	  
	console.log("开始运行mainFrame_1.jsp...");
	   	...
	   	$.ajax({
			...
			success: function(data){
				if(data){
					...
					console.log(data.ajaxList[0]);
					var result_data = data.ajaxList;
					...
					for(var i=0; i<result_data.length; i++){
						if(result_data[i].upId == 0){
							//level_one.push(result_data[i]); 
							menuList+='<li class="layui-nav-item"><a href="javascript:;"> <i class="layui-icon layui-icon-home"></i> <cite>'+result_data[i].name+'</cite> </a></li>';
						}
					}
					//$("#LAY-system-side-menu").html(menuList);
