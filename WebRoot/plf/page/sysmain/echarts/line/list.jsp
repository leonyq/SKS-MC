...
<jsp:include page="/plf/common/fp/pub_head_fp.jsp">
  ...
  <body>
  <ul>
  	<li><a href="${path}charts/lineAction_preAdd">新建配置</a><br/></li>
  </ul>
					...
					<s:iterator value="#request.dataList" id="list" status="index">
						<tr>
							...
							<td>(<s:property value="seriesCenterX" />&nbsp;&nbsp;,&nbsp;&nbsp;<s:property value="seriesCenterY" />)</td>
							 --%>
							<td align="center">
								<a href="${path}charts/lineAction_preUpdate.ms?chartsConfig.id=<s:property value="id" />">修改</a>
								&nbsp;
								<a href="${path}charts/lineAction_show.ms?chartsConfig.id=<s:property value="id" />">预览</a>
								&nbsp;
								<a href="${path}charts/lineAction_ajaxDemo.ms?chartsConfig.id=<s:property value="id" />">ajax</a>
							</td>
						</tr>
					</s:iterator>
				</tbody>
