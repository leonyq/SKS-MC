  ...
  <script>
	...
	function dynamicsClsCode(successCallBackFun,errorCallBackFun){
        $.ajax({
		    type: "POST",
	        dataType: "json",
	        url: "${path}charts/<c:out value='${paraMap.analyClsCodeUrl}'/>",
	...
	function successCallBackFun(data){
		if(data.success==true){
				$("#"+"<c:out value='${paraMap.javaClassElementId}'/>",window.parent.document).val(data.infoMap.CLASS_NAME);
				$("#"+"<c:out value='${paraMap.clsCodeIdElementId}'/>",window.parent.document).val(data.infoMap.codeId);
				$("#"+"<c:out value='${paraMap.codeTypeElementId}'/>",window.parent.document).val(data.infoMap.codeType);
				$("#"+"<c:out value='${paraMap.clsCodeElementId}'/>",window.parent.document).val(data.infoMap.clsCode);
	...
	function loadClsCode(){
		...
		type: "POST",
	    dataType: "text",
	    url: "${path}charts/<c:out value='${paraMap.loadClsCodeUrl}'/>",
