...
<body>
    <div class=''>
    	<%--
        <div class="top">
            <input type="button" value="确定" class="botton_img_add" onclick="addtp()">
            <input type="button" value="取消" class="botton_img_search" onclick="cancel();">
        </div> --%>
        <div class="add_table_div">
        <form id="add_form" class="layui-form" name="add_form" action="${path}wx/wxAction_addtp.ms" method="post" >
        ...
        <div class="ptop_10 txac">
					<input type="button" value="<dict:lang value="提交" />" lay-submit lay-filter="*" onclick="/*addtp();*/" class="layui-btn">
