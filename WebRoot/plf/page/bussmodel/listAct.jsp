...
<%@ include file="/plf/common/pub_tag.jsp" %>
	<head>
		<title><s:property value="%{getText('listAct.title')}"/></title>
...
<div class="all">	
    ...
    <table class="table_list" >
		<tr class="tdcolor">
			...
			<th width="10%"><s:property value="%{getText('listAct.ACT_NAME')}"/></th>
			<th width="10%"><s:property value="%{getText('listAct.VIEWID')}"/></th>
			<th width="10%"><s:property value="%{getText('listAct.ACT_TYPE')}"/></th>
			<th width="10%"><s:property value="%{getText('listAct.IS_SQL')}"/></th>
			<th width="15%"><s:property value="%{getText('listAct.SQL')}"/></th>
			<th width="10%"><s:property value="%{getText('listAct.IS_CLASS')}"/></th>
			<th width="15%"><s:property value="%{getText('listAct.CLASS_NAME')}"/></th>
	...
	<s:iterator value="listData" status="index">
		<tr>
			...
			<td><s:property value="IS_SQL"/></td>
			<td><s:property value="SQL"/></td>
			<td><s:property value="IS_CLASS"/></td>
