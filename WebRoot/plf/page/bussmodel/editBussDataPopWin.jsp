...
<head>
	...
	src = "${path}plf/js/ui/include.js?_mc_res_version=<%=PlfStaticRes.PaginationMultAx_JS %>"></script>
...
<body>
	<div class="edit">
            <div class="hd">
			    ...
			    <div class="optn">
			        <button type="button" onclick="addParentData('<c:out value="${param.piframeId}" />','<c:out value="${exeid}" />');"><i class="ico ico-save"></i>保存</button>
