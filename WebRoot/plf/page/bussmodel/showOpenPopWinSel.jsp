...
<body  style="">
		...
		<div class="dlist">
			<div class="hd" style="padding-top:5px;">
				<div>
					...
					<div class="optn" style="margin-right:6px;">
			...
			<div class="bd" style="height:calc(100% - 40px - 5px); ">
				<div class="search-box">
					<form id="searchForm" name="searchForm" action="" method="post">
					   ...
					   <input type="hidden" id="UI_DATA_TYPE" name="paraMap.UI_DATA_TYPE" value="<c:out value='${paraMap.UI_DATA_TYPE}' />" >
					...
					<div class="panel datagrid datagrid-div1">
					  <div class="datagrid-div2 datagrid-div6 datagrid-view" id="datagrid-view" style="">
					  	  <div class="datagrid-header">
					  	     <div class="datagrid-header-inner" id="datagrid-header-inner03b09741c53541aaaea80383029ebe41">
								<table id="datagrid-htable03b09741c53541aaaea80383029ebe41" class="datagrid-htable fixedTable" style="height: 30px; ">
									<tbody>
							 ...
							 <div class="datagrid-body datagrid-body-ajax datagrid-div3" id="tableDiv03b09741c53541aaaea80383029ebe41">
								<table class="datagrid-btable fixedTable" id="datagrid-btable-ajax03b09741c53541aaaea80383029ebe41" style="border-left:1px solid #ccc;">
									<tbody id="tbody_03b09741c53541aaaea80383029ebe41">
	...
	function add(pop,shadow){
		...
		if(ccbFun == "" || ccbFun == null){
			...
			_key=decodeHtml(_key);
			_value=decodeHtml(_value);
			eval("parentWindow."+ccbFun+"(_key,_value,_resObj)");<%-- 加入自定义回调函数 --%>
		}
	...
	function clearSel(pop,shadow){
		if(ccbFun == "" || ccbFun == null){
			...
			eval("parentWindow."+ccbFun+"('','',null)");<%-- 加入自定义回调函数 --%>
		}
		parent.closePopWinFp(pop,shadow);
	}
	...
	function _setSelValue(key,val,obj){
		...
		if($("#UI_DATA_TYPE").val()=='isFk'){val = key}
		parentWindow.$("input[name='"+editName+"']").val(val);
		parentWindow.$("input[name='"+editName+"_CN']").val(val);
		_thisSelObj.focus();
	}
	...
	function getDataTable(paginationImpl){
		var url = "${path}buss/bussModel_showPopWinSelFkSql.ms";
	...
	function clearTable(){
		$("#datagrid-btable-ajax03b09741c53541aaaea80383029ebe41 tr").empty();
	}
	...
	function createTableTitleModel(titleLs,multList){
		...
		_addDragTableEvent("03b09741c53541aaaea80383029ebe41");
	}
	...
	function createTableModel(tableData,currentPage,pageRecord){
		...
		$("#datagrid-btable-ajax03b09741c53541aaaea80383029ebe41 tbody").html(arr.join(""));
		$(".datagrid-btable> tbody tr:odd").addClass("tr-hover");//奇数行
		defTableWidthRewrite("03b09741c53541aaaea80383029ebe41");
		setScroll("03b09741c53541aaaea80383029ebe41");
	}
	...
	/*隔行换色
	$(".datagrid-btable-ajax03b09741c53541aaaea80383029ebe41").each(function(seq) {
	...
	//选中换色
	$(".datagrid-btable-ajax03b09741c53541aaaea80383029ebe41 tbody tr").click(function() {
	     var _this = $(this);
