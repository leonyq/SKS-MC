...
<%@ include file="/plf/common/pub_tag.jsp" %>
	<head>
		<title><s:property value="%{getText('viewActRel.title')}"/></title>
...
<div class="all">	
    ...
    <table class="table_list" >
		<tr class="tdcolor">
			...
			<th width="15%"><s:property value="%{getText('viewActRel.VIEWID')}"/></th>
			<th width="15%"><s:property value="%{getText('viewActRel.ACTID')}"/></th>
