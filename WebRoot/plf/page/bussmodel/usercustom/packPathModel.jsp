...
<body>
	<div class="all">
		<form id="editForm" name="editForm"
			...
			<div>
				...
				<input type="hidden" name="paraMap.clsCode"
					id="clsCode"/> 
				<div id="div_code">
	...
	function reloadPgExe(msg){
			...
			parent.updateCLASS_NAME_TEXT($("#paraMap_CLASS_NAME").val(),editor.getValue(),CODE_TYPE_NAME);
	...
	function loadClsCode(type){
	  ...
	  jQuery.ajax({
	    ...
	    'paraMap.tableName':'MS_COMM_CLASS',
	    'paraMap.relCol':'MS_CLASS_CODE_ID',
	    'paraMap.tpl':'commCodePage'
	    },
