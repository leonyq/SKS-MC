...
<body>
	<div class="all">
		<div>
	      ...
	      <td width="100%" align="right">
			...
			<form id="editForm" name="editForm" action="${path}sys/MClzMgrAction_editClsCode.ms" method="post" target="submitFrame">
				...
				<input type="hidden" id="paraMapUpId" name="paraMap.MID" value="<c:out value='${dataMap.PARENTID}' />" >
	...
	function showEditCode(codeId,OWNER_TYPE){
		...
		var url = "${path}sys/MClzMgrAction_packPathModel.ms?paraMap.CODE_ID="+codeId
