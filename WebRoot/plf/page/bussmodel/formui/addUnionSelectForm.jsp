...
<head>
	...
	<title><dict:lang value="联动下拉框" />UI <dict:lang value="配置" />
	</title>
		...
		<div class="all">
		  <div class="add_table_div">
			<form id="add_form" name="addForm" class="layui-form" action="${path}sys/BussModelAction_cfgUIComp.ms" method="post" target="submitFrame">
				...
				<table class="add_table element_table">
					...
					<tr>
					 ...
					 <tr id="IS_OPEN_DATA_AUTH"> 
					     ...
					     <td >
					       ...
					       id="paraMap_IS_OPEN_DATA_AUTH"   verify="paraMap_IS_OPEN_DATA_AUTH_verify" name="paraMap.IS_OPEN_DATA_AUTH"  />
					     </td>
					 </tr> 
					<tr id="UP_FORM_COL_ID">
							...
							<td >
								<select id="paraMap_UP_FORM_COL_ID" lay-search name="paraMap.UP_FORM_COL_ID" style="width: 100%">
						...
						<tr id="NEXT_FORM_COL_ID">
							...
							<td >
								<select id="paraMap_NEXT_FORM_COL_ID" lay-search name="paraMap.NEXT_FORM_COL_ID" style="width: 100%">
									<option value=""><dict:lang value="--请选择--"/></option>
									<s:iterator value="listData">
			...
			<i class="editCode" style="float: right;margin-right:20px;" id="editCode" onclick="editSqlValFun('comm_sql');"></i> 
              ...
              <textarea id="comm_sql" name="paraMap.UI_DATA_11" rows="4" lay-verify="comm_verify"
