...
<div class="all">
    <div class="add_table_div">
      <form id="add_form" name="addForm" class="layui-form" action="${path}sys/BussModelAction_cfgUIComp.ms" method="post" target="submitFrame">
        ...
        <table class="add_table element_table">
          ...
          <tr>
            <td  class="tr1 title" >
              <span class="Eng">*</span><dict:lang value="数据分隔符" />
            </td>
            <td >
              <input type="text" id="paraMap_UI_DATA_1_0" lay-verify="paraMap_UI_DATA_1_0_verify" name="paraMap.UI_DATA_1_0" value="<s:property value="dataMap.UI_DATA_1_0"/>" />
          ...
          <tr id="UI_DATA_7">
            ...
            <td >
             ...
             <input type="button"  lay-verify="getfields_verify" id="getFieldBtn" class="layui-btn layui-btn-xs" style="width: 70px;margin-bottom:5px;" value="<dict:lang value="获取字段" />" />
          ...
          <tr id="UI_DATA_5">
            ...
            <td >
              <input type="text" id="paraMap_UI_DATA_5" lay-verify="paraMap_UI_DATA_5_verify" name="paraMap.UI_DATA_5" value="<s:property value="dataMap.UI_DATA_5"/>" />
            </td>
          </tr>
          <tr id="UI_DATA_5">
            <td  class="tr1 title" >
  ...
  /*
    ...
    var paraMap_UI_DATA_1_0 = document.getElementById("paraMap_UI_DATA_1_0");
      if(val.isBlank(paraMap_UI_DATA_1_0)){
        _alertValMsg(paraMap_UI_DATA_1_0,"<dict:lang value="数据分隔符" /> -- <dict:lang value="不能为空" />");
        return false;
      }
      */
...
*/
  ...
  function addTr(){
    ...
    var htmlTr = "<tr>"
          +"<td style='padding:5px;white-space: normal;padding: 0px 0px !important;'><input class='mc-list-input-edit' type='text' id='filedName_"+rowNo+"' name='filedName_"+rowNo+"' style='width:100%;'/></td>"
          +"<td style='white-space: normal;padding: 0px 0px !important;'><input class='mc-list-input-edit' type='text' id='showName_"+rowNo+"' name='showName_"+rowNo+"' style='width:100%;'/></td>"
          +"<td style='white-space: normal;padding: 0px 0px !important;'><select class='mc-list-input-edit' lay-ignore id='searchSel_"+rowNo+"' style='width:100%;'><option value='1'>是</option><option value='0'>否</option></select></td>"
          +"<td style='white-space: normal;padding: 0px 0px !important;'><select class='mc-list-input-edit' lay-ignore id='isShow_"+rowNo+"' style='width:100%;'><option value='1'>是</option><option value='0'>否</option></select></td>"
  ...
  $(function(){
    ...
    $("#getFieldBtn").click(function(){
      ...
      //if(!val.isBlank(paraMap_UP_FORM_COL_ID)){
      //  upColId = "&paraMap.UP_FORM_COL_ID=" + paraMap_UP_FORM_COL_ID.value;
      //}
...
$(function(){
	layui.use('form', function(){
			...
			form.on('select(setUiData)', function(data){
		 	...
		 	form.verify({
		        paraMap_UI_DATA_1_0_verify: function(value,item){
		         	var typeVal = $("#paraMap_UI_DATA_TYPE").val();
				    var paraMap_UI_DATA_1_0 = document.getElementById("paraMap_UI_DATA_1_0");
				      if(val.isBlank(paraMap_UI_DATA_1_0)){
				        return "<dict:lang value="数据分隔符" /> -- <dict:lang value="不能为空" />";
				      }
