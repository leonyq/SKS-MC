...
<div class="all">	
	<div>
	<form id="searchForm" name="searchForm" action="${path}sys/JClzAction_listCommPack.ms" method="post">
...
<script type="text/javascript">
	...
	function add(url){
		url = "${path}sys/JClzAction_showAddCommPack.ms?paraMap.ID=<s:property value='paraMap.namePath' />";
	...
	function update(id){
		var url = "${path}sys/JClzAction_showAddCommPack.ms?paraMap.ID="+id;
