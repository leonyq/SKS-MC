...
<%@ include file="/plf/common/pub_tag.jsp" %>
	...
	<body>
		...
		<script>
			...
			tree.loadXML("${path}httpService/httpMgrAction_listModuleTree.ms");
			tree.setOnClickHandler(function (id) {
				if(id=="1") {
					url = "${path}httpService/httpMgrAction_listModule.ms";
				}else {
					url = "${path}httpService/httpMgrAction_listConfig.ms?config.portParentModuleID=" + id;
				}
