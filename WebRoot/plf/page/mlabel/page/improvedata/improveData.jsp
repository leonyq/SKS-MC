            ...
            <div class="centerBottom">
                <div class="container">
                    ...
                    <form action="${path}buss/bussModel_exeFunc.ms?FUNC_CODE=F6465&funcMId=f08d1d44d97c48ae90c61d4ed04606bf" id="registerForm" name="registerForm" method="post" enctype="multipart/form-data">
                        <input type="hidden" id="flagInput" name="flagInput" value="${paraMap.flag}">
                        <div class="block">
                            <div class="title">
                            ...
                            <div class="cont">
                                ...
                                <div class="proposer">
                                    ...
                                    <input type="text"  id="proposer" name="proposer"placeholder="<dict:lang value="请输入姓名" />"  value="">
                                ...
                                <div class="IDNumber">
                                    ...
                                    <input type="text"   id="IDNumber" name="IDNumber" placeholder="<dict:lang value="请输入身份证号" />" onblur="validateIDNumber();"   value="29545645548811">
                                    <span class="empty"></span>
                                    <p class="message"></p>
                                </div>
                                <div class="email">
                                    ...
                                    <input type="text"  id="email" name="email" placeholder="<dict:lang value="请输入电子邮箱" />" onblur="validateEmail();"  value="123456789@qq.com">
                                    <span class="empty"></span>
                                    <p class="message"></p>
                                </div>
                                <div class="department">
                                    <div class="name"><dict:lang value="部门" /></div>
                                    <input type="text"  id="department" name="department" placeholder="<dict:lang value="请输入部门" />" value="">
                                    <span class="empty"></span>
                                    <p class="message"></p>
                                </div>
                                <div class="job">
                                    <div class="name"><dict:lang value="职务" /></div>
                                    <input type="text"  id="job" name="job" placeholder="<dict:lang value="请输入职务" />" value="">
                                    <span class="empty"></span>
                                    <p class="message"></p>
                                </div>
                            </div>
                        ...
                        <div class="block">
                            ...
                            <div class="cont">
                                <div class="company">
                                    ...
                                    <input type="text"  id="company" name="company" placeholder="<dict:lang value="请输入企业全称" />" onblur="validateCompany();"  value="">
                                ...
                                <div class="legalPerson">
                                    ...
                                    <input type="text"  id="legalPerson" name="legalPerson" placeholder="<dict:lang value="请输入法人代表" />"  value=""> 
                                    <span class="empty"></span>
                                    <p class="message"></p>
                                </div>
                                <div class="trade">
                               ...
                               <div class="license">
                                ...
                                <div class="license_id">
                                    ...
                                    <input type="text"  id="license_id" name="license_id" placeholder="<dict:lang value="请输入信用代码或注册号" />" value="">
                                    <span class="empty"></span>
                                    <p class="message"></p>
                                </div>
                                <div class="city">
                                ...
                                <div class="address">
                                    ...
                                    <textarea   id="address" name="address" placeholder="<dict:lang value="请输入详细地址" />" ></textarea>
                                    <span class="empty"></span>
                                    <p class="message"></p>
                                </div>
                            </div>
...
//只能输入数字和xX   
 ...
 function validateEmail(){
   ...
   if(!(vaEmail.test(email))){
                $('.content .email .message').css('color','##FF0000');
                showMessage('.email','<dict:lang value="邮箱格式错误"/>');
    }else{
         $.ajax({
                type: "POST",
                dataType: "json",
	            ...
	            if(data.checkEmailRes == "NG"){
	             $('.content .email .message').css('color','##FF0000');
	             showMessage('.email','<dict:lang value="该邮箱已被注册" />');
	            $('#flag3').val("1");
	            }else if(data.checkEmailRes == "OK"){
	            $('#flag3').val("2"); 
	             showMessage('.email','<dict:lang value="该邮箱可以注册" />');
	             $('.content .email .message').css('color','#00c66b');
   ...
   $.ajax({
       ...
       function addCity(){
        ...
        $('.sub').click(function(){
            var IdTest = IdentityCodeValid($('#IDNumber').val());
            if($('#flag').val()=="1"){
                showMessage('.IDNumber','<dict:lang value="身份证错误" />');
            }else if($('#flag2').val()=="1"){
                showMessage('.company','<dict:lang value="企业错误" />');
            }else if($('#flag3').val()=="1"){
                showMessage('.email','<dict:lang value="邮箱错误" />');
