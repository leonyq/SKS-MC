...
<% request.setAttribute("_login_rd_time",System.currentTimeMillis()); %>
  <head>
    <title><dict:lang value="审核" />--<dict:lang value="摩尔标签云系统" /></title>
...
<body>
	<div class="hidden-info">
		<input type="hidden" id="audit_id" name="dataId" value="${dataMap['ID'] }">
		<input type="hidden" id="audit_status" name="status" value="${dataMap['STATUS'] }">
		<%-- <input type="hidden" id="formId" name="formId" value="${dataMap['formId'] }">  --%>
		<input type="hidden" id="iframeId" name="iframeId" value="${dataMap['iframeId'] }">
	</div>
                    ...
                    <div class="content">
                        <div class="block">
                            ...
                            <div class="cont">
                                ...
                                <div class="IDNumber">
                                    ...
                                    <input type="text" class="readonly" id="IDNumber" readonly value="29545645548811">
                                </div>
                                <div class="email">
                                    <div class="name"><span>*</span><dict:lang value="电子邮箱" /></div>
                                    <input type="text" class="readonly" id="email" readonly value="123456789@qq.com">
                                </div>
                                <div class="company">
                        ...
                        <div class="block">
                            ...
                            <div class="cont">
                                ...
                                <div class="trade">
                                    ...
                                    <input type="text" class="readonly" id="trade" readonly value="互联网">
                                </div>
                                <div class="license">
                        ...
                        <div class="block">
                            ...
                            <div class="cont">
                                ...
                                <p class="operate">
                                	<input id="audit_pass" type="button" class="pass" value="<dict:lang value="通过" />" onclick="auditPass()">
                                   	<input id="audit_fail" type="button" class="fail" value="<dict:lang value="拒绝" />" onclick="auditFail()">
                                </p>  
                            </div>
                        </div>
                    </div>
    ...
    <script>
       ...
       //关闭当前页并刷新列表
        function closeAndRefreshTab(){
        	var iframeId = $("#iframeId").val(); //父级iframe的 id
        	parent.frames[iframeId].query(this); //调用查询
        	top.$("#"+iframeId)[0].contentWindow.reloadPg("<dict:lang value="审核成功" />","<dict:lang value="提示信息" />",200,150,3000);
  			parent.switchTabWithoutReload(iframeId);
    ...
    <bu:submit viewId="aaeafd09c61e41148dd8261a3bf25ae8" /> 
	<bu:script viewId="aaeafd09c61e41148dd8261a3bf25ae8" />
  </body>
  </html>