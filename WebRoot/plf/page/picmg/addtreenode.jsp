...
<body>
    <div class='container'>
        <%-- <div class="top">
            <input type="button" value="确定" class="layui-btn" onclick="add()">
        </div>--%>
        <div  class="add_table_div">
        <form id="add_form" class="layui-form" name="add_form" action="${path}picmg/picmgAction_addtreenode.ms" method="post" >
        <input type="hidden" id="up_id" name="paramMap.UP_ID" value='<s:property value="paramMap.UP_ID"/>' />
        ...
        <div class="ptop_10 txac">
			 ...
			 <input type="button" value="提交" class="layui-btn" lay-submit lay-filter="*" onclick="/*addCal()*/">
