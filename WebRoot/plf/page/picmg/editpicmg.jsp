...
<body>
    <div class='container'>
        ...
        <form id="add_form" class="layui-form" name="add_form" action="${path}picmg/picmgAction_editpicmg.ms" method="post" enctype="multipart/form-data">
        ...
        <table class="add_table">
        	...
        	<tr>
        		...
        		<td style="width: 370px;    padding-left: 110px;"  colspan="2">
						<img id="userPhoto" width="200px" height="200px"  src="${path}/<s:property value='ajaxMap.PIC_PATH'/>/<s:property value='ajaxMap2.PIC_FILES_NAME'/>" />
				</td>
        	...
        	<tr>
        		...
        		<td style="width: 370px;    padding-left: 110px;"  colspan="2">
						<img width="200px" height="200px" id="preview" style="display: none;" src="<s:property value='ajaxMap.PIC_PATH'/>/<s:property value='ajaxMap2.PIC_FILES_NAME'/>"/>
					
					<input type="file" lay-verify="checkPhoto" id="photo" name="upFile" onchange="javascript:setImagePreview();" src="<s:property value='ajaxMap.PIC_PATH'/>/<s:property value='ajaxMap2.PIC_FILES_NAME'/>"/> 
        	...
        	<tr>
				...
				<td style="width: 270px;">
						<input type="text" lay-verify="checkVal" id="PIC_FILES_NAME" name="paramMap.PIC_FILES_NAME" value="<s:property value="ajaxMap2.PIC_FILES_NAME"/>">
        ...
        <div class="main">
        	...
        	<p style='padding-left:20px;'>
					...
					<input type="file" id="photo" name="upFile" onchange="javascript:setImagePreview();" src="<s:property value='ajaxMap.PIC_PATH'/>/<s:property value='ajaxMap2.PIC_FILES_NAME'/>"/> 
            ...
            <p >
                ...
                <input type="text" id="PIC_FILES_NAME" name="paramMap.PIC_FILES_NAME" value="<s:property value="ajaxMap2.PIC_FILES_NAME"/>">
                <span id="errmsg1" style='color:red;'></span>
            </p></br>
        ...
        <div class="ptop_10 txac">
			 ...
			 <input type="button" value="提交" lay-submit lay-filter="*" class="layui-btn" onclick="/*add()*/">
