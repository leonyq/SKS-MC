...
<body>
	<div class="all" >
		<div class="add_table_div">
			<form id="addForm" class="layui-form" name="addForm" action="${path}email/userEmailManageAction_updateEmail.ms" method="post" target="submitFrame">
				<table class="add_table">
					...
					<tr>
						...
						<td style="width: 270px;">
							<dict:selectDict style="width:100%" id="reportType" name="paraMap.reportType" dictCode="MS_SEND_EMAIL_TO_REPORT_TYPE" dictValue="%{ajaxMap.reportType}" onchange="changeReType()" />
						</td>
						<td>&nbsp;
						</td>
						<td style="width: 100px;" class="tr1 mc_form_title mc_form_title">
						...
						<td style="width: 270px;">
								<select style="width:100%" name="paraMap.account" lay-search lay-verify="required" lay-search>
				...
				<table class="add_table" id="normal" >
					...
					<tr>
						...
						<td colspan="4">
							<input type="text" id="httpurl" name="paraMap.httpurl" onkeyup="javascript:replaceLikeVal1(this)"value="<s:property value="ajaxMap.httpurl"/>" style="width:100%;" />
						</td>
					</tr> 
					<tr>
						<td style="width: 100px;" class="tr1 mc_form_title mc_form_title">
				...
				<s:hidden name="paraMap.moduleId" ></s:hidden>
			</form>
		</div>
