...
<body style="height: 100%;width: 100%" onload="init()">
	...
	<div style="display: hidden">
			<form id="exportForm" action="${path}sys/BussModelAction_exportMod.ms" method="post" >
				...
				<div id="iframe1" style="height: 90%;">
					...
					<div class="iframe1_left" id="module_tree"
						...
						<div>
								...
								--%>
								<s:hidden name="moduleExportType" value="1" id="moduleExportType"></s:hidden>
								<h3 class="moduleTitle">业务模型</h3>
...
<%--			alert($("#exportModule").val())--%>
			document.getElementById("submitForm").action="${path}sys/moduleMagAction_moduleFunc.ms"
