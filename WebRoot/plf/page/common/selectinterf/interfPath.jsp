...
<body>
		<div >
			...
			<form id="addForm" class="layui-form" name="addForm" method="post" target="submitFrame">
				<table class="add_table">
					...
					<tr>
						...
						<td class="widget">
							<input type="text" lay-verify="required" id="packPath"  readonly value="<s:property value="paraMap.path"/>" class="_VAL_NULL"  />
						</td>
					</tr> 
					<tr>
					<td class="tr1 title">
	...
	function save(thisObj){
		...
		getSrcDom(obj).showSelectMeth(Inter,packPath,className,mcIframeName);
	...
	function cancle(thisObj){
		...
		var obj={"isFramesetMethod":false,"type":"window"};
		var mcIframeName = window.frameElement.name;; //外层iframe的name
		getSrcDom(obj).showBlankMeth(mcIframeName);
	}
