...
<body>
	<div class="all" >
		<div class="add_table_div">
			<form id="addForm"  class="layui-form" name="addForm" action="${path}sys/cusControlAction_modify.ms" method="post" enctype="multipart/form-data" target="submitFrame">
				<table class="add_table">
					...
					<tr>
						...
						<td colspan="3" >
								<div id="photoImg" >
									<img id="userPhoto" title="支持图像大小在<c:out value='${photoSizeInt}' />k以内" style="height: 133px;width: 133px;"/>
					...
					<tr>
						...
						<td colspan="3">
								<div id="resfile">
										<input type="file" id="reszipfilename" name="reszipfilename" onchange="javascript:reszipchange();"/> 
										&nbsp&nbsp&nbsp<a href="javascript:void()" onclick="seefile('${cusControlDto.id}')">查看</a>
								</div>
						</td>
					</tr>
				...
				<s:hidden id="uiImg" name="cusControlDto.uiImg" />
				<s:hidden id="cusId" name="cusControlDto.id" />
			</form>
		</div>
	</div>
	...
	<script type="text/javascript">
	 ...
	 window.onload = function() {
			document.getElementById("userPhoto").src = $("#userPhotoPath")
					.val()
					+ "plf/js/dhtmlxtree/imgs/csh_bluebooks/" + $("#uiImg").val();
