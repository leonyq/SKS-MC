...
<script src="${path}plf/js/debug/codeMirror/mode/clike/clike.js"></script>
...
<!--全屏模式-->
<link rel="stylesheet" href="${path}plf/js/debug/codeMirror/addon/display/fullscreen.css">
<script src="${path}plf/js/debug/codeMirror/addon/display/fullscreen.js"></script>
...
<body>
	...
	<div class="add_table_div">	
		...
		<form id="editForm" class="layui-form" name="editForm"
			...
			<div class="ptop_10 txac">			
					...
					<c:if test="${is_debug =='TRUE'}">
						<input type="button" class="layui-btn"  onclick="validateIsCurrentDebug()" value="<dict:lang value="调试" />">
					</c:if>
	...
	<script>
	   ...
	   var set_height=winWh - divHeadH - 81;
	...
	function edit(thisObj) {
		...
		if(toFlag == "interface"){ //N2接口保存
			...
			closePopWin();
		}else if(toFlag == "zymk"){//自研模块管理       模块基本信息                  模块启动接口
			analyClsCode()
			if(!isSubmit){
				return false;
			}
