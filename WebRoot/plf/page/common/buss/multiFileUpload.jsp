    ...
    $(document).ready(function () {
		...
		if(fileNames!=""){
		   ...
		   for(var item in fileNameArr) {
			   ...
			   if(toLowerCaseFile.indexOf(".jpg")!=-1||toLowerCaseFile.indexOf(".png")!=-1||toLowerCaseFile.indexOf(".gif")!=-1){
        ...
        $("#kv-explorer").fileinput({
        	...
        	**/
        	...
        	$("#"+componentId,parentFrame.contentWindow.document).val(fileName.replace(reg,""));
