...
<body>
	<div class="all" >
		<div class="add_table_div">
			<form id="addForm" class="layui-form" name="addForm" action="${path}eventHttp/eventHttpManageAction_save.ms" method="post" target="submitFrame">
				<table class="add_table">
					...
					--%><tr>
						...
						<td style="width: 270px;">
							<input type="text" lay-verify="required" id="name" name="paraMap.name" value="<s:property value="ajaxMap.name"/>" class="_VAL_NULL"  onkeyup="javascript:replaceLikeVal(this)"/>
						</td>
						<td>
							&nbsp;
						</td>
						...
						<td style="width: 270px;">
							<input type="text" lay-verify="required" id="detail" name="paraMap.detail" value="<s:property value="ajaxMap.detail"/>" class="_VAL_NULL" maxlength="500"onkeyup="javascript:replaceLikeVal(this)"/>
						</td>
					</tr> 
					<tr>
						<td style="width: 100px;" class="tr1 mc_form_title mc_form_title">
						...
						<td style="width: 270px;">
							<input type="text" lay-verify="required" id="url" name="paraMap.url" value="<s:property value="ajaxMap.url"/>" class="_VAL_NULL" onkeyup="javascript:replaceLikeVal1(this)"/>
						</td>
						<td>
							&nbsp;
						</td>
						...
						<td style="width: 270px;">
							<dict:selectDict name="paraMap.method"  dictCode="RQ_TYPE" dictValue="%{${fn:escapeXml(ajaxMap.method)}}"  onchange="hidenContext()" id="RQ_TYPE" />
						</td>
					</tr>
				</table>
		...
		for(var j in headers){
		   if(!reg.test(j)){
			...
			var obj = headers[j];
			 if(first==1){
			 	headerAdd += "<tr>"
					  + "<td width='35%'><input type='text' id='headerName' onkeyup=\"javascript:replaceLikeVal(this)\" style=\"width:90%;\" value="+obj.key+" /><span class=\"Eng\">*</span></td>"
					  + "<td width='43%'><input type='text' id='headerValue' onkeyup=\"javascript:replaceLikeVal(this)\" style=\"width:98%;\" value="+obj.value+" /><span class=\"Eng\">*</span></td>"
					  + "<td width='7%'>";
				headerAdd += "<img src=\""+path+"/m_add.gif?_mc_res_version=<%=PlfStaticRes.M_ADD_GIF%>\" onclick=\"addHeader('"+path+"')\"/>";
				first++;
			}else{
				headerAdd += "<tr>"
					  + "<td width='35%'><input type='text' id='headerAdd"+new Date+"' style=\"width:90%;\" onkeyup=\"javascript:replaceLikeVal(this)\" value="+obj.key+" /><span class=\"Eng\">*</span></td>"
					  + "<td width='43%'><input type='text' id='headerAdd"+new Date+"' style=\"width:98%;\" onkeyup=\"javascript:replaceLikeVal(this)\"  value="+obj.value+" /><span class=\"Eng\">*</span></td>"
					  + "<td width='7%'>";
			...
			if(bodysString.endWith("keyValueFlag")){
				...
				for(var j in bodys){
					...
					var obj = bodys[j];
					 if(first==1){
					 	bodysAdd += "<tr>"
							  + "<td width='35%'><input type='text' id='bodyAdd"+new Date+"' style=\"width:90%;\" value="+obj.key+" /><span class=\"Eng\">*</span></td>"
							  + "<td width='43%'><input type='text'  id='bodyAdd"+new Date+"' style=\"width:98%;\" value="+obj.value+" /><span class=\"Eng\">*</span></td>"
							  + "<td width='7%'>";
