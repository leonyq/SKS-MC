...
<body>
	<div class="all">
		<div>
			<form action="${path }performance/performanceMonitorAction_memoryObjList.ms" method="post" id="searchForm">
			...
			<table id="listTable" class="table_list"
				...
				<thead>
					<tr class="tdcolor">
						...
						<th width="20%"><dict:lang value="内存对象类名" />
						</th>
						<th width="10%"><dict:lang value="实例数" />
						</th>
						<th width="10%"><dict:lang value="占用空间比" />(%)
						</th>
						<th width="20%"><dict:lang value="占用空间大小" />
						</th>
					</tr>
				</thead>
			</table>
			<table id="listTable" class="table_list"
				...
				<tbody class="body_data">
					<c:forEach items="${dataList }" var="data" varStatus="status">
						...
						<td width="10%">
							<span title="<c:out value = '${data.instances }'/>"> <c:out value = '${data.instances }'/></span>
						</td>
						<td width="10%">
							<span><c:out value = '${data.permGen*100 }'/></span>
