...
<head>
    ...
    <title><dict:lang value="查询条件" /> <dict:lang value="编辑" /></title>
...
<body>
    <div class="all">
        <div>
            ...
            <input type="hidden" id="paraMap_SEARCH_LIST" name="paraMap.SEARCH_LIST"/>
                <table class="add_table" align="center">
                    ...
                    <tr>
                        ...
                        <td width="30%">
                            <input type="text" id="paraMap_CONDITION_NAME" name="CONDITION_NAME"  class="_VAL_NULL" maxlength="100" value="<c:out value='${paraMap.CONDITION_NAME}'/>"/>
                            <span class="Eng">*</span>
                        </td>
                        <td width="20%" class="tr1">
                        ...
                        <td width="30%">
                            <input type="text" id="paraMap_CONDITION_FIELD" name="CONDITION_FIELD"  class="_VAL_NULL" maxlength="100" value="<c:out value='${paraMap.CONDITION_FIELD}'/>"/>
                            <span class="Eng">*</span>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td width="30%">
                            <input type="text" id="paraMap_SHOW_ORDER" name="SHOW_ORDER" maxlength="3" class="_VAL_NULL _VAL_NaN" value="<c:out value='${paraMap.SHOW_ORDER}'/>"
                        ...
                        <td width="30%">
                            ...
                            <div id="paraMap_SEARCH_UI_div">
                                <input type="text" id="paraMap_SEARCH_UI_NAME" name="SEARCH_UI_NAME" readOnly class="readonly _VAL_NULL" value="<c:out value='${paraMap.SEARCH_UI_NAME}'/>"/>
                                <input type="hidden" id="paraMap_SEARCH_UI" name="SEARCH_UI" readOnly class="readonly" value="<c:out value='${paraMap.SEARCH_UI}'/>"/>
                                    <img src="${IMG_PATH}/search.png?mc_res_version=<%=PlfStaticRes.SEARCH_PNG %>" onclick="cfgUI();" style="cursor:pointer;" width="20px" height="20px"/>
                    ...
                    <tr id="is_time_id">
                        ...
                        <td width="30%">
                        <input type="text" id="paraMap_CONN_SYMBOL" name="CONN_SYMBOL" maxlength="5" class="readonly" readOnly value="<c:out value='${paraMap.CONN_SYMBOL}'/>"/>
                        <span class="Eng"></span>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td width="30%">
                            <input type="text" id="paraMap_SH_UI_FUN" name="SH_UI_FUN" maxlength="300" value="<c:out value='${paraMap.SH_UI_FUN}'/>"/>
                        </td>
                        <td width="20%" class="tr1">
                            <dict:lang value="样式表" />
                        </td>
                        <td width="30%">
                            <input type="text" id="paraMap_SH_UI_CLASS" name="SH_UI_CLASS" maxlength="300" value="<c:out value='${paraMap.SH_UI_CLASS}'/>" />
                        </td>                       
                    </tr>  
                    <tr>
                        <td width="20%" class="tr1">
                        ...
                        <td width="30%" colspan="3">
                            <input type="text" id="paraMap_SH_UI_SYTLE" name="SH_UI_SYTLE" maxlength="300"  value="<c:out value='${paraMap.SH_UI_SYTLE}'/>"/>
                        </td>
                    </tr>                                      
                </table>
            </form>
    ...
    function add(){
        ...
        var seq = parseInt("<c:out value='${paraMap.CHK}'/>") - 1;
        ...
        window.parent.editRowData(formHtml);
        parent.closePopWin();
    }
    ...
    function cfgUI(){//alert(UI_COMP);
        ...
        var url = "${path}sys/BussModelAction_cfgUICompFrame.ms?paraMap.id=null&paraMap.FORM_ID=null&paraMap.UI_COMP__TYPE=UI_COMP_SEARCH&paraMap.UI_COMP="+$("#paraMap_SEARCH_UI").val();
        showPopWin(url, 750, 450,null," <dict:lang value="UI组件配置"/>","cfgUiIframe");        
    }   
    
    function init(){
        $("#paraMap_SEARCH_COM").val("<c:out value='${paraMap.SEARCH_COM}'/>");
        $("#paraMap_SEARCH_REL").val("<c:out value='${paraMap.SEARCH_REL}'/>");
        $("#paraMap_IS_TIME_BUCKET").val("<c:out value='${paraMap.IS_TIME_BUCKET}'/>");
        setConnSy("<c:out value='${paraMap.IS_TIME_BUCKET}'/>"); 
