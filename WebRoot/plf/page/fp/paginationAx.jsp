...
<div id="pageSelect" style="display: none;"><dict:selectDict dictCode="PAGE_SHOW" dictValue="%{page.pageRecord}" cssClass="dept_select" style="width:110px;" onchange="deptChangeAx(this)" name="dept"/></div>
<script type="text/javascript" src="${path}plf/page/fp/js/page.js?_mc_res_version=<%=PlfStaticRes.PlfJsUi_Include_js %>"></script>
...
<script language="javascript">
    ...
    function fn_turnPageAx_<c:out value='${param.formId}' />(vflag){
    	...
    	function fn_reloadByChangePerPageAx(icount,thisObj){
    		var formId = $(thisObj).parents('ul').find("input[name='formId']").val();
