...
<head>
  ...
  <title><dict:lang value="动作配置修改"/></title>
...
<body>
    <div class="layui-fluid">
        ...
        <form id="add_form" class="layui-form" name="addForm" action="${path}dmp/DmpMotionAction_MotionModelEdit.ms" method="post">
        	<input type="hidden" value="${dataMap.TOA_REMARK}" id="procedureDto_toaRemark1">
            ...
            <div class="layui-form-item">
                ...
                <div class="list-right">
                    <div class="pane">
                        <input type="text" placeholder="<dict:lang value="请输入动作编码"/>" maxlength="20"  class="layui-input" name="procedureMotionDto.toaCode" id="procedureMotionDto_toaCode" value="${dataMap.TOA_CODE}" readonly="readonly">
                    </div>  
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="list-right">
                    <div class="pane">
                        <input type="text" placeholder="<dict:lang value="请输入动作名称"/>" maxlength="33" lay-verify="required" class="layui-input" name="procedureMotionDto.toaName" id="procedureMotionDto_toaName" value="${dataMap.TOA_NAME}" >
                    </div>
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="list-right">
                    <div class="pane">
                        <input type="text" placeholder="<dict:lang value="请输入提示信息"/>"  maxlength="50" lay-verify="required" class="layui-input" name="procedureMotionDto.toaMsgCode" id="procedureMotionDto_toaMsgCode" value="${dataMap.TOA_MSG_CODE}" >
                    </div>
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="list-right">
                    <div class="pane">
                        <input type="text" placeholder="<dict:lang value="请输入参数"/>"  maxlength="20" lay-verify="required" class="layui-input" name="procedureMotionDto.toaParamCode" id="procedureMotionDto_toaParamCode" value="${dataMap.TOA_PARAM_CODE}" >
                    </div>
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="list-right">
                  <div class="pane" style="position:relative" >
                    <div class="layui-form" lay-filter="pane1" style="position:absolute;float:left;" id="acttype0" >                     
                     ...
                     <select lay-search lay-verify="required" name="procedureMotionDto.toaClassify" id="procedureMotionDto_toaClassify">
            ...
            <div class="layui-form-item">
                ...
                <div class="list-right">
                <div class="pane">
                	<input class="layui-input" maxlength="600" style="height:38px;padding:8px;"  name="procedureMotionDto.toaRemark" id="procedureMotionDto_toaRemark" value="${dataMap.TOA_REMARK}" />
       ...
       <div class="ptop_10">
         	...
         	<button type="button" class="layui-btn" lay-filter="filterSubmit" onclick="moctionEdit()" lay-submit="formSubmit"><dict:lang value="保存"/></button>
...
<script>
    ...
    function preAdd(){
        var flag='${param.flag}';
        var url = "${path}dmp/DmpMotionAction_preMotionModelAdd.ms?&flag="+flag;
...
<script type="text/javascript">
   ...
   return false;
	...
	var flag='${param.flag}';
		var url = "${path}dmp/DmpMotionAction_MotionModelEdit.ms";
	    jQuery.ajax({
		type: "POST",
	    dataType: "json",
	    data:{
	    	"paraMap.ID":$("#procedureMotionDto_id").val(),
		...
		success: function(data){	
				...
				if(flag=="orderSetting"){										
			  	  	window.parent.addActiveList(data.ajaxMap,"2",dir);			  	 	 					  	 					
