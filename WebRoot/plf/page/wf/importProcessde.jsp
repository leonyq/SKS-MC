     ...
     <div class="all">
        ...
        <form id="add_form" name="add_form"  class="layui-form" action="${path}comm/WorkFlowAction_saveProcessde.ms" method="post" target="submitFrame" enctype="multipart/form-data">
         <input type="hidden" name="paraMap.flowTypeId" value='<s:property value="paraMap.flowTypeId"/>' >
           <input type="hidden" id="import" name="paraMap.import" value='import' >
         
        	<table class="add_table">
        		<tr>
						<td  class="tr1 title">
							<span class="Eng">*</span><dict:lang value="文件选择" />
						</td>
						<td class="widget">
							<input type="file" style="" id="upFiles" name="upFiles" class="" lay-verify="required">
						</td>
				</tr>
        		<tr>
						<td  class="tr1  title">
