...
<%@page import="com.more.fw.core.staticresource.PlfStaticRes"%>
	<head>
		<title><dict:lang value="抄送我的" /></title>
	           ...
	           <div class="search-box-group">
	              ...
	              <div style="display: inline-block;vertical-align: top;">
	                   <div class="input-lable">
		                <select id="procDeId" class="dept_select IS_SELECT_FILTER" style="display: none;">
			                    
			            </select>
			            </div>
			             <div class="input-lable">
			               <select name="type" id="type" class="dept_select" style="width: 240px; ">
						        <option value="0"><dict:lang value="待阅" /></option>
			                    <option value="1"><dict:lang value="已阅" /></option>
...
<script type="text/javascript">
				...
				success: function(data){
						...
						if(null != data.ajaxPage.dataList){
							...
							for(var i = 0;i < usertList.length; i++){
								...
								$("#listTable").append("<tr id='"+usertList[i].id+"' ondblclick=\"detail('"+usertList[i].id+"','"+usertList[i].task_id+"','"+usertList[i].process_id+"')\"></tr>");
								...
								$("#listTable tr:last").append("<td style='display:none;'>"+usertList[i].task_id+"</td>");
								...
								$("#listTable tr:last").append("<td style='text-align:center;'>"+usertList[i].start_user_name+"</td>");
	...
	function detail(id,task_id,process_id){	    	
		showDetail(task_id,process_id);
		notified(id);
	...
	function notified(id)
	   {
	     $.ajax({
				type: "POST",
			    dataType: "json",
			    url: "${path}comm/ProcessAction_taskNotified.ms",
			    data: {			    	
			    	'paraMap.id' : id
			    },
				success: function(data){
