...
<%@page import="com.more.fw.core.staticresource.PlfStaticRes"%>
	<head>
		<title><dict:lang value="发起审批" /></title>
	    ...
	    <div class="children-search-box">
	        <div class="search-box-content">
	           <div class="search-box-group">
	              ...
	              <input type="text" value="<c:out value='${flowName}' />" name="flowName" style="margin-left: 30px;"  class="input input-box" placeholder="<dict:lang value='输入流程名称' /> ">
	           </div>
	           
	        </div>
	        <div class="optn work-time-optn" style="left:270px">
		  ...
		  <div  id="mainCard"  style="border-bottom: 1px solid #ededed;">
		    ...
		    <div class="work-card-body">
		          ...
		          <c:forEach var="mapli" items="${map.value}">
		               <li class="card-item" onclick="startFlow('${mapli.proc_de_id}');" >                
...
<script type="text/javascript">
	...
	$(function(){
      ...
      if(error!='')
      {
         utilsFp.confirmIcon(1, "", "", "",error, 0, "300", "");
      }
          ...
          $(".card-font").hover(function(e){
          	if($(this).height()>92){
          		 var str="<span class='card-name-show'>"+$(this).text()+"<span>";
          		 $(".card-name-show").css({"left":e.clientX+10+"px","top":e.clientY+15+"px"})
           	    $("body").append(str);
          		  $(this).mousemove(function(event){
                		 $(".card-name-show").css({"left":event.clientX+10+"px","top":event.clientY+15+"px"})
          		  })
          	} 	
          },function(){
          	$(".card-name-show").remove();
          })
    ...
    function startFlow(flowId){
       var piframeId = parent.window.frameElement.id+"_reloadPgClose";
       var url = "${path}buss/bussModel.ms?iframeId="+piframeId+"&exeid="+flowId+"&flowId="+flowId;
       //var url = "${path}buss/bussModel_exeFunc.ms?flowId="+flowId+"&iframeId="+piframeId;
       showPopWinFp(url, 900, 500,null,"<dict:lang value='新增' />");
    }
