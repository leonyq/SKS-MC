...
<%@page import="com.more.fw.core.staticresource.PlfStaticRes"%>
	<head>
		<title><dict:lang value="已办事宜" /></title>
...
<script type="text/javascript">
	...
	function query(paginationImpl){
		...
		$.ajax({
				type: "POST",
			    dataType: "json",
			    url: "${path}comm/ProcessAction_searchCompletedList.ms",
			    data: {
				...
				success: function(data){
						...
						if(null != data.ajaxPage.dataList){
							...
							for(var i = 0;i < usertList.length; i++){
								...
								$("#listTable").append("<tr id='"+usertList[i].id+"' ondblclick=\"showDetail('"+usertList[i].id+"','"+usertList[i].process_id+"')\"></tr>");
