...
<body>
	<div class="edit">
            <div class="hd">
			    ...
			    <div class="optn">
			        <button type="button" onclick="saveBom(this);"><i class="ico ico-save"></i>保存1</button>
	...
	<input type="hidden" name="relcol" value="3a6a195ea82c4ebbaaaacc3ee52c6438" />		<s:set name="_$viewId" value="'5ef2a5aae81342ef93ea5b9376dd08a6'" />
		...
		<tr>
			...
			<bu:td cssClass="dec" colNo="CB_STATUS" formId="881411561f8f4940ac22575c4b8f02ef" ><bu:ui colNo="CB_STATUS" formId="881411561f8f4940ac22575c4b8f02ef" type="add" value="%{CB_STATUS}" formIndex="0" /></bu:td>
