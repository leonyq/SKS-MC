...
<head>
	...
	<%@ include file="/plf/page/common/buss/listCommJs.jsp"%>
		<bu:header formId ="b37b28af09114b73b08bce4b03d25ccb"/>
...
<body scroll="auto" >
		...
		<bu:func viewId="a51c5ff624ad4efda2a5722b96be96d8" />
		...
		<bu:search viewId="a51c5ff624ad4efda2a5722b96be96d8" />
						</form>
		...
		<form id="listForm" name="listForm" action="${path}buss/bussModel.ms" method="post">
			<input type="hidden" name="exeid" value="${exeid}" />
			<s:hidden name="%{@com.more.fw.core.common.method.Constants@FUNC_CODE}" />
		<bu:form viewId="a51c5ff624ad4efda2a5722b96be96d8" formId="b37b28af09114b73b08bce4b03d25ccb" list="dataList" formidFirstId="b37b28af09114b73b08bce4b03d25ccb" relColIds="" subFormIds="" subRelColIds="" currentPage="${page.currentPage}" pageRecord="${page.pageRecord}" />
  ...
  <% }}%></div>
		...
		<bu:submit viewId="a51c5ff624ad4efda2a5722b96be96d8" />
		<bu:script viewId="a51c5ff624ad4efda2a5722b96be96d8" />
