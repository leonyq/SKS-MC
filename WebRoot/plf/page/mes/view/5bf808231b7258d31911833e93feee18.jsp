...
<body>
	...
	<input type="hidden" name="relcol" value="0ef8b50df2ec49e9b4384d1d3fbc7447" />		<s:set name="_$viewId" value="'14b402759687481c8e8d43b6f2a03e14'" />
...
<bu:editcpwin exeid="%{exeid}" formId="%{formId}" dataId="%{dataId}" hide="false"  hidecol="UUNAME" viewid="bac1167c353e42f1bba8da0f35e4f65b"/>
