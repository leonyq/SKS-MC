...
<body scroll="auto" style="overflow: auto;" >
    <div class="content-in">
		...
		<bu:table cssClass="datagrid-htable fixedTable datagrid-div6 datagrid-htable-kz" id="datagrid-htable536730f0f221402c8ddc9bb284b26acc" style="width:1490px;">
		...
		<table class="datagrid-btable fixedTable dblClick"  id="datagrid-btable-ajax536730f0f221402c8ddc9bb284b26acc" style="width:1470px;">
...
function createTableModel(ms,formId){
    ...
    if(formId=='536730f0f221402c8ddc9bb284b26acc'){<%--FM-辅料报废信息--%>
        $.each(uiTxt,function(i,v){
            ...
            arrHtml.push("</td>");
            arrHtml.push("<td colno='CTS_ITEM_TYPE' class='datagrid-cell "+ms.tdClass(formId, 'CTS_ITEM_TYPE')+"' style='width:130px;"+ms.tdStyle(formId, 'CTS_ITEM_TYPE')+"' "+ms.tdEvent(formId, 'CTS_ITEM_TYPE')+">")
            ...
            arrHtml.push("</td>");
            arrHtml.push("<td colno='CTS_SCARP_TYPE' class='datagrid-cell "+ms.tdClass(formId, 'CTS_SCARP_TYPE')+"' style='width:130px;"+ms.tdStyle(formId, 'CTS_SCARP_TYPE')+"' "+ms.tdEvent(formId, 'CTS_SCARP_TYPE')+">")
            ...
            arrHtml.push("</td>");
            arrHtml.push("<td colno='CTS_SCARP_TIME' class='datagrid-cell "+ms.tdClass(formId, 'CTS_SCARP_TIME')+"' style='width:130px;"+ms.tdStyle(formId, 'CTS_SCARP_TIME')+"' "+ms.tdEvent(formId, 'CTS_SCARP_TIME')+">")
            ...
            arrHtml.push("</td>");
            arrHtml.push("<td colno='CTS_SCARP_MAN' class='datagrid-cell "+ms.tdClass(formId, 'CTS_SCARP_MAN')+"' style='"+ms.tdStyle(formId, 'CTS_SCARP_MAN')+"' "+ms.tdEvent(formId, 'CTS_SCARP_MAN')+">")
