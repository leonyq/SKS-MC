...
<body scroll="auto" style="overflow: auto;" >
    <div class="content-in">
		...
		<bu:table cssClass="datagrid-htable fixedTable datagrid-div6 datagrid-htable-kz" id="datagrid-htable6c64c25e45214328b6adbec0abc8f34f" style="width:1505px;">
		...
		<table class="datagrid-btable fixedTable dblClick"  id="datagrid-btable-ajax6c64c25e45214328b6adbec0abc8f34f" style="width:1485px;">
...
function createTableModel(ms,formId){
    ...
    if(formId=='6c64c25e45214328b6adbec0abc8f34f'){<%--FM-辅料信息--%>
        $.each(uiTxt,function(i,v){
            ...
            arrHtml.push("</td>");
            arrHtml.push("<td colno='CTI_THAWING_TIME_TOTAL' class='datagrid-cell "+ms.tdClass(formId, 'CTI_THAWING_TIME_TOTAL')+"' style='width:90px;"+ms.tdStyle(formId, 'CTI_THAWING_TIME_TOTAL')+"' "+ms.tdEvent(formId, 'CTI_THAWING_TIME_TOTAL')+">")
            ...
            arrHtml.push("</td>");
            arrHtml.push("<td colno='CTI_THAWING_TIME_MAX' class='datagrid-cell "+ms.tdClass(formId, 'CTI_THAWING_TIME_MAX')+"' style='width:100px;"+ms.tdStyle(formId, 'CTI_THAWING_TIME_MAX')+"' "+ms.tdEvent(formId, 'CTI_THAWING_TIME_MAX')+">")
            ...
            arrHtml.push("</td>");
            arrHtml.push("<td colno='CTI_QULITY_DATE' class='datagrid-cell "+ms.tdClass(formId, 'CTI_QULITY_DATE')+"' style='width:85px;"+ms.tdStyle(formId, 'CTI_QULITY_DATE')+"' "+ms.tdEvent(formId, 'CTI_QULITY_DATE')+">")
