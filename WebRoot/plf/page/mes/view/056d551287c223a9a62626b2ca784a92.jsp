...
<script type="text/javascript">
    ...
    function updateAssociatedData(formId,formIndex,viewId){
        ...
        addTable_612afe7157ae46479b87fdd32cb77485datagrid-btbody
    	*/
    	 ...
    	 var uuid = guid();
    	 selectedTr.wrap("<form id="+uuid+" action=''></form>");
    	 var formData = JSON.stringify(form.serialize($("#"+uuid)));
    ...
    function addRow(tableId,formIndex,formData){
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                var thisTr = $("#addTableTr"+curRowSeq+"_"+FORM_COL_ID_D);
