...
<script type="text/javascript">
		$(function(){
        		$("#paraMapObj_CHECK_DATE").val('${dataMap.nowDate}');
        		});
		var addTableTrMap;
		var isQuery = false;
...
<script> 
				...
				<table class="basic-table">
					...
					<bu:set name="paraMapObj" value="${dataId}" formId="48144a83dd8d48bfb2efd478b3e61934" type="edit" />
					<tr>
					...
					<tr>
						...
						<td class="dec"><bu:ui colNo="REVIEW_DATE"
								formId="48144a83dd8d48bfb2efd478b3e61934" dataId="${dataId}"
								formIndex="1" disabled="disabled"/></td>
						<%--<td class="name "><span class="dot">*</span><bu:uitn colNo="STATE" formId="48144a83dd8d48bfb2efd478b3e61934" />
						</td>
						<td><bu:ui colNo="STATE"
								formId="48144a83dd8d48bfb2efd478b3e61934" dataId="${dataId}"
								formIndex="1" />
								</td>
					--%>
					...
					<tr>
						...
						<td colspan="3" class="dec"><bu:ui colNo="CODE_PATH"
								formId="48144a83dd8d48bfb2efd478b3e61934" dataId="${dataId}"
								formIndex="1" disabled="disabled"/></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td colspan="3" style="height:80px;" class="dec"><bu:ui colNo="IMPROVE_REMARK"
								formId="48144a83dd8d48bfb2efd478b3e61934" dataId="${dataId}"
								formIndex="1"  style="width:100%;height:100%;" disabled="disabled"/></td>
					</tr>
					<tr>
						<td class="name "><span class="dot">*</span><bu:uitn colNo="CHECK_USER" formId="48144a83dd8d48bfb2efd478b3e61934" /></td>
						<td class="dec"><bu:ui colNo="CHECK_USER" formId="48144a83dd8d48bfb2efd478b3e61934" dataId="${dataId}" formIndex="1" cssClass="_VAL_NULL isSubmit" /></td>
						<td class="name "><span class="dot">*</span><bu:uitn colNo="CHECK_DATE" formId="48144a83dd8d48bfb2efd478b3e61934" /></td>
						<td class="dec"><bu:ui colNo="CHECK_DATE" formId="48144a83dd8d48bfb2efd478b3e61934" dataId="${dataId}" formIndex="1" cssClass="_VAL_NULL isSubmit" /></td>
					</tr>
					<tr>
						<td class="name "><span class="dot">*</span><bu:uitn colNo="STATE" formId="48144a83dd8d48bfb2efd478b3e61934" /></td>
						<td colspan="3" class="dec">
						<dict:selectDict dictCode="CODECK_STATE" dictValue="%{paraMapObj.STATE}"  id="paraMapObj_STATE" 
							cssClass="input" name="paraMapObj.STATE"	onchange="setUiData(this);"  filterVal="1,2,3,5"/>  </td>
					</tr>
					<tr>
						<td class="name "><span class="dot">*</span><bu:uitn colNo="CHECK_REMARK" formId="48144a83dd8d48bfb2efd478b3e61934" /></td>
						<td colspan="3" style="height:80px;" class="dec"><bu:ui colNo="CHECK_REMARK" formId="48144a83dd8d48bfb2efd478b3e61934" dataId="${dataId}" formIndex="1" style="width:100%;height:100%;" cssClass="_VAL_NULL isSubmit" /></td>
					</tr>
				</table>
			</form>
		</div>
	...
	<bu:script viewId="5fcbc9e2d3654b699785d5597294c219" />
