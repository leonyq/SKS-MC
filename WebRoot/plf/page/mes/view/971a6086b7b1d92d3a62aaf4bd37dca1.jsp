...
<body>
	...
	<input type="hidden" name="relcol" value="UUID" />
	...
	<input type="hidden" name="paraMap0@__DATA_COUNT__" value="1" />
		<s:set name="_$viewId" value="'a4198b771d87409cb30a8a15462148fd'" />
...
<bu:editcpwin exeid="%{exeid}" formId="%{formId}" dataId="%{dataId}" hide="false"/>
	...
	<script type="text/javascript">
		...
		function showAddPopWin(exeid)
		{
			...
			var url = "/mes/buss/bussModel_forAddCommPop.ms?exeid=" + exeid + "&piframeId=" + piframeId + "&relcol=" + relcol;
		...
		function showEditPopWin(exeid,e)
		{
			...
			data = data + "}";
			var url = "/mes/buss/bussModel_forEditCommPop.ms?exeid=" + exeid + "&piframeId=" + piframeId + "&data=" + data +"&trId=" + id + "&relcol=" + relcol;
			showPopWinFp(url, 800, 400,"","test","新增","");
		}
		...
		function addData(data,exeid){
			var colParams = "";
			addRowPop(exeid,'1', colParams,data,'edit');
