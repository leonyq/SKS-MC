...
<body scroll="auto" style="overflow: auto;" >
    <div class="content-in">
        <div class="dlist">
            <div class="hd">
		<bu:func viewId="12c3b17d1b5a45d9a535d3fb364856af" />
            </div>
            <div class="bd">
		...
		<bu:search viewId="12c3b17d1b5a45d9a535d3fb364856af" />
                   </form>
		...
		<bu:table cssClass="datagrid-htable fixedTable datagrid-div6 datagrid-htable-kz" id="datagrid-htable46a69fb9850f4b81909589215ac5053a" style="width:2000px;min-width:1200px;">
		<s:set name="_$type" value="'view'" />
		<tbody class="isParentsTitle">
		<bu:tr cssClass="datagrid-header-row datagrid-title-ajax" id="datagrid-title-ajax">
			<td class="datagrid-cell" style="width:400px;"><bu:uitn colNo="SEX" formId="46a69fb9850f4b81909589215ac5053a" /></td>
			<td class="datagrid-cell" style="width:400px;"><bu:uitn colNo="QQ" formId="46a69fb9850f4b81909589215ac5053a" /></td>
		...
		<table class="datagrid-btable fixedTable"  id="datagrid-btable-ajax46a69fb9850f4b81909589215ac5053a" style="width:2000px;min-width:1180px;">
		...
		<bu:submit viewId="12c3b17d1b5a45d9a535d3fb364856af" />
		<bu:script viewId="12c3b17d1b5a45d9a535d3fb364856af" />
    ...
    function setTableHeight(formId){
    	var scrollHeight = $("#tableDiv"+formId)[0].scrollHeight;
    	var height = $("#tableDiv"+formId).height();
    	//id="datagrid-btable-ajax46a69fb9850f4b81909589215ac5053a"
...
function createTableModel(ms,formId){
    ...
    if(formId=='46a69fb9850f4b81909589215ac5053a'){<%--测试异步--%>
        $.each(uiTxt,function(i,v){
            console.log(uiRaw[i].CREATE_TIME);
            ...
            if($("#"+formId).find(".left-datagrid-title-ajax").length>0){
                ...
                arrLeftHtml.push("<td colno='NAME' class='datagrid-cell "+ms.tdClass(formId, 'NAME')+"' style='"+ms.tdStyle(formId, 'NAME')+" width:400px;' "+ms.tdEvent(formId, 'NAME')+">")
                ...
                arrLeftHtml.push("</td>");
                arrHtml.push("<td colno='SEX' class='datagrid-cell "+ms.tdClass(formId, 'SEX')+"' style='"+ms.tdStyle(formId, 'SEX')+" width:400px;' "+ms.tdEvent(formId, 'SEX')+">")
                arrHtml.push("<span colno='SEX' class='"+ms.uiClass(formId, 'SEX')+"' style='"+ms.uiStyle(formId, 'SEX')+"' "+ms.uiEvent(formId, 'SEX')+" >"+v['SEX']+"</span>")
                arrHtml.push("</td>");
                arrHtml.push("<td colno='QQ' class='datagrid-cell "+ms.tdClass(formId, 'QQ')+"' style='"+ms.tdStyle(formId, 'QQ')+" width:400px;' "+ms.tdEvent(formId, 'QQ')+">")
