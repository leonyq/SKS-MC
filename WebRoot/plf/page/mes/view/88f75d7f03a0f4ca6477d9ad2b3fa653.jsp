...
<body scroll="auto" style="overflow: auto;" >
		...
		<bu:func viewId="c06e07263b234fa58fd523337000b292" />
		...
		<bu:search viewId="c06e07263b234fa58fd523337000b292" />
						</form>
		...
		<form id="listForm" name="listForm" action="${path}buss/bussModel.ms" method="post">
			<input type="hidden" name="exeid" value="${exeid}" />
			<s:hidden name="%{@com.more.fw.core.common.method.Constants@FUNC_CODE}" />
		<bu:form viewId="c06e07263b234fa58fd523337000b292" formId="cc27f18548f648f4b033ec84305a5cd3" list="dataList" formidFirstId="cc27f18548f648f4b033ec84305a5cd3" relColIds="" subFormIds="" subRelColIds="" />
  ...
  <% }}%></div>
		...
		<bu:submit viewId="c06e07263b234fa58fd523337000b292" />
		<bu:script viewId="c06e07263b234fa58fd523337000b292" />
    <script type="text/javascript">
         $('.js-nav').slick({
            dots: false,
            autoplay: false,
