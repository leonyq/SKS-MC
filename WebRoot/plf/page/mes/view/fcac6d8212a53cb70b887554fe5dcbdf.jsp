...
<body>
	...
	<input type="hidden" name="relcol" value="0ef8b50df2ec49e9b4384d1d3fbc7447" />		<s:set name="_$viewId" value="'fc136dacec394583a02cfa1aa6785b12'" />
...
<bu:editcpwin exeid="%{exeid}" formId="%{formId}" dataId="%{dataId}" hide="false"  hidecol="" viewid="878357d2e57e4032817b8deb95afdf58"/>
