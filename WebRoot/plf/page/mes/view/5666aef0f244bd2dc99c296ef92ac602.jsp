...
<a href="javascript:delAssociatedData('612afe7157ae46479b87fdd32cb77485','1','24c04f963db647769778aeed5eaead19');" title="移除" class="btn-op"><i class="ico2 ico-sc"></i>移除</a>
</div>
...
<input type="hidden"  value="0b9e08429193488aba64454dfbb0c226" id="viewId_612afe7157ae46479b87fdd32cb77485">
...
<a href="javascript:delAssociatedData('677346fc6b47486ba7a9164f03017738','2','6867953fd832411c9a4a77c7f69d2362');" title="移除" class="btn-op"><i class="ico2 ico-sc"></i>移除</a>
</div>
...
<table  class="datagrid-htable fixedTable datagrid-div6">
<tbody>
<input type="hidden" id="677346fc6b47486ba7a9164f03017738" value="838ca5844aa648d193678e96bd870742"/>
<tr class="datagrid-header-row"><td class="datagrid-cell">
测试字段0</td>
<td class="datagrid-cell">
测试字段1</td>
...
<input type="hidden"  value="808c452db48846d48bd8dac79ccffed1" id="viewId_677346fc6b47486ba7a9164f03017738">
...
<script type="text/javascript">
    ...
    function addAssociatedData(formId,formIndex,viewId){
             ...
             var url = "buss/bussModel.ms?exeid="+viewId+"&formId="+formId+"&formIndex="+formIndex;
        	 showPopWinFp(url, 800, 400,null,"<dict:lang value="新增"/>","56456");
