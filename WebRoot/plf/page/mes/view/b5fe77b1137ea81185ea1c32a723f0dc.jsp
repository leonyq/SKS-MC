...
<body>
	<div class="edit">
		...
		<bu:set name="paraMapObj" value="${dataId}" formId="279c5856e1534dd0a77caf1eda21aec8" type="edit" />
	<table class="basic-table">
	...
	<input type="hidden" name="paraMap1@__DATA_COUNT__" value="1" />
		<s:set name="_$viewId" value="'4c0e72fb90994e3f98b55906ff3305b5'" />
		<s:set name="_$formId_1" value="'279c5856e1534dd0a77caf1eda21aec8'" />
		<s:set name="_$type" value="'edit'" />
		
		<input type="hidden" name="formEdit" value="'edit'" />
		
		<tr>
			<td class="name" style="width:82px;"/><span class="dot">*</span><bu:uitn colNo="CONTAINER_SN" formId="279c5856e1534dd0a77caf1eda21aec8" /></td>
			<td class="dec"><bu:ui colNo="CONTAINER_SN" formId="279c5856e1534dd0a77caf1eda21aec8" dataId="${dataId}"  formIndex="1"  style="width:300px;"/></td>
		</tr>
		<tr>	
			<td class="name" /><bu:uitn colNo="CONTAINER_TYPE" formId="279c5856e1534dd0a77caf1eda21aec8" /></td>
			<td class="dec"><bu:ui colNo="CONTAINER_TYPE" formId="279c5856e1534dd0a77caf1eda21aec8" dataId="${dataId}" formIndex="1"  style="width:300px;"/></td>
		</tr>
		<tr>	
			<td class="name" /><bu:uitn colNo="CONTAINER_SPEC" formId="279c5856e1534dd0a77caf1eda21aec8" /></td>
			<td class="dec"><bu:ui colNo="CONTAINER_SPEC" formId="279c5856e1534dd0a77caf1eda21aec8" dataId="${dataId}" formIndex="1"  style="width:300px;"/></td>
		</tr>
		<tr>	
		        <td class="name" /><bu:uitn colNo="CONTAINER_CAPACITY" formId="279c5856e1534dd0a77caf1eda21aec8" /></td>
			<td class="dec"><bu:ui colNo="CONTAINER_CAPACITY" formId="279c5856e1534dd0a77caf1eda21aec8" dataId="${dataId}" formIndex="1"  style="width:300px;"/></td>
		</tr>
		<tr>	
		        <td class="name" /><bu:uitn colNo="STATE_FLAG" formId="279c5856e1534dd0a77caf1eda21aec8" /></td>
			<td class="dec"><bu:ui colNo="STATE_FLAG" formId="279c5856e1534dd0a77caf1eda21aec8" dataId="${dataId}"  formIndex="1"  style="width:300px;"/></td>
		</tr>
		<tr>	
			<td class="name" /><bu:uitn colNo="ENABLE_FLAG" formId="279c5856e1534dd0a77caf1eda21aec8" /></td>
			<td class="dec" ><bu:ui colNo="ENABLE_FLAG" formId="279c5856e1534dd0a77caf1eda21aec8" dataId="${dataId}"  formIndex="1" /></td>
