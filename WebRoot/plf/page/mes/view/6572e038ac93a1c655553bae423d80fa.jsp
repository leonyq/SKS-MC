...
<body>
	...
	<input type="hidden" name="paraMap1@__DATA_COUNT__" value="1" />
		<s:set name="_$viewId" value="'5efdfae0c54749fc97e5195d87e125e8'" />
...
<script type="text/javascript">
    ...
    function saveData(formId,formIndex,curRowSeq){
        ...
        if(type == "2"){
            parentWindow.editData(formId,formIndex,changeKey(formData,formIndex,curRowSeq),curRowSeq,levelForm);
        }else{
