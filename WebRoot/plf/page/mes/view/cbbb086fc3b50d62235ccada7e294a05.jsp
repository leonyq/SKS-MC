...
<body scroll="auto" >
		...
		<bu:func viewId="630327be733a4179b51d05ffe8667465" />
		...
		<bu:search viewId="630327be733a4179b51d05ffe8667465" />
						</form>
		...
		<form id="listForm" name="listForm" action="${path}buss/bussModel.ms" method="post">
			<input type="hidden" name="exeid" value="${exeid}" />
			<s:hidden name="%{@com.more.fw.core.common.method.Constants@FUNC_CODE}" />
		<bu:form viewId="630327be733a4179b51d05ffe8667465" formId="c47ff0279b024a9989e3eba875ae6136" list="dataList" formidFirstId="c47ff0279b024a9989e3eba875ae6136" relColIds="" subFormIds="" subRelColIds="" currentPage="${page.currentPage}" pageRecord="${page.pageRecord}" />
  ...
  <% }}%></div>
		...
		<bu:submit viewId="630327be733a4179b51d05ffe8667465" />
		<bu:script viewId="630327be733a4179b51d05ffe8667465" />
