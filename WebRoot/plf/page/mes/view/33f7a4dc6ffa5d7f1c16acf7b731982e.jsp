...
<body>
	<div class="edit">
			...
			<div class="bd">
					<form id="editForm" name="editForm" action="${path}buss/bussModel_editComm.ms" method="post" target="submitFrame"
								...
								<input type="hidden" id="paraMapObj.CSI_ADDRESS" name="paraMapObj.CSI_ADDRESS" value="esop">
	...
	<input type="hidden" name="paraMap1@__DATA_COUNT__" value="1" />
		...
		<tr>
			<td class="name" style="width:68px;"/><span class="dot">*</span><bu:uitn colNo="CSI_SN" formId="62e5f8f76eab45ddbcf24c091ee691ce" /></td>
			...
			<td class="name" style="width:68px;"/><span class="dot">*</span><bu:uitn colNo="CSI_NAME" formId="62e5f8f76eab45ddbcf24c091ee691ce" /></td>
