...
<body scroll="auto" style="overflow: auto;" >
	...
	<div class="content-in">
              <div class="dlist">
                  <div class="hd">
		<bu:func viewId="37c15bb5c79d421c9f724bc439a37ef9" />
                  </div>
		...
		<bu:search viewId="37c15bb5c79d421c9f724bc439a37ef9" />
						</form>
...
<tbody id="tbody_46a69fb9850f4b81909589215ac5053a" class="isParents">
   ...
   <div class="center">
<c:if test="${formPage46a69fb9850f4b81909589215ac5053a==1}">
...
<tbody id="tbody_612afe7157ae46479b87fdd32cb77485" class="isChilds">
  ...
  <div class="center">
<c:if test="${formPage612afe7157ae46479b87fdd32cb77485==1}">
...
<tbody id="tbody_677346fc6b47486ba7a9164f03017738" class="isChilds">
  ...
  <div class="center">
<c:if test="${formPage677346fc6b47486ba7a9164f03017738==1}">
 <s:include value="/plf/page/fp/paginationAx.jsp?listDataFn=listAjaxTable&formId=677346fc6b47486ba7a9164f03017738&showLoading=0" />
</c:if>
</div>
...
<input type="hidden" name="tableCount" id="tableCount" value='3' />
		...
		<bu:submit viewId="37c15bb5c79d421c9f724bc439a37ef9" />
		<bu:script viewId="37c15bb5c79d421c9f724bc439a37ef9" />
	...
	alert(_GLO_FORM_PAGE_MAP[formId].currentPage);
