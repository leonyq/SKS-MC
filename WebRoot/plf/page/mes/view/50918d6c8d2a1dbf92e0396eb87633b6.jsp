				...
				<table class="basic-table">
					...
					<tr>
						...
						<dict:selectDict dictCode="CODECK_STATE" dictValue="%{paraMapObj.STATE}"  id="paraMapObj_STATE" 
							cssClass="input"	name="paraMapObj.STATE"	onchange="setUiData(this);"  filterVal="0"/> 
						<%--<bu:ui colNo="STATE"
								formId="48144a83dd8d48bfb2efd478b3e61934" dataId="${dataId}"
								formIndex="1" cssClass="_VAL_NULL isSubmit" />
								--%></td>
					</tr>
					<tr>
						<td class="name "><bu:uitn colNo="CODE_PATH" formId="48144a83dd8d48bfb2efd478b3e61934" />
						</td>
						<td class="dec" colspan="3"><bu:ui colNo="CODE_PATH"
								formId="48144a83dd8d48bfb2efd478b3e61934" dataId="${dataId}"
								formIndex="1" /></td>
					</tr>
					<tr>
						...
						<td class="dec" colspan="3" style="height:80px;"><bu:ui colNo="CODE_DETAIL"
								formId="48144a83dd8d48bfb2efd478b3e61934" dataId="${dataId}"
								formIndex="1" style="width:100%"/></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="dec" colspan="3" style="height:80px;"><bu:ui colNo="IMPROVE_REMARK"
								formId="48144a83dd8d48bfb2efd478b3e61934" dataId="${dataId}"
								formIndex="1" disabled="disabled" style="width:100%"/></td>
					</tr>
					<tr>
					...
					<%--<tr>
						...
						<td class="dec" colspan="3"><bu:ui colNo="STATE" formId="48144a83dd8d48bfb2efd478b3e61934" dataId="${dataId}" formIndex="1" disabled="disabled"/></td>
					</tr>
					--%><tr>
						<td class="name "><span class="dot">*</span><bu:uitn colNo="CHECK_REMARK" formId="48144a83dd8d48bfb2efd478b3e61934" /></td>
						<td class="dec" colspan="3" style="height:120px;"><bu:ui colNo="CHECK_REMARK" formId="48144a83dd8d48bfb2efd478b3e61934" dataId="${dataId}" formIndex="1" disabled="disabled"/></td>
					</tr>
				</table>
