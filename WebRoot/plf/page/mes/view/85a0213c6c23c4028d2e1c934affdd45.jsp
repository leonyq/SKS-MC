...
<body>
            ...
            <div class="hd">
                <%--<h2 class="tit"><i class="ico-hd"></i>物料信息常规</h2>--%>
			    	<div class="optn">
        					...
        					<button type="button" onclick="resetForm();" ><i class="ico ico-gk"></i><dict:lang value="重" /></button>
			    </div>
	...
	<input type="hidden" name="paraMap1@__DATA_COUNT__" value="1" />
		<s:set name="_$viewId" value="'4db2c8cfe4e14b1896a5efe14c49f70d'" />
		...
		<bu:form viewId="4db2c8cfe4e14b1896a5efe14c49f70d" formId="612afe7157ae46479b87fdd32cb77485" isSubForm="1" list="dataListSub" formidFirstId="46a69fb9850f4b81909589215ac5053a" relColIds="" subFormIds="" subRelColIds="" />
