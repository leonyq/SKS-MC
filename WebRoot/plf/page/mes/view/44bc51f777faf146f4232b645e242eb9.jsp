...
<body>
	<div class="edit">
		...
		<bu:set name="paraMapObj" value="${dataId}" formId="913b9c4be3e342b69567d81e69619d65" type="edit" />
	<table class="basic-table" >
	<input type="hidden" name="formIds" value="913b9c4be3e342b69567d81e69619d65" />
	<input type="hidden" name="913b9c4be3e342b69567d81e69619d65" value="paraMap0@" />
	<input type="hidden" name="paraMap0@__LEVEL__" value="0" />
	<input type="hidden" name="paraMap0@__DATA_COUNT__" value="1" />
		<s:set name="_$viewId" value="'d758e7c9e51a4a2893e59f2c35c0f44f'" />
		<s:set name="_$formId_0" value="'913b9c4be3e342b69567d81e69619d65'" />
		<s:set name="_$type" value="'edit'" />
		<tr>
			<td class="name-three" /><bu:uitn colNo="EID" formId="913b9c4be3e342b69567d81e69619d65" /></td>
			<bu:td cssClass="dec-self" colNo="EID" formId="913b9c4be3e342b69567d81e69619d65" ><bu:ui colNo="EID" formId="913b9c4be3e342b69567d81e69619d65" dataId="${dataId}" formIndex="0" /></bu:td>
		</tr>
		<tr>
			<td class="name-three" /><bu:uitn colNo="UUUID" formId="913b9c4be3e342b69567d81e69619d65" /></td>
			<bu:td cssClass="dec-self" colNo="UUUID" formId="913b9c4be3e342b69567d81e69619d65" ><bu:ui colNo="UUUID" formId="913b9c4be3e342b69567d81e69619d65" dataId="${dataId}" formIndex="0" /></bu:td>
		</tr>
	</table>
			<bu:jsVal formId="913b9c4be3e342b69567d81e69619d65" formIndex="0" />
									</form>
			</div>
