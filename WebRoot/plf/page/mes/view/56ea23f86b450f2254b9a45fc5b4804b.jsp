...
iframe2.window.query(this);
	...
	//初始化iframe
	function intIframe(){
switchTag('tag2','content2','/mes/buss/bussModel.ms?exeid=e0928408b8014026be9b27834b00db86');
switchTag('tag1','content1','/mes/buss/bussModel.ms?exeid=3696748d368743728aed26d8cf0be516');
...
<body scroll="no">
	<DIV class="multilist comwrap content-in">
		<div class="dlist">
			<div class="hd">
		<bu:func viewId="5347a54c23f245d492c25d4661522aee" />
			</div>
			<div class="bd">
		...
		<bu:search viewId="5347a54c23f245d492c25d4661522aee" />
						</form>
...
<LI id="tag1">
 <A class="selectli1" onclick="switchTag('tag1','content1','${path}buss/bussModel.ms?exeid=3696748d368743728aed26d8cf0be516');this.blur();" href="javascript:void(0);"> <SPAN class="selectspan1">测试列表</SPAN> </A>
</LI>
<LI id="tag2">
 <A class="" onclick="switchTag('tag2','content2','${path}buss/bussModel.ms?exeid=e0928408b8014026be9b27834b00db86');this.blur();" href="javascript:void(0);"> <SPAN >票据列表</SPAN> </A>
</LI>
...
<DIV id="content1" >
 ...
 <tr>
 <td>
 <iframe id="iframe1" name="iframe1" frameBorder="0" src='${path}buss/bussModel.ms?exeid=3696748d368743728aed26d8cf0be516' width="100%" scrolling="auto" height="400" onload="dynIframesize('iframe1');"></iframe>
<form id="listForm" name="listForm" action="${path}buss/bussModel.ms" method="post">
<input type="hidden" name="exeid" value="3696748d368743728aed26d8cf0be516" />
<s:hidden name="%{@com.more.fw.core.common.method.Constants@FUNC_CODE}" />
</form>
 </td>
 </tr>
...
<form id="listForm" name="listForm" action="${path}buss/bussModel.ms" method="post">
<input type="hidden" name="exeid" value="e0928408b8014026be9b27834b00db86" />
<s:hidden name="%{@com.more.fw.core.common.method.Constants@FUNC_CODE}" />
</form>
 </td>
 </tr>
		...
		<bu:submit viewId="5347a54c23f245d492c25d4661522aee" />
		<bu:script viewId="5347a54c23f245d492c25d4661522aee" />
				</div>
		    </div>
		</div>
	</DIV>
