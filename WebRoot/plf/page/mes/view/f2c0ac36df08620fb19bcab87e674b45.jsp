...
<body>
	...
	<form id="searchForm" name="searchForm" action="${path}buss/bussModel.ms" method="post">
		...
		<bu:func viewId="e8381c90ac7143a3b1ec4ac8ac8e91d2" />
		<div>
		<form id="listForm" name="listForm" action="${path}buss/bussModel.ms" method="post">
			<input type="hidden" name="exeid" value="${exeid}" />
			<s:hidden name="%{@com.more.fw.core.common.method.Constants@FUNC_CODE}" />
		<bu:form viewId="e8381c90ac7143a3b1ec4ac8ac8e91d2" formId="d2d9268a180041c1999e70338e590e5c" list="dataList" formidFirstId="d2d9268a180041c1999e70338e590e5c" relColIds="" subFormIds="" subRelColIds="" />
  ...
  <% }}%></div>
		...
		<bu:submit viewId="e8381c90ac7143a3b1ec4ac8ac8e91d2" />
		<bu:script viewId="e8381c90ac7143a3b1ec4ac8ac8e91d2" />
