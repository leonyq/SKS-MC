...
<body>
	<div class="edit">
			    ...
			    <div class="optn">
			        <button type="button" onclick="savechild(this);"><i class="ico ico-save"></i><dict:lang value="提交" /></button>
				...
				<%-- <table class="func_table">
					<tr>
						<td width="100%" align="right">
							...
							<input type="button" onclick="reset();resetInit();" value="<dict:lang value="重置" />" class="botton_img_search" />
							
							<input type="button" value="<dict:lang value="关闭" />" onclick="closeWindow();" class="botton_img_search">
						</td>
					</tr>
				</table>
	...
	<input type="hidden" name="paraMap1@__DATA_COUNT__" value="1" />
		<s:set name="_$viewId" value="'00874c6e54424f2a85f252a1a7a6c0b7'" />
		...
		<tr>
			...
			<td class="dec"><bu:ui colNo="PID" formId="846ed3470b134d86aa1c860acc4e442c" value="%{PID}" formIndex="1" /></td>
		</tr>
		<tr>
	...
	<div style="display: none;">
		<iframe id="submitFrame" name="submitFrame" src="" width="0" height="0"></iframe>
                        ...
                        <bu:submit viewId="00874c6e54424f2a85f252a1a7a6c0b7" />
                <bu:script viewId="00874c6e54424f2a85f252a1a7a6c0b7" />
<script type="text/javascript">
	function init(){
	...
	$("#paraMap1_PROJECT_ID_SHOW").val('${dataMap.PROJECT_NAME}');
