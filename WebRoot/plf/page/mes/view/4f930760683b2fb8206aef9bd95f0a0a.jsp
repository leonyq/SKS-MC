                ...
                <div style="margin-bottom:50px;" class="topTab two-top-tab">
                    <div id="tabPanel_612afe7157ae46479b87fdd32cb77485" class="tabPanel">
                        <div class="tab-button more tab-add">
                            <a href="javascript:addAssociatedData('612afe7157ae46479b87fdd32cb77485','1','48f43a08b25f4ef1b0c3af5dc77f2062','2','46a69fb9850f4b81909589215ac5053a');" title="添加" class="btn-op"><i class="ico ico-add"></i>添加</a>
                            <a href="javascript:updateAssociatedData('612afe7157ae46479b87fdd32cb77485','1','48f43a08b25f4ef1b0c3af5dc77f2062','2','46a69fb9850f4b81909589215ac5053a');" title="修改" class="btn-op"><i class="ico2 ico-xg"></i>修改</a>                            <input type="hidden"  value="2" id="associatedModel612afe7157ae46479b87fdd32cb77485"/>
                        </div>
                             ...
                             <div class="datagrid-div2 datagrid-div6 datagrid-view" id="datagrid-header1">
                                ...
                                <div class="datagrid-body tab-table-height">
                                    <table class="datagrid-btable-pop fixedTable datagrid-div6 glxb-table" id="addTable_612afe7157ae46479b87fdd32cb77485">
                                        <input type="hidden" name="level_612afe7157ae46479b87fdd32cb77485" value="2""/>                                        <input type="hidden" id="table_curRowSeq612afe7157ae46479b87fdd32cb77485" value="1"/>
                    ...
                    <div id="tabPanel_677346fc6b47486ba7a9164f03017738" style="display:none" class="tabPanel">
                        <div class="tab-button more tab-add">
                            <a href="javascript:addAssociatedData('677346fc6b47486ba7a9164f03017738','2','5efdfae0c54749fc97e5195d87e125e8','2','46a69fb9850f4b81909589215ac5053a');" title="添加" class="btn-op"><i class="ico ico-add"></i>添加</a>
                            <a href="javascript:updateAssociatedData('677346fc6b47486ba7a9164f03017738','2','5efdfae0c54749fc97e5195d87e125e8','2','46a69fb9850f4b81909589215ac5053a');" title="修改" class="btn-op"><i class="ico2 ico-xg"></i>修改</a>                            <input type="hidden"  value="2" id="associatedModel677346fc6b47486ba7a9164f03017738"/>
                        </div>
                        <div class="tab-add-div"></div>                        <div class="panel datagrid datagrid-div1"  id="46a69fb9850f4b81909589215ac5053a">
            ...
            <div style="margin-bottom:50px;display:none;" class="three-content three-content-612afe7157ae46479b87fdd32cb77485">
                ...
                <div class="topTab three-top-tab">
                    <div id="tabPanel_ef89e60166894af08c5dfd37085b7f2e" class="tabPanel">
                        <div class="tab-button more tab-add">
                            <a href="javascript:addAssociatedData('ef89e60166894af08c5dfd37085b7f2e','3','351bde98643c4160a8cc2723d58924d0','3','612afe7157ae46479b87fdd32cb77485');" title="添加" class="btn-op"><i class="ico ico-add"></i>添加</a>
                            <a href="javascript:updateAssociatedData('ef89e60166894af08c5dfd37085b7f2e','3','351bde98643c4160a8cc2723d58924d0','3','612afe7157ae46479b87fdd32cb77485');" title="修改" class="btn-op"><i class="ico2 ico-xg"></i>修改</a>                            <input type="hidden"  value="2" id="associatedModelef89e60166894af08c5dfd37085b7f2e"/>
                        </div>
                        <div class="tab-add-div"></div>                        <div class="panel datagrid datagrid-div1"  id="46a69fb9850f4b81909589215ac5053a">
                    ...
                    <div id="tabPanel_783ba612e92847ad941f9f9d33cb331a" style="display:none" class="tabPanel">
                        <div class="tab-button more tab-add">
                            <a href="javascript:addAssociatedData('783ba612e92847ad941f9f9d33cb331a','4','05eb31ce186d47038790ac01d72a163b','3','612afe7157ae46479b87fdd32cb77485');" title="添加" class="btn-op"><i class="ico ico-add"></i>添加</a>
                            <a href="javascript:updateAssociatedData('783ba612e92847ad941f9f9d33cb331a','4','05eb31ce186d47038790ac01d72a163b','3','612afe7157ae46479b87fdd32cb77485');" title="修改" class="btn-op"><i class="ico2 ico-xg"></i>修改</a>                            <input type="hidden"  value="2" id="associatedModel783ba612e92847ad941f9f9d33cb331a"/>
                        </div>
                        <div class="tab-add-div"></div>                        <div class="panel datagrid datagrid-div1"  id="46a69fb9850f4b81909589215ac5053a">
            ...
            <div style="margin-bottom:50px;display:none;" class="three-content three-content-677346fc6b47486ba7a9164f03017738">
                ...
                <div class="topTab three-top-tab">
                    <div id="tabPanel_cdba5173030f4b3da5bdb29f7dd9b0cd" class="tabPanel">
                        <div class="tab-button more tab-add">
                            <a href="javascript:addAssociatedData('cdba5173030f4b3da5bdb29f7dd9b0cd','5','049f383122e84ce69fa44eb997f26135','3','677346fc6b47486ba7a9164f03017738');" title="添加" class="btn-op"><i class="ico ico-add"></i>添加</a>
                            <a href="javascript:updateAssociatedData('cdba5173030f4b3da5bdb29f7dd9b0cd','5','049f383122e84ce69fa44eb997f26135','3','677346fc6b47486ba7a9164f03017738');" title="修改" class="btn-op"><i class="ico2 ico-xg"></i>修改</a>                            <input type="hidden"  value="2" id="associatedModelcdba5173030f4b3da5bdb29f7dd9b0cd"/>
                        </div>
                        <div class="tab-add-div"></div>                        <div class="panel datagrid datagrid-div1"  id="46a69fb9850f4b81909589215ac5053a">
                    ...
                    <div id="tabPanel_323f914f68b44838916953f0bc56668f" style="display:none" class="tabPanel">
                        <div class="tab-button more tab-add">
                            <a href="javascript:addAssociatedData('323f914f68b44838916953f0bc56668f','6','9a080015b7a347a389ee28c692dab3d5','3','677346fc6b47486ba7a9164f03017738');" title="添加" class="btn-op"><i class="ico ico-add"></i>添加</a>
                            <a href="javascript:updateAssociatedData('323f914f68b44838916953f0bc56668f','6','9a080015b7a347a389ee28c692dab3d5','3','677346fc6b47486ba7a9164f03017738');" title="修改" class="btn-op"><i class="ico2 ico-xg"></i>修改</a>                            <input type="hidden"  value="2" id="associatedModel323f914f68b44838916953f0bc56668f"/>
                        </div>
                        <div class="tab-add-div"></div>                        <div class="panel datagrid datagrid-div1"  id="46a69fb9850f4b81909589215ac5053a">
...
function getEditRowsData(tableId,formIndex,trId,levelForm){
    ...
    $.ajax({
        ...
        data:{
             ...
             'paraMap.parentTrId':trId ,'paraMap.levelForm':levelForm,'paraMap.colNo':colNo,
             'paraMap.colNoD':colNoD
