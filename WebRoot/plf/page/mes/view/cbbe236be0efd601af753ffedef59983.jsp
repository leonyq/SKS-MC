...
<body scroll="auto" style="overflow: auto;" >
    <div class="content-in">
		...
		<bu:table cssClass="datagrid-htable fixedTable datagrid-div6 datagrid-htable-kz" id="datagrid-htable05b39a22c63b4544be3294a59d5dd767"  style="min-width:1220px;">
		...
		<bu:tr cssClass="datagrid-header-row datagrid-title-ajax" id="datagrid-title-ajax">
			...
			<td class="datagrid-cell" style="width: 150px;"><bu:uitn colNo="CREATE_TIME" formId="05b39a22c63b4544be3294a59d5dd767" /></td>
			<td class="datagrid-cell" style="width: 150px;"><bu:uitn colNo="EDIT_TIME" formId="05b39a22c63b4544be3294a59d5dd767" /></td>
		...
		<table class="datagrid-btable fixedTable dblClick"  id="datagrid-btable-ajax05b39a22c63b4544be3294a59d5dd767"  style="min-width:1200px;">
...
function createTableModel(ms,formId){
    ...
    if(formId=='05b39a22c63b4544be3294a59d5dd767'){<%--条码规则--%>
        $.each(uiTxt,function(i,v){
            ...
            arrHtml.push("<span colno='TBR_NAME' class='"+ms.uiClass(formId, 'TBR_NAME')+"' style='"+ms.uiStyle(formId, 'TBR_NAME')+"' "+ms.uiEvent(formId, 'TBR_NAME')+" >"+v['TBR_NAME']+"</span>")
            arrHtml.push("</td>");
            arrHtml.push("<td colno='TBR_MATCH_CHAR' class='datagrid-cell "+ms.tdClass(formId, 'TBR_MATCH_CHAR')+"' style='width:90px;"+ms.tdStyle(formId, 'TBR_MATCH_CHAR')+"' "+ms.tdEvent(formId, 'TBR_MATCH_CHAR')+">")
            arrHtml.push("<span colno='TBR_MATCH_CHAR' class='"+ms.uiClass(formId, 'TBR_MATCH_CHAR')+"' style='"+ms.uiStyle(formId, 'TBR_MATCH_CHAR')+"' "+ms.uiEvent(formId, 'TBR_MATCH_CHAR')+" >"+v['TBR_MATCH_CHAR']+"</span>")
            arrHtml.push("</td>");
            arrHtml.push("<td colno='TBR_ANALYTIC_TYPE' class='datagrid-cell "+ms.tdClass(formId, 'TBR_ANALYTIC_TYPE')+"' style='width:90px;"+ms.tdStyle(formId, 'TBR_ANALYTIC_TYPE')+"' "+ms.tdEvent(formId, 'TBR_ANALYTIC_TYPE')+">")
            arrHtml.push("<span colno='TBR_ANALYTIC_TYPE' class='"+ms.uiClass(formId, 'TBR_ANALYTIC_TYPE')+"' style='"+ms.uiStyle(formId, 'TBR_ANALYTIC_TYPE')+"' "+ms.uiEvent(formId, 'TBR_ANALYTIC_TYPE')+" >"+v['TBR_ANALYTIC_TYPE']+"</span>")
            arrHtml.push("</td>");
            arrHtml.push("<td colno='TBR_STATUS' class='datagrid-cell "+ms.tdClass(formId, 'TBR_STATUS')+"' style='width:70px;text-align:center;"+ms.tdStyle(formId, 'TBR_STATUS')+"' "+ms.tdEvent(formId, 'TBR_STATUS')+">")
            arrHtml.push("<span colno='TBR_STATUS' class='"+ms.uiClass(formId, 'TBR_STATUS')+"' style='"+ms.uiStyle(formId, 'TBR_STATUS')+"' "+ms.uiEvent(formId, 'TBR_STATUS')+" >"+v['TBR_STATUS']+"</span>")
            arrHtml.push("</td>");
            ...
            arrHtml.push("<span colno='TBR_DEFAULT' class='"+ms.uiClass(formId, 'TBR_DEFAULT')+"' style='"+ms.uiStyle(formId, 'TBR_DEFAULT')+"' "+ms.uiEvent(formId, 'TBR_DEFAULT')+" >"+v['TBR_DEFAULT']+"</span>")
            arrHtml.push("</td>");
            ...
            arrHtml.push("<span colno='TBR_TYPE' class='"+ms.uiClass(formId, 'TBR_TYPE')+"' style='"+ms.uiStyle(formId, 'TBR_TYPE')+"' "+ms.uiEvent(formId, 'TBR_TYPE')+" >"+v['TBR_TYPE']+"</span>")
            arrHtml.push("</td>");
            ...
            arrHtml.push("</td>");
            arrHtml.push("<td colno='TBR_MEMO' class='datagrid-cell "+ms.tdClass(formId, 'TBR_MEMO')+"' style='"+ms.tdStyle(formId, 'TBR_MEMO')+"' "+ms.tdEvent(formId, 'TBR_MEMO')+">")
            arrHtml.push("<span colno='TBR_MEMO' class='"+ms.uiClass(formId, 'TBR_MEMO')+"' style='"+ms.uiStyle(formId, 'TBR_MEMO')+"' "+ms.uiEvent(formId, 'TBR_MEMO')+" >"+v['TBR_MEMO']+"</span>")
            arrHtml.push("</td>");
            arrHtml.push("</tr>")
        });
