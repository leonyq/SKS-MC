...
<body>
	...
	<input type="hidden" name="relcol" value="0ef8b50df2ec49e9b4384d1d3fbc7447" />		<s:set name="_$viewId" value="'b26f312104fe40ac83cb2fecc0b45a25'" />
...
<bu:editcpwin exeid="%{exeid}" formId="%{formId}" dataId="%{dataId}" hide="false" viewid="ffeedc023dff4b8ea0b7e005caed810e"  hidecol="S_NAME,UUNAME"/>
