...
<body>
	...
	<input type="hidden" name="relcol" value="0ef8b50df2ec49e9b4384d1d3fbc7447" />		<s:set name="_$viewId" value="'a9eeee6bae3c4a2dab245cf41c92b7c0'" />
...
<bu:editcpwin exeid="%{exeid}" formId="%{formId}" dataId="%{dataId}" hide="false"  hidecol="" viewid="81c2dd7e68ed462ca51b5630853310bf"/>
