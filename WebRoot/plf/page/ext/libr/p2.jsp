...
<body>
    ...
    <table class="add_table" >
			<tr >
				...
				<img src="${path }images/ext/libr/demo.png" width="230" height="268" />
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td height="120px;" colspan="2" valign="top" align="left">
			...
			<tr>
				...
				<SPAN style="font-size:18px"><dict:lang value="剧集列表" />(<s:if test="null==page.dataList">0</s:if><s:property value="page.dataList.size()" />)</SPAN>
				</td>
			</tr>
			<tr>
	...
	function playVido(id){
		if(id == null || ""==id){util.alert("<dict:lang value='剧集列表为空，未找到相关视频' />");return;}
		var url = "${path}buss/bussModel.ms?exeid=730329913f7d41ae9fd50ba038df0398&paraMap.ID="+id;
		if(null !=openObj){
			openObj.close();
		}
