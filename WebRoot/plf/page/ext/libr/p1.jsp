...
<body>
			...
			<tr>
				...
				<s:iterator value="page.dataList" status="index">
					<div class="div_auto_wrap_single" style="width: 200px;border:1px solid white;" onmouseover="showBorder(this);" onmouseout="showBorderOut(this);">
						...
						<div><img src="${path }images/ext/libr/demo.png" style="cursor: pointer;" onclick="showVidoChild(this,'<s:property value="ID"/>');" /></div>
	...
	function showVidoChild(thisObj,id){
		var url = "${path}buss/bussModel.ms?exeid=5142642e0ee44118a1893d3dc17044c6&paraMap.ID="+id;
		window.open(url);
	}
