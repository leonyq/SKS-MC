...
<!-- 页面加载前 -->
 <jsp:include page="/plf/page/mesdemo/commCode/commCode.jsp">
     <jsp:param name="modelName" value="VIEW_TYPE_12" />
...
<body>
    <div class="edit">
            <div class="hd">
               ...
               <div style="margin-left:10px;">
                ...
                <div class="optn">
                    ...
                    <button type="button" onclick="addFlow(this);"><i class="ico ico-save"></i><dict:lang value="保存并发起流程" /></button>
           ...
           <form id="addForm" name="addForm" action="${path}buss/bussModel_addAjaxComm.ms?<s:property value='%{@com.more.fw.core.common.method.ConstantsMc@FUNC_CODE}' />=<s:property value='%{FUNC_CODE}' />" method="post" <bu:formet exeid="%{exeid}" /> target="submitFrame">
