		...
		this.check=function (){
			if ((dhtmlObject)&&(dhtmlObject.onloadAction!=null)){
				if  ((!dhtmlObject.xmlDoc.readyState)||(dhtmlObject.xmlDoc.readyState == 4)){
					var sessionstatus = dhtmlObject.xmlDoc.getResponseHeader("sessionstatus");
					var isPlatform = dhtmlObject.xmlDoc.getResponseHeader("isPlatform");
					if(false== _mcAjaxBack(dhtmlObject.xmlDoc)){//ldg 修改,增加判断是否有开发者权限
						return false;
					}
...
//if ((navigator.userAgent.indexOf('Safari') != -1)||(navigator.userAgent.indexOf('Konqueror')!= -1))//ldg modify 在Chrome浏览器下会报错
...
_dhtmlxError.prototype.throwError=function(type,name,params){
        ...
        //window.location.reload();//modify by liudg 2014-07-04 do session time out ect.
        return null;
}
