...
<head>
    ...
    <%@ include file="/plf/page/common/buss/listCommJs.jsp"%>
		<bu:header formId ="4cd2b210c7a241f8a46f17580fe751d6"/>
...
<body>
    <div class="content-in">
        <div class="dlist">
            <div class="hd">
		<bu:func viewId="ef25fda6126a4a7c84415bb14805fffa" />
            </div>
            <div class="bd">
  ...
  <table class="search_table">
      <bu:search deal_mark="1" viewId="ef25fda6126a4a7c84415bb14805fffa" /> 
		...
		<input type="hidden" name="formPage4cd2b210c7a241f8a46f17580fe751d6" id="formPage4cd2b210c7a241f8a46f17580fe751d6" value="${formPage4cd2b210c7a241f8a46f17580fe751d6}"/>
		<input type="hidden" name="formId" id="formId1" value='4cd2b210c7a241f8a46f17580fe751d6'/>
		<input type="hidden" id="subRelColIds" name="subRelColIds" value='null'/>
		<input type="hidden" id="subFormIds" name="subFormIds" value='null'/>
		<div class="panel-ajax datagrid datagrid-div1"  id="4cd2b210c7a241f8a46f17580fe751d6">
		<div class="datagrid-div2 datagrid-div6 datagrid-view-ajax" id="datagrid-view-ajax4cd2b210c7a241f8a46f17580fe751d6" style="">
		<div class="datagrid-header">
		<div class="datagrid-header-inner" id="datagrid-header-inner4cd2b210c7a241f8a46f17580fe751d6">
		<bu:table cssClass="datagrid-htable fixedTable datagrid-div6 datagrid-htable-kz" id="datagrid-htable4cd2b210c7a241f8a46f17580fe751d6">
		<s:set name="_$type" value="'view'" />
		<tbody class="isParentsTitle">
		<bu:tr cssClass="datagrid-header-row datagrid-title-ajax" id="datagrid-title-ajax">
			<td class="datagrid-cell" name="noprintset_SEQ" style="width:30px; text-align:center;" ><bu:thSeq  formId="4cd2b210c7a241f8a46f17580fe751d6" i18n="1"/></td>
			<td class="datagrid-cell no-print" style="width:30px; text-align:center"><span><input type="checkbox" id="selectAll_4cd2b210c7a241f8a46f17580fe751d6" onclick="_selectAjaxTableAllData(this,'4cd2b210c7a241f8a46f17580fe751d6')" style="cursor: pointer;"title="全选"/></span></td>
			<td name="noprintset_NAME" class="datagrid-cell"><bu:uitn colNo="NAME" formId="4cd2b210c7a241f8a46f17580fe751d6" /></td>
			<td name="noprintset_AGE" class="datagrid-cell"><bu:uitn colNo="AGE" formId="4cd2b210c7a241f8a46f17580fe751d6" /></td>
			<td name="noprintset_TIMES" class="datagrid-cell"><bu:uitn colNo="TIMES" formId="4cd2b210c7a241f8a46f17580fe751d6" /></td>
			<td name="noprintset_TIMEDATES" class="datagrid-cell"><bu:uitn colNo="TIMEDATES" formId="4cd2b210c7a241f8a46f17580fe751d6" /></td>
			<td name="noprintset_DAWENBEN" class="datagrid-cell"><bu:uitn colNo="DAWENBEN" formId="4cd2b210c7a241f8a46f17580fe751d6" /></td>
		</bu:tr>
		</tbody>
		</bu:table>
		</div>
		</div>
		<div class="datagrid-body datagrid-div3 datagrid-body-ajax" id="tableDiv4cd2b210c7a241f8a46f17580fe751d6" onscroll="ajaxTableScroll(this,'4cd2b210c7a241f8a46f17580fe751d6')">
		<table class="datagrid-btable fixedTable dblClick"  id="datagrid-btable-ajax4cd2b210c7a241f8a46f17580fe751d6">
		<tbody id="tbody_4cd2b210c7a241f8a46f17580fe751d6" class="isParents">
		</tbody>
		</table>		</div>
		</div>
		</div>
		<c:if test="${formPage4cd2b210c7a241f8a46f17580fe751d6==1}">			<div class="center">
			<s:include value="/plf/page/fp/paginationPopMultAx.jsp?listDataFn=listAjaxTable&formId=4cd2b210c7a241f8a46f17580fe751d6&showLoading=0" />
			</div>
		</c:if>
 ...
 <button type="button" onclick="printset_17('4cd2b210c7a241f8a46f17580fe751d6','1');">打印</button>
 </div>
 </div>
 ...
 <input type="text" name="DAWENBEN" value="" title_name="大文本" />px
		...
		<bu:submit viewId="ef25fda6126a4a7c84415bb14805fffa" />
      <jsp:include page="/plf/page/mesdemo/commCode/commCode.jsp">
           <jsp:param name="modelName" value="VIEW_TYPE_17" />
           <jsp:param name="location" value="beforeJsLoad" />
      </jsp:include>
		<bu:script viewId="ef25fda6126a4a7c84415bb14805fffa" />
...
function createTableModel(ms,formId){
    ...
    if(formId=='4cd2b210c7a241f8a46f17580fe751d6'){<%--FOR1011--%>
