...
<head>
    ...
    <%@ include file="/plf/page/common/buss/listCommJs.jsp"%>
		<bu:header formId ="a72270d6707744fbb087cf29c4df4581"/>
...
<body>
    <div class="content-in">
        <div class="dlist">
            <div class="hd">
		<bu:func viewId="6c9d1e50466b47f5b0dba9bd5476313d" />
            </div>
            <div class="bd">
  ...
  <table class="search_table">
      <bu:search deal_mark="1" viewId="6c9d1e50466b47f5b0dba9bd5476313d" /> 
		...
		<input type="hidden" name="formPagea72270d6707744fbb087cf29c4df4581" id="formPagea72270d6707744fbb087cf29c4df4581" value="${formPagea72270d6707744fbb087cf29c4df4581}"/>
		<input type="hidden" name="formId" id="formId1" value='a72270d6707744fbb087cf29c4df4581'/>
		<input type="hidden" id="subRelColIds" name="subRelColIds" value='null'/>
		<input type="hidden" id="subFormIds" name="subFormIds" value='null'/>
		<div class="panel-ajax datagrid datagrid-div1"  id="a72270d6707744fbb087cf29c4df4581">
		<div class="datagrid-div2 datagrid-div6 datagrid-view-ajax" id="datagrid-view-ajaxa72270d6707744fbb087cf29c4df4581" style="">
		<div class="datagrid-header">
		<div class="datagrid-header-inner" id="datagrid-header-innera72270d6707744fbb087cf29c4df4581">
		<bu:table cssClass="datagrid-htable fixedTable datagrid-div6 datagrid-htable-kz" id="datagrid-htablea72270d6707744fbb087cf29c4df4581">
		<s:set name="_$type" value="'view'" />
		<tbody class="isParentsTitle">
		<bu:tr cssClass="datagrid-header-row datagrid-title-ajax" id="datagrid-title-ajax">
			<td class="datagrid-cell" name="noprintset_SEQ" style="width:30px; text-align:center;" ><bu:thSeq  formId="a72270d6707744fbb087cf29c4df4581" i18n="1"/></td>
			<td class="datagrid-cell no-print" style="width:30px; text-align:center"><span><input type="checkbox" id="selectAll_a72270d6707744fbb087cf29c4df4581" onclick="_selectAjaxTableAllData(this,'a72270d6707744fbb087cf29c4df4581')" style="cursor: pointer;"title="全选"/></span></td>
			<td name="noprintset_WU_NAME" class="datagrid-cell"><bu:uitn colNo="WU_NAME" formId="a72270d6707744fbb087cf29c4df4581" /></td>
			<td name="noprintset_TIMES" class="datagrid-cell"><bu:uitn colNo="TIMES" formId="a72270d6707744fbb087cf29c4df4581" /></td>
			<td name="noprintset_DATES" class="datagrid-cell"><bu:uitn colNo="DATES" formId="a72270d6707744fbb087cf29c4df4581" /></td>
			<td name="noprintset_BEIZHU" class="datagrid-cell"><bu:uitn colNo="BEIZHU" formId="a72270d6707744fbb087cf29c4df4581" /></td>
			<td name="noprintset_SNO" class="datagrid-cell"><bu:uitn colNo="SNO" formId="a72270d6707744fbb087cf29c4df4581" /></td>
			<td name="noprintset_NAME" class="datagrid-cell"><bu:uitn colNo="NAME" formId="a72270d6707744fbb087cf29c4df4581" /></td>
			<td name="noprintset_SEX" class="datagrid-cell"><bu:uitn colNo="SEX" formId="a72270d6707744fbb087cf29c4df4581" /></td>
			<td name="noprintset_AGE" class="datagrid-cell"><bu:uitn colNo="AGE" formId="a72270d6707744fbb087cf29c4df4581" /></td>
			<td name="noprintset_NATHION" class="datagrid-cell"><bu:uitn colNo="NATHION" formId="a72270d6707744fbb087cf29c4df4581" /></td>
			<td name="noprintset_XUELI" class="datagrid-cell"><bu:uitn colNo="XUELI" formId="a72270d6707744fbb087cf29c4df4581" /></td>
			<td name="noprintset_HOBBY" class="datagrid-cell"><bu:uitn colNo="HOBBY" formId="a72270d6707744fbb087cf29c4df4581" /></td>
			<td name="noprintset_SCORE" class="datagrid-cell"><bu:uitn colNo="SCORE" formId="a72270d6707744fbb087cf29c4df4581" /></td>
			<td name="noprintset_PHONE" class="datagrid-cell"><bu:uitn colNo="PHONE" formId="a72270d6707744fbb087cf29c4df4581" /></td>
			<td name="noprintset_PHOTO" class="datagrid-cell"><bu:uitn colNo="PHOTO" formId="a72270d6707744fbb087cf29c4df4581" /></td>
			<td name="noprintset_PHOTO_NAME" class="datagrid-cell"><bu:uitn colNo="PHOTO_NAME" formId="a72270d6707744fbb087cf29c4df4581" /></td>
			<td name="noprintset_PHOTO_SIZE" class="datagrid-cell"><bu:uitn colNo="PHOTO_SIZE" formId="a72270d6707744fbb087cf29c4df4581" /></td>
			<td name="noprintset_PHOTO_PATH" class="datagrid-cell"><bu:uitn colNo="PHOTO_PATH" formId="a72270d6707744fbb087cf29c4df4581" /></td>
			<td name="noprintset_PHOTO_LIU" class="datagrid-cell"><bu:uitn colNo="PHOTO_LIU" formId="a72270d6707744fbb087cf29c4df4581" /></td>
			<td name="noprintset_WENJIAN" class="datagrid-cell"><bu:uitn colNo="WENJIAN" formId="a72270d6707744fbb087cf29c4df4581" /></td>
			<td name="noprintset_WENJIAN_NAME" class="datagrid-cell"><bu:uitn colNo="WENJIAN_NAME" formId="a72270d6707744fbb087cf29c4df4581" /></td>
			<td name="noprintset_WENJIAN_SIZE" class="datagrid-cell"><bu:uitn colNo="WENJIAN_SIZE" formId="a72270d6707744fbb087cf29c4df4581" /></td>
			<td name="noprintset_WENJIAN_PATH" class="datagrid-cell"><bu:uitn colNo="WENJIAN_PATH" formId="a72270d6707744fbb087cf29c4df4581" /></td>
			<td name="noprintset_ZHUCE" class="datagrid-cell"><bu:uitn colNo="ZHUCE" formId="a72270d6707744fbb087cf29c4df4581" /></td>
			<td name="noprintset_MORELEAN" class="datagrid-cell"><bu:uitn colNo="MORELEAN" formId="a72270d6707744fbb087cf29c4df4581" /></td>
			<td name="noprintset_WU_CODE" class="datagrid-cell"><bu:uitn colNo="WU_CODE" formId="a72270d6707744fbb087cf29c4df4581" /></td>
			<td name="noprintset_PROVINCE" class="datagrid-cell"><bu:uitn colNo="PROVINCE" formId="a72270d6707744fbb087cf29c4df4581" /></td>
			<td name="noprintset_CITY" class="datagrid-cell"><bu:uitn colNo="CITY" formId="a72270d6707744fbb087cf29c4df4581" /></td>
			<td name="noprintset_TOWN" class="datagrid-cell"><bu:uitn colNo="TOWN" formId="a72270d6707744fbb087cf29c4df4581" /></td>
			<td name="noprintset_VILLAGE" class="datagrid-cell"><bu:uitn colNo="VILLAGE" formId="a72270d6707744fbb087cf29c4df4581" /></td>
			<td name="noprintset_WU_SPEC" class="datagrid-cell"><bu:uitn colNo="WU_SPEC" formId="a72270d6707744fbb087cf29c4df4581" /></td>
		</bu:tr>
		</tbody>
		</bu:table>
		</div>
		</div>
		<div class="datagrid-body datagrid-div3 datagrid-body-ajax" id="tableDiva72270d6707744fbb087cf29c4df4581" onscroll="ajaxTableScroll(this,'a72270d6707744fbb087cf29c4df4581')">
		<table class="datagrid-btable fixedTable dblClick"  id="datagrid-btable-ajaxa72270d6707744fbb087cf29c4df4581">
		<tbody id="tbody_a72270d6707744fbb087cf29c4df4581" class="isParents">
		</tbody>
		</table>		</div>
		</div>
		</div>
		<c:if test="${formPagea72270d6707744fbb087cf29c4df4581==1}">			<div class="center">
			<s:include value="/plf/page/fp/paginationPopMultAx.jsp?listDataFn=listAjaxTable&formId=a72270d6707744fbb087cf29c4df4581&showLoading=0" />
			</div>
		</c:if>
 ...
 <button type="button" onclick="printset_17('a72270d6707744fbb087cf29c4df4581','1');">打印</button>
 </div>
 </div>
 ...
 <input type="text" name="WU_SPEC" value="" title_name="?物料描述" />px
		...
		<bu:submit viewId="6c9d1e50466b47f5b0dba9bd5476313d" />
      <jsp:include page="/plf/page/mesdemo/commCode/commCode.jsp">
           <jsp:param name="modelName" value="VIEW_TYPE_17" />
           <jsp:param name="location" value="beforeJsLoad" />
      </jsp:include>
		<bu:script viewId="6c9d1e50466b47f5b0dba9bd5476313d" />
...
function createTableModel(ms,formId){
    ...
    if(formId=='a72270d6707744fbb087cf29c4df4581'){<%--fzhouer_925--%>
