...
<head>
    ...
    <%@ include file="/plf/page/common/buss/listCommJs.jsp"%>
		<bu:header formId ="e421ae7fd0714683b9c83928f7a272be"/>
...
<body>
    <div class="content-in">
        <div class="dlist">
            <div class="hd">
		<bu:func viewId="4462a502dcb84ece869bee66677baf77" />
            </div>
            <div class="bd">
  ...
  <table class="search_table">
      <bu:search deal_mark="1" viewId="4462a502dcb84ece869bee66677baf77" /> 
		...
		<input type="hidden" name="formPagee421ae7fd0714683b9c83928f7a272be" id="formPagee421ae7fd0714683b9c83928f7a272be" value="${formPagee421ae7fd0714683b9c83928f7a272be}"/>
		<input type="hidden" name="formId" id="formId1" value='e421ae7fd0714683b9c83928f7a272be'/>
		<input type="hidden" id="subRelColIds" name="subRelColIds" value='null'/>
		<input type="hidden" id="subFormIds" name="subFormIds" value='null'/>
		<div class="panel-ajax datagrid datagrid-div1"  id="e421ae7fd0714683b9c83928f7a272be">
		<div class="datagrid-div2 datagrid-div6 datagrid-view-ajax" id="datagrid-view-ajaxe421ae7fd0714683b9c83928f7a272be" style="">
		<div class="datagrid-header">
		<div class="datagrid-header-inner" id="datagrid-header-innere421ae7fd0714683b9c83928f7a272be">
		<bu:table cssClass="datagrid-htable fixedTable datagrid-div6 datagrid-htable-kz" id="datagrid-htablee421ae7fd0714683b9c83928f7a272be">
		<s:set name="_$type" value="'view'" />
		<tbody class="isParentsTitle">
		<bu:tr cssClass="datagrid-header-row datagrid-title-ajax" id="datagrid-title-ajax">
			<td class="datagrid-cell" name="noprintset_SEQ" style="width:30px; text-align:center;" ><bu:thSeq  formId="e421ae7fd0714683b9c83928f7a272be" i18n="1"/></td>
			<td class="datagrid-cell no-print" style="width:30px; text-align:center"><span><input type="checkbox" id="selectAll_e421ae7fd0714683b9c83928f7a272be" onclick="_selectAjaxTableAllData(this,'e421ae7fd0714683b9c83928f7a272be')" style="cursor: pointer;"title="全选"/></span></td>
			<td name="noprintset_AGE" class="datagrid-cell"><bu:uitn colNo="AGE" formId="e421ae7fd0714683b9c83928f7a272be" /></td>
			<td name="noprintset_NAME" class="datagrid-cell"><bu:uitn colNo="NAME" formId="e421ae7fd0714683b9c83928f7a272be" /></td>
			<td name="noprintset_TIMES" class="datagrid-cell"><bu:uitn colNo="TIMES" formId="e421ae7fd0714683b9c83928f7a272be" /></td>
			<td name="noprintset_TIMEDATES" class="datagrid-cell"><bu:uitn colNo="TIMEDATES" formId="e421ae7fd0714683b9c83928f7a272be" /></td>
			<td name="noprintset_DAWENBEN" class="datagrid-cell"><bu:uitn colNo="DAWENBEN" formId="e421ae7fd0714683b9c83928f7a272be" /></td>
		</bu:tr>
		</tbody>
		</bu:table>
		</div>
		</div>
		<div class="datagrid-body datagrid-div3 datagrid-body-ajax" id="tableDive421ae7fd0714683b9c83928f7a272be" onscroll="ajaxTableScroll(this,'e421ae7fd0714683b9c83928f7a272be')">
		<table class="datagrid-btable fixedTable dblClick"  id="datagrid-btable-ajaxe421ae7fd0714683b9c83928f7a272be">
		<tbody id="tbody_e421ae7fd0714683b9c83928f7a272be" class="isParents">
		</tbody>
		</table>		</div>
		</div>
		</div>
		<c:if test="${formPagee421ae7fd0714683b9c83928f7a272be==1}">			<div class="center">
			<s:include value="/plf/page/fp/paginationPopMultAx.jsp?listDataFn=listAjaxTable&formId=e421ae7fd0714683b9c83928f7a272be&showLoading=0" />
			</div>
		</c:if>
 ...
 <button type="button" onclick="printset_17('e421ae7fd0714683b9c83928f7a272be','1');">打印</button>
 </div>
 </div>
 ...
 <tr>
 <td style="width: 100px;text-align: right;"><span>?时间日期</span></td>
 <td style="padding-left: 5px;">
 <input type="checkbox" name="TIMEDATES" value="1" checked="checked" />
 </td>
 <td style="padding-left: 5px;">
 <input type="text" name="TIMEDATES" value="" title_name="?时间日期" />px
 </td>
 </tr>
 <tr>
 ...
 <input type="text" name="DAWENBEN" value="" title_name="大文本" />px
		...
		<bu:submit viewId="4462a502dcb84ece869bee66677baf77" />
      <jsp:include page="/plf/page/mesdemo/commCode/commCode.jsp">
           <jsp:param name="modelName" value="VIEW_TYPE_17" />
           <jsp:param name="location" value="beforeJsLoad" />
      </jsp:include>
		<bu:script viewId="4462a502dcb84ece869bee66677baf77" />
...
function createTableModel(ms,formId){
    ...
    if(formId=='e421ae7fd0714683b9c83928f7a272be'){<%--st1081--%>
