...
<body>
    <div class="content-in">
		...
		<bu:table cssClass="datagrid-htable fixedTable datagrid-div6 datagrid-htable-kz" id="datagrid-htablee6226ab6caf14e5db2e7d9d5537bab41" style="min-width:2800px;">
		...
		<bu:tr cssClass="datagrid-header-row datagrid-title-ajax" id="datagrid-title-ajax">
			...
			<td name="noprintset_PSI_SN" class="datagrid-cell"><bu:uitn colNo="PSI_SN" formId="e6226ab6caf14e5db2e7d9d5537bab41" /></td>
			<td name="noprintset_PSI_TAKEPLACE" class="datagrid-cell"><bu:uitn colNo="PSI_TAKEPLACE" formId="e6226ab6caf14e5db2e7d9d5537bab41" /></td>
			<td name="noprintset_PSI_MO_NUMBER" class="datagrid-cell"><bu:uitn colNo="PSI_MO_NUMBER" formId="e6226ab6caf14e5db2e7d9d5537bab41" /></td>
			<td name="noprintset_PSI_CONTAINER_SN" class="datagrid-cell"><bu:uitn colNo="PSI_CONTAINER_SN" formId="e6226ab6caf14e5db2e7d9d5537bab41" /></td>
			<td name="noprintset_PSI_PROJECT_ID" class="datagrid-cell"><bu:uitn colNo="PSI_PROJECT_ID" formId="e6226ab6caf14e5db2e7d9d5537bab41" /></td>
			<td name="noprintset_PSI_MODEL_CODE" class="datagrid-cell"><bu:uitn colNo="PSI_MODEL_CODE" formId="e6226ab6caf14e5db2e7d9d5537bab41" /></td>
			<td name="noprintset_CI_ITEM_NAME" class="datagrid-cell"><bu:uitn colNo="CI_ITEM_NAME" formId="e6226ab6caf14e5db2e7d9d5537bab41" /></td>
		<!--	<td name="noprintset_CI_ITEM_SPEC" class="datagrid-cell"><bu:uitn colNo="CI_ITEM_SPEC" formId="e6226ab6caf14e5db2e7d9d5537bab41" /></td>  -->
			<td name="noprintset_PSI_AREA_SN" class="datagrid-cell"><bu:uitn colNo="PSI_AREA_SN" formId="e6226ab6caf14e5db2e7d9d5537bab41" /></td>
			<td name="noprintset_PSI_PRODUCT_STEP" class="datagrid-cell"><bu:uitn colNo="PSI_PRODUCT_STEP" formId="e6226ab6caf14e5db2e7d9d5537bab41" /></td>
			<td name="noprintset_PSI_WORK_STATION" class="datagrid-cell"><bu:uitn colNo="PSI_WORK_STATION" formId="e6226ab6caf14e5db2e7d9d5537bab41" /></td>
			<td name="noprintset_PSI_SN_NUM" class="datagrid-cell"><bu:uitn colNo="PSI_SN_NUM" formId="e6226ab6caf14e5db2e7d9d5537bab41" /></td>
		...
		<!--	<td name="noprintset_PSI_ACTUAL_WEIGHT" class="datagrid-cell"><bu:uitn colNo="PSI_ACTUAL_WEIGHT" formId="e6226ab6caf14e5db2e7d9d5537bab41" /></td> -->
			<td name="noprintset_PSI_INSPECT_SN" class="datagrid-cell"><bu:uitn colNo="PSI_INSPECT_SN" formId="e6226ab6caf14e5db2e7d9d5537bab41" /></td>
			<td name="noprintset_PSI_TIME" class="datagrid-cell"><bu:uitn colNo="PSI_TIME" formId="e6226ab6caf14e5db2e7d9d5537bab41" /></td>
			<td name="noprintset_PSI_EMP" class="datagrid-cell"><bu:uitn colNo="PSI_EMP" formId="e6226ab6caf14e5db2e7d9d5537bab41" /></td>
			<td name="noprintset_PSI_PROCESS_FACE" class="datagrid-cell"><bu:uitn colNo="PSI_PROCESS_FACE" formId="e6226ab6caf14e5db2e7d9d5537bab41" /></td>
			<td name="noprintset_PSI_LOT" class="datagrid-cell"><bu:uitn colNo="PSI_LOT" formId="e6226ab6caf14e5db2e7d9d5537bab41" /></td>
		...
		<table class="datagrid-btable fixedTable dblClick"  id="datagrid-btable-ajaxe6226ab6caf14e5db2e7d9d5537bab41" style="min-width:2800px;">
...
function createTableModel(ms,formId){
    ...
    if(formId=='e6226ab6caf14e5db2e7d9d5537bab41'){<%--FM-产品包装信息--%>
        $.each(uiTxt,function(i,v){
            ...
            arrHtml.push("</td>");
            arrHtml.push("<td colno='PSI_SN' name='noprintset_PSI_SN' class='datagrid-cell "+ms.tdClass(formId, 'PSI_SN')+"' style='"+ms.tdStyle(formId, 'PSI_SN')+"' "+ms.tdEvent(formId, 'PSI_SN')+">")
            arrHtml.push("<span colno='PSI_SN' class='"+ms.uiClass(formId, 'PSI_SN')+"' style='"+ms.uiStyle(formId, 'PSI_SN')+"' "+ms.uiEvent(formId, 'PSI_SN')+" title='"+ms.titleAttr(formId,'PSI_SN','IS_TITLE_ATTR',v)+"' >"+v['PSI_SN']+"</span>")
            arrHtml.push("</td>");
            arrHtml.push("<td colno='PSI_TAKEPLACE' name='noprintset_PSI_TAKEPLACE' class='datagrid-cell "+ms.tdClass(formId, 'PSI_TAKEPLACE')+"' style='"+ms.tdStyle(formId, 'PSI_TAKEPLACE')+"' "+ms.tdEvent(formId, 'PSI_TAKEPLACE')+">")
            ...
            arrHtml.push("</td>");
            arrHtml.push("<td colno='PSI_MO_NUMBER' name='noprintset_PSI_MO_NUMBER' class='datagrid-cell "+ms.tdClass(formId, 'PSI_MO_NUMBER')+"' style='"+ms.tdStyle(formId, 'PSI_MO_NUMBER')+"' "+ms.tdEvent(formId, 'PSI_MO_NUMBER')+">")
            arrHtml.push("<span colno='PSI_MO_NUMBER' class='"+ms.uiClass(formId, 'PSI_MO_NUMBER')+"' style='"+ms.uiStyle(formId, 'PSI_MO_NUMBER')+"' "+ms.uiEvent(formId, 'PSI_MO_NUMBER')+" title='"+ms.titleAttr(formId,'PSI_MO_NUMBER','IS_TITLE_ATTR',v)+"' >"+v['PSI_MO_NUMBER']+"</span>")
            arrHtml.push("</td>");
              arrHtml.push("<td colno='PSI_CONTAINER_SN' name='noprintset_PSI_CONTAINER_SN' class='datagrid-cell "+ms.tdClass(formId, 'PSI_CONTAINER_SN')+"' style='"+ms.tdStyle(formId, 'PSI_CONTAINER_SN')+"' "+ms.tdEvent(formId, 'PSI_CONTAINER_SN')+">")
            ...
            arrHtml.push("</td>");
            arrHtml.push("<td colno='PSI_PROJECT_ID' name='noprintset_PSI_PROJECT_ID' class='datagrid-cell "+ms.tdClass(formId, 'PSI_PROJECT_ID')+"' style='"+ms.tdStyle(formId, 'PSI_PROJECT_ID')+"' "+ms.tdEvent(formId, 'PSI_PROJECT_ID')+">")
            arrHtml.push("<span colno='PSI_PROJECT_ID' class='"+ms.uiClass(formId, 'PSI_PROJECT_ID')+"' style='"+ms.uiStyle(formId, 'PSI_PROJECT_ID')+"' "+ms.uiEvent(formId, 'PSI_PROJECT_ID')+" title='"+ms.titleAttr(formId,'PSI_PROJECT_ID','IS_TITLE_ATTR',v)+"' >"+v['PSI_PROJECT_ID']+"</span>")
            arrHtml.push("</td>");
            arrHtml.push("<td colno='PSI_MODEL_CODE' name='noprintset_PSI_MODEL_CODE' class='datagrid-cell "+ms.tdClass(formId, 'PSI_MODEL_CODE')+"' style='"+ms.tdStyle(formId, 'PSI_MODEL_CODE')+"' "+ms.tdEvent(formId, 'PSI_MODEL_CODE')+">")
            arrHtml.push("<span colno='PSI_MODEL_CODE' class='"+ms.uiClass(formId, 'PSI_MODEL_CODE')+"' style='"+ms.uiStyle(formId, 'PSI_MODEL_CODE')+"' "+ms.uiEvent(formId, 'PSI_MODEL_CODE')+" title='"+ms.titleAttr(formId,'PSI_MODEL_CODE','IS_TITLE_ATTR',v)+"' >"+v['PSI_MODEL_CODE']+"</span>")
            arrHtml.push("</td>");
           ...
           // arrHtml.push("</td>");
            arrHtml.push("<td colno='PSI_AREA_SN' name='noprintset_PSI_AREA_SN' class='datagrid-cell "+ms.tdClass(formId, 'PSI_AREA_SN')+"' style='"+ms.tdStyle(formId, 'PSI_AREA_SN')+"' "+ms.tdEvent(formId, 'PSI_AREA_SN')+">")
            ...
            arrHtml.push("</td>");
            arrHtml.push("<td colno='PSI_PRODUCT_STEP' name='noprintset_PSI_PRODUCT_STEP' class='datagrid-cell "+ms.tdClass(formId, 'PSI_PRODUCT_STEP')+"' style='"+ms.tdStyle(formId, 'PSI_PRODUCT_STEP')+"' "+ms.tdEvent(formId, 'PSI_PRODUCT_STEP')+">")
            ...
            arrHtml.push("</td>");
            arrHtml.push("<td colno='PSI_WORK_STATION' name='noprintset_PSI_WORK_STATION' class='datagrid-cell "+ms.tdClass(formId, 'PSI_WORK_STATION')+"' style='"+ms.tdStyle(formId, 'PSI_WORK_STATION')+"' "+ms.tdEvent(formId, 'PSI_WORK_STATION')+">")
            ...
            arrHtml.push("</td>");
            arrHtml.push("<td colno='PSI_SN_NUM' name='noprintset_PSI_SN_NUM' class='datagrid-cell "+ms.tdClass(formId, 'PSI_SN_NUM')+"' style='"+ms.tdStyle(formId, 'PSI_SN_NUM')+"' "+ms.tdEvent(formId, 'PSI_SN_NUM')+">")
           ...
           // arrHtml.push("</td>");
            arrHtml.push("<td colno='PSI_INSPECT_SN' name='noprintset_PSI_INSPECT_SN' class='datagrid-cell "+ms.tdClass(formId, 'PSI_INSPECT_SN')+"' style='"+ms.tdStyle(formId, 'PSI_INSPECT_SN')+"' "+ms.tdEvent(formId, 'PSI_INSPECT_SN')+">")
            ...
            arrHtml.push("</td>");
            arrHtml.push("<td colno='PSI_TIME' name='noprintset_PSI_TIME' class='datagrid-cell "+ms.tdClass(formId, 'PSI_TIME')+"' style='"+ms.tdStyle(formId, 'PSI_TIME')+"' "+ms.tdEvent(formId, 'PSI_TIME')+">")
            ...
            arrHtml.push("</td>");
            arrHtml.push("<td colno='PSI_EMP' name='noprintset_PSI_EMP' class='datagrid-cell "+ms.tdClass(formId, 'PSI_EMP')+"' style='"+ms.tdStyle(formId, 'PSI_EMP')+"' "+ms.tdEvent(formId, 'PSI_EMP')+">")
            ...
            arrHtml.push("</td>");
            arrHtml.push("<td colno='PSI_PROCESS_FACE' name='noprintset_PSI_PROCESS_FACE' class='datagrid-cell "+ms.tdClass(formId, 'PSI_PROCESS_FACE')+"' style='"+ms.tdStyle(formId, 'PSI_PROCESS_FACE')+"' "+ms.tdEvent(formId, 'PSI_PROCESS_FACE')+">")
            ...
            arrHtml.push("</td>");
            arrHtml.push("<td colno='PSI_LOT' name='noprintset_PSI_LOT' class='datagrid-cell "+ms.tdClass(formId, 'PSI_LOT')+"' style='"+ms.tdStyle(formId, 'PSI_LOT')+"' "+ms.tdEvent(formId, 'PSI_LOT')+">")
