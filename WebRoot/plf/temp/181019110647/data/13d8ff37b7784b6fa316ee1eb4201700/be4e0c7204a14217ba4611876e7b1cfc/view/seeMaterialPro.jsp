				...
				<div class="panel datagrid datagrid-div1">
					<div class="datagrid-div2 datagrid-div6 datagrid-view"  id="datagrid-view">
						...
						<div class="datagrid-body datagrid-div3 scroll11"   style="height:380px;">
							<table class="dlist-table table-line" style="width:100%;table-layout:fixed;"  id="itemInfo" >
					...
					<div class="datagrid-div2 datagrid-div6 datagrid-view"  id="datagrid-view">
						<div class="datagrid-header" style="width:100%;">
							<div class="datagrid-header-inner head2" style="width:100%;" id="datagrid-header-inner1">
								<table  class="datagrid-htable fixedTable  " id="datagrid-htable" style="width:1300px;">
									<tbody>
									<tr class="datagrid-header-row datagrid-title-ajax">
										<td class="datagrid-cell" style="width:30px;"></td>
										<td class="datagrid-cell" style="width:30px;">
						...
						<div class="datagrid-body datagrid-div3 scroll2"   style="height:380px;">
							<table class="dlist-table table-line" style="width:1300px;table-layout:fixed;"  id="GetEsop" >
								<tbody id="addGetEsop" >
								</tbody>
							</table>
						</div>
                    ...
                    if(null!=data.ajaxString){
                     ...
                     if(null!=data.ajaxList){
                        ...
                        for(var i=0;i<rccList.length;i++){
							...
							$("#itemInfo tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:150px;text-align: center;'>"+rccList[i].CTM_MODEL_CODE+"<input type='hidden' class='CI_ITEM_CODE' name='CI_ITEM_CODE' value='"+rccList[i].CTM_MODEL_CODE+"'/></td>");
    ...
    function GetEsop(){
         ...
         var succe;
            ...
            $.ajax({
                type:"post",
                dataType:"json",
                data:"ctId="+ctId+"&step="+step+"&face="+face,
                url:loadItemUrl,
                success:function(data){
                    if(null==data){
                        return;
                    ...
                    var tableTrJs = $("#GetEsop tbody tr");
					_tongLineColor(tableTrJs);
					clickTr('GetEsop');
