...
<body>
 ...
 <input type="text" name="TAM_PHOTO_PATH2" value="" title_name="?选中图片路径" />px
  ...
  <!-- 新增div -->
    ...
    <div class="dialog dialog-s1" id="addItem" style="display:none;z-index:11112;margin-left:0px;left:calc(50% - 250px);top:calc(50% - 182.5px);width:500px;height:365px;" >
		<div class="dialog-hd">
		...
		<div class="optn optn_div hd" style="height: 40px;box-sizing: border-box;margin-bottom: 0;">	
            <div style="margin-left:10px;">
                <div class="save-close" id="savelose" <dict:lang value = "关闭保存并关闭窗口" /> onclick="saveClose(this)"></div>
 ...
 <!--修改div-->
   ...
   <!-- 修改div -->		
		...
		<div class="dialog dialog-s1" id="addItems" style="display:none;z-index:11112;margin-left:0px;left:calc(50% - 250px);top:calc(50% - 182.5px);top:5px;width:500px;height:365px;" >
		 <div class="dialog-hd">
 ...
 <!--查看div-->
     ...
     <div id="backItemd" class="dialog-mask" style="z-index:11111;"/></div>
		...
		<div class="dialog dialog-s1" id="addItemd" style="display:none;z-index:11112;margin-left:0px;left:calc(50% - 250px);top:calc(50% - 182.5px);top:5px;width:500px;height:365px;" >
		 <div class="dialog-hd">
