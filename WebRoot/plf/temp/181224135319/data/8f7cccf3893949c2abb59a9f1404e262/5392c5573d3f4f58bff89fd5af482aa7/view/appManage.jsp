...
<body>
    <div class="content-in">
		...
		<bu:tr cssClass="datagrid-header-row datagrid-title-ajax" id="datagrid-title-ajax">
			...
			<td class="datagrid-cell" style="width:100px;"><bu:uitn colNo="TAS_MENU_ID" formId="cde7667fb3bc47d1b64355437e9de4ef" /></td>
			...
			<td class="datagrid-cell"  style="width:100px;"><bu:uitn colNo="TAS_MOUDLE_ID" formId="cde7667fb3bc47d1b64355437e9de4ef" /></td>
			<td class="datagrid-cell"  style="width:100px;"><bu:uitn colNo="TAS_SHOW_TYPE" formId="cde7667fb3bc47d1b64355437e9de4ef" /></td>
			<td class="datagrid-cell"  style="width:100px;"><bu:uitn colNo="TAS_FUN_NAME" formId="cde7667fb3bc47d1b64355437e9de4ef" /></td>
			<td class="datagrid-cell"  style="width:100px;"><dict:lang value="数据" /></td>
			<td class="datagrid-cell"  style="width:100px;"><dict:lang value="图片" /></td>
		<!--	<td class="datagrid-cell"  style="width:100px;"><bu:uitn colNo="TAS_IS_DEFAULT" formId="cde7667fb3bc47d1b64355437e9de4ef" /></td> -->
			<td class="datagrid-cell"  style="width:100px;"><bu:uitn colNo="TAS_SEQ" formId="cde7667fb3bc47d1b64355437e9de4ef" /></td>
		...
		<!--	<td class="datagrid-cell"  style="width:30px;"><bu:uitn colNo="TAS_DISPLAY_MODE" formId="cde7667fb3bc47d1b64355437e9de4ef" /></td> -->
			<td class="datagrid-cell"  style="width:100px;"><bu:uitn colNo="TAS_FUNCTION_LINK" formId="cde7667fb3bc47d1b64355437e9de4ef" /></td>
...
function setAselect1(obj){
    ...
    //var intid2 = sid.replace("smenu","intmenu");
    	...
    	$.ajax({
				type: "POST",
			    dataType: "json",
			    url: "buss/bussModel_exeFunc.ms?funcMId=768bf678b60741fc848016809538f0e0",
			    data: {
			    	"selectType" : "1"
			    },
						    ...
						    //	var isStatusSel = "<select id='isStatus"+(i+1)+"' name='isStatus' class=' input isSubmit 'style=' cursor: pointer;width:100%;height:100%;border:0;background-color:transparent;' onchange='setModify(this);'>"+ isCheckOption +"</select>";
						     ...
						     //	if(rccList[i].TAS_UNIT==null) rccList[i].TAS_UNIT=""; 
								...
								if(rccList[i].TAS_DATA_CONTENT!=null){
								    console.log(i);
								    console.log(rccList[i].TAS_DATA_CONTENT);
							    ...
							    arrHtml.push("<input type='text' id='funName"+(i+1)+"' name='funName_1' maxlength='50' value='"+rccList[i].TAS_FUN_NAME+"' onchange='setModify(this);' style='width: 100%;text-align:center;border:0px;background-color:transparent;'/>");
							    arrHtml.push("</td>");
							    ...
							    if(rccList[i].TAS_PIC_PATH!=null){
    							    ...
    							    arrHtml.push("<input type='hidden' id='PIC_ID"+(i+1)+"' name='picId'  class='isSubmit'/><div class='small_button'></div>");
    							    arrHtml.push("</td>");
							    }else{
							         arrHtml.push("<td class='datagrid-cell ' style='width:100px; text-align:center;'>");
							   ...
							   // arrHtml.push("</td>");
							    arrHtml.push("<td class='datagrid-cell ' style='width:100px; text-align:center;padding:0;'>");
							    arrHtml.push("<input type='text' id='showSeq"+(i+1)+"' name='showSeq' maxlength='5' value='"+rccList[i].TAS_SEQ+"' style='width: 100%;text-align:center;border:0px;background-color:transparent;' onchange='setModify(this);' onkeyup=\"this.value=this.value.replace(/[^0-9]/gi,'')\"/>");
							    arrHtml.push("</td>");
							   // arrHtml.push("<td class='datagrid-cell ' style='width:100px; text-align:center;padding:0;'>");
...
function addMyRow(){
   ...
   //var arrHtml = [];
    ...
    arrHtml.push("<td class='datagrid-cell ' style='width:100px; text-align:center;'>");
    arrHtml.push("<input type='text' id='funName"+(row_count+1)+"' name='funName_1' maxlength='50' style='width: 100%;text-align:center;border:0px;background-color:transparent;'/>");
    arrHtml.push("</td>");
    arrHtml.push("<td class='_data' style='width:100px; text-align:center;'>");
   ...
   // arrHtml.push("</td>");
    arrHtml.push("<td class='datagrid-cell ' style='width:100px; text-align:center;padding:0;'>");
    arrHtml.push("<input type='text' id='showSeq"+(row_count+1)+"' name='showSeq' maxlength='5' style='width: 100%;text-align:center;border:0px;background-color:transparent;' onkeyup=\"this.value=this.value.replace(/[^0-9]/gi,'')\"/>");
    arrHtml.push("</td>");
 //   arrHtml.push("<td class='datagrid-cell ' style='width:100px; text-align:center;padding:0;'>");
  //  arrHtml.push(isStatusSel);
  //  arrHtml.push("</td>");
...
function setPic(thisObj){
		...
		console.log("val:"+picUrlId);
        console.log(picIdId);
        console.log(picIdValue);
