...
<html>
  ...
  <body>
    <table width="100%">
      <tr>
        <td align="left"><img src="axis2-web/images/asf-logo.gif?_mc_res_version=<%=PlfStaticRes.ASF_LOGO_GIF %>" alt=""/></td>
        <td align="right"><img src="axis2-web/images/axis_l.jpg?_mc_res_version=<%=PlfStaticRes.AXIS_L_JPG %>" alt=""/></td>
      </tr>
    </table>
    <table width="100%">
      <tr>
