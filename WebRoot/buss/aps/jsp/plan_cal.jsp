                                ...
                                <div class="headTable">
                                    <table>
                                        <tr>
                                            ...
                                            <td style="width:30px; text-align:center;"><input id="allchecked" type="checkbox" onclick="selectAll()"></td>
...
<script>
    ...
    function beforeDel(){
        ...
        utilsFp.confirmIcon(4,"","deleteCal","", "<dict:lang value='是否确定删除？' />",1,"300","");
    }
    //删除
    function deleteCal(){
        ...
        $.ajax({
            ...
            data:data,
            success:function(data){
                showMessage(2,"删除成功！",true);
                //刷新界面数据
                query("formId1");
            },
            error:function(msg){
                showMessage(3,"删除失败！",true);
            }
        });
    }
    //绘制时段头
    function loadExceptionHead(year,month,data){
        ...
        while(num<=days){
            ...
            for(var i=0;i<colspan;i++){
                ...
                $("#rigthHeadMiddle").append("<td style='width:"+defaultwidth+"px;'><dict:lang value='"+week[dayindex]+"'/></td>");
                //绘制数据内容
    ...
    function showMessage(type,msg,islan){
        if(islan){
            utilsFp.confirmIcon(type,"","","", "<dict:lang value='"+msg+"' />",0,"300","");
        }
        else {
            utilsFp.confirmIcon(type,"","","", msg,0,"300","");
        }
    }
    //显示进度条
