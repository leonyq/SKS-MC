...
<body scroll="auto" >
								...
								<tr>
									<td width="100%" align="right">
										<button type="button" value=""
											onclick="backFill('${paraMap.popId}pop','${paraMap.popId}shadow');" sytle=""
											class="botton_img_add">
											<i class="ico ico-kl "></i>
											<dict:lang value="提交" />
										</button>
										<button type="button" value=""
											onclick="clearSel('${paraMap.popId}pop','${paraMap.popId}shadow');" sytle=""
											class="botton_img_add">
										...
										<button class="botton_img_add" onclick="searchOpen();">
    ...
    <script type="text/javascript">
		...
		if(top.$("#"+window.frameElement.name)[0] != null)
		{
       	...
       	// 回填值 
    	function backFill(popId,shadow){
    	...
    	function getDataTable(paginationImpl){
    	 ...
    	 var pageRecord =  isFirstLoad? 10 : _GLO_FORM_PAGE_MAP[paginationImpl].pageRecord;
    	...
    	function createTableModel(tableData,hiddenCol){
    		...
    		if(!$.isEmptyObject(tableData)){
    			$.each(tableData,function(i,v){
    				...
    				arr.push("</td>");
    				arr.push("<td class=\"datagrid-cell\" width=\"10%\">"+count+"</td>");
    				for(var key in v){
    					if(hiddenCol.length>0){
    						var flag = true;
    						hiddenCol.forEach(function(i){
    				...
    				arr.push("<td class=\"datagrid-cell\" hidden=\"hidden\">"+JSON.stringify(v)+"</td>");
    				arr.push("</tr>");
    				count++;
    			});
    		}
