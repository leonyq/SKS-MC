...
<body style="background-color:#fff;overflow:hidden;">
                      ...
                      <div class="search-box">
                    	<form id="searchForm" name="searchForm" action="" method="post">
							...
							<table class="search_table">
								...
								<tr> 
									<td><div class="group"  style="width:300px;"><div class="name" title="等于"><dict:lang value="工艺代码" /></div><div class="dec"  style="width:200px;"><input class="input inputsd" id="ctId" name="paraMap2.ctId" style="width:200px;"></div></div></td>
									<td><div class="group"  style="width:300px;"><div class="name" title="等于"><dict:lang value="工艺名称" /></div><div class="dec"  style="width:200px;"><input class="input inputsd" id="ctName" name="paraMap2.ctName"  style="width:200px;"></div></div></td>
								</tr>
								</tbody>
							</table>
						</form>
					  ...
					  <div class="datagrid-div2 datagrid-div6 datagrid-view" id="datagrid-view" style="">
					  	<div class="datagrid-header">
					  		<div class="datagrid-header-inner" id="datagrid-header-inner831b2dbf0dfb494695b7ce66538a1234">
								<table  id="datagrid-htable831b2dbf0dfb494695b7ce66538a1234" class="datagrid-htable fixedTable  " style="height: 25px; ">
									<tbody id="title-tbody"></tbody>
								  </table>
								</div>
							</div>
							<div class="datagrid-body datagrid-div3 datagrid-body-ajax" id="tableDiv831b2dbf0dfb494695b7ce66538a1234"  style="height:328px;overflow-x: hidden;">
								<table class=" fixedTable" id="datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a1234">
    ...
    <script type="text/javascript">
    	...
    	function backFill(popId,shadow,thisId){
    		...
    		parentWindow.backFillTechnicsVal(trObj,thisId);
    		parent.closePopWinFp(popId,shadow);
    	}
       	
       	// 清空值
    	function clearSel(pop,shadow,thisId){
    		parentWindow.clearTechnicsVal(thisId);
