...
<body style="background-color:#fff;overflow:hidden;">
          <div class="content-in">
              <div class="dlist">
              <div class="hd" style="margin: 0;background-color: #f6f5f7;padding-bottom: 6px;">
				<div>
                      ...
                      <div class="search-box">
                    	<form id="searchForm" name="searchForm" action="" method="post">
							...
							<table class="search_table">
								...
								<tr><td><div class="group"  style="width:350px;"><div class="name" title="等于">员工编号</div><div class="dec"><input class="input inputsd" style="width:200px;" id="projectUserId" name="paraMap2.userid"></div></div></td>
								<td><div class="group"  style="width:350px;margin-left: -55px;"><div class="name" title="等于">员工名称</div><div class="dec"><input class="input inputsd" style="width:200px;" id="projectName" name="paraMap2.name"></div></div></td>
								</tr>
            		...
            		<div class="panel datagrid datagrid-div1">
					  <div class="datagrid-div2 datagrid-div6 datagrid-view" id="datagrid-view" style="">
					  	<div class="datagrid-header">
							...
							<div class="datagrid-body datagrid-div3 datagrid-body-ajax" id="tableDiv123456"  style="height:326px;overflow-x: hidden;">
    ...
    <script type="text/javascript">
    	...
    	function backFill(popId,shadow,thisId){
    		...
    		parentWindow.backFillUserVal(trObj,thisId);
    	...
    	function clearSel(pop,shadow,thisId){
    		parentWindow.clearUserVal(thisId);
    		...
    		if(!$.isEmptyObject(titleData)){
    			...
    			for(var key in titleData){
    				...
    				if(hiddenCol.length>0){
    					...
    					if(flag==true){
    						arr.push("<td style='width:206px;' colName="+key+">");
            				arr.push(titleData[key]);
            				arr.push("</td>");
						}
    				}else{
    			...
    			$.each(tableData,function(i,v){
    				...
    				for(var key in v){
    					...
    					if(hiddenCol.length>0){
    						...
    						if(flag==true){
    							arr.push("<td colName="+key+" style='width:206px;' class=\"datagrid-cell\" align=\"center\">");
    	            			arr.push(v[key]);
    	            			arr.push("</td>");
    						}
    					}else{
