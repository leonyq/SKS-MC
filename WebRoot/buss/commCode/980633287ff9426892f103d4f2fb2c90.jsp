                      ...
                      <div class="search-box">
                    	<form id="searchForm" name="searchForm" action="" method="post">
							...
							<table class="search_table">
								...
								<tr> 
									<td><div class="group"  style="width:300px;"><div class="name" title="等于"><dict:lang value="物料料号" /></div><div class="dec"  style="width:200px;"><input class="input inputsd" id="ciItemCode" name="paraMap2.ciItemCode" style="width:200px;"></div></div></td>
									<td><div class="group"  style="width:300px;"><div class="name" title="等于"><dict:lang value="物料名称" /></div><div class="dec"  style="width:200px;"><input class="input inputsd" id="ciItemName" name="paraMap2.ciItemName"  style="width:200px;"></div></div></td>
								</tr>
								<tr><td><div class="group"  style="width:300px;"><div class="name" title="等于"><dict:lang value="物料规格" /></div><div class="dec"  style="width:200px;"><input class="input inputsd" id="ciItemSpec" name="paraMap2.ciItemSpec" style="width:200px;"></div></div></td></tr>
