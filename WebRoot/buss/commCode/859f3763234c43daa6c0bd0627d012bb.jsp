...
<body scroll="auto" style="background-color:#fff;">
                      ...
                      <div class="search-box">
                    	<form id="searchForm" name="searchForm" action="" method="post">
							...
							<table class="search_table">
								...
								<tr> 
									<td><div class="group"  style="width:300px;"><div class="name" title="等于"><dict:lang value="工单号" /></div><div class="dec"  style="width:200px;"><input class="input inputsd" id="productId" name="paraMap2.productId" style="width:200px;"></div></div></td>
								</tr>
								</tbody>
							</table>
						</form>
            		...
            		<div class="panel datagrid datagrid-div1">
					  <div class="datagrid-div2 datagrid-div6 datagrid-view" id="datagrid-view" style="">
					  	<div class="datagrid-header">
							...
							<div class="datagrid-body datagrid-div3 datagrid-body-ajax" id="tableDiv123456" style="height:331px;overflow-x: hidden;">
    ...
    <script type="text/javascript">
    	...
    	function backFill(popId,shadow,thisId){
    		...
    		parentWindow.backFillProductVal(trObj,thisId);
    		parent.closePopWinFp(popId,shadow);
    	}
       	
       	// 清空值
    	function clearSel(pop,shadow,thisId){
    		parentWindow.clearProductVal(thisId);
    		...
    		if(!$.isEmptyObject(titleData)){
    			...
    			for(var key in titleData){
    				if(hiddenCol.length>0){
    					...
    					if(flag==true){
    						arr.push("<td style='width:103px;' colName="+key+">");
            				arr.push(titleData[key]);
            				arr.push("</td>");
						}
    				}else{
    			...
    			$.each(tableData,function(i,v){
    				...
    				for(var key in v){
    					if(hiddenCol.length>0){
    						...
    						if(flag==true){
    							arr.push("<td colName="+key+" style='width:103px;' class=\"datagrid-cell\" align=\"center\">");
    	            			arr.push(v[key]);
    	            			arr.push("</td>");
    						}
    					}else{
