...
<body style="background-color:#fff;overflow:hidden;">
          <div class="content-in">
              <div class="dlist">
              <div class="hd" style="background-color: #f6f5f7;padding-top:5px;padding-bottom: 10px;margin: 0;">
				<div>
                      ...
                      <div class="search-box">
                    	<form id="searchForm" name="searchForm" action="" method="post">
							...
							<table class="search_table">
								...
								<tr> 
									<td><div class="group"  style="width:300px;"><div class="name" title="等于"><dict:lang value="料号" /></div><div class="dec"  style="width:200px;"><input class="input inputsd" id="cbItemCode" name="paraMap2.cbItemCode" style="width:200px;"></div></div></td>
									<td><div class="group"  style="width:300px;"><div class="name" title="等于"><dict:lang value="机种名称" /></div><div class="dec"  style="width:200px;"><input class="input inputsd" id="cbItemName" name="paraMap2.cbItemName"  style="width:200px;"></div></div></td>
								</tr>
								<tr><td><div class="group"  style="width:300px;"><div class="name" title="等于"><dict:lang value="机种规格" /></div><div class="dec"  style="width:200px;"><input class="input inputsd" id="cbItemSpec" name="paraMap2.cbItemSpec" style="width:200px;"></div></div></td></tr>
            ...
            <form id="submitForm" name="submitForm" action="" method="post" target="submitFrame">
            		<div class="panel datagrid datagrid-div1" id="831b2dbf0dfb494695b7ce66538a1234">
					  <div class="datagrid-div2 datagrid-div6 datagrid-view" id="datagrid-view-ajax831b2dbf0dfb494695b7ce66538a1234" style="">
					  	<div class="datagrid-header">
					  		<div class="datagrid-header-inner " id="datagrid-header-inner831b2dbf0dfb494695b7ce66538a1234">
								<table  class="datagrid-htable fixedTable datagrid-div6 datagrid-htable-kz  " id="datagrid-htable831b2dbf0dfb494695b7ce66538a1234">
									<tbody id="title-tbody"></tbody>
								  </table>
								</div>
							</div>
							<div class="datagrid-body datagrid-div3  datagrid-body-ajax"  id="tableDiv831b2dbf0dfb494695b7ce66538a1234"   style="height:293px;overflow-x: hidden;">
								<table class="datagrid-btable fixedTable dblClick "  id="datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a1234" >
									<tbody id="tbody_831b2dbf0dfb494695b7ce66538a1234"></tbody>
								</table>
							</div>
						</div>
					</div>
				<div class="center"><c:choose>
    ...
    <script type="text/javascript">
    	...
    	function backFill(popId,shadow,thisId){
    		...
    		parentWindow.backFillBomVal(trObj,thisId);
    		parent.closePopWinFp(popId,shadow);
    	}
       	
       	// 清空值
    	function clearSel(pop,shadow,thisId){
    		parentWindow.clearBomVal(thisId);
    	...
    	function createTableTitleModel(titleData,hiddenCol){
    		if(!$.isEmptyObject(titleData)){
    			var arr = [];
    			arr.push("<tr class='datagrid-header-row thcolor'>");
    			...
    			for(var key in titleData){
    				if(hiddenCol.length>0){
    					...
    					if(flag==true){
    						arr.push("<td style='width:123px;'colName="+key+">");
            				arr.push(titleData[key]);
            				arr.push("</td>");
						}
    				}else{
    			...
    			arr.push("<td class=\"datagrid-cell\" style=\"display:none;\"></td>");
    			arr.push("</tr>");
    			$("#title-tbody").empty().append(arr.join(""));
    			_addDragTableEvent("831b2dbf0dfb494695b7ce66538a1234");
    		}
    	}
    	...
    	function createTableModel(tableData,hiddenCol,currentPage,pageRecord){
    			...
    			$.each(tableData,function(i,v){
    				...
    				for(var key in v){
    					if(hiddenCol.length>0){
    						...
    						if(flag==true){
    							arr.push("<td colName="+key+" style='width:123px;' class=\"datagrid-cell\" align=\"center\">");
    	            			arr.push(v[key]);
    	            			arr.push("</td>");
    						}
    					}else{
    		...
    		if(arr.length>0){
    			$("#tbody_831b2dbf0dfb494695b7ce66538a1234").empty().append(arr.join(""));
    		}else{
    			$("#tbody_831b2dbf0dfb494695b7ce66538a1234").empty();
    		}
    		if(trClass!=""){
    			$("input[name='selectValue']:checked").parents("tr").attr("class",trClass);
    		}
    		defTableWidthRewrite("831b2dbf0dfb494695b7ce66538a1234");
    		setScroll("831b2dbf0dfb494695b7ce66538a1234");
    	}
    	...
    	$(function(){
    		...
    		$("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a1234").width($("#tableDiv831b2dbf0dfb494695b7ce66538a1234").width());
    		$("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a1234 tr").live("click",function(){
   		     var _this = $(this);
