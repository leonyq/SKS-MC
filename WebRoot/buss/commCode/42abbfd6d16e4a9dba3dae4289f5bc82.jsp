...
<body style="background-color:#fff;overflow:hidden;">
                      ...
                      <div class="search-box">
                    	<form id="searchForm" name="searchForm" action="" method="post">
							...
							<table class="search_table">
								...
								<tr> 
									<td><div class="group"  style="width:300px;">
											<div class="name" title="等于"><dict:lang value="制令单号" /></div>
											<div class="dec"  style="width:200px;">
												<input class="input inputsd" id="pmMoNumber" name="paraMap2.pmMoNumber" style="width:200px;">
											</div>
											</div>
									</td>
								</tr>
					  ...
					  <div class="datagrid-div2 datagrid-div6 datagrid-view" id="datagrid-view" style="">
					  	<div class="datagrid-header">
					  		<div class="datagrid-header-inner" id="datagrid-header-inner831b2dbf0dfb494695b7ce66538a1234">
								<table  id="datagrid-htable831b2dbf0dfb494695b7ce66538a1234" class="datagrid-htable fixedTable datagrid-div6 datagrid-htable-k  " style="height: 25px; ">
									<tbody id="title-tbody"></tbody>
								  </table>
								</div>
							</div>
							<div class="datagrid-body datagrid-div3 datagrid-body-ajax" id="tableDiv831b2dbf0dfb494695b7ce66538a1234"  style="overflow-x: hidden;">
    ...
    <script type="text/javascript">
    	...
    	function backFill(popId,shadow,thisId){
    		...
    		parentWindow.backFillMoVal(trObj,thisId);
    		parent.closePopWinFp(popId,shadow);
    	}
       	
       	// 清空值
    	function clearSel(pop,shadow,thisId){
    		parentWindow.clearMoVal(thisId);
