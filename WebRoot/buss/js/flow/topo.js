...
var nodeAbaseLineX;//线体开始节点X轴	
var nodeAbaseLineY;//线体开始节点Y轴
var nodeZbaseLineX;//线体结束节点X轴
var nodeZbaseLineY;//线体结束节点Y
/**
 *功能:获取场景scene
 *  param:canvas（画布）
 */
function initCanvas(canvas,select,wheelZoom,alpha)
{
    ...
    this.addLineByJson=function(nodeA,nodeZ,lineJson){
    	return addLineF(nodeA,nodeZ,lineJson.text,lineJson.font,lineJson.fontColor,lineJson.lineWidth,lineJson.arrowsRadius,lineJson.strokeColor,lineJson.direction,lineJson.lineType,lineJson.uuid,lineJson.Uline,lineJson.groupLinkUUid,lineJson.middleNodeUUid);
    }
 ...
 */
function addNode(funcId,width,height,text,imgUrl, x, y,uuid,font,fontColor,startProcedure,endProcedure,processType,borderColor,nodeType,alarm,alarmColor,dragable,uuid,nodeRefer,treeNodeUUid,directionType,groupCode,sequence){
