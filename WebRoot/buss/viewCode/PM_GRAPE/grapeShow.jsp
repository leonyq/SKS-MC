...
<body>
	...
	<div class="hd1">
	    <span class="dot">*</span>组织机构：<input type="text" value="${param.dataAuthName}" style="width:200px;text-align:center;" disabled="disabled"/>
	</div>
	...
	<div class="bd">
		...
		<bu:set name="paraMapObj" value="${dataId}" formId="fb66f7fc8c2f4978a861483d64b52ed2" type="edit" />
		...
		<table style="width:340px;" class="basic-table">
			...
			<tr style="height: 50px;">
				...
				<bu:uitn colNo="LOGIN_NAME" formId="fb66f7fc8c2f4978a861483d64b52ed2" />
				</td>
				<bu:td cssClass="dec" colNo="LOGIN_NAME" formId="fb66f7fc8c2f4978a861483d64b52ed2">
					<bu:ui colNo="LOGIN_NAME" formId="fb66f7fc8c2f4978a861483d64b52ed2" dataId="${dataId}" readonly="readonly"  formIndex="1" style="width:280px;" /></bu:td>
			</tr>
			<tr style="height: 50px;">
				<td class="name" />
				<bu:uitn colNo="USER_NAME" formId="fb66f7fc8c2f4978a861483d64b52ed2" />
				</td>
				<bu:td cssClass="dec" colNo="USER_NAME" formId="fb66f7fc8c2f4978a861483d64b52ed2">
					<bu:ui colNo="USER_NAME" formId="fb66f7fc8c2f4978a861483d64b52ed2" readonly="readonly" dataId="${dataId}" formIndex="1" style="width:280px;" /></bu:td>
			</tr>
			<tr style="height: 50px;">
		...
		<tr style="display:none">
			<td class="name-three" /><bu:uitn colNo="DEPT_NAME" formId="fb66f7fc8c2f4978a861483d64b52ed2" /></td>
			<bu:td cssClass="dec-self" colNo="DEPT_NAME" formId="fb66f7fc8c2f4978a861483d64b52ed2" ><bu:ui readonly="readonly" colNo="DEPT_NAME" formId="fb66f7fc8c2f4978a861483d64b52ed2" dataId="${dataId}" formIndex="1" /></bu:td>
		</tr>
		<tr style="display:none">
			<td class="name-three" /><bu:uitn colNo="M_TOTAL_SCORE" formId="fb66f7fc8c2f4978a861483d64b52ed2" /></td>
			<bu:td cssClass="dec-self" colNo="M_TOTAL_SCORE" formId="fb66f7fc8c2f4978a861483d64b52ed2" ><bu:ui readonly="readonly" colNo="M_TOTAL_SCORE" formId="fb66f7fc8c2f4978a861483d64b52ed2" dataId="${dataId}" formIndex="1" /></bu:td>
		</tr>
		<tr style="display:none">
			<td class="name-three" /><bu:uitn colNo="ID" formId="fb66f7fc8c2f4978a861483d64b52ed2" /></td>
			<bu:td cssClass="dec-self" colNo="ID" formId="fb66f7fc8c2f4978a861483d64b52ed2" ><bu:ui colNo="ID" readonly="readonly" formId="fb66f7fc8c2f4978a861483d64b52ed2" dataId="${dataId}" formIndex="1" /></bu:td>
		</tr>
		<tr style="display:none">
			<td class="name-three" /><bu:uitn colNo="DEPT_ID" formId="fb66f7fc8c2f4978a861483d64b52ed2" /></td>
			<bu:td cssClass="dec-self" colNo="DEPT_ID" formId="fb66f7fc8c2f4978a861483d64b52ed2" ><bu:ui readonly="readonly" colNo="DEPT_ID" formId="fb66f7fc8c2f4978a861483d64b52ed2" dataId="${dataId}" formIndex="1" /></bu:td>
		</tr>
	</table>
...
<script>
  	/*定义必要的全局变量*/
	 user_id =$('#paraMapObj_ID').val();
	dept_id = $('#paraMapObj_DEPT_ID').val();
...
*/
			...
			success: function(data) {
				...
				for(var i = 0; i < data.ajaxPage.dataList.length; i++) {
					...
					$("#mmz_tbody001").append('<tr id="123" style="">' +
						...
						'<td class="dec" style="width:50px;overflow: hidden; text-overflow:ellipsis;"  ><input  placeholder="<=' + data.ajaxPage.dataList[i].ITEM_SCORE + '" onchange="rule1(this)"  maxval="' + data.ajaxPage.dataList[i].ITEM_SCORE + '" id= input1_"' + data.ajaxPage.dataList[i].ID + '" type="text" size="10" value="" maxlength="2"/></td>' +
	...
	var itemshow = true;//是否开始时候就展示空项目
	function git() { //获得葡萄数据
		　　
		var j = {
			"date": date,
		...
		$.ajax({
			type: "POST",
			dataType: "json",
			url: "${path}buss/bussModel_exeFunc.ms?funcMId=51b13544d91941e88506289a2f537f08&dataAuth=${param.dataAuth}",
			data: j,
			success: function(data) {
				// console.log(data);
				var k = data.ajaxPage.dataList.length;
				if(itemshow){//只触发一次
				if(k&&k>0) itemshow = false;//是否开始时候就展示空项目
				getItem();
				}
				for(var i = 0; i < k; i++) {
					...
					$("#grape_" + idx).attr("data", data.ajaxPage.dataList[i].ID+","+data.ajaxPage.dataList[i].CHECK_USER_ID); //存储葡萄主表id 用于点击时获取项目信息
				}
...
//	console.log("showScore中");
		...
		//展示时间
		$("#searchtime").text(strDate + "号");
		console.log("在方法showscore中D="+strDate);
		$("#thistime").text(date.substring(0, 4) + "年 " + date.substring(5, 7) + "月");
		...
		if(!$(obj).attr("data"))　　 {　　 //console.log('进入项目');
			...
			for(var i = 0; i < org_item_list.length; i++) {
				$("#mmz_tbody001").append('<tr id="123" style="">' +
					...
					'<td class="dec" style="width:50px;overflow: hidden; text-overflow:ellipsis;"  ><input  placeholder="<=' + org_item_list[i].ITEM_SCORE + '" onchange="rule1(this)"  maxval="' + org_item_list[i].ITEM_SCORE + '" id= input1_"' + org_item_list[i].ID + '" type="text" size="10" value="" maxlength="2"/></td>' +
          	...
          	//  */
				...
				for(var i = 0; i < k.length; i++) {
					$("#mmz_tbody001").append('<tr id="123" style="">' +
						...
						'<td class="dec" style="width:50px;overflow: hidden; text-overflow:ellipsis;"  ><input  placeholder="<=' + data.ajaxPage.dataList[i].MAX_SCORE + '" onchange="rule1(this)"  maxval="' + data.ajaxPage.dataList[i].MAX_SCORE + '" id= input1_"' + data.ajaxPage.dataList[i].ID + '" value="' + k[i].ITEM_SCORE + '" type="text" size="10" value="" maxlength="2"/></td>' +
						'<td class="dec" style="overflow: hidden; text-overflow:ellipsis;"    title="'+zeroTonull(data.ajaxPage.dataList[i].REMARK)+'" ><input onchange="rule2(this)"  value="' + zeroTonull(data.ajaxPage.dataList[i].REMARK) + '"  validateJson="" id= input2_"' + data.ajaxPage.dataList[i].ID + '" type="text" size="10" value="" maxlength="20" /></td>' +
						'</tr>');
				}
