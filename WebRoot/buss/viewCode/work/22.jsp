...
<body>
    <div class="content-in">
        <div class="dlist">
            <div class="hd">
		<bu:func viewId="6b264892b8304864ae02091936139d81" />
            </div>
            <div class="bd">
  ...
  <table class="search_table">
      <bu:search deal_mark="1" viewId="6b264892b8304864ae02091936139d81" /> 
		...
		<bu:tr cssClass="datagrid-header-row datagrid-title-ajax" id="datagrid-title-ajax">
			<td class="datagrid-cell" name="noprintset_SEQ" style="width:30px; text-align:center;" ><bu:thSeq  formId="b3b00ad970894885bd60a59ca296580c" i18n="1"/></td>
			<td class="datagrid-cell no-print" style="width:30px; text-align:center"><span><input type="checkbox" id="selectAll_b3b00ad970894885bd60a59ca296580c" onclick="_selectAjaxTableAllData(this,'b3b00ad970894885bd60a59ca296580c')" style="cursor: pointer;"title="全选"/></span></td>
		</bu:tr>
		</tbody>
		</bu:table>
		</div>
 ...
 <button type="button" onclick="printset_17('b3b00ad970894885bd60a59ca296580c','1');">打印</button>
 </div>
 </div>
 ...
 <input type="text" name="SEQ" value="30" title_name="序号" />px
		...
		<bu:submit viewId="6b264892b8304864ae02091936139d81" />
      <jsp:include page="/plf/page/mesdemo/commCode/commCode.jsp">
           <jsp:param name="modelName" value="VIEW_TYPE_17" />
           <jsp:param name="location" value="beforeJsLoad" />
      </jsp:include>
		<bu:script viewId="6b264892b8304864ae02091936139d81" />
