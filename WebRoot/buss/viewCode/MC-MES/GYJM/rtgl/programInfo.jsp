...
<body scroll="auto" style="overflow: auto;" >
    <div class="content-in">
		...
		<bu:table cssClass="datagrid-htable fixedTable datagrid-div6 datagrid-htable-kz" id="datagrid-htablecc45a8ab4c87407090593be875962853" style="min-width:1700px;">
		...
		<bu:tr cssClass="datagrid-header-row datagrid-title-ajax" id="datagrid-title-ajax">
			...
			<td class="datagrid-cell" style="width:200px;"><bu:uitn colNo="DATA_AUTH" formId="cc45a8ab4c87407090593be875962853" /></td>
			<td class="datagrid-cell" style="width:100px;"><bu:uitn colNo="CPI_SN" formId="cc45a8ab4c87407090593be875962853" /></td>
			<td class="datagrid-cell" style="width:100px;"><bu:uitn colNo="CPI_NAME" formId="cc45a8ab4c87407090593be875962853" /></td>
			<td class="datagrid-cell" style="width:100px;"><bu:uitn colNo="CPI_MODEL_CODE" formId="cc45a8ab4c87407090593be875962853" /></td>
			<td class="datagrid-cell" style="width:100px;"><bu:uitn colNo="CPI_PRODUCT_STEP" formId="cc45a8ab4c87407090593be875962853" /></td>
			<td class="datagrid-cell" style="width:100px;"><bu:uitn colNo="CPI_PROCESS_FACE" formId="cc45a8ab4c87407090593be875962853" /></td>
			<td class="datagrid-cell" style="width:100px;"><bu:uitn colNo="CPI_GROUP" formId="cc45a8ab4c87407090593be875962853" /></td>
			<td class="datagrid-cell" style="width:100px;"><bu:uitn colNo="CPI_VERSION" formId="cc45a8ab4c87407090593be875962853" /></td>
			<td class="datagrid-cell" style="width:100px;"><bu:uitn colNo="CPI_DEFAULT_FLAG" formId="cc45a8ab4c87407090593be875962853" /></td>
			<td class="datagrid-cell" style="width:80px;"><bu:uitn colNo="CREATE_USER" formId="cc45a8ab4c87407090593be875962853" /></td>
			<td class="datagrid-cell" style="width:140px;"><bu:uitn colNo="CREATE_TIME" formId="cc45a8ab4c87407090593be875962853" /></td>
			<td class="datagrid-cell" style="width:80px;"><bu:uitn colNo="EDIT_USER" formId="cc45a8ab4c87407090593be875962853" /></td>
			<td class="datagrid-cell" style="width:140px;"><bu:uitn colNo="EDIT_TIME" formId="cc45a8ab4c87407090593be875962853" /></td>
		</bu:tr>
		</tbody>
		</bu:table>
		</div>
		...
		<table class="datagrid-btable fixedTable dblClick"  id="datagrid-btable-ajaxcc45a8ab4c87407090593be875962853" style="min-width:1700px;">
    ...
    if(formId=='cc45a8ab4c87407090593be875962853'){<%--FM-软体管理--%>
        $.each(uiTxt,function(i,v){
           ...
           // arrHtml.push("</td>");
            ...
            arrHtml.push("</td>");
            arrHtml.push("<td colno='CPI_SN' class='datagrid-cell "+ms.tdClass(formId, 'CPI_SN')+"' style='width:100px;text-align:center;"+ms.tdStyle(formId, 'CPI_SN')+"' "+ms.tdEvent(formId, 'CPI_SN')+">")
            ...
            arrHtml.push("</td>");
            arrHtml.push("<td colno='CPI_NAME' class='datagrid-cell "+ms.tdClass(formId, 'CPI_NAME')+"'style='width:100px;text-align:center;"+ms.tdStyle(formId, 'CPI_NAME')+"' "+ms.tdEvent(formId, 'CPI_NAME')+">")
            ...
            arrHtml.push("</td>");
            arrHtml.push("<td colno='CPI_MODEL_CODE' class='datagrid-cell "+ms.tdClass(formId, 'CPI_MODEL_CODE')+"' style='width:100px;text-align:center;"+ms.tdStyle(formId, 'CPI_MODEL_CODE')+"' "+ms.tdEvent(formId, 'CPI_MODEL_CODE')+">")
            ...
            arrHtml.push("</td>");
            arrHtml.push("<td colno='CPI_PRODUCT_STEP' class='datagrid-cell "+ms.tdClass(formId, 'CPI_PRODUCT_STEP')+"' style='width:100px;text-align:center;"+ms.tdStyle(formId, 'CPI_PRODUCT_STEP')+"' "+ms.tdEvent(formId, 'CPI_PRODUCT_STEP')+">")
            ...
            arrHtml.push("</td>");
            arrHtml.push("<td colno='CPI_PROCESS_FACE' class='datagrid-cell "+ms.tdClass(formId, 'CPI_PROCESS_FACE')+"' style='width:100px;text-align:center;"+ms.tdStyle(formId, 'CPI_PROCESS_FACE')+"' "+ms.tdEvent(formId, 'CPI_PROCESS_FACE')+">")
            ...
            arrHtml.push("</td>");
            arrHtml.push("<td colno='CPI_GROUP' class='datagrid-cell "+ms.tdClass(formId, 'CPI_GROUP')+"' style='width:100px;text-align:center;"+ms.tdStyle(formId, 'CPI_GROUP')+"' "+ms.tdEvent(formId, 'CPI_GROUP')+">")
            ...
            arrHtml.push("</td>");
            arrHtml.push("<td colno='CPI_VERSION' class='datagrid-cell "+ms.tdClass(formId, 'CPI_VERSION')+"' style='width:100px;text-align:center;"+ms.tdStyle(formId, 'CPI_VERSION')+"' "+ms.tdEvent(formId, 'CPI_VERSION')+">")
            ...
            arrHtml.push("</td>");
            arrHtml.push("<td colno='CPI_DEFAULT_FLAG' class='datagrid-cell "+ms.tdClass(formId, 'CPI_DEFAULT_FLAG')+"'style='width:100px;text-align:center;"+ms.tdStyle(formId, 'CPI_DEFAULT_FLAG')+"' "+ms.tdEvent(formId, 'CPI_DEFAULT_FLAG')+">")
