...
<script type="text/javascript">
  function bom_search(){
		...
		var url="/mes/buss/bussModel_exeFunc.ms?FUNC_CODE=F1890&funcMId=d55495acbdfa4f0b858d8ee6b9be0600&type=1";
		$.ajax({
			url:url,
			type:"post",
...
<body scroll="auto" style="overflow: auto;">
	<div class="content-in">
			<div class="hd">
					...
					<div class="optn" style="margin-right:6px;margin-top:56px;">
								...
								<tr>
									<td width="100%" align="right">
										<button type="button" value=""
											onclick="add('${popId}pop','${popId}shadow');" sytle=""
											class="botton_img_add">
											<i class="ico ico-kl "></i>
											<dict:lang value="提交" />
										</button>
										<button type="button" value=""
											onclick="clearSel('${popId}pop','${popId}shadow');" sytle=""
											class="botton_img_add">
											<i class="ico ico-xg "></i>
											<dict:lang value="清空" />
										</button>
										<button type="button" value=""
											onclick="parent.closePopWinFp('hidePop_65eec5ae8fa948b0bfaa48c814f5725d','hidePops_65eec5ae8fa948b0bfaa48c814f5725d');"
											sytle="" class="botton_img_add">
											<i class="ico ico-sc "></i><dict:lang value="关闭" />
										</button>
										<button class="botton_img_add" onclick="bom_search();">
			...
			<div class="bd">
				...
				<form id="submitForm" name="submitForm" action="" method="post"
					...
					<div style="margin: 5px;">
						<table id="add_table" width="100%" class="dlist-table table-line ">
							<thead>
								<tr class="thcolor">
									<th width="5%" style="text-align:center;">&nbsp;&nbsp;</th>
									<th width="5%" style="text-align:center;">序号</th>
									<th width="20%" style="text-align:center;">料号</th>
									<th width="30%" style="text-align:center;">料号名称</th>
									<th width="20%" style="text-align:center;">料号规格</th>
									<th width="20%" style="text-align:center;">料号类型</th>
								</tr>
							</thead>
							<tbody>
							<c:forEach items="${page.dataList}" var="items" varStatus="status">
								...
								<td align="center">${items.CBD_ITEM_CODE}</td>
								<td align="center">${items.ITEM_NAME}</td>
								<td align="center">${items.ITEM_SPEC}</td>
								<td align="center">${items.ITEM_TYPE}</td>
								</tr>
