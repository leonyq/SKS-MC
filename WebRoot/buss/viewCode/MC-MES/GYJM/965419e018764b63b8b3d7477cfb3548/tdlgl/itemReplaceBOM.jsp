...
<body scroll="auto" style="overflow: auto;">
	<div class="content-in">
			<div class="hd">
					...
					<div class="optn" style="margin-right:6px;margin-top:40px;">
							...
							<table class="func_table">
								<tr>
									<td width="100%" align="right">
										...
										<button class="botton_img_add" onclick="search_item2();">
	...
	function search_item2(){
		...
		var url="/mes/buss/bussModel_exeFunc.ms?FUNC_CODE=F1890&funcMId=d55495acbdfa4f0b858d8ee6b9be0600&type=2"
		$.ajax({
			url:url,
			type:"post",
	  ...
	  $.ajax({
	    ...
	    //$("#searchForm").serialize()+"&page.currentPage="+_GLO_FORM_PAGE_MAP[paginationImpl].currentPage+"&page.pageRecord=" + _GLO_FORM_PAGE_MAP[paginationImpl].pageRecord,
		success: function(data){
				var tbodyStr = "";
					var tabContent=$(data).find("#submitForm");
					$("#submitForm").html(tabContent.html());
