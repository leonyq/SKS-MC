...
<head>
	...
	#leftPanel .operation>ul,#leftPanel .attribute>ul{
	    padding:10px;
	    box-sizing:border-box;
	}
	
	#leftPanel .operation>ul{
	    height:140px;
	}
	
	#leftPanel .operation>ul li{
	    float:left;
	    height:30px;
	    width:50%;
	    line-height:30px;
	...
	//获取数据回显
		function getEditData(){
			...
			$.ajax({
        			type: "POST",
        		    dataType: "json",
        		    url: "buss/bussModel_exeFunc.ms?FUNC_CODE=F3226&funcMId=0618c381a3914dc29931f2fd3574eb6d",
        		    data: {
        		        flag:flag,
        		    	dataId: $("#dataId").val(),
				        ...
				        if(data.authLs != null && data.authLs != ""){
     					...
     					if(data.groupList != null && data.groupList != ""){
     						...
     						for ( var i = 0; i < data.groupList.length; i++) {
								...
								leftHtml = leftHtml + "<div class='pop-content' style='height: 60px'><div class='left-content'>"+
									"<img src='"+photoPath+"' name='"+photoPath+"' onerror=\"javascript:this.src='${path}plf/js/jsPlumb/images/process.png'\" draggable='true' ondragstart='drag(event)' myAttr='"+data.groupList[i].GROUP_NAME+"' id='"+data.groupList[i].GROUP_CODE+"' >"+
	     							"<input type='hidden' id='groupID_"+data.groupList[i].GROUP_CODE+"' value='"+data.groupList[i].GROUP_CODE+"'/>"+
									"</div><div class='right-context'>"+data.groupList[i].GROUP_NAME+"</div></div>";
     						}	
     					...
     					if ("edit" == flag) {
							...
							if(countList != null && countList != ""){
								for ( var i = 0; i < countList.length; i++) {
						        	...
						        	$("#addRoutelist tr:last").append("<td style='text-align: center;width: 10%;'><input type='checkbox' onclick='' disabled='disabled' /></td>");
        ...
        function saveFlow(){
          ...
          $.ajax({
     		    ...
     		    data: {
     		    	...
     		    	CR_PO_INPUT_ORDER: $("#paraMap1_CR_MO_INPUT").find("option:selected").attr("order"),
     		    	CR_PO_OUTPUT: $("#paraMap1_CR_PO_OUTPUT").find("option:selected").val(),
     		    	CR_PO_OUTPUT_ORDER: $("#paraMap1_CR_MO_INPUT").find("option:selected").attr("order"),
     		    	CR_ITEM_GROUP: $("#paraMap1_CR_ITEM_GROUP").find("option:selected").val(),
     		    	CR_ITEM_GROUP_ORDER: $("#paraMap1_CR_MO_INPUT").find("option:selected").attr("order"),
...
<body>
  <div class="mod" style="margin-top: 40px;height:100%;background-color:#f6f5f7;">
	<div class="dlist" style="height:100%;">
            <div>
             	<div style="position: absolute;left:0;top:1px;">
                	<span class="dot">*</span><dict:lang value="组织机构" />
                	<select id="data_auth" name="data_auth" class="dept_select" style="width: 234px;" disabled="disabled"/>
                		<option value='' class='select_name'>--<dict:lang value='请选择'/>--</option>
                	</select>
                </div>
			...
			<tr>
				...
				<td style="text-align: right;line-height: 25px;"/>
					<div class="section">
						...
						<bu:ui colNo="CR_ROUTE_NAME" formId="4930de89023b451385f973aed9882309" value="%{CR_ROUTE_NAME}" formIndex="1" style="width: 200px;"  disabled="disabled"/>
					</div>
		    		...
		    		<td style="text-align: right;line-height: 25px;"/>
						...
						<bu:ui colNo="CR_ROUTE_STEP" formId="4930de89023b451385f973aed9882309" value="%{CR_ROUTE_STEP}" formIndex="1" style="width: 200px;"  disabled="disabled"/>
					</div>
				...
				<td style="text-align: right;line-height: 25px;"/>
					<div class="section" style="text-align: left;">
						...
						<bu:ui colNo="CR_ROUTE_FLAG" formId="4930de89023b451385f973aed9882309" formIndex="1"  disabled="disabled"/>
					</div>
		...
		<tr>
			...
			<td style="width:200px;" >
				<div id="leftPanel"  ondrop="dropNo(event)" ondragover="allowDropNo(event)" style="border: 1px solid #E4E4E4;height: 450px;">
				    <div class="operation">
				        <div class="_head">控件操作</div>
				        <ul>
				            <li onclick="gainPointType(this)" class='tool-con'><img src="${path}plf/page/fp/img/point-icon.png"  /><span>指针工具</span></li>
				            <li onclick="changeLineType('straight',this)" class='tool-con'><img src="${path}plf/page/fp/img/straight-icon.png" /><span>直线</span></li>
				            <li onclick="changeLineType('broken',this)" class='tool-con'><img src="${path}plf/page/fp/img/broken-icon.png" /><span>折线</span></li>
				            <li onclick="changeLineType('Uline',this)" class='tool-con'><img src="${path}plf/page/fp/img/u-icon.png" /><span>U型线</span></li>
				            <li onclick="foldingLine();" style="margin-top:10px;"><img src="${path}plf/page/fp/img/revers.png" />线体翻折</li>
				            <li onclick="upClear();"  style="margin-top:10px;"><img src="${path}plf/page/fp/img/empty.png" />清空</li>
				        </ul>
				    </div>
				    <div class="attribute" id="paramPanel">
				        ...
				        <ul>
				            ...
				            <li><span>文字位置</span><select id="pLabelPosition" onchange="updateObject()" class="null dept_select" style="display: none;">
				            ...
				            <li><span>显示字体</span><select id="pFont"  onClick="updateObject()" class="null dept_select" style="display: none;">
...
<DIV id="content2"  style="display:none">
	        	...
	        	<td>
	        	    <div class="group">
	                    <div class="name" ><bu:uitn colNo="CR_MO_INPUT" formId="4930de89023b451385f973aed9882309" /></div>
 	                    <div class="dec"><select id="paraMap1_CR_MO_INPUT" name="paraMap1@0#CR_MO_INPUT" style="width: 234px;" class="dept_select" onchange="compareMO();"  disabled="disabled">
                ...
                <td>
	        	    <div class="group">
	                    <div class="name" ><bu:uitn colNo="CR_MO_OUTPUT" formId="4930de89023b451385f973aed9882309" /></div>
 	                    <div class="dec"><select id="paraMap1_CR_MO_OUTPUT" name="paraMap1@0#CR_MO_OUTPUT" style="width: 234px;" class="dept_select" onchange="compareMO_s();"  disabled="disabled">
								<option value=''>--请选择--</option></select></div>
                    </div>
	        	</td>													
                <td>
	        	    <div class="group">
	                    <div class="name" ><bu:uitn colNo="CR_ITEM_GROUP" formId="4930de89023b451385f973aed9882309" /></div>
 	                    <div class="dec"><select id="paraMap1_CR_ITEM_GROUP" name="paraMap1@0#CR_ITEM_GROUP" style="width: 234px;" class="dept_select"  disabled="disabled">
								<option value=''>--请选择--</option></select></div>
                    </div>
	        	</td>
	    </tr>
	        	...
	        	<td>
	        	    <div class="group">
	                    <div class="name" ><bu:uitn colNo="CR_PO_OUTPUT" formId="4930de89023b451385f973aed9882309" /></div>
 	                    <div class="dec"><select id="paraMap1_CR_PO_OUTPUT" name="paraMap1@0#CR_PO_OUTPUT" style="width: 234px;" class="dept_select" onchange="comparePO_s();"  disabled="disabled">
								<option value=''>--请选择--</option></select></div>
                    </div>
	        	</td>	
			    <td>
	        	    <div class="group">
	                    <div class="name" ><bu:uitn colNo="CR_PO_INPUT" formId="4930de89023b451385f973aed9882309" /></div>
 	                    <div class="dec"><select id="paraMap1_CR_PO_INPUT" name="paraMap1@0#CR_PO_INPUT" style="width: 234px;" class="dept_select" onchange="comparePO();"  disabled="disabled">
								<option value=''>--请选择--</option></select></div>
                    </div>
	        	</td>	
			    <td>
	        	    <div class="group">
	                    <div class="name" ><bu:uitn colNo="CR_FQC_GROUP" formId="4930de89023b451385f973aed9882309" /></div>
 	                    <div class="dec"><select id="paraMap1_CR_FQC_GROUP" name="paraMap1@0#CR_FQC_GROUP" style="width: 234px;" class="dept_select"  disabled="disabled">
								<option value=''>--请选择--</option></select></div>
                    </div>
	        	</td>
	    </tr>
		    ...
		    <td>
	        	    <div class="group">
	                    <div class="name" ><bu:uitn colNo="CR_IPQC_GROUP" formId="4930de89023b451385f973aed9882309" /></div>
 	                    <div class="dec"><select id="paraMap1_CR_IPQC_GROUP" name="paraMap1@0#CR_IPQC_GROUP" style="width: 234px;" class="dept_select"  disabled="disabled">
								<option value=''>--请选择--</option></select></div>
                    </div>
	        	</td>
	        	<td>
	        	    <div class="group">
	                    <div class="name" ><bu:uitn colNo="CR_AGING_BEGIN_GROUP" formId="4930de89023b451385f973aed9882309" /></div>
 	                    <div class="dec"><select id="paraMap1_CR_AGING_BEGIN_GROUP" name="paraMap1@0#CR_AGING_BEGIN_GROUP" style="width: 234px;" class="dept_select" disabled="disabled" >
								<option value=''>--请选择--</option></select></div>
                    </div>
	        	</td>
	        	<td>
	        	    <div class="group">
	                    <div class="name" ><bu:uitn colNo="CR_AGING_END_GROUP" formId="4930de89023b451385f973aed9882309" /></div>
 	                    <div class="dec"><select id="paraMap1_CR_AGING_END_GROUP" name="paraMap1@0#CR_AGING_END_GROUP" style="width: 234px;" class="dept_select" disabled="disabled" >
								<option value=''>--请选择--</option></select></div>
                    </div>
	        	</td>
		</tr>
	...
	<div style="width: 100%;">
		...
		<table class="dlist-table table-line " id="routetb" width="100%;" style="margin-top:5px;">
							<thead>
								<tr class="thcolor">
									<th style="text-align: center;width: 10%;"><input type="checkbox" id="route_list_cb" onchange="getAllRoute();"  disabled="disabled" /></th >
...
function setDataAuth(){
		        ...
		        success: function(data){
		            ...
		            $("#data_auth").empty();
		            $("#data_auth").append("<option value='"+list[0].ID+"'>"+list[0].NAME+"</option>");
		            $("#data_auth").trigger("chosen:updated");
		        },
		        error:function(msg){
