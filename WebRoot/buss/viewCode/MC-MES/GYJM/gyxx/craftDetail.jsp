							...
							<div class="datagrid-header-inner head11 "  id="datagrid-header-inner831b2dbf0dfb494695b7ce66538a1234">
								<table  class="datagrid-htable fixedTable datagrid-div6 datagrid-htable-kz  " id="datagrid-htable831b2dbf0dfb494695b7ce66538a1234">
									...
									<tr class="datagrid-header-row thcolor">
										...
										<td class="datagrid-cell" style="width:169px;" ><dict:lang value="机种" /></td >
										<td class="datagrid-cell" style="width:298px;" ><dict:lang value="机种名称" /></td >
										<td class="datagrid-cell" style="width:236px;" ><dict:lang value="机种规格" /></td >
									</tr>
									</tbody>		
								</table>
							</div>
							...
							<div class="datagrid-header-inner head2"  id="datagrid-header-inner123456">
								<table  class="datagrid-htable fixedTable datagrid-div6 datagrid-htable-kz  " id="datagrid-htable123456">
									...
									<tr class="datagrid-header-row thcolor">
										...
										<td class="datagrid-cell" style="width:140px;" ><dict:lang value="机种料号" /></td >
    ...
    function getInfo(){
        ...
        console.log(dataAuth)
            ...
            $.ajax({
                type:"post",
                dataType:"json",
                data:"CT_ROUTE_CODE="+CT_ROUTE_CODE+"&id="+id+"&step="+step+"&face="+face+"&dataAuth="+dataAuth,
                url:loadItemUrl,
