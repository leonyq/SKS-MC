...
<head>
    ...
    <%@ include file="/plf/page/common/buss/listCommJs.jsp"%>
		<bu:header formId ="4e451ca4ecd143ed9a05e7c960050a81"/>
	<jsp:include page="/plf/page/mesdemo/commCode/commCode.jsp">
         <jsp:param name="modelName" value="VIEW_TYPE_17" />
...
<body scroll="auto" style="overflow: auto;" >
    <div class="content-in">
        <div class="dlist">
            <div class="hd">
		<bu:func viewId="71b8153df103454e9d1e49b5dce3021c" />
            </div>
            <div class="bd">
		...
		<bu:search viewId="71b8153df103454e9d1e49b5dce3021c" />
                   </form>
		...
		<input type="hidden" name="formPage4e451ca4ecd143ed9a05e7c960050a81" id="formPage4e451ca4ecd143ed9a05e7c960050a81" value="${formPage4e451ca4ecd143ed9a05e7c960050a81}"/>
		<input type="hidden" name="formId" id="formId1" value='4e451ca4ecd143ed9a05e7c960050a81'/>
		<input type="hidden" id="subRelColIds" name="subRelColIds" value='null'/>
		<input type="hidden" id="subFormIds" name="subFormIds" value='null'/>
		<div class="panel-ajax datagrid datagrid-div1"  id="4e451ca4ecd143ed9a05e7c960050a81">
		<div class="datagrid-div2 datagrid-div6 datagrid-view-ajax" id="datagrid-view-ajax4e451ca4ecd143ed9a05e7c960050a81" >
		<div class="datagrid-header">
		<div class="datagrid-header-inner" id="datagrid-header-inner4e451ca4ecd143ed9a05e7c960050a81">
		<bu:table cssClass="datagrid-htable fixedTable datagrid-div6 datagrid-htable-kz" id="datagrid-htable4e451ca4ecd143ed9a05e7c960050a81" >
		<s:set name="_$type" value="'view'" />
		<tbody class="isParentsTitle">
		<bu:tr cssClass="datagrid-header-row datagrid-title-ajax" id="datagrid-title-ajax">
			<td class="datagrid-cell" style="width:30px; text-align:center;" ><bu:thSeq  formId="4e451ca4ecd143ed9a05e7c960050a81" i18n="1"/></td>
			<td class="datagrid-cell" style="width:30px; text-align:center"><span><input type="checkbox" id="selectAll_4e451ca4ecd143ed9a05e7c960050a81" onclick="_selectAjaxTableAllData(this,'4e451ca4ecd143ed9a05e7c960050a81')" style="cursor: pointer;"title="全选"/></span></td>
			<td class="datagrid-cell" style="width:150px;"><bu:uitn colNo="WSI_MO_NUMBER" formId="4e451ca4ecd143ed9a05e7c960050a81" /></td>
			<td class="datagrid-cell" style="width:80px;"><bu:uitn colNo="WSI_ACTIONTYPE" formId="4e451ca4ecd143ed9a05e7c960050a81" /></td>
			<td class="datagrid-cell" style="width:150px;"><bu:uitn colNo="WSI_MODEL_CODE" formId="4e451ca4ecd143ed9a05e7c960050a81" /></td>
			<td class="datagrid-cell" style="width:80px;"><bu:uitn colNo="WSI_PROCESS_FACE" formId="4e451ca4ecd143ed9a05e7c960050a81" /></td>
			<td class="datagrid-cell" style="width:100px;"><bu:uitn colNo="WSI_AREA_ID" formId="4e451ca4ecd143ed9a05e7c960050a81" /></td>
			<td class="datagrid-cell" style="width:100px;"><bu:uitn colNo="WSI_WORKSTATION_SN" formId="4e451ca4ecd143ed9a05e7c960050a81" /></td>
			<td class="datagrid-cell" style="width:80px;"><bu:uitn colNo="WSI_ONLINE_FLAG" formId="4e451ca4ecd143ed9a05e7c960050a81" /></td>
			<td class="datagrid-cell" style="width:180px;"><bu:uitn colNo="WSI_ITEM_SN" formId="4e451ca4ecd143ed9a05e7c960050a81" /></td>
			<td class="datagrid-cell" style="width:120px;"><bu:uitn colNo="WSI_ITEM_CODE" formId="4e451ca4ecd143ed9a05e7c960050a81" /></td>
			<td class="datagrid-cell" style="width:80px;"><bu:uitn colNo="WSI_LOT_NO" formId="4e451ca4ecd143ed9a05e7c960050a81" /></td>
			<td class="datagrid-cell" style="width:80px;"><bu:uitn colNo="WSI_ITEM_COUNT" formId="4e451ca4ecd143ed9a05e7c960050a81" /></td>
			<td class="datagrid-cell" style="width:80px;"><bu:uitn colNo="WSI_INIT_COUNT" formId="4e451ca4ecd143ed9a05e7c960050a81" /></td>
			<td class="datagrid-cell" style="width:80px;"><bu:uitn colNo="WSI_POINT" formId="4e451ca4ecd143ed9a05e7c960050a81" /></td>
			<td class="datagrid-cell" style="width:80px;"><bu:uitn colNo="WSI_POINT_NUM" formId="4e451ca4ecd143ed9a05e7c960050a81" /></td>
			<td class="datagrid-cell" style="width:100px;"><bu:uitn colNo="WSI_SUPPLIERS" formId="4e451ca4ecd143ed9a05e7c960050a81" /></td>
			<td class="datagrid-cell" style="width:180px;"><bu:uitn colNo="WSI_ITEM_SN_OLD" formId="4e451ca4ecd143ed9a05e7c960050a81" /></td>
			<td class="datagrid-cell" style="width:120px;"><bu:uitn colNo="WSI_ITEM_CODE_OLD" formId="4e451ca4ecd143ed9a05e7c960050a81" /></td>
			<td class="datagrid-cell" style="width:80px;"><bu:uitn colNo="WSI_LOT_NO_OLD" formId="4e451ca4ecd143ed9a05e7c960050a81" /></td>
			<td class="datagrid-cell" style="width:80px;"><bu:uitn colNo="WSI_COUNT_OLD" formId="4e451ca4ecd143ed9a05e7c960050a81" /></td>
			<td class="datagrid-cell" style="width:100px;"><bu:uitn colNo="WSI_DEVICE_SN" formId="4e451ca4ecd143ed9a05e7c960050a81" /></td>
			<td class="datagrid-cell" style="width:80px;"><bu:uitn colNo="WSI_DEVICE_SEQ" formId="4e451ca4ecd143ed9a05e7c960050a81" /></td>
			<td class="datagrid-cell" style="width:100px;"><bu:uitn colNo="WSI_SKIP_NO" formId="4e451ca4ecd143ed9a05e7c960050a81" /></td>
			<td class="datagrid-cell" style="width:100px;"><bu:uitn colNo="WSI_TABLE_NO" formId="4e451ca4ecd143ed9a05e7c960050a81" /></td>
			<td class="datagrid-cell" style="width:100px;"><bu:uitn colNo="WSI_LOADPOINT_SN" formId="4e451ca4ecd143ed9a05e7c960050a81" /></td>
			<td class="datagrid-cell" style="width:100px;"><bu:uitn colNo="WSI_FEEDER_SN" formId="4e451ca4ecd143ed9a05e7c960050a81" /></td>
			<td class="datagrid-cell" style="width:80px;"><bu:uitn colNo="WSI_CHANEL" formId="4e451ca4ecd143ed9a05e7c960050a81" /></td>
			<td class="datagrid-cell" style="width:80px;"><bu:uitn colNo="WSI_TRAY_FLAG" formId="4e451ca4ecd143ed9a05e7c960050a81" /></td>
			<td class="datagrid-cell" style="width:80px;"><bu:uitn colNo="WSI_REPEAT_FLAG" formId="4e451ca4ecd143ed9a05e7c960050a81" /></td>
			<td class="datagrid-cell" style="width:80px;"><bu:uitn colNo="WSI_EMP" formId="4e451ca4ecd143ed9a05e7c960050a81" /></td>
			<td class="datagrid-cell" style="width:140px;"><bu:uitn colNo="WSI_LOADTIME" formId="4e451ca4ecd143ed9a05e7c960050a81" /></td>
		</bu:tr>
		</tbody>
		</bu:table>
		</div>
		</div>
		<div class="datagrid-body datagrid-div3 datagrid-body-ajax scroll1" id="tableDiv4e451ca4ecd143ed9a05e7c960050a81" onscroll="ajaxTableScroll(this,'4e451ca4ecd143ed9a05e7c960050a81')">
		<table class="datagrid-btable fixedTable dblClick"  id="datagrid-btable-ajax4e451ca4ecd143ed9a05e7c960050a81" >
		<tbody id="tbody_4e451ca4ecd143ed9a05e7c960050a81" class="isParents">
		</tbody>
		</table>		</div>
		</div>
		</div>
		<c:if test="${formPage4e451ca4ecd143ed9a05e7c960050a81==1}">			<div class="center">
			<s:include value="/plf/page/fp/paginationPopMultAx.jsp?listDataFn=listAjaxTable&formId=4e451ca4ecd143ed9a05e7c960050a81&showLoading=0" />
			</div>
		</c:if>
		</div>
		...
		<bu:submit viewId="71b8153df103454e9d1e49b5dce3021c" />
		<bu:script viewId="71b8153df103454e9d1e49b5dce3021c" />
	<!--	<jsp:include page="/plf/page/mesdemo/commCode/commCode.jsp">
        	<jsp:param name="modelName" value="VIEW_TYPE_17" />
...
function createTableModel(ms,formId){
    ...
    var colNo = $("#relColVals").val();
    if(formId=='4e451ca4ecd143ed9a05e7c960050a81'){<%--物料离线作业记录日志--%>
