...
<body scroll="auto" style="overflow: auto;" >
    <div class="content-in">
        <div class="dlist">
            <div class="hd">
		<bu:func viewId="e5a8e72f4d3b4564911305406bc40129" />
            </div>
            <div class="bd">
		...
		<bu:search viewId="e5a8e72f4d3b4564911305406bc40129" />
                   </form>
		...
		<div class="datagrid-header-inner head" id="datagrid-header-inner2bf705be618c47afafb6a33e0d0c9376">
		...
		<bu:tr cssClass="datagrid-header-row datagrid-title-ajax" id="datagrid-title-ajax">
			...
			<td class="datagrid-cell" style="width:80px;"><bu:uitn colNo="WSI_ACTIONTYPE" formId="2bf705be618c47afafb6a33e0d0c9376" /></td>
			...
			<td class="datagrid-cell" style="width:80px;"><bu:uitn colNo="WSI_ONLINE_FLAG" formId="2bf705be618c47afafb6a33e0d0c9376" /></td>
			...
			<td class="datagrid-cell" style="width:80px;"><bu:uitn colNo="WSI_INIT_COUNT" formId="2bf705be618c47afafb6a33e0d0c9376" /></td>
			...
			<td class="datagrid-cell" style="width:100px;"><bu:uitn colNo="WSI_SUPPLIERS" formId="2bf705be618c47afafb6a33e0d0c9376" /></td>
			<td class="datagrid-cell" style="width:180px;"><bu:uitn colNo="WSI_ITEM_SN_OLD" formId="2bf705be618c47afafb6a33e0d0c9376" /></td>
			<td class="datagrid-cell" style="width:120px;"><bu:uitn colNo="WSI_ITEM_CODE_OLD" formId="2bf705be618c47afafb6a33e0d0c9376" /></td>
			<td class="datagrid-cell" style="width:80px;"><bu:uitn colNo="WSI_LOT_NO_OLD" formId="2bf705be618c47afafb6a33e0d0c9376" /></td>
			<td class="datagrid-cell" style="width:80px;"><bu:uitn colNo="WSI_COUNT_OLD" formId="2bf705be618c47afafb6a33e0d0c9376" /></td>
		...
		<div class="datagrid-body datagrid-div3 datagrid-body-ajax scroll" id="tableDiv2bf705be618c47afafb6a33e0d0c9376" onscroll="ajaxTableScroll(this,'2bf705be618c47afafb6a33e0d0c9376')">
		...
		<bu:submit viewId="e5a8e72f4d3b4564911305406bc40129" />
		<bu:script viewId="e5a8e72f4d3b4564911305406bc40129" />
               ...
               function setTableWidth(formId){
                ...
                function init(){
                    ...
                    var jumpId = $("#jumpId").val();  
              		if(jumpId!=""){
                  $("#WSI_MO_NUMBER_SHOW").val(jumpId);
                  $("#WSI_MO_NUMBER").val(jumpId);
                  $("#WSI_LOADTIME_BEGIN").val('');
                  $("#WSI_LOADTIME_END").val('');
                  }  
                  
                  var jumpId2 = $("#jumpId2").val();  
              		if(jumpId2!=""){
                  $("#WSI_FEEDER_SN").val(jumpId2);
                  $("#WSI_LOADTIME_BEGIN").val('');
                  $("#WSI_LOADTIME_END").val('');
                  }
...
function getInfo(){
   var timeBegin=$("#WSI_LOADTIME_BEGIN").val();
    ...
    var wsiOnlineFlag = $("#WSI_ONLINE_FLAG").val();
    var formId = $("#formId1").val();
    var feederSn=$.trim($("#WSI_FEEDER_SN").val());
            ...
            if(null != data.ajaxPage.dataList){
					...
					if(rccList[i].LOADTIME  ==null) rccList[i].LOADTIME ="";
                                ...
                                var backgroudColor = (i+1)%2 == 0 ? "tr-hover" : "";
			 					...
			 					+"<td colno='DATA_AUTH' class='datagrid-cell' style='width:200px;'>"
			 					+"<span colno='DATA_AUTH' title='"+rccList[i].DATA_AUTH2+"'>"+rccList[i].DATA_AUTH2+"</span>"
			 					+"</td>"
			 					...
			 					+"</td>"
			 					+"<td colno='WSI_COUNT_OLD' class='datagrid-cell' style='width:80px;text-align:right;'>"
			 					...
			 					+"<span colno='WSI_TRUCK_NO' title='"+rccList[i].WSI_TRUCK_NO+"' onclick='itemJump8(\""+rccList[i].WSI_TRUCK_NO+"\")' style='display: inline;border-bottom: 1px solid #004098;' >"+rccList[i].WSI_TRUCK_NO+"</span>"
			 					+"</td>"
