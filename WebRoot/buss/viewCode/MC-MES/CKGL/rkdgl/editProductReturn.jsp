...
<head>
    ...
    <style type="text/css">	
    	...
    	#paraMapObj_T2_WRD_DOC_TYPE_chosen {
    	    width:200px !important;
    	}
    	#paraMapObj_T2_WRD_DISPATCH_SN_chosen{
    	    width:200px !important;
    	}
	</style>
				...
				success: function(data){
						...
						if(null != data.ajaxPage.dataList){
							...
							for(var i=0;i<rccList.length;i++){
								...
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72003 tbody:last").append("<tr id='tr1_"+i+"' ></tr>");
								...
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72003 tr:last").append("<td class='datagrid-cell datagrid-cell-2' style='width:30px;text-align: center;'><input id='"+(trCount+1)+"' type='checkbox' name='isSelect2'/></td>");
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72003 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:150px;text-align: center;'>"+rccList[i].CI_ITEM_CODE+"<input type='hidden' id='CI_ITEM_CODE"+(trCount+1)+"' value='"+rccList[i].CI_ITEM_CODE+"'/></td>");
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72003 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:180px;text-align: center;'>"+rccList[i].CI_ITEM_NAME+"<input type='hidden' id='CI_ITEM_NAME"+(trCount+1)+"' value='"+rccList[i].CI_ITEM_NAME+"'/></td>");
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72003 tr:last").append("<td class='datagrid-cell datagrid-cell-5' style='width:150px;text-align: center;'>"+rccList[i].CI_ITEM_SPEC+"<input type='hidden' id='CI_ITEM_SPEC"+(trCount+1)+"' value='"+rccList[i].CI_ITEM_SPEC+"'/></td>");
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72003 tr:last").append("<td class='datagrid-cell datagrid-cell-6' style='width:150px;text-align: center;'>"+rccList[i].SUPPLIER_NAME+"</td>");
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72003 tr:last").append("<td class='datagrid-cell datagrid-cell-7' style='width:100px;text-align: center;'>"+rccList[i].ITEM_TYPE+"<input type='hidden' id='CI_MIN_PACK"+(trCount+1)+"' value='"+rccList[i].CI_MIN_PACK+"'/></td>");
								trCount++;
							}
						...
						pageFun(data.ajaxPage,"formId1");
							...
							clickTr('datagrid-btable-ajaxd48d2c929e63402f94a2551000c72003');
				...
				success: function(data){
						...
						if(null != data.ajaxPage.dataList){
							...
							for(var i=0;i<rccList.length;i++){
								...
								if(rccList[i].ITEM_TYPE==null) rccList[i].ITEM_TYPE="";
								if(rccList[i].CI_MIN_PACK==null) rccList[i].CI_MIN_PACK="0";
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72003 tbody:last").append("<tr id='tr1_"+((currentPage-1)*pageRecord+(i+1))+"' ></tr>");
...
function addItemList(showId,backId){
	...
	$("#itemTbody :checkbox").each(function(){
			if($(this).attr("checked")){
					...
					$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72002 tbody:last").append("<tr id='trr"+(trrCount+1)+"' ></tr>");
					$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72002 tr:last").append("<td class='datagrid-cell datagrid-cell-1' style='width:30px;text-align: center;'>"+(len+1)+"<input type='hidden' name='itemId' value=''/></td>");
					$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72002 tr:last").append("<td class='datagrid-cell datagrid-cell-2' style='width:30px;text-align: center;'><input type='checkbox' name='isSelect1'/></td>");
					$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72002 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:150px;text-align: center;'>"+$("#CI_ITEM_CODE"+$(this).attr("id")).val()+"<input type='hidden' id='CI_ITEM_CODE_"+(trrCount+1)+"' name='CI_ITEM_CODE' value='"+$("#CI_ITEM_CODE"+$(this).attr("id")).val()+"'/></td>");
					$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72002 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:120px;text-align: center;'>"+$("#CI_ITEM_NAME"+$(this).attr("id")).val()+"<input type='hidden' id='Comparison_"+(trrCount+1)+"' class='Comparison' name='Comparison' value=''/></td>");
					$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72002 tr:last").append("<td class='datagrid-cell datagrid-cell-5' style='width:120px;text-align: center;'>"+$("#CI_ITEM_SPEC"+$(this).attr("id")).val()+"</td>");
					$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72002 tr:last").append("<td class='datagrid-cell datagrid-cell-6' style='width:90px;text-align: center;padding:0;'><input type='text' style='width: 90px;padding:0;text-align: right;' maxlength='9' class='_VAL_NULL input isSubmit' id='PLAN_NUM_"+(trrCount+1)+"' name='PLAN_NUM' value=''/></td>");
					$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72002 tr:last").append("<td class='datagrid-cell datagrid-cell-7' style='width:102px;text-align: center;padding:0;'><input type='text' style='width: 102px;padding:0;text-align: right;' maxlength='9' class=' input isSubmit' id='CI_MIN_PACK_"+(trrCount+1)+"' name='MIN_PACK' value='"+$("#CI_MIN_PACK"+$(this).attr("id")).val()+"'/></td>");
					
					$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72002 tr:last").append("<td class='datagrid-cell datagrid-cell-8' style='width:70px;text-align: center;padding:0;'><input type='text' style='width: 70px;padding:0;text-align: right;' maxlength='9' class='_VAL_NULL input isSubmit' id='ITEM_SEQ_"+(trrCount+1)+"' name='ITEM_SEQ' value='0'/></td>");
					$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72002 tr:last").append("<td class='datagrid-cell datagrid-cell-9' style='width:160px;text-align: center;padding:0;'>"+tempHi+tempPr+"</td>");
					$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72002 tr:last").append("<td class='datagrid-cell datagrid-cell-10' style='width:120px;padding:0;'>"+wmsSel+"</td>");
					
					$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72002 tr:last").append("<td class='datagrid-cell datagrid-cell-11' style='width:120px;text-align: center;padding:0;'><input type='text' class=' input isSubmit' maxlength='50' style='width: 120px;padding:0;text-align: right;' id='WRI_LOT_NO_"+(trrCount+1)+"' name='WRI_LOT_NO'/></td>");
					$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72002 tr:last").append("<td class='datagrid-cell datagrid-cell-12' style='width:150px;text-align: center;padding:0;'><input style='width: 100%;padding:0;' name='WRI_PRODUCE_DATE' class=' input isSubmit  _VAL_OjbsData WdateNomorl' onfocus='WdatePicker({skin:\"blue\",dateFmt:\"yyyy-MM-dd\"})'/></td>");
					...
					_tongLineColor(tableTrJs);
					clickTr('datagrid-btable-ajaxd48d2c929e63402f94a2551000c72002');		
				...
				success: function(data){
						...
						if(null != data){
							...
							if(data.returnMsg=="addError"){
								$("#delIds").val(delId);
								//删除行
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72002 :checkbox").each(function(){
									if($(this).attr("checked")){
								...
								reSort("datagrid-btable-ajaxd48d2c929e63402f94a2551000c72002");
								var tableTrJs = $("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72002 tbody tr");
								_tongLineColor(tableTrJs);
								clickTr('datagrid-btable-ajaxd48d2c929e63402f94a2551000c72002');
...
<body>
	...
	<form id="editForm" name="editForm" action="${path}buss/bussModel_editAjaxComm.ms" method="post" target="submitFrame"
		...
		<bu:set name="paraMapObj" value="${dataId}" formId="d48d2c929e63402f94a2551000c72098" type="edit" />
<div class="js-tab">
	...
	<input type="hidden" name="formIds" value="d48d2c929e63402f94a2551000c72098" />
	...
	<input type="hidden" name="d48d2c929e63402f94a2551000c72098" value="paraMap1@" />
	<input type="hidden" name="paraMap1@__LEVEL__" value="1" />
	<input type="hidden" name="paraMap1@__DATA_COUNT__" value="1" />
		<s:set name="_$viewId" value="'821f572a323843079df5386dc14f5469'" />
		<s:set name="_$formId_1" value="'d48d2c929e63402f94a2551000c72098'" />
		<s:set name="_$type" value="'edit'"/>
		<tr>
			<td class="name" /><bu:uitn colNo="WRI_DOC_NUM" formId="d48d2c929e63402f94a2551000c72098" /></td>
			<bu:td cssClass="dec" colNo="WRI_DOC_NUM" formId="d48d2c929e63402f94a2551000c72098" ><bu:ui colNo="WRI_DOC_NUM" style="width:200px;" formId="d48d2c929e63402f94a2551000c72098" dataId="${dataId}" formIndex="1" /></bu:td>
			
			<td class="name" /><bu:uitn colNo="T2#WRD_DOC_TYPE" formId="d48d2c929e63402f94a2551000c72098" /></td>
			<bu:td cssClass="dec" colNo="T2#WRD_DOC_TYPE" formId="d48d2c929e63402f94a2551000c72098" ><bu:ui colNo="T2#WRD_DOC_TYPE" style="width:200px;" formId="d48d2c929e63402f94a2551000c72098" dataId="${dataId}" formIndex="1" /></bu:td>
			
			<td class="name" /><bu:uitn colNo="T2#WRD_DISPATCH_SN" formId="d48d2c929e63402f94a2551000c72098" /></td>
			<bu:td cssClass="dec" style="width:200px;" colNo="T2#WRD_DISPATCH_SN" formId="d48d2c929e63402f94a2551000c72098" ><bu:ui colNo="T2#WRD_DISPATCH_SN" style="width:200px;" formId="d48d2c929e63402f94a2551000c72098" dataId="${dataId}" formIndex="1" /></bu:td>

		</tr>
		<tr>
			<td class="name" /><span class="dot">*</span><bu:uitn colNo="T2#WPD_DELIVERY_DATE" formId="d48d2c929e63402f94a2551000c72098" /></td>
			<bu:td cssClass="dec" colNo="T2#WPD_DELIVERY_DATE" formId="d48d2c929e63402f94a2551000c72098" ><bu:ui colNo="T2#WPD_DELIVERY_DATE" style="width:200px;" formId="d48d2c929e63402f94a2551000c72098" dataId="${dataId}" formIndex="1" /></bu:td>
			
			<td class="name" /><bu:uitn colNo="T2#WRD_URGENT_FLAG" formId="d48d2c929e63402f94a2551000c72098" /></td>
			<bu:td cssClass="dec" colNo="T2#WRD_URGENT_FLAG" formId="d48d2c929e63402f94a2551000c72098" ><bu:ui colNo="T2#WRD_URGENT_FLAG" formId="d48d2c929e63402f94a2551000c72098" dataId="${dataId}" formIndex="1" /></bu:td>
			
			<td class="name" /><bu:uitn colNo="T2#WRD_SUP_CODE" formId="d48d2c929e63402f94a2551000c72098" /></td>
			<bu:td cssClass="dec" colNo="T2#WRD_SUP_CODE" formId="d48d2c929e63402f94a2551000c72098" ><bu:ui colNo="T2#WRD_SUP_CODE" style="width:200px;" formId="d48d2c929e63402f94a2551000c72098" dataId="${dataId}" formIndex="1" /></bu:td>
			
		</tr>
		
		<tr>
			<td class="name" /><bu:uitn colNo="T2#WRD_MEMO" formId="d48d2c929e63402f94a2551000c72098" /></td>
			<bu:td cssClass="dec" colNo="T2#WRD_MEMO" formId="d48d2c929e63402f94a2551000c72098" style="height:80px;" colspan="5"><bu:ui colNo="T2#WRD_MEMO" style="width:100%;height:100%" formId="d48d2c929e63402f94a2551000c72098" dataId="${dataId}" formIndex="1" /></bu:td>
					...
					<div class="datagrid-div2 datagrid-div6 datagrid-view"  id="datagrid-view">
						<div class="datagrid-header" style="width:100%;">
							<div class="datagrid-header-inner head1" style="width:100%;" id="datagrid-header-inner1">
								<table  class="datagrid-htable fixedTable dlist-table table-line " id="datagrid-htabled48d2c929e63402f94a2551000c72002">
									<tbody>
						...
						<div class="datagrid-body datagrid-div3 scroll1"   style="height:390px;">
							<table class="datagrid-htable fixedTable dlist-table table-line" style="table-layout:fixed;"  id="datagrid-btable-ajaxd48d2c929e63402f94a2551000c72002" >
	...
	<div id="backItem" class="dialog-mask" style="z-index:1029px;"/></div>
		<div class="dialog dialog-s1" id="addItem" style="display:none;z-index:1030;margin-left:150px;left:16px;top:10px;width:870px;height:520px;">
    					...
    					<div class="datagrid-div2 datagrid-div6 datagrid-view"  id="datagrid-view">
    						<div class="datagrid-header" style="width:100%;">
    							<div class="datagrid-header-inner head2" style="width:100%;" id="datagrid-header-inner1">
    								<table  class="datagrid-htable fixedTable dlist-table table-line " id="datagrid-htabled48d2c929e63402f94a2551000c72003">
    									<tbody>
    									<tr class="datagrid-header-row datagrid-title-ajax">
    						...
    						<div class="datagrid-body datagrid-div3 scroll2"   style="height:340px;">
    							<table class="datagrid-htable fixedTable dlist-table table-line" style="table-layout:fixed;"  id="datagrid-btable-ajaxd48d2c929e63402f94a2551000c72003" >
    								<tbody id="itemTbody" >
    								</tbody>
    							</table>
    						</div>
			...
			<bu:jsVal formId="d48d2c929e63402f94a2551000c72098" formIndex="1" />
									
			</div>
	</form>	
	</div>
<bu:script viewId="821f572a323843079df5386dc14f5469" />
				...
				success: function(data){
						...
						if(null != data.ajaxList){
							...
							for(var i=0;i<rccList.length;i++){
								...
								var wmsSel = "<select id='wmsSel_"+(trrCount+1)+"' name='wmsSelect' class='wmsSelect input isSubmit _VAL_OjbsData dept_select' style='width:120px;'>"+ wmsOption +"</select>";
								var tempHi = "<input type='hidden' id='paraMap_"+(trrCount+1)+"_WRI_CONNECT_DOC' name='WPI_PO' maxlength='50' class=' input isSubmit  _VAL_OjbsData _VAL_DATABASE' value='"+rccList[i].WRI_CONNECT_DOC+"' style='width: 160px;'>";
					            var tempPr = "<input editname='paraMap1@0#WRI_CONNECT_DOC' textval='paraMap1@0#WRI_CONNECT_DOCSHOW' type='text' id='paraMap_"+(trrCount+1)+"_WRI_CONNECT_DOC_SHOW' maxlength='50'	value='"+rccList[i].WRI_CONNECT_DOC+"' class='input  input isSubmit  _VAL_OjbsData _VAL_DATABASE ico-search-input' style='width: 160px; left: 152px;' onclick='_showCommonTablePage(this,\"929ca143e65f443abcfd37c00a288ce9\",\"42abbfd6d16e4a9dba3dae4289f5bc82\",\"制令单\",\"\",\"%7B%22WP_WIDTH%22%3A400%2C%22WP_HEIGHT%22%3A450%2C%22WP_FULL_SCREEN%22%3A0%7D\",\"4cdc19ef-cf1b-4470-aebf-e0ab62ef63dd\");' onfocus='this.blur()' readonly='readonly'>";
	                            var temps="<tr id='trr"+(trrCount+1)+"' >"
	                                   	 ...
	                                   	 +"<td  style='width:150px;text-align: center;'>"+rccList[i].WRI_ITEM_CODE+"<input type='hidden' id='CI_ITEM_CODE_"+(trrCount+1)+"' class='CI_ITEM_CODE' name='CI_ITEM_CODE' value='"+rccList[i].WRI_ITEM_CODE+"'/></td>"
	                                   	 +"<td  style='width:120px;text-align: center;'>"+rccList[i].CI_ITEM_NAME+"<input type='hidden' name='itemId' value='"+rccList[i].ID+"'/></td>"
	                                   	 +"<td  style='width:120px;text-align: center;'>"+rccList[i].CI_ITEM_SPEC+"<input type='hidden' id='Comparison_"+(trrCount+1)+"' class='Comparison' name='Comparison' value=''/></td>"
	                            ...
	                            $("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72002").append(temps);
	                        //	mySetChosen();//设置下拉框样式
...
function getNounum(thisId){
    ...
    $.ajax({
        ...
        //data:"docNum="+docNum+"&itemCodes="+itemCodes,
        url:dataUrl,
        success:function(data){
            if(null==data){
                return;
...
function editCal(){
  ...
  document.forms.editForm.action = "${path}buss/bussModel_exeFunc.ms?funcMId=1b8ddf4050a94e2589c7b259b3119b1f";
