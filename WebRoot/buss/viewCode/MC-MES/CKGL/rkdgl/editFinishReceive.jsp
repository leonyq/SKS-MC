...
function addItemInfo(){
		util.showLoading("处理中...");
		  $.ajax({
				type: "POST",
			    dataType: "json",
			    url: "buss/bussModel_exeFunc.ms?funcMId=a3f786391ee249099b9713fae57eec1c",//VM-完工入库管理-新增 操作功能 加载机种信息
			    data: "",
				success: function(data){
						...
						if(null != data.ajaxPage.dataList){
							...
							for(var i=0;i<rccList.length;i++){
								...
								$("#datagrid-btable-ajax31690bf77f664ce4bcdc8e341ff03c03 tbody:last").append("<tr id='tr1_"+i+"' ></tr>");
								...
								$("#datagrid-btable-ajax31690bf77f664ce4bcdc8e341ff03c03 tr:last").append("<td class='datagrid-cell datagrid-cell-2' style='width:30px;text-align: center;'><input id='"+(trCount+1)+"' type='checkbox' name='isSelect2'/></td>");
								$("#datagrid-btable-ajax31690bf77f664ce4bcdc8e341ff03c03 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:160px;text-align: center;'>"+rccList[i].PM_MO_NUMBER+"<input type='hidden' id='PROJECT_ID"+(trCount+1)+"' value='"+rccList[i].PM_MO_NUMBER+"'/></td>");
								$("#datagrid-btable-ajax31690bf77f664ce4bcdc8e341ff03c03 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:160px;text-align: center;'>"+rccList[i].PRODUCT_MATERIAL+"<input type='hidden' id='CB_ITEM_CODE"+(trCount+1)+"' value='"+rccList[i].PRODUCT_MATERIAL+"'/></td>");
								$("#datagrid-btable-ajax31690bf77f664ce4bcdc8e341ff03c03 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:160px;text-align: center;'>"+rccList[i].PRODUCT_NAME+"<input type='hidden' id='CI_ITEM_NAME"+(trCount+1)+"' value='"+rccList[i].PRODUCT_NAME+"'/></td>");
								$("#datagrid-btable-ajax31690bf77f664ce4bcdc8e341ff03c03 tr:last").append("<td class='datagrid-cell datagrid-cell-5' style='width:160px;text-align: center;'>"+rccList[i].PRODUCT_STANDARD+"<input type='hidden' id='CI_ITEM_SPEC"+(trCount+1)+"' value='"+rccList[i].PRODUCT_STANDARD+"'/></td>");
								$("#datagrid-btable-ajax31690bf77f664ce4bcdc8e341ff03c03 tr:last").append("<td class='datagrid-cell datagrid-cell-6' style='width:100px;text-align: center;'>"+rccList[i].CUSTOMER+"<input type='hidden' id='CI_MIN_PACK"+(trCount+1)+"' value='"+rccList[i].CI_MIN_PACK+"'/></td>");
								trCount++;
							}
						...
						pageFun(data.ajaxPage,"formId1");
							...
							clickTr('datagrid-btable-ajax31690bf77f664ce4bcdc8e341ff03c03');
...
function searchItemInfo(paginationImpl){
	var isFirstLoad = firstLoadThisPage(paginationImpl);
    	...
    	$.ajax({
			    type: "POST",
			    dataType: "json",
			    url: "buss/bussModel_exeFunc.ms?funcMId=016b0a9f37024e6c85be2b237db2cd20",//VM-完工入库管理-新增 操作功能 机种信息份分页
			    data:{
			     "paraMap.type":"1",
			   ...
			   // data: "paraMap.type=1&paraMap.itemCode="+itemCode+"&paraMap.projectId="+projectId+"&paraMap.itemName="+itemName+"&page.currentPage="+_GLO_FORM_PAGE_MAP[paginationImpl].currentPage+"&page.pageRecord=" + _GLO_FORM_PAGE_MAP[paginationImpl].pageRecord,
				success: function(data){
				                 $("#itemTbody").empty();
						util.closeLoading();
						if(null != data.ajaxPage.dataList){
							...
							for(var i=0;i<rccList.length;i++){
								...
								if(rccList[i].CI_MIN_PACK==null) rccList[i].CI_MIN_PACK="0";
								if(rccList[i].PM_MO_NUMBER==null) rccList[i].PM_MO_NUMBER="";
								$("#datagrid-btable-ajax31690bf77f664ce4bcdc8e341ff03c03 tbody:last").append("<tr id='tr1_"+((currentPage-1)*pageRecord+(i+1))+"' ></tr>");
...
function addItemList(showId,backId){
	...
	$("#itemTbody :checkbox").each(function(){
			if($(this).attr("checked")){
					...
					var tempPr = "<input editname='paraMap1@0#WRI_CONNECT_DOC' textval='paraMap1@0#WRI_CONNECT_DOCSHOW' type='text' id='paraMap"+(trrCount+1)+"_WRI_CONNECT_DOC_SHOW' value='' maxlength='50' class='input  input isSubmit  _VAL_OjbsData _VAL_DATABASE ico-search-input' style='width: 160px; left: 152px;' onclick='_showCommonTablePage(this,\"0d5f2635c2024a4a8d955686c7d88f61\",\"859f3763234c43daa6c0bd0627d012bb\",\"工单号\",\"\",\"%7B%22WP_WIDTH%22%3A400%2C%22WP_HEIGHT%22%3A450%2C%22WP_FULL_SCREEN%22%3A0%7D\",\"b8f80b28-5da9-495b-91f1-84238967c552\");' onfocus='this.blur()' readonly='readonly'>";
					
					$("#datagrid-btable-ajax31690bf77f664ce4bcdc8e341ff03c02 tbody:last").append("<tr id='trr"+(trrCount+1)+"' ></tr>");
					$("#datagrid-btable-ajax31690bf77f664ce4bcdc8e341ff03c02 tr:last").append("<td class='datagrid-cell datagrid-cell-1' style='width:30px;text-align: center;'>"+(len+1)+"<input type='hidden' name='itemId' value=''/></td>");
					$("#datagrid-btable-ajax31690bf77f664ce4bcdc8e341ff03c02 tr:last").append("<td class='datagrid-cell datagrid-cell-2' style='width:30px;text-align: center;'><input type='checkbox' name='isSelect1'/></td>");
					$("#datagrid-btable-ajax31690bf77f664ce4bcdc8e341ff03c02 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:150px;text-align: center;'>"+$("#CB_ITEM_CODE"+$(this).attr("id")).val()+"<input type='hidden' name='CI_ITEM_CODE' value='"+$("#CB_ITEM_CODE"+$(this).attr("id")).val()+"'/></td>");
					$("#datagrid-btable-ajax31690bf77f664ce4bcdc8e341ff03c02 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:120px;text-align: center;'>"+$("#CI_ITEM_NAME"+$(this).attr("id")).val()+"</td>");
					$("#datagrid-btable-ajax31690bf77f664ce4bcdc8e341ff03c02 tr:last").append("<td class='datagrid-cell datagrid-cell-5' style='width:120px;text-align: center;'>"+$("#CI_ITEM_SPEC"+$(this).attr("id")).val()+"</td>");
					$("#datagrid-btable-ajax31690bf77f664ce4bcdc8e341ff03c02 tr:last").append("<td class='datagrid-cell datagrid-cell-6' style='width:90px;text-align: center;padding:0;'><input type='text' style='width: 90px;padding:0;text-align: right;' maxlength='9' class='_VAL_NULL input isSubmit' id='PLAN_NUM_"+(trrCount+1)+"' name='PLAN_NUM' value=''/></td>");
					$("#datagrid-btable-ajax31690bf77f664ce4bcdc8e341ff03c02 tr:last").append("<td class='datagrid-cell datagrid-cell-7' style='width:102px;text-align: center;padding:0;'><input type='text' style='width: 102px;padding:0;text-align: right;' maxlength='9' class=' input isSubmit' id='CI_MIN_PACK_"+(trrCount+1)+"' name='MIN_PACK' value='"+$("#CI_MIN_PACK"+$(this).attr("id")).val()+"'/></td>");
					$("#datagrid-btable-ajax31690bf77f664ce4bcdc8e341ff03c02 tr:last").append("<td class='datagrid-cell datagrid-cell-8' style='width:70px;text-align: center;padding:0;'><input type='text' style='width: 70px;padding:0;text-align: right;' maxlength='9' class='_VAL_NULL input isSubmit' id='ITEM_SEQ_"+(trrCount+1)+"' name='ITEM_SEQ' value='0'/></td>");
					$("#datagrid-btable-ajax31690bf77f664ce4bcdc8e341ff03c02 tr:last").append("<td class='datagrid-cell datagrid-cell-9' style='width:160px;text-align: center;padding:0;'>"+$("#PROJECT_ID"+$(this).attr("id")).val()+"<input type='hidden' name='WPI_PO' value='"+$("#PROJECT_ID"+$(this).attr("id")).val()+"'/></td>");
					$("#datagrid-btable-ajax31690bf77f664ce4bcdc8e341ff03c02 tr:last").append("<td class='datagrid-cell datagrid-cell-10' style='width:120px;padding:0;'>"+wmsSel+"</td>");
					$("#datagrid-btable-ajax31690bf77f664ce4bcdc8e341ff03c02 tr:last").append("<td class='datagrid-cell datagrid-cell-11' style='width:120px;text-align: center;padding:0;'><input type='text' class=' input isSubmit' maxlength='50' style='width: 120px;padding:0;text-align: right;' id='WRI_LOT_NO_"+(trrCount+1)+"' name='WRI_LOT_NO'/></td>");
					$("#datagrid-btable-ajax31690bf77f664ce4bcdc8e341ff03c02 tr:last").append("<td class='datagrid-cell datagrid-cell-12' style='width:150px;text-align: center;padding:0;'><input style='width: 100%;padding:0;' name='WRI_PRODUCE_DATE' class=' input isSubmit  _VAL_OjbsData WdateNomorl' onfocus='WdatePicker({skin:\"blue\",dateFmt:\"yyyy-MM-dd\"})'/></td>");
					...
					_tongLineColor(tableTrJs);
					clickTr('datagrid-btable-ajax31690bf77f664ce4bcdc8e341ff03c02');	
				...
				success: function(data){
						...
						if(null != data){
							...
							if(data.returnMsg=="addSucc"){
								utilsFp.confirmIcon(3,"","","", "<dict:lang value="有明细的机种不允许删除" />",0,"300","");
								return;
							}
							if(data.returnMsg=="addError"){
								$("#delIds").val(delId);
								//删除行
								$("#datagrid-btable-ajax31690bf77f664ce4bcdc8e341ff03c02 :checkbox").each(function(){
									if($(this).attr("checked")){
								...
								reSort("datagrid-btable-ajax31690bf77f664ce4bcdc8e341ff03c02");
								var tableTrJs = $("#datagrid-btable-ajax31690bf77f664ce4bcdc8e341ff03c02 tbody tr");
								_tongLineColor(tableTrJs);
								clickTr('datagrid-btable-ajax31690bf77f664ce4bcdc8e341ff03c02');
								defTableWidthRewrite('31690bf77f664ce4bcdc8e341ff03c02');
...
<body>
 ...
 <div class="js-tab">
	...
	<input type="hidden" name="paraMap1@__DATA_COUNT__" value="1" />
		<s:set name="_$viewId" value="'d7631595b35645b9929f3fb9b83ab717'" />
		...
		<tr>
			...
			<td class="name" /><bu:uitn colNo="T2#WRD_DOC_TYPE" formId="31690bf77f664ce4bcdc8e341ff03c79" /></td>
			<bu:td cssClass="dec" colNo="T2#WRD_DOC_TYPE" formId="31690bf77f664ce4bcdc8e341ff03c79" ><bu:ui colNo="T2#WRD_DOC_TYPE" style="width:200px;" formId="31690bf77f664ce4bcdc8e341ff03c79" dataId="${dataId}" formIndex="1" /></bu:td>
			
			<td class="name" /><bu:uitn colNo="T2#WRD_DISPATCH_SN" formId="31690bf77f664ce4bcdc8e341ff03c79" /></td>
			<bu:td cssClass="dec" style="width:200px;" colNo="T2#WRD_DISPATCH_SN" formId="31690bf77f664ce4bcdc8e341ff03c79" ><bu:ui colNo="T2#WRD_DISPATCH_SN" style="width:200px;" formId="31690bf77f664ce4bcdc8e341ff03c79" dataId="${dataId}" formIndex="1" /></bu:td>
		
		</tr>
		<tr style="display:none;">
		<td class="name" /><bu:uitn colNo="WRI_CONNECT_DOC" formId="31690bf77f664ce4bcdc8e341ff03c79" /></td>
			<bu:td cssClass="dec" colNo="WRI_CONNECT_DOC" formId="31690bf77f664ce4bcdc8e341ff03c79" ><bu:ui colNo="WRI_CONNECT_DOC" style="width:200px;" formId="31690bf77f664ce4bcdc8e341ff03c79" dataId="${dataId}" formIndex="1" /></bu:td>
			
		</tr>
		<tr>
			<td class="name" /><span class="dot">*</span><bu:uitn colNo="T2#WPD_DELIVERY_DATE" formId="31690bf77f664ce4bcdc8e341ff03c79" /></td>
			...
			<bu:td cssClass="dec" colNo="T2#WRD_URGENT_FLAG" formId="31690bf77f664ce4bcdc8e341ff03c79" ><bu:ui colNo="T2#WRD_URGENT_FLAG" formId="31690bf77f664ce4bcdc8e341ff03c79" dataId="${dataId}" formIndex="1" /></bu:td>
			
			<td class="name" /><bu:uitn colNo="T2#WRD_CUST_CODE" formId="31690bf77f664ce4bcdc8e341ff03c79" /></td>
			<bu:td cssClass="dec" colNo="T2#WRD_CUST_CODE" formId="31690bf77f664ce4bcdc8e341ff03c79" ><bu:ui colNo="T2#WRD_CUST_CODE" style="width:200px;" formId="31690bf77f664ce4bcdc8e341ff03c79" dataId="${dataId}" formIndex="1" /></bu:td>
			...
			<div class="mod-bd" style="margin-top:5px;border-bottom: none;height:500px;">
				<div class="panel datagrid datagrid-div1">
					<div class="datagrid-div2 datagrid-div6 datagrid-view"  id="datagrid-view">
						...
						<div class="datagrid-body datagrid-div3 scroll1"   style="height:390px;">
	...
	<div id="backItem" class="dialog-mask" style="z-index:1029px;"/></div>
		<div class="dialog dialog-s1" id="addItem" style="display:none;z-index:1030;margin-left:150px;left:16px;top:10px;width:870px;height:500px;">
			<div class="dialog-hd">
			<h3 class="tit">
			<dict:lang value="选择机种" />
				...
				<div class="dialog-bd-div" style="width:100%;height:calc(100% - 3px);">
				...
				<table class="basic-table">
				 <tr>
			    	...
			    	<tr>
			    	<td class="name" /><dict:lang value="制令单号"/></td>
					<td class="dec"><input type="text" id="projectId" name="projectId" class=" input isSubmit isaddSubmit"/></td>
			    	</tr>
			    	</table>
    					...
    					<div class="datagrid-div2 datagrid-div6 datagrid-view"  id="datagrid-view">
    						<div class="datagrid-header" style="width:100%;">
    							<div class="datagrid-header-inner head2" style="width:100%;" id="datagrid-header-inner1">
    								<table  class="datagrid-htable fixedTable  dlist-table table-line " id="datagrid-htable31690bf77f664ce4bcdc8e341ff03c03">
    									<tbody>
    									<tr class="datagrid-header-row datagrid-title-ajax">
    										<td style="width: 30px;text-align: center;"></td>
                							<td style="width: 30px;text-align: center;"><input type="checkbox" id="item_list_cb"  onchange="getAllItem();" /></td>
                							<td style="width: 160px;text-align: center;"><dict:lang value="制令单号" /></td>
                							...
                							<td style="width: 160px;text-align: center;"><dict:lang value="规格" /></td>
                							<td style="width: 100px;text-align: center;"><dict:lang value="客户" /></td>
    									</tr>
    									</tbody>		
    								</table>
    							</div>
    						</div>
    						<div class="datagrid-body datagrid-div3 scroll2"   style="height:320px;">
    							<table class="datagrid-btable fixedTable dlist-table table-line" style="table-layout:fixed;"  id="datagrid-btable-ajax31690bf77f664ce4bcdc8e341ff03c03"  >
    								<tbody id="itemTbody" >
    								</tbody>
    							</table>
    						</div>
			    	...
			    	<table style="width:100%;" class="dlist-table table-line " >
						<thead>
						<tr>
			    			<th style="width: 30px;text-align: center;"></th>
							<th style="width: 30px;text-align: center;"><input type="checkbox" id="item_list_cb"  onchange="getAllItem();" /></th>
							<th style="width: 160px;text-align: center;"><dict:lang value="制令单号" /></th>
							<th style="width: 160px;text-align: center;"><dict:lang value="机种料号" /></th>
							<th style="width: 160px;text-align: center;"><dict:lang value="机种名称" /></th>
							<th style="width: 160px;text-align: center;"><dict:lang value="规格" /></th>
							<th style="text-align: center;"><dict:lang value="客户" /></th>
						</tr>
			    	</thead>
			    	</table>
			    	</div>
			    	<div style="width:870px;height:calc(100% - 140px);overflow-y: auto;overflow-x: hidden;" class="scroll">  
...
<bu:script viewId="d7631595b35645b9929f3fb9b83ab717" />
				...
				success: function(data){
						...
						if(null != data.ajaxList){
							...
							for(var i=0;i<rccList.length;i++){
								...
								var wmsSel = "<select id='wmsSel_"+(trrCount+1)+"' name='wmsSelect' class='wmsSelect input isSubmit _VAL_OjbsData dept_select' style='width:120px;'>"+ wmsOption +"</select>";
								var tempHi = "<input type='hidden' id='paraMap"+(trrCount+1)+"_WRI_CONNECT_DOC' name='WPI_PO' maxlength='50' class=' input isSubmit  _VAL_OjbsData _VAL_DATABASE' value='"+rccList[i].WRI_CONNECT_DOC+"' style='width: 160px;'>";
					            var tempPr = "<input editname='paraMap1@0#WRI_CONNECT_DOC' textval='paraMap1@0#WRI_CONNECT_DOCSHOW' type='text' id='paraMap"+(trrCount+1)+"_WRI_CONNECT_DOC_SHOW' maxlength='50' value='"+rccList[i].WRI_CONNECT_DOC+"' class='input  input isSubmit  _VAL_OjbsData _VAL_DATABASE ico-search-input' style='width: 160px; left: 152px;' onclick='_showCommonTablePage(this,\"0d5f2635c2024a4a8d955686c7d88f61\",\"859f3763234c43daa6c0bd0627d012bb\",\"工单号\",\"\",\"%7B%22WP_WIDTH%22%3A400%2C%22WP_HEIGHT%22%3A450%2C%22WP_FULL_SCREEN%22%3A0%7D\",\"b8f80b28-5da9-495b-91f1-84238967c552\");' onfocus='this.blur()' readonly='readonly'>";
					            /*
								...
								$("#itemInfo tr:last").append("<td class='datagrid-cell datagrid-cell-2' style='width:30px;text-align: center;'><input type='checkbox' name='isSelect1' value='"+rccList[i].ID+"'/></td>");
								...
								$("#itemInfo tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:120px;text-align: center;'>"+rccList[i].CI_ITEM_NAME+"<input type='hidden' name='itemId' value='"+rccList[i].ID+"'/></td>");
								...
								$("#itemInfo tr:last").append("<td class='datagrid-cell datagrid-cell-6' style='width:90px;text-align: center;padding:0;'><input type='text' style='width: 90px;padding:0;text-align: right;' maxlength='9' class='_VAL_NULL input isSubmit' id='PLAN_NUM_"+(trrCount+1)+"' name='PLAN_NUM' value='"+rccList[i].WRI_PLAN_NUM+"'/></td>");
								$("#itemInfo tr:last").append("<td class='datagrid-cell datagrid-cell-7' style='width:90px;text-align: center;padding:0;'><input type='text' style='width: 90px;padding:0;text-align: right;' maxlength='9' class=' input isSubmit' id='CI_MIN_PACK_"+(trrCount+1)+"' name='MIN_PACK' value='"+rccList[i].WRI_PACK_NUM+"'/></td>");

								$("#itemInfo tr:last").append("<td class='datagrid-cell datagrid-cell-8' style='width:70px;text-align: center;padding:0;'><input type='text' style='width: 70px;padding:0;text-align: right;' maxlength='9' class='_VAL_NULL input isSubmit' id='ITEM_SEQ_"+(trrCount+1)+"' name='ITEM_SEQ' value='"+rccList[i].WRI_ITEM_SEQ+"'/></td>");
								//$("#itemInfo tr:last").append("<td class='datagrid-cell datagrid-cell-9' style='width:160px;text-align: center;padding:0;'><input type='text' style='width: 160px;padding:0;' maxlength='50' class=' input isSubmit' id='WPI_PO_"+(trrCount+1)+"' name='WPI_PO' value='"+rccList[i].WRI_CONNECT_DOC+"'/></td>");
								$("#itemInfo tr:last").append("<td class='datagrid-cell datagrid-cell-9' style='width:160px;text-align: center;padding:0;'>"+rccList[i].WRI_CONNECT_DOC+"<input type='hidden'  name='WPI_PO' value='"+rccList[i].WRI_CONNECT_DOC+"'/></td>");
								$("#itemInfo tr:last").append("<td class='datagrid-cell datagrid-cell-10' style='width:120px;padding:0;'>"+wmsSel+"</td>");

								$("#itemInfo tr:last").append("<td class='datagrid-cell datagrid-cell-11' style='width:120px;text-align: center;padding:0;'><input type='text' class=' input isSubmit' maxlength='50' style='width: 120px;padding:0;text-align: right;' id='WRI_LOT_NO_"+(trrCount+1)+"' name='WRI_LOT_NO' value='"+rccList[i].WRI_LOT_NO+"'/></td>");
								$("#itemInfo tr:last").append("<td class='datagrid-cell datagrid-cell-12' style='text-align: center;padding:0;'><input style='width: 100%;padding:0;' name='WRI_PRODUCE_DATE' class=' input isSubmit  _VAL_OjbsData WdateNomorl' onfocus='WdatePicker({skin:\"blue\",dateFmt:\"yyyy-MM-dd\"})' value='"+rccList[i].PRODUCE_DATE+"'/></td>");
							    	*/
							    var temps="<tr id='trr"+(trrCount+1)+"' class='diyclass' >"
							             ...
							             +"<td  style='width:150px;text-align: center;padding:0;'><input style='width: 100%;padding:0;' name='WRI_PRODUCE_DATE' class=' input isSubmit  _VAL_OjbsData WdateNomorl' onfocus='WdatePicker({skin:\"blue\",dateFmt:\"yyyy-MM-dd\"})' value='"+rccList[i].PRODUCE_DATE+"'/></td>"
...
function clickTr(tableId){
  ...
  document.forms.editForm.action = "${path}buss/bussModel_exeFunc.ms?funcMId=4196efee802748d2a7b36fa952f45544";
  document.forms.editForm.submit();
}
