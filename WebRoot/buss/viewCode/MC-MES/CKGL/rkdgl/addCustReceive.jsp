				...
				success: function(data){
						...
						if(null != data.ajaxPage.dataList){
							...
							for(var i=0;i<rccList.length;i++){
								...
								$("#datagrid-btable-ajaxe633154263d04ccaa225a43048997e03 tr:last").append("<td class='datagrid-cell datagrid-cell-7' style='width:150px;text-align: center;'>"+rccList[i].ITEM_TYPE+"<input type='hidden' id='CI_MIN_PACK"+(trCount+1)+"' value='"+rccList[i].CI_MIN_PACK+"'/></td>");
								trCount++;
							}
...
function addItemList(showId,backId){
	...
	$("#itemTbody :checkbox").each(function(){
			if($(this).attr("checked")){
					...
					$("#datagrid-btable-ajaxe633154263d04ccaa225a43048997e02 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:150px;text-align: center;'>"+$("#CI_ITEM_CODE"+$(this).attr("id")).val()+"<input type='hidden' name='CI_ITEM_CODE' value='"+$("#CI_ITEM_CODE"+$(this).attr("id")).val()+"'/></td>");
					...
					$("#datagrid-btable-ajaxe633154263d04ccaa225a43048997e02 tr:last").append("<td class='datagrid-cell datagrid-cell-8' style='width:90px;text-align: center;padding:0;'><input type='text' style='width: 90px;padding:0;text-align: right;' maxlength='9' class=' input isSubmit' id='GIFT_NUM_"+(trrCount+1)+"' name='GIFT_NUM' value='0'/></td>");
					$("#datagrid-btable-ajaxe633154263d04ccaa225a43048997e02 tr:last").append("<td class='datagrid-cell datagrid-cell-9' style='width:70px;text-align: center;padding:0;'><input type='text' style='width: 70px;padding:0;text-align: right;' maxlength='9' class='_VAL_NULL input isSubmit' id='ITEM_SEQ_"+(trrCount+1)+"' name='ITEM_SEQ' value='0'/></td>");
					$("#datagrid-btable-ajaxe633154263d04ccaa225a43048997e02 tr:last").append("<td class='datagrid-cell datagrid-cell-10' style='width:160px;text-align: center;padding:0;'><input type='text' style='width: 160px;padding:0;' maxlength='50' class=' input isSubmit' id='WPI_PO_"+(trrCount+1)+"' name='WPI_PO' value=''/></td>");
					$("#datagrid-btable-ajaxe633154263d04ccaa225a43048997e02 tr:last").append("<td class='datagrid-cell datagrid-cell-11' style='width:120px;padding:0;'>"+wmsSel+"</td>");
					$("#datagrid-btable-ajaxe633154263d04ccaa225a43048997e02 tr:last").append("<td class='datagrid-cell datagrid-cell-12' style='width:120px;text-align: center;padding:0;'><input style='width: 120px;padding:0;' name='WRI_DELIVERY_DATE' class=' input isSubmit  _VAL_OjbsData WdateNomorl' onfocus='WdatePicker({skin:\"blue\",dateFmt:\"yyyy-MM-dd\"})'/></td>");
					$("#datagrid-btable-ajaxe633154263d04ccaa225a43048997e02 tr:last").append("<td class='datagrid-cell datagrid-cell-13' style='width:120px;text-align: center;padding:0;'><input type='text' class=' input isSubmit' maxlength='50' style='width: 120px;padding:0;text-align: right;' id='WRI_LOT_NO_"+(trrCount+1)+"' name='WRI_LOT_NO'/></td>");
					$("#datagrid-btable-ajaxe633154263d04ccaa225a43048997e02 tr:last").append("<td class='datagrid-cell datagrid-cell-14' style='width:150px;text-align: center;padding:0;'><input style='width: 100%;padding:0;' name='WRI_PRODUCE_DATE' class=' input isSubmit  _VAL_OjbsData WdateNomorl' onfocus='WdatePicker({skin:\"blue\",dateFmt:\"yyyy-MM-dd\"})'/></td>");
...
$(function(){
	getWmsSel();
	$(document.getElementById('paraMap1_T2#WRD_DOC_TYPE')).val("DJ04");
})
var wmsOption;
//获取仓库信息
function getWmsSel(){
...
<body>
	...
	<input type="hidden" name="formId" id="formId2" value='e633154263d04ccaa225a43048997e03'/>
	<input type="hidden" name="e633154263d04ccaa225a43048997e75" value="paraMap1@" />
	<input type="hidden" name="paraMap1@__LEVEL__" value="1" />
	<input type="hidden" name="paraMap1@__DATA_COUNT__" value="1" />
		<s:set name="_$viewId" value="'e59dda304ff945abb2dc71192841023f'" />
		...
		<tr>
			...
			<bu:td cssClass="dec" colNo="T2#WRD_DOC_TYPE" formId="24b1b1adf7b54d90865c4b39ac6f971e" ><bu:ui colNo="T2#WRD_DOC_TYPE" style="width:200px;" formId="24b1b1adf7b54d90865c4b39ac6f971e" value="%{T2#WRD_DOC_TYPE}" formIndex="1" /></bu:td>
			
			<td class="name" /><bu:uitn colNo="T2#WRD_DISPATCH_SN" formId="24b1b1adf7b54d90865c4b39ac6f971e" /></td>
			<bu:td cssClass="dec" style="width:200px;" colNo="T2#WRD_DISPATCH_SN" formId="24b1b1adf7b54d90865c4b39ac6f971e" ><bu:ui colNo="T2#WRD_DISPATCH_SN" style="width:200px;" formId="24b1b1adf7b54d90865c4b39ac6f971e" value="%{T2#WRD_DISPATCH_SN}" formIndex="1" /></bu:td>
				...
				<div class="panel datagrid datagrid-div1">
					<div class="datagrid-div2 datagrid-div6 datagrid-view"  id="datagrid-view">
						...
						<div class="datagrid-body datagrid-div3 scroll1"   style="height:385px;">
							<table class="datagrid-htable fixedTable dlist-table table-line" style="table-layout:fixed;"  id="datagrid-btable-ajaxe633154263d04ccaa225a43048997e02" >
...
<bu:script viewId="e59dda304ff945abb2dc71192841023f" />
...
function addCal(){      
			...
			$("#saveBtn").prop("disabled","disabled");
                        ...
                        document.forms.addForm.action = "${path}buss/bussModel_exeFunc.ms?funcMId=b8ed92a91b674c21b95afd7672459a53";
