...
<body>
    <div class="content-in">
		...
		<bu:tr cssClass="datagrid-header-row datagrid-title-ajax" id="datagrid-title-ajax">
		    ...
		    <td class="datagrid-cell" style="width:200px;"><bu:uitn colNo="DATA_AUTH" formId="31690bf77f664ce4bcdc8e341ff03c79" /></td>
			...
			<td class="datagrid-cell" style="width:110px;"><bu:uitn colNo="T2#WRD_ERP_FLAG" formId="31690bf77f664ce4bcdc8e341ff03c79" /></td>
			...
			<td class="datagrid-cell" style="width:120px;"><bu:uitn colNo="WRI_PACK_NUM" formId="31690bf77f664ce4bcdc8e341ff03c79" /></td>
	...
	$.ajax({
				...
				success: function(data){
						...
						if(null != data.ajaxPage.dataList){
							...
							//	$("#datagrid-btable-ajax31690bf77f664ce4bcdc8e341ff03c02 tr:last").append("<td class='datagrid-cell datagrid-cell-2' style='width:250px;text-align: center;' title='"+rccList[i].DATAAUTH+"'>"+rccList[i].DATAAUTH+"</td>");
								$("#datagrid-btable-ajax31690bf77f664ce4bcdc8e341ff03c02 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:250px;text-align: center;' title='"+rccList[i].WRD_ITEM_SN+"'><span onclick='itemJump1(\""+rccList[i].WRD_ITEM_SN+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].WRD_ITEM_SN+"</span></td>");
								$("#datagrid-btable-ajax31690bf77f664ce4bcdc8e341ff03c02 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:150px;text-align: center;' title='"+rccList[i].WRD_ITEM_CODE+"'><span onclick='itemJump2(\""+rccList[i].WRD_ITEM_CODE+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].WRD_ITEM_CODE+"</span></td>");
    	...
    	$.ajax({
				...
				success: function(data){
						...
						if(null != data.ajaxPage.dataList){
							...
							//	$("#datagrid-btable-ajax31690bf77f664ce4bcdc8e341ff03c02 tr:last").append("<td class='datagrid-cell datagrid-cell-2' style='width:250px;text-align: center;' title='"+rccList[i].DATAAUTH+"'>"+rccList[i].DATAAUTH+"</td>");
							    $("#datagrid-btable-ajax31690bf77f664ce4bcdc8e341ff03c02 tr:last").append("<td class='datagrid-cell datagrid-cell-2' style='text-align: center;width:200px;' title='"+rccList[i].DATAAUTH+"'>"+rccList[i].DATAAUTH+"<input type='hidden' id='DATA_AUTH_ID_"+rccList[i].ID+"' value='"+rccList[i].DATA_AUTH2+"' /></td>");//rccList[i].DATA_AUTH3
								$("#datagrid-btable-ajax31690bf77f664ce4bcdc8e341ff03c02 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:250px;text-align: center;' title='"+rccList[i].WRD_ITEM_SN+"'><span onclick='itemJump1(\""+rccList[i].WRD_ITEM_SN+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].WRD_ITEM_SN+"</span></td>");
								$("#datagrid-btable-ajax31690bf77f664ce4bcdc8e341ff03c02 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:150px;text-align: center;' title='"+rccList[i].WRD_ITEM_CODE+"'><span onclick='itemJump2(\""+rccList[i].WRD_ITEM_CODE+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].WRD_ITEM_CODE+"</span></td>");
								$("#datagrid-btable-ajax31690bf77f664ce4bcdc8e341ff03c02 tr:last").append("<td class='datagrid-cell datagrid-cell-5' style='width:150px;text-align: center;' title='"+rccList[i].CI_ITEM_NAME+"'>"+rccList[i].CI_ITEM_NAME+"</td>");
								$("#datagrid-btable-ajax31690bf77f664ce4bcdc8e341ff03c02 tr:last").append("<td class='datagrid-cell datagrid-cell-6' style='width:150px;text-align: center;' title='"+rccList[i].CI_ITEM_SPEC+"'>"+rccList[i].CI_ITEM_SPEC+"</td>");
...
function searchItemDetail(){
	...
	//var supCode = $(document.getElementById('T5#CUSTOMER')).val();
				...
				success: function(data){
						...
						if(null != data.ajaxPage.dataList){
							...
							for(var i = 0;i < rccList.length; i++){
								...
								//$("#datagrid-btable-ajax31690bf77f664ce4bcdc8e341ff03c03 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:250px;text-align: center;' title='"+rccList[i].DATAAUTH+"'>"+rccList[i].DATAAUTH+"</td>");
								$("#datagrid-btable-ajax31690bf77f664ce4bcdc8e341ff03c03 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='text-align: center;width:200px;' title='"+rccList[i].DATAAUTH+"'>"+rccList[i].DATAAUTH+"<input type='hidden' id='DATA_AUTH_ID_"+rccList[i].ID+"' value='"+rccList[i].DATA_AUTH2+"' /></td>");//ccList[i].DATA_AUTH3
								$("#datagrid-btable-ajax31690bf77f664ce4bcdc8e341ff03c03 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:250px;text-align: center;' title='"+rccList[i].WRD_ITEM_SN+"'><span onclick='itemJump1(\""+rccList[i].WRD_ITEM_SN+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].WRD_ITEM_SN+"</span></td>");
								$("#datagrid-btable-ajax31690bf77f664ce4bcdc8e341ff03c03 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:150px;text-align: center;' title='"+rccList[i].WRD_ITEM_CODE+"'><span onclick='itemJump2(\""+rccList[i].WRD_ITEM_CODE+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].WRD_ITEM_CODE+"</span></td>");
    	...
    	$.ajax({
				...
				success: function(data){
						...
						if(null != data.ajaxPage.dataList){
							...
							//	$("#datagrid-btable-ajax31690bf77f664ce4bcdc8e341ff03c03 tr:last").append("<td class='datagrid-cell datagrid-cell-2' style='width:250px;text-align: center;' title='"+rccList[i].DATAAUTH+"'>"+rccList[i].DATAAUTH+"</td>");
							    $("#datagrid-btable-ajax31690bf77f664ce4bcdc8e341ff03c03 tr:last").append("<td class='datagrid-cell datagrid-cell-2' style='text-align: center;width:200px;' title='"+rccList[i].DATAAUTH+"'>"+rccList[i].DATAAUTH+"<input type='hidden' id='DATA_AUTH_ID_"+rccList[i].ID+"' value='"+rccList[i].DATA_AUTH2+"' /></td>");//rccList[i].DATA_AUTH3
								$("#datagrid-btable-ajax31690bf77f664ce4bcdc8e341ff03c03 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:250px;text-align: center;' title='"+rccList[i].WRD_ITEM_SN+"'><span onclick='itemJump1(\""+rccList[i].WRD_ITEM_SN+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].WRD_ITEM_SN+"</span></td>");
								$("#datagrid-btable-ajax31690bf77f664ce4bcdc8e341ff03c03 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:150px;text-align: center;' title='"+rccList[i].WRD_ITEM_CODE+"'><span onclick='itemJump2(\""+rccList[i].WRD_ITEM_CODE+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].WRD_ITEM_CODE+"</span></td>");
								$("#datagrid-btable-ajax31690bf77f664ce4bcdc8e341ff03c03 tr:last").append("<td class='datagrid-cell datagrid-cell-5' style='width:150px;text-align: center;' title='"+rccList[i].CI_ITEM_NAME+"'>"+rccList[i].CI_ITEM_NAME+"</td>");
								$("#datagrid-btable-ajax31690bf77f664ce4bcdc8e341ff03c03 tr:last").append("<td class='datagrid-cell datagrid-cell-6' style='width:150px;text-align: center;' title='"+rccList[i].CI_ITEM_SPEC+"'>"+rccList[i].CI_ITEM_SPEC+"</td>");
    ...
    if(formId=='31690bf77f664ce4bcdc8e341ff03c79'){<%--FM-完工入库单物料信息--%>
        ...
        $.each(uiTxt,function(i,v){
           ...
           arrHtml.push("<td colno='DATA_AUTH' class='datagrid-cell TD_DATA_AUTH"+ms.tdClass(formId, 'DATA_AUTH')+"' style='width:200px;text-align:center;"+ms.tdStyle(formId, 'DATA_AUTH')+"' "+ms.tdEvent(formId, 'DATA_AUTH')+">")		
            ...
            arrHtml.push("<span colno='WRI_ITEM_CODE' class='"+ms.uiClass(formId, 'WRI_ITEM_CODE')+"' onclick='itemJump2(\""+v['WRI_ITEM_CODE']+"\")' style='display: inline;border-bottom: 1px solid #004098;' "+ms.uiEvent(formId, 'WRI_ITEM_CODE')+" title='"+ms.titleAttr(formId,'WRI_ITEM_CODE','IS_TITLE_ATTR',v)+"' >"+v['WRI_ITEM_CODE']+"</span>")
            arrHtml.push("</td>");
            ...
            arrHtml.push("<span colno='WRI_CONNECT_DOC' class='"+ms.uiClass(formId, 'WRI_CONNECT_DOC')+"' onclick='itemJump3(\""+v['WRI_CONNECT_DOC']+"\")' style='display: inline;border-bottom: 1px solid #004098;' "+ms.uiEvent(formId, 'WRI_CONNECT_DOC')+" title='"+ms.titleAttr(formId,'WRI_CONNECT_DOC','IS_TITLE_ATTR',v)+"' >"+v['WRI_CONNECT_DOC']+"</span>")
            arrHtml.push("</td>");
...
function searchReceive(){
    var url = "${path}buss/bussModel_exeFunc.ms?funcMId=f0c586d5a7d649beb36310a87267b459";//VM-完工入库管理 操作功能 完工入库单信息
    var dataAuth = $("#DATA_AUTH").val();
	var itemCode = $.trim($("#WRI_ITEM_CODE_SHOW").val());
	var docNum = $.trim($("#WRI_DOC_NUM").val());
	//var supCode = $(document.getElementById('T5#CUSTOMER')).val();
            ...
            if(null!=data.ajaxPage.dataList){
                ...
                console.log(list);
                    for(var i=0; i<list.length;i++){
						...
						$("#addReceive tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='text-align: left;width:140px;' title='"+list[i].WRD_DOC_NUM+"'>"+list[i].WRD_DOC_NUM+"</td>");
						$("#addReceive tr:last").append("<td class='datagrid-cell datagrid-cell-5' style='text-align: center;width:100px;' title='"+list[i].WDT_TYPE_NAME+"'>"+list[i].WDT_TYPE_NAME+"</td>");
						$("#addReceive tr:last").append("<td class='datagrid-cell datagrid-cell-6' style='text-align: center;width:90px;' >"+tempType+"<input type='hidden' id='state_"+list[i].WRD_DOC_NUM+"' value='"+list[i].WRD_STATUS+"'></td>");
						$("#addReceive tr:last").append("<td class='datagrid-cell datagrid-cell-7' style='text-align: center;width:90px;' >"+tempCheck+"</td>");
						$("#addReceive tr:last").append("<td class='datagrid-cell datagrid-cell-8' style='text-align: center;width:90px;' >"+tempFreeze+"</td>");
						
						$("#addReceive tr:last").append("<td class='datagrid-cell datagrid-cell-9' style='text-align: left;width:110px;' >"+list[i].CUSTOMER+"</td>");
						
						$("#addReceive tr:last").append("<td class='datagrid-cell datagrid-cell-10' style='text-align: center;width:140px;' >"+list[i].DELIVERY_DATE+"</td>");
...
var supCode = $.trim($(document.getElementById('T5#CUSTOMER')).val());
	var connectDoc = $.trim($("#WRI_CONNECT_DOC").val());
	console.log("connectDoc==>",connectDoc);
	var itemStatus = $("#WRI_STATUS").val();
	var beginTime = $(document.getElementById('T2#WRD_CREATE_TIME_BEGIN')).val();
	var endTime = $(document.getElementById('T2#WRD_CREATE_TIME_END')).val();
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(type==1){
                ...
                var url = "${path}buss/bussModel_exeFunc.ms?FUNC_CODE=F6743&funcMId=bcf650ecef104053af109208f9f520ba&formId=31690bf77f664ce4bcdc8e341ff03c79&dataId="+dateId+"&trDataAuth="+trDataAuth+"&iframeId="+_currentFrame;			
