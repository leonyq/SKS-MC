...
$(function(){
	getWmsSel();
	$(document.getElementById('paraMap1_T2#WRD_DOC_TYPE')).val("DJ06");
})
var wmsOption;
//获取仓库信息
function getWmsSel(){
...
<body>
	...
	<input type="hidden" name="paraMap1@__DATA_COUNT__" value="1" />
		<s:set name="_$viewId" value="'db44decb4a774871b6cf0a1b03e16465'" />
		...
		<tr>
			...
			<bu:td cssClass="dec" colNo="T2#WRD_DOC_TYPE" formId="2f1adeb396c4403b8fea545ec6317938" ><bu:ui colNo="T2#WRD_DOC_TYPE" style="width:200px;" formId="2f1adeb396c4403b8fea545ec6317938" value="%{T2#WRD_DOC_TYPE}" formIndex="1" /></bu:td>
			
			<td class="name" /><bu:uitn colNo="T2#WRD_DISPATCH_SN" formId="2f1adeb396c4403b8fea545ec6317938" /></td>
			<bu:td cssClass="dec" style="width:200px;" colNo="T2#WRD_DISPATCH_SN" formId="2f1adeb396c4403b8fea545ec6317938" ><bu:ui colNo="T2#WRD_DISPATCH_SN" style="width:200px;" formId="2f1adeb396c4403b8fea545ec6317938" value="%{T2#WRD_DISPATCH_SN}" formIndex="1" /></bu:td>
		...
		<tr>	
        	...
        	<td class="name" /><span class="dot">*</span><bu:uitn colNo="DEPT_ID" formId="e633154263d04ccaa225a43048997e75" /></td>
			<bu:td cssClass="dec" colNo="DEPT_ID" formId="e633154263d04ccaa225a43048997e75" ><bu:ui colNo="DEPT_ID" style="width:200px;" formId="e633154263d04ccaa225a43048997e75" value="%{DEPT_ID}" formIndex="1" /></bu:td>
		    <!--		
            <td class="name" /><span class="dot">*</span><bu:uitn colNo="ACCOUNT_ID" formId="e633154263d04ccaa225a43048997e75" /></td>
			<bu:td cssClass="dec" colNo="ACCOUNT_ID" formId="e633154263d04ccaa225a43048997e75" ><bu:ui colNo="ACCOUNT_ID" style="width:200px;" formId="e633154263d04ccaa225a43048997e75" value="%{ACCOUNT_ID}" formIndex="1" /></bu:td>-->
		</tr>
		<tr>
	...
	<div id="backItem" class="dialog-mask" style="z-index:1029px;"/></div>
		<div class="dialog dialog-s1" id="addItem" style="display:none;z-index:1030;margin-left:150px;left:16px;top:10px;width:870px;height:510px;">
			<div  class="dialog-hd">
			<h3 class="tit">
				 ...
				 <tr>
    	            ...
    	            <div class="panel datagrid datagrid-div1">
    					<div class="datagrid-div2 datagrid-div6 datagrid-view"  id="datagrid-view">
    						...
    						<div class="datagrid-body datagrid-div3 scroll2"   style="height:350px;">
...
<bu:script viewId="db44decb4a774871b6cf0a1b03e16465" />
...
function addCal(){      
		...
		return ;
			...
			$("#saveBtn").prop("disabled","disabled");
                        ...
                        document.forms.addForm.action = "${path}buss/bussModel_exeFunc.ms?funcMId=4ac453782e61469997af2565c2393185";
