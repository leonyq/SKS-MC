            ...
            if(null!=data.ajaxPage.dataList){
                ...
                for(var i=0;i<list.length;i++){
                    ...
                    $("#tbody_a5c2d366015d4387b20efc4bb2d30f81 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:200px;text-align: center;' title='"+list[i].DEPT_NAME+"'>"+list[i].DEPT_NAME+"</td>");
                   	$("#tbody_a5c2d366015d4387b20efc4bb2d30f81 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:200px;text-align: left;' title='"+list[i].WMI_ITEM_SN+"'><span onclick='itemJump1(\""+list[i].WMI_ITEM_SN+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+list[i].WMI_ITEM_SN+"</span></td>");
                   	$("#tbody_a5c2d366015d4387b20efc4bb2d30f81 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:120px;text-align: left;' title='"+list[i].WMI_DOC_NO+"'><span onclick='itemJump2(\""+list[i].WMI_DOC_NO+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+list[i].WMI_DOC_NO+"</span></td>");
                   	$("#tbody_a5c2d366015d4387b20efc4bb2d30f81 tr:last").append("<td class='datagrid-cell datagrid-cell-5' style='width:120px;text-align: left;' title='"+list[i].WMI_MO_NUMBER+"'><span onclick='itemJump3(\""+list[i].WMI_MO_NUMBER+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+list[i].WMI_MO_NUMBER+"</span></td>");
                   	$("#tbody_a5c2d366015d4387b20efc4bb2d30f81 tr:last").append("<td class='datagrid-cell datagrid-cell-6' style='width:120px;text-align: left;' title='"+list[i].WMI_ITEM_CODE+"'><span onclick='itemJump4(\""+list[i].WMI_ITEM_CODE+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+list[i].WMI_ITEM_CODE+"</span></td>");
                   	...
                   	$("#tbody_a5c2d366015d4387b20efc4bb2d30f81 tr:last").append("<td class='datagrid-cell datagrid-cell-10' style='width:200px;text-align: left;' title='"+list[i].WMI_PROJECT_ID+"'><span onclick='itemJump5(\""+list[i].WMI_PROJECT_ID+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+list[i].WMI_PROJECT_ID+"</span></td>");
                   	$("#tbody_a5c2d366015d4387b20efc4bb2d30f81 tr:last").append("<td class='datagrid-cell datagrid-cell-11' style='width:120px;text-align: left;' title='"+list[i].WMI_PO+"'><span onclick='itemJump6(\""+list[i].WMI_PO+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+list[i].WMI_PO+"</span></td>");
