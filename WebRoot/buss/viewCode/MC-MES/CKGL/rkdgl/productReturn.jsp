...
<head>
    ...
    <%@ include file="/plf/page/common/buss/listCommJs.jsp"%>
		<bu:header formId ="d48d2c929e63402f94a2551000c72098"/>
...
<script type="text/javascript">
	...
	function switchTag(tag, content, url) {
		...
		if(tag=="tag1"){
			listAjaxTable("d48d2c929e63402f94a2551000c72098");
...
<body>
    <div class="content-in">
        <div class="dlist">
            <div class="hd">
		<bu:func viewId="b165bfc67df34684b84b6715ba629eab" />
            </div>
            <div class="bd">
		...
		<bu:search viewId="b165bfc67df34684b84b6715ba629eab" />
                   </form>
		...
		<input type="hidden" name="formPaged48d2c929e63402f94a2551000c72098" id="formPaged48d2c929e63402f94a2551000c72098" value="${formPaged48d2c929e63402f94a2551000c72098}"/>
		<input type="hidden" name="formId" id="formId1" value='d48d2c929e63402f94a2551000c72098'/>
		<input type="hidden" name="formId" id="formId2" value='d48d2c929e63402f94a2551000c72002'/>
		<input type="hidden" name="formId" id="formId3" value='d48d2c929e63402f94a2551000c72003'/>
		<input type="hidden" name="formId" id="formId4" value='d48d2c929e63402f94a2551000c72004'/>
		...
		<div class="panel-ajax datagrid datagrid-div1"  id="d48d2c929e63402f94a2551000c72098">
		<div class="datagrid-div2 datagrid-div6 datagrid-view-ajax" id="datagrid-view-ajaxd48d2c929e63402f94a2551000c72098"  style="overflow-x:hidden;">
		<div class="datagrid-header">
		<div class="datagrid-header-inner head2" id="datagrid-header-innerd48d2c929e63402f94a2551000c72098">
		<bu:table cssClass="datagrid-htable fixedTable datagrid-div6 datagrid-htable-kz" id="datagrid-htabled48d2c929e63402f94a2551000c72098">
		<s:set name="_$type" value="'view'" />
		<tbody class="isParentsTitle">
		<bu:tr cssClass="datagrid-header-row datagrid-title-ajax" id="datagrid-title-ajax">
			<td class="datagrid-cell" style="width:30px; text-align:center;" ><bu:thSeq  formId="d48d2c929e63402f94a2551000c72098" i18n="1"/></td>
			<td class="datagrid-cell" style="width:200px;"><bu:uitn colNo="DATA_AUTH" formId="d48d2c929e63402f94a2551000c72098" /></td> 
			<td class="datagrid-cell" style="width:150px;"><bu:uitn colNo="WRI_DOC_NUM" formId="d48d2c929e63402f94a2551000c72098" /></td>
			
			<td class="datagrid-cell" style="width:150px;"><bu:uitn colNo="WRI_ITEM_CODE" formId="d48d2c929e63402f94a2551000c72098" /></td>
			<td class="datagrid-cell" style="width:110px;"><bu:uitn colNo="T2#WRD_ERP_FLAG" formId="d48d2c929e63402f94a2551000c72098" /></td>
			<td class="datagrid-cell" style="width:70px;"><bu:uitn colNo="T2#WRD_URGENT_FLAG" formId="d48d2c929e63402f94a2551000c72098" /></td>
			<td class="datagrid-cell" style="width:70px;"><bu:uitn colNo="WRI_STATUS" formId="d48d2c929e63402f94a2551000c72098" /></td>
			<td class="datagrid-cell" style="width:120px;"><bu:uitn colNo="WRI_PACK_NUM" formId="d48d2c929e63402f94a2551000c72098" /></td>
			<td class="datagrid-cell" style="width:70px;"><bu:uitn colNo="WRI_PLAN_NUM" formId="d48d2c929e63402f94a2551000c72098" /></td>
			<td class="datagrid-cell" style="width:70px;"><bu:uitn colNo="WRI_RECEIVE_NUM" formId="d48d2c929e63402f94a2551000c72098" /></td>
			<td class="datagrid-cell" style="width:70px;"><bu:uitn colNo="WRI_ITEM_SEQ" formId="d48d2c929e63402f94a2551000c72098" /></td>
			<td class="datagrid-cell" style="width:150px;"><bu:uitn colNo="WRI_CONNECT_DOC" formId="d48d2c929e63402f94a2551000c72098" /></td>
			<td class="datagrid-cell" style="width:90px;"><bu:uitn colNo="T6#WDT_TYPE_NAME" formId="d48d2c929e63402f94a2551000c72098" /></td>
			<td class="datagrid-cell" style="width:90px;"><bu:uitn colNo="T7#WDO_DISPATCH_NAME" formId="d48d2c929e63402f94a2551000c72098" /></td>
			<td class="datagrid-cell" style="width:90px;"><bu:uitn colNo="WRI_WH_CODE" formId="d48d2c929e63402f94a2551000c72098" /></td>
			<td class="datagrid-cell" style="width:150px;"><bu:uitn colNo="WRI_ITEM_NAME" formId="d48d2c929e63402f94a2551000c72098" /></td>
			<td class="datagrid-cell" style="width:150px;"><bu:uitn colNo="WRI_ITEM_SPEC" formId="d48d2c929e63402f94a2551000c72098" /></td>
			<td class="datagrid-cell" style="width:90px;"><bu:uitn colNo="T4#NAME" formId="d48d2c929e63402f94a2551000c72098" /></td>
			<td class="datagrid-cell" style="width:150px;"><bu:uitn colNo="T2#WRD_CREATE_TIME" formId="d48d2c929e63402f94a2551000c72098" /></td>
		</bu:tr>
		</tbody>
		</bu:table>
		</div>
		</div>
		<div class="datagrid-body datagrid-div3 datagrid-body-ajax scroll2" id="tableDivd48d2c929e63402f94a2551000c72098" onscroll="ajaxTableScroll(this,'d48d2c929e63402f94a2551000c72098')">
		<table class="datagrid-btable fixedTable "  id="datagrid-btable-ajaxd48d2c929e63402f94a2551000c72098">
		<tbody id="tbody_d48d2c929e63402f94a2551000c72098" class="isParents">
		</tbody>
		</table>		</div>
		</div>
		</div>
		<c:if test="${formPaged48d2c929e63402f94a2551000c72098==1}">			<div class="center">
			<s:include value="/plf/page/fp/paginationPopMultAx.jsp?listDataFn=listAjaxTable&formId=d48d2c929e63402f94a2551000c72098&showLoading=0" />
			</div>
		</c:if>
		<!---->
					...
					<div class="datagrid-div2 datagrid-div6 datagrid-view"  style="overflow-x:hidden;border-bottom:0;">
						<div class="datagrid-header" style="">
							<div class="datagrid-header-inner head1"  id="">
								<table  class="datagrid-htable fixedTable  " id="datagrid-htabled48d2c929e63402f94a2551000c72002"  >
									<tbody>
						...
						<div class="datagrid-body datagrid-div3 scroll1"><!--130-->
							<table class="datagrid-btable fixedTable " style="table-layout: fixed;"  id="datagrid-btable-ajaxd48d2c929e63402f94a2551000c72002" >
					...
					<div class="datagrid-div2 datagrid-div6 datagrid-view"  style="overflow-x:hidden;border:0;">
						<div class="datagrid-header" style="">
							<div class="datagrid-header-inner head"  id="" >
								<table  class="datagrid-htable fixedTable  "  id="datagrid-htabled48d2c929e63402f94a2551000c72003"  >
									<tbody>
									<tr class="thcolor datagrid-header-row">
										<td class="datagrid-cell" align="center" style="width:30px;text-align: center"></td >
						...
						<div class="datagrid-body datagrid-div3 scroll">
							<table class="datagrid-btable fixedTable " style="table-layout: fixed;"  id="datagrid-btable-ajaxd48d2c929e63402f94a2551000c72003" >
					...
					<div class="datagrid-div2 datagrid-div6 datagrid-view"  style="overflow-x:hidden;border:0;">
						<div class="datagrid-header" style="">
							<div class="datagrid-header-inner head3"  id="" >
								<table  class="datagrid-htable fixedTable  " id="datagrid-htabled48d2c929e63402f94a2551000c72004" >
									<tbody>
									<tr class="thcolor datagrid-header-row">
										<td class="datagrid-cell" align="center" style="width:30px;text-align: center"></td >
						...
						<div class="datagrid-body datagrid-div3 scroll3">
							<table class="datagrid-btable fixedTable " style="table-layout: fixed;"  id="datagrid-btable-ajaxd48d2c929e63402f94a2551000c72004" >
								<tbody id="addReceive" >
								</tbody>
							</table>
						</div>
		...
		<bu:submit viewId="b165bfc67df34684b84b6715ba629eab" />
      <jsp:include page="/plf/page/mesdemo/commCode/commCode.jsp">
           <jsp:param name="modelName" value="VIEW_TYPE_17" />
           <jsp:param name="location" value="beforeJsLoad" />
      </jsp:include>
		<bu:script viewId="b165bfc67df34684b84b6715ba629eab" />
 <script type="text/javascript">
function listAjaxTable(formId){
                ...
                function query(thisObj){
                  ...
                  if($("#tag1").attr("class")=="current"){
                    ...
                    //defTableWidthRewrite('d48d2c929e63402f94a2551000c72098');
                }
               ...
               function setTableWidth(formId){
                ...
                function init(){
                    ...
                    $("#T2#WRD_CREATE_TIME_END").val(timeEndString());
                     $(document.getElementById('T2#WRD_DOC_TYPE')).val('DJ03');
						...
						if(null != data.ajaxPage.dataList){
							...
							for(var i = 0;i < rccList.length; i++){
							 //   if(rccList[i].DATAAUTH==null)  rccList[i].DATAAUTH="";
								...
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72002 tbody:last").append("<tr id='tr1_"+i+"' ></tr>");
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72002 tr:last").append("<td class='datagrid-cell datagrid-cell-1' style='width:30px;text-align: center;'>"+(i+1)+"</td>");
							//	$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72002 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:200px;text-align: center;' title='"+rccList[i].DATAAUTH+"'>"+rccList[i].DATAAUTH+"</td>");
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72002 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:250px;text-align: center;' title='"+rccList[i].WRD_ITEM_SN+"'><span onclick='itemJump3(\""+rccList[i].WRD_ITEM_SN+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].WRD_ITEM_SN+"</span></td>");
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72002 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:150px;text-align: center;' title='"+rccList[i].WRD_ITEM_CODE+"'><span onclick='itemJump4(\""+rccList[i].WRD_ITEM_CODE+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].WRD_ITEM_CODE+"</span></td>");
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72002 tr:last").append("<td class='datagrid-cell datagrid-cell-5' style='width:150px;text-align: center;' title='"+rccList[i].CI_ITEM_NAME+"'>"+rccList[i].CI_ITEM_NAME+"</td>");
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72002 tr:last").append("<td class='datagrid-cell datagrid-cell-6' style='width:150px;text-align: center;' title='"+rccList[i].CI_ITEM_SPEC+"'>"+rccList[i].CI_ITEM_SPEC+"</td>");
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72002 tr:last").append("<td class='datagrid-cell datagrid-cell-7' style='width:90px;text-align: right;' title='"+rccList[i].WRD_RECEIVE_NUM+"'>"+rccList[i].WRD_RECEIVE_NUM+"</td>");
								
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72002 tr:last").append("<td class='datagrid-cell datagrid-cell-8' style='width:150px;' title='"+rccList[i].WRD_CONNECT_DOC+"'><span onclick='itemJump5(\""+rccList[i].WRD_CONNECT_DOC+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].WRD_CONNECT_DOC+"</span></td>");
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72002 tr:last").append("<td class='datagrid-cell datagrid-cell-9' style='width:110px;' title='"+rccList[i].WRD_FIRST_SN+"'>"+rccList[i].WRD_FIRST_SN+"</td>");
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72002 tr:last").append("<td class='datagrid-cell datagrid-cell-10' style='width:110px;' title='"+rccList[i].WRD_SECOND_SN+"'>"+rccList[i].WRD_SECOND_SN+"</td>");
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72002 tr:last").append("<td class='datagrid-cell datagrid-cell-11' style='width:110px;' title='"+rccList[i].WRD_THIRD_SN+"'>"+rccList[i].WRD_THIRD_SN+"</td>");
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72002 tr:last").append("<td class='datagrid-cell datagrid-cell-12' style='width:110px;' title='"+rccList[i].WRD_FOURTH_SN+"'>"+rccList[i].WRD_FOURTH_SN+"</td>");
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72002 tr:last").append("<td class='datagrid-cell datagrid-cell-13' style='width:110px;' title='"+rccList[i].WH_NAME+"'>"+rccList[i].WH_NAME+"</td>");
								
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72002 tr:last").append("<td class='datagrid-cell datagrid-cell-14' style='width:110px;' title='"+rccList[i].SUPPLIER_NAME+"'>"+rccList[i].SUPPLIER_NAME+"</td>");
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72002 tr:last").append("<td class='datagrid-cell datagrid-cell-15' style='width:90px;text-align: center;' title='"+rccList[i].RECEIVE_EMP+"'>"+rccList[i].RECEIVE_EMP+"</td>");
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72002 tr:last").append("<td class='datagrid-cell datagrid-cell-16' style='width:130px;' title='"+rccList[i].RECEIVE_TIME+"'>"+rccList[i].RECEIVE_TIME+"</td>");
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72002 tr:last").append("<td class='datagrid-cell datagrid-cell-17' style='width:70px;'>"+rccList[i].WRD_UPLOAD_FLAG+"</td>");
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72002 tr:last").append("<td class='datagrid-cell datagrid-cell-18' style='width:150px;' title='"+rccList[i].WRD_UPLOAD_TIME+"'>"+rccList[i].WRD_UPLOAD_TIME+"</td>");
							}
						}
						pageFun(data.ajaxPage,"formId2");
							var tableTrJs = $("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72002 tbody tr");
							_tongLineColor(tableTrJs);
							//clickTr('itemDetail');
							defTableWidthRewrite('d48d2c929e63402f94a2551000c72002');
				...
				success: function(data){
						...
						if(null != data.ajaxPage.dataList){
							...
							for(var i = 0;i < rccList.length; i++){
								...
								if(rccList[i].CI_ITEM_NAME==null)  rccList[i].CI_ITEM_NAME="";
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72002 tbody:last").append("<tr id='tr1_"+i+"' ></tr>");
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72002 tr:last").append("<td class='datagrid-cell datagrid-cell-1' style='width:30px;text-align: center;'>"+((currentPage-1)*pageRecord+(i+1))+"</td>");
							//	$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72002 tr:last").append("<td class='datagrid-cell datagrid-cell-2' style='width:150px;text-align: center;' title='"+rccList[i].DATAAUTH+"'>"+rccList[i].DATAAUTH+"</td>");
							    $("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72002 tr:last").append("<td class='datagrid-cell datagrid-cell-2' style='text-align: center;width:200px;' title='"+rccList[i].DATAAUTH+"'>"+rccList[i].DATAAUTH+"<input type='hidden' id='DATA_AUTH_ID_"+rccList[i].ID+"' value='"+rccList[i].DATA_AUTH2+"' /></td>");
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72002 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:250px;text-align: center;' title='"+rccList[i].WRD_ITEM_SN+"'><span onclick='itemJump3(\""+rccList[i].WRD_ITEM_SN+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].WRD_ITEM_SN+"</span></td>");
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72002 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:150px;text-align: center;' title='"+rccList[i].WRD_ITEM_CODE+"'><span onclick='itemJump4(\""+rccList[i].WRD_ITEM_CODE+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].WRD_ITEM_CODE+"</span></td>");
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72002 tr:last").append("<td class='datagrid-cell datagrid-cell-5' style='width:150px;text-align: center;' title='"+rccList[i].CI_ITEM_NAME+"'>"+rccList[i].CI_ITEM_NAME+"</td>");
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72002 tr:last").append("<td class='datagrid-cell datagrid-cell-6' style='width:150px;text-align: center;' title='"+rccList[i].CI_ITEM_SPEC+"'>"+rccList[i].CI_ITEM_SPEC+"</td>");
...
//	var endTime = $('T2#WPD_DELIVERY_DATE_END').val();
	util.showLoading("处理中...");
	//&itemCode="+itemCode+"&dataAuth="+dataAuth+"&docNum="+docNum+"&supCode="+supCode+"&connectDoc="+connectDoc+"&itemStatus="+itemStatus+"&docType=DJ03"
	$.ajax({
			    type: "POST",
			    dataType: "json",
			    url: "buss/bussModel_exeFunc.ms?funcMId=97f0a52fa234453f8e4c430d50081b74",//VM-采购入库管理 操作功能 点击入库信息获取物料信息
				...
				success: function(data){
						...
						if(null != data.ajaxPage.dataList){
							...
							//	if(rccList[i].CI_ITEM_SPEC==null)  rccList[i].CI_ITEM_SPEC="";
								...
								if(rccList[i].WRD_UPLOAD_TIME==null)  rccList[i].WRD_UPLOAD_TIME="";
								if(rccList[i].CI_ITEM_NAME==null)  rccList[i].CI_ITEM_NAME="";
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72003 tbody:last").append("<tr id='tr2_"+i+"' ></tr>");
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72003  tr:last").append("<td class='datagrid-cell datagrid-cell-1' style='width:30px;text-align: center;'>"+(i+1)+"</td>");
								//$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72003 tr:last").append("<td class='datagrid-cell datagrid-cell-2' style='width:200px;text-align: center;' title='"+rccList[i].DATAAUTH+"'>"+rccList[i].DATAAUTH+"</td>");
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72003 tr:last").append("<td class='datagrid-cell datagrid-cell-2' style='text-align: center;width:200px;' title='"+rccList[i].DATAAUTH+"'>"+rccList[i].DATAAUTH+"<input type='hidden' id='DATA_AUTH_ID_"+rccList[i].ID+"' value='"+rccList[i].DATA_AUTH2+"' /></td>");
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72003 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:250px;text-align: center;' title='"+rccList[i].WRD_ITEM_SN+"'><span onclick='itemJump3(\""+rccList[i].WRD_ITEM_SN+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].WRD_ITEM_SN+"</span></td>");
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72003 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:150px;text-align: center;' title='"+rccList[i].WRD_ITEM_CODE+"'><span onclick='itemJump4(\""+rccList[i].WRD_ITEM_CODE+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].WRD_ITEM_CODE+"</span></td>");
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72003 tr:last").append("<td class='datagrid-cell datagrid-cell-5' style='width:150px;text-align: center;' title='"+rccList[i].CI_ITEM_NAME+"'>"+rccList[i].CI_ITEM_NAME+"</td>");
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72003 tr:last").append("<td class='datagrid-cell datagrid-cell-6' style='width:150px;text-align: center;' title='"+rccList[i].CI_ITEM_SPEC+"'>"+rccList[i].CI_ITEM_SPEC+"</td>");
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72003 tr:last").append("<td class='datagrid-cell datagrid-cell-7' style='width:90px;text-align: right;' title='"+rccList[i].WRD_RECEIVE_NUM+"'>"+rccList[i].WRD_RECEIVE_NUM+"</td>");
								
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72003 tr:last").append("<td class='datagrid-cell datagrid-cell-8' style='width:150px;' title='"+rccList[i].WRD_CONNECT_DOC+"'><span onclick='itemJump5(\""+rccList[i].WRD_CONNECT_DOC+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].WRD_CONNECT_DOC+"</span></td>");
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72003 tr:last").append("<td class='datagrid-cell datagrid-cell-9' style='width:110px;' title='"+rccList[i].WRD_FIRST_SN+"'>"+rccList[i].WRD_FIRST_SN+"</td>");
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72003 tr:last").append("<td class='datagrid-cell datagrid-cell-10' style='width:110px;' title='"+rccList[i].WRD_SECOND_SN+"'>"+rccList[i].WRD_SECOND_SN+"</td>");
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72003 tr:last").append("<td class='datagrid-cell datagrid-cell-11' style='width:110px;' title='"+rccList[i].WRD_THIRD_SN+"'>"+rccList[i].WRD_THIRD_SN+"</td>");
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72003 tr:last").append("<td class='datagrid-cell datagrid-cell-12' style='width:110px;' title='"+rccList[i].WRD_FOURTH_SN+"'>"+rccList[i].WRD_FOURTH_SN+"</td>");
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72003 tr:last").append("<td class='datagrid-cell datagrid-cell-13' style='width:110px;' title='"+rccList[i].WH_NAME+"'>"+rccList[i].WH_NAME+"</td>");
							
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72003 tr:last").append("<td class='datagrid-cell datagrid-cell-14' style='width:110px;' title='"+rccList[i].SUPPLIER_NAME+"'>"+rccList[i].SUPPLIER_NAME+"</td>");
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72003 tr:last").append("<td class='datagrid-cell datagrid-cell-15' style='width:90px;text-align: center;' title='"+rccList[i].RECEIVE_EMP+"'>"+rccList[i].RECEIVE_EMP+"</td>");
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72003 tr:last").append("<td class='datagrid-cell datagrid-cell-16' style='width:130px;' title='"+rccList[i].RECEIVE_TIME+"'>"+rccList[i].RECEIVE_TIME+"</td>");
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72003 tr:last").append("<td class='datagrid-cell datagrid-cell-17' style='width:70px;'>"+rccList[i].WRD_UPLOAD_FLAG+"</td>");
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72003 tr:last").append("<td class='datagrid-cell datagrid-cell-18' style='width:150px;' title='"+rccList[i].WRD_UPLOAD_TIME+"'>"+rccList[i].WRD_UPLOAD_TIME+"</td>");
							}
						}
						pageFun(data.ajaxPage,"formId3");
							var tableTrJs = $("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72003 tbody tr");
							_tongLineColor(tableTrJs);
							//clickTr('itemDetail');
							defTableWidthRewrite('d48d2c929e63402f94a2551000c72003');
...
//	var endTime = $('T2#WPD_DELIVERY_DATE_END').val();
    	...
    	$.ajax({
			    ...
			    data:{
			       ...
			       "paraMap.docType":"DJ03",
			       "page.currentPage":_GLO_FORM_PAGE_MAP[paginationImpl].currentPage,
			       "page.pageRecord" : _GLO_FORM_PAGE_MAP[paginationImpl].pageRecord, 
			    },
			    //data: "paraMap.type=1&paraMap.itemCode="+itemCode+"&paraMap.dataAuth="+dataAuth+"&paraMap.docNum="+docNum+"&paraMap.supCode="+"&paraMap.connectDoc="+connectDoc+"&paraMap.itemStatus="+itemStatus+"&paraMap.docType=DJ03"+"&page.currentPage="+_GLO_FORM_PAGE_MAP[paginationImpl].currentPage+"&page.pageRecord=" + _GLO_FORM_PAGE_MAP[paginationImpl].pageRecord,
				success: function(data){
						...
						if(null != data.ajaxPage.dataList){
							...
							for(var i = 0;i < rccList.length; i++){
								...
								if(rccList[i].CI_ITEM_NAME==null)  rccList[i].CI_ITEM_NAME="";
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72003 tbody:last").append("<tr id='tr2_"+i+"' ></tr>");
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72003 tr:last").append("<td class='datagrid-cell datagrid-cell-1' style='width:30px;text-align: center;'>"+((currentPage-1)*pageRecord+(i+1))+"</td>");
							//	$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72003 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:200px;text-align: center;' title='"+rccList[i].DATAAUTH+"'>"+rccList[i].DATAAUTH+"</td>");
							    $("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72003 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='text-align: center;width:200px;' title='"+rccList[i].DATAAUTH+"'>"+rccList[i].DATAAUTH+"<input type='hidden' id='DATA_AUTH_ID_"+rccList[i].ID+"' value='"+rccList[i].DATA_AUTH2+"' /></td>");
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72003 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:250px;text-align: center;' title='"+rccList[i].WRD_ITEM_SN+"'><span onclick='itemJump3(\""+rccList[i].WRD_ITEM_SN+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].WRD_ITEM_SN+"</span></td>");
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72003 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:150px;text-align: center;' title='"+rccList[i].WRD_ITEM_CODE+"'><span onclick='itemJump4(\""+rccList[i].WRD_ITEM_CODE+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].WRD_ITEM_CODE+"</span></td>");
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72003 tr:last").append("<td class='datagrid-cell datagrid-cell-5' style='width:150px;text-align: center;' title='"+rccList[i].CI_ITEM_NAME+"'>"+rccList[i].CI_ITEM_NAME+"</td>");
								$("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72003 tr:last").append("<td class='datagrid-cell datagrid-cell-6' style='width:150px;text-align: center;' title='"+rccList[i].CI_ITEM_SPEC+"'>"+rccList[i].CI_ITEM_SPEC+"</td>");
...
function createTableModel(ms,formId){
    ...
    var colNo = $("#relColVals").val();
    if(formId=='d48d2c929e63402f94a2551000c72098'){<%--FM-生产退料物料信息--%>
        ...
        $.each(uiTxt,function(i,v){
           ...
           arrHtml.push("<td colno='DATA_AUTH' class='datagrid-cell TD_DATA_AUTH"+ms.tdClass(formId, 'DATA_AUTH')+"' style='width:200px;text-align:center;"+ms.tdStyle(formId, 'DATA_AUTH')+"' "+ms.tdEvent(formId, 'DATA_AUTH')+">")
            ...
            arrHtml.push("<span colno='WRI_CONNECT_DOC' class='"+ms.uiClass(formId, 'WRI_CONNECT_DOC')+"' onclick='itemJump6(\""+v['WRI_CONNECT_DOC']+"\")' style='display: inline;border-bottom: 1px solid #004098;' "+ms.uiEvent(formId, 'WRI_CONNECT_DOC')+" title='"+ms.titleAttr(formId,'WRI_CONNECT_DOC','IS_TITLE_ATTR',v)+"' >"+v['WRI_CONNECT_DOC']+"</span>")
            arrHtml.push("</td>");
...
function searchReceive(){
    var url = "${path}buss/bussModel_exeFunc.ms?funcMId=9878ffb417be4a689c7b563fa8707712";//VM-生产退料管理 操作功能 生产退料
    var dataAuth = $("#DATA_AUTH").val();
	var itemCode = $.trim($("#WRI_ITEM_CODE_SHOW").val());
	var docNum = $.trim($("#WRI_DOC_NUM").val());
	//var supCode = $(document.getElementById('T2#WRD_SUP_CODE')).val();
    ...
    $.ajax({
		...
		success:function(data){
            ...
            if(null!=data.ajaxPage.dataList){
                ...
                console.log(list);
                    for(var i=0; i<list.length;i++){
						...
						//$("#addReceive tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='text-align: center;width:140px;' title='"+list[i].DATA_AUTH+"'>"+list[i].DATA_AUTH+"</td>");
            ...
            pageFun(data.ajaxPage,"formId4");
							var tableTrJs = $("#datagrid-btable-ajaxd48d2c929e63402f94a2551000c72004 tbody tr");
							_tongLineColor(tableTrJs);
							clickTr('addReceive');
							defTableWidthRewrite('d48d2c929e63402f94a2551000c72004');
        },
        error:function(msg){
            	utilsFp.confirmIcon(3,"","","", "error:"+msg,0,"300","");
        }
            ...
            if(null!=data.ajaxPage.dataList){
                ...
                console.log(list);
                    for(var i=0; i<list.length;i++){
						...
						//$("#addReceive tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='text-align: center;width:140px;' title='"+list[i].DATA_AUTH+"'>"+list[i].DATA_AUTH+"</td>");
						$("#addReceive tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='text-align: center;width:200px;' title='"+list[i].DATA_AUTH+"'>"+list[i].DATA_AUTH+"<input type='hidden' id='DATA_AUTH_ID_"+list[i].ID+"' value='"+list[i].DATA_AUTH2+"' /></td>");
						$("#addReceive tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='text-align: center;width:140px;' title='"+list[i].WRD_DOC_NUM+"'>"+list[i].WRD_DOC_NUM+"</td>");
						$("#addReceive tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='text-align: center;width:100px;' title='"+list[i].WDT_TYPE_NAME+"'>"+list[i].WDT_TYPE_NAME+"</td>");
...
function getNumId(docNum,type){
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(type==1){
                 var url = "${path}buss/bussModel_exeFunc.ms?FUNC_CODE=F6754&funcMId=96f0176fc2614be8994d9a1039bd6807&formId=d48d2c929e63402f94a2551000c72098&dataId="+dateId+"&iframeId="+_currentFrame;			
            
                showPopWinFp(url, 1200, 550,null,document.title+ "<dict:lang value="修改" />"); 
            }else if(type==3){
                var url = "${path}buss/bussModel_exeFunc.ms?FUNC_CODE=F6756&funcMId=4da11efb10ab4e97997dc8eff83682e6&formId=d48d2c929e63402f94a2551000c72098&dataId="+dateId+"&trDataAuth="+trDataAuth+"&iframeId="+_currentFrame;			
