...
<div class="js-tab">
	...
	<input type="hidden" name="paraMap1@__DATA_COUNT__" value="1" />
		<s:set name="_$viewId" value="'f5eda067085b40cba83973aab6e6e313'" />
		...
		<tr>
			...
			<td class="name" /><bu:uitn colNo="T6#WDT_TYPE_NAME" formId="2f1adeb396c4403b8fea545ec6317938" /></td>
			<bu:td cssClass="dec" colNo="T6#WDT_TYPE_NAME" formId="2f1adeb396c4403b8fea545ec6317938" ><bu:ui colNo="T6#WDT_TYPE_NAME" style="width:200px;" formId="2f1adeb396c4403b8fea545ec6317938" dataId="${dataId}" formIndex="1" /></bu:td>
			
			<td class="name" /><bu:uitn colNo="T7#WDO_DISPATCH_NAME" formId="2f1adeb396c4403b8fea545ec6317938" /></td>
			<bu:td cssClass="dec" style="width:200px;" colNo="T7#WDO_DISPATCH_NAME" formId="2f1adeb396c4403b8fea545ec6317938" ><bu:ui colNo="T7#WDO_DISPATCH_NAME" style="width:200px;" formId="2f1adeb396c4403b8fea545ec6317938" dataId="${dataId}" formIndex="1" /></bu:td>
		
		</tr>
		<tr>
			<td class="name" /><bu:uitn colNo="T2#WPD_DELIVERY_DATE" formId="2f1adeb396c4403b8fea545ec6317938" /></td>
			...
			<bu:td cssClass="dec" colNo="T2#WRD_URGENT_FLAG" formId="2f1adeb396c4403b8fea545ec6317938" >
			<bu:ui colNo="T2#WRD_URGENT_FLAG" formId="2f1adeb396c4403b8fea545ec6317938" dataId="${dataId}" formIndex="1" />
		    <bu:uitn colNo="T2#WRD_ERP_FLAG" formId="2f1adeb396c4403b8fea545ec6317938" />
			<bu:ui colNo="T2#WRD_ERP_FLAG" formId="2f1adeb396c4403b8fea545ec6317938" dataId="${dataId}" formIndex="1" />
			</bu:td>
			
			<td class="name" /><bu:uitn colNo="T3#SUPPLIER_NAME" formId="2f1adeb396c4403b8fea545ec6317938" /></td>
			<bu:td cssClass="dec" colNo="T3#SUPPLIER_NAME" formId="2f1adeb396c4403b8fea545ec6317938" ><bu:ui colNo="T3#SUPPLIER_NAME" style="width:200px;" formId="2f1adeb396c4403b8fea545ec6317938" dataId="${dataId}" formIndex="1" /></bu:td>
			
		</tr>
		<tr>
			<td class="name" /><bu:uitn colNo="WRD_STATUS" formId="2f1adeb396c4403b8fea545ec6317938" /></td>
			<bu:td cssClass="dec" colNo="WRD_STATUS" formId="2f1adeb396c4403b8fea545ec6317938"><input type="text" id="myState" class="input isSubmit" readonly="readonly"></bu:td>
			
			<td class="name" /><bu:uitn colNo="T4#NAME" formId="2f1adeb396c4403b8fea545ec6317938" /></td>
			<bu:td cssClass="dec" colNo="T4#NAME" formId="2f1adeb396c4403b8fea545ec6317938" ><bu:ui colNo="T4#NAME" style="width:200px;" formId="2f1adeb396c4403b8fea545ec6317938" dataId="${dataId}" formIndex="1" /></bu:td>
			
			<td class="name" /><bu:uitn colNo="T2#WRD_CREATE_TIME" formId="2f1adeb396c4403b8fea545ec6317938" /></td>
			<bu:td cssClass="dec" colNo="T2#WRD_CREATE_TIME" formId="2f1adeb396c4403b8fea545ec6317938" ><bu:ui colNo="T2#WRD_CREATE_TIME" style="width:200px;" formId="2f1adeb396c4403b8fea545ec6317938" dataId="${dataId}" formIndex="1" /></bu:td>
			
		</tr>
		<tr style="display:none;">
			<td class="name" /><bu:uitn colNo="WRD_STATUS" formId="2f1adeb396c4403b8fea545ec6317938" /></td>
			<bu:td cssClass="dec" colNo="WRD_STATUS" formId="2f1adeb396c4403b8fea545ec6317938"><bu:ui colNo="WRD_STATUS" style="width:200px;" formId="2f1adeb396c4403b8fea545ec6317938" dataId="${dataId}" formIndex="1" /></bu:td>
			
		</tr>
			<tr>
			<td class="name" /><bu:uitn colNo="T8#NAME" formId="2f1adeb396c4403b8fea545ec6317938" /></td>
			<bu:td cssClass="dec" colNo="T8#NAME" formId="2f1adeb396c4403b8fea545ec6317938" ><bu:ui colNo="T8#NAME" style="width:200px;" formId="2f1adeb396c4403b8fea545ec6317938" dataId="${dataId}" formIndex="1" /></bu:td>
			
			<!--<td class="name" /><bu:uitn colNo="T2#ACCOUNT_ID" formId="2f1adeb396c4403b8fea545ec6317938" /></td>
			<bu:td cssClass="dec" colNo="T9#ACCOUNT_ALIAS" formId="2f1adeb396c4403b8fea545ec6317938" ><bu:ui colNo="T9#ACCOUNT_ALIAS" style="width:200px;" formId="2f1adeb396c4403b8fea545ec6317938" dataId="${dataId}" formIndex="1" /></bu:td> -->
			...
			<div class="mod-bd" style="margin-top:5px;border-bottom: none;height:500px;">
				<div class="panel datagrid datagrid-div1">
					<div class="datagrid-div2 datagrid-div6 datagrid-view"  id="datagrid-view">
						...
						<div class="datagrid-body datagrid-div3"   style="height:450px;">
...
//根据入库单号获取对应物料信息
function getItem(){
    	var docNum =$("#paraMapObj_WRI_DOC_NUM").val();
	util.showLoading("处理中...");
			$.ajax({
				type: "POST",
			    dataType: "json",
			    //url: "buss/bussModel_exeFunc.ms?funcMId=4df28c380ad54dcf81f10de621ea220f&docNum="+$("#paraMapObj_WRI_DOC_NUM").val(),
			   // data: "",
						...
						if(null != data.ajaxList){
							...
							for(var i=0;i<rccList.length;i++){
								...
								var temps="<tr id='trr"+(trrCount+1)+"' >"
								         ...
								         +"<td  style='width:150px;text-align: center;padding:0;'><input style='width: 100%;padding:0;' name='WRI_PRODUCE_DATE' class=' input isSubmit  _VAL_OjbsData WdateNomorl' onfocus='WdatePicker({skin:\"blue\",dateFmt:\"yyyy-MM-dd\"})' disabled='disabled' value='"+rccList[i].PRODUCE_DATE+"'/></td>"
