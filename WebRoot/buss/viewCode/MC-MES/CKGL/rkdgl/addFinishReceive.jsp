...
function addItemInfo(){
		...
		var itemInfoUrl = "${path}buss/bussModel_exeFunc.ms?funcMId=a3f786391ee249099b9713fae57eec1c";//VM-完工入库管理-新增 操作功能 加载机种信息
		  $.ajax({
				type: "POST",
			    dataType: "json",
			    url: itemInfoUrl,
				...
				success: function(data){
						...
						if(null != data.ajaxPage.dataList){
							...
							for(var i=0;i<rccList.length;i++){
								...
								$("#datagrid-btable-ajaxe633154263d04ccaa225a43048997e03 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:160px;text-align: center;'>"+rccList[i].PM_MO_NUMBER+"<input type='hidden' id='PROJECT_ID"+(trCount+1)+"' value='"+rccList[i].PM_MO_NUMBER+"'/></td>");
								$("#datagrid-btable-ajaxe633154263d04ccaa225a43048997e03 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:160px;text-align: center;'>"+rccList[i].PRODUCT_MATERIAL+"<input type='hidden' id='CB_ITEM_CODE"+(trCount+1)+"' value='"+rccList[i].PRODUCT_MATERIAL+"'/></td>");
								$("#datagrid-btable-ajaxe633154263d04ccaa225a43048997e03 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:160px;text-align: center;'>"+rccList[i].PRODUCT_NAME+"<input type='hidden' id='CI_ITEM_NAME"+(trCount+1)+"' value='"+rccList[i].PRODUCT_NAME+"'/></td>");
								$("#datagrid-btable-ajaxe633154263d04ccaa225a43048997e03 tr:last").append("<td class='datagrid-cell datagrid-cell-5' style='width:160px;text-align: center;'>"+rccList[i].PRODUCT_STANDARD+"<input type='hidden' id='CI_ITEM_SPEC"+(trCount+1)+"' value='"+rccList[i].PRODUCT_STANDARD+"'/></td>");
								$("#datagrid-btable-ajaxe633154263d04ccaa225a43048997e03 tr:last").append("<td class='datagrid-cell datagrid-cell-6' style='width:100px;text-align: center;'>"+rccList[i].CUSTOMER+"<input type='hidden' id='CI_MIN_PACK"+(trCount+1)+"' value='"+rccList[i].CI_MIN_PACK+"'/></td>");
								trCount++;
							}
...
function addItemList(showId,backId){
	...
	$("#itemTbody :checkbox").each(function(){
			if($(this).attr("checked")){
				...
				//	$("#itemInfo tbody:last").append("<tr id='trr"+$(this).attr("id")+"' ></tr>");
					...
					$("#datagrid-btable-ajaxe633154263d04ccaa225a43048997e02 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:150px;text-align: center;'>"+$("#CB_ITEM_CODE"+$(this).attr("id")).val()+"<input type='hidden' name='CI_ITEM_CODE' value='"+$("#CB_ITEM_CODE"+$(this).attr("id")).val()+"'/></td>");
					$("#datagrid-btable-ajaxe633154263d04ccaa225a43048997e02 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:120px;text-align: center;'>"+$("#CI_ITEM_NAME"+$(this).attr("id")).val()+"</td>");
					...
					//$("#itemInfo tr:last").append("<td class='datagrid-cell datagrid-cell-9' style='width:160px;text-align: center;padding:0;'>"+tempHi+tempPr+"</td>");
					$("#datagrid-btable-ajaxe633154263d04ccaa225a43048997e02 tr:last").append("<td class='datagrid-cell datagrid-cell-9' style='width:160px;text-align: center;padding:0;'>"+$("#PROJECT_ID"+$(this).attr("id")).val()+"<input type='hidden' name='WPI_PO' value='"+$("#PROJECT_ID"+$(this).attr("id")).val()+"'/></td>");
					...
					if(len>1){
                           //utilsFp.confirmIcon(1,"","","", "%{getText("请至少添加一条单据明细信息")}",0,"260","");
                            utilsFp.confirmIcon(3,"","","", "<dict:lang value="请最多添加一条单据明细信息" />",0,"260","");
                          return false;
                        }
					*/
...
/*
function checkErr(count){
    if($("#wmsSel"+count).val()=="2"){
        $("#errSel_"+count).removeAttr("disabled");
        $("#errSel_"+count).trigger("chosen:updated");
    }else{
        $("#errSel_"+count).val("");
        $("#errSel_"+count).attr("disabled","disabled");
        $("#errSel_"+count).trigger("chosen:updated");
    }
}
*/
...
$(function(){
	getWmsSel();
	$(document.getElementById('paraMap1_T2#WRD_DOC_TYPE')).val("DJ05");
})
var wmsOption;
//获取仓库信息
function getWmsSel(){
...
<body>
	...
	<input type="hidden" name="paraMap1@__DATA_COUNT__" value="1" />
		<s:set name="_$viewId" value="'42e7c613636546feb89c827be3419178'" />
		...
		<tr>
			...
			<bu:td cssClass="dec" colNo="T2#WRD_DOC_TYPE" formId="31690bf77f664ce4bcdc8e341ff03c79" ><bu:ui colNo="T2#WRD_DOC_TYPE" style="width:200px;" formId="31690bf77f664ce4bcdc8e341ff03c79" value="%{T2#WRD_DOC_TYPE}" formIndex="1" /></bu:td>
			
			<td class="name" /><bu:uitn colNo="T2#WRD_DISPATCH_SN" formId="31690bf77f664ce4bcdc8e341ff03c79" /></td>
			<bu:td cssClass="dec" style="width:200px;" colNo="T2#WRD_DISPATCH_SN" formId="31690bf77f664ce4bcdc8e341ff03c79" ><bu:ui colNo="T2#WRD_DISPATCH_SN" style="width:200px;" formId="31690bf77f664ce4bcdc8e341ff03c79" value="%{T2#WRD_DISPATCH_SN}" formIndex="1" /></bu:td>
		...
		<tr>
			...
			<td class="name" /><bu:uitn colNo="WRD_CUST_CODE" formId="e633154263d04ccaa225a43048997e75" /></td>
			<bu:td cssClass="dec" colNo="WRD_CUST_CODE" formId="e633154263d04ccaa225a43048997e75" ><bu:ui colNo="WRD_CUST_CODE" style="width:200px;" formId="e633154263d04ccaa225a43048997e75" value="%{WRD_CUST_CODE}" formIndex="1" /></bu:td>
				 ...
				 <tr>
			    	...
			    	<div class="panel datagrid datagrid-div1">
    					<div class="datagrid-div2 datagrid-div6 datagrid-view"  id="datagrid-view">
    						...
    						<div class="datagrid-body datagrid-div3 scroll2" style="height:320px ;" > <!--   style="height:340px;" -->
			    	...
			    	<div class="scroll" style="width:870px;height:calc(100% - 140px);overflow-y: auto;overflow-x: hidden;" >  
...
<bu:script viewId="42e7c613636546feb89c827be3419178" />
...
function searchItemInfo(paginationImpl){
        var url = "${path}buss/bussModel_exeFunc.ms?funcMId=016b0a9f37024e6c85be2b237db2cd20";//VM-完工入库管理-新增 操作功能 机种信息份分页
...
function addCal(){      
			...
			$("#saveBtn").prop("disabled","disabled");
                        ...
                        document.forms.addForm.action = "${path}buss/bussModel_exeFunc.ms?funcMId=a58faa33e5204074a956f9d66f49610d";
