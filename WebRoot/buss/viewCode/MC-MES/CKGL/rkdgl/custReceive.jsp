...
<head>
    ...
    <%@ include file="/plf/page/common/buss/listCommJs.jsp"%>
		<bu:header formId ="24b1b1adf7b54d90865c4b39ac6f971e"/>
...
<script type="text/javascript">
	...
	function switchTag(tag, content, url) {
		...
		if(tag=="tag1"){
			listAjaxTable("24b1b1adf7b54d90865c4b39ac6f971e");
...
<body>
    <div class="content-in">
        <div class="dlist">
            <div class="hd">
		<bu:func viewId="e4d05965598c4786a8b87a90122a9b3a" />
            </div>
            <div class="bd">
		...
		<bu:search viewId="e4d05965598c4786a8b87a90122a9b3a" />
                   </form>
		...
		<input type="hidden" name="formPage24b1b1adf7b54d90865c4b39ac6f971e" id="formPage24b1b1adf7b54d90865c4b39ac6f971e" value="${formPage24b1b1adf7b54d90865c4b39ac6f971e}"/>
		<input type="hidden" name="formId" id="formId1" value='24b1b1adf7b54d90865c4b39ac6f971e'/>
		<input type="hidden" name="formId" id="formId2" value='24b1b1adf7b54d90865c4b39ac6f9702'/>
		<input type="hidden" name="formId" id="formId3" value='24b1b1adf7b54d90865c4b39ac6f9703'/>
		<input type="hidden" name="formId" id="formId4" value='24b1b1adf7b54d90865c4b39ac6f9704'/>
		...
		<div class="panel-ajax datagrid datagrid-div1"  id="24b1b1adf7b54d90865c4b39ac6f971e">
		<div class="datagrid-div2 datagrid-div6 datagrid-view-ajax" id="datagrid-view-ajax24b1b1adf7b54d90865c4b39ac6f971e" style="overflow-x:hidden;">
		<div class="datagrid-header">
		<div class="datagrid-header-inner head2" id="datagrid-header-inner24b1b1adf7b54d90865c4b39ac6f971e">
		<bu:table cssClass="datagrid-htable fixedTable datagrid-div6 datagrid-htable-kz" id="datagrid-htable24b1b1adf7b54d90865c4b39ac6f971e">
		<s:set name="_$type" value="'view'" />
		<tbody class="isParentsTitle">
		<bu:tr cssClass="datagrid-header-row datagrid-title-ajax" id="datagrid-title-ajax">
			<td class="datagrid-cell" style="width:30px; text-align:center;" ><bu:thSeq  formId="24b1b1adf7b54d90865c4b39ac6f971e" i18n="1"/></td>
			<td class="datagrid-cell" style="width:200px;"><bu:uitn colNo="DATA_AUTH" formId="24b1b1adf7b54d90865c4b39ac6f971e" /></td>
			<td class="datagrid-cell" style="width:150px;"><bu:uitn colNo="WRI_DOC_NUM" formId="24b1b1adf7b54d90865c4b39ac6f971e" /></td>
			<td class="datagrid-cell" style="width:150px;"><bu:uitn colNo="WRI_ITEM_CODE" formId="24b1b1adf7b54d90865c4b39ac6f971e" /></td>
			<td class="datagrid-cell" style="width:110px;"><bu:uitn colNo="T2#WRD_ERP_FLAG" formId="24b1b1adf7b54d90865c4b39ac6f971e" /></td>
			<td class="datagrid-cell" style="width:70px;"><bu:uitn colNo="T2#WRD_URGENT_FLAG" formId="24b1b1adf7b54d90865c4b39ac6f971e" /></td>
			<td class="datagrid-cell" style="width:70px;"><bu:uitn colNo="WRI_STATUS" formId="24b1b1adf7b54d90865c4b39ac6f971e" /></td>
			
			<td class="datagrid-cell" style="width:120px;"><bu:uitn colNo="WRI_PACK_NUM" formId="24b1b1adf7b54d90865c4b39ac6f971e" /></td>
			<td class="datagrid-cell" style="width:70px;"><bu:uitn colNo="WRI_PLAN_NUM" formId="24b1b1adf7b54d90865c4b39ac6f971e" /></td>
			<td class="datagrid-cell" style="width:70px;"><bu:uitn colNo="WRI_GIFT_NUM" formId="24b1b1adf7b54d90865c4b39ac6f971e" /></td>
			<td class="datagrid-cell" style="width:70px;"><bu:uitn colNo="WRI_RECEIVE_NUM" formId="24b1b1adf7b54d90865c4b39ac6f971e" /></td>
			<td class="datagrid-cell" style="width:70px;"><bu:uitn colNo="WRI_ITEM_SEQ" formId="24b1b1adf7b54d90865c4b39ac6f971e" /></td>
			<td class="datagrid-cell" style="width:150px;"><bu:uitn colNo="WRI_CONNECT_DOC" formId="24b1b1adf7b54d90865c4b39ac6f971e" /></td>
			<td class="datagrid-cell" style="width:90px;"><bu:uitn colNo="T6#WDT_TYPE_NAME" formId="24b1b1adf7b54d90865c4b39ac6f971e" /></td>
			<td class="datagrid-cell" style="width:90px;"><bu:uitn colNo="T7#WDO_DISPATCH_NAME" formId="24b1b1adf7b54d90865c4b39ac6f971e" /></td>
			<td class="datagrid-cell" style="width:90px;"><bu:uitn colNo="WRI_WH_CODE" formId="24b1b1adf7b54d90865c4b39ac6f971e" /></td>
			<td class="datagrid-cell" style="width:150px;"><bu:uitn colNo="WRI_ITEM_NAME" formId="24b1b1adf7b54d90865c4b39ac6f971e" /></td>
			<td class="datagrid-cell" style="width:150px;"><bu:uitn colNo="WRI_ITEM_SPEC" formId="24b1b1adf7b54d90865c4b39ac6f971e" /></td>
			<td class="datagrid-cell" style="width:120px;"><bu:uitn colNo="T5#CUSTOMER" formId="24b1b1adf7b54d90865c4b39ac6f971e" /></td>
			<td class="datagrid-cell" style="width:90px;"><bu:uitn colNo="T4#NAME" formId="24b1b1adf7b54d90865c4b39ac6f971e" /></td>
			<td class="datagrid-cell" style="width:150px;"><bu:uitn colNo="T2#WRD_CREATE_TIME" formId="24b1b1adf7b54d90865c4b39ac6f971e" /></td>
		</bu:tr>
		</tbody>
		</bu:table>
		</div>
		</div>
		<div class="datagrid-body datagrid-div3 datagrid-body-ajax scroll2" id="tableDiv24b1b1adf7b54d90865c4b39ac6f971e" onscroll="ajaxTableScroll(this,'24b1b1adf7b54d90865c4b39ac6f971e')">
		<table class="datagrid-btable fixedTable "  id="datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f971e" >
		<tbody id="tbody_24b1b1adf7b54d90865c4b39ac6f971e" class="isParents">
		</tbody>
		</table>		</div>
		</div>
		</div>
		<c:if test="${formPage24b1b1adf7b54d90865c4b39ac6f971e==1}">			<div class="center">
			<s:include value="/plf/page/fp/paginationPopMultAx.jsp?listDataFn=listAjaxTable&formId=24b1b1adf7b54d90865c4b39ac6f971e&showLoading=0" />
			</div>
		</c:if>
		<!---->
				...
				<div class="panel-ajax datagrid datagrid-div1" style="margin-top:10px;"><!--143-->
					<div class="datagrid-div2 datagrid-div6 datagrid-view"  style="overflow-x:hidden;border-bottom:0;">
						...
						<div class="datagrid-body datagrid-div3 scroll1"><!--130-->
							<table class="datagrid-btable fixedTable " style="table-layout: fixed;" id="datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9702"  >
					...
					<div class="datagrid-div2 datagrid-div6 datagrid-view"  style="overflow-x:hidden;border:0;">
						<div class="datagrid-header" style="">
							<div class="datagrid-header-inner head"  id="" >
								<table  class="datagrid-htable fixedTable  "  id="datagrid-htable24b1b1adf7b54d90865c4b39ac6f9703">
									<tbody>
									<tr class="thcolor datagrid-header-row" >
										<td class="datagrid-cell" align="center" style="width:30px;text-align: center"></td >
						...
						<div class="datagrid-body datagrid-div3 scroll">
							<table class="datagrid-btable fixedTable " style="table-layout: fixed;"  id="datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9703" >
					...
					<div class="datagrid-div2 datagrid-div6 datagrid-view"  style="overflow-x:hidden;border:0;">
						<div class="datagrid-header" style="">
							<div class="datagrid-header-inner head3"  id="" >
								<table  class="datagrid-htable fixedTable  "  id="datagrid-htable24b1b1adf7b54d90865c4b39ac6f9704">
									<tbody>
									<tr class="thcolor datagrid-header-row">
										<td class="datagrid-cell" align="center" style="width:30px;text-align: center"></td >
						...
						<div class="datagrid-body datagrid-div3 scroll3">
							<table class="datagrid-btable fixedTable " style="table-layout: fixed;"  id="datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9704" >
								<tbody id="addReceive" >
								</tbody>
							</table>
						</div>
		...
		<bu:submit viewId="e4d05965598c4786a8b87a90122a9b3a" />
      <jsp:include page="/plf/page/mesdemo/commCode/commCode.jsp">
           <jsp:param name="modelName" value="VIEW_TYPE_17" />
           <jsp:param name="location" value="beforeJsLoad" />
      </jsp:include>
		<bu:script viewId="e4d05965598c4786a8b87a90122a9b3a" />
   <script type="text/javascript">
               ...
               function setTableWidth(formId){
                ...
                function init(){
                    ...
                    $("#T2#WRD_CREATE_TIME_END").val(timeEndString());
                     $(document.getElementById('T2#WRD_DOC_TYPE')).val('DJ04');
				...
				success: function(data){
						...
						if(null != data.ajaxPage.dataList){
							...
							//    if(rccList[i].DATAAUTH==null)  rccList[i].DATAAUTH="";
								...
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9702 tbody:last").append("<tr id='tr1_"+i+"' ></tr>");
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9702 tr:last").append("<td class='datagrid-cell datagrid-cell-1' style='width:30px;text-align: center;'>"+(i+1)+"</td>");
							//	$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9702 tr:last").append("<td class='datagrid-cell datagrid-cell-2' style='width:250px;text-align: center;' title='"+rccList[i].DATAAUTH+"'>"+rccList[i].DATAAUTH+"</td>");
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9702 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:250px;text-align: center;' title='"+rccList[i].WRD_ITEM_SN+"'><span onclick='itemJump3(\""+rccList[i].WRD_ITEM_SN+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].WRD_ITEM_SN+"</span></td>");
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9702 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:150px;text-align: center;' title='"+rccList[i].WRD_ITEM_CODE+"'><span onclick='itemJump4(\""+rccList[i].WRD_ITEM_CODE+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].WRD_ITEM_CODE+"</span></td>");
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9702 tr:last").append("<td class='datagrid-cell datagrid-cell-5' style='width:150px;text-align: center;' title='"+rccList[i].CI_ITEM_NAME+"'>"+rccList[i].CI_ITEM_NAME+"</td>");
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9702 tr:last").append("<td class='datagrid-cell datagrid-cell-6' style='width:150px;text-align: center;' title='"+rccList[i].CI_ITEM_SPEC+"'>"+rccList[i].CI_ITEM_SPEC+"</td>");
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9702 tr:last").append("<td class='datagrid-cell datagrid-cell-7' style='width:90px;text-align: right;' title='"+rccList[i].WRD_RECEIVE_NUM+"'>"+rccList[i].WRD_RECEIVE_NUM+"</td>");
								
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9702 tr:last").append("<td class='datagrid-cell datagrid-cell-8' style='width:150px;' title='"+rccList[i].WRD_CONNECT_DOC+"'>"+rccList[i].WRD_CONNECT_DOC+"</td>");
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9702 tr:last").append("<td class='datagrid-cell datagrid-cell-9' style='width:110px;' title='"+rccList[i].WRD_FIRST_SN+"'>"+rccList[i].WRD_FIRST_SN+"</td>");
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9702 tr:last").append("<td class='datagrid-cell datagrid-cell-10' style='width:110px;' title='"+rccList[i].WRD_SECOND_SN+"'>"+rccList[i].WRD_SECOND_SN+"</td>");
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9702 tr:last").append("<td class='datagrid-cell datagrid-cell-11' style='width:110px;' title='"+rccList[i].WRD_THIRD_SN+"'>"+rccList[i].WRD_THIRD_SN+"</td>");
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9702 tr:last").append("<td class='datagrid-cell datagrid-cell-12' style='width:110px;' title='"+rccList[i].WRD_FOURTH_SN+"'>"+rccList[i].WRD_FOURTH_SN+"</td>");
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9702 tr:last").append("<td class='datagrid-cell datagrid-cell-13' style='width:110px;' title='"+rccList[i].WH_NAME+"'>"+rccList[i].WH_NAME+"</td>");
								
								
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9702 tr:last").append("<td class='datagrid-cell datagrid-cell-14' style='width:90px;text-align: center;' title='"+rccList[i].RECEIVE_EMP+"'>"+rccList[i].RECEIVE_EMP+"</td>");
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9702 tr:last").append("<td class='datagrid-cell datagrid-cell-15' style='width:130px;' title='"+rccList[i].RECEIVE_TIME+"'>"+rccList[i].RECEIVE_TIME+"</td>");
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9702 tr:last").append("<td class='datagrid-cell datagrid-cell-16' style='width:70px;'>"+rccList[i].WRD_UPLOAD_FLAG+"</td>");
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9702 tr:last").append("<td class='datagrid-cell datagrid-cell-17' style='width:150px;' title='"+rccList[i].WRD_UPLOAD_TIME+"'>"+rccList[i].WRD_UPLOAD_TIME+"</td>");
							}
						}
				...
				success: function(data){
						...
						if(null != data.ajaxPage.dataList){
							...
							for(var i = 0;i < rccList.length; i++){										
								...
								if(rccList[i].WRD_UPLOAD_TIME==null)  rccList[i].WRD_UPLOAD_TIME="";
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9702 tbody:last").append("<tr id='tr1_"+i+"' ></tr>");
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9702 tr:last").append("<td class='datagrid-cell datagrid-cell-1' style='width:30px;text-align: center;'>"+((currentPage-1)*pageRecord+(i+1))+"</td>");
								//$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9702 tr:last").append("<td class='datagrid-cell datagrid-cell-2' style='width:150px;text-align: center;' title='"+rccList[i].DATAAUTH+"'>"+rccList[i].DATAAUTH+"</td>");
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9702 tr:last").append("<td class='datagrid-cell datagrid-cell-2' style='text-align: center;width:200px;' title='"+rccList[i].DATA_AUTH+"'>"+rccList[i].DATA_AUTH+"<input type='hidden' id='DATA_AUTH_ID_"+rccList[i].ID+"' value='"+rccList[i].DATA_AUTH2+"' /></td>");
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9702 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:250px;text-align: center;' title='"+rccList[i].WRD_ITEM_SN+"'><span onclick='itemJump3(\""+rccList[i].WRD_ITEM_SN+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].WRD_ITEM_SN+"</span></td>");
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9702 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:150px;text-align: center;' title='"+rccList[i].WRD_ITEM_CODE+"'><span onclick='itemJump4(\""+rccList[i].WRD_ITEM_CODE+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].WRD_ITEM_CODE+"</span></td>");
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9702 tr:last").append("<td class='datagrid-cell datagrid-cell-5' style='width:150px;text-align: center;' title='"+rccList[i].CI_ITEM_NAME+"'>"+rccList[i].CI_ITEM_NAME+"</td>");
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9702 tr:last").append("<td class='datagrid-cell datagrid-cell-6' style='width:150px;text-align: center;' title='"+rccList[i].CI_ITEM_SPEC+"'>"+rccList[i].CI_ITEM_SPEC+"</td>");
...
function searchItemDetail(){
	...
	var supCode = $.trim($(document.getElementById('T5#CUSTOMER')).val());
...
//	var endTime = $('T2#WPD_DELIVERY_DATE_END').val();
	util.showLoading("处理中...");
	//&itemCode="+itemCode+"&dataAuth="+dataAuth+"&docNum="+docNum+"&supCode="+supCode+"&connectDoc="+connectDoc+"&itemStatus="+itemStatus+"&docType=DJ04
	$.ajax({
			    type: "POST",
			    dataType: "json",
			    url: "buss/bussModel_exeFunc.ms?funcMId=97f0a52fa234453f8e4c430d50081b74",//VM-采购入库管理 操作功能 点击入库信息获取物料信息
						...
						if(null != data.ajaxPage.dataList){
							...
							for(var i = 0;i < rccList.length; i++){
							 if(rccList[i].DATAAUTH==null)  rccList[i].DATAAUTH="";
								...
								if(rccList[i].WRD_UPLOAD_FLAG==null)  rccList[i].WRD_UPLOAD_FLAG="";
								if(rccList[i].WRD_UPLOAD_TIME==null)  rccList[i].WRD_UPLOAD_TIME="";
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9703 tbody:last").append("<tr id='tr2_"+i+"' ></tr>");
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9703  tr:last").append("<td class='datagrid-cell datagrid-cell-1' style='width:30px;text-align: center;'>"+(i+1)+"</td>");
								//$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9703 tr:last").append("<td class='datagrid-cell datagrid-cell-2' style='width:200px;text-align: center;' title='"+rccList[i].DATAAUTH+"'>"+rccList[i].DATAAUTH+"</td>");
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9703 tr:last").append("<td class='datagrid-cell datagrid-cell-2' style='text-align: center;width:200px;' title='"+rccList[i].DATAAUTH+"'>"+rccList[i].DATAAUTH+"<input type='hidden' id='DATA_AUTH_ID_"+rccList[i].ID+"' value='"+rccList[i].DATA_AUTH2+"' /></td>");
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9703 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:250px;text-align: center;' title='"+rccList[i].WRD_ITEM_SN+"'><span onclick='itemJump3(\""+rccList[i].WRD_ITEM_SN+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].WRD_ITEM_SN+"</span></td>");
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9703 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:150px;text-align: center;' title='"+rccList[i].WRD_ITEM_CODE+"'><span onclick='itemJump4(\""+rccList[i].WRD_ITEM_CODE+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].WRD_ITEM_CODE+"</span></td>");
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9703 tr:last").append("<td class='datagrid-cell datagrid-cell-5' style='width:150px;text-align: center;' title='"+rccList[i].CI_ITEM_NAME+"'>"+rccList[i].CI_ITEM_NAME+"</td>");
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9703 tr:last").append("<td class='datagrid-cell datagrid-cell-6' style='width:150px;text-align: center;' title='"+rccList[i].CI_ITEM_SPEC+"'>"+rccList[i].CI_ITEM_SPEC+"</td>");
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9703 tr:last").append("<td class='datagrid-cell datagrid-cell-7' style='width:90px;text-align: right;' title='"+rccList[i].WRD_RECEIVE_NUM+"'>"+rccList[i].WRD_RECEIVE_NUM+"</td>");
								
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9703 tr:last").append("<td class='datagrid-cell datagrid-cell-8' style='width:150px;' title='"+rccList[i].WRD_CONNECT_DOC+"'>"+rccList[i].WRD_CONNECT_DOC+"</td>");
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9703 tr:last").append("<td class='datagrid-cell datagrid-cell-9' style='width:110px;' title='"+rccList[i].WRD_FIRST_SN+"'>"+rccList[i].WRD_FIRST_SN+"</td>");
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9703 tr:last").append("<td class='datagrid-cell datagrid-cell-10' style='width:110px;' title='"+rccList[i].WRD_SECOND_SN+"'>"+rccList[i].WRD_SECOND_SN+"</td>");
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9703 tr:last").append("<td class='datagrid-cell datagrid-cell-11' style='width:110px;' title='"+rccList[i].WRD_THIRD_SN+"'>"+rccList[i].WRD_THIRD_SN+"</td>");
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9703 tr:last").append("<td class='datagrid-cell datagrid-cell-12' style='width:110px;' title='"+rccList[i].WRD_FOURTH_SN+"'>"+rccList[i].WRD_FOURTH_SN+"</td>");
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9703 tr:last").append("<td class='datagrid-cell datagrid-cell-13' style='width:110px;' title='"+rccList[i].WH_NAME+"'>"+rccList[i].WH_NAME+"</td>");
							
								
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9703 tr:last").append("<td class='datagrid-cell datagrid-cell-14' style='width:90px;text-align: center;' title='"+rccList[i].RECEIVE_EMP+"'>"+rccList[i].RECEIVE_EMP+"</td>");
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9703 tr:last").append("<td class='datagrid-cell datagrid-cell-15' style='width:130px;' title='"+rccList[i].RECEIVE_TIME+"'>"+rccList[i].RECEIVE_TIME+"</td>");
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9703 tr:last").append("<td class='datagrid-cell datagrid-cell-16' style='width:70px;'>"+rccList[i].WRD_UPLOAD_FLAG+"</td>");
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9703 tr:last").append("<td class='datagrid-cell datagrid-cell-17' style='width:150px;' title='"+rccList[i].WRD_UPLOAD_TIME+"'>"+rccList[i].WRD_UPLOAD_TIME+"</td>");
							}
						}
						pageFun(data.ajaxPage,"formId3");
							var tableTrJs = $("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9703 tbody tr");
							_tongLineColor(tableTrJs);
							//clickTr('itemDetail');
							defTableWidthRewrite('24b1b1adf7b54d90865c4b39ac6f9703');
...
function searchSecondItem(paginationImpl){
	...
	var supCode = $.trim($(document.getElementById('T2#WRD_SUP_CODE')).val());
	var connectDoc = $.trim($("#WRI_CONNECT_DOC").val());
	var itemStatus = $("#WRI_STATUS").val();
	var beginTime = $(document.getElementById('T2#WRD_CREATE_TIME_BEGIN')).val();
	var endTime = $(document.getElementById('T2#WRD_CREATE_TIME_END')).val();
//	var endTime = $('T2#WPD_DELIVERY_DATE_END').val();
    	...
    	$.ajax({
			    ...
			    data:{
			       ...
			       "paraMap.docType":"DJ04",
			       "page.currentPage":_GLO_FORM_PAGE_MAP[paginationImpl].currentPage,
			       "page.pageRecord": _GLO_FORM_PAGE_MAP[paginationImpl].pageRecord 
			    },
			    //data: "paraMap.type=1&paraMap.itemCode="+itemCode+"&paraMap.dataAuth="+dataAuth+"&paraMap.docNum="+docNum+"&paraMap.supCode="+"&paraMap.connectDoc="+connectDoc+"&paraMap.itemStatus="+itemStatus+"&paraMap.docType=DJ04"+"&page.currentPage="+_GLO_FORM_PAGE_MAP[paginationImpl].currentPage+"&page.pageRecord=" + _GLO_FORM_PAGE_MAP[paginationImpl].pageRecord,
				success: function(data){
						...
						if(null != data.ajaxPage.dataList){
							...
							for(var i = 0;i < rccList.length; i++){
								...
								if(rccList[i].WRD_UPLOAD_TIME==null)  rccList[i].WRD_UPLOAD_TIME="";
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9703 tbody:last").append("<tr id='tr2_"+i+"' ></tr>");
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9703 tr:last").append("<td class='datagrid-cell datagrid-cell-1' style='width:30px;text-align: center;'>"+((currentPage-1)*pageRecord+(i+1))+"</td>");
								//$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9703 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:200px;text-align: center;' title='"+rccList[i].DATAAUTH+"'>"+rccList[i].DATAAUTH+"</td>");
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9703 tr:last").append("<td class='datagrid-cell datagrid-cell-3'style='text-align: center;width:200px;' title='"+rccList[i].DATAAUTH+"'>"+rccList[i].DATAAUTH+"<input type='hidden' id='DATA_AUTH_ID_"+rccList[i].ID+"' value='"+rccList[i].DATA_AUTH2+"' /></td>");
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9703 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:250px;text-align: center;' title='"+rccList[i].WRD_ITEM_SN+"'><span onclick='itemJump3(\""+rccList[i].WRD_ITEM_SN+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].WRD_ITEM_SN+"</span></td>");
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9703 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:150px;text-align: center;' title='"+rccList[i].WRD_ITEM_CODE+"'><span onclick='itemJump4(\""+rccList[i].WRD_ITEM_CODE+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].WRD_ITEM_CODE+"</span></td>");
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9703 tr:last").append("<td class='datagrid-cell datagrid-cell-5' style='width:150px;text-align: center;' title='"+rccList[i].CI_ITEM_NAME+"'>"+rccList[i].CI_ITEM_NAME+"</td>");
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9703 tr:last").append("<td class='datagrid-cell datagrid-cell-6' style='width:150px;text-align: center;' title='"+rccList[i].CI_ITEM_SPEC+"'>"+rccList[i].CI_ITEM_SPEC+"</td>");
...
function createTableModel(ms,formId){
    ...
    var colNo = $("#relColVals").val();
    if(formId=='24b1b1adf7b54d90865c4b39ac6f971e'){<%--FM-客退入库物料信息--%>
        ...
        $.each(uiTxt,function(i,v){
           ...
           arrHtml.push("<td colno='DATA_AUTH' class='datagrid-cell TD_DATA_AUTH"+ms.tdClass(formId, 'DATA_AUTH')+"' style='width:200px;text-align:center;"+ms.tdStyle(formId, 'DATA_AUTH')+"' "+ms.tdEvent(formId, 'DATA_AUTH')+">")
            ...
            arrHtml.push("</td>");
            arrHtml.push("<td colno='T5#CUSTOMER' class='datagrid-cell "+ms.tdClass(formId, 'T5#CUSTOMER')+"' style='width:120px;"+ms.tdStyle(formId, 'T5#CUSTOMER')+"' "+ms.tdEvent(formId, 'T5#CUSTOMER')+">")
            ...
            arrHtml.push("</td>");
            arrHtml.push("<td colno='T2#WRD_CREATE_TIME' class='datagrid-cell "+ms.tdClass(formId, 'T2#WRD_CREATE_TIME')+"' style='width:150px;text-align:center;"+ms.tdStyle(formId, 'T2#WRD_CREATE_TIME')+"' "+ms.tdEvent(formId, 'T2#WRD_CREATE_TIME')+">")
    ...
    //defTableWidthRewrite('24b1b1adf7b54d90865c4b39ac6f971e');
}
function searchReceive(){
    var url = "${path}buss/bussModel_exeFunc.ms?funcMId=233837179f36474bae0a2477ec999d78";//VM-客退入库管理 操作功能 客退入库单信息
    var dataAuth = $("#DATA_AUTH").val();
	var itemCode = $.trim($("#WRI_ITEM_CODE_SHOW").val());
    ...
    $.ajax({
		...
		success:function(data){
            ...
            pageFun(data.ajaxPage,"formId4");
							var tableTrJs = $("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9704 tbody tr");
							_tongLineColor(tableTrJs);
							clickTr('addReceive');
							defTableWidthRewrite('24b1b1adf7b54d90865c4b39ac6f9704');
        },
        error:function(msg){
            	utilsFp.confirmIcon(3,"","","", "error:"+msg,0,"300","");
        }
            ...
            if(null!=data.ajaxPage.dataList){
                ...
                console.log(list);
                    for(var i=0; i<list.length;i++){
						...
						$("#addReceive tr:last").append("<td class='datagrid-cell datagrid-cell-2' style='width:30px;text-align: center;'><input type='checkbox' class='_selectdata' value='"+list[i].ID+"' name='isSelect3'/></td>");
					//	$("#addReceive tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='text-align: CENTER;width:200px;' title='"+list[i].DATA_AUTH+"'>"+list[i].DATA_AUTH+"</td>");
				    	$("#addReceive tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='text-align: center;width:200px;' title='"+list[i].DATA_AUTH+"'>"+list[i].DATA_AUTH+"<input type='hidden' id='DATA_AUTH_ID_"+list[i].ID+"' value='"+list[i].DATA_AUTH2+"' /></td>");
						$("#addReceive tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='text-align: left;width:140px;' title='"+list[i].WRD_DOC_NUM+"'>"+list[i].WRD_DOC_NUM+"</td>");
						$("#addReceive tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='text-align: center;width:100px;' title='"+list[i].WDT_TYPE_NAME+"'>"+list[i].WDT_TYPE_NAME+"</td>");
...
function getNumId(docNum,type){
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(type==1){
                 var url = "${path}buss/bussModel_exeFunc.ms?FUNC_CODE=F6762&funcMId=cb5372a1a6b14021b4d215538553a0ea&formId=24b1b1adf7b54d90865c4b39ac6f971e&dataId="+dateId+"&iframeId="+_currentFrame;			
            
                showPopWinFp(url, 1200,550,document.title+ "<dict:lang value="修改" />"); 
            }else if(type==3){
                var url = "${path}buss/bussModel_exeFunc.ms?FUNC_CODE=F6764&funcMId=356b750b76f047e2888c1969d24fd9fa&formId=24b1b1adf7b54d90865c4b39ac6f971e&dataId="+dateId+"&trDataAuth="+trDataAuth+"&iframeId="+_currentFrame;			
