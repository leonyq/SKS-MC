				...
				success: function(data){
						...
						if(null != data.ajaxPage.dataList){
							...
							for(var i=0;i<rccList.length;i++){
								...
								$("#datagrid-btable-ajax4f273d714d9544149f34e2d6d7ff9b03 tbody:last").append("<tr id='tr1_"+i+"' ></tr>");
								$("#datagrid-btable-ajax4f273d714d9544149f34e2d6d7ff9b03 tr:last").append("<td class='datagrid-cell datagrid-cell-1' style='width:30px;text-align: center;'>"+(i+1)+"</td>");
								$("#datagrid-btable-ajax4f273d714d9544149f34e2d6d7ff9b03 tr:last").append("<td class='datagrid-cell datagrid-cell-2' style='width:30px;text-align: center;'><input id='"+rccList[i].ID+"' type='checkbox' name='isSelect2'/></td>");
								$("#datagrid-btable-ajax4f273d714d9544149f34e2d6d7ff9b03 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:150px;text-align: center;'>"+rccList[i].CI_ITEM_CODE+"<input type='hidden' id='CI_ITEM_CODE"+rccList[i].ID+"' value='"+rccList[i].CI_ITEM_CODE+"'/></td>");
								$("#datagrid-btable-ajax4f273d714d9544149f34e2d6d7ff9b03 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:180px;text-align: center;'>"+rccList[i].CI_ITEM_NAME+"<input type='hidden' id='CI_ITEM_NAME"+rccList[i].ID+"' value='"+rccList[i].CI_ITEM_NAME+"'/></td>");
								$("#datagrid-btable-ajax4f273d714d9544149f34e2d6d7ff9b03 tr:last").append("<td class='datagrid-cell datagrid-cell-5' style='width:150px;text-align: center;'>"+rccList[i].CI_ITEM_SPEC+"<input type='hidden' id='CI_ITEM_SPEC"+rccList[i].ID+"' value='"+rccList[i].CI_ITEM_SPEC+"'/></td>");
								$("#datagrid-btable-ajax4f273d714d9544149f34e2d6d7ff9b03 tr:last").append("<td class='datagrid-cell datagrid-cell-6' style='width:150px;text-align: center;'>"+rccList[i].SUPPLIER_NAME+"</td>");
								$("#datagrid-btable-ajax4f273d714d9544149f34e2d6d7ff9b03 tr:last").append("<td class='datagrid-cell datagrid-cell-7' style='width:150px;text-align: center;'>"+rccList[i].ITEM_TYPE+"<input type='hidden' id='CI_MIN_PACK"+rccList[i].ID+"' value='"+rccList[i].CI_MIN_PACK+"'/></td>");
								trCount++;
							}
							
						}
						pageFun(data.ajaxPage,"formId1");
							var tableTrJs = $("#datagrid-btable-ajax4f273d714d9544149f34e2d6d7ff9b03 tbody tr");
							_tongLineColor(tableTrJs);
							clickTr('datagrid-btable-ajax4f273d714d9544149f34e2d6d7ff9b03');
							defTableWidthRewrite('4f273d714d9544149f34e2d6d7ff9b03');
				...
				success: function(data){
						...
						if(null != data.ajaxPage.dataList){
							...
							for(var i=0;i<rccList.length;i++){
								...
								if(rccList[i].ITEM_TYPE==null) rccList[i].ITEM_TYPE="";
								if(rccList[i].CI_MIN_PACK==null) rccList[i].CI_MIN_PACK="0";
								$("#datagrid-btable-ajax4f273d714d9544149f34e2d6d7ff9b03 tbody:last").append("<tr id='tr1_"+((currentPage-1)*pageRecord+(i+1))+"' ></tr>");
								$("#datagrid-btable-ajax4f273d714d9544149f34e2d6d7ff9b03 tr:last").append("<td class='datagrid-cell datagrid-cell-1' style='width:30px;text-align: center;'>"+((currentPage-1)*pageRecord+(i+1))+"</td>");
								$("#datagrid-btable-ajax4f273d714d9544149f34e2d6d7ff9b03 tr:last").append("<td class='datagrid-cell datagrid-cell-2' style='width:30px;text-align: center;'><input id='"+rccList[i].ID+"' type='checkbox' name='isSelect2'/></td>");
								$("#datagrid-btable-ajax4f273d714d9544149f34e2d6d7ff9b03 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:150px;text-align: center;'>"+rccList[i].CI_ITEM_CODE+"<input type='hidden' id='CI_ITEM_CODE"+rccList[i].ID+"' value='"+rccList[i].CI_ITEM_CODE+"'/></td>");
								$("#datagrid-btable-ajax4f273d714d9544149f34e2d6d7ff9b03 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:180px;text-align: center;'>"+rccList[i].CI_ITEM_NAME+"<input type='hidden' id='CI_ITEM_NAME"+rccList[i].ID+"' value='"+rccList[i].CI_ITEM_NAME+"'/></td>");
								$("#datagrid-btable-ajax4f273d714d9544149f34e2d6d7ff9b03 tr:last").append("<td class='datagrid-cell datagrid-cell-5' style='width:150px;text-align: center;'>"+rccList[i].CI_ITEM_SPEC+"<input type='hidden' id='CI_ITEM_SPEC"+rccList[i].ID+"' value='"+rccList[i].CI_ITEM_SPEC+"'/></td>");
...
function addItemList(showId,backId){
	...
	$("#itemTbody :checkbox").each(function(){
			if($(this).attr("checked")){
					...
					$("#datagrid-btable-ajax4f273d714d9544149f34e2d6d7ff1234 tr:last").append("<td class='datagrid-cell datagrid-cell-1' style='width:30px;text-align: center;'>"+(len+1)+"<input type='hidden' name='itemId' value=''/></td>");
...
function delRow(){
	...
	var checkDetailUrl = "${path}buss/bussModel_exeFunc.ms?funcMId=ed278a31633249109fd23cec96c91337";
	util.showLoading("处理中...");
		  $.ajax({
				type: "POST",
			    dataType: "json",
...
<div class="js-tab">
	...
	<input type="hidden" name="formId" id="formId3" value='4f273d714d9544149f34e2d6d7ff9b03'/>
	<input type="hidden" name="4f273d714d9544149f34e2d6d7ff9b4a" value="paraMap1@" />
	<input type="hidden" name="paraMap1@__LEVEL__" value="1" />
	<input type="hidden" name="paraMap1@__DATA_COUNT__" value="1" />
		<s:set name="_$viewId" value="'4da93f8a8ca44eda8837e9ed9ba9c25e'" />
		...
		<tr>
			...
			<td class="name" /><bu:uitn colNo="T2#WAD_DOC_TYPE" formId="4f273d714d9544149f34e2d6d7ff9b4a" /></td>
			<bu:td cssClass="dec" colNo="T2#WAD_DOC_TYPE" formId="4f273d714d9544149f34e2d6d7ff9b4a" ><bu:ui colNo="T2#WAD_DOC_TYPE" style="width:200px;" formId="4f273d714d9544149f34e2d6d7ff9b4a" dataId="${dataId}" formIndex="1" /></bu:td>
			
			<td class="name" /><bu:uitn colNo="T2#WAD_DISPATCH_SN" formId="4f273d714d9544149f34e2d6d7ff9b4a" /></td>
			<bu:td cssClass="dec" style="width:200px;" colNo="T2#WAD_DISPATCH_SN" formId="4f273d714d9544149f34e2d6d7ff9b4a" ><bu:ui colNo="T2#WAD_DISPATCH_SN" style="width:200px;" formId="4f273d714d9544149f34e2d6d7ff9b4a" dataId="${dataId}" formIndex="1" /></bu:td>
		
		</tr>
		<tr>
			<td class="name" /><span class="dot">*</span><bu:uitn colNo="T2#WAD_ALLOT_DATE" formId="4f273d714d9544149f34e2d6d7ff9b4a" /></td>
    					...
    					<div class="datagrid-div2 datagrid-div6 datagrid-view"  id="datagrid-view">
    						<div class="datagrid-header" style="width:100%;">
    							<div class="datagrid-header-inner head2" style="width:100%;" id="datagrid-header-inner1">
    								<table  class="datagrid-htable fixedTable  " id="datagrid-htable4f273d714d9544149f34e2d6d7ff9b03" >
    									<tbody>
    						...
    						<div class="datagrid-body datagrid-div3 scroll2"   style="height:340px;">
    							<table class="datagrid-htable fixedTable dlist-table table-line" style="table-layout:fixed;" id="datagrid-btable-ajax4f273d714d9544149f34e2d6d7ff9b03" >
    								<tbody id="itemTbody" >
    								</tbody>
    							</table>
    						</div>
...
<bu:script viewId="4da93f8a8ca44eda8837e9ed9ba9c25e" />
...
<script type="text/javascript">
$(function(){
    	//$("#document.getElementById('paraMapObj_T2#WAD_DOC_TYPE')").val();
	getWmsSel();
})
//根据调拨单号获取物料信息
function getItem(){
	$("#docNum").val($("#paraMapObj_WAI_DOC_NUM").val());
	var getItemUrl= "${path}buss/bussModel_exeFunc.ms?funcMId=5b174435d68345c3a35ac776f4aae0cb";
	util.showLoading("处理中...");
			$.ajax({
				type: "POST",
			    dataType: "json",
				...
				success: function(data){
						...
						if(null != data.ajaxList){
							...
							for(var i=0;i<rccList.length;i++){
								...
								$("#datagrid-btable-ajax4f273d714d9544149f34e2d6d7ff1234 tr:last").append("<td class='datagrid-cell datagrid-cell-2' style='width:30px;text-align: center;'><input type='checkbox' name='isSelect1' value='"+rccList[i].ID+"'/></td>");
								...
								$("#datagrid-btable-ajax4f273d714d9544149f34e2d6d7ff1234 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:120px;text-align: center;'>"+rccList[i].CI_ITEM_NAME+"<input type='hidden' name='itemId' value='"+rccList[i].ID+"'/></td>");
								...
								$("#datagrid-btable-ajax4f273d714d9544149f34e2d6d7ff1234 tr:last").append("<td class='datagrid-cell datagrid-cell-6' style='width:90px;text-align: center;padding:0;'><input type='text' style='width: 90px;padding:0;text-align: right;' class=' input isSubmit' id='PLAN_NUM_"+(trrCount+1)+"' name='PLAN_NUM' value='"+rccList[i].WAI_PLAN_NUM+"'/></td>");
								...
								$("#datagrid-btable-ajax4f273d714d9544149f34e2d6d7ff1234 tr:last").append("<td class='datagrid-cell datagrid-cell-8' style='width:120px;padding:0;'>"+wmsSel+"</td>");
								$("#datagrid-btable-ajax4f273d714d9544149f34e2d6d7ff1234 tr:last").append("<td class='datagrid-cell datagrid-cell-9' style='width:120px;padding:0;'>"+outSel+"</td>");
								$("#datagrid-btable-ajax4f273d714d9544149f34e2d6d7ff1234 tr:last").append("<td class='datagrid-cell datagrid-cell-10' style='width:200px;text-align: center;padding:0;'><input style='width: 100%;padding:0;' name='ALLOT_DATE' class=' input isSubmit  _VAL_OjbsData WdateNomorl' onfocus='WdatePicker({skin:\"blue\",dateFmt:\"yyyy-MM-dd\"})' value='"+rccList[i].ALLOT_DATE+"'/></td>");
...
function editCal(){
  ...
  document.forms.editForm.action = "${path}buss/bussModel_exeFunc.ms?funcMId=8e2891ccda9740c691a046035b450a87";
