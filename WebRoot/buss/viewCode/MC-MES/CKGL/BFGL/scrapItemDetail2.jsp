...
$(function(){
	...
	<script type="text/javascript">
		...
		$(function() {
			$("#paraMapObj_T2#WAD_WH_CODE").attr("disabled",true);
			$("#paraMapObj_T2#WSD_DUTY_DEPT").attr("disabled",true);
			$("#paraMapObj_T2#WAD_SCARP_TYPE").attr("disabled",true);
			$("#paraMapObj_T2#WSD_DUTY_EMP_SHOW").attr("disabled",true);
		})
...
<body style="overflow: hidden;">
	...
	<s:set name="_$viewId" value="'8e08e566519843989b95417629e2499a'" />
									...
									<tbody id="addItemInfo">
										<c:forEach items="${dataList}" var="item" varStatus="status">
											<tr id="trr${item.ID}" name="${item.ID}">
												...
												<td  class='datagrid-cell datagrid-cell-3' style='width:150px;text-align:left;' title='${item.ITEM_SN}'>
													${item.ITEM_SN}<input type='hidden' name='ITEM_SN' value='${item.ITEM_SN}'/>
												</td>
												<td  class='datagrid-cell datagrid-cell-4' style='width:110px;text-align:left;' title='${item.WH_CODE_NAME}'>
													${item.WH_CODE_NAME}<input type='hidden' name='WH_CODE_NAME' value='${item.WH_CODE_NAME}'/>
												</td>
												<td  class='datagrid-cell datagrid-cell-5' style='width:100px;text-align:right;' title='${item.ITEM_NUM}'>
													${item.ITEM_NUM}<input type='hidden' name='ITEM_NUM' value='${item.ITEM_NUM}'/>
												</td>
												<td class='datagrid-cell datagrid-cell-6' style='width:150px;text-align:left;' title='${item.ITEM_CODE}'>
													${item.ITEM_CODE}<input type='hidden' name='ITEM_CODE' value='${item.ITEM_CODE}'/>
												</td>
												<td  class='datagrid-cell datagrid-cell-7' style='width:150px;text-align:left;' title='${item.ITEM_NAME}'>
													${item.ITEM_NAME}<input type='hidden' name='ITEM_NAME' value='${item.ITEM_NAME}'/>
												</td>
												<td  class='datagrid-cell datagrid-cell-8' style='width:150px;text-align:left;' title='${item.ITEM_SPEC}'>
			...
			<div class="panel datagrid datagrid-div1">
				<div class="datagrid-div2 datagrid-div6 datagrid-view"  id="datagrid-view">
					...
					<div class="datagrid-body datagrid-div3 scroll2"   style="height:310px;">
						<table class="datagrid-htable fixedTable dlist-table table-line" style="table-layout:fixed;" id="datagrid-btable-ajax1aad990f8a774aeaa80d6b02a13a1203" >
							<tbody id="itemTbody" >
							</tbody>
						</table>
					</div>
	...
	<bu:submit viewId="8e08e566519843989b95417629e2499a" />
	<bu:script viewId="8e08e566519843989b95417629e2499a" />
