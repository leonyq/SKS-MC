	...
	<script type="text/javascript">
		...
		function addItemInfo() {
			...
			$.ajax({
				type: "POST",
				dataType: "json",
				url: "buss/bussModel_exeFunc.ms?FUNC_CODE=F6902&funcMId=31f832aeb5374d6eb587bda81bf53ec1",
				data: "",
		...
		function searchItemInfo(paginationImpl) {
			...
			$.ajax({
				type: "POST",
				dataType: "json",
				url: "buss/bussModel_exeFunc.ms?FUNC_CODE=F6903&funcMId=1e8500fa425b4ca7a70c7f28f1921545",
...
<body style="overflow: hidden;background-color:white;">
	<div class="edit">
		<form id="detailForm" name="detailForm" action="#" method="post" <bu:formet exeid="%{exeid}" />
					target="submitFrame">
		...
		<bu:set name="paraMapObj" value="${dataId}" formId="a0614fd913404e73a7141ce9ff13e439" type="edit" />
	<div class="mod">
	<div class="mod-hd">
	...
	<s:set name="_$viewId" value="'a0614fd913404e73a7141ce9ff13e439'" />
	...
	<tr>
		...
		<bu:td cssClass="dec" colNo="WSD_DOC_NUM" formId="a0614fd913404e73a7141ce9ff13e439">
			<bu:ui colNo="WSD_DOC_NUM" style="width:200px;" formId="a0614fd913404e73a7141ce9ff13e439" dataId="${dataId}" formIndex="1" /></bu:td>
		...
		<bu:td cssClass="dec" colNo="WSD_DOC_TYPE" formId="a0614fd913404e73a7141ce9ff13e439">
			<bu:ui colNo="WSD_DOC_TYPE" style="width:200px;" formId="a0614fd913404e73a7141ce9ff13e439" dataId="${dataId}" formIndex="1" /></bu:td>
		...
		<bu:td cssClass="dec" style="width:200px;" colNo="WAD_SCARP_TYPE" formId="a0614fd913404e73a7141ce9ff13e439">
			<bu:ui colNo="WAD_SCARP_TYPE" style="width:200px;" formId="a0614fd913404e73a7141ce9ff13e439" dataId="${dataId}" formIndex="1" /></bu:td>
	...
	<tr>
		...
		<bu:td cssClass="dec" colNo="WAD_WH_CODE" formId="a0614fd913404e73a7141ce9ff13e439">
			<bu:ui colNo="WAD_WH_CODE" style="width:200px;" formId="a0614fd913404e73a7141ce9ff13e439" dataId="${dataId}" formIndex="1" /></bu:td>
	
		<td class="name" />
		<bu:uitn colNo="WAD_CREATE_MAN" formId="a0614fd913404e73a7141ce9ff13e439" />
		</td>
		<bu:td cssClass="dec" colNo="WAD_CREATE_MAN" formId="a0614fd913404e73a7141ce9ff13e439">
			<bu:ui colNo="WAD_CREATE_MAN" style="width:200px;" formId="a0614fd913404e73a7141ce9ff13e439" dataId="${dataId}" formIndex="1" /></bu:td>
	...
	<tr>
		...
		<bu:td cssClass="dec" colNo="WAD_SCARP_REASON" formId="a0614fd913404e73a7141ce9ff13e439" style="height:80px;" colspan="5">
			<bu:ui colNo="WAD_SCARP_REASON" style="width:100%;height:100%" formId="a0614fd913404e73a7141ce9ff13e439" dataId="${dataId}" formIndex="1" /></bu:td>
	...
	<bu:submit viewId="a0614fd913404e73a7141ce9ff13e439" />
	<bu:script viewId="a0614fd913404e73a7141ce9ff13e439" />
