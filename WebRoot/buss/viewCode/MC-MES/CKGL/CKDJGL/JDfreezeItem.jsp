...
<body>
	<div class="edit">
		<form id="addForm" name="addForm" action="${path}buss/bussModel_addAjaxComm.ms?<s:property value='%{@com.more.fw.core.common.method.Constants@FUNC_CODE}' />=<s:property value='%{FUNC_CODE_2}' />" method="post" <bu:formet exeid="%{exeid}" />
            ...
            <div class="hd">
                ...
                <div style="margin-left:10px;">
	                <table class="basic-table">
						...
						<input type="hidden" name="paraMap1@__DATA_COUNT__" value="1" />
							<s:set name="_$viewId" value="'5051f5a882f34908af328884fe125b1e'" />
			    ...
			    <div class="optn">
			        <button type="button" onclick="addInfo();"><i class="ico ico-save"></i><dict:lang value="解冻当前" /></button>
			        <button type="button" onclick="addInfoAll();"><i class="ico ico-save"></i><dict:lang value="解冻所有" /></button>
	...
	<input type="hidden" name="paraMap1@__DATA_COUNT__" value="1" />
		...
		<tr>
			<td class="name" />
			<bu:uitn colNo="WFI_THAW_MEMO" formId="d67504b364614451ae814526364a482c" />
			</td>
			<bu:td cssClass="dec" colNo="WFI_THAW_MEMO" formId="d67504b364614451ae814526364a482c" style="height:80px;" colspan="5">
				<bu:ui colNo="WFI_THAW_MEMO" style="width:100%;height:100%" formId="d67504b364614451ae814526364a482c" value="%{WFI_THAW_MEMO}" formIndex="1" /></bu:td>
	...
	<bu:submit viewId="5051f5a882f34908af328884fe125b1e" />
	<bu:script viewId="5051f5a882f34908af328884fe125b1e" />
	...
	$(function(){
		...
		function getItemInfo() {
			...
			$.ajax({
				type: "POST",
				dataType: "json",
				url: "buss/bussModel_exeFunc.ms?funcMId=d7a9100d491d4ed4a1969470fdb43ba1",
				data: {
				    "flag" : "empty",
				    "paraMap.type" : 2
				},
		...
		function searchItemInfo(paginationImpl) {
			...
			$.ajax({
				type: "POST",
				dataType: "json",
				url: "buss/bussModel_exeFunc.ms?funcMId=36eb52a12488495b9ede0040b658a2f9",
				data: {
				    "paraMap.type" : 2,
				...
				/*data: "paraMap.type=2&paraMap.startDate=" +startDate+ "&paraMap.endDate=" + endDate+ "&paraMap.itemSN=" + itemSN+ "&paraMap.itemCode=" + itemCode
				    + "&paraMap.whCode=" + whCode+ "&paraMap.custCode=" + custCode + "&paraMap.supCode=" + supCode+ "&paraMap.lotNo=" + lotNo 					
                    + "&paraMap.productStartDate=" + productStartDate	+ "&paraMap.productEndDate=" + productEndDate+ "&paraMap.connectDoc=" + connectDoc+ "&paraMap.inspectSn=" + inspectSn
	...
	<script type="text/javascript">
		...
		function saveInfoAll(){
			var flag=false;
			var itemSns="";
			if($("#addItemInfo :checkbox").length<=0){
			    return flag;
			}
			var startDate = $.trim($("#startDate").val());//入库开始时间
			var endDate = $.trim($("#endDate").val());//入库结束时间
		...
		function addInfo(){      
			...
			$("#saveBtn").prop("disabled","disabled");
                        ...
                        document.forms.addForm.action = "${path}buss/bussModel_exeFunc.ms?funcMId=982e97bf0c5b41eeb2a080b448326c7b";
