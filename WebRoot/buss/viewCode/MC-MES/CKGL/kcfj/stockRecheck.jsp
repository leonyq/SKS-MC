 ...
 function createTableModel(ms,formId){
    ...
    if(formId=='c408f3497e29446eb0d2f546ff63868b'){<%--仓库库存复检信息--%>
        $.each(uiTxt,function(i,v){
            ...
            arrHtml.push("<span colno='WRD_TEST_DOC' class='"+ms.uiClass(formId, 'WRD_TEST_DOC')+"' onclick='itemJump1(\""+v['WRD_TEST_DOC']+"\")' style='display: inline;border-bottom: 1px solid #004098;' "+ms.uiEvent(formId, 'WRD_TEST_DOC')+" title='"+ms.titleAttr(formId,'WRD_TEST_DOC','IS_TITLE_ATTR',v)+"' >"+v['WRD_TEST_DOC']+"</span>")
            ...
            arrHtml.push("<span colno='WRD_ITEM_CODE' class='"+ms.uiClass(formId, 'WRD_ITEM_CODE')+"' onclick='itemJump2(\""+v['WRD_ITEM_CODE']+"\")' style='display: inline;border-bottom: 1px solid #004098;' "+ms.uiEvent(formId, 'WRD_ITEM_CODE')+" title='"+ms.titleAttr(formId,'WRD_ITEM_CODE','IS_TITLE_ATTR',v)+"' >"+v['WRD_ITEM_CODE']+"</span>")
    ...
    if(formId=='c2bca7b7c2094a2495a26e6ca72b7bbc'){<%--仓库库存复检单明细信息--%>
        $.each(uiTxt,function(i,v){
           ...
           // arrHtml.push("</td>");
            ...
            arrHtml.push("<span colno='WRD_ITEM_SN' class='"+ms.uiClass(formId, 'WRD_ITEM_SN')+"' onclick='itemJump3(\""+v['WRD_ITEM_SN']+"\")' style='display: inline;border-bottom: 1px solid #004098;' "+ms.uiEvent(formId, 'WRD_ITEM_SN')+" title='"+ms.titleAttr(formId,'WRD_ITEM_SN','IS_TITLE_ATTR',v)+"' >"+v['WRD_ITEM_SN']+"</span>")
            arrHtml.push("</td>");
            arrHtml.push("<td colno='WRD_ITEM_CODE' class='datagrid-cell "+ms.tdClass(formId, 'WRD_ITEM_CODE')+"' style='width:150px;"+ms.tdStyle(formId, 'WRD_ITEM_CODE')+"' "+ms.tdEvent(formId, 'WRD_ITEM_CODE')+">")
            arrHtml.push("<span colno='WRD_ITEM_CODE' class='"+ms.uiClass(formId, 'WRD_ITEM_CODE')+"' onclick='itemJump2(\""+v['WRD_ITEM_CODE']+"\")' style='display: inline;border-bottom: 1px solid #004098;' "+ms.uiEvent(formId, 'WRD_ITEM_CODE')+" title='"+ms.titleAttr(formId,'WRD_ITEM_CODE','IS_TITLE_ATTR',v)+"' >"+v['WRD_ITEM_CODE']+"</span>")
            arrHtml.push("</td>");
