	...
	<script type="text/javascript">
	    ...
	    $(function(){
	    	...
	    	function  _getUserEMP(){
	    	    var GetUserEmpUrl="${path}buss/bussModel_exeFunc.ms?funcMId=393b63d805924ab9ac9a24ab1933c5e0";//VM-物料管控-新增 操作功能 获取员工号
	    	    $.ajax({
	    	        type:"post",
	    	        dataType:"json",
	    	        url:GetUserEmpUrl,
		...
		function addItemTbody(){
		    ...
		    var SerachDetail= "${path}buss/bussModel_exeFunc.ms?funcMId=8dc7f69bb6a14476b74cf1fd119a1471";//VM-物料管控-新增 操作功能 物料明细信息
				...
				success: function(data){
					...
					if(null !=data.ajaxPage.dataList){
						...
						for(var i=0; i<list.length; i++){
							...
							$("#itemTbody tr:last").append("<td class='datagrid-cell datagrid-cell-5' style='width:165px;text-align: center;' >"+list[i].CI_ITEM_SPEC+"<input type='hidden' id='CI_ITEM_SPEC_"+list[i].ID+"' value='"+list[i].CI_ITEM_SPEC+"'/></td>");
...
<body>
	...
	<input type="hidden" name="paraMap1@__DATA_COUNT__" value="1" />
		...
		<tr>
			<td class="name-three" /><span class="dot">*</span><bu:uitn   colNo="WIC_CTRL_EMP" formId="465bfc3dfbec493d8bf3eab7cd53bef4" /></td>
...
<jsp:include page="/plf/page/mesdemo/commCode/commCode.jsp">
					...
					<td class="name" style="text-align:center;width:90px;"/><dict:lang value="物料类别"/></td>
					 <td class="dec"><dict:selectDict id="itemGenre" name="itemGenre" dictCode="CI_ITEM_GENRE" dictValue="%{userDto.CI_ITEM_GENRE}"  style="cursor: pointer;width:230px;" /></td>
    					...
    					<div class="datagrid-div2 datagrid-div6 datagrid-view"  id="datagrid-view">
    						...
    						<div class="datagrid-body datagrid-div3 scroll3"   style="height:275px;">
	...
	<jsp:include page="/plf/common/fp/pub_dom_fp.jsp">
		...
		function _getUserName(obj){
		    ...
		    var getNameUrl= "${path}buss/bussModel_exeFunc.ms?funcMId=4914832d21fa411ea1d374e5a1e5bc9c";//VM-物料管控-新增 操作功能 获取员工名字
		...
		function  SearchDetailFun(paginationImpl,url){
    			...
    			var itemCodeStr = getItemCodeList();
			  var SearchDetailFunUrl= "${path}buss/bussModel_exeFunc.ms?funcMId=97e5c26e8a074e5eacd841831449d9bd";//VM-物料管控-新增 操作功能 物料明细信息分页
			$.ajax({
				type: "POST",
			    	dataType: "json",
    	...
    	$("#itemTbody :checkbox").each(function(){
    			if($(this).attr("checked")){
    				if (!$("#trr"+$(this).attr("id")).length) {  
    					...
    					$("#addItemInfo tr:last").append("<td class='datagrid-cell datagrid-cell-5' style='width:120px;text-align: center;'>"+$("#CI_ITEM_SPEC_"+$(this).attr("id")).val()+"</td>");
