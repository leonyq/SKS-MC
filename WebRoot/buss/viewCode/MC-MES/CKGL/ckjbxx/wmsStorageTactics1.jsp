...
<body >
    <div class="content-in">
		...
		<div class="datagrid-div2 datagrid-div6 datagrid-view-ajax" id="datagrid-view-ajaxe517a4b8c2a44f9695a6415348789dac" style="width:100%;height:100%;overflow-x:hidden;"><!--overflow-x:hidden;-->
		...
		<bu:tr cssClass="datagrid-header-row datagrid-title-ajax" id="datagrid-title-ajax">
			...
			<td class="datagrid-cell" style="width:200px;display:none;"><bu:uitn colNo="DATA_AUTH" formId="e517a4b8c2a44f9695a6415348789dac" /></td>
    ...
    <script type="text/javascript">
                ...
                function listAjaxTable(formId){
                    ...
                    console.log("searchParams="+searchParams+"结束");
                ...
                function query(thisObj){
                    ...
                    if(dataAuth==""){
                     utilsFp.confirmIcon(1,"","","", "请选择组织机构",0,"260","145");  
                     return false;
                    }
