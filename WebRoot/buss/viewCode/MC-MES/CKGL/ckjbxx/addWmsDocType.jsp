...
function popModelDiv(showId,backId){
            $("#paraMap1_WDT_ORDER_SET").val("");
            $("#paraMap1_WDT_ORDER_SET").trigger("chosen:updated");
            $("#paraMap1_WDO_ORDER_SN").val("");
		        $("#"+showId+",#"+backId).show();
			$("#"+showId).draggable();
			...
			//mySetChosen(); 
			$("#paraMap1_WDT_ORDER_SET_chosen").attr("style","width:230px;");
			addOrderInfo();
			//getModTypeSelect();
	}
...
function searchOrderInfo(paginationImpl){
	var isFirstLoad = firstLoadThisPage(paginationImpl);
    	...
    	var orderSet = $("#paraMap1_WDT_ORDER_SET").val();
        var orderSn = $("#paraMap1_WDO_ORDER_SN").val();
    	util.showLoading("处理中...");
    	$.ajax({
			    type: "POST",
			    dataType: "json",
			    url: "${path}buss/bussModel_exeFunc.ms?funcMId=91f902675c6441abbbc6245a89cd6d75",//VM-单据配置中心-新增 操作功能 指令信息分页
			    data:{
			       "paraMap.type":"1",
			    ...
			    //data: "paraMap.type=1&paraMap.orderSet="+orderSet+"&paraMap.orderSn="+orderSn+"&page.currentPage="+_GLO_FORM_PAGE_MAP[paginationImpl].currentPage+"&page.pageRecord=" + _GLO_FORM_PAGE_MAP[paginationImpl].pageRecord,
				success: function(data){
				                 $("#orderTbody").empty();
						util.closeLoading();
						if(null != data.ajaxPage.dataList){
	...
	$("#orderTbody :checkbox").each(function(){
			if($(this).attr("checked")){
				...
				if (!$("#trr"+$(this).attr("id")).length) { //验证是否有重复的
					...
					$("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a1234 tr:last").append("<td class='datagrid-cell datagrid-cell-1' style='width:30px;text-align: center;'>"+(len+1)+"<input type='hidden' name='TCS_CODE' value='"+$("#TCS_CODE"+$(this).attr("id")).val()+"'/></td>");
					...
					$("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a1234 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:110px;text-align: center;'>"+$("#TCL_NAME"+$(this).attr("id")).val()+"</td>");
...
function addMyRow(){
	...
	$("#createRuleSel_"+(ttCount+1)+"_chosen").attr("style","width:150px;");
	ttCount++;
...
function addCal(){
			...
			$("#saveBtn").prop("disabled","disabled");
                        ...
                        document.forms.addForm.action = "${path}buss/bussModel_exeFunc.ms?funcMId=c77c606226f440ee8639a3f60985f932";
...
<body>
	<div class="edit">
		...
		<bu:set name="paraMapObj" value="${dataId}" formId="ef1235107cca42518c74d9cac446da3f" type="add" />
	...
	<input type="hidden" name="paraMap1@__DATA_COUNT__" value="1" />
		<s:set name="_$viewId" value="'25a1db21abee45e4b441a53964642d6b'" />
		...
		<tr>
			...
			<bu:td cssClass="dec" colNo="WDT_TYPE_SN" formId="ef1235107cca42518c74d9cac446da3f" ><bu:ui colNo="WDT_TYPE_SN" formId="ef1235107cca42518c74d9cac446da3f" value="%{WDT_TYPE_SN}" formIndex="1" /></bu:td>
		
			<td class="name" /><span class="dot">*</span><bu:uitn colNo="WDT_TYPE_NAME" formId="ef1235107cca42518c74d9cac446da3f" /></td>
			<bu:td cssClass="dec" colNo="WDT_TYPE_NAME" formId="ef1235107cca42518c74d9cac446da3f" ><bu:ui colNo="WDT_TYPE_NAME" formId="ef1235107cca42518c74d9cac446da3f" value="%{WDT_TYPE_NAME}" formIndex="1" /></bu:td>
		</tr>
		<tr>
			<td class="name" /><bu:uitn colNo="WDT_DOC_PREFIX" formId="ef1235107cca42518c74d9cac446da3f" /></td>
			<bu:td cssClass="dec" colNo="WDT_DOC_PREFIX" formId="ef1235107cca42518c74d9cac446da3f" ><bu:ui colNo="WDT_DOC_PREFIX" formId="ef1235107cca42518c74d9cac446da3f" value="%{WDT_DOC_PREFIX}" formIndex="1" /></bu:td>
		
			<td class="name" /><bu:uitn colNo="WDT_OPERATE_TYPE" formId="ef1235107cca42518c74d9cac446da3f" /></td>
			<bu:td cssClass="dec" colNo="WDT_OPERATE_TYPE" formId="ef1235107cca42518c74d9cac446da3f" ><bu:ui colNo="WDT_OPERATE_TYPE" formId="ef1235107cca42518c74d9cac446da3f" value="%{WDT_OPERATE_TYPE}" formIndex="1" /></bu:td>
		</tr>
		<tr>
			<td class="name" /><bu:uitn colNo="WDT_ERP_TYPE" formId="ef1235107cca42518c74d9cac446da3f" /></td>
			<bu:td cssClass="dec" colNo="WDT_ERP_TYPE" formId="ef1235107cca42518c74d9cac446da3f" ><bu:ui colNo="WDT_ERP_TYPE" formId="ef1235107cca42518c74d9cac446da3f" value="%{WDT_ERP_TYPE}" formIndex="1" /></bu:td>
			...
			<bu:ui colNo="WDT_SAMPLE_FLAG" formId="ef1235107cca42518c74d9cac446da3f" value="%{WDT_SAMPLE_FLAG}" formIndex="1" />
			&nbsp;&nbsp;&nbsp;
			<bu:uitn colNo="WDT_HANDOVER_FLAG" formId="ef1235107cca42518c74d9cac446da3f" />
			<bu:ui colNo="WDT_HANDOVER_FLAG" formId="ef1235107cca42518c74d9cac446da3f" value="%{WDT_HANDOVER_FLAG}" formIndex="1" />
			&nbsp;&nbsp;&nbsp;
			<bu:uitn colNo="WDT_UPLOAD_FLAG" formId="ef1235107cca42518c74d9cac446da3f" />
			<bu:ui colNo="WDT_UPLOAD_FLAG" formId="ef1235107cca42518c74d9cac446da3f" value="%{WDT_UPLOAD_FLAG}" formIndex="1" />
			</bu:td>
		<tr>
			<td class="name" /><bu:uitn colNo="WDT_TEST_STEP" formId="ef1235107cca42518c74d9cac446da3f" /></td>
			<bu:td cssClass="dec" colNo="WDT_TEST_STEP" formId="ef1235107cca42518c74d9cac446da3f" ><bu:ui colNo="WDT_TEST_STEP" formId="ef1235107cca42518c74d9cac446da3f" value="%{WDT_TEST_STEP}" formIndex="1" /></bu:td>
		
			<td class="name" /><bu:uitn colNo="WDT_SAMPLE_TYPE" formId="ef1235107cca42518c74d9cac446da3f" /></td>
			<bu:td cssClass="dec" colNo="WDT_SAMPLE_TYPE" formId="ef1235107cca42518c74d9cac446da3f" ><bu:ui colNo="WDT_SAMPLE_TYPE" formId="ef1235107cca42518c74d9cac446da3f" value="%{WDT_SAMPLE_TYPE}" formIndex="1" /></bu:td>
		...
		<tr>
			...
			<bu:ui colNo="WDT_EXCESS_RECEIVE" formId="ef1235107cca42518c74d9cac446da3f" value="%{WDT_EXCESS_RECEIVE}" formIndex="1" />
			&nbsp;&nbsp;&nbsp;
			<bu:uitn colNo="WDT_EXCESS_PICK" formId="ef1235107cca42518c74d9cac446da3f" />
			<bu:ui colNo="WDT_EXCESS_PICK" formId="ef1235107cca42518c74d9cac446da3f" value="%{WDT_EXCESS_PICK}" formIndex="1" />
			&nbsp;&nbsp;&nbsp;
			<bu:uitn colNo="WDT_PDA_FLAG" formId="ef1235107cca42518c74d9cac446da3f" />
			<bu:ui colNo="WDT_PDA_FLAG" formId="ef1235107cca42518c74d9cac446da3f" value="%{WDT_PDA_FLAG}" formIndex="1" />
			</bu:td>
		
			<td class="name" /><bu:uitn colNo="WDT_HANDOVER_WAYS" formId="ef1235107cca42518c74d9cac446da3f" /></td>
			<bu:td cssClass="dec" colNo="WDT_HANDOVER_WAYS" formId="ef1235107cca42518c74d9cac446da3f" ><bu:ui colNo="WDT_HANDOVER_WAYS" formId="ef1235107cca42518c74d9cac446da3f" value="%{WDT_HANDOVER_FLAG}" formIndex="1" /></bu:td>
		
		</tr>
		<tr>
			<td class="name" /><bu:uitn colNo="WDT_CREATE_RULE" formId="ef1235107cca42518c74d9cac446da3f" /></td>
			<bu:td cssClass="dec" colNo="WDT_CREATE_RULE" formId="ef1235107cca42518c74d9cac446da3f" ><bu:ui colNo="WDT_CREATE_RULE" formId="ef1235107cca42518c74d9cac446da3f" value="%{WDT_CREATE_RULE}" formIndex="1" /></bu:td>
	...
	<div class="js-tab">
		...
		<div class="extend-btn" id="addDel" style="float: right;margin-top:-40px;">
			...
			<div class="mod-bd" style="margin-top:5px;">
				<div class="panel datagrid datagrid-div1">
					<div class="datagrid-div2 datagrid-div6 datagrid-view"   >
						...
						<div class="datagrid-body datagrid-div3 scorl1"   style="height:170px;max-width:100%">
							...
							<div class="datagrid-header-inner head2" id="" >
								<table  class="datagrid-htable fixedTable datagrid-div6 datagrid-htable-kz  " id="datagrid-htable831b2dbf0dfb494695b7ce66538a5678">
									...
									<tr class="datagrid-header-row thcolor">
										...
										<td style="display:none;">
										<bu:ui colNo="WDT_CREATE_RULE" id="createRule" name="createRule" style="width:240px;" formId="ef1235107cca42518c74d9cac446da3f" value="%{WDT_CREATE_RULE}" formIndex="1" />
										</td >
									</tr>
									</tbody>		
								</table>
...
<bu:script viewId="25a1db21abee45e4b441a53964642d6b" />
...
$(function(){
	...
	$("#paraMap1_WDT_SAMPLE_FLAG_1").attr("onchange","changeInfo();");
	$("#paraMap1_WDT_OPERATE_TYPE").attr("onchange","changeCheckState();");
	$("#paraMap1_WDT_HANDOVER_FLAG_1").attr("onchange","changeHandover();");
	
})
//根据复选框选中状态改变检验阶别和检验类型
function changeInfo(){
	if($("#paraMap1_WDT_SAMPLE_FLAG_1").attr("checked") == "checked"){
        	$("#paraMap1_WDT_TEST_STEP").removeAttr("disabled");
        	$("#paraMap1_WDT_TEST_STEP").attr("class","_VAL_NULL input isSubmit  _VAL_OjbsData dept_select");
        	$("#paraMap1_WDT_SAMPLE_TYPE").removeAttr("disabled");
        	$("#paraMap1_WDT_TEST_STEP").trigger("chosen:updated");
        	$("#paraMap1_WDT_SAMPLE_TYPE").trigger("chosen:updated");
    	}else{
    		$("#paraMap1_WDT_TEST_STEP").val("");
    		
    		$("#paraMap1_WDT_SAMPLE_TYPE").val("");
    		$("#paraMap1_WDT_TEST_STEP").attr("class"," input isSubmit  _VAL_OjbsData readonly dept_select");
        	$("#paraMap1_WDT_TEST_STEP").attr("disabled","disabled");
        	$("#paraMap1_WDT_SAMPLE_TYPE").attr("disabled","disabled");
        	$("#paraMap1_WDT_TEST_STEP").trigger("chosen:updated");
        	$("#paraMap1_WDT_SAMPLE_TYPE").trigger("chosen:updated");
    	}
}
...
function changeCheckState(){
	if($("#paraMap1_WDT_OPERATE_TYPE").val()==1){  //为入库时超收标志允许勾选，超发标志不允许勾选
		$("#paraMap1_WDT_EXCESS_RECEIVE_1").removeAttr("disabled");
		$("#paraMap1_WDT_EXCESS_PICK_1").attr("disabled","disabled");
	}
	if($("#paraMap1_WDT_OPERATE_TYPE").val()==2){  //为出库类型时，超收标志不允许勾选，超发标志允许勾选
		$("#paraMap1_WDT_EXCESS_PICK_1").removeAttr("disabled");
		$("#paraMap1_WDT_EXCESS_RECEIVE_1").attr("disabled","disabled");
	}
	if($("#paraMap1_WDT_OPERATE_TYPE").val()==""){  //为空
		$("#paraMap1_WDT_EXCESS_PICK_1").attr("disabled","disabled");
		$("#paraMap1_WDT_EXCESS_RECEIVE_1").attr("disabled","disabled");
	}
}
//根据复选框选中状态改变交接方式
function changeHandover(){
	if($("#paraMap1_WDT_HANDOVER_FLAG_1").attr("checked") == "checked"){
        	$("#paraMap1_WDT_HANDOVER_WAYS").removeAttr("disabled");
        	$("#paraMap1_WDT_HANDOVER_WAYS").attr("class","_VAL_NULL input isSubmit  _VAL_OjbsData dept_select");
        	$("#paraMap1_WDT_HANDOVER_WAYS").trigger("chosen:updated");
    	}else{
    		$("#paraMap1_WDT_HANDOVER_WAYS").val("");

        	$("#paraMap1_WDT_HANDOVER_WAYS").attr("disabled","disabled");
        	$("#paraMap1_WDT_HANDOVER_WAYS").attr("class"," input isSubmit  _VAL_OjbsData readonly dept_select");
        	$("#paraMap1_WDT_HANDOVER_WAYS").trigger("chosen:updated");
    	}
}
//根据下拉框选中状态改变交接方式
