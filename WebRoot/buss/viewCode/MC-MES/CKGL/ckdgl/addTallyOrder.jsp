		...
		function searchOutItem(paginationImpl) {
			...
			$.ajax({
				...
				data:  {
			        ...
			        "paraMap.currentPage" : _GLO_FORM_PAGE_MAP[paginationImpl].currentPage,
			        "paraMap.pageRecord" :  _GLO_FORM_PAGE_MAP[paginationImpl].pageRecord,
			    }
...
<body>
	...
	<div class="bd">
		...
		<div class="mod">
			...
			<table class="basic-table">
				...
				<s:set name="_$viewId" value="'2ae84eb4d44a46f0acbbe3525d396e6b'" />
				...
				<tr>
					...
					<bu:td cssClass="dec" style="width:200px;" colNo="T2#WOD_DISPATCH_SN" formId="747171193cf444a784fe3b339285e612">
						<bu:ui colNo="T2#WOD_DISPATCH_SN" style="width:200px;" formId="747171193cf444a784fe3b339285e612" value="%{T2#WOD_DISPATCH_SN}" formIndex="1" /></bu:td>
	...
	<bu:submit viewId="2ae84eb4d44a46f0acbbe3525d396e6b" />
	<bu:script viewId="2ae84eb4d44a46f0acbbe3525d396e6b" />
	...
	<script type="text/javascript">
		$(function() {
			...
			$("#paraMap1_WOD_ITEM_TYPE_chosen").attr("style","width:200px;");
			$("#paraMap1_WOD_DOC_TYPE option[value='理货单']").attr("selected",true);
		...
		function addInfo(){    var tempFlag1 = checkVal1();
			...
			$("#saveBtn").prop("disabled","disabled");
                        ...
                        document.forms.addForm.action = "${path}buss/bussModel_exeFunc.ms?funcMId=e80404e06dfe428cac56969c79e2b185";
