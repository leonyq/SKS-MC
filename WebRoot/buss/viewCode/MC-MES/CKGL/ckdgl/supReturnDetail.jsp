...
<body style="background-color: white;">
	...
	<div class="bd"  style="height:550px;border:none;">
		...
		<div class="js-tab">
			...
			<table class="basic-table" id="myTable">
				...
				<s:set name="_$viewId" value="'7c8c806b0d2c4bb1870f6fc2be8e8ad5'" />
				...
				<tr>
					...
					<bu:td cssClass="dec" colNo="WOI_DOC_NUM" formId="e708d689ec8840948482b6fb750e6321">
						<bu:ui colNo="WOI_DOC_NUM" style="width:210px;" formId="e708d689ec8840948482b6fb750e6321" dataId="${dataId}" formIndex="1" /></bu:td>

					<td class="name" style="width:69px;"/>
					<bu:uitn colNo="T5#WDT_TYPE_NAME" formId="e708d689ec8840948482b6fb750e6321" />
					</td>
					<bu:td cssClass="dec" colNo="T5#WDT_TYPE_NAME" formId="e708d689ec8840948482b6fb750e6321">
						<bu:ui colNo="T5#WDT_TYPE_NAME" style="width:210px;" formId="e708d689ec8840948482b6fb750e6321" dataId="${dataId}" formIndex="1" /></bu:td>

					<td class="name" style="width:69px;"/>
					<bu:uitn colNo="T2#WOD_DISPATCH_SN" formId="e708d689ec8840948482b6fb750e6321" />
					</td>
					<bu:td cssClass="dec" style="width:210px;" colNo="T2#WOD_DISPATCH_SN" formId="e708d689ec8840948482b6fb750e6321">
						<bu:ui colNo="T2#WOD_DISPATCH_SN" style="width:210px;" formId="e708d689ec8840948482b6fb750e6321" dataId="${dataId}" formIndex="1" /></bu:td>

				</tr>
				<tr>
					<td class="name" />
					<bu:uitn colNo="T8#SUPPLIER_NAME" formId="e708d689ec8840948482b6fb750e6321" />
					</td>
					<bu:td cssClass="dec" colNo="T8#SUPPLIER_NAME" formId="e708d689ec8840948482b6fb750e6321">
						<bu:ui colNo="T8#SUPPLIER_NAME" style="width:200px;" formId="e708d689ec8840948482b6fb750e6321" dataId="${dataId}" formIndex="1" /></bu:td>
					...
					<td class="name" /><bu:uitn colNo="T2#WOD_URGENT_FLAG" formId="e708d689ec8840948482b6fb750e6321" /></td>
			        <bu:td cssClass="dec" colNo="T2#WOD_URGENT_FLAG" formId="e708d689ec8840948482b6fb750e6321" >
			        <bu:ui colNo="T2#WOD_URGENT_FLAG" formId="e708d689ec8840948482b6fb750e6321" dataId="${dataId}" formIndex="1" />
			        <bu:uitn colNo="T2#WOD_ERP_FLAG" formId="e708d689ec8840948482b6fb750e6321" />
			        <bu:ui colNo="T2#WOD_ERP_FLAG" formId="e708d689ec8840948482b6fb750e6321" dataId="${dataId}" formIndex="1" />
			        </bu:td>
				</tr>
                <tr>
					<td class="name" />
					<bu:uitn colNo="T2#WOD_STATUS" formId="e708d689ec8840948482b6fb750e6321" />
					</td>
					<bu:td cssClass="dec" colNo="T2#WOD_STATUS" formId="e708d689ec8840948482b6fb750e6321">
						<bu:ui colNo="T2#WOD_STATUS" style="width:200px;" formId="e708d689ec8840948482b6fb750e6321" dataId="${dataId}" formIndex="1" /></bu:td>
				</tr>
				<tr>
					<td class="name" />
		...
		<div class="dialog-bd-div" style="width:100%;height:120%;">
			...
			<table class="basic-table">
				...
				<tr>
					...
					<bu:td cssClass="dec" colNo="WOD_ITEM_TYPE" formId="e708d689ec8840948482b6fb750e6321" >
						<bu:ui colNo="WOD_ITEM_TYPE" formId="e708d689ec8840948482b6fb750e6321" value="%{WOD_ITEM_TYPE}" formIndex="1" />
					</bu:td>
				</tr>
			</table>
	...
	<bu:submit viewId="7c8c806b0d2c4bb1870f6fc2be8e8ad5" />
	<bu:script viewId="7c8c806b0d2c4bb1870f6fc2be8e8ad5" />
	...
	<script type="text/javascript">
		...
		//console.log(itemUrl);
			...
			$.ajax({
				type: "POST",
		    	dataType: "json",
		    	url: "buss/bussModel_exeFunc.ms?funcMId=3c4ff53029cc4d08acd181f05659fe76&type=DJ13"+"&docNum="+$("#paraMapObj_WOI_DOC_NUM").val()+"&dataAuth=${param.dataAuth}",
		    	data: "",
				success: function(data){
		        	$("#addItemInfo").empty();
					util.closeLoading();
					...
					if(null != data.ajaxList){
						...
						for(var i=0;i<rccList.length;i++){
                			...
                			$("#datagrid-btable-ajaxe708d689ec8840948482b6fb750e6302 tr:last").append("<td class='datagrid-cell datagrid-cell-2' style='width:30px;text-align: center;'><input type='checkbox' name='isSelect1'/></td>");
						...
						//	mySetChosen();//设置下拉框样式
							...
							$("#wmsSel_"+(trrCount+1)+"_chosen").attr("style","width:120px;");
							$("#wmsSel_"+(trrCount+1)+"_chosen").attr("disabled","disabled");
							trrCount++;
						}	
