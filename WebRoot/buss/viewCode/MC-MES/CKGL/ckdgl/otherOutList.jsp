...
<head>
    ...
    <%@ include file="/plf/page/common/buss/listCommJs.jsp"%>
		<bu:header formId ="65324c73fb4340eab7fcd1a57edfee4f"/>
...
<script type="text/javascript">
	...
	function switchTag(tag, content, url) {
		...
		if(tag=="tag1"){
			listAjaxTable("65324c73fb4340eab7fcd1a57edfee4f");
...
<body >
    <div class="content-in">
        <div class="dlist">
            <div class="hd">
		<bu:func viewId="7302eb216f7d4068b3380c0178186911" />
            </div>
            <div class="bd">
		...
		<bu:search viewId="7302eb216f7d4068b3380c0178186911" />
                   </form>
		...
		<input type="hidden" name="formPage65324c73fb4340eab7fcd1a57edfee4f" id="formPage65324c73fb4340eab7fcd1a57edfee4f" value="${formPage65324c73fb4340eab7fcd1a57edfee4f}"/>
		<input type="hidden" name="formId" id="formId1" value='65324c73fb4340eab7fcd1a57edfee4f'/>
		<input type="hidden" name="formId" id="formId2" value='65324c73fb4340eab7fcd1a57edfee02'/>
		<input type="hidden" name="formId" id="formId3" value='65324c73fb4340eab7fcd1a57edfee03'/>
		<input type="hidden" name="formId" id="formId4" value='65324c73fb4340eab7fcd1a57edfee04'/>
		...
		<div class="js-tab">
			...
			<DIV class="content1" id="content" style="margin-top: 15px;">
				<DIV id="content1" style="margin-top:4px;" data-tab="tag1">
					<!--table1-->
					<div class="panel-ajax datagrid datagrid-div1"  id="65324c73fb4340eab7fcd1a57edfee4f">
					<div class="datagrid-div2 datagrid-div6 datagrid-view-ajax" id="datagrid-view-ajax65324c73fb4340eab7fcd1a57edfee4f" style="overflow: hidden;">
					<div class="datagrid-header">
					<div class="datagrid-header-inner head2" id="datagrid-header-inner65324c73fb4340eab7fcd1a57edfee4f">
					<bu:table cssClass="datagrid-htable fixedTable datagrid-div6 datagrid-htable-kz" id="datagrid-htable65324c73fb4340eab7fcd1a57edfee4f">
					<s:set name="_$type" value="'view'" />
					<tbody class="isParentsTitle">
					<bu:tr cssClass="datagrid-header-row datagrid-title-ajax" id="datagrid-title-ajax">
						<td class="datagrid-cell" style="width:30px; text-align:center;" ><bu:thSeq  formId="65324c73fb4340eab7fcd1a57edfee4f" i18n="1"/></td>
						<td class="datagrid-cell" style="width:150px;"><bu:uitn  colNo="DATA_AUTH" formId="65324c73fb4340eab7fcd1a57edfee4f" /></td>
						<td class="datagrid-cell" style="width:150px;"><bu:uitn  colNo="WOI_DOC_NUM" formId="65324c73fb4340eab7fcd1a57edfee4f" /></td>
						<td class="datagrid-cell" style="width:150px;"><bu:uitn  colNo="WOI_ITEM_CODE" formId="65324c73fb4340eab7fcd1a57edfee4f" /></td>
						<td class="datagrid-cell" style="width:120px;"><bu:uitn  colNo="T2#WOD_ERP_FLAG" formId="65324c73fb4340eab7fcd1a57edfee4f" /></td>
						<td class="datagrid-cell" style="width:90px;"><bu:uitn  colNo="T10#WDI_LIGHT_FLAG" formId="65324c73fb4340eab7fcd1a57edfee4f" /></td>
						<td class="datagrid-cell" style="width:80px;"><bu:uitn  colNo="T2#WOD_URGENT_FLAG" formId="65324c73fb4340eab7fcd1a57edfee4f" /></td>
						<td class="datagrid-cell" style="width:100px;"><bu:uitn  colNo="WOI_STATUS" formId="65324c73fb4340eab7fcd1a57edfee4f" /></td>
						<td class="datagrid-cell" style="width:80px;"><bu:uitn  colNo="WOI_PLAN_NUM" formId="65324c73fb4340eab7fcd1a57edfee4f" /></td>
						<td class="datagrid-cell" style="width:80px;"><bu:uitn  colNo="WOI_REQUEST_NUM" formId="65324c73fb4340eab7fcd1a57edfee4f" /></td>
						<td class="datagrid-cell" style="width:80px;"><bu:uitn  colNo="WOI_OUT_NUM" formId="65324c73fb4340eab7fcd1a57edfee4f" /></td>
						<td class="datagrid-cell" style="width:120px;"><bu:uitn  colNo="WOI_PACK_NUM" formId="65324c73fb4340eab7fcd1a57edfee4f" /></td>
						<!--<td class="datagrid-cell" style="width:80px;"><bu:uitn  colNo="WOI_ITEM_SEQ" formId="65324c73fb4340eab7fcd1a57edfee4f" /></td>-->
						<td class="datagrid-cell" style="width:150px;"><bu:uitn  colNo="WOI_CONNECT_DOC" formId="65324c73fb4340eab7fcd1a57edfee4f" /></td>
						<td class="datagrid-cell" style="width:120px;"><bu:uitn  colNo="T5#WDT_TYPE_NAME" formId="65324c73fb4340eab7fcd1a57edfee4f" /></td>
						<td class="datagrid-cell" style="width:120px;"><bu:uitn  colNo="T2#WOD_DISPATCH_SN" formId="65324c73fb4340eab7fcd1a57edfee4f" /></td>
						<td class="datagrid-cell" style="width:100px;"><bu:uitn  colNo="WOI_WH_CODE" formId="65324c73fb4340eab7fcd1a57edfee4f" /></td>
						<td class="datagrid-cell" style="width:150px;"><bu:uitn  colNo="WOI_ITEM_NAME" formId="65324c73fb4340eab7fcd1a57edfee4f" /></td>
						<td class="datagrid-cell" style="width:150px;"><bu:uitn  colNo="WOI_ITEM_SPEC" formId="65324c73fb4340eab7fcd1a57edfee4f" /></td>
						<!--<td class="datagrid-cell" style="width:120px;"><bu:uitn  colNo="T2#WOD_SUP_CODE" formId="65324c73fb4340eab7fcd1a57edfee4f" /></td>-->
						<td class="datagrid-cell" style="width:150px;"><bu:uitn  colNo="WOI_DELIVERY_DATE" formId="65324c73fb4340eab7fcd1a57edfee4f" /></td>
						<td class="datagrid-cell" style="width:80px;"><bu:uitn  colNo="T4#NAME" formId="65324c73fb4340eab7fcd1a57edfee4f" /></td>
						<td class="datagrid-cell" style="width:150px;" ><bu:uitn  colNo="T2#WOD_CREATE_TIME" formId="65324c73fb4340eab7fcd1a57edfee4f" /></td>
						
						<td class="datagrid-cell" style="width:120px;"><bu:uitn  colNo="T2#WOD_DISPATCH_SN" formId="65324c73fb4340eab7fcd1a57edfee4f" /></td>
						<td class="datagrid-cell" style="width:120px;"><bu:uitn  colNo="T2#WOD_DOC_TYPE" formId="65324c73fb4340eab7fcd1a57edfee4f" /></td>
						<td class="datagrid-cell" style="width:120px;" ><bu:uitn  colNo="T2#WOD_STATUS" formId="65324c73fb4340eab7fcd1a57edfee4f" /></td>
					</bu:tr>
					</tbody>
					</bu:table>
					</div>
					</div>
					<div class="datagrid-body datagrid-div3 datagrid-body-ajax scroll2" id="tableDiv65324c73fb4340eab7fcd1a57edfee4f" onscroll="ajaxTableScroll(this,'65324c73fb4340eab7fcd1a57edfee4f')" style="height: 130px;">
					<table class="datagrid-btable fixedTable dblClick"  id="datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee4f">
					<tbody id="tbody_65324c73fb4340eab7fcd1a57edfee4f" class="isParents">
					</tbody>
					</table>		</div>
					</div>
					</div>
					<c:if test="${formPage65324c73fb4340eab7fcd1a57edfee4f==1}">			<div class="center">
						<s:include value="/plf/page/fp/paginationPopMultAx.jsp?listDataFn=listAjaxTable&formId=65324c73fb4340eab7fcd1a57edfee4f&showLoading=0" />
						</div>
					</c:if>
					<!--table2-->
						...
						<div class="datagrid-div2 datagrid-div6 datagrid-view"   style="overflow-x:hidden;border-bottom:0;">
							<div class="datagrid-header" style="">
								<div class="datagrid-header-inner head1" id="" >
									<table  class="datagrid-htable fixedTable  "  id="datagrid-htable65324c73fb4340eab7fcd1a57edfee02" >
										<tbody>
							...
							<div class="datagrid-body datagrid-div3 scroll1" ><!--130-->
								<table class="datagrid-htable fixedTable dlist-table table-line " style="table-layout: fixed;"   id="datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee02">
					...
					<div class="datagrid-div2 datagrid-div6 datagrid-view"  style="overflow-x:hidden;border:0;">
						<div class="datagrid-header" style="">
							<div class="datagrid-header-inner head" id="" >
								<table  class="datagrid-htable fixedTable  "  id="datagrid-htable65324c73fb4340eab7fcd1a57edfee03" >
									<tbody>
									<tr class="datagrid-header-row thcolor">
										<td class="datagrid-cell" align="center" style="width:30px;text-align: center"></td >
						                <td class="datagrid-cell" style="width:200px;" ><dict:lang value="组织机构" /></td >
						...
						<div class="datagrid-body datagrid-div3 scroll">
							<table class="datagrid-htable fixedTable dlist-table table-line " style="width:1860px; table-layout: fixed;"    id="datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee03" >
					...
					<div class="datagrid-div2 datagrid-div6 datagrid-view"  style="overflow-x:hidden;border:0;">
						<div class="datagrid-header" style="">
							<div class="datagrid-header-inner head3" id="" >
								<table  class="datagrid-htable fixedTable  "  id="datagrid-htable65324c73fb4340eab7fcd1a57edfee04">
									<tbody>
									<tr class="datagrid-header-row thcolor">
										<td class="datagrid-cell" align="center" style="width:30px;text-align: center"></td >
						...
						<div class="datagrid-body datagrid-div3 scroll3">
							<table class="datagrid-htable fixedTable dlist-table table-line " style="table-layout: fixed;"    id="datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee04">
		...
		<bu:submit viewId="7302eb216f7d4068b3380c0178186911" />
      <jsp:include page="/plf/page/mesdemo/commCode/commCode.jsp">
           <jsp:param name="modelName" value="VIEW_TYPE_17" />
           <jsp:param name="location" value="beforeJsLoad" />
      </jsp:include>
		<bu:script viewId="7302eb216f7d4068b3380c0178186911" />
...
<script type="text/javascript">
				...
				$(document.getElementById('T2#WOD_DOC_TYPE')).val('DJ14');
                    var currentPage="";
                    var pageRecord="";
                    var isFirstLoad;
...
<script type="text/javascript">
					...
					success: function(data){
							...
							//	console.log(rccList);
                              ...
                              //      if(rccList[i].DATA_AUTH==null)  rccList[i].DATA_AUTH="";
									...
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee02 tbody:last").append("<tr id='tr1_"+i+"' ></tr>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee02 tr:last").append("<td class='datagrid-cell datagrid-cell-1' style='width:30px;text-align: center;'>"+(i+1)+"</td>");
								//	$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee02 tr:last").append("<td class='datagrid-cell datagrid-cell-2' style='width:210px;text-align: left;' title='"+rccList[i].DATA_AUTH+"'>"+rccList[i].DATA_AUTH+"</td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee02 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:210px;text-align: left;' title='"+rccList[i].ITEM_SN+"'><span onclick='itemJump3(\""+rccList[i].ITEM_SN+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].ITEM_SN+"</span></td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee02 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:150px;text-align: left;' title='"+rccList[i].ITEM_CODE+"'><span onclick='itemJump2(\""+rccList[i].ITEM_CODE+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].ITEM_CODE+"</span></td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee02 tr:last").append("<td class='datagrid-cell datagrid-cell-5' style='width:150px;text-align: left;' title='"+rccList[i].ITEM_NAME+"'>"+rccList[i].ITEM_NAME+"</td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee02 tr:last").append("<td class='datagrid-cell datagrid-cell-6' style='width:150px;text-align: left;' title='"+rccList[i].ITEM_SPEC+"'>"+rccList[i].ITEM_SPEC+"</td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee02 tr:last").append("<td class='datagrid-cell datagrid-cell-7' style='width:80px;text-align: left;' title='"+rccList[i].OUTSTOCK_NUM+"'>"+rccList[i].OUTSTOCK_NUM+"</td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee02 tr:last").append("<td class='datagrid-cell datagrid-cell-10' style='width:150px;text-align: left;' title='"+rccList[i].DOC_NUM+"'>"+rccList[i].DOC_NUM+"</td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee02 tr:last").append("<td class='datagrid-cell datagrid-cell-11' style='width:100px;text-align: left;' title='"+rccList[i].FIRST_SN+"'>"+rccList[i].FIRST_SN+"</td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee02 tr:last").append("<td class='datagrid-cell datagrid-cell-12' style='width:100px;text-align: left;' title='"+rccList[i].SECOND_SN+"'>"+rccList[i].SECOND_SN+"</td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee02 tr:last").append("<td class='datagrid-cell datagrid-cell-13' style='width:100px;text-align: left;' title='"+rccList[i].THIRD_SN+"'>"+rccList[i].THIRD_SN+"</td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee02 tr:last").append("<td class='datagrid-cell datagrid-cell-14' style='width:100px;text-align: left;' title='"+rccList[i].FOURTH_SN+"'>"+rccList[i].FOURTH_SN+"</td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee02 tr:last").append("<td class='datagrid-cell datagrid-cell-15' style='width:110px;text-align: left;' title='"+rccList[i].WH_NAME+"'>"+rccList[i].WH_NAME+"</td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee02 tr:last").append("<td class='datagrid-cell datagrid-cell-18' style='width:80px;text-align: center;' title='"+rccList[i].OUTSTOCK_EMP+"'>"+rccList[i].OUTSTOCK_EMP+"</td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee02 tr:last").append("<td class='datagrid-cell datagrid-cell-19' style='width:130px;text-align: center;' title='"+rccList[i].OUTSTOCK_TIME+"'>"+rccList[i].OUTSTOCK_TIME+"</td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee02 tr:last").append("<td class='datagrid-cell datagrid-cell-20' style='width:70px;text-align: center;' title=''>"+tempFlag+"</td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee02 tr:last").append("<td class='datagrid-cell datagrid-cell-21' style='width:150px;text-align: center;' title='"+rccList[i].UPLOAD_TIME+"'>"+rccList[i].UPLOAD_TIME+"</td>");
								}
							}
							pageFun(data.ajaxPage,"formId2");
								var tableTrJs = $("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee02 tbody tr");
								_tongLineColor(tableTrJs);
								//clickTr('itemDetail');
								defTableWidthRewrite('65324c73fb4340eab7fcd1a57edfee02');
					...
					success: function(data){
							...
							if(null != data.ajaxPage.dataList){
								...
								for(var i = 0;i < rccList.length; i++){
									...
									if(rccList[i].UPLOAD_TIME==null)  rccList[i].UPLOAD_TIME="";
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee02 tbody:last").append("<tr id='tr1_"+i+"' ></tr>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee02 tr:last").append("<td class='datagrid-cell datagrid-cell-1' style='width:30px;text-align: center;'>"+((currentPage - 1) * pageRecord + (i + 1))+"</td>");
									//$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee02 tr:last").append("<td class='datagrid-cell datagrid-cell-2' style='width:200px;text-align: center;' title='"+rccList[i].DATA_AUTH+"'>"+rccList[i].DATA_AUTH+"</td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee02 tr:last").append("<td class='datagrid-cell datagrid-cell-2' style='text-align: center;width:200px;' title='"+rccList[i].DATA_AUTH+"'>"+rccList[i].DATA_AUTH+"<input type='hidden' id='DATA_AUTH_ID_"+rccList[i].ID+"' value='"+rccList[i].DATA_AUTH2+"' /></td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee02 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:210px;text-align: center;' title='"+rccList[i].ITEM_SN+"'><span onclick='itemJump3(\""+rccList[i].ITEM_SN+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].ITEM_SN+"</span></td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee02 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:150px;text-align: center;' title='"+rccList[i].ITEM_CODE+"'><span onclick='itemJump2(\""+rccList[i].ITEM_CODE+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].ITEM_CODE+"</span></td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee02 tr:last").append("<td class='datagrid-cell datagrid-cell-5' style='width:150px;text-align: center;' title='"+rccList[i].ITEM_NAME+"'>"+rccList[i].ITEM_NAME+"</td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee02 tr:last").append("<td class='datagrid-cell datagrid-cell-6' style='width:150px;text-align: center;' title='"+rccList[i].ITEM_SPEC+"'>"+rccList[i].ITEM_SPEC+"</td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee02 tr:last").append("<td class='datagrid-cell datagrid-cell-7' style='width:80px;text-align: right;' title='"+rccList[i].OUTSTOCK_NUM+"'>"+rccList[i].OUTSTOCK_NUM+"</td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee02 tr:last").append("<td class='datagrid-cell datagrid-cell-11' style='width:100px;' title='"+rccList[i].FIRST_SN+"'>"+rccList[i].FIRST_SN+"</td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee02 tr:last").append("<td class='datagrid-cell datagrid-cell-12' style='width:100px;' title='"+rccList[i].SECOND_SN+"'>"+rccList[i].SECOND_SN+"</td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee02 tr:last").append("<td class='datagrid-cell datagrid-cell-13' style='width:100px;' title='"+rccList[i].THIRD_SN+"'>"+rccList[i].THIRD_SN+"</td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee02 tr:last").append("<td class='datagrid-cell datagrid-cell-14' style='width:100px;' title='"+rccList[i].FOURTH_SN+"'>"+rccList[i].FOURTH_SN+"</td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee02 tr:last").append("<td class='datagrid-cell datagrid-cell-15' style='width:110px;' title='"+rccList[i].WH_NAME+"'>"+rccList[i].WH_NAME+"</td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee02 tr:last").append("<td class='datagrid-cell datagrid-cell-18' style='width:80px;' title='"+rccList[i].OUTSTOCK_EMP+"'>"+rccList[i].OUTSTOCK_EMP+"</td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee02 tr:last").append("<td class='datagrid-cell datagrid-cell-19' style='width:130px;' title='"+rccList[i].OUTSTOCK_TIME+"'>"+rccList[i].OUTSTOCK_TIME+"</td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee02 tr:last").append("<td class='datagrid-cell datagrid-cell-20' style='width:70px;' title=''>"+tempFlag+"</td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee02 tr:last").append("<td class='datagrid-cell datagrid-cell-21' style='width:150px;' title='"+rccList[i].UPLOAD_TIME+"'>"+rccList[i].UPLOAD_TIME+"</td>");
								}
							}
							pageFun(data.ajaxPage,"formId2");
								var tableTrJs = $("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee02 tbody tr");
	...
	//	console.log("d"+connectDoc);
		...
		$.ajax({
				    type: "POST",
				    dataType: "json",
				    url: getItemDetailUrl,//+"&itemCode="+itemCode+"&dataAuth="+dataAuth+"&docNum="+docNum+"&supCode="+supCode+"&connectDoc="+connectDoc+"&woiStatus="+woiStatus+"&docType=DJ14",
				    data:  {
                    "itemCode" :itemCode,
					"dataAuth" : dataAuth,
					"docNum" : docNum,
					...
					success: function(data){
							...
							if(null != data.ajaxPage.dataList){
								...
								for(var i = 0;i < rccList.length; i++){
									...
									if(rccList[i].UPLOAD_TIME==null)  rccList[i].UPLOAD_TIME="";
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee03 tbody:last").append("<tr id='tr1_"+i+"' ></tr>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee03 tr:last").append("<td class='datagrid-cell datagrid-cell-1' style='width:30px;text-align: center;'>"+(i+1)+"</td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee03 tr:last").append("<td class='datagrid-cell datagrid-cell-2' style='text-align: center;width:200px;' title='"+rccList[i].DATA_AUTH+"'>"+rccList[i].DATA_AUTH+"<input type='hidden' id='DATA_AUTH_ID_"+rccList[i].ID+"' value='"+rccList[i].DATA_AUTH2+"' /></td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee03 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:210px;text-align: left;' title=''><span onclick='itemJump3(\""+rccList[i].ITEM_SN+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].ITEM_SN+"</span></td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee03 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:150px;text-align: left;' title=''><span onclick='itemJump2(\""+rccList[i].ITEM_CODE+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].ITEM_CODE+"</span></td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee03 tr:last").append("<td class='datagrid-cell datagrid-cell-5' style='width:150px;text-align: left;' title=''>"+rccList[i].ITEM_NAME+"</td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee03 tr:last").append("<td class='datagrid-cell datagrid-cell-6' style='width:150px;text-align: left;' title=''>"+rccList[i].ITEM_SPEC+"</td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee03 tr:last").append("<td class='datagrid-cell datagrid-cell-7' style='width:80px;text-align: left;' title=''>"+rccList[i].OUTSTOCK_NUM+"</td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee03 tr:last").append("<td class='datagrid-cell datagrid-cell-10' style='width:150px;text-align: left;' title=''>"+rccList[i].DOC_NUM+"</td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee03 tr:last").append("<td class='datagrid-cell datagrid-cell-11' style='width:100px;text-align: left;' title=''>"+rccList[i].FIRST_SN+"</td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee03 tr:last").append("<td class='datagrid-cell datagrid-cell-12' style='width:100px;text-align: left;' title=''>"+rccList[i].SECOND_SN+"</td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee03 tr:last").append("<td class='datagrid-cell datagrid-cell-13' style='width:100px;text-align: left;' title=''>"+rccList[i].THIRD_SN+"</td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee03 tr:last").append("<td class='datagrid-cell datagrid-cell-14' style='width:100px;text-align: left;' title=''>"+rccList[i].FOURTH_SN+"</td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee03 tr:last").append("<td class='datagrid-cell datagrid-cell-15' style='width:110px;text-align: left;' title=''>"+rccList[i].WH_NAME+"</td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee03 tr:last").append("<td class='datagrid-cell datagrid-cell-18' style='width:80px;text-align: center;' title='"+rccList[i].OUTSTOCK_EMP+"'>"+rccList[i].OUTSTOCK_EMP+"</td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee03 tr:last").append("<td class='datagrid-cell datagrid-cell-19' style='width:130px;text-align: center;' title=''>"+rccList[i].OUTSTOCK_TIME+"</td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee03 tr:last").append("<td class='datagrid-cell datagrid-cell-20' style='width:70px;text-align: center;' title=''>"+tempFlag+"</td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee03 tr:last").append("<td class='datagrid-cell datagrid-cell-21' style='width:150px;text-align: center;' title=''>"+rccList[i].UPLOAD_TIME+"</td>");
								}
							}
							setPopScroll('.scroll','.head');
							pageFun(data.ajaxPage,"formId3");
								var tableTrJs = $("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee03 tbody tr");
								_tongLineColor(tableTrJs);
								//clickTr('secondItemDetail');
								defTableWidthRewrite('65324c73fb4340eab7fcd1a57edfee03');
	...
	function searchSecondItem(paginationImpl){
		...
		var woiStatus = $("#WOI_STATUS").val();
	    	...
	    	$.ajax({
                    ...
                    "paraMap.docType" : "DJ14",
                    "page.currentPage" : _GLO_FORM_PAGE_MAP[paginationImpl].currentPage,
                    "page.pageRecord" : _GLO_FORM_PAGE_MAP[paginationImpl].pageRecord,
                    },
				    //"paraMap.type=1&paraMap.itemCode="+itemCode+"&paraMap.dataAuth="+dataAuth+"&paraMap.docNum="+docNum+"&paraMap.supCode="+supCode+"&paraMap.connectDoc="+connectDoc+"&paraMap.woiStatus="+woiStatus+"&paraMap.docType=DJ14"+"&page.currentPage="+_GLO_FORM_PAGE_MAP[paginationImpl].currentPage+"&page.pageRecord=" + _GLO_FORM_PAGE_MAP[paginationImpl].pageRecord,
					success: function(data){
							...
							if(null != data.ajaxPage.dataList){
								...
								for(var i = 0;i < rccList.length; i++){
									...
									if(rccList[i].UPLOAD_TIME==null)  rccList[i].UPLOAD_TIME="";
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee03 tbody:last").append("<tr id='tr1_"+i+"' ></tr>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee03 tr:last").append("<td class='datagrid-cell datagrid-cell-1' style='width:30px;text-align: center;'>"+((currentPage - 1) * pageRecord + (i + 1))+"</td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee03 tr:last").append("<td class='datagrid-cell datagrid-cell-2' style='text-align: center;width:200px;' title='"+rccList[i].DATA_AUTH+"'>"+rccList[i].DATA_AUTH+"<input type='hidden' id='DATA_AUTH_ID_"+rccList[i].ID+"' value='"+rccList[i].DATA_AUTH2+"' /></td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee03 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:210px;text-align: left;' title=''><span onclick='itemJump3(\""+rccList[i].ITEM_SN+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].ITEM_SN+"</span></td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee03 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:150px;text-align: left;' title=''><span onclick='itemJump2(\""+rccList[i].ITEM_CODE+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].ITEM_CODE+"</span></td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee03 tr:last").append("<td class='datagrid-cell datagrid-cell-5' style='width:150px;text-align: left;' title=''>"+rccList[i].ITEM_NAME+"</td>");
									...
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee03 tr:last").append("<td class='datagrid-cell datagrid-cell-14' style='width:100px;text-align: left;' title=''>"+rccList[i].FOURTH_SN+"</td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee03 tr:last").append("<td class='datagrid-cell datagrid-cell-15' style='width:110px;text-align: left;' title=''>"+rccList[i].WH_NAME+"</td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee03 tr:last").append("<td class='datagrid-cell datagrid-cell-18' style='width:80px;text-align: center;' title=''>"+rccList[i].OUTSTOCK_EMP+"</td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee03 tr:last").append("<td class='datagrid-cell datagrid-cell-19' style='width:130px;text-align: center;' title=''>"+rccList[i].OUTSTOCK_TIME+"</td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee03 tr:last").append("<td class='datagrid-cell datagrid-cell-20' style='width:70px;text-align: center;' title=''>"+tempFlag+"</td>");
									$("#datagrid-btable-ajax65324c73fb4340eab7fcd1a57edfee03 tr:last").append("<td class='datagrid-cell datagrid-cell-21' style='width:150px;text-align: center;' title=''>"+rccList[i].UPLOAD_TIME+"</td>");
								}
         ...
         // var formId = $("#formId1").val();
          ...
          if(createUserId=='关结'){
               ...
               return false;
			    ...
			    type: "POST",
			    dataType: "json",
			    url: "${path}buss/bussModel_exeFunc.ms?FUNC_CODE=F7555&funcMId=3e29b2e44c0f49aa8e442378fa519c72",//&docNum="+docNum,
			    data: {"docNum" : docNum},
			    success: function(data){
						    if(null == data){return;}
						    if(null != data){
    							...
    							if(data.ajaxMap.returnMsg=="addSucc1"){
    								msgPop(data.ajaxMap.alertMsg,"",data.ajaxMap.title,data.ajaxMap.width.ajaxMap,data.height,data.ajaxMap.time,"");
    								var urlDetail = "${path}buss/bussModel.ms?exeid=d29ba408ffab44b3ae2521e6b8d9304e&dataId=&formId=65324c73fb4340eab7fcd1a57edfee4f&docNum="+docNum;
...
function createTableModel(ms,formId){
    ...
    var colNo = $("#relColVals").val();
    if(formId=='65324c73fb4340eab7fcd1a57edfee4f'){<%--出库单物料信息--%>
        ...
        $.each(uiTxt,function(i,v){
	          ...
	          //  arrHtml.push("</td>");
                ...
                arrHtml.push("</td>");
                arrHtml.push("<td colno='T10#WDI_LIGHT_FLAG' class='datagrid-cell "+ms.tdClass(formId, 'T10#WDI_LIGHT_FLAG')+"' style='width:90px;text-align:center;"+ms.tdStyle(formId, 'T10#WDI_LIGHT_FLAG')+"' "+ms.tdEvent(formId, 'T10#WDI_LIGHT_FLAG')+">")
	            ...
	            arrHtml.push("</td>");
	            arrHtml.push("<td colno='T2#WOD_CREATE_TIME' class='datagrid-cell "+ms.tdClass(formId, 'T2#WOD_CREATE_TIME')+"' style='text-align:center;"+ms.tdStyle(formId, 'T2#WOD_CREATE_TIME')+"' "+ms.tdEvent(formId, 'T2#WOD_CREATE_TIME')+">")
	            ...
	            arrHtml.push("</td>");
	            //arrHtml.push("<td colno='T2#WOD_OUTSTOCK_DATE' class='datagrid-cell "+ms.tdClass(formId, 'T2#WOD_OUTSTOCK_DATE')+"' style='width:150px;text-align:center;padding:0;"+ms.tdStyle(formId, 'T2#WOD_OUTSTOCK_DATE')+"' "+ms.tdEvent(formId, 'T2#WOD_OUTSTOCK_DATE')+">")
...
function searchOutstock(){
    //	console.log("sss");
    var url = "${path}buss/bussModel_exeFunc.ms?funcMId=cec3deb7f86c4a989b615f11ba6ecf80";
    var dataAuth = $("#DATA_AUTH").val();
	var itemCode = $.trim($("#WOI_ITEM_CODE_SHOW").val());
	var docNum = $.trim($("#WOI_DOC_NUM").val());
...
function GetProduceNumId(docNum,type){
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(type==1){
                 var url = "${path}buss/bussModel_exeFunc.ms?FUNC_CODE=F6845&funcMId=c1cad79df9904c1da1483c88c93487fa&formId=65324c73fb4340eab7fcd1a57edfee4f&dataId="+dateId+"&iframeId="+_currentFrame+"&dataAuth="+dataAuth;			
            
                showPopWinFp(url, 1200, 550,null,document.title+ "<dict:lang value="修改" />"); 
            }else if(type==3){
               //alert(dateId);
                var url = "${path}buss/bussModel_exeFunc.ms?FUNC_CODE=F6843&funcMId=e5d3dcfffb26459d9c7c618e95e261ab&formId=65324c73fb4340eab7fcd1a57edfee4f&dataId="+dateId+"&iframeId="+_currentFrame+"&dataAuth="+dataAuth;			
