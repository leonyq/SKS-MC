...
<head>
	...
	<script type="text/javascript">
		...
		var addItemUrl = "${path}buss/bussModel_exeFunc.ms?funcMId=08529f8efd764ff888e5598233580a59";
			$("#itemCode").val("");//机种料号
			$("#itemName").val("");//面别
			$("#itemSpec").val("");//面别
				...
				success: function(data) {
					...
					if(null != data.ajaxPage.dataList) {
						...
						for(var i = 0; i < rccList.length; i++) {
							...
							$("#itemTable tr:last").append("<td class='datagrid-cell datagrid-cell-5' style='width:162px;text-align: center;'>" + rccList[i].SUP_NAME + "<input type='hidden' id='SUP_NAME" + (i + 1) + "' value='" + rccList[i].SUP_NAME + "'/></td>");
							$("#itemTable tr:last").append("<td class='datagrid-cell datagrid-cell-5' style='text-align: center;'>" + rccList[i].ITEM_TYPE_NAME + "<input type='hidden' id='ITEM_SPEC" + (i + 1) + "' value='" + rccList[i].ITEM_TYPE_NAME + "'/></td>");
		...
		function addConfirm(objId,len){
			...
			$("#itemInfo tr:last").append("<td class='datagrid-cell datagrid-cell-2' style='width:30px;text-align: center;'><input type='checkbox' name='isSelect1'/><input type='hidden' name='itemId' value=''/></td>");
			...
			$("#itemInfo tr:last").append("<td class='datagrid-cell datagrid-cell-6' style='width:100px;text-align: center;padding:0;'><input type='text' style='width: 100px;padding:0;text-align: right;' maxlength='50' class=' input isSubmit' id='CI_MIN_PACK"+(trrCount+1)+"' name='MIN_PACK' value='"+$("#MIN_PACK"+objId).val()+"' oninput='OnInput2(event,\"CI_MIN_PACK"+(trrCount+1)+"\")'/></td>");
			$("#itemInfo tr:last").append("<td class='datagrid-cell datagrid-cell-7' style='width:80px;text-align: center;padding:0;'><input type='text' style='width: 80px;padding:0;text-align: right;' maxlength='50' class=' input isSubmit' id='CI_PLAN_NUM"+(trrCount+1)+"' name='PLAN_NUM' value='' oninput='OnInput2(event,\"CI_PLAN_NUM"+(trrCount+1)+"\")'/></td>");
			//$("#itemInfo tr:last").append("<td class='datagrid-cell datagrid-cell-8' style='width:120px;text-align: center;padding:0;'><input type='text' style='width: 120px;padding:0;text-align: left;' maxlength='50' class=' input isSubmit' name='CONNECT_NUM' value=''/></td>");
			...
			$("#itemInfo tr:last").append("<td class='datagrid-cell datagrid-cell-10' style='width:100px;text-align: left;'>" + $("#SUP_NAME"+objId).val() + "<input type='hidden' name='SUP_NAME' value='" + $("#SUP_NAME"+objId).val() + "'/></td>");
			...
			$("#itemInfo tr:last").append("<td class='datagrid-cell datagrid-cell-12' style='text-align: center;padding:0;'><input style='width:130px;padding:0;' name='OUTSTOCK_DATE' class=' input isSubmit  _VAL_OjbsData WdateNomorl' onfocus='WdatePicker({skin:\"blue\",dateFmt:\"yyyy-MM-dd\"})'/></td>");
		}
		$(function() {
			getWmsSel();
		})
...
<body>
	...
	<div class="bd">
		...
		<div class="mod">
			...
			<table class="basic-table">
				...
				<s:set name="_$viewId" value="'84a3aec310104cbc89bd145ce54434ba'" />
				...
				<tr>
					...
					<bu:td cssClass="dec" colNo="WOI_DOC_NUM" formId="747171193cf444a784fe3b339285e612">
						<bu:ui colNo="WOI_DOC_NUM" style="width:200px;" formId="747171193cf444a784fe3b339285e612" dataId="${dataId}" formIndex="1" /></bu:td>

					<td class="name" /><span class="dot">*</span>
					<bu:uitn colNo="T2#WOD_DOC_TYPE" formId="747171193cf444a784fe3b339285e612" />
					</td>
					<bu:td cssClass="dec" colNo="T2#WOD_DOC_TYPE" formId="747171193cf444a784fe3b339285e612">
						<bu:ui colNo="T2#WOD_DOC_TYPE" style="width:200px;" formId="747171193cf444a784fe3b339285e612" dataId="${dataId}" formIndex="1" /></bu:td>

					<td class="name" />
					<bu:uitn colNo="T2#WOD_DISPATCH_SN" formId="747171193cf444a784fe3b339285e612" />
					</td>
					<bu:td cssClass="dec" style="width:200px;" colNo="T2#WOD_DISPATCH_SN" formId="747171193cf444a784fe3b339285e612">
						<bu:ui colNo="T2#WOD_DISPATCH_SN" style="width:200px;" formId="747171193cf444a784fe3b339285e612" dataId="${dataId}" formIndex="1" /></bu:td>

				</tr>
				<tr>
					<td class="name" />
					<bu:uitn colNo="T2#WOD_SUP_CODE" formId="747171193cf444a784fe3b339285e612" />
					</td>
					<bu:td cssClass="dec" colNo="T2#WOD_SUP_CODE" formId="747171193cf444a784fe3b339285e612">
						<bu:ui colNo="T2#WOD_SUP_CODE" style="width:200px;" formId="747171193cf444a784fe3b339285e612" dataId="${dataId}" formIndex="1" /></bu:td>
		...
		<div class="dialog-bd-div" style="width:100%;height:120%;">
			...
			<table class="basic-table">
				...
				<tr>
					...
					<bu:td cssClass="dec" colNo="WOI_ITEM_TYPE" formId="747171193cf444a784fe3b339285e612" >
						<bu:ui colNo="WOI_ITEM_TYPE" formId="747171193cf444a784fe3b339285e612" value="%{WOI_ITEM_TYPE}" formIndex="1" />
					</bu:td>
				</tr>
			</table>
	...
	<bu:submit viewId="84a3aec310104cbc89bd145ce54434ba" />
	<bu:script viewId="84a3aec310104cbc89bd145ce54434ba" />
				...
				success: function(data){
					...
					if(null != data.ajaxList){
						...
						for(var i=0;i<rccList.length;i++){
							...
							$("#itemInfo tr:last").append("<td class='datagrid-cell datagrid-cell-2' style='width:30px;text-align: center;'><input type='checkbox' name='isSelect1' value='"+rccList[i].ID+"'/><input type='hidden' name='itemId' value='"+rccList[i].ID+"'/></td>");
							...
							$("#itemInfo tr:last").append("<td class='datagrid-cell datagrid-cell-6' style='width:100px;text-align: center;padding:0;'><input type='text' style='width: 100px;padding:0;text-align: right;' maxlength='50' class=' input isSubmit' id='CI_MIN_PACK"+(trrCount+1)+"' name='MIN_PACK' value='"+rccList[i].MIN_PACK+"' oninput='OnInput2(event,\"CI_MIN_PACK"+(trrCount+1)+"\")'/></td>");
							$("#itemInfo tr:last").append("<td class='datagrid-cell datagrid-cell-7' style='width:80px;text-align: center;padding:0;'><input type='text' style='width: 80px;padding:0;text-align: right;' maxlength='50' class=' input isSubmit' id='CI_PLAN_NUM"+(trrCount+1)+"' name='PLAN_NUM' value='"+rccList[i].PLAN_NUM+"' oninput='OnInput2(event,\"CI_PLAN_NUM"+(trrCount+1)+"\")'/></td>");
							/*$("#itemInfo tr:last").append("<td class='datagrid-cell datagrid-cell-8' style='width:120px;text-align: center;padding:0;'><input type='text' style='width: 120px;padding:0;text-align: left;' maxlength='50' class=' input isSubmit' name='CONNECT_NUM' value='"+rccList[i].CONNECT_NUM+"'/></td>");*/
							/*$("#itemInfo tr:last").append("<td class='datagrid-cell datagrid-cell-6' style='width:90px;text-align: center;padding:0;'><input type='text' style='width: 90px;padding:0;text-align: right;' maxlength='50' class=' input isSubmit' id='PLAN_NUM_" + (trrCount + 1) + "' name='PLAN_NUM' value=''/></td>");*/
							$("#itemInfo tr:last").append("<td class='datagrid-cell datagrid-cell-9' style='width:120px;padding:0;'>" + wmsSel + "</td>");
							...
							$("#itemInfo tr:last").append("<td class='datagrid-cell datagrid-cell-12' style='text-align: center;padding:0;'><input style='width:130px;padding:0;' value='" + rccList[i].OUTSTOCK_DATE + "' name='OUTSTOCK_DATE' class=' input isSubmit  _VAL_OjbsData WdateNomorl' onfocus='WdatePicker({skin:\"blue\",dateFmt:\"yyyy-MM-dd\"})'/></td>");
							mySetChosen();//设置下拉框样式
	...
	function editInfo(){
			...
			if(!val.valOjbsData()){
				...
				if(!val.valDataBaseSetData()){
                        ...
                        document.forms.editForm.action = "${path}buss/bussModel_exeFunc.ms?funcMId=f9244917904947ce8ea39b2e5293799f";
                        document.forms.editForm.submit();
}
