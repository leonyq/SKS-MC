...
$(function(){
	...
	<script type="text/javascript">
		...
		function backFillMoVal(trObj,thisId){
        		...
        		id='paraMap"+(trrCount+1)+"_WOI_CONNECT_DOC_SHOW';
        }
				...
				success: function(data) {
					...
					if(null != data.ajaxPage.dataList) {
						...
						for(var i = 0; i < rccList.length; i++) {
							...
							$("#datagrid-btable-ajaxb1001c913da94c22b6e93cf7148da003 tr:last").append("<td class='datagrid-cell datagrid-cell-5' style='width:162px;text-align: center;'>" + rccList[i].SUP_NAME + "<input type='hidden' id='SUP_NAME" + (i + 1) + "' value='" + rccList[i].SUP_NAME + "'/></td>");
							$("#datagrid-btable-ajaxb1001c913da94c22b6e93cf7148da003 tr:last").append("<td class='datagrid-cell datagrid-cell-5' style='width:162px;text-align: center;'>" + rccList[i].ITEM_TYPE_NAME + "<input type='hidden' id='ITEM_SPEC" + (i + 1) + "' value='" + rccList[i].ITEM_TYPE_NAME + "'/></td>");
							
							$("#datagrid-btable-ajaxb1001c913da94c22b6e93cf7148da003 tr:last").append("<td class='datagrid-cell datagrid-cell-7' style='width:202.5px;text-align: right;display:none'><input type='hidden' id='CUST_CODE" + (i + 1) + "' value='" + rccList[i].CUST_CODE + "'/></td>");
							$("#datagrid-btable-ajaxb1001c913da94c22b6e93cf7148da003 tr:last").append("<td class='datagrid-cell datagrid-cell-7' style='width:202.5px;text-align: right;display:none'><input type='hidden' id='CUST_NAME" + (i + 1) + "' value='" + rccList[i].CUST_NAME + "'/></td>");
							$("#datagrid-btable-ajaxb1001c913da94c22b6e93cf7148da003 tr:last").append("<td class='datagrid-cell datagrid-cell-7' style='width:202.5px;text-align: right;display:none'><input type='hidden' id='MIN_PACK" + (i + 1) + "' value='" + rccList[i].MIN_PACK + "'/></td>");
						
						    $("#datagrid-btable-ajaxb1001c913da94c22b6e93cf7148da003 tr:last").append("<td class='datagrid-cell datagrid-cell-8' style='width:202.5px;text-align: center;display:none'>" + (i + 1) + "<input type='hidden' id='WSI_ITEM_NUM" + (i + 1) + "' value='" + rccList[i].WSI_ITEM_NUM + "'/></td>");
						}
		...
		function addConfirm(objId,len){
			...
			//var tempHi = "<input type='hidden' id='paraMap"+(trrCount+1)+"WOI_CONNECT_DOC' name='WPI_PO' value='' maxlength='50' class=' input isSubmit  _VAL_OjbsData _VAL_DATABASE' style='width: 160px;'>";
		   	// var tempPr = "<input editname='paraMap1@0#WOI_CONNECT_DOC' textval='paraMap1@0#WOI_CONNECT_DOCSHOW' type='text' id='paraMap"+(trrCount+1)+"WOI_CONNECT_DOC_SHOW' value='' maxlength='50' class='  input isSubmit ' style='width: 160px; left: 152px;'  onfocus='this.blur()' >";
			//var tempPr = "<input editname='paraMap1@0#WOI_CONNECT_DOC' textval='paraMap1@0#WOI_CONNECT_DOCSHOW' type='text' id='paraMap"+(trrCount+1)+"WOI_CONNECT_DOC_SHOW' value='' maxlength='50' class='input  input isSubmit  _VAL_OjbsData _VAL_DATABASE ico-search-input' style='width: 160px; left: 152px;' onclick='_showCommonTablePage(this,\"929ca143e65f443abcfd37c00a288ce9\",\"42abbfd6d16e4a9dba3dae4289f5bc82\",\"制令单号\",\"\",\"%7B%22WP_WIDTH%22%3A%22%22%2C%22WP_HEIGHT%22%3A%22%22%2C%22WP_FULL_SCREEN%22%3A%22%22%7D\",\"68326f34-2d18-423a-b18d-cb4152dde642\");' onfocus='this.blur()' disabled='disabled'>";
			...
			$("#datagrid-btable-ajaxb1001c913da94c22b6e93cf7148da002 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:120px;text-align: center;'>"+$("#ITEM_CODE"+objId).val()+"<input type='hidden' name='ITEM_CODE' value='" + $("#ITEM_CODE"+objId).val() + "'/></td>");
			$("#datagrid-btable-ajaxb1001c913da94c22b6e93cf7148da002 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:120px;text-align: center;'>" + $("#ITEM_NAME"+objId).val() + "</td>");
			$("#datagrid-btable-ajaxb1001c913da94c22b6e93cf7148da002 tr:last").append("<td class='datagrid-cell datagrid-cell-5' style='width:120px;text-align: center;'>" + $("#ITEM_SPEC"+objId).val() + "</td>");
			//$("#datagrid-btable-ajaxb1001c913da94c22b6e93cf7148da002 tr:last").append("<td class='datagrid-cell datagrid-cell-6' style='width:160px;text-align: center;padding:0;'>"+tempHi+tempPr+"</td>");
		    $("#datagrid-btable-ajaxb1001c913da94c22b6e93cf7148da002 tr:last").append("<td class='datagrid-cell datagrid-cell-7' style='width:160px;text-align: center;padding:0;'><input type='text' style='width: 160px;padding:0;text-align: right;'  maxlength='50' class=' input isSubmit' id='paraMap"+(trrCount+1)+"WOI_CONNECT_DOC' name='WPI_PO' value='' oninput='OnInput2(event,\"WOI_CONNECT_DOC"+(trrCount+1)+"\")'/></td>");
			$("#datagrid-btable-ajaxb1001c913da94c22b6e93cf7148da002 tr:last").append("<td class='datagrid-cell datagrid-cell-7' style='width:100px;text-align: center;padding:0;'><input type='text' style='width: 100px;padding:0;text-align: right;'  maxlength='50' class=' input isSubmit' id='CI_MIN_PACK"+(trrCount+1)+"' name='MIN_PACK' value='"+$("#MIN_PACK"+objId).val()+"' oninput='OnInput2(event,\"CI_MIN_PACK"+(trrCount+1)+"\")'/></td>");
			$("#datagrid-btable-ajaxb1001c913da94c22b6e93cf7148da002 tr:last").append("<td class='datagrid-cell datagrid-cell-8' style='width:80px;text-align: center;padding:0;'><input type='text' style='width: 80px;padding:0;text-align: right;' maxlength='50' class=' input isSubmit' id='CI_PLAN_NUM"+(trrCount+1)+"' name='PLAN_NUM' value='' oninput='OnInput2(event,\"CI_PLAN_NUM"+(trrCount+1)+"\")'/></td>");
			$("#datagrid-btable-ajaxb1001c913da94c22b6e93cf7148da002 tr:last").append("<td class='datagrid-cell datagrid-cell-9' style='width:80px;text-align: right;'>" + $("#WSI_ITEM_NUM" + objId).val() + "</td>");
			$("#datagrid-btable-ajaxb1001c913da94c22b6e93cf7148da002 tr:last").append("<td class='datagrid-cell datagrid-cell-10' style='width:120px;padding:0;'>" + wmsSel + "</td>");
			$("#datagrid-btable-ajaxb1001c913da94c22b6e93cf7148da002 tr:last").append("<td class='datagrid-cell datagrid-cell-11' style='width:150px;text-align: center;padding:0;'><input style='width:130px;padding:0;' name='OUTSTOCK_DATE' class=' input isSubmit  _VAL_OjbsData WdateNomorl' onfocus='WdatePicker({skin:\"blue\",dateFmt:\"yyyy-MM-dd\"})'/></td>");
		}
		$(function() {
			getWmsSel();
		})
...
<body>
	...
	<div class="bd" style="height:534px;">
		...
		<div class="js-tab">
			...
			<table class="basic-table">
				...
				<s:set name="_$viewId" value="'07b77b03d3324781ae6af9f1ba9a06c6'" />
				...
				<tr>
					...
					<bu:td cssClass="dec" style="width:200px;" colNo="T2#WOD_DISPATCH_SN" formId="65324c73fb4340eab7fcd1a57edfee4f">
						<bu:ui colNo="T2#WOD_DISPATCH_SN" style="width:200px;" formId="65324c73fb4340eab7fcd1a57edfee4f" value="%{T2#WOD_DISPATCH_SN}" formIndex="1" /></bu:td>
				...
				<tr>
                    ...
                    <td class="name" /><span class="dot">*</span>
					<bu:uitn colNo="DEPT_ID" formId="b1001c913da94c22b6e93cf7148da0d6" />
					</td>
					<bu:td cssClass="dec" colNo="DEPT_ID" formId="b1001c913da94c22b6e93cf7148da0d6">
						<bu:ui colNo="DEPT_ID" style="width:200px;" formId="b1001c913da94c22b6e93cf7148da0d6" value="%{DEPT_ID}" formIndex="1" /></bu:td>

                    <!--
                    <td class="name" /><span class="dot">*</span>
					<bu:uitn colNo="ACCOUNT_ID" formId="b1001c913da94c22b6e93cf7148da0d6" />
					</td>
					<bu:td cssClass="dec" colNo="ACCOUNT_ID" formId="b1001c913da94c22b6e93cf7148da0d6">
						<bu:ui colNo="ACCOUNT_ID" style="width:200px;" formId="b1001c913da94c22b6e93cf7148da0d6" value="%{ACCOUNT_ID}" formIndex="1" /></bu:td>
					-->	
	...
	<bu:submit viewId="07b77b03d3324781ae6af9f1ba9a06c6" />
	<bu:script viewId="07b77b03d3324781ae6af9f1ba9a06c6" />
	...
	<script type="text/javascript">
		$(function() {
			...
			$("#paraMap1_WOD_ITEM_TYPE_chosen").attr("style","width:200px;");
			$("#paraMap1_WOD_DOC_TYPE option[value='其它出库单']").attr("selected",true);
		...
		return ;
			...
			$("#saveBtn").prop("disabled","disabled");
                        ...
                        document.forms.addForm.action = "${path}buss/bussModel_exeFunc.ms?funcMId=96f2faff5af5488f984168761c94e1a5";
