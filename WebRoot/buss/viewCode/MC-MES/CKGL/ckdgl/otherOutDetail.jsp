	...
	<script type="text/javascript">
		...
		function searchOutItem(paginationImpl) {
			...
			$.ajax({
				...
				data: "paraMap.type=1&paraMap.itemCode=" + itemCode + "&paraMap.itemName=" + itemName + "&paraMap.itemSpec=" + itemSpec + "&paraMap.itemType=" + itemType  + "&page.currentPage=" + _GLO_FORM_PAGE_MAP[paginationImpl].currentPage + "&page.pageRecord=" + _GLO_FORM_PAGE_MAP[paginationImpl].pageRecord,
				success: function(data) {
					$("#itemTbody").empty();
					util.closeLoading();
					if(null != data.ajaxPage.dataList) {
...
<body style="background-color: white;">
	...
	<div class="bd" style="height:550px;border:none;">
		...
		<div class="js-tab">
			...
			<table class="basic-table" id="myTable">
				...
				<s:set name="_$viewId" value="'00500085a6f0445297ec23606cae8674'" />
				...
				<tr>
					...
					<bu:td cssClass="dec" colNo="WOI_DOC_NUM" formId="65324c73fb4340eab7fcd1a57edfee4f">
						<bu:ui colNo="WOI_DOC_NUM" style="width:210px;" formId="65324c73fb4340eab7fcd1a57edfee4f" dataId="${dataId}" formIndex="1" /></bu:td>

					<td class="name" style="width:69px;"/>
					<bu:uitn colNo="T5#WDT_TYPE_NAME" formId="65324c73fb4340eab7fcd1a57edfee4f" />
					</td>
					<bu:td cssClass="dec" colNo="T5#WDT_TYPE_NAME" formId="65324c73fb4340eab7fcd1a57edfee4f">
						<bu:ui colNo="T5#WDT_TYPE_NAME" style="width:210px;" formId="65324c73fb4340eab7fcd1a57edfee4f" dataId="${dataId}" formIndex="1" /></bu:td>

					<td class="name" style="width:69px;"/>
					<bu:uitn colNo="T2#WOD_DISPATCH_SN" formId="65324c73fb4340eab7fcd1a57edfee4f" />
					</td>
					<bu:td cssClass="dec" style="width:210px;" colNo="T2#WOD_DISPATCH_SN" formId="65324c73fb4340eab7fcd1a57edfee4f">
						<bu:ui colNo="T2#WOD_DISPATCH_SN" style="width:210px;" formId="65324c73fb4340eab7fcd1a57edfee4f" dataId="${dataId}" formIndex="1" /></bu:td>
				...
				<tr>
					...
					<td class="name" /><bu:uitn colNo="T2#WOD_URGENT_FLAG" formId="65324c73fb4340eab7fcd1a57edfee4f" /></td>
			        <bu:td cssClass="dec" colNo="T2#WOD_URGENT_FLAG" formId="65324c73fb4340eab7fcd1a57edfee4f" >
			        <bu:ui colNo="T2#WOD_URGENT_FLAG" formId="65324c73fb4340eab7fcd1a57edfee4f" dataId="${dataId}" formIndex="1" />
			        <bu:uitn colNo="T2#WOD_ERP_FLAG" formId="65324c73fb4340eab7fcd1a57edfee4f" />
			        <bu:ui colNo="T2#WOD_ERP_FLAG" formId="65324c73fb4340eab7fcd1a57edfee4f" dataId="${dataId}" formIndex="1" />
			        </bu:td>
			        
					<td class="name" />
					<bu:uitn colNo="T2#WOD_STATUS" formId="65324c73fb4340eab7fcd1a57edfee4f" />
					</td>
					<bu:td cssClass="dec" colNo="T2#WOD_STATUS" formId="65324c73fb4340eab7fcd1a57edfee4f">
						<bu:ui colNo="T2#WOD_STATUS" style="width:200px;" formId="65324c73fb4340eab7fcd1a57edfee4f" dataId="${dataId}" formIndex="1" /></bu:td>
				</tr>
				<tr>
				    <td class="name" />
					<bu:uitn colNo="T11#NAME" formId="65324c73fb4340eab7fcd1a57edfee4f" />
					</td>
					<bu:td cssClass="dec" colNo="T11#NAME" formId="65324c73fb4340eab7fcd1a57edfee4f">
						<bu:ui colNo="T11#NAME" style="width:200px;" formId="65324c73fb4340eab7fcd1a57edfee4f" dataId="${dataId}" formIndex="1" /></bu:td>	
                   <!-- 
				    <td class="name" />
					<bu:uitn colNo="T2#ACCOUNT_ID" formId="65324c73fb4340eab7fcd1a57edfee4f" />
					</td>
					<bu:td cssClass="dec" colNo="T12#ACCOUNT_ALIAS" formId="65324c73fb4340eab7fcd1a57edfee4f">
						<bu:ui colNo="T12#ACCOUNT_ALIAS" style="width:200px;" formId="65324c73fb4340eab7fcd1a57edfee4f" dataId="${dataId}" formIndex="1" /></bu:td>
						-->
				</tr>
				<tr>
					<td class="name" />
				...
				<div class="mod-bd" style="margin-top:5px;border-bottom: none;height:500px;">
					<div class="panel datagrid datagrid-div1">
						<div class="datagrid-div2 datagrid-div6 datagrid-view" id="datagrid-view">
							...
							<div class="datagrid-body datagrid-div3 scroll" style="height:435px;">
		...
		<div class="dialog-bd-div" style="width:100%;height:120%;">
			...
			<table class="basic-table">
				...
				<tr>
					...
					<bu:td cssClass="dec" colNo="WOD_ITEM_TYPE" formId="65324c73fb4340eab7fcd1a57edfee4f" >
						<bu:ui colNo="WOD_ITEM_TYPE" formId="65324c73fb4340eab7fcd1a57edfee4f" value="%{WOD_ITEM_TYPE}" formIndex="1" />
					</bu:td>
				</tr>
			</table>
	...
	<bu:submit viewId="00500085a6f0445297ec23606cae8674" />
	<bu:script viewId="00500085a6f0445297ec23606cae8674" />
		...
		function getWmsSel() {
		   ...
		   // alert("1:"+dataAuth)
			...
			$.ajax({
				type: "POST",
				dataType: "json",
				url: "buss/bussModel_exeFunc.ms?funcMId=36ab8790932148f59643b4cf74962e00"+"&dataAuth="+dataAuth,
				success: function(data) {
					...
					if(null != data.ajaxList){
						...
						for(var i=0;i<rccList.length;i++){
						    ...
						    var tempHtmls = "<tr	id='trr"+(trrCount+1)+"' >"
								              ...
								              +"<td  style='width:160px;text-align: center;padding:0;'>"+rccList[i].CONNECT_NUM+"</td>"
								              +"<td  style='width:100px;text-align: center;padding:0;'><input type='text' style='width: 100px;padding:0;text-align: right;' maxlength='50' disabled='disabled' class=' input isSubmit' id='CI_MIN_PACK"+(trrCount+1)+"' name='MIN_PACK' value='"+rccList[i].MIN_PACK+"' oninput='OnInput2(event,\"CI_MIN_PACK"+(trrCount+1)+"\")'/></td>"
								              +"<td  style='width:80px;text-align: center;padding:0;'><input type='text' style='width: 80px;padding:0;text-align: right;' maxlength='50' disabled='disabled' class=' input isSubmit' id='CI_PLAN_NUM"+(trrCount+1)+"' name='PLAN_NUM' value='"+rccList[i].PLAN_NUM+"' oninput='OnInput2(event,\"CI_PLAN_NUM"+(trrCount+1)+"\")'/></td>"
