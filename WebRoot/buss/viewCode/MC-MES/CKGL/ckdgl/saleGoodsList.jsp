...
<head>
    ...
    <%@ include file="/plf/page/common/buss/listCommJs.jsp"%>
		<bu:header formId ="1d55b72cd2294215b11d41bcca95b1c9"/>
...
<script type="text/javascript">
	...
	function switchTag(tag, content, url) {
		...
		if(tag=="tag1"){
			listAjaxTable("1d55b72cd2294215b11d41bcca95b1c9");
...
<body >
    <div class="content-in">
        <div class="dlist">
            <div class="hd">
         <!--  <div class="optn" >
           		     <button type="button"  onclick="addAjax()"><i class="ico ico-kl"></i><dict:lang value="新增" /></button>
		              <button type="button"  onclick="ajaxEdit()"><i class="ico ico-xg"></i><dict:lang value="修改" /></button>
		              <button type="button"  onclick="ajaxDel()"><i class="ico ico-sc"></i><dict:lang value="删除" /></button>
		              <button type="button"  onclick="showDetail()"><i class="ico ico-view"></i><dict:lang value="查看" /></button>
		              <button type="button"  onclick="closeState()"><i class="ico ico-nexus"></i><dict:lang value="关结" /></button>
		              <button type="button"  onclick="add()"><i class="ico ico-lead"></i><dict:lang value="导入" /></button> 

		              <button type="button"  onclick=""><i class="ico ico-lead"></i><dict:lang value="查询" /></button>
		         </div>-->
		  <bu:func viewId="c69c39eee55846dfaf868e62a28a2bf7" />
            </div>
                    ...
                    <form id="searchForm" name="searchForm" action="${path}buss/bussModel.ms" method="post">
                      <jsp:include page="/plf/page/mesdemo/commCode/commCode.jsp">
                         ...
                         <jsp:param name="location" value="searchForm" />
		                    ...
		                    <bu:search viewId="c69c39eee55846dfaf868e62a28a2bf7" />
		...
		<input type="hidden" name="formPage1d55b72cd2294215b11d41bcca95b1c9" id="formPage1d55b72cd2294215b11d41bcca95b1c9" value="${formPage1d55b72cd2294215b11d41bcca95b1c9}"/>
		<input type="hidden" name="formId" id="formId1" value='1d55b72cd2294215b11d41bcca95b1c9'/>
		...
		<input type="hidden" name="formId" id="formId4" value='1d55b72cd2294215b11d41bcca95b104'/>
		...
		<div class="js-tab">
			...
			<DIV class="content1" id="content" style="margin-top: 15px;">
				<DIV id="content1" style="margin-top:4px;" data-tab="tag1">
					<!--table1-->
					<div class="panel-ajax datagrid datagrid-div1"  id="1d55b72cd2294215b11d41bcca95b1c9">
					<div class="datagrid-div2 datagrid-div6 datagrid-view-ajax" id="datagrid-view-ajax1d55b72cd2294215b11d41bcca95b1c9" style="overflow: hidden;">
					<div class="datagrid-header">
					<div class="datagrid-header-inner head2" id="datagrid-header-inner1d55b72cd2294215b11d41bcca95b1c9">
					<bu:table cssClass="datagrid-htable fixedTable datagrid-div6 datagrid-htable-kz" id="datagrid-htable1d55b72cd2294215b11d41bcca95b1c9">
					<s:set name="_$type" value="'view'" />
					<tbody class="isParentsTitle">
					<bu:tr cssClass="datagrid-header-row datagrid-title-ajax" id="datagrid-title-ajax">
						<td class="datagrid-cell" style="width:30px; text-align:center;" ><bu:thSeq  formId="1d55b72cd2294215b11d41bcca95b1c9" i18n="1"/></td>
						<td class="datagrid-cell" style="width:200px;"><bu:uitn  colNo="DATA_AUTH" formId="1d55b72cd2294215b11d41bcca95b1c9" /></td>
						<td class="datagrid-cell" style="width:150px;"><bu:uitn  colNo="WOI_DOC_NUM" formId="1d55b72cd2294215b11d41bcca95b1c9" /></td>
						<td class="datagrid-cell" style="width:150px;"><bu:uitn  colNo="WOI_ITEM_CODE" formId="1d55b72cd2294215b11d41bcca95b1c9" /></td>
						<td class="datagrid-cell" style="width:120px;"><bu:uitn colNo="T2#WOD_ERP_FLAG" formId="1d55b72cd2294215b11d41bcca95b1c9" /></td>
						<td class="datagrid-cell" style="width:80px;"><bu:uitn  colNo="T2#WOD_URGENT_FLAG" formId="1d55b72cd2294215b11d41bcca95b1c9" /></td>
						<td class="datagrid-cell" style="width:100px;"><bu:uitn  colNo="WOI_STATUS" formId="1d55b72cd2294215b11d41bcca95b1c9" /></td>
						<td class="datagrid-cell" style="width:80px;"><bu:uitn  colNo="WOI_PLAN_NUM" formId="1d55b72cd2294215b11d41bcca95b1c9" /></td>
						<td class="datagrid-cell" style="width:80px;"><bu:uitn  colNo="WOI_REQUEST_NUM" formId="1d55b72cd2294215b11d41bcca95b1c9" /></td>
						<td class="datagrid-cell" style="width:80px;"><bu:uitn  colNo="WOI_OUT_NUM" formId="1d55b72cd2294215b11d41bcca95b1c9" /></td>
						<td class="datagrid-cell" style="width:120px;"><bu:uitn  colNo="WOI_PACK_NUM" formId="1d55b72cd2294215b11d41bcca95b1c9" /></td>
						<td class="datagrid-cell" style="width:150px;"><bu:uitn  colNo="WOI_CONNECT_DOC" formId="1d55b72cd2294215b11d41bcca95b1c9" /></td>
						<td class="datagrid-cell" style="width:120px;"><bu:uitn  colNo="T5#WDT_TYPE_NAME" formId="1d55b72cd2294215b11d41bcca95b1c9" /></td>
						<td class="datagrid-cell" style="width:120px;"><bu:uitn  colNo="T2#WOD_DISPATCH_SN" formId="1d55b72cd2294215b11d41bcca95b1c9" /></td>
						<td class="datagrid-cell" style="width:100px;"><bu:uitn  colNo="WOI_WH_CODE" formId="1d55b72cd2294215b11d41bcca95b1c9" /></td>
						<td class="datagrid-cell" style="width:150px;"><bu:uitn  colNo="WOI_ITEM_NAME" formId="1d55b72cd2294215b11d41bcca95b1c9" /></td>
						<td class="datagrid-cell" style="width:150px;"><bu:uitn  colNo="WOI_ITEM_SPEC" formId="1d55b72cd2294215b11d41bcca95b1c9" /></td>
						<td class="datagrid-cell" style="width:120px;"><bu:uitn  colNo="T2#WOD_CUST_CODE" formId="1d55b72cd2294215b11d41bcca95b1c9" /></td>
						<td class="datagrid-cell" style="width:150px;"><bu:uitn  colNo="WOI_DELIVERY_DATE" formId="1d55b72cd2294215b11d41bcca95b1c9" /></td>
						<td class="datagrid-cell" style="width:80px;"><bu:uitn  colNo="T4#NAME" formId="1d55b72cd2294215b11d41bcca95b1c9" /></td>
						<td class="datagrid-cell" style="width:150px;"><bu:uitn  colNo="T2#WOD_CREATE_TIME" formId="1d55b72cd2294215b11d41bcca95b1c9" /></td>
						
						<td class="datagrid-cell" style="display:none;width:120px;"><bu:uitn  colNo="T2#WOD_DISPATCH_SN" formId="1d55b72cd2294215b11d41bcca95b1c9" /></td>
						<td class="datagrid-cell" style="display:none;width:120px;"><bu:uitn  colNo="T2#WOD_DOC_TYPE" formId="1d55b72cd2294215b11d41bcca95b1c9" /></td>
						<td class="datagrid-cell" style="display:none;width:120px;"><bu:uitn  colNo="T2#WOD_STATUS" formId="1d55b72cd2294215b11d41bcca95b1c9" /></td>
					</bu:tr>
					</tbody>
					</bu:table>
					</div>
					</div>
					<div class="datagrid-body datagrid-div3 datagrid-body-ajax scroll2" id="tableDiv1d55b72cd2294215b11d41bcca95b1c9" onscroll="ajaxTableScroll(this,'1d55b72cd2294215b11d41bcca95b1c9')" style="height: 130px;">
					<table class="datagrid-btable fixedTable dblClick"  id="datagrid-btable-ajax1d55b72cd2294215b11d41bcca95b1c9" >
					<tbody id="tbody_1d55b72cd2294215b11d41bcca95b1c9" class="isParents">
					</tbody>
					</table>		</div>
					</div>
					</div>
					<c:if test="${formPage1d55b72cd2294215b11d41bcca95b1c9==1}">			<div class="center">
						<s:include value="/plf/page/fp/paginationPopMultAx.jsp?listDataFn=listAjaxTable&formId=1d55b72cd2294215b11d41bcca95b1c9&showLoading=0" />
						</div>
					</c:if>
					<!--table2-->
					<div class="panel-ajax datagrid datagrid-div1" style="margin-top:10px;"><!--143-->
						<div class="datagrid-div2 datagrid-div6 datagrid-view"   style="overflow-x:hidden;border-bottom:0;">
								...
								<div class="datagrid-header-inner head1" id="" >
									<table  class="datagrid-htable fixedTable  " id="datagrid-htable1d55b72cd2294215b11d41bcca95b102" >
							            ...
							            <!--    <td class="datagrid-cell" style="width:200px;" ><dict:lang value="组织机构" /></td > -->
											...
											<td class="datagrid-cell" style="width:150px;" ><dict:lang value="销售单号" /></td >
							...
							<div class="datagrid-body datagrid-div3 scroll1" ><!--130-->
								<table class="datagrid-btable fixedTable" style="table-layout: fixed;"  id="datagrid-btable-ajax1d55b72cd2294215b11d41bcca95b102" >
				...
				<div class="panel1 datagrid datagrid-div1">
					<div class="datagrid-div2 datagrid-div6 datagrid-view"  style="overflow-x:hidden;border:0;">
						...
						<div class="datagrid-body datagrid-div3 scroll">
							<table class="datagrid-btable fixedTable" style=" table-layout: fixed;"  id="datagrid-btable-ajax1d55b72cd2294215b11d41bcca95b103" >
					...
					<div class="datagrid-div2 datagrid-div6 datagrid-view"  style="overflow-x:hidden;border:0;">
						<div class="datagrid-header" style="">
							<div class="datagrid-header-inner head3" id="" >
								<table  class="datagrid-htable fixedTable  "  id="datagrid-htable1d55b72cd2294215b11d41bcca95b104" >
									<tbody>
								<tr class="thcolor datagrid-header-row">
										<td class="datagrid-cell" align="center" style="width:30px;text-align: center"></td >
						...
						<div class="datagrid-body datagrid-div3 scroll3">
							<table class="datagrid-btable fixedTable" style="table-layout: fixed;"  id="datagrid-btable-ajax1d55b72cd2294215b11d41bcca95b104">
		...
		<bu:submit viewId="c69c39eee55846dfaf868e62a28a2bf7" />
      ...
      <jsp:include page="/plf/page/mesdemo/commCode/commCode.jsp">
		...
		<bu:script viewId="c69c39eee55846dfaf868e62a28a2bf7" />
		
     
<script type="text/javascript">
				function listAjaxTable(formId){
				$(document.getElementById('T2#WOD_DOC_TYPE')).val('DJ11');
                    var currentPage="";
                    var pageRecord="";
                    var isFirstLoad;
                ...
                function query(thisObj){
                 var formId = $("#formId1").val();
                   if($("#tag1").attr("class")=="current"){
                    ...
                    //defTableWidthRewrite('1d55b72cd2294215b11d41bcca95b1c9');
                }
...
<script type="text/javascript">
							...
							if(null != data.ajaxPage.dataList){
								...
								for(var i = 0;i < rccList.length; i++){				
                                   // if(rccList[i].DATA_AUTH==null)  rccList[i].DATA_AUTH="";
									...
									$("#datagrid-btable-ajax1d55b72cd2294215b11d41bcca95b102 tbody:last").append("<tr id='tr1_"+i+"' ></tr>");
									$("#datagrid-btable-ajax1d55b72cd2294215b11d41bcca95b102 tr:last").append("<td class='datagrid-cell datagrid-cell-1' style='width:30px;text-align: center;'>"+(i+1)+"</td>");
								//	$("#datagrid-btable-ajax1d55b72cd2294215b11d41bcca95b102 tr:last").append("<td class='datagrid-cell datagrid-cell-2' style='width:200px;text-align: left;' title='"+rccList[i].DATA_AUTH+"'>"+rccList[i].DATA_AUTH+"</td>");
									$("#datagrid-btable-ajax1d55b72cd2294215b11d41bcca95b102 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:210px;text-align: left;' title='"+rccList[i].ITEM_SN+"'><span onclick='itemJump3(\""+rccList[i].ITEM_SN+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].ITEM_SN+"</span></td>");
									$("#datagrid-btable-ajax1d55b72cd2294215b11d41bcca95b102 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:150px;text-align: left;' title='"+rccList[i].ITEM_CODE+"'><span onclick='itemJump2(\""+rccList[i].ITEM_CODE+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].ITEM_CODE+"</span></td>");
									$("#datagrid-btable-ajax1d55b72cd2294215b11d41bcca95b102 tr:last").append("<td class='datagrid-cell datagrid-cell-5' style='width:150px;text-align: left;' title='"+rccList[i].ITEM_NAME+"'>"+rccList[i].ITEM_NAME+"</td>");
									$("#datagrid-btable-ajax1d55b72cd2294215b11d41bcca95b102 tr:last").append("<td class='datagrid-cell datagrid-cell-6' style='width:150px;text-align: left;' title='"+rccList[i].ITEM_SPEC+"'>"+rccList[i].ITEM_SPEC+"</td>");
									$("#datagrid-btable-ajax1d55b72cd2294215b11d41bcca95b102 tr:last").append("<td class='datagrid-cell datagrid-cell-7' style='width:80px;text-align: right;' title='"+rccList[i].OUTSTOCK_NUM+"'>"+rccList[i].OUTSTOCK_NUM+"</td>");
									$("#datagrid-btable-ajax1d55b72cd2294215b11d41bcca95b102 tr:last").append("<td class='datagrid-cell datagrid-cell-10' style='width:150px;text-align: left;' title='"+rccList[i].DOC_NUM+"'>"+rccList[i].DOC_NUM+"</td>");
									$("#datagrid-btable-ajax1d55b72cd2294215b11d41bcca95b102 tr:last").append("<td class='datagrid-cell datagrid-cell-11' style='width:100px;text-align: left;' title='"+rccList[i].FIRST_SN+"'>"+rccList[i].FIRST_SN+"</td>");
									$("#datagrid-btable-ajax1d55b72cd2294215b11d41bcca95b102 tr:last").append("<td class='datagrid-cell datagrid-cell-12' style='width:100px;text-align: left;' title='"+rccList[i].SECOND_SN+"'>"+rccList[i].SECOND_SN+"</td>");
									$("#datagrid-btable-ajax1d55b72cd2294215b11d41bcca95b102 tr:last").append("<td class='datagrid-cell datagrid-cell-13' style='width:100px;text-align: left;' title='"+rccList[i].THIRD_SN+"'>"+rccList[i].THIRD_SN+"</td>");
									$("#datagrid-btable-ajax1d55b72cd2294215b11d41bcca95b102 tr:last").append("<td class='datagrid-cell datagrid-cell-14' style='width:100px;text-align: left;' title='"+rccList[i].FOURTH_SN+"'>"+rccList[i].FOURTH_SN+"</td>");
									$("#datagrid-btable-ajax1d55b72cd2294215b11d41bcca95b102 tr:last").append("<td class='datagrid-cell datagrid-cell-15' style='width:110px;text-align: left;' title='"+rccList[i].WH_NAME+"'>"+rccList[i].WH_NAME+"</td>");
									$("#datagrid-btable-ajax1d55b72cd2294215b11d41bcca95b102 tr:last").append("<td class='datagrid-cell datagrid-cell-18' style='width:80px;text-align: center;' title='"+rccList[i].OUTSTOCK_EMP+"'>"+rccList[i].OUTSTOCK_EMP+"</td>");
									$("#datagrid-btable-ajax1d55b72cd2294215b11d41bcca95b102 tr:last").append("<td class='datagrid-cell datagrid-cell-19' style='width:130px;text-align: center;' title='"+rccList[i].OUTSTOCK_TIME+"'>"+rccList[i].OUTSTOCK_TIME+"</td>");
									$("#datagrid-btable-ajax1d55b72cd2294215b11d41bcca95b102 tr:last").append("<td class='datagrid-cell datagrid-cell-20' style='width:70px;text-align: center;' title=''>"+tempFlag+"</td>");
									$("#datagrid-btable-ajax1d55b72cd2294215b11d41bcca95b102 tr:last").append("<td class='datagrid-cell datagrid-cell-21' style='width:150px;text-align: center;' title='"+rccList[i].UPLOAD_TIME+"'>"+rccList[i].UPLOAD_TIME+"</td>");
								}
							}
					...
					success: function(data){
							...
							if(null != data.ajaxPage.dataList){
								...
								for(var i = 0;i < rccList.length; i++){
									...
									if(rccList[i].UPLOAD_TIME==null)  rccList[i].UPLOAD_TIME="";
									$("#datagrid-btable-ajax1d55b72cd2294215b11d41bcca95b102 tbody:last").append("<tr id='tr1_"+i+"' ></tr>");
									$("#datagrid-btable-ajax1d55b72cd2294215b11d41bcca95b102 tr:last").append("<td class='datagrid-cell datagrid-cell-1' style='width:30px;text-align: center;'>"+((currentPage - 1) * pageRecord + (i + 1))+"</td>");
									//$("#datagrid-btable-ajax1d55b72cd2294215b11d41bcca95b102 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:200px;text-align: center;' title='"+rccList[i].DATA_AUTH+"'>"+rccList[i].DATA_AUTH+"</td>");
									$("#datagrid-btable-ajax1d55b72cd2294215b11d41bcca95b102 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='text-align: center;width:200px;' title='"+rccList[i].DATA_AUTH+"'>"+rccList[i].DATA_AUTH+"<input type='hidden' id='DATA_AUTH_ID_"+rccList[i].ID+"' value='"+rccList[i].DATA_AUTH2+"' /></td>");
									$("#datagrid-btable-ajax1d55b72cd2294215b11d41bcca95b102 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:210px;text-align: left;' title='"+rccList[i].ITEM_SN+"'><span onclick='itemJump3(\""+rccList[i].ITEM_SN+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].ITEM_SN+"</span></td>");
									$("#datagrid-btable-ajax1d55b72cd2294215b11d41bcca95b102 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:150px;text-align: left;' title='"+rccList[i].ITEM_CODE+"'><span onclick='itemJump2(\""+rccList[i].ITEM_CODE+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].ITEM_CODE+"</span></td>");
									$("#datagrid-btable-ajax1d55b72cd2294215b11d41bcca95b102 tr:last").append("<td class='datagrid-cell datagrid-cell-5' style='width:150px;text-align: left;' title='"+rccList[i].ITEM_NAME+"'>"+rccList[i].ITEM_NAME+"</td>");
									$("#datagrid-btable-ajax1d55b72cd2294215b11d41bcca95b102 tr:last").append("<td class='datagrid-cell datagrid-cell-6' style='width:150px;text-align: left;' title='"+rccList[i].ITEM_SPEC+"'>"+rccList[i].ITEM_SPEC+"</td>");
	...
	function searchItemDetail(){
		...
		$.ajax({
				    type: "POST",
				    dataType: "json",
				    url: getItemDetailUrl+"&itemCode="+itemCode+"&dataAuth="+dataAuth+"&docNum="+docNum+"&connectDoc="+connectDoc+"&dispatchSn="+dispatchSn+"&woiStatus="+woiStatus+"&docType=DJ11",
				    data: "",
					success: function(data){
							util.closeLoading();
							...
							if(null != data.ajaxPage.dataList){
								...
								for(var i = 0;i < rccList.length; i++){
									...
									//$("#datagrid-btable-ajax1d55b72cd2294215b11d41bcca95b103 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:200px;text-align: center;' title='"+rccList[i].DATA_AUTH+"'>"+rccList[i].DATA_AUTH+"</td>");
									$("#datagrid-btable-ajax1d55b72cd2294215b11d41bcca95b103 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='text-align: center;width:200px;' title='"+rccList[i].DATA_AUTH+"'>"+rccList[i].DATA_AUTH+"<input type='hidden' id='DATA_AUTH_ID_"+rccList[i].ID+"' value='"+rccList[i].DATA_AUTH2+"' /></td>");
									$("#datagrid-btable-ajax1d55b72cd2294215b11d41bcca95b103 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:210px;text-align: left;' title='"+rccList[i].ITEM_SN+"'><span onclick='itemJump3(\""+rccList[i].ITEM_SN+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].ITEM_SN+"</span></td>");
									$("#datagrid-btable-ajax1d55b72cd2294215b11d41bcca95b103 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:150px;text-align: left;' title='"+rccList[i].ITEM_CODE+"'><span onclick='itemJump2(\""+rccList[i].ITEM_CODE+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].ITEM_CODE+"</span></td>");
									$("#datagrid-btable-ajax1d55b72cd2294215b11d41bcca95b103 tr:last").append("<td class='datagrid-cell datagrid-cell-5' style='width:150px;text-align: left;' title='"+rccList[i].ITEM_NAME+"'>"+rccList[i].ITEM_NAME+"</td>");
									$("#datagrid-btable-ajax1d55b72cd2294215b11d41bcca95b103 tr:last").append("<td class='datagrid-cell datagrid-cell-6' style='width:150px;text-align: left;' title='"+rccList[i].ITEM_SPEC+"'>"+rccList[i].ITEM_SPEC+"</td>");
									$("#datagrid-btable-ajax1d55b72cd2294215b11d41bcca95b103 tr:last").append("<td class='datagrid-cell datagrid-cell-7' style='width:80px;text-align: right;' title='"+rccList[i].OUTSTOCK_NUM+"'>"+rccList[i].OUTSTOCK_NUM+"</td>");
									$("#datagrid-btable-ajax1d55b72cd2294215b11d41bcca95b103 tr:last").append("<td class='datagrid-cell datagrid-cell-10' style='width:150px;text-align: left;' title='"+rccList[i].DOC_NUM+"'>"+rccList[i].DOC_NUM+"</td>");
									$("#datagrid-btable-ajax1d55b72cd2294215b11d41bcca95b103 tr:last").append("<td class='datagrid-cell datagrid-cell-11' style='width:100px;text-align: left;' title='"+rccList[i].FIRST_SN+"'>"+rccList[i].FIRST_SN+"</td>");
									$("#datagrid-btable-ajax1d55b72cd2294215b11d41bcca95b103 tr:last").append("<td class='datagrid-cell datagrid-cell-12' style='width:100px;text-align: left;' title='"+rccList[i].SECOND_SN+"'>"+rccList[i].SECOND_SN+"</td>");
									$("#datagrid-btable-ajax1d55b72cd2294215b11d41bcca95b103 tr:last").append("<td class='datagrid-cell datagrid-cell-13' style='width:100px;text-align: left;' title='"+rccList[i].THIRD_SN+"'>"+rccList[i].THIRD_SN+"</td>");
									$("#datagrid-btable-ajax1d55b72cd2294215b11d41bcca95b103 tr:last").append("<td class='datagrid-cell datagrid-cell-14' style='width:100px;text-align: left;' title='"+rccList[i].FOURTH_SN+"'>"+rccList[i].FOURTH_SN+"</td>");
									$("#datagrid-btable-ajax1d55b72cd2294215b11d41bcca95b103 tr:last").append("<td class='datagrid-cell datagrid-cell-15' style='width:110px;text-align: left;' title='"+rccList[i].WH_NAME+"'>"+rccList[i].WH_NAME+"</td>");
									$("#datagrid-btable-ajax1d55b72cd2294215b11d41bcca95b103 tr:last").append("<td class='datagrid-cell datagrid-cell-18' style='width:90px;text-align: center;' title='"+rccList[i].OUTSTOCK_EMP+"'>"+rccList[i].OUTSTOCK_EMP+"</td>");
									$("#datagrid-btable-ajax1d55b72cd2294215b11d41bcca95b103 tr:last").append("<td class='datagrid-cell datagrid-cell-19' style='width:130px;text-align: center;' title='"+rccList[i].OUTSTOCK_TIME+"'>"+rccList[i].OUTSTOCK_TIME+"</td>");
									$("#datagrid-btable-ajax1d55b72cd2294215b11d41bcca95b103 tr:last").append("<td class='datagrid-cell datagrid-cell-20' style='width:70px;text-align: center;' title=''>"+tempFlag+"</td>");
									$("#datagrid-btable-ajax1d55b72cd2294215b11d41bcca95b103 tr:last").append("<td class='datagrid-cell datagrid-cell-21' style='width:150px;text-align: center;' title='"+rccList[i].UPLOAD_TIME+"'>"+rccList[i].UPLOAD_TIME+"</td>");
								}
							}
	...
	function searchSecondItem(paginationImpl){
		...
		var woiStatus = $("#WOI_STATUS").val();
	    	...
	    	$.ajax({
				    ...
				    dataType: "json",
				    url: "buss/bussModel_exeFunc.ms?funcMId=bef7e3e81a4a400db34d65b2ebdad5e4",
				    data: "paraMap.type=1&paraMap.itemCode="+itemCode+"&paraMap.dataAuth="+dataAuth+"&paraMap.docNum="+docNum+"&paraMap.connectDoc="+connectDoc+"&paraMap.woiStatus="+woiStatus+"&paraMap.docType=DJ11"+"&page.currentPage="+_GLO_FORM_PAGE_MAP[paginationImpl].currentPage+"&page.pageRecord=" + _GLO_FORM_PAGE_MAP[paginationImpl].pageRecord,
					success: function(data){
							...
							if(null != data.ajaxPage.dataList){
								...
								//	$("#datagrid-btable-ajax1d55b72cd2294215b11d41bcca95b103 tr:last").append("<td class='datagrid-cell datagrid-cell-2' style='width:210px;text-align: center;' title='"+rccList[i].DATA_AUTH+"'>"+rccList[i].DATA_AUTH+"</td>");
								$("#datagrid-btable-ajax1d55b72cd2294215b11d41bcca95b103 tr:last").append("<td class='datagrid-cell datagrid-cell-2' style='text-align: center;width:200px;' title='"+rccList[i].DATA_AUTH+"'>"+rccList[i].DATA_AUTH+"<input type='hidden' id='DATA_AUTH_ID_"+rccList[i].ID+"' value='"+rccList[i].DATA_AUTH2+"' /></td>");
									$("#datagrid-btable-ajax1d55b72cd2294215b11d41bcca95b103 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:210px;text-align: left;' title='"+rccList[i].ITEM_SN+"'><span onclick='itemJump3(\""+rccList[i].ITEM_SN+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].ITEM_SN+"</span></td>");
									$("#datagrid-btable-ajax1d55b72cd2294215b11d41bcca95b103 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:150px;text-align: left;' title='"+rccList[i].ITEM_CODE+"'><span onclick='itemJump2(\""+rccList[i].ITEM_CODE+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].ITEM_CODE+"</span></td>");
									$("#datagrid-btable-ajax1d55b72cd2294215b11d41bcca95b103 tr:last").append("<td class='datagrid-cell datagrid-cell-5' style='width:150px;text-align: left;' title='"+rccList[i].ITEM_NAME+"'>"+rccList[i].ITEM_NAME+"</td>");
									$("#datagrid-btable-ajax1d55b72cd2294215b11d41bcca95b103 tr:last").append("<td class='datagrid-cell datagrid-cell-6' style='width:150px;text-align: left;' title='"+rccList[i].ITEM_SPEC+"'>"+rccList[i].ITEM_SPEC+"</td>");
...
function createTableModel(ms,formId){
    ...
    var colNo = $("#relColVals").val();
    if(formId=='1d55b72cd2294215b11d41bcca95b1c9'){<%--出库单物料信息--%>
        ...
        $.each(uiTxt,function(i,v){
            ...
            arrHtml.push("</td>");
	            ...
	            arrHtml.push("<span colno='T2#WOD_STATUS' class='"+ms.uiClass(formId, 'T2#WOD_STATUS')+"' style='"+ms.uiStyle(formId, 'T2#WOD_STATUS')+"' "+ms.uiEvent(formId, 'T2#WOD_STATUS')+" title='"+v['T2#WOD_STATUS']+"' >"+v['T2#WOD_STATUS']+"</span>")
	            arrHtml.push("</td>");
	            arrHtml.push("</tr>")
                if(i==0){
...
function searchOutstock(){
    ...
    var url = "${path}buss/bussModel_exeFunc.ms?funcMId=c4b3322de1b64727b74f775d13efda7c";
    var dataAuth = $("#DATA_AUTH").val();
    ...
    $.ajax({
        ...
        dataType:"json",
        url:url,
         data: "connectDoc="+connectDoc+"&beginTime="+beginTime+"&endTime="+endTime+"&type=1&itemStatus="+itemStatus+"&itemCode="+itemCode+"&dataAuth="+dataAuth+"&docNum="+docNum+"&docType=DJ14",
		success:function(data){
            if(null==data){
                return;
            }
            ...
            if(null!=data.ajaxPage.dataList){
                var list = eval(data.ajaxPage.dataList);
                    ...
                    for(var i=0; i<list.length;i++){
                        ...
                        $("#addOutstock ").append("<tr id='"+list[i].WOI_DOC_NUM+"_"+list[i].WOI_WH_CODE+"' ondblclick='dblClickShowDetail(this)' onclick='clickTr(this.id)' ></tr>");
					...
					//	$("#addOutstock tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='text-align: center;width:130px;' title='"+list[i].DATA_AUTH+"'>"+list[i].DATA_AUTH+"</td>");
						...
						$("#addOutstock tr:last").append("<td class='datagrid-cell datagrid-cell-5' style='text-align: center;width:110px;' >"+tempType+"<input type='hidden' id='state_"+list[i].WOI_DOC_NUM+"_"+list[i].WOI_WH_CODE+"' value='"+list[i].WRD_STATUS+"'></td>");
            ...
            pageFun(data.ajaxPage,"formId4");
							var tableTrJs = $("#datagrid-btable-ajax1d55b72cd2294215b11d41bcca95b104 tbody tr");
							_tongLineColor(tableTrJs);
							clickTr('addOutstock');
							defTableWidthRewrite('1d55b72cd2294215b11d41bcca95b104');
        },
        error:function(msg){
            	utilsFp.confirmIcon(3,"","","", "error:"+msg,0,"300","");
        }
...
function SearchOutstockItem(paginationImpl,url){
    ...
    $.ajax({
        ...
        dataType:"json",
        url:url,
        data: "beginTime="+beginTime+"&endTime="+endTime+"&type=1&itemStatus="+itemStatus+"&itemCode="+itemCode+"&dataAuth="+dataAuth+"&docNum="+docNum+"&connectDoc="+connectDoc+"&docType=DJ14"+"&page.currentPage="+_GLO_FORM_PAGE_MAP[paginationImpl].currentPage+"&page.pageRecord=" + _GLO_FORM_PAGE_MAP[paginationImpl].pageRecord,
...
function GetProduceNumId(docNum,dataAuth,type){
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(type==1){
                 var url = "${path}buss/bussModel_exeFunc.ms?FUNC_CODE=F6785&funcMId=fcd574fbfa64400c9f985ab9cdc5c123&formId=1d55b72cd2294215b11d41bcca95b1c9&dataId="+dateId+"&iframeId="+_currentFrame;			
                console.log(dateId);
                showPopWinFp(url, 1200, 550,null,document.title+ "<dict:lang value="修改" />"); 
            }else if(type==3){
                var url = "${path}buss/bussModel_exeFunc.ms?FUNC_CODE=F6787&funcMId=730cc779cf5a4386b966d9b3b228b063&formId=1d55b72cd2294215b11d41bcca95b1c9&dataId="+dateId+"&iframeId="+_currentFrame+"&dataAuth="+dataAuth;			
