					...
					success: function(data){
							...
							if(null != data.ajaxPage.dataList){
								...
								//	$("#datagrid-btable-ajaxbb156a44e6e242a885b3fde9386fd502 tr:last").append("<td class='datagrid-cell datagrid-cell-2' style='text-align: center;width:200px;' title='"+rccList[i].DATA_AUTH+"'>"+rccList[i].DATA_AUTH+"<input type='hidden' id='DATA_AUTH_ID_"+rccList[i].ID+"' value='"+rccList[i].DATA_AUTH2+"' /></td>");
									$("#datagrid-btable-ajaxbb156a44e6e242a885b3fde9386fd502 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:210px;text-align: left;' title='"+rccList[i].ITEM_SN+"'><span onclick='itemJump3(\""+rccList[i].ITEM_SN+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].ITEM_SN+"</span></td>");
									$("#datagrid-btable-ajaxbb156a44e6e242a885b3fde9386fd502 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:150px;text-align: left;' title='"+rccList[i].ITEM_CODE+"'><span onclick='itemJump2(\""+rccList[i].ITEM_CODE+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].ITEM_CODE+"</span></td>");
					...
					success: function(data){
							...
							if(null != data.ajaxPage.dataList){
								...
								for(var i = 0;i < rccList.length; i++){
									...
									$("#datagrid-btable-ajaxbb156a44e6e242a885b3fde9386fd503 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:210px;text-align: left;' title='"+rccList[i].ITEM_SN+"'><span onclick='itemJump3(\""+rccList[i].ITEM_SN+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].ITEM_SN+"</span></td>");
									$("#datagrid-btable-ajaxbb156a44e6e242a885b3fde9386fd503 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:150px;text-align: left;' title='"+rccList[i].ITEM_CODE+"'><span onclick='itemJump2(\""+rccList[i].ITEM_CODE+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].ITEM_CODE+"</span></td>");
        ...
        $.each(uiTxt,function(i,v){
          ...
          //  arrHtml.push("</td>");
           ...
           // arrHtml.push("</td>");
            ...
            arrHtml.push("<span colno='WOI_DOC_NUM' class='"+ms.uiClass(formId, 'WOI_DOC_NUM')+"' onclick='itemJump1(\""+v['WOI_DOC_NUM']+"\")' style='display: inline;border-bottom: 1px solid #004098;' "+ms.uiEvent(formId, 'WOI_DOC_NUM')+" title='"+v['WOI_DOC_NUM']+"' >"+v['WOI_DOC_NUM']+"</span>")
            arrHtml.push("</td>");
            ...
            arrHtml.push("<span colno='WOI_CONNECT_DOC' class='"+ms.uiClass(formId, 'WOI_CONNECT_DOC')+"' onclick='itemJump4(\""+v['WOI_CONNECT_DOC']+"\")' style='display: inline;border-bottom: 1px solid #004098;' "+ms.uiEvent(formId, 'WOI_CONNECT_DOC')+" title='"+v['WOI_CONNECT_DOC']+"' >"+v['WOI_CONNECT_DOC']+"</span>")
            arrHtml.push("</td>");
            ...
            if(null!=data.ajaxPage.dataList){
                var list = eval(data.ajaxPage.dataList);
					...
					//	$("#addOutstock tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='text-align: center;width:200px;' title='"+list[i].DATA_AUTH+"'>"+list[i].DATA_AUTH+"</td>");
						...
						$("#addOutstock tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='text-align: left;width:160px;' title='"+list[i].WOI_DOC_NUM+"'><span onclick='itemJump1(\""+list[i].WOI_DOC_NUM+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+list[i].WOI_DOC_NUM+"</span><input type='hidden' id='WOI_DOC_NUM"+list[i].WOI_DOC_NUM+"_"+list[i].WOI_WH_CODE+"' value='"+list[i].WOI_DOC_NUM+"' /></td>");
...
function GetProduceNumId(docNum,type){
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(type==1){
                 var url = "${path}buss/bussModel_exeFunc.ms?FUNC_CODE=F6729&funcMId=037009132b8d43f4a689e437b0aa16a7&formId=bb156a44e6e242a885b3fde9386fd567&dataId="+dateId+"&iframeId="+_currentFrame+"&dataAuth="+dataAuth;			
            
                showPopWinFp(url, 1200, 550,null,document.title+ "<dict:lang value="修改" />"); 
            }else if(type==3){
                //alert(dateId);
                var url = "${path}buss/bussModel_exeFunc.ms?FUNC_CODE=F6727&funcMId=e2c0195b73fb47da97d0098d592ea223&formId=bb156a44e6e242a885b3fde9386fd567&dataId="+dateId+"&iframeId="+_currentFrame+"&dataAuth="+dataAuth;			
