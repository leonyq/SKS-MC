...
<body style="background-color: white;">
	...
	<div class="bd" style="height:550px;border:0;">
		...
		<div class="js-tab">
			...
			<table class="basic-table" id="myTable">
				...
				<s:set name="_$viewId" value="'30dcc1421d8241848826540cbc63f171'" />
				...
				<tr>
					...
					<bu:td cssClass="dec" colNo="WOI_DOC_NUM" formId="1d55b72cd2294215b11d41bcca95b1c9">
						<bu:ui colNo="WOI_DOC_NUM" style="width:210px;" formId="1d55b72cd2294215b11d41bcca95b1c9" dataId="${dataId}" formIndex="1" /></bu:td>

					<td class="name" style="width:69px;"/>
					<bu:uitn colNo="T5#WDT_TYPE_NAME" formId="1d55b72cd2294215b11d41bcca95b1c9" />
					</td>
					<bu:td cssClass="dec" colNo="T5#WDT_TYPE_NAME" formId="1d55b72cd2294215b11d41bcca95b1c9">
						<bu:ui colNo="T5#WDT_TYPE_NAME" style="width:210px;" formId="1d55b72cd2294215b11d41bcca95b1c9" dataId="${dataId}" formIndex="1" /></bu:td>

					<td class="name" style="width:69px;"/>
					<bu:uitn colNo="T2#WOD_DISPATCH_SN" formId="1d55b72cd2294215b11d41bcca95b1c9" />
					</td>
					<bu:td cssClass="dec" style="width:210px;" colNo="T2#WOD_DISPATCH_SN" formId="1d55b72cd2294215b11d41bcca95b1c9">
						<bu:ui colNo="T2#WOD_DISPATCH_SN" style="width:210px;" formId="1d55b72cd2294215b11d41bcca95b1c9" dataId="${dataId}" formIndex="1" /></bu:td>

				</tr>
				<tr>
					<td class="name" />
					<bu:uitn colNo="T7#CUSTOMER" formId="1d55b72cd2294215b11d41bcca95b1c9" />
					</td>
					<bu:td cssClass="dec" colNo="T7#CUSTOMER" formId="1d55b72cd2294215b11d41bcca95b1c9">
						<bu:ui colNo="T7#CUSTOMER" style="width:200px;" formId="1d55b72cd2294215b11d41bcca95b1c9" dataId="${dataId}" formIndex="1" /></bu:td>
					...
					<td class="name" /><bu:uitn colNo="T2#WOD_URGENT_FLAG" formId="1d55b72cd2294215b11d41bcca95b1c9" /></td>
			        <bu:td cssClass="dec" colNo="T2#WOD_URGENT_FLAG" formId="1d55b72cd2294215b11d41bcca95b1c9" >
			        <bu:ui colNo="T2#WOD_URGENT_FLAG" formId="1d55b72cd2294215b11d41bcca95b1c9" dataId="${dataId}" formIndex="1" />
			        <bu:uitn colNo="T2#WOD_ERP_FLAG" formId="1d55b72cd2294215b11d41bcca95b1c9" />
			        <bu:ui colNo="T2#WOD_ERP_FLAG" formId="1d55b72cd2294215b11d41bcca95b1c9" dataId="${dataId}" formIndex="1" />
			        </bu:td>
				</tr>
                <tr>
					<td class="name" />
					<bu:uitn colNo="T2#WOD_STATUS" formId="1d55b72cd2294215b11d41bcca95b1c9" />
					</td>
					<bu:td cssClass="dec" colNo="T2#WOD_STATUS" formId="1d55b72cd2294215b11d41bcca95b1c9">
						<bu:ui colNo="T2#WOD_STATUS" style="width:200px;" formId="1d55b72cd2294215b11d41bcca95b1c9" dataId="${dataId}" formIndex="1" /></bu:td>
		...
		<div class="dialog-bd-div" style="width:100%;height:120%;">
			...
			<table class="basic-table">
				...
				<tr>
					...
					<bu:td cssClass="dec" colNo="WOD_ITEM_TYPE" formId="1d55b72cd2294215b11d41bcca95b1c9" >
						<bu:ui colNo="WOD_ITEM_TYPE" formId="1d55b72cd2294215b11d41bcca95b1c9" value="%{WOD_ITEM_TYPE}" formIndex="1" />
					</bu:td>
				</tr>
			</table>
	...
	<bu:submit viewId="30dcc1421d8241848826540cbc63f171" />
	<bu:script viewId="30dcc1421d8241848826540cbc63f171" />
	...
	function getLogistic(){
	    ...
	    var LOGISTICS_ID=document.getElementById("paraMapObj_T2#LOGISTICS_ID").value;
	    $.ajax({
				type: "POST",
				dataType: "json",
				url: "buss/bussModel_exeFunc.ms?funcMId=014ad002697d44fb8dea263fe8635193",
				data: "LOGISTICS_ID="+ LOGISTICS_ID,
				success: function(data) {
				
				/*console.log("111");
				console.log(data.ajaxList[0].LOGISTICS_COMPANY);*/
				document.getElementById("paraMapObj_T2#LOGISTICS_ID").value=data.ajaxList[0].LOGISTICS_COMPANY;
				...
				success: function(data){
					...
					if(null != data.ajaxList){
						...
						for(var i=0;i<rccList.length;i++){
							...
							$("#itemInfo tr:last").append("<td class='datagrid-cell datagrid-cell-8' style='width:120px;text-align: center;padding:0;'><input type='text' style='width: 120px;padding:0;text-align: left;background-color:white;border:1px solid #ccc;'  disabled='disabled' class=' input isSubmit' name='CONNECT_NUM' value='"+rccList[i].CONNECT_NUM+"'/></td>");
							/*$("#itemInfo tr:last").append("<td class='datagrid-cell datagrid-cell-6' style='width:90px;text-align: center;padding:0;'><input type='text' style='width: 90px;padding:0;text-align: right;' class=' input isSubmit' id='PLAN_NUM_" + (trrCount + 1) + "' name='PLAN_NUM' value=''/></td>");*/
						/*	$("#itemInfo tr:last").append("<td class='datagrid-cell datagrid-cell-9' style='width:120px;padding:0;'>" + wmsSel + "</td>");
							$("#itemInfo tr:last").append("<td class='datagrid-cell datagrid-cell-10' style='width:100px;text-align: left;'>" + rccList[i].CUST_NAME + "<input type='hidden' name='CUST_NAME' value='" + rccList[i].CUST_NAME + "'/></td>");
							...
							*/
							...
							var themps="<tr id='trr" + (trrCount + 1) + "' >"
						              ...
						              +"<td  style='width:100px;text-align: center;padding:0;'><input type='text' disabled='disabled' style='width: 100px;padding:0;text-align: right;' maxlength='50' class=' input isSubmit' id='CI_MIN_PACK"+(trrCount+1)+"' name='MIN_PACK' value='"+rccList[i].MIN_PACK+"' oninput='OnInput2(event,\"CI_MIN_PACK"+(trrCount+1)+"\")'/></td>"
						              +"<td  style='width:80px;text-align: center;padding:0;'><input type='text'disabled='disabled' style='width: 80px;padding:0;text-align: right;' maxlength='50' class=' input isSubmit' id='CI_PLAN_NUM"+(trrCount+1)+"' name='PLAN_NUM' value='"+rccList[i].PLAN_NUM+"' oninput='OnInput2(event,\"CI_PLAN_NUM"+(trrCount+1)+"\")'/></td>"
						              +"<td  style='width:120px;text-align: center;padding:0;'><input type='text' disabled='disabled' style='width: 120px;padding:0;text-align: left;' maxlength='50' class=' input isSubmit' name='CONNECT_NUM' value='"+rccList[i].CONNECT_NUM+"'/></td>"
						              ...
						              +"<td  style='width:150px;text-align: center;padding:0;'><input style='width:130px;padding:0;' value='" + rccList[i].OUTSTOCK_DATE + "' disabled='disabled'  name='OUTSTOCK_DATE' class=' input isSubmit  _VAL_OjbsData WdateNomorl' onfocus='WdatePicker({skin:\"blue\",dateFmt:\"yyyy-MM-dd\"})'/></td>"
