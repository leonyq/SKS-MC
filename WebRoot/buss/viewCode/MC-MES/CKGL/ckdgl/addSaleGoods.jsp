...
$(function(){
	...
	<script type="text/javascript">
				...
				success: function(data) {
					...
					if(null != data.ajaxPage.dataList) {
						...
						for(var i = 0; i < rccList.length; i++) {
							...
							$("#datagrid-btable-ajaxb1001c913da94c22b6e93cf7148da003 tr:last").append("<td class='datagrid-cell datagrid-cell-5' style='width:162px;text-align: center;'>" + rccList[i].ITEM_SPEC + "<input type='hidden' id='ITEM_SPEC" + (i + 1) + "' value='" + rccList[i].ITEM_SPEC + "'/></td>");
							$("#datagrid-btable-ajaxb1001c913da94c22b6e93cf7148da003 tr:last").append("<td class='datagrid-cell datagrid-cell-6' style='width:162px;text-align: center;'>" + rccList[i].SUP_NAME + "<input type='hidden' id='ITEM_SPEC" + (i + 1) + "' value='" + rccList[i].SUP_NAME + "'/></td>");
							$("#datagrid-btable-ajaxb1001c913da94c22b6e93cf7148da003 tr:last").append("<td class='datagrid-cell datagrid-cell-7' style='text-align: center;'>" + rccList[i].ITEM_TYPE_NAME + "<input type='hidden' id='ITEM_SPEC" + (i + 1) + "' value='" + rccList[i].ITEM_TYPE_NAME + "'/></td>");
							$("#datagrid-btable-ajaxb1001c913da94c22b6e93cf7148da003 tr:last").append("<td class='datagrid-cell datagrid-cell-8' style='width:202.5px;text-align: right;display:none'><input type='hidden' id='CUST_CODE" + (i + 1) + "' value='" + rccList[i].CUST_CODE + "'/></td>");
							$("#datagrid-btable-ajaxb1001c913da94c22b6e93cf7148da003 tr:last").append("<td class='datagrid-cell datagrid-cell-9' style='width:202.5px;text-align: right;display:none'><input type='hidden' id='CUST_NAME" + (i + 1) + "' value='" + rccList[i].CUST_NAME + "'/></td>");
							$("#datagrid-btable-ajaxb1001c913da94c22b6e93cf7148da003 tr:last").append("<td class='datagrid-cell datagrid-cell-10' style='width:202.5px;text-align: right;display:none'><input type='hidden' id='MIN_PACK" + (i + 1) + "' value='" + rccList[i].MIN_PACK + "'/></td>");
						}
		...
		function addConfirm(objId,len){
			...
			$("#datagrid-btable-ajaxb1001c913da94c22b6e93cf7148da002 tr:last").append("<td class='datagrid-cell datagrid-cell-6' style='width:100px;text-align: center;padding:0;'><input type='text' style='width: 100px;padding:0;text-align: right;' maxlength='50' class=' input isSubmit' id='CI_MIN_PACK"+(trrCount+1)+"' name='MIN_PACK' value='"+$("#MIN_PACK"+objId).val()+"' oninput='OnInput2(event,\"CI_MIN_PACK"+(trrCount+1)+"\")'/></td>");
			$("#datagrid-btable-ajaxb1001c913da94c22b6e93cf7148da002 tr:last").append("<td class='datagrid-cell datagrid-cell-7' style='width:80px;text-align: center;padding:0;'><input type='text' style='width: 80px;padding:0;text-align: right;' maxlength='50' class=' input isSubmit' id='CI_PLAN_NUM"+(trrCount+1)+"' name='PLAN_NUM' value='' oninput='OnInput2(event,\"CI_PLAN_NUM"+(trrCount+1)+"\")'/></td>");
			$("#datagrid-btable-ajaxb1001c913da94c22b6e93cf7148da002 tr:last").append("<td class='datagrid-cell datagrid-cell-8' style='width:120px;text-align: center;padding:0;'><input type='text' style='width: 120px;padding:0;text-align: left;' maxlength='50' class=' input isSubmit' name='CONNECT_NUM' value=''/></td>");
			$("#datagrid-btable-ajaxb1001c913da94c22b6e93cf7148da002 tr:last").append("<td class='datagrid-cell datagrid-cell-9' style='width:120px;padding:0;'>" + wmsSel + "</td>");
			$("#datagrid-btable-ajaxb1001c913da94c22b6e93cf7148da002 tr:last").append("<td class='datagrid-cell datagrid-cell-10' style='width:100px;text-align: left;'>" + $("#CUST_NAME"+objId).val() + "<input type='hidden' name='CUST_NAME' value='" + $("#CUST_NAME"+objId).val() + "'/></td>");
			$("#datagrid-btable-ajaxb1001c913da94c22b6e93cf7148da002 tr:last").append("<td class='datagrid-cell datagrid-cell-11' style='width:150px;text-align: center;display:none;'><input type='hidden' name='CUST_CODE' value='" + $("#CUST_CODE"+objId).val() + "'/></td>");
			$("#datagrid-btable-ajaxb1001c913da94c22b6e93cf7148da002 tr:last").append("<td class='datagrid-cell datagrid-cell-12' style='width:150px;text-align: center;padding:0;'><input style='width:130px;padding:0;' name='OUTSTOCK_DATE' class=' input isSubmit  _VAL_OjbsData WdateNomorl' onfocus='WdatePicker({skin:\"blue\",dateFmt:\"yyyy-MM-dd\"})'/></td>");
		}
		$(function() {
			getWmsSel();
		})
...
<body>
	...
	<div class="bd" style="height:534px;">
		...
		<div class="js-tab">
			...
			<table class="basic-table">
				...
				<s:set name="_$viewId" value="'62e91c70804f48eaaa6d7a35fd6a175d'" />
				...
				<tr>
					...
					<bu:td cssClass="dec" style="width:200px;" colNo="T2#WOD_DISPATCH_SN" formId="1d55b72cd2294215b11d41bcca95b1c9">
						<bu:ui colNo="T2#WOD_DISPATCH_SN" style="width:200px;" formId="1d55b72cd2294215b11d41bcca95b1c9" value="%{T2#WOD_DISPATCH_SN}" formIndex="1" /></bu:td>


				</tr>
				<tr>
					<td class="name" />
					<bu:uitn colNo="WOD_CUST_CODE" formId="b1001c913da94c22b6e93cf7148da0d6" />
					</td>
					<bu:td cssClass="dec" colNo="WOD_CUST_CODE" formId="b1001c913da94c22b6e93cf7148da0d6">
						<bu:ui colNo="WOD_CUST_CODE" style="width:200px;" formId="b1001c913da94c22b6e93cf7148da0d6" value="%{WOD_OUTSTOCK_DATE}" formIndex="1" /></bu:td>
                   ...
                   <tr>
                   	...
                   	<td class="name" />
					<bu:uitn colNo="LOGISTICS_ID" formId="b1001c913da94c22b6e93cf7148da0d6" />
					</td>
					<bu:td cssClass="dec" colNo="LOGISTICS_ID" formId="b1001c913da94c22b6e93cf7148da0d6">
						<bu:ui colNo="LOGISTICS_ID" style="width:200px;"  formId="b1001c913da94c22b6e93cf7148da0d6" value="%{LOGISTICS_ID}" formIndex="1" /></bu:td>

                   	<td class="name" />
					<bu:uitn colNo="CUST_ADDRESS" formId="b1001c913da94c22b6e93cf7148da0d6" />
					</td>
					<bu:td cssClass="dec" colNo="CUST_ADDRESS" formId="b1001c913da94c22b6e93cf7148da0d6">
						<bu:ui colNo="CUST_ADDRESS"  style="width:200px;"  formId="b1001c913da94c22b6e93cf7148da0d6" value="%{CUST_ADDRESS}" formIndex="1" /></bu:td>
	...
	<bu:submit viewId="62e91c70804f48eaaa6d7a35fd6a175d" />
	<bu:script viewId="62e91c70804f48eaaa6d7a35fd6a175d" />
	...
	<script type="text/javascript">
		$(function() {
			...
			$("#paraMap1_WOD_ITEM_TYPE_chosen").attr("style","width:200px;");
			$("#paraMap1_WOD_DOC_TYPE option[value='销售出库单']").attr("selected",true);
...
function addInfo(){    var tempFlag1 = checkVal1();
			...
			$("#saveBtn").prop("disabled","disabled");
                        ...
                        document.forms.addForm.action = "${path}buss/bussModel_exeFunc.ms?funcMId=d6c8a5c8216d4edb9b7d47372879aca1";
