...
<head>
    ...
    <%@ include file="/plf/page/common/buss/listCommJs.jsp"%>
		<bu:header formId ="bc3be8856f4f4b09bd75be3a5f1c5b5f"/>
...
<script type="text/javascript">
	...
	function switchTag(tag, content, url) {
		...
		if(tag=="tag1"){
			listAjaxTable("bc3be8856f4f4b09bd75be3a5f1c5b5f");
...
<body >
    <div class="content-in">
        <div class="dlist">
            <div class="hd">
		<bu:func viewId="c3859d76348343bf9391fbc15ab06423" />
            </div>
            <div class="bd">
		...
		<bu:search viewId="c3859d76348343bf9391fbc15ab06423" />
                   </form>
		...
		<input type="hidden" name="formPagebc3be8856f4f4b09bd75be3a5f1c5b5f" id="formPagebc3be8856f4f4b09bd75be3a5f1c5b5f" value="${formPagebc3be8856f4f4b09bd75be3a5f1c5b5f}"/>
		<input type="hidden" name="formId" id="formId1" value='bc3be8856f4f4b09bd75be3a5f1c5b5f'/>
		<input type="hidden" name="formId" id="formId2" value='bc3be8856f4f4b09bd75be3a5f1c5b02'/>
		<input type="hidden" name="formId" id="formId3" value='bc3be8856f4f4b09bd75be3a5f1c5b03'/>
		<input type="hidden" name="formId" id="formId4" value='bc3be8856f4f4b09bd75be3a5f1c5b04'/>
		...
		<div class="js-tab">
			...
			<DIV class="content1" id="content" style="margin-top: 15px;">
				<DIV id="content1" style="margin-top:4px;" data-tab="tag1">
					<!--table1-->
					<div class="panel-ajax datagrid datagrid-div1"  id="bc3be8856f4f4b09bd75be3a5f1c5b5f">
					<div class="datagrid-div2 datagrid-div6 datagrid-view-ajax" id="datagrid-view-ajaxbc3be8856f4f4b09bd75be3a5f1c5b5f" style="overflow: hidden;">
					<div class="datagrid-header">
					<div class="datagrid-header-inner head2" id="datagrid-header-innerbc3be8856f4f4b09bd75be3a5f1c5b5f">
					<bu:table cssClass="datagrid-htable fixedTable datagrid-div6 datagrid-htable-kz" id="datagrid-htablebc3be8856f4f4b09bd75be3a5f1c5b5f">
					<s:set name="_$type" value="'view'" />
					<tbody class="isParentsTitle">
					<bu:tr cssClass="datagrid-header-row datagrid-title-ajax" id="datagrid-title-ajax">
						<td class="datagrid-cell" style="width:30px; text-align:center;" ><bu:thSeq  formId="bc3be8856f4f4b09bd75be3a5f1c5b5f" i18n="1"/></td>
						<td class="datagrid-cell" style="width:200px;"><bu:uitn  colNo="DATA_AUTH" formId="bc3be8856f4f4b09bd75be3a5f1c5b5f" /></td>
						<td class="datagrid-cell" style="width:150px;"><bu:uitn  colNo="WOI_DOC_NUM" formId="bc3be8856f4f4b09bd75be3a5f1c5b5f" /></td>
						<td class="datagrid-cell" style="width:150px;"><bu:uitn  colNo="WOI_ITEM_CODE" formId="bc3be8856f4f4b09bd75be3a5f1c5b5f" /></td>
						<td class="datagrid-cell" style="width:120px;"><bu:uitn  colNo="T2#WOD_ERP_FLAG" formId="bc3be8856f4f4b09bd75be3a5f1c5b5f" /></td>
						<td class="datagrid-cell" style="width:80px;"><bu:uitn  colNo="T2#WOD_URGENT_FLAG" formId="bc3be8856f4f4b09bd75be3a5f1c5b5f" /></td>
						<td class="datagrid-cell" style="width:100px;"><bu:uitn  colNo="WOI_STATUS" formId="bc3be8856f4f4b09bd75be3a5f1c5b5f" /></td>
						<td class="datagrid-cell" style="width:80px;"><bu:uitn  colNo="WOI_PLAN_NUM" formId="bc3be8856f4f4b09bd75be3a5f1c5b5f" /></td>
						<td class="datagrid-cell" style="width:80px;"><bu:uitn  colNo="WOI_OUT_NUM" formId="bc3be8856f4f4b09bd75be3a5f1c5b5f" /></td>
						<td class="datagrid-cell" style="width:120px;"><bu:uitn  colNo="WOI_PACK_NUM" formId="bc3be8856f4f4b09bd75be3a5f1c5b5f" /></td>
						<td class="datagrid-cell" style="width:150px;"><bu:uitn  colNo="WOI_CONNECT_DOC" formId="bc3be8856f4f4b09bd75be3a5f1c5b5f" /></td>
						<td class="datagrid-cell" style="width:120px;"><bu:uitn  colNo="T5#WDT_TYPE_NAME" formId="bc3be8856f4f4b09bd75be3a5f1c5b5f" /></td>
						<td class="datagrid-cell" style="width:120px;"><bu:uitn  colNo="T2#WOD_DISPATCH_SN" formId="bc3be8856f4f4b09bd75be3a5f1c5b5f" /></td>
						<td class="datagrid-cell" style="width:100px;"><bu:uitn  colNo="WOI_WH_CODE" formId="bc3be8856f4f4b09bd75be3a5f1c5b5f" /></td>
						<td class="datagrid-cell" style="width:150px;"><bu:uitn  colNo="WOI_ITEM_NAME" formId="bc3be8856f4f4b09bd75be3a5f1c5b5f" /></td>
						<td class="datagrid-cell" style="width:150px;"><bu:uitn  colNo="WOI_ITEM_SPEC" formId="bc3be8856f4f4b09bd75be3a5f1c5b5f" /></td>
						<td class="datagrid-cell" style="width:120px;"><bu:uitn  colNo="T2#WOD_CUST_CODE" formId="bc3be8856f4f4b09bd75be3a5f1c5b5f" /></td>
						<td class="datagrid-cell" style="width:150px;"><bu:uitn  colNo="WOI_DELIVERY_DATE" formId="bc3be8856f4f4b09bd75be3a5f1c5b5f" /></td>
						<td class="datagrid-cell" style="width:80px;"><bu:uitn  colNo="T4#NAME" formId="bc3be8856f4f4b09bd75be3a5f1c5b5f" /></td>
						<td class="datagrid-cell" style="width:150px;"><bu:uitn  colNo="T2#WOD_CREATE_TIME" formId="bc3be8856f4f4b09bd75be3a5f1c5b5f" /></td>
						
						<td class="datagrid-cell" style="display:none;width:120px;"><bu:uitn  colNo="T2#WOD_DISPATCH_SN" formId="bc3be8856f4f4b09bd75be3a5f1c5b5f" /></td>
						<td class="datagrid-cell" style="display:none;width:120px;"><bu:uitn  colNo="T2#WOD_DOC_TYPE" formId="bc3be8856f4f4b09bd75be3a5f1c5b5f" /></td>
						<td class="datagrid-cell" style="display:none;width:120px;"><bu:uitn  colNo="T2#WOD_STATUS" formId="bc3be8856f4f4b09bd75be3a5f1c5b5f" /></td>
					</bu:tr>
					</tbody>
					</bu:table>
					</div>
					</div>
					<div class="datagrid-body datagrid-div3 datagrid-body-ajax scroll2" id="tableDivbc3be8856f4f4b09bd75be3a5f1c5b5f" onscroll="ajaxTableScroll(this,'bc3be8856f4f4b09bd75be3a5f1c5b5f')" style="height: 130px;">
					<table class="datagrid-btable fixedTable dblClick"  id="datagrid-btable-ajaxbc3be8856f4f4b09bd75be3a5f1c5b5f">
					<tbody id="tbody_bc3be8856f4f4b09bd75be3a5f1c5b5f" class="isParents">
					</tbody>
					</table>		</div>
					</div>
					</div>
					<c:if test="${formPagebc3be8856f4f4b09bd75be3a5f1c5b5f==1}">			<div class="center">
						<s:include value="/plf/page/fp/paginationPopMultAx.jsp?listDataFn=listAjaxTable&formId=bc3be8856f4f4b09bd75be3a5f1c5b5f&showLoading=0" />
						</div>
					</c:if>
					<!--table2-->
					<div class="panel-ajax datagrid datagrid-div1" style="margin-top:10px;"><!--143-->
						<div class="datagrid-div2 datagrid-div6 datagrid-view"  style="overflow-x: hidden;">
							...
							<div class="datagrid-body datagrid-div3 scroll1" ><!--130-->
								<table class="datagrid-btable fixedTable" style="table-layout: fixed;"   id="datagrid-btable-ajaxbc3be8856f4f4b09bd75be3a5f1c5b02">
				...
				<div class="panel1 datagrid datagrid-div1">
					<div class="datagrid-div2 datagrid-div6 datagrid-view"  style="overflow-x:hidden;border:0;">
						...
						<div class="datagrid-body datagrid-div3 scroll">
							<table class="datagrid-btable fixedTable" style="table-layout: fixed;"  id="datagrid-btable-ajaxbc3be8856f4f4b09bd75be3a5f1c5b03" >
					...
					<div class="datagrid-div2 datagrid-div6 datagrid-view"  style="overflow-x:hidden;border:0;">
						<div class="datagrid-header" style="">
							<div class="datagrid-header-inner head3" id="" >
								<table  class="datagrid-htable fixedTable  "  id="datagrid-htablebc3be8856f4f4b09bd75be3a5f1c5b04">
									<tbody>
									<tr class="thcolor datagrid-header-row">
										<td class="datagrid-cell" align="center" style="width:30px;text-align: center"></td >
						...
						<div class="datagrid-body datagrid-div3 scroll3">
							<table class="datagrid-btable fixedTable" style=" table-layout: fixed;"   id="datagrid-btable-ajaxbc3be8856f4f4b09bd75be3a5f1c5b04">
		...
		<bu:submit viewId="c3859d76348343bf9391fbc15ab06423" />
      <jsp:include page="/plf/page/mesdemo/commCode/commCode.jsp">
           <jsp:param name="modelName" value="VIEW_TYPE_17" />
           <jsp:param name="location" value="beforeJsLoad" />
      </jsp:include>
		<bu:script viewId="c3859d76348343bf9391fbc15ab06423" />
...
<script type="text/javascript">
				function listAjaxTable(formId){
                    ...
                    var pageRecord="";
                    var isFirstLoad;
                    $(document.getElementById('T2#WOD_DOC_TYPE')).val('DJ12');
               ...
               function query(thisObj){
                 var formId = $("#formId1").val();
                   ...
                   if($("#tag1").attr("class")=="current"){
                    ...
                    //defTableWidthRewrite('bc3be8856f4f4b09bd75be3a5f1c5b5f');
                }
               ...
               function setTableWidth(formId){
                ...
                function init(){
                    ...
                    getFormIdInitChildPage();
                    initTableWidth();
                     $(document.getElementById('T2#WOD_CREATE_TIME_BEGIN')).val(timeBeginString());
                    $(document.getElementById('T2#WOD_CREATE_TIME_END')).val(timeEndString());
                    $(document.getElementById('T2#WOD_DOC_TYPE')).val('DJ12');
...
<script type="text/javascript">
	...
	function showItemDetail(itemId){  
		...
		$.ajax({
				    type: "POST",
				    dataType: "json",
				    url:   "buss/bussModel_exeFunc.ms?funcMId=9373d092dd704f0dbdc3026faad20db4",
				    data:{
				        "itemId":itemId
				    },
					success: function(data){
							...
							if(null != data.ajaxPage.dataList){
								...
								for(var i = 0;i < rccList.length; i++){								
                                   // if(rccList[i].DATA_AUTH==null)  rccList[i].DATA_AUTH="";
									...
									$("#datagrid-btable-ajaxbc3be8856f4f4b09bd75be3a5f1c5b02 tbody:last").append("<tr id='tr1_"+i+"' ></tr>");
									$("#datagrid-btable-ajaxbc3be8856f4f4b09bd75be3a5f1c5b02 tr:last").append("<td class='datagrid-cell datagrid-cell-1' style='width:30px;text-align: center;'>"+(i+1)+"</td>");
								//	$("#datagrid-btable-ajaxbc3be8856f4f4b09bd75be3a5f1c5b02 tr:last").append("<td class='datagrid-cell datagrid-cell-2' style='width:200px;text-align: left;' title='"+rccList[i].DATA_AUTH+"'>"+rccList[i].DATA_AUTH+"</td>");
									$("#datagrid-btable-ajaxbc3be8856f4f4b09bd75be3a5f1c5b02 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:210px;text-align: left;' title='"+rccList[i].ITEM_SN+"'><span onclick='itemJump3(\""+rccList[i].ITEM_SN+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].ITEM_SN+"</span></td>");
									$("#datagrid-btable-ajaxbc3be8856f4f4b09bd75be3a5f1c5b02 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:150px;text-align: left;' title='"+rccList[i].ITEM_CODE+"'><span onclick='itemJump2(\""+rccList[i].ITEM_CODE+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].ITEM_CODE+"</span></td>");
									$("#datagrid-btable-ajaxbc3be8856f4f4b09bd75be3a5f1c5b02 tr:last").append("<td class='datagrid-cell datagrid-cell-5' style='width:150px;text-align: left;' title='"+rccList[i].ITEM_NAME+"'>"+rccList[i].ITEM_NAME+"</td>");
									$("#datagrid-btable-ajaxbc3be8856f4f4b09bd75be3a5f1c5b02 tr:last").append("<td class='datagrid-cell datagrid-cell-6' style='width:150px;text-align: left;' title='"+rccList[i].ITEM_SPEC+"'>"+rccList[i].ITEM_SPEC+"</td>");
									$("#datagrid-btable-ajaxbc3be8856f4f4b09bd75be3a5f1c5b02 tr:last").append("<td class='datagrid-cell datagrid-cell-7' style='width:80px;text-align: right;' title='"+rccList[i].OUTSTOCK_NUM+"'>"+rccList[i].OUTSTOCK_NUM+"</td>");
									$("#datagrid-btable-ajaxbc3be8856f4f4b09bd75be3a5f1c5b02 tr:last").append("<td class='datagrid-cell datagrid-cell-10' style='width:150px;text-align: left;' title='"+rccList[i].DOC_NUM+"'>"+rccList[i].DOC_NUM+"</td>");
									$("#datagrid-btable-ajaxbc3be8856f4f4b09bd75be3a5f1c5b02 tr:last").append("<td class='datagrid-cell datagrid-cell-11' style='width:100px;text-align: left;' title='"+rccList[i].FIRST_SN+"'>"+rccList[i].FIRST_SN+"</td>");
									$("#datagrid-btable-ajaxbc3be8856f4f4b09bd75be3a5f1c5b02 tr:last").append("<td class='datagrid-cell datagrid-cell-12' style='width:100px;text-align: left;' title='"+rccList[i].SECOND_SN+"'>"+rccList[i].SECOND_SN+"</td>");
									$("#datagrid-btable-ajaxbc3be8856f4f4b09bd75be3a5f1c5b02 tr:last").append("<td class='datagrid-cell datagrid-cell-13' style='width:100px;text-align: left;' title='"+rccList[i].THIRD_SN+"'>"+rccList[i].THIRD_SN+"</td>");
									$("#datagrid-btable-ajaxbc3be8856f4f4b09bd75be3a5f1c5b02 tr:last").append("<td class='datagrid-cell datagrid-cell-14' style='width:100px;text-align: left;' title='"+rccList[i].FOURTH_SN+"'>"+rccList[i].FOURTH_SN+"</td>");
									$("#datagrid-btable-ajaxbc3be8856f4f4b09bd75be3a5f1c5b02 tr:last").append("<td class='datagrid-cell datagrid-cell-15' style='width:110px;text-align: left;' title='"+rccList[i].WH_NAME+"'>"+rccList[i].WH_NAME+"</td>");
									$("#datagrid-btable-ajaxbc3be8856f4f4b09bd75be3a5f1c5b02 tr:last").append("<td class='datagrid-cell datagrid-cell-18' style='width:80px;text-align: center;' title='"+rccList[i].OUTSTOCK_EMP+"'>"+rccList[i].OUTSTOCK_EMP+"</td>");
									$("#datagrid-btable-ajaxbc3be8856f4f4b09bd75be3a5f1c5b02 tr:last").append("<td class='datagrid-cell datagrid-cell-19' style='width:130px;text-align: center;' title='"+rccList[i].OUTSTOCK_TIME+"'>"+rccList[i].OUTSTOCK_TIME+"</td>");
									$("#datagrid-btable-ajaxbc3be8856f4f4b09bd75be3a5f1c5b02 tr:last").append("<td class='datagrid-cell datagrid-cell-20' style='width:70px;text-align: center;' title=''>"+tempFlag+"</td>");
									$("#datagrid-btable-ajaxbc3be8856f4f4b09bd75be3a5f1c5b02 tr:last").append("<td class='datagrid-cell datagrid-cell-21' style='width:150px;text-align: center;' title='"+rccList[i].UPLOAD_TIME+"'>"+rccList[i].UPLOAD_TIME+"</td>");
								}
							}
					...
					success: function(data){
							...
							if(null != data.ajaxPage.dataList){
								...
								for(var i = 0;i < rccList.length; i++){
									...
									if(rccList[i].UPLOAD_TIME==null)  rccList[i].UPLOAD_TIME="";
									$("#datagrid-btable-ajaxbc3be8856f4f4b09bd75be3a5f1c5b02 tbody:last").append("<tr id='tr1_"+i+"' ></tr>");
									$("#datagrid-btable-ajaxbc3be8856f4f4b09bd75be3a5f1c5b02 tr:last").append("<td class='datagrid-cell datagrid-cell-1' style='width:30px;text-align: center;'>"+((currentPage - 1) * pageRecord + (i + 1))+"</td>");
									//$("#datagrid-btable-ajaxbc3be8856f4f4b09bd75be3a5f1c5b02 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:200px;text-align: center;' title='"+rccList[i].DATA_AUTH+"'>"+rccList[i].DATA_AUTH+"</td>");
									$("#datagrid-btable-ajaxbc3be8856f4f4b09bd75be3a5f1c5b02 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='text-align: center;width:200px;' title='"+rccList[i].DATA_AUTH+"'>"+rccList[i].DATA_AUTH+"<input type='hidden' id='DATA_AUTH_ID_"+rccList[i].ID+"' value='"+rccList[i].DATA_AUTH2+"' /></td>");
									$("#datagrid-btable-ajaxbc3be8856f4f4b09bd75be3a5f1c5b02 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:210px;text-align: left;' title='"+rccList[i].ITEM_SN+"'><span onclick='itemJump3(\""+rccList[i].ITEM_SN+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].ITEM_SN+"</span></td>");
									$("#datagrid-btable-ajaxbc3be8856f4f4b09bd75be3a5f1c5b02 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:150px;text-align: left;' title='"+rccList[i].ITEM_CODE+"'><span onclick='itemJump2(\""+rccList[i].ITEM_CODE+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].ITEM_CODE+"</span></td>");
									$("#datagrid-btable-ajaxbc3be8856f4f4b09bd75be3a5f1c5b02 tr:last").append("<td class='datagrid-cell datagrid-cell-5' style='width:150px;text-align: left;' title='"+rccList[i].ITEM_NAME+"'>"+rccList[i].ITEM_NAME+"</td>");
									$("#datagrid-btable-ajaxbc3be8856f4f4b09bd75be3a5f1c5b02 tr:last").append("<td class='datagrid-cell datagrid-cell-6' style='width:150px;text-align: left;' title='"+rccList[i].ITEM_SPEC+"'>"+rccList[i].ITEM_SPEC+"</td>");
	...
	function searchItemDetail(){
		...
		var custCode = $(document.getElementById('T7#CUSTOMER')).val();
					...
					success: function(data){
							...
							if(null != data.ajaxPage.dataList){
								...
								for(var i = 0;i < rccList.length; i++){
									...
									//$("#datagrid-btable-ajaxbc3be8856f4f4b09bd75be3a5f1c5b03 tr:last").append("<td class='datagrid-cell datagrid-cell-2' style='width:200px;text-align: center;' title='"+rccList[i].DATA_AUTH+"'>"+rccList[i].DATA_AUTH+"</td>");
									$("#datagrid-btable-ajaxbc3be8856f4f4b09bd75be3a5f1c5b03 tr:last").append("<td class='datagrid-cell datagrid-cell-2' style='text-align: center;width:200px;' title='"+rccList[i].DATA_AUTH+"'>"+rccList[i].DATA_AUTH+"<input type='hidden' id='DATA_AUTH_ID_"+rccList[i].ID+"' value='"+rccList[i].DATA_AUTH2+"' /></td>");
									$("#datagrid-btable-ajaxbc3be8856f4f4b09bd75be3a5f1c5b03 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:210px;text-align: left;' title='"+rccList[i].ITEM_SN+"'><span onclick='itemJump3(\""+rccList[i].ITEM_SN+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].ITEM_SN+"</span></td>");
									$("#datagrid-btable-ajaxbc3be8856f4f4b09bd75be3a5f1c5b03 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:150px;text-align: left;' title='"+rccList[i].ITEM_CODE+"'><span onclick='itemJump2(\""+rccList[i].ITEM_CODE+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].ITEM_CODE+"</span></td>");
									$("#datagrid-btable-ajaxbc3be8856f4f4b09bd75be3a5f1c5b03 tr:last").append("<td class='datagrid-cell datagrid-cell-5' style='width:150px;text-align: left;' title='"+rccList[i].ITEM_NAME+"'>"+rccList[i].ITEM_NAME+"</td>");
									$("#datagrid-btable-ajaxbc3be8856f4f4b09bd75be3a5f1c5b03 tr:last").append("<td class='datagrid-cell datagrid-cell-6' style='width:150px;text-align: left;' title='"+rccList[i].ITEM_SPEC+"'>"+rccList[i].ITEM_SPEC+"</td>");
									$("#datagrid-btable-ajaxbc3be8856f4f4b09bd75be3a5f1c5b03 tr:last").append("<td class='datagrid-cell datagrid-cell-7' style='width:80px;text-align: right;' title='"+rccList[i].OUTSTOCK_NUM+"'>"+rccList[i].OUTSTOCK_NUM+"</td>");
									$("#datagrid-btable-ajaxbc3be8856f4f4b09bd75be3a5f1c5b03 tr:last").append("<td class='datagrid-cell datagrid-cell-10' style='width:150px;text-align: left;' title='"+rccList[i].DOC_NUM+"'>"+rccList[i].DOC_NUM+"</td>");
									$("#datagrid-btable-ajaxbc3be8856f4f4b09bd75be3a5f1c5b03 tr:last").append("<td class='datagrid-cell datagrid-cell-11' style='width:100px;text-align: left;' title='"+rccList[i].FIRST_SN+"'>"+rccList[i].FIRST_SN+"</td>");
									$("#datagrid-btable-ajaxbc3be8856f4f4b09bd75be3a5f1c5b03 tr:last").append("<td class='datagrid-cell datagrid-cell-12' style='width:100px;text-align: left;' title='"+rccList[i].SECOND_SN+"'>"+rccList[i].SECOND_SN+"</td>");
									$("#datagrid-btable-ajaxbc3be8856f4f4b09bd75be3a5f1c5b03 tr:last").append("<td class='datagrid-cell datagrid-cell-13' style='width:100px;text-align: left;' title='"+rccList[i].THIRD_SN+"'>"+rccList[i].THIRD_SN+"</td>");
									$("#datagrid-btable-ajaxbc3be8856f4f4b09bd75be3a5f1c5b03 tr:last").append("<td class='datagrid-cell datagrid-cell-14' style='width:100px;text-align: left;' title='"+rccList[i].FOURTH_SN+"'>"+rccList[i].FOURTH_SN+"</td>");
									$("#datagrid-btable-ajaxbc3be8856f4f4b09bd75be3a5f1c5b03 tr:last").append("<td class='datagrid-cell datagrid-cell-15' style='width:110px;text-align: left;' title='"+rccList[i].WH_NAME+"'>"+rccList[i].WH_NAME+"</td>");
									$("#datagrid-btable-ajaxbc3be8856f4f4b09bd75be3a5f1c5b03 tr:last").append("<td class='datagrid-cell datagrid-cell-18' style='width:80px;text-align: center;' title='"+rccList[i].OUTSTOCK_EMP+"'>"+rccList[i].OUTSTOCK_EMP+"</td>");
									$("#datagrid-btable-ajaxbc3be8856f4f4b09bd75be3a5f1c5b03 tr:last").append("<td class='datagrid-cell datagrid-cell-19' style='width:130px;text-align: center;' title='"+rccList[i].OUTSTOCK_TIME+"'>"+rccList[i].OUTSTOCK_TIME+"</td>");
									$("#datagrid-btable-ajaxbc3be8856f4f4b09bd75be3a5f1c5b03 tr:last").append("<td class='datagrid-cell datagrid-cell-20' style='width:70px;text-align: center;' title=''>"+tempFlag+"</td>");
									$("#datagrid-btable-ajaxbc3be8856f4f4b09bd75be3a5f1c5b03 tr:last").append("<td class='datagrid-cell datagrid-cell-21' style='width:150px;text-align: center;' title='"+rccList[i].UPLOAD_TIME+"'>"+rccList[i].UPLOAD_TIME+"</td>");
								}
							}
		...
		var woiStatus = $("#WOI_STATUS").val();
	    	...
	    	$.ajax({
				    ...
				    data:{
				        ...
				        "paraMap.docType":"DJ12",
				        "page.currentPage":_GLO_FORM_PAGE_MAP[paginationImpl].currentPage,
				        "page.pageRecord": _GLO_FORM_PAGE_MAP[paginationImpl].pageRecord,
				    },
				    //data: "paraMap.type=1&paraMap.itemCode="+itemCode+"&paraMap.dataAuth="+dataAuthdataAuth+"&paraMap.docNum="+docNum+"&paraMap.connectDoc="+connectDoc+"&paraMap.woiStatus="+woiStatus+"&paraMap.docType=DJ12"+"&page.currentPage="+_GLO_FORM_PAGE_MAP[paginationImpl].currentPage+"&page.pageRecord=" + _GLO_FORM_PAGE_MAP[paginationImpl].pageRecord,
					success: function(data){
...
function createTableModel(ms,formId){
    ...
    var colNo = $("#relColVals").val();
    if(formId=='bc3be8856f4f4b09bd75be3a5f1c5b5f'){<%--出库单物料信息--%>
        ...
        $.each(uiTxt,function(i,v){
           ...
           arrHtml.push("<td colno='DATA_AUTH' class='datagrid-cell TD_DATA_AUTH"+ms.tdClass(formId, 'DATA_AUTH')+"' style='width:200px;text-align:center;"+ms.tdStyle(formId, 'DATA_AUTH')+"' "+ms.tdEvent(formId, 'DATA_AUTH')+">")		
            ...
            arrHtml.push("<span colno='WOI_CONNECT_DOC' class='"+ms.uiClass(formId, 'WOI_CONNECT_DOC')+"' onclick='itemJump1(\""+v['WOI_CONNECT_DOC']+"\")' style='display: inline;border-bottom: 1px solid #004098;' "+ms.uiEvent(formId, 'WOI_CONNECT_DOC')+" title='"+v['WOI_CONNECT_DOC']+"' >"+v['WOI_CONNECT_DOC']+"</span>")
            arrHtml.push("</td>");
            ...
            arrHtml.push("<td colno='T2#WOD_OUTSTOCK_DATE' class='datagrid-cell "+ms.tdClass(formId, 'T2#WOD_OUTSTOCK_DATE')+"' style='display:none;width:150px;text-align:center;padding:0;"+ms.tdStyle(formId, 'T2#WOD_OUTSTOCK_DATE')+"' "+ms.tdEvent(formId, 'T2#WOD_OUTSTOCK_DATE')+">")
...
function searchOutstock(){
    ...
    var url = "${path}buss/bussModel_exeFunc.ms?funcMId=57c0197d784b4ba7a7c4a6a132a230b8";
    var dataAuth = $("#DATA_AUTH").val();
		...
		success:function(data){
            ...
            if(null!=data.ajaxPage.dataList){
                ...
                console.log(list);
                    ...
                    console.log(list[i].WOI_DOC_NUM);
                        ...
                        $("#addOutstock ").append("<tr id='"+list[i].WOI_DOC_NUM+"' ondblclick='dblClickShowDetail(this.id)' onclick='clickTr(this.id)' ></tr>");
						...
						//$("#addOutstock tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='text-align: center;width:130px;' title='"+list[i].DATA_AUTH+"'>"+list[i].DATA_AUTH+"</td>");
            ...
            pageFun(data.ajaxPage,"formId4");
							var tableTrJs = $("#datagrid-btable-ajaxbc3be8856f4f4b09bd75be3a5f1c5b04 tbody tr");
							_tongLineColor(tableTrJs);
							clickTr('addOutstock');
							defTableWidthRewrite('bc3be8856f4f4b09bd75be3a5f1c5b04');
        },
        error:function(msg){
            	utilsFp.confirmIcon(3,"","","", "error:"+msg,0,"300","");
        }
                ...
                console.log(list);
                    for(var i=0; i<list.length;i++){
                        ...
                        if(list[i].WDT_TYPE_NAME==null) list[i].WDT_TYPE_NAME="";
                         ...
                         $("#addOutstock ").append("<tr id='"+list[i].WOI_DOC_NUM+"' ondblclick='dblClickShowDetail(this.id)' ></tr>");
						...
						$("#addOutstock tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='text-align: left;width:160px;' title='"+list[i].WOI_DOC_NUM+"'>"+list[i].WOI_DOC_NUM+"</td>");
					   	$("#addOutstock tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='text-align: center;width:130px;' title='"+list[i].WDT_TYPE_NAME+"'>"+list[i].WDT_TYPE_NAME+"</td>");
						$("#addOutstock tr:last").append("<td class='datagrid-cell datagrid-cell-5' style='text-align: center;width:110px;' >"+tempType+"<input type='hidden' id='state_"+list[i].WRD_DOC_NUM+"' value='"+list[i].WRD_STATUS+"'></td>");
						$("#addOutstock tr:last").append("<td class='datagrid-cell datagrid-cell-6' style='text-align: center;width:130px;' >"+tempCheck+"</td>");
						$("#addOutstock tr:last").append("<td class='datagrid-cell datagrid-cell-7' style='text-align: center;width:130px;' >"+tempFreeze+"</td>");
						$("#addOutstock tr:last").append("<td class='datagrid-cell datagrid-cell-8' style='text-align: center;width:130px;' title='"+list[i].WA_AREA_NAME+"'>"+list[i].WA_AREA_NAME+"</td>");
						$("#addOutstock tr:last").append("<td class='datagrid-cell datagrid-cell-9' style='text-align: center;width:160px;' >"+list[i].OUTSTOCK_DATE+"</td>");
...
function GetProduceNumId(docNum,type){
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(type==1){
                 var url = "${path}buss/bussModel_exeFunc.ms?FUNC_CODE=F6857&funcMId=3582eb9f1e49438285954d9e04735610&formId=bc3be8856f4f4b09bd75be3a5f1c5b5f&dataId="+dateId+"&iframeId="+_currentFrame;			
                	console.log(dateId);
                showPopWinFp(url, 1200, 550,null,document.title+ "<dict:lang value="修改" />"); 
            }else if(type==3){
                var url = "${path}buss/bussModel_exeFunc.ms?FUNC_CODE=F6854&funcMId=eabb689a83f241e18e07f337e8ad61c2&formId=bc3be8856f4f4b09bd75be3a5f1c5b5f&dataId="+dateId+"&iframeId="+_currentFrame+"&dataAuth="+dataAuth;				
