...
<div class="content-in">
    <div class="dlist">
        <div class="hd">
            <bu:func viewId="7fe043b6af20408f85940b2d7c2ca2bb"/>
        </div>
        <div class="bd">
            <div class="search-box">
                <form id="searchForm" name="searchForm" action="${path}buss/bussModel.ms" method="post">
                    ...
                    <table class="search_table">
                        <bu:search deal_mark="1" viewId="7fe043b6af20408f85940b2d7c2ca2bb"/>
                    ...
                    <div class="datagrid-div2 datagrid-div6 datagrid-view-ajax" id="datagrid-view-ajaxb36254ac37e74240b1528d44627b6a84" style="">
                                ...
                                <bu:table cssClass="datagrid-htable fixedTable datagrid-div6 datagrid-htable-kz" id="datagrid-htableb36254ac37e74240b1528d44627b6a84">
                                    ...
                                    <bu:tr cssClass="datagrid-header-row datagrid-title-ajax" id="datagrid-title-ajax">
                                        <td class="datagrid-cell" name="noprintset_SEQ" style="width:30px; text-align:center;">
                                            <bu:thSeq formId="b36254ac37e74240b1528d44627b6a84" i18n="1"/></td>
                                        <td class="datagrid-cell no-print" style="width:30px; text-align:center">
                                            <span><input type="checkbox" id="selectAll_b36254ac37e74240b1528d44627b6a84" onclick="_selectAjaxTableAllData(this,'b36254ac37e74240b1528d44627b6a84')" style="cursor: pointer;" title="全选"/></span>
                                        </td>
                                        <td class="datagrid-cell" style="width:200px;">
                                            <bu:uitn colNo="DATA_AUTH" formId="b36254ac37e74240b1528d44627b6a84"/></td>
                        ...
                        <div class="datagrid-body datagrid-div3 datagrid-body-ajax" id="tableDivb36254ac37e74240b1528d44627b6a84" onscroll="ajaxTableScroll(this,'b36254ac37e74240b1528d44627b6a84')">
                            <table class="datagrid-btable fixedTable dblClick" id="datagrid-btable-ajaxb36254ac37e74240b1528d44627b6a84">
                                <tbody id="tbody_b36254ac37e74240b1528d44627b6a84" class="isParents"></tbody>
                            </table>
                        </div>
                    </div>
                </div>
                <c:if test="${formPageb36254ac37e74240b1528d44627b6a84==1}">
                    <div class="center">
                    ...
                    <div class="datagrid-div2 datagrid-div6 datagrid-view-ajax" id="datagrid-view-ajax92c585de53ff4e9f879b4e4bc0c16e8f" style="">
                        <div class="datagrid-header">
                            <div class="datagrid-header-inner" id="datagrid-header-inner92c585de53ff4e9f879b4e4bc0c16e8f">
                                <bu:table cssClass="datagrid-htable fixedTable datagrid-div6 datagrid-htable-kz" id="datagrid-htable92c585de53ff4e9f879b4e4bc0c16e8f">
                                    ...
                                    <bu:tr cssClass="datagrid-header-row datagrid-title-ajax" id="datagrid-title-ajax">
                                        <td class="datagrid-cell" name="noprintset_SEQ" style="width:30px; text-align:center;">
                                            <bu:thSeq formId="92c585de53ff4e9f879b4e4bc0c16e8f" i18n="1"/></td>
                                        <td class="datagrid-cell no-print" style="width:30px; text-align:center">
                                            <span><input type="checkbox" id="selectAll_92c585de53ff4e9f879b4e4bc0c16e8f" onclick="_selectAjaxTableAllData(this,'92c585de53ff4e9f879b4e4bc0c16e8f')" style="cursor: pointer;" title="全选"/></span>
                                        </td>
                                        <td name="noprintset_PROJECT_ID" class="datagrid-cell">
                                            <bu:uitn colNo="PROJECT_ID" formId="92c585de53ff4e9f879b4e4bc0c16e8f"/></td>
                                        <td name="noprintset_ITEM_CODE" class="datagrid-cell">
                                            <bu:uitn colNo="ITEM_CODE" formId="92c585de53ff4e9f879b4e4bc0c16e8f"/></td>
                                        <td name="noprintset_MODEL_CODE" class="datagrid-cell">
                                            <bu:uitn colNo="MODEL_CODE" formId="92c585de53ff4e9f879b4e4bc0c16e8f"/></td>
                                        <td name="noprintset_ITEM_NUM" class="datagrid-cell">
                                            <bu:uitn colNo="ITEM_NUM" formId="92c585de53ff4e9f879b4e4bc0c16e8f"/></td>
                                        <td name="noprintset_FEED_NUM" class="datagrid-cell">
                                            <bu:uitn colNo="FEED_NUM" formId="92c585de53ff4e9f879b4e4bc0c16e8f"/></td>
                                        <td name="noprintset_PROCESS_ORDER" class="datagrid-cell">
                                            <bu:uitn colNo="PROCESS_ORDER" formId="92c585de53ff4e9f879b4e4bc0c16e8f"/></td>
                                    </bu:tr>
                                    </tbody>
                                </bu:table>
                            </div>
                        ...
                        <div class="datagrid-body datagrid-div3 datagrid-body-ajax" id="tableDiv92c585de53ff4e9f879b4e4bc0c16e8f" onscroll="ajaxTableScroll(this,'92c585de53ff4e9f879b4e4bc0c16e8f')">
                            <table class="datagrid-btable fixedTable dblClick" id="datagrid-btable-ajax92c585de53ff4e9f879b4e4bc0c16e8f">
                                <tbody id="tbody_92c585de53ff4e9f879b4e4bc0c16e8f" class="isChilds"></tbody>
                            </table>
                        </div>
                    </div>
                </div>
                <c:if test="${formPage92c585de53ff4e9f879b4e4bc0c16e8f==1}">
                    <div class="center" id="time92c585de53ff4e9f879b4e4bc0c16e8f" style="display:none">
...
<bu:submit viewId="7fe043b6af20408f85940b2d7c2ca2bb"/>
<jsp:include page="/plf/page/mesdemo/commCode/commCode.jsp">
    <jsp:param name="modelName" value="VIEW_TYPE_17"/>
    <jsp:param name="location" value="beforeJsLoad"/>
</jsp:include>
<bu:script viewId="7fe043b6af20408f85940b2d7c2ca2bb"/>
...
<script type="text/javascript">
    ...
    function itemJump2(obj) {
        ...
        $("#time92c585de53ff4e9f879b4e4bc0c16e8f").css({"display": "block"});
    }
    <%-- 数据为空时设置横向滚动条 --%>
