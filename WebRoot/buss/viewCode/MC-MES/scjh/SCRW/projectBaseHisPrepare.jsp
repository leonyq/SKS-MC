...
<head>
 <title>
  <dict:lang value="VOID-生产备料-历史处理"/>
 </title>
 ...
 <bu:header formId="26281e487960487ca8848b3bd3718288"/>
 <jsp:include page="/plf/page/mesdemo/commCode/commCode.jsp">
  <jsp:param name="modelName" value="VIEW_TYPE_17"/>
...
<div class="content-in">
 <div class="dlist">
  <div class="hd">
   <bu:func viewId="de8b9a01af6b42f190e5ad5fb92e821c"/>
  </div>
  <div class="bd">
   <div class="search-box">
    <form id="searchForm" name="searchForm" action="${path}buss/bussModel.ms" method="post">
     ...
     <bu:search viewId="de8b9a01af6b42f190e5ad5fb92e821c"/>
   ...
   <form id="listForm" name="listForm" action="${path}buss/bussModel.ms" method="post">
    ...
    <input type="hidden" name="formPage26281e487960487ca8848b3bd3718288" id="formPage26281e487960487ca8848b3bd3718288" value="${formPage26281e487960487ca8848b3bd3718288}"/>
    <input type="hidden" name="formId" id="formId1" value='26281e487960487ca8848b3bd3718288'/>
    ...
    <div class="panel-ajax datagrid datagrid-div1" id="26281e487960487ca8848b3bd3718288">
     <div class="datagrid-div2 datagrid-div6 datagrid-view-ajax" id="datagrid-view-ajax26281e487960487ca8848b3bd3718288" style="">
      <div class="datagrid-header">
       <div class="datagrid-header-inner" id="datagrid-header-inner26281e487960487ca8848b3bd3718288">
        <bu:table cssClass="datagrid-htable fixedTable datagrid-div6 datagrid-htable-kz" id="datagrid-htable26281e487960487ca8848b3bd3718288" style="min-width:2030px;">
         <s:set name="_$type" value="'view'"/>
         <tbody class="isParentsTitle">
         <bu:tr cssClass="datagrid-header-row datagrid-title-ajax" id="datagrid-title-ajax">
          <td class="datagrid-cell" style="width:30px; text-align:center;">
           <bu:thSeq formId="26281e487960487ca8848b3bd3718288" i18n="1"/></td>
          <td class="datagrid-cell" style="width:30px; text-align:center">
           <span><input type="checkbox" id="selectAll_26281e487960487ca8848b3bd3718288" onclick="_selectAjaxTableAllData(this,'26281e487960487ca8848b3bd3718288')" style="cursor: pointer;" title="全选"/></span>
          </td>
          <td class="datagrid-cell" style="width:200px;">
           <bu:uitn colNo="DATA_AUTH" formId="26281e487960487ca8848b3bd3718288"/></td>
          <td class="datagrid-cell" style="width:150px;">
           <bu:uitn colNo="PROJECT_ID" formId="26281e487960487ca8848b3bd3718288"/></td>
          <td class="datagrid-cell" style="text-align:center;width:70px;">
           <bu:uitn colNo="PROJECT_STATUS" formId="26281e487960487ca8848b3bd3718288"/></td>
          <td class="datagrid-cell" style="text-align:center;width:100px;">
           <bu:uitn colNo="IS_REL" formId="26281e487960487ca8848b3bd3718288"/></td>
          <td class="datagrid-cell" style="width:150px;">
           <bu:uitn colNo="PRODUCT_MATERIAL" formId="26281e487960487ca8848b3bd3718288"/></td>
          <td class="datagrid-cell" style="width:150px;">
           <bu:uitn colNo="PRODUCT_NAME" formId="26281e487960487ca8848b3bd3718288"/></td>
          <td class="datagrid-cell" style="width:150px;">
           <bu:uitn colNo="PRODUCT_STANDARD" formId="26281e487960487ca8848b3bd3718288"/></td>
          <td class="datagrid-cell" style="width:70px;">
           <bu:uitn colNo="PRODUCT_COUNT" formId="26281e487960487ca8848b3bd3718288"/></td>
          <%--
          <td class="datagrid-cell" style="width:110px;">
              <bu:uitn colNo="FAI_NUM" formId="26281e487960487ca8848b3bd3718288"/></td>
          <td class="datagrid-cell" style="width:70px;">
              <bu:uitn colNo="FQC_COUNT" formId="26281e487960487ca8848b3bd3718288"/></td>
          <td class="datagrid-cell" style="width:70px;">
              <bu:uitn colNo="FINISH_COUNT" formId="26281e487960487ca8848b3bd3718288"/></td>
          <td class="datagrid-cell" style="width:140px;">
              <bu:uitn colNo="PROLEPSIS_START_DATE" formId="26281e487960487ca8848b3bd3718288"/></td>
          <td class="datagrid-cell" style="width:140px;">
              <bu:uitn colNo="PROLEPSIS_END_DATE" formId="26281e487960487ca8848b3bd3718288"/></td>
          <td class="datagrid-cell" style="width:150px;">
              <bu:uitn colNo="CUST_CODE" formId="26281e487960487ca8848b3bd3718288"/></td>
          <td class="datagrid-cell" style="width:150px;">
              <bu:uitn colNo="DESTROY_NO" formId="26281e487960487ca8848b3bd3718288"/></td>
          --%>
          <td class="datagrid-cell" style="width:90px;">
           <bu:uitn colNo="CREATE_USER" formId="26281e487960487ca8848b3bd3718288"/></td>
          <td class="datagrid-cell" style="width:140px;">
           <bu:uitn colNo="CREATE_TIME" formId="26281e487960487ca8848b3bd3718288"/></td>
          <td class="datagrid-cell" style="width:140px;">
           <bu:uitn colNo="EDIT_TIME" formId="26281e487960487ca8848b3bd3718288"/></td>
         </bu:tr>
         </tbody>
        </bu:table>
       </div>
      </div>
      <div class="datagrid-body datagrid-div3 datagrid-body-ajax" id="tableDiv26281e487960487ca8848b3bd3718288" onscroll="ajaxTableScroll(this,'26281e487960487ca8848b3bd3718288')">
       <table class="datagrid-btable fixedTable dblClick" id="datagrid-btable-ajax26281e487960487ca8848b3bd3718288" style="min-width:2030px;">
        <tbody id="tbody_26281e487960487ca8848b3bd3718288" class="isParents"></tbody>
       </table>
      </div>
     </div>
    </div>
    <c:if test="${formPage26281e487960487ca8848b3bd3718288==1}">
    <div class="center">
     <s:include value="/plf/page/fp/paginationPopMultAx.jsp?listDataFn=listAjaxTable&formId=26281e487960487ca8848b3bd3718288&showLoading=0"/>
    </div>
    </c:if>
  </div>
...
<bu:submit viewId="de8b9a01af6b42f190e5ad5fb92e821c"/>

<bu:script viewId="de8b9a01af6b42f190e5ad5fb92e821c"/>
...
<script>
    ...
    function createTableModel(ms, formId) {
        ...
        if (formId == '26281e487960487ca8848b3bd3718288') {<%--工单信息--%>
