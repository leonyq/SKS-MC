...
<div class="content-in">
    <div class="dlist">
        <div class="hd">
            <bu:func viewId="1e4af503feaf4a39937cb1b5a2088a6f"/>
        </div>
        <div class="bd">
            <div class="search-box">
                <form id="searchForm" name="searchForm" action="${path}buss/bussModel.ms" method="post">
                    ...
                    <bu:search viewId="1e4af503feaf4a39937cb1b5a2088a6f"/>
                            ...
                            <div class="datagrid-header-inner" id="datagrid-header-innerb376f2a126f2414d81c63507a3c699c0">
                                <bu:table cssClass="datagrid-htable fixedTable datagrid-div6 datagrid-htable-kz" id="datagrid-htableb376f2a126f2414d81c63507a3c699c0">
                                    ...
                                    <bu:tr cssClass="datagrid-header-row datagrid-title-ajax" id="datagrid-title-ajax">
                                        ...
                                        <!-- <td class="datagrid-cell" style="text-align:center;width:60px;">
                                        <bu:uitn colNo="PROJECT_ID" formId="b376f2a126f2414d81c63507a3c699c0"/></td> <td class="datagrid-cell" style="text-align:center;width:30px;">
                                        ...
                                        <td class="datagrid-cell" style="text-align:center;width:70px;">
                                        <bu:uitn colNo="CREATE_USER" formId="b376f2a126f2414d81c63507a3c699c0"/></td> <td class="datagrid-cell" style="text-align:center;width:100px;">
...
<bu:submit viewId="1e4af503feaf4a39937cb1b5a2088a6f"/>

<bu:script viewId="1e4af503feaf4a39937cb1b5a2088a6f"/>
<!-- 修改组织机构的width-->
<script type="text/javascript">
    $(function () {
        $("#PROJECT_ID_SHOW").next().css("left", "137px");
        editDadtAuthStyle();
    });
...
*/
    ...
    function doStop() {
        ...
        var url = "${path}buss/bussModel_exeFunc.ms?funcMId=56318a3d165d4a03ae101faeb29d8df6";
        ...
        if (formId == 'b376f2a126f2414d81c63507a3c699c0') {<%--工单信息--%>
            $.each(uiTxt, function (i, v) {
                ...
                if ($("#" + formId).find(".left-datagrid-title-ajax").length > 0) {
                    ...
                    arrLeftHtml.push("<input type='checkbox' name='" + formId + "$ID' value='" + v.ID + "' class='isSubmit _selectdata'  id='check_" + v.ID + "' style='cursor: pointer;margin:0'>");
                    arrLeftHtml.push("</td>");
                } else {
                ...
                /*
                arrHtml.push("<td colno='PROJECT_ID' name='noprintset_PROJECT_ID' class='datagrid-cell  " + ms.tdClass(formId, 'PROJECT_ID') + "' style='text-align:center;width:60px;" + ms.tdStyle(formId, 'PROJECT_ID') + "' " + ms.tdEvent(formId, 'PROJECT_ID') + ">")
              ...
              arrHtml.push("</td>");
              arrHtml.push("<td colno='PROJECT_STATUS' name='noprintset_PROJECT_STATUS' class='datagrid-cell  " + ms.tdClass(formId, 'PROJECT_STATUS') + "' style='text-align:center;width:30px;" + ms.tdStyle(formId, 'PROJECT_STATUS') + "' " + ms.tdEvent(formId, 'PROJECT_STATUS') + ">")
