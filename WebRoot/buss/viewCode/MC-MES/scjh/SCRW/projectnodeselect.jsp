...
<body>
 ...
 <input type="text" name="CHECK_USER" value="" title_name="质检员" />px
       ...
       <div class="datagrid-header dd06">
        ...
        <bu:tr cssClass="datagrid-header-row datagrid-title-ajax" id="datagrid-title-ajax">
           ...
           <!-- <td class="datagrid-cell" style="width:160px; text-align:center;" ><dict:lang value="物料阈值"/></td> -->
            ...
            <td class="datagrid-cell" style="width:200px; text-align:center;" ><dict:lang value="工艺顺序"/></td>
        </bu:tr>
        </tbody>
        </bu:table>
        </div>
       ...
       <div class="datagrid-header dd05">
        ...
        <div class="datagrid-body datagrid-div3 datagrid-body-ajax dd01  scroll5" id="tableDivb827b6c4fede48ee8a411a4866072eae" onscroll="ajaxTableScroll(this,'b827b6c4fede48ee8a411a4866072eae')">
      ...
      success: function(data){
        ...
        if(null != packFeedList){
          for(var i=0;i<packFeedList.length;i++){
            ...
            $("#tbody_tab6 tr:last").append("<td class='datagrid-cell' style='width:200px;text-align: center;'>"+(packFeedList[i].FEED_NUM==null?"":packFeedList[i].FEED_NUM)+"</td>");
            ...
            $("#tbody_tab6 tr:last").append("<td class='datagrid-cell' style='width:200px;text-align: center;'>"+(packFeedList[i].PROCESS_ORDER==null?"":packFeedList[i].PROCESS_ORDER)+"</td></tr>");
