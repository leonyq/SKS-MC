...
<div id="gantEditorTemplates" style="display:none;">
  ...
  <div class="ganttButtonBar noprint">
    <div class="buttons">
    <button onclick="$('#workSpace').trigger('undo.gantt');" class="button textual" title="撤销"> 
     撤销
    </button>
    <span class="ganttButtonSeparator"></span>
    <button onclick="$('#workSpace').trigger('redo.gantt');" class="button textual" title="恢复"> 
      恢复
    </button>
    <span class="ganttButtonSeparator"></span>
    <button onclick="$('#workSpace').trigger('zoomMinus.gantt');" class="button textual" title="日期放大">
     日期放大
    </button>
    <span class="ganttButtonSeparator"></span>
    <button onclick="$('#workSpace').trigger('zoomPlus.gantt');" class="button textual" title="日期缩小">
     日期缩小
    </button>
    <span class="ganttButtonSeparator"></span>
    ...
    <% /* <button onclick="editResources();" class="button textual" title="edit resources">
     ***
    </button> */ %>
      <button onclick="saveGanttOnServer();" class="button textual" title="保存">保存</button>
    </div>
    </div>
  </div>
