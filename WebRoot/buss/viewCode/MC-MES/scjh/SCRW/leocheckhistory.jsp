...
<body>
    <div class="content-in">
        <div class="dlist">
            <div class="hd">
		<bu:func viewId="5ec123c23dc14daf925f32ce22932059" />
            </div>
            <div class="bd">
  ...
  <table class="search_table">
      <bu:search deal_mark="1" viewId="5ec123c23dc14daf925f32ce22932059" /> 
...
<tr>
		...
		<bu:submit viewId="5ec123c23dc14daf925f32ce22932059" />
      <jsp:include page="/plf/page/mesdemo/commCode/commCode.jsp">
           <jsp:param name="modelName" value="VIEW_TYPE_17" />
           <jsp:param name="location" value="beforeJsLoad" />
      </jsp:include>
		<bu:script viewId="5ec123c23dc14daf925f32ce22932059" />
...
<script>
  function doUnPrepare(){
        ...
        $("span[colno='PROJECT_ID']").each(function (){
            ...
            if (curText != null) {
                projectSnArr.push(curText);
            }
        });

        var workOrderSn = projectSnArr.join(",");

        var url = "${path}buss/bussModel_exeFunc.ms?funcMId=cec8e32bab1f43f7a2bab1bb6c9882b4";
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                console.log(data);
                util.closeLoading();
                utilsFp.confirmIcon(2,"","query","", "<dict:lang value="取消备料成功" />",0,"300","");
            },
        ...
        //iframe6
        /*
        document.forms.listForm.action = "${path}buss/bussModel_exeFunc.ms?funcMId=70c0a9c7794e47a5a0aacfd0c76bd23f&workOrderSn=" + workOrderSn;
