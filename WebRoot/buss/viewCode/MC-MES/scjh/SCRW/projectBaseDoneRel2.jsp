...
<div class="content-in">
    <div class="dlist">
        <div class="hd">
            <bu:func viewId="f84785ebaea04470b3e45e9ea41e6121"/>
        </div>
        <div class="bd">
            <div class="search-box">
                <form id="searchForm" name="searchForm" action="${path}buss/bussModel.ms" method="post">
                    ...
                    <table class="search_table">
                        <bu:search deal_mark="1" viewId="f84785ebaea04470b3e45e9ea41e6121"/>
            ...
            <form id="listForm" name="listForm" action="${path}buss/bussModel.ms?<s:property value='%{@com.more.fw.core.common.method.ConstantsMc@FUNC_CODE}' />=<s:property value='%{FUNC_CODE}' />" method="post">
                ...
                <input type="hidden" id="subFormIds" name="subFormIds" value='91045f5e1a1047ceadf99b576a9471bb'/>
                                ...
                                <bu:table cssClass="datagrid-htable fixedTable datagrid-div6 datagrid-htable-kz" id="datagrid-htable91045f5e1a1047ceadf99b576a9471bb">
                                    ...
                                    <bu:tr cssClass="datagrid-header-row datagrid-title-ajax" id="datagrid-title-ajax">
                                        ...
                                        <td class="datagrid-cell" style="width:200px;">
                                            <bu:uitn colNo="DATA_AUTH" formId="91045f5e1a1047ceadf99b576a9471bb"/></td>
                                        ...
                                        <td class="datagrid-cell" style="text-align:center;width:100px;">
                                            <bu:uitn colNo="IS_REL" formId="91045f5e1a1047ceadf99b576a9471bb"/></td>
                                        <td class="datagrid-cell" style="text-align:center;width:100px;">
                                            <bu:uitn colNo="IS_REL" formId="91045f5e1a1047ceadf99b576a9471bb"/></td>
                                        <td class="datagrid-cell" style="width:150px;">
                                        ...
                                        <td class="datagrid-cell" style="width:150px;">
                                            <bu:uitn colNo="PRODUCT_STANDARD" formId="91045f5e1a1047ceadf99b576a9471bb"/></td>
                ...
                <div id="printset_div" style="background-color: white;margin-top: 50px;display:none;">
                    ...
                    <div style="height: 390px;overflow:auto;border-top: 1px solid #eaeaea;">
                        <table id="printset_tab" class="basic-table" style="text-align: center;margin-top:10px;">
                            ...
                            <tr>
                                <td style="width: 100px;text-align: right;">
                                    <span>?工单状态（0开立1投产2关结3备料4投料5包装）</span>
                                </td>
                                <td style="padding-left: 5px;">
...
"/>px
                            ...
                            <tr>
                                <td style="width: 100px;text-align: right;">
                                    <span>?工单类别（0未分类，1制造单，2制造单,3其他单据）</span>
                                </td>
                                <td style="padding-left: 5px;">
                ...
                <input type="hidden" name="formPage91045f5e1a1047ceadf99b576a9471bb" id="formPage91045f5e1a1047ceadf99b576a9471bb" value="${formPage91045f5e1a1047ceadf99b576a9471bb}"/>
                <input type="hidden" name="formId" id="formId2" value='91045f5e1a1047ceadf99b576a9471bb'/>
                <div class="panel-ajax datagrid datagrid-div1" id="91045f5e1a1047ceadf99b576a9471bb">
                    <div class="datagrid-div2 datagrid-div6 datagrid-view-ajax" id="datagrid-view-ajax91045f5e1a1047ceadf99b576a9471bb" style="">
                        <div class="datagrid-header">
                            <div class="datagrid-header-inner" id="datagrid-header-inner91045f5e1a1047ceadf99b576a9471bb">
                                <bu:table cssClass="datagrid-htable fixedTable datagrid-div6 datagrid-htable-kz" id="datagrid-htable91045f5e1a1047ceadf99b576a9471bb">
                                    ...
                                    <bu:tr cssClass="datagrid-header-row datagrid-title-ajax" id="datagrid-title-ajax">
                                        ...
                                        <td name="noprintset_REL_PROJECT_ID" class="datagrid-cell">
                                            <bu:uitn colNo="REL_PROJECT_ID" formId="91045f5e1a1047ceadf99b576a9471bb"/></td>
                                    </bu:tr>
                                    </tbody>
                                </bu:table>
                            </div>
                        ...
                        <div class="datagrid-body datagrid-div3 datagrid-body-ajax" id="tableDiv91045f5e1a1047ceadf99b576a9471bb" onscroll="ajaxTableScroll(this,'91045f5e1a1047ceadf99b576a9471bb')">
                            <table class="datagrid-btable fixedTable dblClick" id="datagrid-btable-ajax91045f5e1a1047ceadf99b576a9471bb">
                                <tbody id="tbody_91045f5e1a1047ceadf99b576a9471bb" class="isChilds"></tbody>
                            </table>
                        </div>
                    </div>
                </div>
                <c:if test="${formPage91045f5e1a1047ceadf99b576a9471bb==1}">
                    <div class="center">
                        <s:include value="/plf/page/fp/paginationPopMultAx.jsp?listDataFn=listChildAjaxTable&formId=91045f5e1a1047ceadf99b576a9471bb&showLoading=0"/>
                    </div>
                </c:if>
...
<bu:submit viewId="f84785ebaea04470b3e45e9ea41e6121"/>
<jsp:include page="/plf/page/mesdemo/commCode/commCode.jsp">
    <jsp:param name="modelName" value="VIEW_TYPE_17"/>
    <jsp:param name="location" value="beforeJsLoad"/>
</jsp:include>
<bu:script viewId="f84785ebaea04470b3e45e9ea41e6121"/>
...
<script>
    ...
    function createTableModel(ms, formId) {
        ...
        if (formId == '91045f5e1a1047ceadf99b576a9471bb') {<%--VOID-工单关联-已关联表单--%>
        ...
        if (formId == '91045f5e1a1047ceadf99b576a9471bb') {<%--VOID-工单关联-当日已处理表单--%>
            $.each(uiTxt, function (i, v) {
                var backgroudColor = (i + 1) % 2 == 0 ? "tr-hover" : "";
                arrHtml.push("<tr class='datagrid-row " + backgroudColor + " " + trClass + "' id='" + v.ID + "' abbr='" + v.ID + "' style='cursor: pointer;" + trStyle + "' " + trEvent + ">");
                arrHtml.push("<input type='hidden' name='ID' value='" + v.ID + "' />");
