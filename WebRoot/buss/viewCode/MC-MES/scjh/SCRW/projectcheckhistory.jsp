...
<body>
    <div class="content-in">
        <div class="dlist">
            <div class="hd">
		<bu:func viewId="eef83916300740dfaa8c6dfa7665afc3" />
            </div>
            <div class="bd">
  ...
  <table class="search_table">
      <bu:search deal_mark="1" viewId="eef83916300740dfaa8c6dfa7665afc3" /> 
		...
		<input type="hidden" id="subRelColIds" name="subRelColIds" value='7417dc87359847f188dbff4cc6310a2e'/>
		<input type="hidden" id="subFormIds" name="subFormIds" value='cc0dce4648de4a599b01d4057a2b2c46'/>
...
<tr>
 ...
 <td style="padding-left: 5px;">
 <input type="text" name="PROJECT_TYPE" value="" title_name="工单类型" />px
 </td>
 </tr>
 <tr>
 ...
 <input type="text" name="REL_NUM" value="" title_name="关联数量" />px
		...
		<bu:submit viewId="eef83916300740dfaa8c6dfa7665afc3" />
      <jsp:include page="/plf/page/mesdemo/commCode/commCode.jsp">
           <jsp:param name="modelName" value="VIEW_TYPE_17" />
           <jsp:param name="location" value="beforeJsLoad" />
      </jsp:include>
		<bu:script viewId="eef83916300740dfaa8c6dfa7665afc3" />
