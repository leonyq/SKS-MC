...
<body style="overflow:auto;">
	...
	<input type="hidden" name="paraMap1@__DATA_COUNT__" value="1" />
		<s:set name="_$viewId" value="'3490333bf4054004a7cc86aa0188a5de'" />
		...
		<td>&nbsp;</td>
			...
			<bu:td cssClass="dec-self" colNo="CHECK_USER" formId="e8615feea3564a5db39792538a2cd754" ><bu:ui colNo="CHECK_USER" formId="e8615feea3564a5db39792538a2cd754" dataId="${dataId}" formIndex="1" /></bu:td>
		</tr>
	</table>
