...
<head>
    <title>
        <dict:lang value="VOID-工单缴库-历史缴库记录"/>
    </title>
...
<div class="content-in">
    <div class="dlist">
        <div class="hd">
            <bu:func viewId="a80fffee166e437b87c6c3304c782ce6"/>
        </div>
        <div class="bd">
            <div class="search-box">
                <form id="searchForm" name="searchForm" action="${path}buss/bussModel.ms" method="post">
                    ...
                    <table class="search_table">
                        <bu:search deal_mark="1" viewId="a80fffee166e437b87c6c3304c782ce6"/>
                    </table>
...
<bu:submit viewId="a80fffee166e437b87c6c3304c782ce6"/>
<jsp:include page="/plf/page/mesdemo/commCode/commCode.jsp">
    <jsp:param name="modelName" value="VIEW_TYPE_17"/>
    <jsp:param name="location" value="beforeJsLoad"/>
</jsp:include>
<bu:script viewId="a80fffee166e437b87c6c3304c782ce6"/>
