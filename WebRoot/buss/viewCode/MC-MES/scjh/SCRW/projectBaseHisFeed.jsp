        ...
        <div class="bd">
            ...
            <form id="listForm" name="listForm" action="${path}buss/bussModel.ms?<s:property value='%{@com.more.fw.core.common.method.ConstantsMc@FUNC_CODE}' />=<s:property value='%{FUNC_CODE}' />" method="post">
                ...
                <div class="panel-ajax datagrid datagrid-div1" id="3796bb26929842d4bce71e39a814b089">
                    <div class="datagrid-div2 datagrid-div6 datagrid-view-ajax" id="datagrid-view-ajax3796bb26929842d4bce71e39a814b089" style="">
                        <div class="datagrid-header">
                            <div class="datagrid-header-inner" id="datagrid-header-inner3796bb26929842d4bce71e39a814b089">
                                <bu:table cssClass="datagrid-htable fixedTable datagrid-div6 datagrid-htable-kz" id="datagrid-htable3796bb26929842d4bce71e39a814b089">
                                    ...
                                    <bu:tr cssClass="datagrid-header-row datagrid-title-ajax" id="datagrid-title-ajax">
                                        ...
                                        <td class="datagrid-cell" style="width:100px; text-align:center">
                                            <bu:uitn colNo="LOT_NUMBER" formId="3796bb26929842d4bce71e39a814b089"/></td>
                                        <td class="datagrid-cell" style="width:100px; text-align:center">
                                      ...
                                      <td class="datagrid-cell" style="width:100px; text-align:center">
                                            <bu:uitn colNo="EDIT_USER" formId="3796bb26929842d4bce71e39a814b089"/></td>
                                      <td class="datagrid-cell" style="width:140px; text-align:center">
                        ...
                        <div class="datagrid-body datagrid-div3 datagrid-body-ajax" id="tableDiv3796bb26929842d4bce71e39a814b089" onscroll="ajaxTableScroll(this,'3796bb26929842d4bce71e39a814b089')">
        ...
        if (formId == '3796bb26929842d4bce71e39a814b089') {<%--VOID-投料基础表单--%>
            $.each(uiTxt, function (i, v) {
                ...
                */
                ...
                arrHtml.push("</td>");
                arrHtml.push("<td colno='LOT_NUMBER' name='noprintset_LOT_NUMBER' class='datagrid-cell  " + ms.tdClass(formId, 'LOT_NUMBER') + "' style='width:100px;text-align:center;" + ms.tdStyle(formId, 'LOT_NUMBER') + "' " + ms.tdEvent(formId, 'LOT_NUMBER') + ">");
