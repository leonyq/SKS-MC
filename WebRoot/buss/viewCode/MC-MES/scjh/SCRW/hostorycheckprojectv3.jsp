...
<head>
    <title>
		<dict:lang value="LEO-质检-历史质检version1.3" />
    </title>
    ...
    <%@ include file="/plf/page/common/buss/listCommJs.jsp"%>
		<bu:header formId ="14dc9c8db0594d89a9a59a3055136619"/>
...
<body>
    <div class="content-in">
        <div class="dlist">
            <div class="hd">
		<bu:func viewId="e6bc7114d1bc4e318a028dafa8f5593b" />
            </div>
            <div class="bd">
  ...
  <table class="search_table">
      <bu:search deal_mark="1" viewId="e6bc7114d1bc4e318a028dafa8f5593b" /> 
		...
		<input type="hidden" name="formPage14dc9c8db0594d89a9a59a3055136619" id="formPage14dc9c8db0594d89a9a59a3055136619" value="${formPage14dc9c8db0594d89a9a59a3055136619}"/>
		<input type="hidden" name="formId" id="formId1" value='14dc9c8db0594d89a9a59a3055136619'/>
		<input type="hidden" id="subRelColIds" name="subRelColIds" value='null'/>
		<input type="hidden" id="subFormIds" name="subFormIds" value='null'/>
		<div class="panel-ajax datagrid datagrid-div1"  id="14dc9c8db0594d89a9a59a3055136619">
		<div class="datagrid-div2 datagrid-div6 datagrid-view-ajax" id="datagrid-view-ajax14dc9c8db0594d89a9a59a3055136619" style="">
		<div class="datagrid-header">
		<div class="datagrid-header-inner" id="datagrid-header-inner14dc9c8db0594d89a9a59a3055136619">
		<bu:table cssClass="datagrid-htable fixedTable datagrid-div6 datagrid-htable-kz" id="datagrid-htable14dc9c8db0594d89a9a59a3055136619">
		<s:set name="_$type" value="'view'" />
		<tbody class="isParentsTitle">
		<bu:tr cssClass="datagrid-header-row datagrid-title-ajax" id="datagrid-title-ajax">
			<td class="datagrid-cell" name="noprintset_SEQ" style="width:30px; text-align:center;" ><bu:thSeq  formId="14dc9c8db0594d89a9a59a3055136619" i18n="1"/></td>
			<td class="datagrid-cell no-print" style="width:30px; text-align:center;display:none;"><span><input type="checkbox" id="selectAll_14dc9c8db0594d89a9a59a3055136619" onclick="_selectAjaxTableAllData(this,'14dc9c8db0594d89a9a59a3055136619')" style="cursor: pointer;"title="全选"/></span></td>
			...
			<td name="noprintset_PROJECT_ID" class="datagrid-cell" style="width:70px; text-align:center"><bu:uitn colNo="PROJECT_ID" formId="14dc9c8db0594d89a9a59a3055136619" /></td>
			<td name="noprintset_T2#PROJECT_STATUS" class="datagrid-cell" style="width:70px; text-align:center"><bu:uitn colNo="T2#PROJECT_STATUS" formId="14dc9c8db0594d89a9a59a3055136619" /></td>
			<td name="noprintset_T2#LOT_NUMBER" class="datagrid-cell" style="width:70px; text-align:center"><bu:uitn colNo="T2#LOT_NUMBER" formId="14dc9c8db0594d89a9a59a3055136619" /></td>
			<td name="noprintset_T2#PRODUCT_MATERIAL" class="datagrid-cell" style="width:70px; text-align:center"><bu:uitn colNo="T2#PRODUCT_MATERIAL" formId="14dc9c8db0594d89a9a59a3055136619" /></td>
			<td name="noprintset_T2#PRODUCT_NAME" class="datagrid-cell" style="width:70px; text-align:center"><bu:uitn colNo="T2#PRODUCT_NAME" formId="14dc9c8db0594d89a9a59a3055136619" /></td>
			<td name="noprintset_T2#PRODUCT_COUNT" class="datagrid-cell" style="width:70px; text-align:center"><bu:uitn colNo="T2#PRODUCT_COUNT" formId="14dc9c8db0594d89a9a59a3055136619" /></td>
			<td name="noprintset_T2#FINISH_COUNT" class="datagrid-cell" style="width:70px; text-align:center"><bu:uitn colNo="T2#FINISH_COUNT" formId="14dc9c8db0594d89a9a59a3055136619" /></td>
			<td name="noprintset_CHECK_STATUS" class="datagrid-cell" style="width:70px; text-align:center"><bu:uitn colNo="CHECK_STATUS" formId="14dc9c8db0594d89a9a59a3055136619" /></td>
			<td name="noprintset_QT_MON" class="datagrid-cell" style="width:70px; text-align:center"><bu:uitn colNo="QT_MON" formId="14dc9c8db0594d89a9a59a3055136619" /></td>
			<td name="noprintset_CHECK_USER" class="datagrid-cell" style="width:70px; text-align:center"><bu:uitn colNo="CHECK_USER" formId="14dc9c8db0594d89a9a59a3055136619" /></td>
			<td name="noprintset_EDIT_TIME" class="datagrid-cell" style="width:70px; text-align:center"><bu:uitn colNo="EDIT_TIME" formId="14dc9c8db0594d89a9a59a3055136619" /></td>
		...
		<div class="datagrid-body datagrid-div3 datagrid-body-ajax" id="tableDiv14dc9c8db0594d89a9a59a3055136619" onscroll="ajaxTableScroll(this,'14dc9c8db0594d89a9a59a3055136619')">
		<table class="datagrid-btable fixedTable dblClick"  id="datagrid-btable-ajax14dc9c8db0594d89a9a59a3055136619">
		<tbody id="tbody_14dc9c8db0594d89a9a59a3055136619" class="isParents">
		</tbody>
		</table>		</div>
		</div>
		</div>
		<c:if test="${formPage14dc9c8db0594d89a9a59a3055136619==1}">			<div class="center">
			<s:include value="/plf/page/fp/paginationPopMultAx.jsp?listDataFn=listAjaxTable&formId=14dc9c8db0594d89a9a59a3055136619&showLoading=0" />
			</div>
		</c:if>
 ...
 <button type="button" onclick="printset_17('14dc9c8db0594d89a9a59a3055136619','1');">打印</button>
 </div>
 </div>
 ...
 <input type="text" name="T2#FINISH_COUNT" value="" title_name="收货数量" />px
		...
		<bu:submit viewId="e6bc7114d1bc4e318a028dafa8f5593b" />
      <jsp:include page="/plf/page/mesdemo/commCode/commCode.jsp">
           <jsp:param name="modelName" value="VIEW_TYPE_17" />
           <jsp:param name="location" value="beforeJsLoad" />
      </jsp:include>
		<bu:script viewId="e6bc7114d1bc4e318a028dafa8f5593b" />
...
function createTableModel(ms,formId){
    ...
    if(formId=='14dc9c8db0594d89a9a59a3055136619'){<%--LEO-质检-历史表--%>
