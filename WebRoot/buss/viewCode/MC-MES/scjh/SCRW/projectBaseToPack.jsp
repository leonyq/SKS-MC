...
<head>
    <title>
        <dict:lang value="VOID-产品包装-当日待处理"/>
    </title>
    ...
    <bu:header formId="3ed22e0bef7744dcb3ea955b7bb638fb"/>
    <jsp:include page="/plf/page/mesdemo/commCode/commCode.jsp">
        <jsp:param name="modelName" value="VIEW_TYPE_17"/>
...
<div class="content-in">
    <div class="dlist">
        <div class="hd">
            <bu:func viewId="5913d63991444fd59b3631b91ec691b4"/>
        </div>
        <div class="bd">
            <div class="search-box">
                <form id="searchForm" name="searchForm" action="${path}buss/bussModel.ms" method="post">
                    ...
                    <bu:search viewId="5913d63991444fd59b3631b91ec691b4"/>
            ...
            <form id="listForm" name="listForm" action="${path}buss/bussModel.ms" method="post">
                ...
                <input type="hidden" name="formPage3ed22e0bef7744dcb3ea955b7bb638fb" id="formPage3ed22e0bef7744dcb3ea955b7bb638fb" value="${formPage3ed22e0bef7744dcb3ea955b7bb638fb}"/>
                <input type="hidden" name="formId" id="formId1" value='3ed22e0bef7744dcb3ea955b7bb638fb'/>
                ...
                <div class="panel-ajax datagrid datagrid-div1" id="3ed22e0bef7744dcb3ea955b7bb638fb">
                    <div class="datagrid-div2 datagrid-div6 datagrid-view-ajax" id="datagrid-view-ajax3ed22e0bef7744dcb3ea955b7bb638fb" style="">
                        <div class="datagrid-header">
                            <div class="datagrid-header-inner" id="datagrid-header-inner3ed22e0bef7744dcb3ea955b7bb638fb">
                                <bu:table cssClass="datagrid-htable fixedTable datagrid-div6 datagrid-htable-kz" id="datagrid-htable3ed22e0bef7744dcb3ea955b7bb638fb">
                                    <s:set name="_$type" value="'view'"/>
                                    <tbody class="isParentsTitle">
                                    <bu:tr cssClass="datagrid-header-row datagrid-title-ajax" id="datagrid-title-ajax">
                                        <td class="datagrid-cell" style="width:30px; text-align:center;">
                                            <bu:thSeq formId="3ed22e0bef7744dcb3ea955b7bb638fb" i18n="1"/></td>
                                        <td class="datagrid-cell" style="width:30px; text-align:center;">
                                            <!-- <span><input  type="checkbox" id="selectAll_3ed22e0bef7744dcb3ea955b7bb638fb" onclick="_selectAjaxTableAllData(this,'3ed22e0bef7744dcb3ea955b7bb638fb')" style="cursor: pointer;" title="全选"/></span>-->
                                        </td>
                                        <!-- <td class="datagrid-cell" style="width:200px;">
                                        <bu:uitn colNo="DATA_AUTH" formId="3ed22e0bef7744dcb3ea955b7bb638fb"/></td>-->
                                        ...
                                        <td class="datagrid-cell" style="text-align:center;width:100px;">
                                            <bu:uitn colNo="PROJECT_STATUS" formId="3ed22e0bef7744dcb3ea955b7bb638fb"/></td>
                                        <!-- <td class="datagrid-cell" style="text-align:center;width:100px;">
                                        <bu:uitn colNo="IS_REL" formId="3ed22e0bef7744dcb3ea955b7bb638fb"/></td>--> <!-- <td class="datagrid-cell" style="width:150px;">
                                        ...
                                        <bu:uitn colNo="PRODUCT_STANDARD" formId="3ed22e0bef7744dcb3ea955b7bb638fb"/></td>-->

                                        <td class="datagrid-cell" style="text-align:center;width:100px;">
                                            <bu:uitn colNo="PRODUCT_COUNT" formId="3ed22e0bef7744dcb3ea955b7bb638fb"/></td>
                                        <td class="datagrid-cell" style="text-align:center;width:100px;">
                                            <bu:uitn colNo="PROJECT_SORT" formId="3ed22e0bef7744dcb3ea955b7bb638fb"/></td>
                                        <%--
                                       <td class="datagrid-cell" style="width:110px;">
                                           <bu:uitn colNo="FAI_NUM" formId="3ed22e0bef7744dcb3ea955b7bb638fb"/></td>
                                       <td class="datagrid-cell" style="width:70px;">
                                           <bu:uitn colNo="FQC_COUNT" formId="3ed22e0bef7744dcb3ea955b7bb638fb"/></td>
                                       <td class="datagrid-cell" style="width:70px;">
                                           <bu:uitn colNo="FINISH_COUNT" formId="3ed22e0bef7744dcb3ea955b7bb638fb"/></td>
                                       <td class="datagrid-cell" style="width:140px;">
                                           <bu:uitn colNo="PROLEPSIS_START_DATE" formId="3ed22e0bef7744dcb3ea955b7bb638fb"/></td>
                                       <td class="datagrid-cell" style="width:140px;">
                                           <bu:uitn colNo="PROLEPSIS_END_DATE" formId="3ed22e0bef7744dcb3ea955b7bb638fb"/></td>
                                       <td class="datagrid-cell" style="width:150px;">
                                           <bu:uitn colNo="CUST_CODE" formId="3ed22e0bef7744dcb3ea955b7bb638fb"/></td>
                                       <td class="datagrid-cell" style="width:150px;">
                                           <bu:uitn colNo="DESTROY_NO" formId="3ed22e0bef7744dcb3ea955b7bb638fb"/></td>
                                       --%>
                                        <td class="datagrid-cell" style="text-align:center;width:100px;">
                                            <bu:uitn colNo="CREATE_USER" formId="3ed22e0bef7744dcb3ea955b7bb638fb"/></td>
                                        <td class="datagrid-cell" style="text-align:center;width:140px;">
                                            <bu:uitn colNo="CREATE_TIME" formId="3ed22e0bef7744dcb3ea955b7bb638fb"/></td>
                                        <td class="datagrid-cell" style="text-align:center;width:140px;">
                                            <bu:uitn colNo="EDIT_TIME" formId="3ed22e0bef7744dcb3ea955b7bb638fb"/></td>
                                    </bu:tr>
                                    </tbody>
                                </bu:table>
                            </div>
                        </div>
                        <div class="datagrid-body datagrid-div3 datagrid-body-ajax" id="tableDiv3ed22e0bef7744dcb3ea955b7bb638fb" onscroll="ajaxTableScroll(this,'3ed22e0bef7744dcb3ea955b7bb638fb')">
                            <table class="datagrid-btable fixedTable dblClick" id="datagrid-btable-ajax3ed22e0bef7744dcb3ea955b7bb638fb">
                                <tbody id="tbody_3ed22e0bef7744dcb3ea955b7bb638fb" class="isParents"></tbody>
                            </table>
                        </div>
                    </div>
                </div>
                <c:if test="${formPage3ed22e0bef7744dcb3ea955b7bb638fb==1}">
                <div class="center">
                    <s:include value="/plf/page/fp/paginationPopMultAx.jsp?listDataFn=listAjaxTable&formId=3ed22e0bef7744dcb3ea955b7bb638fb&showLoading=0"/>
                </div>
                </c:if>
        </div>
...
<bu:submit viewId="5913d63991444fd59b3631b91ec691b4"/>

<bu:script viewId="5913d63991444fd59b3631b91ec691b4"/>
<!-- 修改组织机构的width-->
...
<script>
    ...
    function createTableModel(ms, formId) {
        ...
        if (formId == '3ed22e0bef7744dcb3ea955b7bb638fb') {<%--工单信息--%>
            $.each(uiTxt, function (i, v) {
                ...
                if ($("#" + formId).find(".left-datagrid-title-ajax").length > 0) {
                    arrLeftHtml.push("<tr onclick='chgCheckTr(this);' class='datagrid-row " + backgroudColor + " " + trClass + "' id='" + v.ID + "' abbr='" + v.ID + "' style='cursor: pointer;" + trStyle + "' " + trEvent + ">");
                    ...
                    arrLeftHtml.push("<input type='checkbox' name='" + formId + "$ID' value='" + v.ID + "' class='isSubmit _selectdata tui-checkbox' onchange='chgCheck(this);' style='cursor: pointer;margin:0'>");
                    arrLeftHtml.push("</td>");
                } else {
                    arrHtml.push("<input type='hidden' name='ID' value='" + v.ID + "' />");
                    arrHtml.push("<td class='datagrid-cell' style='width:30px;text-align:center;' ><span class='_noedit'>" + v._SEQ + "</span></td>");
                    arrHtml.push("<td class='' style='width:30px;text-align:center;' ><span class='_noedit'>");
                    arrHtml.push("<input type='checkbox' name='" + formId + "$ID' value='" + v.ID + "' class='isSubmit _selectdata tui-checkbox' onchange='chgCheck(this);' style='cursor: pointer;margin:0'>");
                    arrHtml.push("</td>");
                }
                ...
                arrHtml.push("<td colno='PROJECT_STATUS' class='datagrid-cell " + ms.tdClass(formId, 'PROJECT_STATUS') + "' style='text-align:center;width:100px;" + ms.tdStyle(formId, 'PROJECT_STATUS') + "' " + ms.tdEvent(formId, 'PROJECT_STATUS') + ">");
                ...
                arrHtml.push("<span colno='PRODUCT_MATERIAL' class='" + ms.uiClass(formId, 'PRODUCT_MATERIAL') + "' style='" + ms.uiStyle(formId, 'PRODUCT_MATERIAL') + "' " + ms.uiEvent(formId, 'PRODUCT_MATERIAL') + " title='" + v['PRODUCT_MATERIAL'] + "' >" + v['PRODUCT_MATERIAL'] + "</span>");
                arrHtml.push("</td>");
                ...
                arrHtml.push("<td colno='PROJECT_SORT' class='datagrid-cell " + ms.tdClass(formId, 'PROJECT_SORT') + "' style='width:100px;text-align:center;" + ms.tdStyle(formId, 'PROJECT_SORT') + "' " + ms.tdEvent(formId, 'PROJECT_SORT') + ">");
                arrHtml.push("<span colno='PROJECT_SORT' class='" + ms.uiClass(formId, 'PROJECT_SORT') + "' style='" + ms.uiStyle(formId, 'PROJECT_SORT') + "' " + ms.uiEvent(formId, 'PROJECT_SORT') + " >" + v['PROJECT_SORT'] + "</span>");
                arrHtml.push("</td>");
                /*
                ...
                arrHtml.push("</td>");
                */
                arrHtml.push("<td colno='CREATE_USER' class='datagrid-cell " + ms.tdClass(formId, 'CREATE_USER') + "' style='width:100px;text-align:center;" + ms.tdStyle(formId, 'CREATE_USER') + "' " + ms.tdEvent(formId, 'CREATE_USER') + ">");
