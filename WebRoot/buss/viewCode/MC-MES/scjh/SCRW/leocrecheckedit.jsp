...
<body>
    <div class="content-in">
        <div class="dlist">
            <div class="hd">
		<bu:func viewId="e48ba40a9bd049e5945b1be921d2327e" />
            </div>
            <div class="bd">
  ...
  <table class="search_table">
      <bu:search deal_mark="1" viewId="e48ba40a9bd049e5945b1be921d2327e" /> 
		...
		<input type="hidden" id="subRelColIds" name="subRelColIds" value='3302b1a25fad4586bb687dfedf9412d2,7417dc87359847f188dbff4cc6310a2e'/>
		<input type="hidden" id="subFormIds" name="subFormIds" value='b36254ac37e74240b1528d44627b6a84,cc0dce4648de4a599b01d4057a2b2c46'/>
		...
		<bu:tr cssClass="datagrid-header-row datagrid-title-ajax" id="datagrid-title-ajax">
			...
			<td class="datagrid-cell no-print" style="width:30px; text-align:center"><span><input type="checkbox" id="selectAll_606ab631c74a4689ac10de3e9f0843c3" onclick="_selectAjaxTableAllData(this,'606ab631c74a4689ac10de3e9f0843c3')" style="cursor: pointer;"title="全选"/></span></td>
			  <td class="datagrid-cell" style="width:200px;">
                                        ...
                                        <td class="datagrid-cell" style="text-align:center;width:90px;">
                                            <bu:uitn colNo="CHECK_USER" formId="606ab631c74a4689ac10de3e9f0843c3"/></td>
                                        <td class="datagrid-cell" style="text-align:center;width:140px;">
 ...
 <tr>
		...
		<input type="hidden" name="formPagecc0dce4648de4a599b01d4057a2b2c46" id="formPagecc0dce4648de4a599b01d4057a2b2c46" value="${formPagecc0dce4648de4a599b01d4057a2b2c46}"/>
		<input type="hidden" name="formId" id="formId2" value='cc0dce4648de4a599b01d4057a2b2c46'/>
		<div class="panel-ajax datagrid datagrid-div1"  id="cc0dce4648de4a599b01d4057a2b2c46" style="display:none">
		<div class="datagrid-div2 datagrid-div6 datagrid-view-ajax" id="datagrid-view-ajaxcc0dce4648de4a599b01d4057a2b2c46" style="">
		<div class="datagrid-header">
		<div class="datagrid-header-inner" id="datagrid-header-innercc0dce4648de4a599b01d4057a2b2c46">
		<bu:table cssClass="datagrid-htable fixedTable datagrid-div6 datagrid-htable-kz" id="datagrid-htablecc0dce4648de4a599b01d4057a2b2c46">
		<s:set name="_$type" value="'view'" />
		<tbody class="isChildsTitle">
		<bu:tr cssClass="datagrid-header-row datagrid-title-ajax" id="datagrid-title-ajax">
			<td class="datagrid-cell" name="noprintset_SEQ" style="width:30px; text-align:center;" ><bu:thSeq  formId="cc0dce4648de4a599b01d4057a2b2c46" i18n="1"/></td>
			<td class="datagrid-cell no-print" style="width:30px; text-align:center"><span><input type="checkbox" id="selectAll_cc0dce4648de4a599b01d4057a2b2c46" onclick="_selectAjaxTableAllData(this,'cc0dce4648de4a599b01d4057a2b2c46')" style="cursor: pointer;"title="全选"/></span></td>
			
          <td name="noprintset_PROJECT_ID" class="datagrid-cell"><bu:uitn colNo="PROJECT_ID" formId="cc0dce4648de4a599b01d4057a2b2c46" /></td>
			<td name="noprintset_LOT_NUMBER" class="datagrid-cell"><bu:uitn colNo="LOT_NUMBER" formId="cc0dce4648de4a599b01d4057a2b2c46" /></td>
			<td name="noprintset_CHECK_USER" class="datagrid-cell"><bu:uitn colNo="CHECK_USER" formId="cc0dce4648de4a599b01d4057a2b2c46" /></td>
			
			
			<td name="noprintset_CHECK_MON" class="datagrid-cell"><bu:uitn colNo="CHECK_MON" formId="cc0dce4648de4a599b01d4057a2b2c46" /></td>
			
			<td name="noprintset_PM_MEMO" class="datagrid-cell"><bu:uitn colNo="PM_MEMO" formId="cc0dce4648de4a599b01d4057a2b2c46" /></td>
		...
		<div class="datagrid-body datagrid-div3 datagrid-body-ajax" id="tableDivcc0dce4648de4a599b01d4057a2b2c46" onscroll="ajaxTableScroll(this,'cc0dce4648de4a599b01d4057a2b2c46')">
		<table class="datagrid-btable fixedTable dblClick"  id="datagrid-btable-ajaxcc0dce4648de4a599b01d4057a2b2c46">
		<tbody id="tbody_cc0dce4648de4a599b01d4057a2b2c46" class="isChilds">
		</tbody>
		</table>		</div>
		</div>
		</div>
		...
		<c:if test="${formPagecc0dce4648de4a599b01d4057a2b2c46==1}">			<div class="center" id="timecc0dce4648de4a599b01d4057a2b2c46" style="display:none;">
			<s:include value="/plf/page/fp/paginationPopMultAx.jsp?listDataFn=listChildAjaxTable&formId=cc0dce4648de4a599b01d4057a2b2c46&showLoading=0" />
			</div>
		</c:if>
 ...
 <div class="hd" style="background-color: #f6f5f7;height: 35px;">
 <div class="optn" style="top:45px;right:30px;">
 <button type="button" onclick="printset_17('cc0dce4648de4a599b01d4057a2b2c46','1');">打印</button>
 </div>
 </div>
 <div style="height: 390px;overflow:auto;border-top: 1px solid #eaeaea;">
 <table id="printset_tab" class="basic-table" style="text-align: center;margin-top:10px;">
 ...
 <tr>
 <td style="width: 100px;text-align: right;"><span>?质检结果</span></td>
 <td style="padding-left: 5px;">
 <input type="checkbox" name="PM_CHECK_STUST" value="1" checked="checked" />
 </td>
 <td style="padding-left: 5px;">
 <input type="text" name="PM_CHECK_STUST" value="" title_name="?质检结果" />px
 </td>
 </tr>
 <tr>
 ...
 <tr>
 <td style="width: 100px;text-align: right;"><span>?dom表</span></td>
 <td style="padding-left: 5px;">
 <input type="checkbox" name="PM_MEMO" value="1" checked="checked" />
 </td>
 <td style="padding-left: 5px;">
 <input type="text" name="PM_MEMO" value="" title_name="?dom表" />px
 </td>
 </tr>
 <tr>
 ...
 <input type="text" name="REL_NUM" value="" title_name="关联数量" />px
		...
		<bu:submit viewId="e48ba40a9bd049e5945b1be921d2327e" />
      <jsp:include page="/plf/page/mesdemo/commCode/commCode.jsp">
           <jsp:param name="modelName" value="VIEW_TYPE_17" />
           <jsp:param name="location" value="beforeJsLoad" />
      </jsp:include>
		<bu:script viewId="e48ba40a9bd049e5945b1be921d2327e" />
...
<script>
    ...
    function itemJump2() {
        $("#cc0dce4648de4a599b01d4057a2b2c46").css({"display": "block"});
       // $("#timecc0dce4648de4a599b01d4057a2b2c46").css({"display": "block"});
    }
...
function createTableModel(ms,formId){
    ...
    if(formId=='606ab631c74a4689ac10de3e9f0843c3'){<%--LEO-品质检测基础表--%>
        $.each(uiTxt,function(i,v){
           ...
           arrHtml.push("<tr onclick='itemJump2()' class='datagrid-row " + backgroudColor + " " + trClass + "' id='" + v.ID + "' abbr='" + v.ID + "' style='cursor: pointer;" + trStyle + "' " + trEvent + ">");
               ...
               arrHtml.push("<td colno='DATA_AUTH' name='noprintset_DATA_AUTH' class='datagrid-cell TD_DATA_AUTH " + ms.tdClass(formId, 'DATA_AUTH') + "' style='width:200px;text-align:center;" + ms.tdStyle(formId, 'DATA_AUTH') + "' " + ms.tdEvent(formId, 'DATA_AUTH') + ">");
                ...
                arrHtml.push("</td>");
      			arrHtml.push("<td onclick='itemJump3()' colno='PM_CHECK_STUST' name='noprintset_PM_CHECK_STUSTT' class='datagrid-cell  " + ms.tdClass(formId, 'PM_CHECK_STUST') + "' style='text-align:center;width:70px;" + ms.tdStyle(formId, 'PM_CHECK_STUST') + "' " + ms.tdEvent(formId, 'PM_CHECK_STUST') + ">");
    ...
    if(formId=='cc0dce4648de4a599b01d4057a2b2c46'){<%--LEO-质检待处理表--%>
        $.each(uiTxt,function(i,v){
            var backgroudColor = (i+1)%2 == 0 ? "tr-hover" : "";
