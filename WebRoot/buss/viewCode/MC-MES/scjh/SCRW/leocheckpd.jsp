...
<head>
	...
	<title><dict:lang value="质检提审" /></title>
...
<body style="overflow:auto;">
	...
	<form id="editForm" name="editForm" action="${path}buss/bussModel_editAjaxComm.ms" method="post" target="submitFrame"
		...
		<bu:set name="paraMapObj" value="${dataId}" formId="cc0dce4648de4a599b01d4057a2b2c46" type="edit" />
	...
	<input type="hidden" name="paraMap1@__DATA_COUNT__" value="1" />
		<s:set name="_$viewId" value="'16239ef51d4f443291fa33615936083b'" />
		<s:set name="_$formId_1" value="'cc0dce4648de4a599b01d4057a2b2c46'" />
		<s:set name="_$type" value="'edit'"/>
       <tr>
			<td class="name-six" /><bu:uitn colNo="PROJECT_STATUS" formId="cc0dce4648de4a599b01d4057a2b2c46"  /></td>
			<bu:td cssClass="dec-self" colNo="PROJECT_STATUS" formId="cc0dce4648de4a599b01d4057a2b2c46" ><bu:ui colNo="PROJECT_STATUS" formId="cc0dce4648de4a599b01d4057a2b2c46" value="%{PROJECT_STATUS}" formIndex="1" /></bu:td>
		</tr>
		...
		<div class="mod" >
			<div class="mod-hd"> 
				<h3 class="tit"><dict:lang value="质检明细" /></h3>
					...
					<div class="datagrid-div2 datagrid-div6 datagrid-view"   >
						<div class="datagrid-header" >
							<div class="datagrid-header-inner" id="datagrid-header-inner15e21142e45540ef9a80862e8c2a56b6">
								<bu:addSub formid="cc0dce4648de4a599b01d4057a2b2c46" formIndex="2"  selfformid="15e21142e45540ef9a80862e8c2a56b6" hidecol=""  viewid="" />
							</div>
						</div>
...
getEditRows("15e21142e45540ef9a80862e8c2a56b6","2","cc0dce4648de4a599b01d4057a2b2c46","","3fd0c1209e2640e88706f4d18376411a","");
...
<script type="text/javascript">
 ...
 $(function () {
  ...
  function initParam() {
        ...
        $("#paraMapObj_PROJECT_STATUS").val("6");
    	
        $("#paraMapObj_PROJECT_STATUS_chosen").find("span").html("质检");
    	$("#paraMapObj_PROJECT_STATUS_chosen").attr("readonly","readonly");
    }
