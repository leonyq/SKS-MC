...
<head>
    <title>
        <dict:lang value="VOID-工单缴库-今日待缴库"/>
    </title>
...
<div class="content-in">
    <div class="dlist">
        <div class="hd">
            <bu:func viewId="436cb66eed6444539e6c94ff127805d7"/>
        </div>
        <div class="bd">
            <div class="search-box">
                <form id="searchForm" name="searchForm" action="${path}buss/bussModel.ms" method="post">
                    ...
                    <table class="search_table">
                        <bu:search deal_mark="1" viewId="436cb66eed6444539e6c94ff127805d7"/>
                    </table>
                </form>
                            ...
                            <div class="datagrid-header-inner" id="datagrid-header-inner2c88768c86a3467f901210be05a180a9">
                                <bu:table cssClass="datagrid-htable fixedTable datagrid-div6 datagrid-htable-kz" id="datagrid-htable2c88768c86a3467f901210be05a180a9">
                                    ...
                                    <bu:tr cssClass="datagrid-header-row datagrid-title-ajax" id="datagrid-title-ajax">
                                        ...
                                        <td name="noprintset_DATA_AUTH" style="width:200px; text-align:center" class="datagrid-cell">
...
<bu:submit viewId="436cb66eed6444539e6c94ff127805d7"/>
<jsp:include page="/plf/page/mesdemo/commCode/commCode.jsp">
    <jsp:param name="modelName" value="VIEW_TYPE_17"/>
    <jsp:param name="location" value="beforeJsLoad"/>
</jsp:include>
<bu:script viewId="436cb66eed6444539e6c94ff127805d7"/>
...
<script type="text/javascript">
    ...
    // var url = "http://10.10.80.193:8018/mc/http/interface.ms?model=ProjectPostPackIntfImpl&method=sync";
    var url = "http://localhost:8018/mc/http/interface.ms?model=ProjectPostPackIntfImpl&method=sync";
