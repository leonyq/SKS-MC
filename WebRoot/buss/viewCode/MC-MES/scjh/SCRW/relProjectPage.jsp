                ...
                success: function (data) {
                    ...
                    //获取页面上的最后一个tr
                      ...
                      if(projectSort != 2){
         				...
         				utilsFp.confirmIcon(3, "", "doFocus", "", "<dict:lang value="必须先关联包装单！！！"/>", 0, "300", "");                         
       					return ;
                    ...
                    /*
                     if(projectSort == 2 || projectSort == "" || projectSort == null){  
                        boolean = 0;
                		utilsFp.confirmIcon(3, "", "", "", "<dict:lang value="无法关联其他包装单！！！"/>", 0, "300", "");
