        ...
        <div class="hd">
            ...
            <div class="optn">
                <!--     <button type="button" onclick="edit(this);"><i class="ico ico-save"></i><dict:lang value="保存" /></button>
                            <button type="button" onclick="indow();" ><i class="ico ico-cancel"></i><dict:lang value="取消" /></button>
        ...
        <div class="bd">
                                ...
                                <table class="glxb-table" style="width:100%" id="addTable_5a4ae0bc729d430dac8d2d784e4687c5" >
                                    ...
                                    <c:forEach var="item" items="${dataList}" varStatus="status">
                                        <tr>
                                            ...
                                            <td id="WARE_HOUSE_${status.count}" class='datagrid-cell datagrid-cell-3' style="width:150px;">${item.ITEM_WARE_HOUSE}</td>
            ...
            <script>
                ...
                $(function(){
                    ...
                    $("#paraMapObj_FINISH_COUNT").val(productCount);
                    tableInfo();
                    checkFinashCount();
  ...
  ;
            ...
            error: function (XMLHttpRequest, textStatus, errorThrown) {
                ...
                function  packsave1(){
                    ...
                    console.log("itemnumArr>>>>>>>>>" +itemnumArr);
                    console.log("itemspecArr>>>>>>>>>" +itemspecArr);
