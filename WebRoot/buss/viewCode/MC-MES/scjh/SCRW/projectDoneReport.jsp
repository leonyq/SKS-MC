...
<head>
    <title>
        <dict:lang value="VOID-工时报工-今日已报工"/>
    </title>
...
<div class="content-in">
    <div class="dlist">
        <div class="hd">
            <bu:func viewId="6a83f1a3ef7b4e669c94395ce64799c3"/>
        </div>
        <div class="bd">
            <div class="search-box">
                <form id="searchForm" name="searchForm" action="${path}buss/bussModel.ms" method="post">
                    ...
                    <table class="search_table">
                        <bu:search deal_mark="1" viewId="6a83f1a3ef7b4e669c94395ce64799c3"/>
                    </table>
                                ...
                                <bu:table cssClass="datagrid-htable fixedTable datagrid-div6 datagrid-htable-kz" id="datagrid-htable426d60fe64314fb0b97a38b40090f10d">
                                    ...
                                    <bu:tr cssClass="datagrid-header-row datagrid-title-ajax" id="datagrid-title-ajax">
                                        ...
                                        <td style="width:140px; text-align:center" name="noprintset_EDIT_TIME" class="datagrid-cell">
                                            <bu:uitn colNo="EDIT_TIME" formId="426d60fe64314fb0b97a38b40090f10d"/></td>
                                        <td style="width:100px; text-align:center" name="noprintset_EDIT_USER" class="datagrid-cell">
                                            <bu:uitn colNo="EDIT_USER" formId="426d60fe64314fb0b97a38b40090f10d"/></td>
                                    </bu:tr>
                                    </tbody>
                                </bu:table>
                            </div>
...
<bu:submit viewId="6a83f1a3ef7b4e669c94395ce64799c3"/>
<jsp:include page="/plf/page/mesdemo/commCode/commCode.jsp">
    <jsp:param name="modelName" value="VIEW_TYPE_17"/>
    <jsp:param name="location" value="beforeJsLoad"/>
</jsp:include>
<bu:script viewId="6a83f1a3ef7b4e669c94395ce64799c3"/>
    ...
    function createTableModel(ms, formId) {
        ...
        if (formId == '426d60fe64314fb0b97a38b40090f10d') {<%--VOID-工时报工表单--%>
            $.each(uiTxt, function (i, v) {
                ...
                arrHtml.push("</td>");
                arrHtml.push("<td colno='REP_NUM' name='noprintset_REP_NUM' class='datagrid-cell  " + ms.tdClass(formId, 'REP_NUM') + "' style='text-align:right" + ms.tdStyle(formId, 'REP_NUM') + "' " + ms.tdEvent(formId, 'REP_NUM') + ">");
                arrHtml.push("<span colno='REP_NUM' class='" + ms.uiClass(formId, 'REP_NUM') + "' style='text-align:right" + ms.uiStyle(formId, 'REP_NUM') + "' " + ms.uiEvent(formId, 'REP_NUM') + " title='" + ms.titleAttr(formId, 'REP_NUM', 'IS_TITLE_ATTR', v) + "' >" + v['REP_NUM'] + "</span>");
                arrHtml.push("</td>");
                arrHtml.push("<td colno='PROJECT_UNIT' name='noprintset_PROJECT_UNIT' class='datagrid-cell  " + ms.tdClass(formId, 'PROJECT_UNIT') + "' style='text-align:center" + ms.tdStyle(formId, 'PROJECT_UNIT') + "' " + ms.tdEvent(formId, 'PROJECT_UNIT') + ">");
                arrHtml.push("<span colno='PROJECT_UNIT' class='" + ms.uiClass(formId, 'PROJECT_UNIT') + "' style='text-align:center" + ms.uiStyle(formId, 'PROJECT_UNIT') + "' " + ms.uiEvent(formId, 'PROJECT_UNIT') + " title='" + ms.titleAttr(formId, 'PROJECT_UNIT', 'IS_TITLE_ATTR', v) + "' >" + v['PROJECT_UNIT'] + "</span>");
                arrHtml.push("</td>");
                arrHtml.push("<td colno='PREPARE_TIME' name='noprintset_PREPARE_TIME' class='datagrid-cell  " + ms.tdClass(formId, 'PREPARE_TIME') + "' style='text-align:center" + ms.tdStyle(formId, 'PREPARE_TIME') + "' " + ms.tdEvent(formId, 'PREPARE_TIME') + ">");
                arrHtml.push("<span colno='PREPARE_TIME' class='" + ms.uiClass(formId, 'PREPARE_TIME') + "' style='text-align:center" + ms.uiStyle(formId, 'PREPARE_TIME') + "' " + ms.uiEvent(formId, 'PREPARE_TIME') + " title='" + ms.titleAttr(formId, 'PREPARE_TIME', 'IS_TITLE_ATTR', v) + "' >" + v['PREPARE_TIME'] + "</span>");
                arrHtml.push("</td>");
                arrHtml.push("<td colno='MEASURE_UNIT1' name='noprintset_MEASURE_UNIT1' class='datagrid-cell  " + ms.tdClass(formId, 'MEASURE_UNIT1') + "' style='text-align:center" + ms.tdStyle(formId, 'MEASURE_UNIT1') + "' " + ms.tdEvent(formId, 'MEASURE_UNIT1') + ">");
                arrHtml.push("<span colno='MEASURE_UNIT1' class='" + ms.uiClass(formId, 'MEASURE_UNIT1') + "' style='text-align:center" + ms.uiStyle(formId, 'MEASURE_UNIT1') + "' " + ms.uiEvent(formId, 'MEASURE_UNIT1') + " title='" + ms.titleAttr(formId, 'MEASURE_UNIT1', 'IS_TITLE_ATTR', v) + "' >" + v['MEASURE_UNIT1'] + "</span>");
                arrHtml.push("</td>");
                arrHtml.push("<td colno='MACHINE_TIME' name='noprintset_MACHINE_TIME' class='datagrid-cell  " + ms.tdClass(formId, 'MACHINE_TIME') + "' style='text-align:center" + ms.tdStyle(formId, 'MACHINE_TIME') + "' " + ms.tdEvent(formId, 'MACHINE_TIME') + ">");
                arrHtml.push("<span colno='MACHINE_TIME' class='" + ms.uiClass(formId, 'MACHINE_TIME') + "' style='text-align:center" + ms.uiStyle(formId, 'MACHINE_TIME') + "' " + ms.uiEvent(formId, 'MACHINE_TIME') + " title='" + ms.titleAttr(formId, 'MACHINE_TIME', 'IS_TITLE_ATTR', v) + "' >" + v['MACHINE_TIME'] + "</span>");
                arrHtml.push("</td>");
                arrHtml.push("<td colno='MEASURE_UNIT2' name='noprintset_MEASURE_UNIT2' class='datagrid-cell  " + ms.tdClass(formId, 'MEASURE_UNIT2') + "' style='text-align:center" + ms.tdStyle(formId, 'MEASURE_UNIT2') + "' " + ms.tdEvent(formId, 'MEASURE_UNIT2') + ">");
                arrHtml.push("<span colno='MEASURE_UNIT2' class='" + ms.uiClass(formId, 'MEASURE_UNIT2') + "' style='text-align:center" + ms.uiStyle(formId, 'MEASURE_UNIT2') + "' " + ms.uiEvent(formId, 'MEASURE_UNIT2') + " title='" + ms.titleAttr(formId, 'MEASURE_UNIT2', 'IS_TITLE_ATTR', v) + "' >" + v['MEASURE_UNIT2'] + "</span>");
                arrHtml.push("</td>");
                arrHtml.push("<td colno='PEOPLE_TIME' name='noprintset_PEOPLE_TIME' class='datagrid-cell  " + ms.tdClass(formId, 'PEOPLE_TIME') + "' style='text-align:center" + ms.tdStyle(formId, 'PEOPLE_TIME') + "' " + ms.tdEvent(formId, 'PEOPLE_TIME') + ">");
                arrHtml.push("<span colno='PEOPLE_TIME' class='" + ms.uiClass(formId, 'PEOPLE_TIME') + "' style='text-align:center" + ms.uiStyle(formId, 'PEOPLE_TIME') + "' " + ms.uiEvent(formId, 'PEOPLE_TIME') + " title='" + ms.titleAttr(formId, 'PEOPLE_TIME', 'IS_TITLE_ATTR', v) + "' >" + v['PEOPLE_TIME'] + "</span>");
                arrHtml.push("</td>");
                arrHtml.push("<td colno='MEASURE_TIME3' name='noprintset_MEASURE_TIME3' class='datagrid-cell  " + ms.tdClass(formId, 'MEASURE_TIME3') + "' style='text-align:center" + ms.tdStyle(formId, 'MEASURE_TIME3') + "' " + ms.tdEvent(formId, 'MEASURE_TIME3') + ">");
                arrHtml.push("<span colno='MEASURE_TIME3' class='" + ms.uiClass(formId, 'MEASURE_TIME3') + "' style='text-align:center" + ms.uiStyle(formId, 'MEASURE_TIME3') + "' " + ms.uiEvent(formId, 'MEASURE_TIME3') + " title='" + ms.titleAttr(formId, 'MEASURE_TIME3', 'IS_TITLE_ATTR', v) + "' >" + v['MEASURE_TIME3'] + "</span>");
                arrHtml.push("</td>");
                arrHtml.push("<td colno='FINISH_DATE' name='noprintset_FINISH_DATE' class='datagrid-cell  " + ms.tdClass(formId, 'FINISH_DATE') + "' style='text-align:center" + ms.tdStyle(formId, 'FINISH_DATE') + "' " + ms.tdEvent(formId, 'FINISH_DATE') + ">");
                arrHtml.push("<span colno='FINISH_DATE' class='" + ms.uiClass(formId, 'FINISH_DATE') + "' style='text-align:center" + ms.uiStyle(formId, 'FINISH_DATE') + "' " + ms.uiEvent(formId, 'FINISH_DATE') + " title='" + ms.titleAttr(formId, 'FINISH_DATE', 'IS_TITLE_ATTR', v) + "' >" + v['FINISH_DATE'] + "</span>");
                arrHtml.push("</td>");
                arrHtml.push("<td colno='REVERSE_FLAG' name='noprintset_REVERSE_FLAG' class='datagrid-cell  " + ms.tdClass(formId, 'REVERSE_FLAG') + "' style='text-align:center" + ms.tdStyle(formId, 'REVERSE_FLAG') + "' " + ms.tdEvent(formId, 'REVERSE_FLAG') + ">");
                arrHtml.push("<span colno='REVERSE_FLAG' class='" + ms.uiClass(formId, 'REVERSE_FLAG') + "' style='text-align:center" + ms.uiStyle(formId, 'REVERSE_FLAG') + "' " + ms.uiEvent(formId, 'REVERSE_FLAG') + " title='" + ms.titleAttr(formId, 'REVERSE_FLAG', 'IS_TITLE_ATTR', v) + "' >" + v['REVERSE_FLAG'] + "</span>");
                arrHtml.push("</td>");
    ...
    function createTableModel_print(ms, formId) {
        ...
        if (formId == '426d60fe64314fb0b97a38b40090f10d') {<%--VOID-工时报工表单--%>
            $.each(uiTxt, function (i, v) {
                ...
                arrHtml.push("<span colno='PROJECT_ID' class='" + ms.uiClass(formId, 'PROJECT_ID') + "' style='text-align:center" + ms.uiStyle(formId, 'PROJECT_ID') + "' " + ms.uiEvent(formId, 'PROJECT_ID') + " title='" + ms.titleAttr(formId, 'PROJECT_ID', 'IS_TITLE_ATTR', v) + "' >" + v['PROJECT_ID'] + "</span>");
                arrHtml.push("</td>");
                arrHtml.push("<td colno='REP_NUM' name='noprintset_REP_NUM' class='datagrid-cell " + ms.tdClass(formId, 'REP_NUM') + "' style='text-align:center" + ms.tdStyle(formId, 'REP_NUM') + "' " + ms.tdEvent(formId, 'REP_NUM') + ">");
                arrHtml.push("<span colno='REP_NUM' class='" + ms.uiClass(formId, 'REP_NUM') + "' style='text-align:center" + ms.uiStyle(formId, 'REP_NUM') + "' " + ms.uiEvent(formId, 'REP_NUM') + " title='" + ms.titleAttr(formId, 'REP_NUM', 'IS_TITLE_ATTR', v) + "' >" + v['REP_NUM'] + "</span>");
                arrHtml.push("</td>");
                arrHtml.push("<td colno='PROJECT_UNIT' name='noprintset_PROJECT_UNIT' class='datagrid-cell " + ms.tdClass(formId, 'PROJECT_UNIT') + "' style='text-align:center" + ms.tdStyle(formId, 'PROJECT_UNIT') + "' " + ms.tdEvent(formId, 'PROJECT_UNIT') + ">");
                arrHtml.push("<span colno='PROJECT_UNIT' class='" + ms.uiClass(formId, 'PROJECT_UNIT') + "' style='text-align:center" + ms.uiStyle(formId, 'PROJECT_UNIT') + "' " + ms.uiEvent(formId, 'PROJECT_UNIT') + " title='" + ms.titleAttr(formId, 'PROJECT_UNIT', 'IS_TITLE_ATTR', v) + "' >" + v['PROJECT_UNIT'] + "</span>");
                arrHtml.push("</td>");
