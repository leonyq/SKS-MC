...
<head>
 <title>
  <dict:lang value="VOID-生产备料-当日待备料"/>
 </title>
...
<div class="content-in">
 <div class="dlist">
  <div class="hd">
   <bu:func viewId="388a55b6b6244ad68007565f98ae6237"/>
  </div>
  <div class="bd">
   <div class="search-box">
    <form id="searchForm" name="searchForm" action="${path}buss/bussModel.ms" method="post">
     ...
     <table class="search_table">
      <bu:search deal_mark="1" viewId="388a55b6b6244ad68007565f98ae6237"/>
   ...
   <form id="listForm" name="listForm" action="${path}buss/bussModel.ms?<s:property value='%{@com.more.fw.core.common.method.ConstantsMc@FUNC_CODE}' />=<s:property value='%{FUNC_CODE}' />" method="post">
    ...
    <input type="hidden" name="formId" id="formId2" value='b376f2a126f2414d81c63507a3c699c0'/>
       ...
       <div class="datagrid-header-inner" id="datagrid-header-innerf76584409e4a476381f8d66c3ec36d5c">
        <bu:table cssClass="datagrid-htable fixedTable datagrid-div6 datagrid-htable-kz" id="datagrid-htablef76584409e4a476381f8d66c3ec36d5c">
         ...
         <bu:tr cssClass="datagrid-header-row datagrid-title-ajax" id="datagrid-title-ajax">
          ...
          <bu:uitn colNo="DATA_AUTH" formId="f76584409e4a476381f8d66c3ec36d5c"/></td> <td class="datagrid-cell" style="width:150px;">
          <bu:uitn colNo="PROJECT_ID" formId="f76584409e4a476381f8d66c3ec36d5c"/></td> <td class="datagrid-cell" style="text-align:center;width:70px;">
          <bu:uitn colNo="PROJECT_STATUS" formId="f76584409e4a476381f8d66c3ec36d5c"/></td> <td class="datagrid-cell" style="text-align:center;width:100px;">
          <bu:uitn colNo="IS_REL" formId="f76584409e4a476381f8d66c3ec36d5c"/></td> <td class="datagrid-cell" style="text-align:center;width:70px;">
          <bu:uitn colNo="PROJECT_SORT" formId="f76584409e4a476381f8d66c3ec36d5c"/></td> <td class="datagrid-cell" style="width:150px;">
          <bu:uitn colNo="PRODUCT_MATERIAL" formId="f76584409e4a476381f8d66c3ec36d5c"/></td> <td class="datagrid-cell" style="width:150px;">
          <bu:uitn colNo="PRODUCT_NAME" formId="f76584409e4a476381f8d66c3ec36d5c"/></td> <td class="datagrid-cell" style="width:150px;">
          <bu:uitn colNo="PRODUCT_STANDARD" formId="f76584409e4a476381f8d66c3ec36d5c"/></td> <td class="datagrid-cell" style="width:70px;">
          <bu:uitn colNo="PRODUCT_COUNT" formId="f76584409e4a476381f8d66c3ec36d5c"/></td>--> <!-- <td class="datagrid-cell" style="width:70px">
...
<bu:submit viewId="388a55b6b6244ad68007565f98ae6237"/>
<jsp:include page="/plf/page/mesdemo/commCode/commCode.jsp">
 <jsp:param name="modelName" value="VIEW_TYPE_17"/>
 <jsp:param name="location" value="beforeJsLoad"/>
</jsp:include>
<bu:script viewId="388a55b6b6244ad68007565f98ae6237"/>
...
<script>
    ...
    function getAllItem() {
        ...
        if ($("#selectAll_f76584409e4a476381f8d66c3ec36d5c").attr("checked") == "checked") {
            ...
            $("#tbody_f76584409e4a476381f8d66c3ec36d5c:checkbox").prop('checked','true');
        } else {
    ...
    function doPrepare() {
        ...
        ${path}buss/bussModel_exeFunc.ms?funcMId=5628aaa64fe74dbcbe58287c82c800f4&workOrderSn=" + workOrderSn;
    ...
    function createTableModel(ms, formId) {
        ...
        if (formId == 'f76584409e4a476381f8d66c3ec36d5c') {<%--VOID-工单关联-历史关联列表--%>
            $.each(uiTxt, function (i, v) {
                ...
                arrHtml.push("<td class=' no-print' style='width:30px;text-align:center;' ><span class='_noedit'>");
                arrHtml.push("<input  type='checkbox' name='" + formId + "$ID' id ='check_" + v.ID + "' value='" + v.ID + "' class='isSubmit _selectdata' style='cursor: pointer;margin:0'>");
                arrHtml.push("</td>");
                /*
                ...
                arrHtml.push("</td>");
                /*arrHtml.push("<td colno='PM_MEMO' name='noprintset_PM_MEMO' class='datagrid-cell  " + ms.tdClass(formId, 'PM_MEMO') + "' style='text-align:center;width:70px;" + ms.tdStyle(formId, 'PM_MEMO') + "' " + ms.tdEvent(formId, 'PM_MEMO') + ">")
