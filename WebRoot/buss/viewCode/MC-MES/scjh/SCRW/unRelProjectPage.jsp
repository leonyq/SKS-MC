...
<div class="edit">
    <form id="addForm" name="addForm" action="${path}buss/bussModel.ms?" method="post"
        ...
        <div class="hd">
            ...
            <div class="optn">
                <button type="button" onclick="userSave();"><i class="ico ico-save"></i><dict:lang value="确认解绑"/></button>
...
<script type="text/javascript">
    ...
    function userSave() {
        ...
        document.forms.addForm.action = "${path}buss/bussModel_exeFunc.ms?funcMId=83a8a68800b74fc69cd8d861f067fd2e&workOrderSn=" + sn;
