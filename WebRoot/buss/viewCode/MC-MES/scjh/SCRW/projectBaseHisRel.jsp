...
<head>
    <title>
        <dict:lang value="VOID-工单关联-历史处理记录"/>
    </title>
    ...
    <bu:header formId="5e9d1bd881af4f1492a0f4e9388e83fb"/>
...
<div class="content-in">
    <div class="dlist">
        <div class="hd">
            <bu:func viewId="c53f96ae9b10421197c742d5865f90d5"/>
        </div>
        <div class="bd">
            <div class="search-box">
                <form id="searchForm" name="searchForm" action="${path}buss/bussModel.ms" method="post">
                    ...
                    <table class="search_table">
                        <bu:search deal_mark="1" viewId="c53f96ae9b10421197c742d5865f90d5"/>
            ...
            <form id="listForm" name="listForm" action="${path}buss/bussModel.ms?<s:property value='%{@com.more.fw.core.common.method.ConstantsMc@FUNC_CODE}' />=<s:property value='%{FUNC_CODE}' />" method="post">
                ...
                <input type="hidden" name="formPage5e9d1bd881af4f1492a0f4e9388e83fb" id="formPage5e9d1bd881af4f1492a0f4e9388e83fb" value="${formPage5e9d1bd881af4f1492a0f4e9388e83fb}"/>
                <input type="hidden" name="formId" id="formId1" value='5e9d1bd881af4f1492a0f4e9388e83fb'/>
                <input type="hidden" id="subRelColIds" name="subRelColIds" value='null'/>
                <input type="hidden" id="subFormIds" name="subFormIds" value='null'/>
                <div class="panel-ajax datagrid datagrid-div1" id="5e9d1bd881af4f1492a0f4e9388e83fb">
                    <div class="datagrid-div2 datagrid-div6 datagrid-view-ajax" id="datagrid-view-ajax5e9d1bd881af4f1492a0f4e9388e83fb" style="">
                        <div class="datagrid-header">
                            <div class="datagrid-header-inner" id="datagrid-header-inner5e9d1bd881af4f1492a0f4e9388e83fb">
                                <bu:table cssClass="datagrid-htable fixedTable datagrid-div6 datagrid-htable-kz" id="datagrid-htable5e9d1bd881af4f1492a0f4e9388e83fb">
                                    <s:set name="_$type" value="'view'"/>
                                    <tbody class="isParentsTitle">
                                    <bu:tr cssClass="datagrid-header-row datagrid-title-ajax" id="datagrid-title-ajax">
                                        <td class="datagrid-cell" name="noprintset_SEQ" style="width:30px; text-align:center;">
                                            <bu:thSeq formId="5e9d1bd881af4f1492a0f4e9388e83fb" i18n="1"/></td>
                                        <td class="datagrid-cell" style="width:30px; text-align:center">
                                            <span><input type="checkbox" id="selectAll_5e9d1bd881af4f1492a0f4e9388e83fb" onclick="_selectAjaxTableAllData(this,'5e9d1bd881af4f1492a0f4e9388e83fb')" style="cursor: pointer;" title="全选"/></span>
                                        </td>
                                        <%--
                                        <td name="noprintset_DATA_AUTH" class="datagrid-cell">
                                            <bu:uitn colNo="DATA_AUTH" formId="5e9d1bd881af4f1492a0f4e9388e83fb"/></td>
                                        <td name="noprintset_PROJECT_ID" class="datagrid-cell">
                                            <bu:uitn colNo="PROJECT_ID" formId="5e9d1bd881af4f1492a0f4e9388e83fb"/></td>
                                        <td name="noprintset_REL_PROJECT_ID" class="datagrid-cell">
                                            <bu:uitn colNo="REL_PROJECT_ID" formId="5e9d1bd881af4f1492a0f4e9388e83fb"/></td>
                                        <td name="noprintset_CREATE_USER" class="datagrid-cell">
                                            <bu:uitn colNo="CREATE_USER" formId="5e9d1bd881af4f1492a0f4e9388e83fb"/></td>
                                        <td name="noprintset_CREATE_TIME" class="datagrid-cell">
                                            <bu:uitn colNo="CREATE_TIME" formId="5e9d1bd881af4f1492a0f4e9388e83fb"/></td>
                                        --%>
                        ...
                        <div class="datagrid-body datagrid-div3 datagrid-body-ajax" id="tableDiv5e9d1bd881af4f1492a0f4e9388e83fb" onscroll="ajaxTableScroll(this,'5e9d1bd881af4f1492a0f4e9388e83fb')">
                            <table class="datagrid-btable fixedTable dblClick" id="datagrid-btable-ajax5e9d1bd881af4f1492a0f4e9388e83fb">
                                <tbody id="tbody_5e9d1bd881af4f1492a0f4e9388e83fb" class="isParents"></tbody>
                            </table>
                        </div>
                    </div>
                </div>

                <c:if test="${formPage5e9d1bd881af4f1492a0f4e9388e83fb==1}">

                    <div class="center">
                        <s:include value="/plf/page/fp/paginationPopMultAx.jsp?listDataFn=listAjaxTable&formId=5e9d1bd881af4f1492a0f4e9388e83fb&showLoading=0"/>
                    </div>
                </c:if>
                ...
                <div id="printset_div" style="background-color: white;margin-top: 50px;display:none;">
                    <div class="hd" style="background-color: #f6f5f7;height: 35px;">
                        <div class="optn" style="top:45px;right:30px;">
                            <button type="button" onclick="printset_17('5e9d1bd881af4f1492a0f4e9388e83fb','1');">打印</button>
                        </div>
                    </div>
...
<bu:submit viewId="c53f96ae9b10421197c742d5865f90d5"/>
<jsp:include page="/plf/page/mesdemo/commCode/commCode.jsp">
    <jsp:param name="modelName" value="VIEW_TYPE_17"/>
    <jsp:param name="location" value="beforeJsLoad"/>
</jsp:include>
<bu:script viewId="c53f96ae9b10421197c742d5865f90d5"/>
...
<script>
    ...
    function createTableModel(ms, formId) {
        ...
        if (formId == '5e9d1bd881af4f1492a0f4e9388e83fb') {<%--工单关联表单--%>
