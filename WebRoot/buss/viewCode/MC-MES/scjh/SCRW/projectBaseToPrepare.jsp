...
<head>
 <title>
  <dict:lang value="VOID-生产备料-当日待处理"/>
 </title>
 ...
 <bu:header formId="4c4614db1eb6437fa57513fc9df965a6"/>
 <jsp:include page="/plf/page/mesdemo/commCode/commCode.jsp">
  <jsp:param name="modelName" value="VIEW_TYPE_17"/>
...
<div class="content-in">
 <div class="dlist">
  <div class="hd">
   <bu:func viewId="13ca92c7906447da9cd0a3bd773775b4"/>
  </div>
  <div class="bd">
   <div class="search-box">
    <form id="searchForm" name="searchForm" action="${path}buss/bussModel.ms" method="post">
     ...
     <bu:search viewId="13ca92c7906447da9cd0a3bd773775b4"/>
   ...
   <form id="listForm" name="listForm" action="${path}buss/bussModel.ms" method="post">
    ...
    <input type="hidden" name="formPage4c4614db1eb6437fa57513fc9df965a6" id="formPage4c4614db1eb6437fa57513fc9df965a6" value="${formPage4c4614db1eb6437fa57513fc9df965a6}"/>
    <input type="hidden" name="formId" id="formId1" value='4c4614db1eb6437fa57513fc9df965a6'/>
    ...
    <div class="panel-ajax datagrid datagrid-div1" id="4c4614db1eb6437fa57513fc9df965a6">
     <div class="datagrid-div2 datagrid-div6 datagrid-view-ajax" id="datagrid-view-ajax4c4614db1eb6437fa57513fc9df965a6" style="">
      <div class="datagrid-header">
       <div class="datagrid-header-inner" id="datagrid-header-inner4c4614db1eb6437fa57513fc9df965a6">
        <bu:table cssClass="datagrid-htable fixedTable datagrid-div6 datagrid-htable-kz" id="datagrid-htable4c4614db1eb6437fa57513fc9df965a6" style="min-width:2030px;">
         <s:set name="_$type" value="'view'"/>
         <tbody class="isParentsTitle">
         <bu:tr cssClass="datagrid-header-row datagrid-title-ajax" id="datagrid-title-ajax">
          <td class="datagrid-cell" style="width:30px; text-align:center;">
           <bu:thSeq formId="4c4614db1eb6437fa57513fc9df965a6" i18n="1"/></td>
          <td class="datagrid-cell" style="width:30px; text-align:center">
           <span><input type="checkbox" id="selectAll_4c4614db1eb6437fa57513fc9df965a6" onclick="_selectAjaxTableAllData(this,'4c4614db1eb6437fa57513fc9df965a6')" style="cursor: pointer;" title="全选"/></span>
          </td>
          <td class="datagrid-cell" style="width:200px;">
           <bu:uitn colNo="DATA_AUTH" formId="4c4614db1eb6437fa57513fc9df965a6"/></td>
          <td class="datagrid-cell" style="width:150px;">
           <bu:uitn colNo="PROJECT_ID" formId="4c4614db1eb6437fa57513fc9df965a6"/></td>
          <td class="datagrid-cell" style="text-align:center;width:70px;">
           <bu:uitn colNo="PROJECT_STATUS" formId="4c4614db1eb6437fa57513fc9df965a6"/></td>
          <td class="datagrid-cell" style="text-align:center;width:100px;">
           <bu:uitn colNo="IS_REL" formId="4c4614db1eb6437fa57513fc9df965a6"/></td>
          <td class="datagrid-cell" style="width:150px;">
           <bu:uitn colNo="PRODUCT_MATERIAL" formId="4c4614db1eb6437fa57513fc9df965a6"/></td>
          <td class="datagrid-cell" style="width:150px;">
           <bu:uitn colNo="PRODUCT_NAME" formId="4c4614db1eb6437fa57513fc9df965a6"/></td>
          <td class="datagrid-cell" style="width:150px;">
           <bu:uitn colNo="PRODUCT_STANDARD" formId="4c4614db1eb6437fa57513fc9df965a6"/></td>
          <td class="datagrid-cell" style="width:70px;">
           <bu:uitn colNo="PRODUCT_COUNT" formId="4c4614db1eb6437fa57513fc9df965a6"/></td>
          <td class="datagrid-cell" style="width:90px;">
           <bu:uitn colNo="CREATE_USER" formId="4c4614db1eb6437fa57513fc9df965a6"/></td>
          <td class="datagrid-cell" style="width:140px;">
           <bu:uitn colNo="CREATE_TIME" formId="4c4614db1eb6437fa57513fc9df965a6"/></td>
          <td class="datagrid-cell" style="width:140px;">
           <bu:uitn colNo="EDIT_TIME" formId="4c4614db1eb6437fa57513fc9df965a6"/></td>
         </bu:tr>
         </tbody>
        </bu:table>
       </div>
      </div>
      <div class="datagrid-body datagrid-div3 datagrid-body-ajax" id="tableDiv4c4614db1eb6437fa57513fc9df965a6" onscroll="ajaxTableScroll(this,'4c4614db1eb6437fa57513fc9df965a6')">
       <table class="datagrid-btable fixedTable dblClick" id="datagrid-btable-ajax4c4614db1eb6437fa57513fc9df965a6" style="min-width:2030px;">
        <tbody id="tbody_4c4614db1eb6437fa57513fc9df965a6" class="isParents"></tbody>
       </table>
      </div>
     </div>
    </div>
    <c:if test="${formPage4c4614db1eb6437fa57513fc9df965a6==1}">
    <div class="center">
     <s:include value="/plf/page/fp/paginationPopMultAx.jsp?listDataFn=listAjaxTable&formId=4c4614db1eb6437fa57513fc9df965a6&showLoading=0"/>
    </div>
    </c:if>
  </div>
...
<bu:submit viewId="13ca92c7906447da9cd0a3bd773775b4"/>

<bu:script viewId="13ca92c7906447da9cd0a3bd773775b4"/>
<script type="text/javascript">

    function doPrepare(){
        var projectSnArr = new Array();

        $("td[colno='PROJECT_ID']").each(function (){
        ...
        var url = "${path}buss/bussModel_exeFunc.ms?funcMId=ce20983aad8449a5930d2647b8e728a1";
        $.ajax({
            type: "POST",
            dataType: "json",
            url: url,
    ...
    function listChildAjaxTable(formId, paramList){
      console.log("this is listChildAjaxTable function: >>> ");
    }
...
<script>
    ...
    function createTableModel(ms, formId) {
        ...
        if (formId == '4c4614db1eb6437fa57513fc9df965a6') {<%--工单信息--%>
