...
<head>
    ...
    <%@ include file="/plf/page/common/buss/listCommJs.jsp"%>
		<bu:header formId ="6cf6a04ac1934fb7a9db0886b0fc9ffd"/>
...
<body>
    <div class="content-in">
        <div class="dlist">
            <div class="hd">
		<bu:func viewId="fd88d985fe37473eba6a8a9360cba9d5" />
            </div>
            <div class="bd">
  ...
  <table class="search_table">
      <bu:search deal_mark="1" viewId="fd88d985fe37473eba6a8a9360cba9d5" /> 
		...
		<input type="hidden" name="formPage6cf6a04ac1934fb7a9db0886b0fc9ffd" id="formPage6cf6a04ac1934fb7a9db0886b0fc9ffd" value="${formPage6cf6a04ac1934fb7a9db0886b0fc9ffd}"/>
		<input type="hidden" name="formId" id="formId1" value='6cf6a04ac1934fb7a9db0886b0fc9ffd'/>
		<input type="hidden" id="subRelColIds" name="subRelColIds" value='null'/>
		<input type="hidden" id="subFormIds" name="subFormIds" value='null'/>
		<div class="panel-ajax datagrid datagrid-div1"  id="6cf6a04ac1934fb7a9db0886b0fc9ffd">
		<div class="datagrid-div2 datagrid-div6 datagrid-view-ajax" id="datagrid-view-ajax6cf6a04ac1934fb7a9db0886b0fc9ffd" style="">
		<div class="datagrid-header">
		<div class="datagrid-header-inner" id="datagrid-header-inner6cf6a04ac1934fb7a9db0886b0fc9ffd">
		<bu:table cssClass="datagrid-htable fixedTable datagrid-div6 datagrid-htable-kz" id="datagrid-htable6cf6a04ac1934fb7a9db0886b0fc9ffd">
		<s:set name="_$type" value="'view'" />
		<tbody class="isParentsTitle">
		<bu:tr cssClass="datagrid-header-row datagrid-title-ajax" id="datagrid-title-ajax">
			<td class="datagrid-cell" name="noprintset_SEQ" style="width:30px; text-align:center;" ><bu:thSeq  formId="6cf6a04ac1934fb7a9db0886b0fc9ffd" i18n="1"/></td>
			<td class="datagrid-cell no-print" style="width:30px; text-align:center;"><span><input class='tui-checkbox' type="checkbox" id="selectAll_6cf6a04ac1934fb7a9db0886b0fc9ffd" onclick="_selectAjaxTableAllData(this,'6cf6a04ac1934fb7a9db0886b0fc9ffd')" style="cursor: pointer;"title="全选"/></span></td> 
			
            <td name="noprintset_DATA_AUTH" class="datagrid-cell" style="display:none"><bu:uitn colNo="DATA_AUTH" formId="6cf6a04ac1934fb7a9db0886b0fc9ffd" /></td>
			<td name="noprintset_PROJECT_ID" class="datagrid-cell" style="width:70px"><bu:uitn colNo="PROJECT_ID" formId="6cf6a04ac1934fb7a9db0886b0fc9ffd" /></td>
            <td name="noprintset_PROJECT_STATUS" class="datagrid-cell" style="width:70px"><bu:uitn colNo="PROJECT_STATUS" formId="6cf6a04ac1934fb7a9db0886b0fc9ffd" /></td>
			<td name="noprintset_LOT_NUMBER" class="datagrid-cell" style="width:70px"><bu:uitn colNo="LOT_NUMBER" formId="6cf6a04ac1934fb7a9db0886b0fc9ffd" /></td>
            <td name="noprintset_PRODUCT_MATERIAL" class="datagrid-cell" style="width:70px"><bu:uitn colNo="PRODUCT_MATERIAL" formId="6cf6a04ac1934fb7a9db0886b0fc9ffd" /></td>
            <td name="noprintset_PRODUCT_NAME" class="datagrid-cell" style="width:70px"><bu:uitn colNo="PRODUCT_NAME" formId="6cf6a04ac1934fb7a9db0886b0fc9ffd" /></td>
            <td name="noprintset_PRODUCT_COUNT" class="datagrid-cell" style="width:70px"><bu:uitn colNo="PRODUCT_COUNT" formId="6cf6a04ac1934fb7a9db0886b0fc9ffd" /></td>
            <td name="noprintset_PROJECT_SORT" class="datagrid-cell" style="width:70px"><bu:uitn colNo="PROJECT_SORT" formId="6cf6a04ac1934fb7a9db0886b0fc9ffd" /></td>
            <td name="noprintset_CREATE_USER" class="datagrid-cell" style="width:70px"><bu:uitn colNo="CREATE_USER" formId="6cf6a04ac1934fb7a9db0886b0fc9ffd" /></td>
            <td name="noprintset_CREATE_TIME" class="datagrid-cell" style="width:70px"><bu:uitn colNo="CREATE_TIME" formId="6cf6a04ac1934fb7a9db0886b0fc9ffd" /></td>
            <td name="noprintset_EDIT_TIME" class="datagrid-cell" style="width:70px"><bu:uitn colNo="EDIT_TIME" formId="6cf6a04ac1934fb7a9db0886b0fc9ffd" /></td>
		</bu:tr>
		</tbody>
		</bu:table>
		</div>
		</div>
		<div class="datagrid-body datagrid-div3 datagrid-body-ajax" id="tableDiv6cf6a04ac1934fb7a9db0886b0fc9ffd" onscroll="ajaxTableScroll(this,'6cf6a04ac1934fb7a9db0886b0fc9ffd')">
		<table class="datagrid-btable fixedTable dblClick"  id="datagrid-btable-ajax6cf6a04ac1934fb7a9db0886b0fc9ffd">
		<tbody id="tbody_6cf6a04ac1934fb7a9db0886b0fc9ffd" class="isParents">
		</tbody>
		</table>		</div>
		</div>
		</div>
		<c:if test="${formPage6cf6a04ac1934fb7a9db0886b0fc9ffd==1}">			<div class="center">
			<s:include value="/plf/page/fp/paginationPopMultAx.jsp?listDataFn=listAjaxTable&formId=6cf6a04ac1934fb7a9db0886b0fc9ffd&showLoading=0" />
			</div>
		</c:if>
 ...
 <button type="button" onclick="printset_17('6cf6a04ac1934fb7a9db0886b0fc9ffd','1');">打印</button>
 </div>
 </div>
 ...
 <tr>
 <td style="width: 100px;text-align: right;"><span>关联状态</span></td>
 <td style="padding-left: 5px;">
 ...
 <input type="text" name="REL_NUM" value="" title_name="关联数量" />px
		...
		<bu:submit viewId="fd88d985fe37473eba6a8a9360cba9d5" />
      <jsp:include page="/plf/page/mesdemo/commCode/commCode.jsp">
           <jsp:param name="modelName" value="VIEW_TYPE_17" />
           <jsp:param name="location" value="beforeJsLoad" />
      </jsp:include>
		<bu:script viewId="fd88d985fe37473eba6a8a9360cba9d5" />
...
function doInsert(){
   var projectSnArr = [];
        ...
        var url = "${path}buss/bussModel_exeFunc.ms?funcMId=c4bc9253993942c7b4ff467b463f8666";
...
<script>
  ...
  /*function chgCheck() {
   ...
   function chgCheckTr(e) {
    ...
    function getAllItem() {
        if ($("#selectAll_6cf6a04ac1934fb7a9db0886b0fc9ffd").attr("checked") == "checked") {
            $("#tbody_6cf6a04ac1934fb7a9db0886b0fc9ffd :checkbox").attr("checked", true);
        } else {
            $("#tbody_6cf6a04ac1934fb7a9db0886b0fc9ffd :checkbox").each(function () {
...
function createTableModel(ms,formId){
    ...
    if(formId=='6cf6a04ac1934fb7a9db0886b0fc9ffd'){<%--LEO-质检待处理表-待质检--%>
        $.each(uiTxt,function(i,v){
            ...
            arrHtml.push("<tr  onclick='chgCheckTr(this);' class='datagrid-row " + backgroudColor + " " + trClass + "' id='" + v.ID + "' abbr='" + v.ID + "' style='cursor: pointer;" + trStyle + "' " + trEvent + ">");
                ...
                arrHtml.push("<input  id='check_"+v.ID+"' type='checkbox' name='" + formId + "$ID' value='" + v.ID + "' class='isSubmit _selectdata tui-checkbox' style='cursor: pointer;margin:0'>");
                arrHtml.push("</td>");
               arrHtml.push("<td colno='DATA_AUTH' name='noprintset_DATA_AUTH' class='datagrid-cell TD_DATA_AUTH " + ms.tdClass(formId, 'DATA_AUTH') + "' style='width:200px;text-align:center;display:none" + ms.tdStyle(formId, 'DATA_AUTH') + "' " + ms.tdEvent(formId, 'DATA_AUTH') + ">");
                arrHtml.push("<span colno='DATA_AUTH' class='" + ms.uiClass(formId, 'DATA_AUTH') + "' style='" + ms.uiStyle(formId, 'DATA_AUTH') + "' " + ms.uiEvent(formId, 'DATA_AUTH') + " title='" + ms.titleAttr(formId, 'DATA_AUTH', 'IS_TITLE_ATTR', v) + "' >" + v['DATA_AUTH'] + "</span>");
                arrHtml.push("</td>");
                arrHtml.push("<td colno='PROJECT_ID' name='noprintset_PROJECT_ID' class='datagrid-cell  " + ms.tdClass(formId, 'PROJECT_ID') + "' style='width:50px;" + ms.tdStyle(formId, 'PROJECT_ID') + "' " + ms.tdEvent(formId, 'PROJECT_ID') + ">");
              ...
              /**  arrHtml.push("<td colno='PROJECT_STATUS' name='noprintset_PROJECT_STATUS' class='datagrid-cell  " + ms.tdClass(formId, 'PROJECT_STATUS') + "' style='text-align:center;width:70px;" + ms.tdStyle(formId, 'PROJECT_STATUS') + "' " + ms.tdEvent(formId, 'PROJECT_STATUS') + ">")
                ...
                arrHtml.push("</td>");
             	arrHtml.push("<td colno='PRODUCT_NAME' name='noprintset_PRODUCT_NAME' class='datagrid-cell  " + ms.tdClass(formId, 'PRODUCT_NAME') + "' style='text-align:center;width:70px;" + ms.tdStyle(formId, 'PRODUCT_NAME') + "' " + ms.tdEvent(formId, 'PRODUCT_NAME') + ">");
                ...
                arrHtml.push("</td>");
                arrHtml.push("<td colno='CREATE_TIME' name='noprintset_CREATE_TIME' class='datagrid-cell  " + ms.tdClass(formId, 'CREATE_TIME') + "' style='text-align:center;width:70px;" + ms.tdStyle(formId, 'CREATE_TIME') + "' " + ms.tdEvent(formId, 'CREATE_TIME') + ">");
                ...
                arrHtml.push("<td colno='EDIT_TIME' name='noprintset_EDIT_TIME' class='datagrid-cell  " + ms.tdClass(formId, 'EDIT_TIME') + "' style='text-align:center;width:70px;" + ms.tdStyle(formId, 'EDIT_TIME') + "' " + ms.tdEvent(formId, 'EDIT_TIME') + ">");
