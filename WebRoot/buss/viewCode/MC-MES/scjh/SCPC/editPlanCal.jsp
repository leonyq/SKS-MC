    ...
    <div class="bd" style="height:534px;">
        ...
        <table class="basic-table" >
            ...
            <tr>
                ...
                <bu:td cssClass="dec" colNo="PPC_AREA_SN" formId="cc3ac92f89ad485caee993047912a29a" ><bu:ui id="col_PPC_AREA_SN" colNo="PPC_AREA_SN" formId="cc3ac92f89ad485caee993047912a29a" dataId="${dataId}" formIndex="1" /></bu:td>

                <td class="name" /><span class="dot">*</span><bu:uitn colNo="PPC_PRODUCT_STEP" formId="cc3ac92f89ad485caee993047912a29a" /></td>
                <bu:td cssClass="dec" colNo="PPC_PRODUCT_STEP" formId="cc3ac92f89ad485caee993047912a29a" ><bu:ui id="col_PPC_PRODUCT_STEP" colNo="PPC_PRODUCT_STEP" formId="cc3ac92f89ad485caee993047912a29a" dataId="${dataId}" formIndex="1" /></bu:td>
            </tr>
            <tr>
                <td class="name" /><bu:uitn colNo="PPC_SAT_FLAG" formId="cc3ac92f89ad485caee993047912a29a" /></td>
                <bu:td cssClass="dec" colNo="PPC_SAT_FLAG" formId="cc3ac92f89ad485caee993047912a29a" ><bu:ui id="col_PPC_SAT_FLAG" colNo="PPC_SAT_FLAG" formId="cc3ac92f89ad485caee993047912a29a" dataId="${dataId}" formIndex="1" onchange="changeWeekDayFlag();"/></bu:td>

                <td class="name" /><bu:uitn colNo="PPC_SUN_FLAG" formId="cc3ac92f89ad485caee993047912a29a" /></td>
                <bu:td cssClass="dec" colNo="PPC_SUN_FLAG" formId="cc3ac92f89ad485caee993047912a29a" ><bu:ui id="col_PPC_SUN_FLAG" colNo="PPC_SUN_FLAG" formId="cc3ac92f89ad485caee993047912a29a" dataId="${dataId}" formIndex="1" onchange="changeWeekDayFlag();"/></bu:td>
            </tr>
            <tr>
                <td class="name" /><bu:uitn colNo="PPC_DEFAULT_FLAG" formId="cc3ac92f89ad485caee993047912a29a" /></td>
                <bu:td cssClass="dec" colNo="PPC_DEFAULT_FLAG" formId="cc3ac92f89ad485caee993047912a29a" ><bu:ui id="col_PPC_DEFAULT_FLAG" colNo="PPC_DEFAULT_FLAG" formId="cc3ac92f89ad485caee993047912a29a" dataId="${dataId}" formIndex="1" /></bu:td>

                <td class="name" /><bu:uitn colNo="PPC_MEMO" formId="cc3ac92f89ad485caee993047912a29a" /></td>
                <bu:td cssClass="dec" colNo="PPC_MEMO" formId="cc3ac92f89ad485caee993047912a29a" ><bu:ui id="col_PPC_MEMO" colNo="PPC_MEMO" formId="cc3ac92f89ad485caee993047912a29a" dataId="${dataId}" formIndex="1" /></bu:td>
            </tr>
        </table>
                ...
                <div class="panel datagrid datagrid-div1">
                    <div class="datagrid-div2 datagrid-div6 datagrid-view"   >
                        ...
                        <div class="datagrid-body datagrid-div3 scroll"  style="height:350px" onscroll="ajaxTableScroll(this,'8e3691f22e2f4d818b3b29cd5972c6e6')" >
                            <table class="glxb-table" style="width:100%;table-layout: fixed;" id="addTable_8e3691f22e2f4d818b3b29cd5972c6e6" >
...
<script>
    ...
    function initUiStatus(){
        dropDownEnable($("#col_PPC_AREA_SN"),false);
        dropDownEnable($("#col_PPC_PRODUCT_STEP"),false);
        //将例外明细中的所有例外时长设置未不可更改
        var duration=$("#tbody_8e3691f22e2f4d818b3b29cd5972c6e6").find("input[id$='PPE_DURATION']");
        if(typeof(duration)!="undefined"){
            for(var i=0,len=duration.length;i<len;i++){
                $(duration[i]).attr("readonly","readonly");
            }
        }
    }
    //消息提示
