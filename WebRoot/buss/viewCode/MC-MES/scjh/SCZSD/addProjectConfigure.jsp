...
<body>
	<div class="edit">
		...
		<bu:set name="paraMapObj" value="${dataId}" formId="89d3363bb50f4d9abd364d9fe2acdc9a" type="add" />
	<div class="mod">
		<div class="mod-hd">
	...
	<input type="hidden" name="paraMap1@__DATA_COUNT__" value="1" />
		<s:set name="_$viewId" value="'95a9773ab18a4913903b59a0074046e7'" />
		...
		<tr>
			...
			<bu:td cssClass="dec" style="width: 200px;" colNo="CO_ITEM_CODE" formId="89d3363bb50f4d9abd364d9fe2acdc9a" ><bu:ui colNo="CO_ITEM_CODE" formId="89d3363bb50f4d9abd364d9fe2acdc9a" value="%{CO_ITEM_CODE}" formIndex="1" /></bu:td>
			...
			<bu:td cssClass="dec" style="width: 200px;" colNo="CO_TEMPLATE_NAME" formId="89d3363bb50f4d9abd364d9fe2acdc9a" ><bu:ui colNo="CO_TEMPLATE_NAME" formId="89d3363bb50f4d9abd364d9fe2acdc9a" value="%{CO_TEMPLATE_NAME}" formIndex="1" /></bu:td>
			<td class="name" style="width: 70px;"/><span class="dot">*</span><bu:uitn colNo="CO_PRODUCT_STEP" formId="89d3363bb50f4d9abd364d9fe2acdc9a" /></td>
			<bu:td cssClass="dec" style="width: 200px;" colNo="CO_PRODUCT_STEP" formId="89d3363bb50f4d9abd364d9fe2acdc9a" ><bu:ui colNo="CO_PRODUCT_STEP" formId="89d3363bb50f4d9abd364d9fe2acdc9a" value="%{CO_PRODUCT_STEP}" formIndex="1" /></bu:td>
			-->
		</tr>
		<tr>
            <td class="name" style="width: 70px;"/><span class="dot">*</span><bu:uitn colNo="CO_TEMPLATE_NAME" formId="89d3363bb50f4d9abd364d9fe2acdc9a" /></td>
    ...
    <script type="text/javascript">
		...
		function addItemList(templateName) {
		    ...
		    if(templateName!=""&&templateName!=null){
    			...
    			var getOutItemUrl = "${path}buss/bussModel_exeFunc.ms?funcMId=36aa3cab6dd948a28a63fa8030b7c2a3";
    			$.ajax({
    				type: "POST",
    				dataType: "json",
    				url: getOutItemUrl,
		...
		function addInfo(){
		    ...
		    if($("#paraMap1_CO_ITEM_CODE_SHOW").val()==""){
            ...
            document.forms.addForm.action = "${path}buss/bussModel_exeFunc.ms?funcMId=22ea9868ff4f41e0b6d8efea01013397";
