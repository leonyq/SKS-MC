    ...
    if(formId=='90caa73200734f6c938d5aa280a9664a'){<%--FEEDER信息--%>
        $.each(uiTxt,function(i,v){
            ...
            if($("#"+formId).find(".left-datagrid-title-ajax").length>0){
                ...
                arrHtml.push("<span colno='TCF_MO_NUMBER' class='"+ms.uiClass(formId, 'TCF_MO_NUMBER')+"' onclick='itemJump1(\""+v['TCF_MO_NUMBER']+"\")' style='display: inline;border-bottom: 1px solid #004098;' "+ms.uiEvent(formId, 'TCF_MO_NUMBER')+" >"+v['TCF_MO_NUMBER']+"</span>")
                arrHtml.push("</td>");
...
//    var formId = $("#formId1").val();
 // var timestamp = Date.parse(new Date());
  //var url = "${path}buss/bussModel.ms?exeid=e7762c0eb62d4894b75db048d6bc8a48&FUNC_CODE=F3734&formId="+formId+"&iframeId="+_currentFrame;
  //showPopWinFp(url, 800, 400,null,"FEEDER维保",timestamp,1);
  winOptMethod.jump("e7762c0eb62d4894b75db048d6bc8a48","F3734","jumpId22",22);
}
...
function itemJump1(obj){
      winOptMethod.jump("e5a8e72f4d3b4564911305406bc40129","F10170","jumpId",obj);
}  
</script>
