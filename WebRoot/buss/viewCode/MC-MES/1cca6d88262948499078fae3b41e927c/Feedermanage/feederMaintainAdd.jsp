...
<body style="">
					...
					<table class="basic-table">
						...
						<tr>
							...
							<bu:td cssClass="dec" colNo="TCF_EC_DES" formId="9fe40c6681484bbdaeeee44cc7fe3c2a">
								<bu:ui colNo="TCF_EC_DES" formId="9fe40c6681484bbdaeeee44cc7fe3c2a" value="%{TCF_EC_DES}" formIndex="1" readonly="readonly" style="width:200px; disabled:disabled;" /></bu:td>
						</tr>
	...
	function searchBySN() {
		...
		$.ajax({
			type: "post",
			dataType: "json",
			url: "${path}buss/bussModel_exeFunc.ms?funcMId=2198861b6bc54be9b9d7081175907c14",//VM-FEEDER保养与维修信息新增 操作功能 getUrl
			data: jsondata,
	...
	function fillBySn(zj,j) {
		...
		function getEcDescUrl(){
            var url="${path}buss/bussModel_exeFunc.ms?funcMId=f4f1fa980d204df1937a84d6bc000cce"; //VM-FEEDER保养与维修信息新增 操作功能 获得不良描述
            //alert(url);
            return url;
            }
		function getUrl(){
            var url="${path}buss/bussModel_exeFunc.ms?funcMId=2198861b6bc54be9b9d7081175907c14"; //VM-FEEDER保养与维修信息新增 操作功能 getUrl
            //alert(url);
            return url;
            }
		function saveMTInfo(){
