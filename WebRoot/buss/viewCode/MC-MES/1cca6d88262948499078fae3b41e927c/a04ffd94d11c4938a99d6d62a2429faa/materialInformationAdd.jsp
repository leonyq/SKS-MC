...
<jsp:param name="modelName" value="VIEW_TYPE_10" />
   <jsp:param name="location" value="addForm" />
	    ...
	    <form id="addForm" name="addForm" action="${path}buss/bussModel_addAjaxComm.ms" method="post" <bu:formet exeid="%{exeid}" /> target="submitFrame">
			    ...
			    <div class="optn">
			        <button type="button" onclick="add(this,'${formId}');"><i class="ico ico-save"></i>保存</button>
			...
			<div class="bd" style="height:600px;" >
				...
				<table class="basic-table" width="100%">
					<tr>
						...
						<td class="dec"  style="width: 180px;"><bu:ui colNo="CI_ITEM_CODE" formId="013c4606017841b6b4e7f01e2a32d0a6" value="%{CI_ITEM_CODE}" formIndex="1" style="width: 200px;"/></td>
						<td class="name" style="width: 52px;"><bu:uitn colNo="CI_ITEM_NAME" formId="013c4606017841b6b4e7f01e2a32d0a6" cssClass="tr1" /></td>
						<td class="dec"  style="width: 180px;"><bu:ui colNo="CI_ITEM_NAME" formId="013c4606017841b6b4e7f01e2a32d0a6" value="%{CI_ITEM_NAME}" formIndex="1" style="width: 200px;"/></td>
						<td class="name" style="width: 52px;"><bu:uitn colNo="CI_ITEM_SPEC" formId="013c4606017841b6b4e7f01e2a32d0a6" cssClass="tr1" /></td>
						<td class="dec"  style="width: 180px;"><bu:ui colNo="CI_ITEM_SPEC" formId="013c4606017841b6b4e7f01e2a32d0a6" value="%{CI_ITEM_SPEC}" formIndex="1" style="width: 200px;"/></td>
					</tr>
					<tr>
						<td class="name"><span class="dot">*</span><bu:uitn colNo="CI_ITEM_GENRE" formId="013c4606017841b6b4e7f01e2a32d0a6" cssClass="tr1" /></td>
						<td class="dec" style="width: 180px;"><bu:ui colNo="CI_ITEM_GENRE" formId="013c4606017841b6b4e7f01e2a32d0a6" value="%{CI_ITEM_GENRE}" formIndex="1" style="width: 200px;"/></td>
						<td class="name"><bu:uitn colNo="CI_ITEM_TYPE" formId="013c4606017841b6b4e7f01e2a32d0a6" cssClass="tr1" /></td>
						<td class="dec" style="width: 180px;"><bu:ui colNo="CI_ITEM_TYPE" formId="013c4606017841b6b4e7f01e2a32d0a6" value="%{CI_ITEM_TYPE}" formIndex="1" style="width: 200px;"/></td>
						<td class="name"><bu:uitn colNo="CI_ITEM_SOURCE" formId="013c4606017841b6b4e7f01e2a32d0a6" cssClass="tr1" /></td>
						<td class="dec" style="width: 180px;"><bu:ui colNo="CI_ITEM_SOURCE" formId="013c4606017841b6b4e7f01e2a32d0a6" value="%{CI_ITEM_SOURCE}" formIndex="1" style="width: 200px;"/></td>
					</tr>
					<tr>
						<td class="name" style="width: 82px;"><bu:uitn colNo="CI_SN_RULE" formId="013c4606017841b6b4e7f01e2a32d0a6" cssClass="tr1" /></td>
						<td class="dec" style="width: 180px;"><bu:ui colNo="CI_SN_RULE" formId="013c4606017841b6b4e7f01e2a32d0a6" value="%{CI_SN_RULE}" formIndex="1"/></td>
		...
		<DIV class="content1" id="content" style="margin-top: 15px;">
				...
				<table class="basic-table" width="100%">
					<tr>
						...
						<td class="dec" style="width:35%;"><bu:ui colNo="CI_LINK_NUM" formId="013c4606017841b6b4e7f01e2a32d0a6" value="%{CI_LINK_NUM}" formIndex="1" style="width: 200px;"/></td>
						<td class="name" style="width:15%;"><bu:uitn colNo="CI_JIGSAW_NUM" formId="013c4606017841b6b4e7f01e2a32d0a6"/></td>
						<td class="dec" style="width:35%;"><bu:ui colNo="CI_JIGSAW_NUM" formId="013c4606017841b6b4e7f01e2a32d0a6" value="%{CI_JIGSAW_NUM}" formIndex="1" style="width: 200px;"/></td>
					</tr>
					<tr>
			...
			<DIV id="content2" style="display:none" data-tab="tag2">
				<table class="basic-table" width="100%">
					<tr>
						...
						<td class="dec"  style="width:35%;"><bu:ui colNo="CI_FEEDER_SIZE" formId="013c4606017841b6b4e7f01e2a32d0a6" value="%{CI_FEEDER_SIZE}" formIndex="1" style="width: 200px;"/></td>
						<td class="name" style="width:15%;"><bu:uitn colNo="CI_PACK_TYPE" formId="013c4606017841b6b4e7f01e2a32d0a6"/></td>
						<td class="dec" style="width:35%;"><bu:ui colNo="CI_PACK_TYPE" formId="013c4606017841b6b4e7f01e2a32d0a6" value="%{CI_PACK_TYPE}" formIndex="1" style="width: 200px;"/></td>
					...
					<tr>
						...
						<td class="dec"><bu:ui colNo="CI_CONTRAL_TYPE" formId="013c4606017841b6b4e7f01e2a32d0a6" value="%{CI_CONTRAL_TYPE}" formIndex="1" style="width: 200px;"/></td>
					    <td class="name"><bu:uitn colNo="CI_AGING_TIME" formId="013c4606017841b6b4e7f01e2a32d0a6" /></td>
					    <td class="dec" ><bu:ui colNo="CI_AGING_TIME" formId="013c4606017841b6b4e7f01e2a32d0a6" value="%{CI_AGING_TIME}" formIndex="1" style="width: 200px;"/></td>
					</tr>
				</table>
			</DIV>
			<DIV id="content3" style="display:none" data-tab="tag3">
				<table class="basic-table" width="100%">
					<tr>
						...
						<td class="dec" style="width:35%;"><bu:ui colNo="CI_STOCK_CYCLE" formId="013c4606017841b6b4e7f01e2a32d0a6" value="%{CI_STOCK_CYCLE}" formIndex="1" style="width: 200px;"/></td>
						<td class="name" style="width:15%;"><bu:uitn colNo="CI_CYCLE_REMIND" formId="013c4606017841b6b4e7f01e2a32d0a6" /></td>
						<td class="dec" style="width:35%;"><bu:ui colNo="CI_CYCLE_REMIND" formId="013c4606017841b6b4e7f01e2a32d0a6" value="%{CI_CYCLE_REMIND}" formIndex="1" style="width: 200px;"/></td>
					</tr>
					<tr>
					<!--
						...
						<td class="dec"><bu:ui colNo="CI_AUTO_FQC" formId="013c4606017841b6b4e7f01e2a32d0a6" value="%{CI_AUTO_FQC}" formIndex="1"/></td>
					...
					<tr>
						...
						<td class="dec"><bu:ui colNo="CI_RECHECK_DAYS" formId="013c4606017841b6b4e7f01e2a32d0a6" value="%{CI_RECHECK_DAYS}" formIndex="1" style="width: 200px;"/></td>						
					</tr>
					<tr>
					        <td class="name"><bu:uitn colNo="CI_REMIND_DAYS" formId="013c4606017841b6b4e7f01e2a32d0a6" /></td>
						<td class="dec"><bu:ui colNo="CI_REMIND_DAYS" formId="013c4606017841b6b4e7f01e2a32d0a6" value="%{CI_REMIND_DAYS}" formIndex="1" style="width: 200px;"/></td>					
					</tr>
				</table>
			</DIV>
			<DIV id="content4" style="display:none" data-tab="tag4">
				<table class="basic-table" width="100%">
					<tr>
						...
						<td class="dec" style="width:35%;"><bu:ui colNo="CI_MIN_STOCK" formId="013c4606017841b6b4e7f01e2a32d0a6" value="%{CI_MIN_STOCK}" formIndex="1" style="width: 200px;"/></td>
						<td class="name" style="width:15%;"><bu:uitn colNo="CI_MAX_STOCK" formId="013c4606017841b6b4e7f01e2a32d0a6" /></td>
						<td class="dec" style="width:35%;"><bu:ui colNo="CI_MAX_STOCK" formId="013c4606017841b6b4e7f01e2a32d0a6" value="%{CI_MAX_STOCK}" formIndex="1" style="width: 200px;"/></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="dec"><bu:ui colNo="CI_EXCESS_RECEIVE" formId="013c4606017841b6b4e7f01e2a32d0a6" value="%{CI_EXCESS_RECEIVE}" formIndex="1" />
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<bu:uitn colNo="CI_EXCESS_PICK" formId="013c4606017841b6b4e7f01e2a32d0a6" />
										<bu:ui colNo="CI_EXCESS_PICK" formId="013c4606017841b6b4e7f01e2a32d0a6" value="%{CI_EXCESS_PICK}" formIndex="1"/></td>
					</tr>
					<tr>
					    <td class="name"><bu:uitn colNo="CI_SLUGGISH_CYCLE" formId="013c4606017841b6b4e7f01e2a32d0a6" /></td>
						<td class="dec"><bu:ui colNo="CI_SLUGGISH_CYCLE" formId="013c4606017841b6b4e7f01e2a32d0a6" value="%{CI_SLUGGISH_CYCLE}" formIndex="1" style="width: 200px;"/></td>
					</tr>
				</table>
			</DIV>
			<DIV id="content5" style="display:none" data-tab="tag5">
				<table class="basic-table" width="100%">
					<tr>
						...
						<td class="dec"><bu:ui colNo="CI_MSD_FLAG" formId="013c4606017841b6b4e7f01e2a32d0a6" value="%{CI_MSD_FLAG}" formIndex="1" />
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<bu:uitn colNo="CI_ROHS_FLAG" formId="013c4606017841b6b4e7f01e2a32d0a6" />
										<bu:ui colNo="CI_ROHS_FLAG" formId="013c4606017841b6b4e7f01e2a32d0a6" value="%{CI_ROHS_FLAG}" formIndex="1" /></td>
						
						<td class="name" style="width:15%;"><bu:uitn colNo="CI_MSD_ID" formId="013c4606017841b6b4e7f01e2a32d0a6" /></td>
						<td class="dec" style="width:35%;"><bu:ui colNo="CI_MSD_ID" formId="013c4606017841b6b4e7f01e2a32d0a6" value="%{CI_MSD_ID}" formIndex="1" style="width: 200px;"/></td>
					</tr>
					<tr>
						...
						<td class="dec"><bu:ui colNo="CI_ITEM_SIZE" formId="013c4606017841b6b4e7f01e2a32d0a6" value="%{CI_ITEM_SIZE}" formIndex="1" style="width: 200px;"/></td>
					</tr>
				</table>
			</DIV>
...
<script type="text/javascript">
	...
	alert($("#paraMap1_CI_TEST_UNIT_chosen").html());
	})*/
	
	function init(){
		$("#tag1").addClass("current");
		
		//$("#paraMap1_CI_TEST_UNIT_chosen .chosen-drop").attr("style","top: auto; bottom: 100%; border-top: 1px solid rgb(117, 196, 255); border-bottom: 0px; background-color: rgb(248, 252, 255);");
