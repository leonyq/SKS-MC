...
<body>
            ...
            <div class="hd">
                ...
                <div style="margin-left:40px;">
	               <s:if test="${isDataAuth == '1'}">
			    	...
			    	<div class="optn">
			    	        <button type="button" onclick="editCall();"><i class="ico ico-save"></i><dict:lang value="保存" /></button>
	...
	<input type="hidden" name="paraMap1@__DATA_COUNT__" value="1" />
		<s:set name="_$viewId" value="'806e50cc6de641da965b89cdbb611ceb'" />
							...
							<div class="dialog-bd" style="width:100%;height:380px;">
							 ...
							 <table class="basic-table" style="margin-top:15px;background-color: white;">
								...
								<tbody id="addDiv2" style="display: none;">
											...
											<tr>
												<td style="width: 27%;text-align: right;" class="name"><dict:lang value="说明"/></td>
												<td class="dec"><textarea id="WEC_MEMO1" onkeyup="javascript: utilsFp.replaceLikeVal(this)" style="height: 62px;" class=" input isSubmit"></textarea></td>
											</tr>
								</tbody>
							 </table>
							 </div>
...
<div class="panel datagrid datagrid-div1">
	<div class="datagrid-div2 datagrid-div6 datagrid-view" id="datagrid-view" style="width:100%;height:100%">
		...
		<div class="datagrid-body datagrid-div3" id="datagrid-body" style="height: 230px;width:100%;">
	    ...
	    function getInfo(){
	        ...
	        $.ajax({
	            ...
	            success:function(data){	
					...
					$("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a1234 tr:last").append("<td class='datagrid-cell datagrid-cell-2' name='STORAGE_SN' align='left' style='width:131px;'>"+list[i].WEC_STORAGE_SN+"<input name='STORAGE' type='hidden' id='STORAGE' value='"+list[i].WEC_STORAGE_SN+"'></td>");
					$("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a1234 tr:last").append("<td class='datagrid-cell datagrid-cell-3' name='SHELF_SN' align='left' style='width:134px;'>"+list[i].WEC_SHELF_SN+"<input name='SHELF' type='hidden' id='SHELF' value='"+list[i].WEC_SHELF_SN+"'></td>");
					$("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a1234 tr:last").append("<td class='datagrid-cell datagrid-cell-4' name='ITEM_SIZE' align='left' style='width:137px;'>"+size+"<input name='ITEM' type='hidden' id='ITEM' value='"+list[i].WEC_ITEM_SIZE+"'></td>");
					$("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a1234 tr:last").append("<td class='datagrid-cell datagrid-cell-5' name='WEC_CAPACITY' align='left' style='width:120px;'>"+list[i].WEC_CAPACITY+"<input name='WEC' type='hidden' id='WEC' value='"+list[i].WEC_CAPACITY+"'></td>");
					$("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a1234 tr:last").append("<td class='datagrid-cell datagrid-cell-6' name='WEC_MEMO' align='left' style='width:120px;'>"+list[i].WEC_MEMO+"<input name='tempMemo' type='hidden' id='tempMemo' value='"+list[i].WEC_MEMO+"'></td>");
		...
		function addLoadPoint(showId,backId){
			...
			if(addWay2=="0"){
				...
				/*var divN="<div id='hidDiv_"+trCount+"'>"+
						...
						"<input name='WEC' type='hidden' id='WEC' value='"+$("#WEC_CAPACITY").val()+"'>"+
				...
				$("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a1234 tr:last").append("<td class='datagrid-cell datagrid-cell-6' name='WEC_MEMO' align='left'><div>"+$("#WEC_MEMO").val()+"<input name='tempMemo' type='hidden' id='tempMemo' value='"+$("#WEC_MEMO").val()+"'></div></td>");
			   // $("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a1234 tbody:last").append(divN);
				...
				if(loadPointCount<=1){
					...
					/*var divN="<div id='hidDiv_"+trCount+"'>"+
						...
						"<input name='WEC' type='hidden' id='WEC' value='"+$("#WEC_CAPACITY1").val()+"'>"+
