...
<div class="mod-hd">		
  <h3 class="tit"><dict:lang value="基本信息" /></h3>	
	...
	<input type="hidden" name="paraMap1@__DATA_COUNT__" value="1" />
		...
		<tr>
			<td class="name" style="width:83px;"/>
            <bu:uitn colNo="CD_DEVICE_TYPE" formId="99338dfb95df4eec8d5714a4e773b127" /></td>
			<bu:td cssClass="dec" colNo="CD_DEVICE_TYPE" formId="99338dfb95df4eec8d5714a4e773b127" >            
			<bu:ui colNo="CD_DEVICE_TYPE" style="width:200px;" formId="99338dfb95df4eec8d5714a4e773b127" dataId="${dataId}" formIndex="1" disabled="disabled" /></bu:td>

			<td class="name" style="width:83px;"/><bu:uitn colNo="CD_DEVICE_SN" formId="99338dfb95df4eec8d5714a4e773b127" /></td>
			<bu:td cssClass="dec" style="width:220px;" colNo="CD_DEVICE_SN" formId="99338dfb95df4eec8d5714a4e773b127" >
            <bu:ui colNo="CD_DEVICE_SN" style="width:200px;" formId="99338dfb95df4eec8d5714a4e773b127"  dataId="${dataId}" formIndex="1" readonly="readonly" /></bu:td>
		
			<td class="name"/><bu:uitn colNo="CD_DEVICE_CLASS" formId="99338dfb95df4eec8d5714a4e773b127" /></td>
			<bu:td cssClass="dec" style="width:200px;" colNo="CD_DEVICE_CLASS" formId="99338dfb95df4eec8d5714a4e773b127" >
            <bu:ui colNo="CD_DEVICE_CLASS" style="width:200px;" formId="99338dfb95df4eec8d5714a4e773b127" dataId="${dataId}" formIndex="1" disabled="disabled" /></bu:td>
		...
		<tr>
			...
			<bu:td cssClass="dec" colNo="CDM_MT_EMP" formId="4981cf692e39466b9f092273166c00b4" >
            <bu:ui colNo="CDM_MT_EMP" style="width:200px;" formId="4981cf692e39466b9f092273166c00b4" dataId="${dataId}" formIndex="1" /></bu:td>
		...
		<tr>
			...
			<bu:td cssClass="dec" colNo="CDM_MT_LONG" formId="4981cf692e39466b9f092273166c00b4" >
            <bu:ui colNo="CDM_MT_LONG" style="width:200px;" onkeyup="value=value.replace(/[^\d.]/g,'')" formId="4981cf692e39466b9f092273166c00b4" dataId="${dataId}" formIndex="1"/></bu:td>
			
			<td class="name" style="width:80px;"/><bu:uitn colNo="CDM_MT_TIME" formId="4981cf692e39466b9f092273166c00b4" /></td>
			<bu:td cssClass="dec" colNo="CDM_MT_TIME" formId="4981cf692e39466b9f092273166c00b4" >
            <bu:ui colNo="CDM_MT_TIME" style="width:200px;" formId="4981cf692e39466b9f092273166c00b4" dataId="${dataId}" formIndex="1" disabled="disabled" /></bu:td>
			
			<td class="name"/><bu:uitn colNo="CDM_MT_SPACE" formId="4981cf692e39466b9f092273166c00b4" /></td>
			<bu:td cssClass="dec" colNo="CDM_MT_SPACE" formId="4981cf692e39466b9f092273166c00b4" >
            <bu:ui colNo="CDM_MT_SPACE" style="width:200px;" formId="4981cf692e39466b9f092273166c00b4" dataId="${dataId}" formIndex="1" readonly="readonly" /></bu:td>
		...
		<!--	<div class="extend-btn" style="float: right;margin-top:-40px;">
			...
			<DIV id="content2" style="display:none" data-tab="tag2">
			   <div class="extend-btn" style="float: right;margin-top:-35px;">
						...
						<button type="button" onclick="delRow();"     style="padding:0"   title="<dict:lang value="移除" /> " >   <i class="ico ico-sc-new-add ico-small"></i> 
						</button> 
					</div>
			<div class="mod" >
