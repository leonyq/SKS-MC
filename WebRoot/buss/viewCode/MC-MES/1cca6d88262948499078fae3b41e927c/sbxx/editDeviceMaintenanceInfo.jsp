...
<body>
	...
	<input type="hidden" name="paraMap1@__DATA_COUNT__" value="1" />
		<s:set name="_$viewId" value="'9a67414fadb443c7b1f4bf9d6c741712'" />
		<s:set name="_$formId_1" value="'4b6c04e8e1384717a4be814862e502a1'" />
		<s:set name="_$type" value="'edit'"/>
		<input type="hidden" id="CDM_ITEM_TYPE" name="CDM_ITEM_TYPE" value="" />
		<tr>
		...
		<tr>
			...
			<bu:td cssClass="dec-self" style="height:80px;" colspan="4" colNo="CDM_MT_CONTENT" formId="4b6c04e8e1384717a4be814862e502a1" ><bu:ui colNo="CDM_MT_CONTENT" style="width: 100%;height: 100%;" formId="4b6c04e8e1384717a4be814862e502a1" dataId="${dataId}" formIndex="1" /></bu:td>
		</tr>
		...
		<tr>
			...
			<bu:td cssClass="dec-self" colNo="CDM_MT_EMP" formId="4b6c04e8e1384717a4be814862e502a1" ><bu:ui colNo="CDM_MT_EMP" formId="4b6c04e8e1384717a4be814862e502a1" dataId="${dataId}" formIndex="1" /></bu:td>
		<td>&nbsp;</td>
			<td class="name-four" /><bu:uitn colNo="CDM_MT_TIME" formId="4b6c04e8e1384717a4be814862e502a1" /></td>
			<bu:td cssClass="dec-self" colNo="CDM_MT_TIME" formId="4b6c04e8e1384717a4be814862e502a1" ><bu:ui colNo="CDM_MT_TIME" formId="4b6c04e8e1384717a4be814862e502a1" dataId="${dataId}" formIndex="1" /></bu:td>
		<td>&nbsp;</td>
...
<bu:script viewId="9a67414fadb443c7b1f4bf9d6c741712" />
	<script type="text/javascript">
			var parentWindow;
			$(function(){
		...
		function init(){
				...
				$("#CDM_ITEM_TYPE").val(CDM_ITEM_TYPE);
				...
				var CDM_CYCLE = $("#paraMapObj_CDM_CYCLE").val();
									...
									if(CDM_ITEM_TYPE=="设备参数"){
										...
										$("#deviceItem_1 tr:last").append("<td class='datagrid-cell datagrid-cell-6' style='width:70px;text-align: center;'><input type='text' id='deviceItemReal1' name='deviceItemReal1' value='"+CDM_ITEM_REAL+"'/></td>");
									...
									if(CDM_ITEM_TYPE=="保养项目"){
										...
										$("#deviceItem_2 tr:last").append("<td class='datagrid-cell datagrid-cell-6' style='width:70px;text-align: center;'><input type='text' id='deviceItemReal2' name='deviceItemReal2' value='"+CDM_ITEM_REAL+"'/></td>");
									...
									if(CDM_ITEM_TYPE=="点检项目"){
										...
										$("#deviceItem_3 tr:last").append("<td class='datagrid-cell datagrid-cell-6' style='width:70px;text-align: center;'><input type='text' id='deviceItemReal3' name='deviceItemReal3' value='"+CDM_ITEM_REAL+"'/></td>");
									...
									if(CDM_ITEM_TYPE=="校验项目"){
										...
										$("#deviceItem_4 tr:last").append("<td class='datagrid-cell datagrid-cell-6' style='width:70px;text-align: center;'><input type='text' id='deviceItemReal4' name='deviceItemReal4' value='"+CDM_ITEM_REAL+"'/></td>");
		...
		function editCal(){
           ...
           document.forms.editForm.action = "${path}buss/bussModel_exeFunc.ms?funcMId=9ab9ad95c58149f3971ab369a70b3f44"; 
