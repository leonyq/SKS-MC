...
<body>
	...
	<input type="hidden" name="paraMap1@__DATA_COUNT__" value="1" />
		...
		<tr>
			...
			<td class="dec" style="height:80px;" colspan="3"><textarea id="CDM_MT_CONTENT" name="CDM_MT_CONTENT" style="width: 158.5%;height: 100%;"></textarea></td>
		</tr>
	</table>
...
<bu:script viewId="e038776ba4c444bdbb33c4d32b715380" />
	...
	var trCount3 = 0;
	var trCount4 = 0;
	var url = "buss/bussModel_exeFunc.ms?FUNC_CODE=F3595&funcMId=a66c0c5a0b5c4c24be618f9b93c61838";
		function init(){
	...
	function checkVal2(trCount2){
		...
		for(var i=1;i<=trCount2;i++){
			tempVal = $("#deviceItemReal2_"+i).val();
			tempId = document.getElementById("deviceItemReal2_"+i);
			if(tempVal==null) continue;
			if(tempVal!=""){
				tempFlag = checkNum(tempVal,tempId);
			}else{
	...
	function checkVal3(trCount3){
		...
		for(var i=1;i<=trCount3;i++){
			tempVal = $("#deviceItemReal3_"+i).val();
			tempId = document.getElementById("deviceItemReal3_"+i);
			if(tempVal==null) continue;
			if(tempVal!=""){
				tempFlag = checkNum(tempVal,tempId);
			}else{
	...
	function checkVal4(trCount4){
		...
		for(var i=1;i<=trCount4;i++){
			tempVal = $("#deviceItemReal4_"+i).val();
			tempId = document.getElementById("deviceItemReal4_"+i);
			if(tempVal==null) continue;
			if(tempVal!=""){
				tempFlag = checkNum(tempVal,tempId);
			}else{
