...
<body>
    <div class="content-in">
		...
		<bu:table cssClass="datagrid-htable fixedTable datagrid-div6 datagrid-htable-kz" id="datagrid-htablee09e1f47e824490d80ba2717d25498d3" style="width:1890px;">
		...
		<bu:tr cssClass="datagrid-header-row datagrid-title-ajax" id="datagrid-title-ajax">
			...
			<td class="datagrid-cell" style="width:200px;"><bu:uitn colNo="DATA_AUTH" formId="e09e1f47e824490d80ba2717d25498d3" /></td>
			<td class="datagrid-cell" style="width:210px;"><bu:uitn colNo="ASSISTANTTOOLNO" formId="e09e1f47e824490d80ba2717d25498d3" /></td>
			...
			<td class="datagrid-cell" style="width:100px;" ><bu:uitn colNo="TIN_USE_TIME" formId="e09e1f47e824490d80ba2717d25498d3" /></td>
			...
			<td class="datagrid-cell" style="width:150px;"><bu:uitn colNo="TIN_CREATE_RULE" formId="e09e1f47e824490d80ba2717d25498d3" /></td>
		...
		<table class="datagrid-btable fixedTable dblClick"  id="datagrid-btable-ajaxe09e1f47e824490d80ba2717d25498d3" style="width:1890px;">
    ...
    function listAjaxTable(formId){
        ...
        $.ajax({
            ...
            //{"searchParams" : searchParams,"page.currentPage" : _GLO_FORM_PAGE_MAP[formId].currentPage, "page.pageRecord" : _GLO_FORM_PAGE_MAP[formId].pageRecord},
...
function createTableModel(ms,formId){
    ...
    if(formId=='e09e1f47e824490d80ba2717d25498d3'){<%--辅料制具料号信息--%>
        $.each(uiTxt,function(i,v){
            ...
            arrHtml.push("</td>");            
            arrHtml.push("<td colno='ASSISTANTTOOLNO' class='datagrid-cell "+ms.tdClass(formId, 'ASSISTANTTOOLNO')+"' style='width:210px;"+ms.tdStyle(formId, 'ASSISTANTTOOLNO')+"' "+ms.tdEvent(formId, 'ASSISTANTTOOLNO')+">")
            ...
            arrHtml.push("</td>");
            arrHtml.push("<td colno='ASSISTANTTOOLTYPE' class='datagrid-cell "+ms.tdClass(formId, 'ASSISTANTTOOLTYPE')+"' style='width:110px;text-align:center;"+ms.tdStyle(formId, 'ASSISTANTTOOLTYPE')+"' "+ms.tdEvent(formId, 'ASSISTANTTOOLTYPE')+">")
            ...
            arrHtml.push("</td>");
            arrHtml.push("<td colno='ASSISTANTLEASTCOUNT' class='datagrid-cell "+ms.tdClass(formId, 'ASSISTANTLEASTCOUNT')+"' style='width:90px;text-align:right;"+ms.tdStyle(formId, 'ASSISTANTLEASTCOUNT')+"' "+ms.tdEvent(formId, 'ASSISTANTLEASTCOUNT')+">")
            ...
            arrHtml.push("</td>");
            arrHtml.push("<td colno='TIN_DISCARD_TIME' class='datagrid-cell "+ms.tdClass(formId, 'TIN_DISCARD_TIME')+"' style='width:90px;text-align:right;"+ms.tdStyle(formId, 'TIN_DISCARD_TIME')+"' "+ms.tdEvent(formId, 'TIN_DISCARD_TIME')+">")
            ...
            arrHtml.push("</td>");
            arrHtml.push("<td colno='TIN_OPEN_DISCARD_TIME' class='datagrid-cell "+ms.tdClass(formId, 'TIN_OPEN_DISCARD_TIME')+"' style='width:130px;text-align:right;"+ms.tdStyle(formId, 'TIN_OPEN_DISCARD_TIME')+"' "+ms.tdEvent(formId, 'TIN_OPEN_DISCARD_TIME')+">")
            arrHtml.push("<span colno='TIN_OPEN_DISCARD_TIME' class='"+ms.uiClass(formId, 'TIN_OPEN_DISCARD_TIME')+"' style='"+ms.uiStyle(formId, 'TIN_OPEN_DISCARD_TIME')+"' "+ms.uiEvent(formId, 'TIN_OPEN_DISCARD_TIME')+" >"+v['TIN_OPEN_DISCARD_TIME']+"</span>")
            arrHtml.push("</td>");
            arrHtml.push("<td colno='ASSISTANTTOOLCOUNT' class='datagrid-cell "+ms.tdClass(formId, 'ASSISTANTTOOLCOUNT')+"' style='width:90px;text-align:right;"+ms.tdStyle(formId, 'ASSISTANTTOOLCOUNT')+"' "+ms.tdEvent(formId, 'ASSISTANTTOOLCOUNT')+">")
            ...
            arrHtml.push("</td>");
            arrHtml.push("<td colno='TIN_BACK_TIME' class='datagrid-cell "+ms.tdClass(formId, 'TIN_BACK_TIME')+"' style='width:110px;text-align:right;"+ms.tdStyle(formId, 'TIN_BACK_TIME')+"' "+ms.tdEvent(formId, 'TIN_BACK_TIME')+">")
            ...
            arrHtml.push("</td>");
            arrHtml.push("<td colno='TIN_DURING_TIME' class='datagrid-cell "+ms.tdClass(formId, 'TIN_DURING_TIME')+"' style='width:110px;text-align:right;"+ms.tdStyle(formId, 'TIN_DURING_TIME')+"' "+ms.tdEvent(formId, 'TIN_DURING_TIME')+">")
            ...
            arrHtml.push("</td>");
            arrHtml.push("<td colno='TIN_USE_TIME' class='datagrid-cell "+ms.tdClass(formId, 'TIN_USE_TIME')+"' style='width:100px;text-align:right;"+ms.tdStyle(formId, 'TIN_USE_TIME')+"' "+ms.tdEvent(formId, 'TIN_USE_TIME')+">")
            ...
            arrHtml.push("</td>");            
            arrHtml.push("<td colno='BARD_COUNT' class='datagrid-cell "+ms.tdClass(formId, 'BARD_COUNT')+"' style='width:90px;text-align:right;"+ms.tdStyle(formId, 'BARD_COUNT')+"' "+ms.tdEvent(formId, 'BARD_COUNT')+">")
            ...
            arrHtml.push("</td>");
            arrHtml.push("<td colno='MAX_USE_COUNT' class='datagrid-cell "+ms.tdClass(formId, 'MAX_USE_COUNT')+"' style='width:100px;text-align:right;"+ms.tdStyle(formId, 'MAX_USE_COUNT')+"' "+ms.tdEvent(formId, 'MAX_USE_COUNT')+">")
            ...
            arrHtml.push("</td>");
            arrHtml.push("<td colno='LEAD_FLAG' class='datagrid-cell "+ms.tdClass(formId, 'LEAD_FLAG')+"' style='width:90px;text-align:center;"+ms.tdStyle(formId, 'LEAD_FLAG')+"' "+ms.tdEvent(formId, 'LEAD_FLAG')+">")
            ...
            arrHtml.push("<span colno='TIN_BAR_RULE' class='"+ms.uiClass(formId, 'TIN_BAR_RULE')+"' style='"+ms.uiStyle(formId, 'TIN_BAR_RULE')+"' "+ms.uiEvent(formId, 'TIN_BAR_RULE')+" title='"+v['TIN_BAR_RULE']+"' >"+v['TIN_BAR_RULE']+"</span>")
            arrHtml.push("</td>");
            arrHtml.push("<td colno='TIN_CREATE_RULE' class='datagrid-cell "+ms.tdClass(formId, 'TIN_CREATE_RULE')+"' style='width:150px;"+ms.tdStyle(formId, 'TIN_CREATE_RULE')+"' "+ms.tdEvent(formId, 'TIN_CREATE_RULE')+">")
            arrHtml.push("<span colno='TIN_CREATE_RULE' class='"+ms.uiClass(formId, 'TIN_CREATE_RULE')+"' style='"+ms.uiStyle(formId, 'TIN_CREATE_RULE')+"' "+ms.uiEvent(formId, 'TIN_CREATE_RULE')+" title='"+v['TIN_CREATE_RULE']+"' >"+v['TIN_CREATE_RULE']+"</span>")
            arrHtml.push("</td>");
