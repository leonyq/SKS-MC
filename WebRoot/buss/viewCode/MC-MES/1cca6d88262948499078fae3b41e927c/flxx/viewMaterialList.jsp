...
<bu:tdSBox formidFirstId="e09e1f47e824490d80ba2717d25498d3" /></td>
			...
			<bu:td cssClass="datagrid-cell datagrid-cell-16" style="width:100px;" colNo="FIX_CLCLE_UNIT" formId="e09e1f47e824490d80ba2717d25498d3" >
				<bu:ui colNo="FIX_CLCLE_UNIT" formId="e09e1f47e824490d80ba2717d25498d3" value="%{FIX_CLCLE_UNIT}" seq="%{#seq}" />
			</bu:td>
			<bu:td cssClass="datagrid-cell datagrid-cell-17"  style="width:110px;" colNo="FIX_MT_REMIND" formId="e09e1f47e824490d80ba2717d25498d3" >
				<bu:ui colNo="FIX_MT_REMIND" formId="e09e1f47e824490d80ba2717d25498d3" value="%{FIX_MT_REMIND}" seq="%{#seq}" />
			</bu:td>
			<bu:td cssClass="datagrid-cell datagrid-cell-18"  style="width:90px;" colNo="TIN_BAR_RULE" formId="e09e1f47e824490d80ba2717d25498d3" >
				<bu:ui colNo="TIN_BAR_RULE" formId="e09e1f47e824490d80ba2717d25498d3" value="%{TIN_BAR_RULE}" seq="%{#seq}" />
			</bu:td>
			<bu:td cssClass="datagrid-cell datagrid-cell-19" colNo="TIN_USE_TIME" formId="e09e1f47e824490d80ba2717d25498d3" >
