	...
	*/
	...
	$(function(){
		...
		function init(){
          ...
          $("#paraMapObj_CFI_CYCLE_REMIND").addClass("readonly"); 	
      
      		$("#paraMapObj_CFI_REMIND_CYCLE").addClass("readonly"); 	
      
     		 $("#paraMapObj_CFI_PERIOD_LIMIT").addClass("readonly");
      		
      		$("#paraMapObj_CFI_UPKEEP_PERIOD").addClass("readonly"); 	
      
      		$("#paraMapObj_CFI_REMIND_DAY").addClass("readonly"); 
	...
	var calwStart=$("#paraMapObj_CFI_FLATNESS");
             if( !/^[0-9]+(.[0-9]{0,2})?$/.test(this.value)){
             	...
             	_alertValMsg($('#paraMapObj_CFI_FLATNESS'),"<dict:lang value="只能输入有两位小数的正实数" />");
             }
         });
