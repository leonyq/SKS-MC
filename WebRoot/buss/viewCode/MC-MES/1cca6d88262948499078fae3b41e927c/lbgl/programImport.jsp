...
<body>
		...
		<div class="bd" style="height:300px;">
			<form id="addForm" name="addForm"
				...
				<table class="basic-table">
					...
					<s:set name="_$viewId" value="'c786895d0e51458c8cd30d91eb4c863a'" />
	...
	function addParentData(resdata){
		 ...
		 //console.log('curRowSeq'+getCurRow());
	...
	function uploadProgram(thisObj) {
		var file = document.getElementById("upFile").value;
		if (file == "") {
				//utilsFp.confirmIcon(3, "", "", "","%{getText("请选择程式文件")}"
				//	, "", "360", "145");
		    utilsFp.confirmIcon(3,"","","", "<dict:lang value="请选择程式文件" />",0,"260","");
         return;
		} else {
			var seqs = "";
			var deviceArr=[];
		...
		document.forms.addForm.action = "${path}buss/bussModel_exeFunc.ms?funcMId=1adef452641040a7b0c366ac4398d508";
		document.forms.addForm.submit();
	}
</script>
	<bu:script viewId="c786895d0e51458c8cd30d91eb4c863a" />
