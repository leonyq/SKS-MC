...
<body>
    <div  style="width: 100%;height:calc(100% - 10px);background-color:#fff;border: 1px solid #eaeaea;box-sizing:border-box;" >
    	...
    	<input type="text" class="input" id="proSn" placeholder="请输入产品SN,按Enter键或点击查询" style="margin-left:30px;margin-top:10px;height: 28px;line-height: 28px;">
    	<input type="hidden" id="hiddenlot" value="" >
    	<input type="hidden" id="hiddenitem" value="" >
    	<input type="hidden" id="proSn1" value="${param.proSn}" >
    	<input type="hidden" name="formId" id="formId1" value='ff22f995cd064055b2658fb26776340b'/>
    	...
    	<button type="button" id="exportbtn" value="" onclick="exportProData()" sytle="" class="botton_img_add"><i class="ico ico-show-detail "></i><dict:lang value="导出" /></button>
    	</div>
		<div class="block1" style="background:#ffffff;overflow:auto;position: absolute; top: 38px;height:calc(100% - 38px);width:100%;">
		    <div class="mod" style="height:100%;">
                ...
                <div id="index_tree" class="ztree" style="height:calc(100% - 40px);box-sizing: border-box;border: 1px solid #ccc;">
          	    </div>
            </div>
      	</div>
      </div>
        <div  style="width: calc(67% - 20px);height:40%;float: right;position: relative;border-color:#eaeaea;background:#ffffff;" >
        	...
        	<td ><div class="name" ><dict:lang value="工序名称" /></div></td><td><div class="dec"><input readonly id="groupCode" class="input coc" style="width:147px;"></div></td>
        	...
        	<tr>
        	<td ><div class="name" ><dict:lang value="工艺名称" /></div></td><td><div class="dec"><input readonly id="techSn" class="input coc" ondblclick="seeMaterialPro(this.value);" style="width:147px;"></div></td>
        ...
        <div  style="width: 33%;height:60%;float: left;border-color:#eaeaea;background:#ffffff;border:1px;margin-left: 5px;" >
            <div class="mod" style="height:100%;">
                <div class="mod-hd">
                ...
                <div style="height:calc(100% - 70px);">
            		...
            		<bu:table cssClass="datagrid-htable fixedTable datagrid-div6 datagrid-htable-kz" id="datagrid-htable2f1adeb396c4403b8fea545ec6315555" ><!--ff22f995cd064055b2658fb26776340b  2f1adeb396c4403b8fea545ec6315555-->
            		<s:set name="_$type" value="'view'" />
            		<tbody class="isParentsTitle">
            		<bu:tr cssClass="datagrid-header-row datagrid-title-ajax" id="datagrid-title-ajax">
            			<td class="datagrid-cell pokja" style="width:30px; text-align:center;" ><bu:thSeq  formId="2f1adeb396c4403b8fea545ec6315555" i18n="1"/></td>
            			<td class="datagrid-cell" style="width:120px;"><dict:lang value="产品SN" /></td>
            		...
            		<div class="datagrid-body datagrid-div3 datagrid-body-ajax scroll" id="tableDivff22f995cd064055b2658fb26776340b" onscroll="ajaxTableScroll(this,'2f1adeb396c4403b8fea545ec6315555')">
      ...
      <DIV id="container" style="margin-bottom:5px;">
        ...
        <div class="datagrid-header-inner scroll003" id="datagrid-header-inner2f1adeb396c4403b8fea545ec6313333">
        ...
        <table class="datagrid-btable fixedTable dblClick"  id="datagrid-btable-ajax2f1adeb396c4403b8fea545ec6313333">
        <tbody id="tbody_tab3">
        </tbody>
        </table>        
        </div>
       ...
       <div class="datagrid-header dd05">
        ...
        <table class=" datagrid-btable fixedTable dblClick "  id="datagrid-btable-ajax2f1adeb396c4403b8fea545ec63155551" >
        <tbody id="tbody_tab5">
        </tbody>
        </table>        
        </div>        
...
function detailcon(obj){
  ...
  showPopWinFp(url, 800, 400,null,"记录内容","logCon");
   ...
   $.ajax({
        type: "POST",
        dataType: "json",
        url: "${path}buss/bussModel_exeFunc.ms?funcMId=4c187ba1fff2451dbbd10a8e00725e53",
        data: {
            "tab" : "5",
            "timeArr" : timeArr
        },
        success: function(data){
              ...
              $("#tbody_tab5").empty();
               if(null != data.ajaxPage.dataList){
                    ...
                    $("#tbody_tab5 tr:last").append("<td  class='datagrid-cell' style='width:300px;text-align: center;'>"+(reslist[i].CEI_RECORD_CONTENT==null?"":reslist[i].CEI_RECORD_CONTENT)+"</td>");//
                  }
               var tableTrJs = $("#tbody_tab5 tr");_tongLineColor(tableTrJs);  
               }
               	defTableWidthRewrite("2f1adeb396c4403b8fea545ec63155551");
        ...
        success: function(data){
              ...
              $("#tbody_tab6").empty();
               ...
               var tableTrJs = $("#tbody_tab6 tr");_tongLineColor(tableTrJs);
               	...
               	defTableWidthRewrite("2f1adeb396c4403b8fea545ec6316666");
        },
        error: function(msg){
                util.closeLoading();
                utilsFp.confirmIcon(3,"","","", "error:"+msg,0,"300","");
   ...
   $.ajax({
        ...
        success: function(data){
              ...
              if(null != data.ajaxPage.dataList){
                  for(var i=0;i<reslist.length;i++){
                    $("#tbody_tab4").append("<tr style='cursor:pointer' id='"+(reslist[i].QII_INSPECT_SN==null?"":reslist[i].QII_INSPECT_SN)+"'   ></tr>");
                    $("#tbody_tab4 tr:last").append("<td class='datagrid-cell' style='width:30px;text-align: center;'>"+(i+1)+"</td>");
                    $("#tbody_tab4 tr:last").append("<td class='datagrid-cell' style='width:160px;text-align: center;'><span onclick='itemJump7(\""+reslist[i].QII_INSPECT_SN+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+(reslist[i].QII_INSPECT_SN==null?"":reslist[i].QII_INSPECT_SN)+"</span></td>");
        ...
        success: function(data){
              ...
              if(null != data.ajaxPage.dataList){
                  for(var i=0;i<reslist.length;i++){
                    ...
                    $("#tbody_tab3 tr:last").append("<td class='datagrid-cell' style='width:200px;text-align: center;' title='"+(reslist[i].WSI_ITEM_SN==null?"":reslist[i].WSI_ITEM_SN)+"'><span onclick='itemJump6(\""+reslist[i].WSI_ITEM_SN+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+(reslist[i].WSI_ITEM_SN==null?"":reslist[i].WSI_ITEM_SN)+"</span></td>");
                    ...
                    $("#tbody_tab3 tr:last").append("<td class='datagrid-cell' style='width:160px;text-align: center;'><span onclick='itemJump1(\""+reslist[i].WSI_MO_NUMBER+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+(reslist[i].WSI_MO_NUMBER==null?"":reslist[i].WSI_MO_NUMBER)+"</span></td>");
        ...
        success: function(data){
              ...
              if(null != data.ajaxPage.dataList){
                  for(var i=0;i<reslist.length;i++){
                    ...
                    $("#tbody_tab1 tr:last").append("<td class='datagrid-cell' style='width:160px;text-align: center;'><span onclick='itemJump4(\""+reslist[i].GROUP_NAME+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+(reslist[i].GROUP_NAME==null?"":reslist[i].GROUP_NAME)+"</span></td>");
                    ...
                    $("#tbody_tab1 tr:last").append("<td class='datagrid-cell' style='width:160px;text-align: center;'><span onclick='itemJump1(\""+reslist[i].WD_MO_NUMBER+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+(reslist[i].WD_MO_NUMBER==null?"":reslist[i].WD_MO_NUMBER)+"</span></td>");
                    $("#tbody_tab1 tr:last").append("<td class='datagrid-cell' style='width:160px;text-align: center;'><span onclick='itemJump2(\""+reslist[i].WD_PROJECT_ID+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+(reslist[i].WD_PROJECT_ID==null?"":reslist[i].WD_PROJECT_ID)+"</span></td>");
                    $("#tbody_tab1 tr:last").append("<td class='datagrid-cell' style='width:160px;text-align: center;'><span onclick='itemJump3(\""+reslist[i].WD_MODEL_CODE+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+(reslist[i].WD_MODEL_CODE==null?"":reslist[i].WD_MODEL_CODE)+"</span></td>");
                 ...
                 var tableTrJs = $("#tbody_tab1 tr");_tongLineColor(tableTrJs);
                 	...
                 	defTableWidthRewrite("2f1adeb396c4403b8fea545ec6311111");
        },
        error: function(msg){
                util.closeLoading();
                utilsFp.confirmIcon(3,"","","", "error:"+msg,0,"300","");
   ...
   $.ajax({
        type: "POST",
        dataType: "json",
        url: "${path}buss/bussModel_exeFunc.ms?funcMId=c3bdb7809cc449e8ad709ae9b99848d4",
        data: {
            "lot" : lot,
            "item" : item
        },
        success: function(data){
              ...
              if(null != data.ajaxPage.dataList){
                  for(var i=0;i<reslist.length;i++){
                    ...
                    $("#tbody_proSn tr:last").append("<td class='datagrid-cell' style='width:120px;text-align: center;'><span style='display: inline;border-bottom: 1px solid #004098;'>"+(reslist[i].WT_SN==null?"":reslist[i].WT_SN)+"</span></td>");
                 ...
                 pageFun(data.ajaxPage,"formId1");
                 	defTableWidthRewrite('2f1adeb396c4403b8fea545ec6315555');
                 }
        },
        error: function(msg){
                util.closeLoading();
   ...
   $.ajax({
        ...
        success: function(data){
              ...
              var page0 = pagec * (pagea-1);
              
              $("#tbody_proSn").empty();
              if(null != data.ajaxPage.dataList){
                  for(var i=0;i<reslist.length;i++){
                    $("#tbody_proSn").append("<tr style='cursor:pointer' ondblclick='trdbevent1(this.id)' id='"+(reslist[i].WT_SN==null?"":reslist[i].WT_SN)+"'></tr>");
                    $("#tbody_proSn tr:last").append("<td class='datagrid-cell' style='width:30px;text-align: center;'>"+(page0+i+1)+"</td>");
                    $("#tbody_proSn tr:last").append("<td class='datagrid-cell' style='width:120px;text-align: center;'><span style='display: inline;border-bottom: 1px solid #004098;'>"+(reslist[i].WT_SN==null?"":reslist[i].WT_SN)+"</span></td>");
                    $("#tbody_proSn tr:last").append("<td class='datagrid-cell' style='width:120px;text-align: center;'>"+(reslist[i].WT_MO_NUMBER==null?"":reslist[i].WT_MO_NUMBER)+"</td>");                   
                  }
                 var tableTrJs = $("#tbody_proSn tr");_tongLineColor(tableTrJs);
                 pageFun(data.ajaxPage,"formId1");
                 defTableWidthRewrite('2f1adeb396c4403b8fea545ec6315555');
   ...
   $.ajax({
        type: "POST",
        dataType: "json",
        url: "${path}buss/bussModel_exeFunc.ms?funcMId=5c636aa3911f4e5c8f50c8e6222fc24d",
        data: {
            "proSn" : prosn
        },
        success: function(data){
...
function exportProData(){
    ...
    var url = "buss/bussModel_exeFunc.ms?funcMId=ff681f3da15949948500ea12799f4609"+"&proSn="+$("#proSn").val()+"&orderArr="+orderArr+"&timeArr="+timeArr; 
    DownLoadExcelEx(url);
}
