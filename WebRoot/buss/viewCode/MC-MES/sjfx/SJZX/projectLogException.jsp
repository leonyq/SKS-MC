...
<head>
    ...
    <bu:header formId="90716fb0552a4172aadeac93dd6f32f5"/>
...
<div class="content-in">
    <div class="dlist">
        <div class="hd">
            <bu:func viewId="930e20e8c74d4c15acd628e221066929"/>
        </div>
        <div class="bd">
            <div class="search-box">
                <form id="searchForm" name="searchForm" action="${path}buss/bussModel.ms" method="post">
                    ...
                    <table class="search_table">
                        <bu:search deal_mark="1" viewId="930e20e8c74d4c15acd628e221066929"/>
                    </table>
            ...
            <form id="listForm" name="listForm" action="${path}buss/bussModel.ms?<s:property value='%{@com.more.fw.core.common.method.ConstantsMc@FUNC_CODE}' />=<s:property value='%{FUNC_CODE}' />" method="post">
                ...
                <input type="hidden" name="formId" id="formId1" value='90716fb0552a4172aadeac93dd6f32f5'/>
                    ...
                    <div class="datagrid-div2 datagrid-div6 datagrid-view-ajax" id="datagrid-view-ajax90716fb0552a4172aadeac93dd6f32f5" style="">
                            ...
                            <div class="datagrid-header-inner" id="datagrid-header-inner90716fb0552a4172aadeac93dd6f32f5">
                                <bu:table cssClass="datagrid-htable fixedTable datagrid-div6 datagrid-htable-kz" id="datagrid-htable90716fb0552a4172aadeac93dd6f32f5">
                                    ...
                                    <bu:tr cssClass="datagrid-header-row datagrid-title-ajax" id="datagrid-title-ajax">
                                        ...
                                        <td style="width:100px; text-align:center" name="noprintset_PROJECT_ID" class="datagrid-cell">
                                        ...
                                        <td style="width:100px; text-align:center" name="noprintset_SFLAG" class="datagrid-cell">
                                            <bu:uitn colNo="SFLAG" formId="90716fb0552a4172aadeac93dd6f32f5"/></td>
                                        <td style="width:300px; text-align:center" name="noprintset_MESSAGE" class="datagrid-cell">
                                        ...
                                        <td style="width:300px; text-align:center" name="noprintset_SAP_INFO" class="datagrid-cell">
                                            <bu:uitn colNo="SAP_INFO" formId="90716fb0552a4172aadeac93dd6f32f5"/></td>
                                        <td style="width:100px; text-align:center" name="noprintset_INTF_NAME" class="datagrid-cell">
                        ...
                        <div class="datagrid-body datagrid-div3 datagrid-body-ajax" id="tableDiv90716fb0552a4172aadeac93dd6f32f5" onscroll="ajaxTableScroll(this,'90716fb0552a4172aadeac93dd6f32f5')">
                            <table class="datagrid-btable fixedTable dblClick" id="datagrid-btable-ajax90716fb0552a4172aadeac93dd6f32f5">
                                <tbody id="tbody_90716fb0552a4172aadeac93dd6f32f5" class="isParents"></tbody>
                            </table>
                        </div>
                    </div>
                </div>
                <c:if test="${formPage90716fb0552a4172aadeac93dd6f32f5==1}">
                    <div class="center">
                        <s:include value="/plf/page/fp/paginationPopMultAx.jsp?listDataFn=listAjaxTable&formId=90716fb0552a4172aadeac93dd6f32f5&showLoading=0"/>
                    </div>
                </c:if>
...
<bu:submit viewId="930e20e8c74d4c15acd628e221066929"/>
<jsp:include page="/plf/page/mesdemo/commCode/commCode.jsp">
    <jsp:param name="modelName" value="VIEW_TYPE_17"/>
    <jsp:param name="location" value="beforeJsLoad"/>
</jsp:include>
<bu:script viewId="930e20e8c74d4c15acd628e221066929"/>
    ...
    function createTableModel(ms, formId) {
        ...
        if (formId == '90716fb0552a4172aadeac93dd6f32f5') {<%--VOID-SAP工单接口日志明细--%>
            $.each(uiTxt, function (i, v) {
                ...
                arrHtml.push("</td>");
                arrHtml.push("<td colno='SAP_INFO' name='noprintset_SAP_INFO' class='datagrid-cell  " + ms.tdClass(formId, 'SAP_INFO') + "' style='" + ms.tdStyle(formId, 'SAP_INFO') + "' " + ms.tdEvent(formId, 'SAP_INFO') + ">");
                arrHtml.push("<span colno='SAP_INFO' class='" + ms.uiClass(formId, 'SAP_INFO') + "' style='" + ms.uiStyle(formId, 'SAP_INFO') + "' " + ms.uiEvent(formId, 'SAP_INFO') + " title='" + ms.titleAttr(formId, 'SAP_INFO', 'IS_TITLE_ATTR', v) + "' >" + v['SAP_INFO'] + "</span>");
                arrHtml.push("</td>");
...
<script type="text/javascript">
    ...
    // var url = "https://skshu_21.morewiscloud.com/mc/http/interface.ms?model=ProjectReportIntfImpl&method=sync";
    // var url = "http://localhost:8018/mc/http/interface.ms?model=ProjectReportIntfImpl&method=sync";

    // var host = "https://skshu_21.morewiscloud.com";
    // var host = "http://10.10.80.193:8018";
    var host = "http://localhost:8018";
    var path = "/mc/http/interface.ms?model=ReSendProjectReportIntfImpl&method=sync";
