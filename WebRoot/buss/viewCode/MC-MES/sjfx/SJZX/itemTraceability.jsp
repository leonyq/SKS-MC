						...
						<div class="datagrid-header" style="width:100%">
							<div class="datagrid-header-inner head" id="" style="width:100%;">
								...
								<tr class="datagrid-header-row thcolor">
										...
										<td class="datagrid-cell" style="width:220px;"><dict:lang value="物料SN" /></td >
										<td class="datagrid-cell statusRoll" style=""><dict:lang value="状态" /></td >
									</tr> 
								</tbody>	
								</table>
							</div>
				...
				success: function(data){
						...
						if(null != data.ajaxPage.dataList){
							...
							for(var i=0;i<rccList.length;i++){
								...
								$("#datagrid-btable-ajax1111 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:220px;text-align: center;'><span style='display: inline;border-bottom: 1px solid #004098'>"+rccList[i].WMI_ITEM_SN+"</span></td>");
								$("#datagrid-btable-ajax1111 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='text-align: center;'>"+rccList[i].STOCK_FLAG+"</td>");
							}
				...
				success: function(data){
						...
						if(null != data.ajaxPage.dataList){
							...
							for(var i=0;i<rccList.length;i++){
								...
								$("#datagrid-btable-ajax1111 tr:last").append("<td class='datagrid-cell datagrid-cell-1' style='width:30px!important;text-align: center;'>"+((currentPage-1)*pageRecord+(i+1))+"</td>");
								$("#datagrid-btable-ajax1111 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:220px;text-align: center;'><span style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].WMI_ITEM_SN+"</span></td>");
								$("#datagrid-btable-ajax1111 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='text-align: center;'>"+rccList[i].STOCK_FLAG+"</td>");
							}
				...
				success: function(data){
						...
						if(null != data.ajaxPage.dataList){
							...
							for(var i=0;i<rccList.length;i++){
								...
								$("#datagrid-btable-ajax2222 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:150px;'><span onclick='itemJump6(\""+rccList[i].WTI_DOC_NUM+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].WTI_DOC_NUM+"</span></td>");
				...
				success: function(data){
						...
						if(null != data.ajaxPage.dataList){
							...
							for(var i=0;i<rccList.length;i++){
								...
								$("#datagrid-btable-ajax3333 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:150px;'><span onclick='itemJump1(\""+rccList[i].WIT_SN+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].WIT_SN+"</span></td>");
								$("#datagrid-btable-ajax3333 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:150px;' title='"+rccList[i].WIT_MO_NUMBER+"'><span onclick='itemJump2(\""+rccList[i].WIT_MO_NUMBER+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].WIT_MO_NUMBER+"</span></td>");
								$("#datagrid-btable-ajax3333 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:120px;' title='"+rccList[i].PM_PROJECT_ID+"'><span onclick='itemJump3(\""+rccList[i].PM_PROJECT_ID+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].PM_PROJECT_ID+"</span></td>");
								$("#datagrid-btable-ajax3333 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:120px;' title='"+rccList[i].WIT_MODEL_CODE+"'><span onclick='itemJump4(\""+rccList[i].WIT_MODEL_CODE+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].WIT_MODEL_CODE+"</span></td>");
				...
				success: function(data){
						...
						if(null != data.ajaxList){
							...
							for(var i=0;i<rccList.length;i++){
								...
								$("#datagrid-btable-ajax4444 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:150px;' title='"+rccList[i].QII_INSPECT_SN+"'><span onclick='itemJump5(\""+rccList[i].QII_INSPECT_SN+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].QII_INSPECT_SN+"</span></td>");
