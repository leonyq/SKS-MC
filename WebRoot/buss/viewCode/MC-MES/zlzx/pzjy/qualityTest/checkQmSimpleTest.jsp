    ...
    <form id="editForm" name="editForm" action="${path}buss/bussModel_editAjaxComm.ms" method="post" target="submitFrame"
        ...
        <div class="bd">
            ...
            <table class="basic-table">
                ...
                <s:set name="_$viewId" value="'99be8ec025544c7c842ebd3ae85676dd'"/>
                ...
                <tr>
                    ...
                    <bu:td cssClass="dec-self" colNo="QT_EXAMINE_EMP" formId="50c012f45e304e2993fb61b37d32e6be">
                        <bu:ui colNo="QT_EXAMINE_EMP" formId="50c012f45e304e2993fb61b37d32e6be" dataId="${dataId}" formIndex="1"/>
                    </bu:td>
                    ...
                    <bu:td cssClass="dec-self" colNo="QT_EXAMINE_RESULT" formId="50c012f45e304e2993fb61b37d32e6be">
                        <bu:ui colNo="QT_EXAMINE_RESULT" formId="50c012f45e304e2993fb61b37d32e6be" dataId="${dataId}" formIndex="1"/>
                    </bu:td>
                </tr>
                ...
                <tr>
                    ...
                    <bu:td cssClass="dec-self" colNo="QT_EXAMINE_TIME" formId="50c012f45e304e2993fb61b37d32e6be">
                        <bu:ui colNo="QT_EXAMINE_TIME" formId="50c012f45e304e2993fb61b37d32e6be" dataId="${dataId}" formIndex="1"/>
                    </bu:td>
                </tr>
                ...
                <tr>
                    ...
                    <bu:td cssClass="dec-self" colspan="3" colNo="QT_EXAMINE_CONTENT" formId="50c012f45e304e2993fb61b37d32e6be">
                        <bu:ui colNo="QT_EXAMINE_CONTENT" formId="50c012f45e304e2993fb61b37d32e6be" dataId="${dataId}" formIndex="1"/>
                    </bu:td>
                </tr>
...
<script type="text/javascript">
    $(function () {
        $("#paraMapObj_QT_PROJECT_ID").css("disabled", "disabled");
        $("#paraMapObj_QT_PROJECT_ID_SHOW").css("disabled", "disabled");

        $("#paraMapObj_QT_MODEL_CODE").css("disabled", "disabled");
        $("#paraMapObj_QT_MODEL_CODE_SHOW").css("disabled", "disabled");
    });
</script>
