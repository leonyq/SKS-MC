...
<head>
 ...
 function searchModelInfo(paginationImpl){
        var url = "${path}buss/bussModel_exeFunc.ms?funcMId=04874ae67fc6445ea54ac4c9e251cacf";//VM-机种检测类型-新增 操作功能 校验类型信息分页
...
function getModel(){
var modelUrl="${path}buss/bussModel_exeFunc.ms?funcMId=a0dc7811626c42b391ab265406b59f0d";//VM-机种检测类型-新增 操作功能 检验类型信息弹窗

            var checkType = $("#paraMap1_QMT_TEST_STEP").val();
            var sampleType = $("#paraMap1_QMT_SAMPLE_TYPE").val();
            var dataAuth = $("#deptLs_data_auth").val();
            var jsondata={"type":"1","checkType":checkType,"dataAuth":dataAuth,"sampleType":sampleType};
...
function SearchModelInfo(paginationImpl,url){
	...
	var getNeedSelUrl="${path}buss/bussModel_exeFunc.ms?funcMId=e0dc5bed321f4bdeac4c96c76dfd0a75";//VM-机种检测类型-新增 操作功能 获取检验项目信息所需下拉框
  ...
  <h3 class="tit"><dict:lang value="基本信息" /></h3>	
	...
	<input type="hidden" name="itemGenre" id="itemGenre" value="" />
		...
		<tr>	
            ...
            <td class="name" /><span class="dot">*</span><bu:uitn colNo="QMT_SAMPLE_TYPE" formId="95f9041534d84ce2ab92935d2ade0945" /></td>
			...
			<div class="mod-bd" style="margin-top:5px;border-bottom: none;">
				<div class="panel datagrid datagrid-div1">
					<div class="datagrid-div2 datagrid-div6 datagrid-view"  id="datagrid-view">
						...
						<div class="datagrid-body datagrid-div3 scroll1"   style="height:264px;">
