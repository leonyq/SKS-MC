...
<body>
    <div class="content-in">
		...
		<bu:tr cssClass="datagrid-header-row datagrid-title-ajax" id="datagrid-title-ajax">
			...
			<td class="datagrid-cell" style="width:200px;"><bu:uitn colNo="DATA_AUTH" formId="fba7fc49f50e4a7d80996a6a5d0fe903" /></td>
			...
			<td class="datagrid-cell" style="width:140px;"><bu:uitn colNo="QIE_HANDLE_TIME" formId="fba7fc49f50e4a7d80996a6a5d0fe903" /></td>
		</bu:tr>
		</tbody>
		</bu:table>
		</div>
...
function createTableModel(ms,formId){
    ...
    if(formId=='fba7fc49f50e4a7d80996a6a5d0fe903'){<%--FM-检验单不良处理信息--%>
        $.each(uiTxt,function(i,v){
            ...
            arrHtml.push("<span colno='QIE_SN' class='"+ms.uiClass(formId, 'QIE_SN')+"' onclick='itemJump1(\""+v['QIE_SN']+"\")' style='display: inline;border-bottom: 1px solid #004098;' "+ms.uiEvent(formId, 'QIE_SN')+" title='"+ms.titleAttr(formId,'QIE_SN','IS_TITLE_ATTR',v)+"' >"+v['QIE_SN']+"</span>")
            arrHtml.push("</td>");
            ...
            arrHtml.push("<span colno='QIE_INSPECT_SN' class='"+ms.uiClass(formId, 'QIE_INSPECT_SN')+"' onclick='itemJump2(\""+v['QIE_INSPECT_SN']+"\")' style='display: inline;border-bottom: 1px solid #004098;' "+ms.uiEvent(formId, 'QIE_INSPECT_SN')+" title='"+ms.titleAttr(formId,'QIE_INSPECT_SN','IS_TITLE_ATTR',v)+"' >"+v['QIE_INSPECT_SN']+"</span>")
            arrHtml.push("</td>");
            ...
            arrHtml.push("<span colno='QIE_ITEM_CODE' class='"+ms.uiClass(formId, 'QIE_ITEM_CODE')+"' onclick='itemJump3(\""+v['QIE_ITEM_CODE']+"\")' style='display: inline;border-bottom: 1px solid #004098;' "+ms.uiEvent(formId, 'QIE_ITEM_CODE')+" title='"+ms.titleAttr(formId,'QIE_ITEM_CODE','IS_TITLE_ATTR',v)+"' >"+v['QIE_ITEM_CODE']+"</span>")
            arrHtml.push("</td>");
            ...
            arrHtml.push("</td>");
            arrHtml.push("<td colno='QIE_HANDLE_TIME' class='datagrid-cell "+ms.tdClass(formId, 'QIE_HANDLE_TIME')+"' style='width:140px;text-align:center;"+ms.tdStyle(formId, 'QIE_HANDLE_TIME')+"' "+ms.tdEvent(formId, 'QIE_HANDLE_TIME')+">")
