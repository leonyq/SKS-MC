...
<body>
                ...
                <div style="margin-left:40px;">
	               <s:if test="${isDataAuth == '1'}">
			    	...
			    	<div class="optn">
			    	        ...
			    	        <button id="filter" style="display:none;" type="button" onclick="filterInfo();"><i class="ico ico-save"></i><dict:lang value="筛选" /></button>
        				
        				<button id="close" style="display:none;" type="button" onclick="closeWindow();" ><i class="ico ico-cancel"></i><dict:lang value="取消" /></button>
	...
	<input type="hidden" name="paraMap1@__DATA_COUNT__" value="1" />
		...
		<tr>
            ...
            <bu:td cssClass="dec-self" colNo="QII_FILE_NAME" formId="339caba30f6c4d78957a3815da1d1fdf" ><bu:ui colNo="QII_FILE_NAME"  formId="339caba30f6c4d78957a3815da1d1fdf" dataId="${dataId}" formIndex="1" style="width: 100%;" /></bu:td>
		</tr>
		<tr>
			...
			<td colspan="5">
				<bu:ui colNo="QII_INSEPCT_BASIS" disabled="disabled" style="margin-left:5px;height:80px;width: 354px;" formId="339caba30f6c4d78957a3815da1d1fdf" dataId="${dataId}" formIndex="1" /> &#x3000;
		...
		<table class="basic-table" >
			<!--<tr>
				...
				<td class="name" style="width:80px;"><bu:uitn colNo="QII_FILE_NAME" formId="339caba30f6c4d78957a3815da1d1fdf" /></td>
				<bu:td cssClass="dec" colNo="QII_FILE_NAME" formId="339caba30f6c4d78957a3815da1d1fdf" ><bu:ui colNo="QII_FILE_NAME" disabled="disabled" name="upFile" formId="339caba30f6c4d78957a3815da1d1fdf" dataId="${dataId}" formIndex="1" style="display:none;"/></bu:td>
				<td class="name">&nbsp;</td>
				<td class="dec" >&nbsp;</td>
				<td class="name" >&nbsp;</td>
				<td class="dec" >&nbsp;</td>
			...
			<tr>
				<td class="name" style="width:90px;"/><bu:uitn colNo="QII_CONCESSION_MEMO" formId="339caba30f6c4d78957a3815da1d1fdf" /></td>
				<bu:td cssClass="dec" colNo="QII_CONCESSION_MEMO" formId="339caba30f6c4d78957a3815da1d1fdf" colspan="5" style="height:80px;"><bu:ui colNo="QII_CONCESSION_MEMO" disabled="disabled" style="width: 100%;height: 100%;" formId="339caba30f6c4d78957a3815da1d1fdf" dataId="${dataId}" formIndex="1" /></bu:td>
			</tr>
			</table>
	   </div>
	</DIV>
	<DIV id="content2" style="display:none" data-tab="tag2">
		<!--<div class="panel datagrid datagrid-div1" name="itemTable" id="itemTable4">
										<div class="datagrid-div2 datagrid-div6 datagrid-view" id="datagrid-header1" >
											<div class="datagrid-header2" style="border-top:0px;soild;white;">
												<div class="datagrid-header-inner" id="datagrid-header-inner" style="width:100%">
													<table class="datagrid-htable fixedTable " style="margin-top: 5px;">
														<tbody>-->
		<div class="panel datagrid datagrid-div1" name="itemTable" id="itemTable4">
...
<script type="text/javascript">
	...
	function getItemInfo(){
		...
		$.ajax({
			    type: "POST",
			    dataType: "json",
			    url: "buss/bussModel_exeFunc.ms?funcMId=fa2754ab739d4b719e8735125092085d",
			    data: jsondata,
				success: function(data){
						if(null != data.ajaxPage.dataList){
							...
							for(var i = 0;i < rccList.length; i++){
								...
								if(rccList[i].QIP_SAMPLE_FLAG=='Y') tempFlag="<img src='/mes/plf/page/fp/img/ico-state-h.png' width='35' height='15' class='mCS_img_loaded'>";
								if(rccList[i].QIP_SAMPLE_FLAG=='N') tempFlag="<img src='/mes/plf/page/fp/img/ico-state.png' width='35' height='15' class='mCS_img_loaded'>";
	...
	var dataAuth = $("#deptLs_data_auth").val();
		...
		util.showLoading("处理中...");
			$.ajax({
				type: "POST",
			    dataType: "json",
			    url: "buss/bussModel_exeFunc.ms?funcMId=9c8cea646bde41e0825618e980bbc9bd",
	...
	function filterInfo(){
			...
			var result=$("#paraMapObj_QII_INSEPCT_RESULT").val();
  			...
  			document.forms.editForm.action = "buss/bussModel_exeFunc.ms?funcMId=513676a477634048a4526808d1edbfd3&result="+result+"&checkNo="+checkNo1;
	...
	//点击行寄选中该行
		...
		function select_All(index){
		    if(index==4){
                        var check = $("#selectAll"+index).attr("checked")=="checked"||$("#selectAll"+index).attr("checked")=="true"?true:false;
            $("#datagrid-btable-ajax339caba30f6c4d78957a3815da1d1234").find("tbody :checkbox").each(function(){
