...
<div class="mod-hd">		
  <h3 class="tit"><dict:lang value="基本信息" /></h3>	
	...
	<input type="hidden" name="paraMap1@__DATA_COUNT__" value="1" />
		<s:set name="_$viewId" value="'60f8750762204255b8942ed162da41a3'" />
...
<!---->
	...
	<table class="basic-table" >
        ...
        <tr>
			<td class="name" style="width:65px;"/><span class="dot">*</span><bu:uitn colNo="CPR_PERMANENT_IMPROVE_MEASURE" formId="0affca5a6d75419ab073cd608cc5e1e2" /></td>
...
function editCal(){
  ...
  document.forms.editForm.action = "${path}buss/bussModel_exeFunc.ms?funcMId=2e8a263a82564d7ca16bc12e764b20eb";
