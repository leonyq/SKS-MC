...
<script type="text/javascript">
	...
	function switchTag(tag, content, url) {
		if (currentTag == tag) {
      	...
      	var docNumber = $("#paraMap1_CRD_DOC_NUMBER").val();
			if (docNumber == '') {
...
<DIV class="multilist comwrap content-in">
	<div class="edit">
		<form id="addForm" name="addForm"
			action="${path}buss/bussModel_addAjaxComm.ms?<s:property value='%{@com.more.fw.core.common.method.Constants@FUNC_CODE}' />=<s:property value='%{FUNC_CODE_2}' />"
			method="post" <bu:formet exeid="%{exeid}" /> target="submitFrame">
			<div class="hd">

				<div style="margin-left:10px;">
					<div class="save-close save-not-close"
						title=" <dict:lang value = '开启保存并关闭窗口' /> "
						onclick="saveClose(this)"></div>
					<input type="checkbox" id="isCloseWin" name="isCloseWin" value="1"
						style="display:none;" />
					<s:if test="${isDataAuth == '1'}">
						...
						<s:if test="${fn:length(deptLs)==1}">
							<s:select list="deptLs" listKey="id" listValue="name"
								name="_DATA_AUTH" id="deptLs_data_auth" cssStyle="width: 200px;"
								cssClass="_VAL_NULL dept_select" />
						</s:if>
						<s:else>
							<s:select list="deptLs" headerKey=""
								headerValue='--%{getText("请选择")}--' listKey="id"
								listValue="name" name="_DATA_AUTH" id="deptLs_data_auth"
				...
				<div class="optn">
					<button type="button" id="saveBtn"
						onclick="saveRework(this,'${formId}');">
						<i class="ico ico-save"></i><dict:lang value="生成返工单"/>
					</button>
			...
			<bu:set name="paraMapObj" value="${dataId}"
				formId="d23be1e0a97e488c922c8d1144b774e9" type="add" />
			<div class="js-tab">
				<DIV id="container" style="padding:0 20px;box-sizing: border-box;height:580px;">
					<!--<DIV class="hd"> -->
					...
					<DIV class="content1" id="content">
						<DIV id="content1" data-tab="tag1">
							...
							<table class="basic-table" id="tableRe">
								...
								<input type="hidden" id="paraMap1_CRD_DOC_NUMBER" />
								<s:set name="_$viewId"
									value="'8b3810078af24377978cab5a12c2de9c'" />
								...
								<tr>
									...
									<bu:td cssClass="dec-self" style="width:200px;"
										...
										<bu:ui colNo="CRI_REWORK_MO"
											formId="d23be1e0a97e488c922c8d1144b774e9"
											value="%{CRI_REWORK_MO}" formIndex="1" />
									</bu:td>
									...
									<bu:td cssClass="dec-self" style="width:200px;"
										...
										<bu:ui colNo="CRI_REWORK_TECH"
											formId="d23be1e0a97e488c922c8d1144b774e9"
											value="%{CRI_REWORK_TECH}" formIndex="1" />
									</bu:td>
									...
									<bu:td cssClass="dec-self" style="width:200px;"
										...
										formId="d23be1e0a97e488c922c8d1144b774e9">
										<select id="paraMapObj_CRI_REWORK_INPUT"
											name="paraMap1@0#CRI_REWORK_INPUT"
											class="_VAL_NULL  input isSubmit  dept_select">
											<option value="">
												<dict:lang value="--请选择--" />
											</option>
								...
								<tr>
									...
									<bu:td cssClass="dec-self" colNo="CRI_REWORK_MODEL"
										...
										<bu:ui colNo="CRI_REWORK_MODEL"
											formId="d23be1e0a97e488c922c8d1144b774e9"
											value="%{CRI_REWORK_MODEL}" readonly="readonly" cssClass="readonly isaddSubmit" formIndex="1" />
									</bu:td>
									<td class="name-six" />
									...
									<bu:td cssClass="dec-self" colNo="CRI_INSPECT_NUM"
										...
										<bu:ui colNo="CRI_INSPECT_NUM"
											formId="d23be1e0a97e488c922c8d1144b774e9"
											value="%{CRI_INSPECT_NUM}" formIndex="1" />
									</bu:td>
									...
									<bu:td cssClass="dec-self" colNo="CRI_ERROR_NUM"
										...
										<bu:ui colNo="CRI_ERROR_NUM"
											formId="d23be1e0a97e488c922c8d1144b774e9"
											value="%{CRI_ERROR_NUM}" formIndex="1" />
									</bu:td>
								...
								<tr>
									...
									<bu:td cssClass="dec-self" colNo="CRI_ORIGINAL_FLAG"
										...
										<bu:ui colNo="CRI_ORIGINAL_FLAG"
											formId="d23be1e0a97e488c922c8d1144b774e9"
											value="%{CRI_ORIGINAL_FLAG}" onclick="originalCheck(this)" formIndex="1" />
									</bu:td>
									<td class="name-six" />
									<bu:uitn colNo="CRI_FILE_NAME"
										formId="d23be1e0a97e488c922c8d1144b774e9" />
									</td>
									<td class="dec-self" colspan="3"><input type="file"
										name="upFile" id="upFile" /></td>
								...
								<tr>
									...
									<bu:td cssClass="dec-self" colspan="5" colNo="CRI_MEMO"
										formId="d23be1e0a97e488c922c8d1144b774e9">
										<bu:ui colNo="CRI_MEMO" rows="3"
											formId="d23be1e0a97e488c922c8d1144b774e9" value="%{CRI_MEMO}"
	...
	<script type="text/javascript">
		...
		$(function() {
			...
			$("#paraMap1_KZ_JYPH").removeAttr("disabled");
			$("#paraMap1_KZ_RQSN").removeAttr("disabled");
		...
		function originalCheck(obj){
		   if (obj.checked) {
				var criMo = $("#paraMap1_CRI_REWORK_MO").val();
				if (criMo == '' || criMo == null) {
					utilsFp.confirmIcon(3, "", "", "",
							"<dict:lang value="返工制令单必须选择" />", 0, "360", "");
					document.getElementById("paraMap1_CRI_ORIGINAL_FLAG_1").checked=false;
					
					return;
				}
				$("#paraMap1_CRI_MO_NUMBER").val(criMo);
				$("#paraMap1_CRI_MO_NUMBER_SHOW").val(criMo);
				$("#paraMap1_CRI_MO_NUMBER_SHOW").attr("disabled","disabled");
			
		   }
		   else{
		    $("#paraMap1_CRI_MO_NUMBER_SHOW").removeAttr("disabled");
		   }
		}
		function searchTracking(paginationImpl) {
			...
			var moNumber = $("#paraMap1_CRI_MO_NUMBER").val();
			var modelCode = $("#paraMap1_KZ_MODEL").val();
			var jyph = $("#paraMap1_KZ_JYPH").val();
			var rqsn = $("#paraMap1_KZ_RQSN").val();
			...
			$.ajax({
						...
						success : function(data) {
							...
							if (null != data.ajaxPage.dataList) {
								...
								for ( var i = 0; i < rccList.length; i++) {
								 if(rccList[i].PSI_CONTAINER_SN==null || rccList[i].PSI_CONTAINER_SN=='null'){
									...
									$("#addTracking tr:last").append(
											"<td class='datagrid-cell datagrid-cell-8' style='display:none;'>"
													+ rccList[i].WT_NUM + "</td>");	
							...
							var tableTrJs = $("#addTracking tbody tr");
		...
		function searchHadTracking(paginationImpl) {
			...
			$.ajax({
						...
						success : function(data) {
							...
							pageFun(data.ajaxPage, paginationImpl);
							var tableTrJs = $("#addTracking3 tbody tr");
							_tongLineColor(tableTrJs);
							clickTr('addTracking3');
...
function nullToEmpty(str){
	 ...
	 return str;
		...
		function saveRework() {
			...
			if ($("#isCloseWin")
					&& $("#addForm").find("#isCloseWin").length == 0) {
				$("#addForm").append($("#isCloseWin").clone());
				$("#addForm")
						.find("#isCloseWin")
						.wrap(
								"<div id=\"isCloseWinDiv\" style=\"display:none;\"></div>");
			}

			document.forms.addForm.action = reworkurl + "&type=saveRework";
			document.forms.addForm.submit();
			isQuery = true;
		}

		function addParentData(msg, title, width, height, time, docNumber) {
			$("#paraMap1_CRD_DOC_NUMBER").val(docNumber);
