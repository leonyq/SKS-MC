...
<body style="background-color: #fff;"
						...
						<DIV id="content1" data-tab="tag1">
							...
							<table class="basic-table" id="tableRe">
								...
								<input type="hidden" name="paraMap1@__DATA_COUNT__" value="1" />
									<input type="hidden" id="paraMapObj_CRD_DOC_NUMBER" value="${paraMapObj.CRI_DOC_NUMBER }"/>
								...
								<tr>
									...
									<bu:td cssClass="dec-self" style="width:200px;"
										...
										<bu:ui colNo="CRI_REWORK_TECH"
											formId="d23be1e0a97e488c922c8d1144b774e9"
											dataId="${dataId}" formIndex="1" readonly="readonly" cssClass="readonly isaddSubmit" disabled="disabled"/>
									</bu:td>
									<td class="name-six" style="width:96px;" />
									...
									<bu:td cssClass="dec-self" style="width:200px;"
										...
										formId="d23be1e0a97e488c922c8d1144b774e9">
										<bu:ui colNo="CRI_REWORK_INPUT" dataId="${dataId}"
											formId="d23be1e0a97e488c922c8d1144b774e9" readonly="readonly" cssClass="readonly isaddSubmit" disabled="disabled"
											 formIndex="1" />
									</bu:td>
								...
								<tr>
									...
									<bu:td cssClass="dec-self" colNo="CRI_INSPECT_NUM"
										...
										<bu:ui colNo="CRI_INSPECT_NUM"
											formId="d23be1e0a97e488c922c8d1144b774e9"
											dataId="${dataId}" readonly="readonly" cssClass="readonly isaddSubmit" disabled="disabled" formIndex="1" />
									</bu:td>
									<td class="name-six" />
								...
								<tr>
									...
									<bu:td cssClass="dec-self" colNo="CRI_ORIGINAL_FLAG"
										...
										<bu:ui colNo="CRI_ORIGINAL_FLAG"
											formId="d23be1e0a97e488c922c8d1144b774e9"
											dataId="${dataId}" onclick="originalCheck(this)" readonly="readonly" cssClass="readonly isaddSubmit" disabled="disabled" formIndex="1" />
									</bu:td>
									<td class="name-six" />
									...
									<bu:ui colNo="CRI_SYS_NAME" name="upFile" formId="d23be1e0a97e488c922c8d1144b774e9" dataId="${dataId}" readonly="readonly" cssClass="readonly isaddSubmit" disabled="disabled" formIndex="1" />
                                   </td>
								...
								<tr>
									...
									<bu:td cssClass="dec-self" colspan="5" colNo="CRI_MEMO"
										...
										<bu:ui colNo="CRI_MEMO" rows="3"
											formId="d23be1e0a97e488c922c8d1144b774e9" dataId="${dataId}" readonly="readonly" cssClass="readonly isaddSubmit" disabled="disabled" 
											formIndex="1" style="width:100%;height:80px;" />
									</bu:td>
								</tr>
								...
								<table class="basic-table">
									<tr>
										...
										<bu:td cssClass="dec-self" style="width:200px;"
											...
											<bu:ui colNo="CRI_MO_NUMBER"
												formId="d23be1e0a97e488c922c8d1144b774e9"
												dataId="${dataId}"  cssClass="readonly isaddSubmit" readonly="readonly" disabled="disabled" formIndex="1" />
										</bu:td>
										<td class="name-six" style="width:96px;" />
										...
										<bu:td cssClass="dec-self" style="width:200px;"
											...
											<bu:ui colNo="KZ_MODEL"
												formId="d23be1e0a97e488c922c8d1144b774e9"
												 cssClass="readonly isaddSubmit" readonly="readonly" disabled="disabled" formIndex="1" />
										</bu:td>
										<td class="name-six" style="width:96px;" />
										...
										<bu:td cssClass="dec-self" style="width:200px;"
											...
											<bu:ui colNo="KZ_JYPH"
												formId="d23be1e0a97e488c922c8d1144b774e9" value="%{KZ_JYPH}"  cssClass="readonly isaddSubmit" readonly="readonly" disabled="disabled"
												formIndex="1" />
										</bu:td>
									...
									<tr>
										...
										<bu:td cssClass="dec-self" colNo="KZ_RQSN"
											formId="d23be1e0a97e488c922c8d1144b774e9">
											<bu:ui colNo="KZ_RQSN"
												formId="d23be1e0a97e488c922c8d1144b774e9" value="%{KZ_RQSN}"  cssClass="readonly isaddSubmit" readonly="readonly" disabled="disabled"
												formIndex="1" />
										</bu:td>
										...
										<td class="dec-self"><input type="text" id="wtSn"
											name="wtSn" class="isSubmit input _VAL_DATABASE readonly isaddSubmit"  readonly="readonly" disabled="disabled"></td>
	...
	var reworkurl= "${path}buss/bussModel_exeFunc.ms?funcMId=b9782e3489a741b5bd656493cebb0f09";
		...
		$(function() {
		   // document.getElementById("paraMapObj_CRI_SYS_NAME_a").style.display = "none";
								...
								for ( var i = 0; i < rccList.length; i++) {
									...
									$("#addTracking tr:last").append(
											"<td class='datagrid-cell datagrid-cell-3' style='width: 120px;'>"
													...
													+ "</td>");
									$("#addTracking tr:last").append(
											"<td class='datagrid-cell datagrid-cell-4' style='width: 100px;'>"
													+ rccList[i].WT_GROUP_CODE
													+ "</td>");
									$("#addTracking tr:last").append(
											"<td class='datagrid-cell datagrid-cell-5' style='width:100px;align:center;'>"
													+ repairState + "</td>");
                                    $("#addTracking tr:last").append("<td class='datagrid-cell ' style='display:none;'>"+ rccList[i].WT_NUM+"</td>");	
								}
							}
	 ...
	 return str;
		...
		function fromNoToYes2() {
			...
			$("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a1234 tbody tr ").each(function(i) {
				...
				reS.WT_NUM=$(this).find("td").eq(6).find('input').val();
				reArr.push(reS);
			...
			if (state != '正常') {
				utilsFp.confirmIcon(3, "", "", "",
						"<dict:lang value="未选择的产品状态非正常的不允许变成已选择产品" />", 0,
						"360", "");
				return false;
			}
			//console.log(reArr);
		...
		function fromNoToYes1() {
			...
			$("input[name='isSelect1']:checked").each(function(i) {
				...
				reS.WT_NUM=$tr.find("td").eq(6).text();
				reArr.push(reS);
		...
		function queryGroup(routeId) {
			...
			routeId = $("#paraMapObj_CRI_REWORK_TECH").val();
				console.log("routeId:"+routeId);
			$("#paraMapObj_CRI_REWORK_INPUT").append("<option value='''><dict:lang value="--请选择--"/></option>");
			jQuery.ajax({
						type : "POST",
						dataType : "json",
						url : reworkurl,
						...
						success : function(data) {
							...
							$("#paraMapObj_CRI_REWORK_INPUT").trigger("chosen:updated");
						},
