...
<head>
	...
	<title><dict:lang value="维护" /></title>
...
<body>
	...
	<input type="hidden" name="paraMap1@__DATA_COUNT__" value="1" />
		<s:set name="_$viewId" value="'c09deca65baa43cdbb3bd21cbc024518'" />
	     ...
	     $("#paraMapObj_CSI_MAINTENANCE").removeAttr("disabled");
	 	 ...
	 	 var isQuery = false;
                    function edit(thisObj){				
                            ...
                            emptyValToHide();
                            document.forms.editForm.action = "${path}buss/bussModel_exeFunc.ms?funcMId=e4e8420b2a224397adfc3d84f51ce33b&id="+id;
