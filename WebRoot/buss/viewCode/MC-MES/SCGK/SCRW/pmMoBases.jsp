...
<input type="hidden" name="formId" value='9b18994844b049f2ad90204b77793334'/>
 ...
 <div class="datagrid-header-inner" id="datagrid-header-inner">
		<bu:table  id="datagrid-htable-kz"  cssClass="datagrid-htable fixedTable datagrid-div6"  style="min-width:1870px;">
		<s:set name="_$type" value="'view'" />
		<tbody>
		<bu:tr cssClass="datagrid-header-row" id="datagrid-title-kz">
			<td class="datagrid-cell" style="width:30px; text-align:center" >123<bu:thSeq  formId="9b18994844b049f2ad90204b77793334" i18n="1"/></td>
			...
			<td class="datagrid-cell" style="width: 150px;"><bu:uitn colNo="PM_PRODUCT_STEP" formId="9b18994844b049f2ad90204b77793334" /></td>
            ...
            <td class="datagrid-cell" style="width:90px;"><bu:uitn colNo="PM_PROCESS_FACE" formId="9b18994844b049f2ad90204b77793334" /></td>
            <td class="datagrid-cell" style="width:90px;"><bu:uitn colNo="PM_TRACK" formId="9b18994844b049f2ad90204b77793334" /></td>
			<td class="datagrid-cell" style="width:90px;"><bu:uitn colNo="PM_ISSUED_DATE" formId="9b18994844b049f2ad90204b77793334" /></td>
		...
		<bu:table cssClass="datagrid-btable fixedTable" id="datagrid-btable-kz"  style="min-width:1870px;">
...
<bu:tdSBox formidFirstId="9b18994844b049f2ad90204b77793334" /></td>
			...
			<bu:td cssClass="datagrid-cell datagrid-cell-7" style="width: 150px;" colNo="PM_PRODUCT_STEP" formId="9b18994844b049f2ad90204b77793334" >
				<bu:ui colNo="PM_PRODUCT_STEP" formId="9b18994844b049f2ad90204b77793334" value="%{PM_PRODUCT_STEP}" seq="%{#seq}" />
			</bu:td>
			...
			<bu:td cssClass="datagrid-cell datagrid-cell-13"  style="width:90px;" colNo="PM_PROCESS_FACE" formId="9b18994844b049f2ad90204b77793334" >
				<bu:ui colNo="PM_PROCESS_FACE" formId="9b18994844b049f2ad90204b77793334" value="%{PM_PROCESS_FACE}" seq="%{#seq}" />
			</bu:td>
				<bu:td cssClass="datagrid-cell datagrid-cell-14" style="width:90px;" colNo="PM_TRACK" formId="9b18994844b049f2ad90204b77793334" >
			<bu:ui colNo="PM_TRACK" formId="9b18994844b049f2ad90204b77793334" value="%{PM_TRACK}" seq="%{#seq}" />
			</bu:td>
			<bu:td cssClass="datagrid-cell datagrid-cell-15"  style="width:90px;" colNo="PM_ISSUED_DATE" formId="9b18994844b049f2ad90204b77793334" >
  ...
  <% }}%></div>
    ...
    function getCompDevice(dataId){
        var loadItemUrl="${path}buss/bussModel_exeFunc.ms?funcMId=e218881085f84f7cac4e30879cef264a";
        $.ajax({
            type:"post",
            dataType:"json",
            data:"dataId="+dataId,
            ...
            success:function(data){
                ...
                if(null!=data.ajaxString){
                    ...
                    if(com==1){
                         var url = "${path}buss/bussModel_exeFunc.ms?FUNC_CODE=F3456&funcMId=451bcb014e3f4bb287dac878a4ed8d98&formId="+formId+"&iframeId="+_currentFrame+"&dataId="+_selectedEditTr.attr("id");
                        //  var url = "@{funcUrl}&formId="+formId+"&dataId="+_selectedEditTr.attr("id");
                        //  showPopWinFp(url, 663, 300,null,"%{getText("关结")}");
                          showPopWinFp(url, 500, 300,null,"关结");
                    }else{
                         utilsFp.confirmIcon(3,"","","", "请先下线",0,"300","");
                    }
