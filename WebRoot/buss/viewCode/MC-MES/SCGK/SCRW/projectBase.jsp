					...
					<div class="datagrid-div2 datagrid-div6 datagrid-view-ajax" id="datagrid-view-ajaxd34c8f48bead40d88c24a153c731de82" style="">
						<div class="datagrid-header">
							<div class="datagrid-header-inner" id="datagrid-header-innerd34c8f48bead40d88c24a153c731de82">
								<bu:table cssClass="datagrid-htable fixedTable datagrid-div6 datagrid-htable-kz" id="datagrid-htabled34c8f48bead40d88c24a153c731de82" style="min-width:2030px;">
									...
									<bu:tr cssClass="datagrid-header-row datagrid-title-ajax" id="datagrid-title-ajax">
										...
										<!--<td class="datagrid-cell" style="width:200px;"><bu:uitn colNo="DATA_AUTH" formId="d34c8f48bead40d88c24a153c731de82" /></td>-->
										<td class="datagrid-cell" style="width:110px;"><bu:uitn colNo="PROJECT_ID" formId="d34c8f48bead40d88c24a153c731de82" /></td>
										<td class="datagrid-cell" style="text-align:center;width:100px;"><bu:uitn colNo="PROJECT_STATUS" formId="d34c8f48bead40d88c24a153c731de82" /></td>
										<td class="datagrid-cell" style="text-align:center;width:110px;"><bu:uitn colNo="IS_REL" formId="d34c8f48bead40d88c24a153c731de82" /></td>
										<td class="datagrid-cell" style="width:110px;"><bu:uitn colNo="PRODUCT_MATERIAL" formId="d34c8f48bead40d88c24a153c731de82" /></td>
										<td class="datagrid-cell" style="width:200px;"><bu:uitn colNo="PRODUCT_NAME" formId="d34c8f48bead40d88c24a153c731de82" /></td>
										<td class="datagrid-cell" style="width:150px;"><bu:uitn colNo="PRODUCT_STANDARD" formId="d34c8f48bead40d88c24a153c731de82" /></td>

										<td class="datagrid-cell" style="width:150px;"><bu:uitn colNo="LOT_NUMBER" formId="d34c8f48bead40d88c24a153c731de82" /></td>

										<td class="datagrid-cell" style="width:70px;"><bu:uitn colNo="PRODUCT_COUNT" formId="d34c8f48bead40d88c24a153c731de82" /></td>
										<!--<td class="datagrid-cell" style="width:110px;"><bu:uitn colNo="FAI_NUM" formId="d34c8f48bead40d88c24a153c731de82" /></td>-->
										...
										<td class="datagrid-cell" style="width:140px;"><bu:uitn colNo="PROLEPSIS_START_DATE" formId="d34c8f48bead40d88c24a153c731de82" /></td>
										<td class="datagrid-cell" style="width:140px;"><bu:uitn colNo="PROLEPSIS_END_DATE" formId="d34c8f48bead40d88c24a153c731de82" /></td>
										...
										<td class="datagrid-cell" style="width:140px;"><bu:uitn colNo="EDIT_TIME" formId="d34c8f48bead40d88c24a153c731de82" /></td>
									</bu:tr>
									</tbody>
								</bu:table>
							</div>
						...
						<div class="datagrid-body datagrid-div3 datagrid-body-ajax" id="tableDivd34c8f48bead40d88c24a153c731de82" onscroll="ajaxTableScroll(this,'d34c8f48bead40d88c24a153c731de82')">
							<table class="datagrid-btable fixedTable dblClick"  id="datagrid-btable-ajaxd34c8f48bead40d88c24a153c731de82" style="min-width:2030px;">
    ...
    function createTableModel(ms,formId){
        ...
        if(formId=='d34c8f48bead40d88c24a153c731de82'){<%--工单信息--%>
            $.each(uiTxt,function(i,v){
                ...
                //arrHtml.push("</td>");
                arrHtml.push("<td colno='PROJECT_ID' class='datagrid-cell "+ms.tdClass(formId, 'PROJECT_ID')+"' style='text-align:center;width:110px;"+ms.tdStyle(formId, 'PROJECT_ID')+"' "+ms.tdEvent(formId, 'PROJECT_ID')+">")
                ...
                arrHtml.push("<td colno='IS_REL' class='datagrid-cell "+ms.tdClass(formId, 'IS_REL')+"' style='text-align:center;width:110px;"+ms.tdStyle(formId, 'IS_REL')+"' "+ms.tdEvent(formId, 'IS_REL')+">")
                ...
                arrHtml.push("</td>");
                arrHtml.push("<td colno='PRODUCT_MATERIAL'  class='datagrid-cell "+ms.tdClass(formId, 'PRODUCT_MATERIAL')+"' style='text-align:center;width:110px;"+ms.tdStyle(formId, 'PRODUCT_MATERIAL')+"' "+ms.tdEvent(formId, 'PRODUCT_MATERIAL')+">")
                ...
                arrHtml.push("<td colno='PRODUCT_NAME' class='datagrid-cell "+ms.tdClass(formId, 'PRODUCT_NAME')+"'style='text-align:center;width:200px;"+ms.tdStyle(formId, 'PRODUCT_NAME')+"' "+ms.tdEvent(formId, 'PRODUCT_NAME')+">")
                ...
                arrHtml.push("</td>");
                arrHtml.push("<td colno='PRODUCT_STANDARD' class='datagrid-cell "+ms.tdClass(formId, 'PRODUCT_STANDARD')+"' style='text-align:center;width:150px;"+ms.tdStyle(formId, 'PRODUCT_STANDARD')+"' "+ms.tdEvent(formId, 'PRODUCT_STANDARD')+">")
                ...
                arrHtml.push("<td colno='LOT_NUMBER' class='datagrid-cell "+ms.tdClass(formId, 'LOT_NUMBER')+"' style='text-align:center;width:150px;"+ms.tdStyle(formId, 'LOT_NUMBER')+"' "+ms.tdEvent(formId, 'LOT_NUMBER')+">")
                ...
                arrHtml.push("<td colno='PRODUCT_COUNT' class='datagrid-cell "+ms.tdClass(formId, 'PRODUCT_COUNT')+"' style='text-align:center;width:70px;"+ms.tdStyle(formId, 'PRODUCT_COUNT')+"' "+ms.tdEvent(formId, 'PRODUCT_COUNT')+">")
                ...
                //arrHtml.push("<td colno='FAI_NUM' class='datagrid-cell "+ms.tdClass(formId, 'FAI_NUM')+"' style='text-align:center;width:110px;"+ms.tdStyle(formId, 'FAI_NUM')+"' "+ms.tdEvent(formId, 'FAI_NUM')+">")
                ...
                //  arrHtml.push("<td colno='FQC_COUNT' class='datagrid-cell "+ms.tdClass(formId, 'FQC_COUNT')+"' style='text-align:center;width:70px;"+ms.tdStyle(formId, 'FQC_COUNT')+"' "+ms.tdEvent(formId, 'FQC_COUNT')+">")
                ...
                arrHtml.push("<td colno='FINISH_COUNT' class='datagrid-cell "+ms.tdClass(formId, 'FINISH_COUNT')+"' style='width:70px;text-align:center;"+ms.tdStyle(formId, 'FINISH_COUNT')+"' "+ms.tdEvent(formId, 'FINISH_COUNT')+">")
