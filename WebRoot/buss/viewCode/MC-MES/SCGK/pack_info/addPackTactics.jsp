...
$(function(){
    ...
    $("#paraMapObj_PTC_CUST_CODE_SHOW").attr("disabled","disabled");
  	$("#paraMapObj_PTC_TYPE").attr("disabled",false);
   $("#paraMapObj_PTC_TYPE").removeClass("readonly");
...
function resetForm1(){
    	...
    	function editCal(){
          ...
          document.forms.editForm.action = "${path}buss/bussModel_exeFunc.ms?funcMId=0cb641b8cdbc41978e3e86a77ae04603&storageName="+storageName+"&type=add";
