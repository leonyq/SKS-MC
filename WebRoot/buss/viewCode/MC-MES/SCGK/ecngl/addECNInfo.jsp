...
function addItemInfo(){
		util.showLoading("处理中...");
		  $.ajax({
			    ...
			    data:{
			      "modelCode":$("#paraMap1_CEI_ITEM_CODE").val()  
			    },
...
function searchItemInfo(paginationImpl){
	var isFirstLoad = firstLoadThisPage(paginationImpl);
    	...
    	var modelCode = $("#paraMap1_CEI_ITEM_CODE").val();
    	util.showLoading("处理中...");
    	$.ajax({
			    type: "POST",
			    dataType: "json",
...
var projectStepOption = projectStep.substring(projectStep.indexOf('<option'));
	...
	$("#itemTbody :checkbox").each(function(){
			if($(this).attr("checked")){
					...
					$("#addItemDetail tr:last").append("<td class='datagrid-cell datagrid-cell-8' style='width:120px;padding:0;'><input type='text' style='width:100%;' maxlength='50' class='_VAL_NULL input isSubmit' name='GROUP_CODE' value=''/></td>");
					...
					$("#addItemDetail tr:last").append("<td class='datagrid-cell datagrid-cell-12' style='width:120px;padding:0;'><input type='text' style='width:100%;' maxlength='50' class='_VAL_NULL input isSubmit' name='REPLACE_TYPE' value=''/></td>");
					...
					mySetChosen();//设置下拉框样式
					$("#actionSel_"+(trrCount+1)+"_chosen").attr("style","width:100%;");
                    $("#cutTypeSel_"+(trrCount+1)+"_chosen").attr("style","width:100%;");
                    $("#projectStepSel_"+(trrCount+1)+"_chosen").attr("style","width:100%;");
					len = len+1;
						trrCount++;
				...
				success: function(data){console.log(data);
						...
						if(null != data.ajaxList){
							...
							for(var i=0;i<rccList.length;i++){
								...
								$("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a1234 tr:last").append("<td class='datagrid-cell datagrid-cell-6' style='width:120px;padding:0;'><input style='width: 100%;' name='STOCK_DATE' class=' input isSubmit  _VAL_OjbsData WdateNomorl' onfocus='WdatePicker({skin:\"blue\",dateFmt:\"yyyy-MM-dd\"})'/></td>");
								...
								$("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a1234 tr:last").append("<td class='datagrid-cell datagrid-cell-8' style='width:130px;padding:0;'><input type='text' style='width:100%;' maxlength='9' class=' input isSubmit' name='ORDERITEM_NUM' value='0'/></td>");
							
								$("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a1234 tr:last").append("<td class='datagrid-cell datagrid-cell-12' style='width:130px;padding:0;'><input style='width: 100%;' name='ORDER_DATE' class=' input isSubmit  _VAL_OjbsData WdateNomorl' onfocus='WdatePicker({skin:\"blue\",dateFmt:\"yyyy-MM-dd\"})'/></td>");
                            	...
                            	$("#orderWaySel_"+(trrCount+1)+"_chosen").attr("style","width:100%;");
...
//根据选择的机种获取成品库存信息
function getProductStockInfo(modelCode){
    util.showLoading("处理中...");
		  $.ajax({
				type: "POST",
			    dataType: "json",
			    url: "${path}buss/bussModel_exeFunc.ms?funcMId=fb3b3bf79cc64405bcd5b3b0861a500a",
			    data:{
			        "modelCode":modelCode
			    },
				success: function(data){
				                 $("#addProductStock").empty();
						util.closeLoading();
						if(null != data.ajaxList){
							var rccList = eval(data.ajaxList);
							...
							for(var i=0;i<rccList.length;i++){
								if(rccList[i].TRACKNUM==null) rccList[i].TRACKNUM=0;
								if(rccList[i].STOCKNUM==null) rccList[i].STOCKNUM=0;
								...
								//$("#itemDetail tr:last").append("<td class='datagrid-cell datagrid-cell-2' style='width:30px;text-align: center;'><input id='"+(trCount+1)+"' type='checkbox' name='isSelect1'/></td>");
								$("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a5678 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:90px;text-align: center;' title='"+rccList[i].TRACKNUM+"'>"+rccList[i].TRACKNUM+"<input type='hidden' name='TRACKNUM' value='"+rccList[i].TRACKNUM+"'/></td>");
								$("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a5678 tr:last").append("<td class='datagrid-cell datagrid-cell-6' style='width:120px;padding:0;'><input style='width: 100%;' name='TRACK_DATE' class=' input isSubmit  _VAL_OjbsData WdateNomorl' onfocus='WdatePicker({skin:\"blue\",dateFmt:\"yyyy-MM-dd\"})'/></td>");
								...
								$("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a5678 tr:last").append("<td class='datagrid-cell datagrid-cell-5' style='width:90px;text-align: center;' title='"+rccList[i].STOCKNUM+"'>"+rccList[i].STOCKNUM+"<input type='hidden' name='STOCKNUM' value='"+rccList[i].STOCKNUM+"'/></td>");
								$("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a5678 tr:last").append("<td class='datagrid-cell datagrid-cell-6' style='width:120px;padding:0;'><input style='width: 100%;' name='PRODUCT_DATE' class=' input isSubmit  _VAL_OjbsData WdateNomorl' onfocus='WdatePicker({skin:\"blue\",dateFmt:\"yyyy-MM-dd\"})'/></td>");
								...
								$("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a5678 tr:last").append("<td class='datagrid-cell datagrid-cell-8' style='width:90px;padding:0;'><input type='text' style='width:90px;' maxlength='9' class=' input isSubmit' name='SHIP_NUM' value='0'/></td>");
							
								$("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a5678 tr:last").append("<td class='datagrid-cell datagrid-cell-12' style='width:120px;padding:0;'><input style='width: 100%;' name='SHIP_DATE' class=' input isSubmit  _VAL_OjbsData WdateNomorl' onfocus='WdatePicker({skin:\"blue\",dateFmt:\"yyyy-MM-dd\"})'/></td>");
								...
								mySetChosen();//设置下拉框样式
                            	$("#trackWaySel_"+(trrCount+1)+"_chosen").attr("style","width:100%;");
                            	$("#productWaySel_"+(trrCount+1)+"_chosen").attr("style","width:100%;");
                            	$("#shipWaySel_"+(trrCount+1)+"_chosen").attr("style","width:100%;");
								trrCount++;
							}
...
function addCal(){      
			...
			$("#saveBtn").prop("disabled","disabled");
                        ...
                        document.forms.addForm.action = "${path}buss/bussModel_exeFunc.ms?funcMId=06c59f3d77f746cf8e0107b8e237c71f";
...
<body>
	<div class="edit">
		...
		<bu:set name="paraMapObj" value="${dataId}" formId="4a5db9f5df65424caa083c77fa45e44b" type="add" />
	...
	<input type="hidden" name="paraMap1@__DATA_COUNT__" value="1" />
		<s:set name="_$viewId" value="'77d50f37a77f4ed7ac6440b387021f1a'" />
		...
		<tr>
			...
			<bu:td cssClass="dec" colNo="CEI_ECR_SN" formId="4a5db9f5df65424caa083c77fa45e44b" ><bu:ui colNo="CEI_ECR_SN" style="width:200px;" formId="4a5db9f5df65424caa083c77fa45e44b" value="%{CEI_ECR_SN}" formIndex="1" /></bu:td>
		
		    <td class="name" /><span class="dot">*</span><bu:uitn colNo="CEI_ITEM_CODE" formId="4a5db9f5df65424caa083c77fa45e44b" /></td>
			<bu:td cssClass="dec" colNo="CEI_ITEM_CODE" formId="4a5db9f5df65424caa083c77fa45e44b" ><bu:ui colNo="CEI_ITEM_CODE" style="width:200px;" formId="4a5db9f5df65424caa083c77fa45e44b" value="%{CEI_ITEM_CODE}" formIndex="1" /></bu:td>
		
		    <td class="name" /><bu:uitn colNo="CEI_URGENT_GRADE" formId="4a5db9f5df65424caa083c77fa45e44b" /></td>
			<bu:td cssClass="dec" colNo="CEI_URGENT_GRADE" formId="4a5db9f5df65424caa083c77fa45e44b" ><bu:ui colNo="CEI_URGENT_GRADE" style="width:200px;" formId="4a5db9f5df65424caa083c77fa45e44b" value="%{CEI_URGENT_GRADE}" formIndex="1" /></bu:td>
		
		</tr>
		<tr>
			<td class="name" /><bu:uitn colNo="CEI_CHANGE_IMPLEMENT" formId="4a5db9f5df65424caa083c77fa45e44b" /></td>
			<bu:td cssClass="dec" colNo="CEI_CHANGE_IMPLEMENT" formId="4a5db9f5df65424caa083c77fa45e44b" ><bu:ui colNo="CEI_CHANGE_IMPLEMENT" style="width:200px;" formId="4a5db9f5df65424caa083c77fa45e44b" value="%{CEI_CHANGE_IMPLEMENT}" formIndex="1" /></bu:td>
		    	
            <td class="name" /><bu:uitn colNo="CEI_DISTRIBUTE_DEP" formId="4a5db9f5df65424caa083c77fa45e44b" /></td>
			<bu:td cssClass="dec" colNo="CEI_DISTRIBUTE_DEP" formId="4a5db9f5df65424caa083c77fa45e44b" ><bu:ui colNo="CEI_DISTRIBUTE_DEP" style="width:200px;" formId="4a5db9f5df65424caa083c77fa45e44b" value="%{CEI_DISTRIBUTE_DEP}" formIndex="1" /></bu:td>
					
            <td class="name" /><bu:uitn colNo="CEI_ECR_APPLAYDATE" formId="4a5db9f5df65424caa083c77fa45e44b" /></td>
			<bu:td cssClass="dec" colNo="CEI_ECR_APPLAYDATE" formId="4a5db9f5df65424caa083c77fa45e44b" ><bu:ui colNo="CEI_ECR_APPLAYDATE" style="width:200px;" formId="4a5db9f5df65424caa083c77fa45e44b" value="%{CEI_ECR_APPLAYDATE}" formIndex="1" /></bu:td>
		
		</tr>
		<tr>
			<td class="name" /><bu:uitn colNo="CEI_ECR_APPLAYEMP" formId="4a5db9f5df65424caa083c77fa45e44b" /></td>
			<bu:td cssClass="dec" colNo="CEI_ECR_APPLAYEMP" formId="4a5db9f5df65424caa083c77fa45e44b" ><bu:ui colNo="CEI_ECR_APPLAYEMP" style="width:200px;" formId="4a5db9f5df65424caa083c77fa45e44b" value="%{CEI_ECR_APPLAYEMP}" formIndex="1" /></bu:td>
					
			<td class="name" /><bu:uitn colNo="CEI_ECR_EXAMINEEMP" formId="4a5db9f5df65424caa083c77fa45e44b" /></td>
			<bu:td cssClass="dec" colNo="CEI_ECR_EXAMINEEMP" formId="4a5db9f5df65424caa083c77fa45e44b" ><bu:ui colNo="CEI_ECR_EXAMINEEMP" style="width:200px;" formId="4a5db9f5df65424caa083c77fa45e44b" value="%{CEI_ECR_EXAMINEEMP}" formIndex="1" /></bu:td>
		
			<td class="name" /><bu:uitn colNo="CEI_ECR_APPROVALEMP" formId="4a5db9f5df65424caa083c77fa45e44b" /></td>
			<bu:td cssClass="dec" colNo="CEI_ECR_APPROVALEMP" formId="4a5db9f5df65424caa083c77fa45e44b" ><bu:ui colNo="CEI_ECR_APPROVALEMP" style="width:200px;" formId="4a5db9f5df65424caa083c77fa45e44b" value="%{CEI_ECR_APPROVALEMP}" formIndex="1" /></bu:td>
		</tr>
		...
		<i class="ico ico-sc-new-add ico-small"></i>
				...
				<div class="panel datagrid datagrid-div1">
					<div class="datagrid-div2 datagrid-div6 datagrid-view"  id="datagrid-view1">
						...
						<div class="datagrid-body datagrid-div3 scroll1"   style="height:300px;">
