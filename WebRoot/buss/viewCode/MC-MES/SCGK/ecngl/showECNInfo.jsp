				...
				success: function(data){
						...
						if(null != data.ajaxMap){
							...
							for(var i=0;i<stockList.length;i++){
								...
								$("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a1234 tr:last").append("<td class='datagrid-cell datagrid-cell-7' style='width:120px;padding:0;'>"+stockWaySel+"</td>");
								...
								$("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a1234 tr:last").append("<td class='datagrid-cell datagrid-cell-8' style='width:120px;padding:0;'><input type='text' style='width:120px;' maxlength='9' class=' input isSubmit' name='ORDERITEM_NUM' value='"+stockList[i].CEID_ORDERITEM_NUM+"' readonly='readonly'/></td>");
							
								$("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a1234 tr:last").append("<td class='datagrid-cell datagrid-cell-12' style='width:120px;padding:0;'><input style='width: 120px;' name='ORDER_DATE' class=' input isSubmit  _VAL_OjbsData WdateNomorl' onfocus='WdatePicker({skin:\"blue\",dateFmt:\"yyyy-MM-dd\"})' value='"+stockList[i].ORDER_DATE+"' disabled='disabled'/></td>");
								$("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a1234 tr:last").append("<td class='datagrid-cell datagrid-cell-13' style='width:120px;padding:0;'>"+orderWaySel+"</td>");
                            	...
                            	$("#stockWaySel_"+(trrCount+1)+"_chosen").attr("style","width:120px;");
                            	$("#orderWaySel_"+(trrCount+1)+"_chosen").attr("style","width:120px;");
...
<body>
	...
	<input type="hidden" name="paraMap1@__DATA_COUNT__" value="1" />
		<s:set name="_$viewId" value="'23c8923135a848c6ac3a1fc8271bf136'" />
		...
		<tr>
			<td class="name" /><bu:uitn colNo="CEI_ECN_EXAMINEEMP" formId="4a5db9f5df65424caa083c77fa45e44b" /></td>
			...
			<td class="name" /><bu:uitn colNo="CEI_ECN_APPROVALEMP" formId="4a5db9f5df65424caa083c77fa45e44b" /></td>
	...
	<div class="js-tab">
			...
			<DIV id="content1" style="margin-top:4px;" data-tab="tag1">
				<div class="panel datagrid datagrid-div1">
					<div class="datagrid-div2 datagrid-div6 datagrid-view"  id="datagrid-view1">
						...
						<div class="datagrid-body datagrid-div3 scroll1"   style="height:310px;">
							...
							<div class="datagrid-header-inner head2">
								<table  class="datagrid-htable fixedTable datagrid-div6 datagrid-htable-kz  " id="datagrid-htable831b2dbf0dfb494695b7ce66538a1234">
									...
									<tr class="datagrid-header-row thcolor">
										...
										<td class="datagrid-cell" style="width:120px;" ><dict:lang value="库存物料处理方式" /></td >
										<td style="display:none;width:120px;">
										<dict:selectDict id="stockWay" name="stockWay" dictCode="ITEMSTOCK_HANDLEWAY" />
										</td >
										
										<td class="datagrid-cell" style="width:120px;" ><dict:lang value="已下订单物料数量" /></td >
										<td class="datagrid-cell" style="width:120px;" ><dict:lang value="已下订单统计日期" /></td >
										<td class="datagrid-cell" style="width:120px;"><dict:lang value="已下订单处理方式" /></td >
		...
		<DIV id="content3" style="display:none" data-tab="tag3">
				<div class="panel datagrid datagrid-div1">
					...
					<div class="datagrid-body datagrid-div3 scroll3" style="height:280px;">
