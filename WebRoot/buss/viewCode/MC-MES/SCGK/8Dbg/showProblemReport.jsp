...
<div class="mod-hd">		
  <h3 class="tit"><dict:lang value="基本信息" /></h3>	
	...
	<input type="hidden" name="paraMap1@__DATA_COUNT__" value="1" />
		<s:set name="_$viewId" value="'d8fe862a02c0441ba2f36a5882a4b298'" />
...
<!---->
	...
	<table class="basic-table" >
        ...
        <tr>
			<td class="name" style="width:65px;"/><bu:uitn colNo="CPR_PERMANENT_IMPROVE_MEASURE" formId="0affca5a6d75419ab073cd608cc5e1e2" /></td>
	...
	<table class="basic-table" >
        <tr>
			...
			<td class="name" style="width:140px;"/><bu:uitn colNo="CPR_CONFIRM_RESULT" formId="0affca5a6d75419ab073cd608cc5e1e2" /></td>
			<bu:td cssClass="dec" colNo="CPR_CONFIRM_RESULT" formId="0affca5a6d75419ab073cd608cc5e1e2">
			<bu:ui colNo="CPR_CONFIRM_RESULT" style="width: 200px;" formId="0affca5a6d75419ab073cd608cc5e1e2" dataId="${dataId}" formIndex="1" disabled="disabled"/>
			</bu:td>
		    <td class="name" style="width:72px;"/><bu:uitn colNo="CPR_STANDARDIZE_FILE" formId="0affca5a6d75419ab073cd608cc5e1e2" /></td>
			<bu:td cssClass="dec" colNo="CPR_STANDARDIZE_FILE" formId="0affca5a6d75419ab073cd608cc5e1e2" ><bu:ui colNo="CPR_STANDARDIZE_FILE" name="upFile" style="width: 200px;" formId="0affca5a6d75419ab073cd608cc5e1e2" dataId="${dataId}" formIndex="1" disabled="disabled"/></bu:td>
		...
		<tr>
			<td class="name" style="width:65px;">&nbsp;</td>
			<td class="dec">&nbsp;</td>
		
			<td class="name" style="width:291px;"/><bu:uitn colNo="CPR_CONFIRM_EMP" formId="0affca5a6d75419ab073cd608cc5e1e2" /></td>
			<bu:td cssClass="dec" colNo="CPR_CONFIRM_EMP" formId="0affca5a6d75419ab073cd608cc5e1e2" ><bu:ui colNo="CPR_CONFIRM_EMP" style="width:200px;" formId="0affca5a6d75419ab073cd608cc5e1e2" dataId="${dataId}" formIndex="1" /></bu:td>
		
			<td class="name" style="width:110px;"/><bu:uitn colNo="CPR_CONFIRM_DATE" formId="0affca5a6d75419ab073cd608cc5e1e2" /></td>
			<bu:td cssClass="dec" colNo="CPR_CONFIRM_DATE" formId="0affca5a6d75419ab073cd608cc5e1e2" ><bu:ui colNo="CPR_CONFIRM_DATE" style="width:200px;" formId="0affca5a6d75419ab073cd608cc5e1e2" dataId="${dataId}" formIndex="1"/></bu:td>
		</tr>
	</table>
</div>
...
$(function(){
    ...
    $("#paraMapObj_CPR_CONGRATULATE").attr("disabled","disabled");
    $("#paraMapObj_CPR_CONGRATULATE").attr("class"," isSubmit input readonly _VAL_DATABASE");
    $("#paraMapObj_CPR_CONFIRM_EMP_SHOW").attr("style","width:200px;");
