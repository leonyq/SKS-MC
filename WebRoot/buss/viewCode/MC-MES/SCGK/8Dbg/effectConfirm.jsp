...
<!---->
	...
	<table class="basic-table" >
        ...
        <tr>
			<td class="name" style="width:65px;"/><span class="dot">*</span><bu:uitn colNo="CPR_IMPROVE_MEASURE" formId="0affca5a6d75419ab073cd608cc5e1e2" /></td>
	...
	<table class="basic-table" >
        ...
        <tr>
			<td class="name" style="width:90px;"/><span class="dot">*</span><bu:uitn colNo="CPR_PERMANENT_IMPROVE_MEASURE" formId="0affca5a6d75419ab073cd608cc5e1e2" /></td>
	...
	<table class="basic-table" >
        <tr>
			<td class="name" style="width:65px;"/><span class="dot">*</span><bu:uitn colNo="CPR_CONFIRM_RESULT" formId="0affca5a6d75419ab073cd608cc5e1e2" /></td>
        ...
        <tr>
			<td class="name" style="width:65px;"/><span class="dot">*</span><bu:uitn colNo="CPR_EFFECT_CONFIRM" formId="0affca5a6d75419ab073cd608cc5e1e2" /></td>
			...
			$.ajax({
				...
				success: function(data){
						...
						if(null != data.ajaxList){
						    ...
						    $("#paraMapObj_CPC_CAUSE_EMP_SHOW").val(rcList[0].SNAME);
...
function editCal(){
  ...
  document.forms.editForm.action = "${path}buss/bussModel_exeFunc.ms?funcMId=6d79e061d64446ed833595bc4b737fcb";
