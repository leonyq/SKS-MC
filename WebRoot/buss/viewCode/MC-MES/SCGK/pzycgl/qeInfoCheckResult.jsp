...
<div class="mod-hd">		
  <h3 class="tit"><dict:lang value="异常单信息" /></h3>	
	...
	<input type="hidden" name="paraMap1@__DATA_COUNT__" value="1" />
		<s:set name="_$viewId" value="'21955e69586b4434b9c4301fd544f888'" />
	...
	<table class="basic-table" >
		...
		<tr>
			...
			<td class="name" style="width:100px;"/><bu:uitn colNo="CQI_ANALYSIS_TIME" formId="46a2000d9dd641acab47c18beb57b9d0" /></td>
	...
	<table class="basic-table" >
        	...
        	<tr>
			<td class="name" style="width:55px;"/><bu:uitn colNo="CQI_RESPONSIBLE_DEP" formId="46a2000d9dd641acab47c18beb57b9d0" /></td>
		...
		<tr>
			...
			<td class="name" style="width:100px;"/><bu:uitn colNo="CQI_JUDGE_TIME" formId="46a2000d9dd641acab47c18beb57b9d0" /></td>
	...
	<table class="basic-table" >
		...
		<tr>
			...
			<td class="name" style="width:100px;"/><bu:uitn colNo="CQI_MAKE_TIME" formId="46a2000d9dd641acab47c18beb57b9d0" /></td>
	...
	<div class="mod-hd">		
        ...
        <table class="basic-table" >
			...
			<bu:td cssClass="dec" colNo="CQI_RESULT_CHECK" formId="46a2000d9dd641acab47c18beb57b9d0"><bu:ui colNo="CQI_RESULT_CHECK" formId="46a2000d9dd641acab47c18beb57b9d0" dataId="${dataId}" formIndex="1"/></bu:td>
		</tr>
		<tr>
			<td class="name" /><bu:uitn colNo="CQI_MEMO" formId="46a2000d9dd641acab47c18beb57b9d0" /></td>
			<bu:td cssClass="dec" colNo="CQI_MEMO" formId="46a2000d9dd641acab47c18beb57b9d0" style="height:80px;" colspan="5"><bu:ui colNo="CQI_MEMO" style="width: 100%;height: 100%;" formId="46a2000d9dd641acab47c18beb57b9d0" dataId="${dataId}" formIndex="1"/></bu:td>
		</tr>
	</table>
...
<bu:script viewId="21955e69586b4434b9c4301fd544f888" />
...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#paraMapObj_CQI_ERROR_CAUSE").attr("class","isSubmit readonly");
		$("#paraMapObj_CQI_OUTFLOW_CAUSE").attr("class","isSubmit readonly");
		$("#paraMapObj_CQI_ANALYSIS_EMP_SHOW").attr("class","isSubmit input readonly");
		$("#paraMapObj_CQI_ANALYSIS_EMP_SHOW").removeAttr("style");
		
		$("#paraMapObj_CQI_RESPONSIBLE_DESC").attr("class","isSubmit readonly");
		$("#paraMapObj_CQI_JUDGE_EMP_SHOW").attr("class","isSubmit input readonly");
		$("#paraMapObj_CQI_JUDGE_EMP_SHOW").removeAttr("style");
		
		$("#paraMapObj_CQI_SHORT_METHOD").attr("class","isSubmit readonly");
		$("#paraMapObj_CQI_LONG_METHOD").attr("class","isSubmit readonly");
		$("#paraMapObj_CQI_MAKE_EMP_SHOW").attr("class","isSubmit input readonly");
		$("#paraMapObj_CQI_MAKE_EMP_SHOW").removeAttr("style");
	})
	
	//重置    
        function resetForm1(){
                $("#editForm")[0].reset();
                $("#paraMapObj_CQI_RESULT_CHECK").trigger("chosen:updated");
        }
        ...
        function editCal(){
            ...
            document.forms.editForm.action = "${path}buss/bussModel_exeFunc.ms?funcMId=cb05c769d3b240c6bdf919b4b985652a";
