...
<body>
	...
	<form id="editForm" style="height:100%;" name="editForm" action="${path}buss/bussModel_editAjaxComm.ms?<s:property value='%{@com.more.fw.core.common.method.Constants@FUNC_CODE}' />=<s:property value='%{FUNC_CODE}' />" method="post" target="submitFrame"
...
<div class="mod-hd">		
  <h3 class="tit"><dict:lang value="异常单信息" /></h3>	
	...
	<input type="hidden" name="paraMap1@__DATA_COUNT__" value="1" />
		<s:set name="_$viewId" value="'eff44bdefc554a9a88c257a7a006749c'" />
	...
	<div class="mod-hd">		
        ...
        <table class="basic-table" >
			...
			<bu:td cssClass="dec" colNo="CQI_SHORT_METHOD" formId="46a2000d9dd641acab47c18beb57b9d0" style="height:80px;" colspan="5"><bu:ui colNo="CQI_SHORT_METHOD" style="width: 100%;height: 100%;" formId="46a2000d9dd641acab47c18beb57b9d0" dataId="${dataId}" formIndex="1"/></bu:td>
		</tr>
		<tr>
			<td class="name" /><bu:uitn colNo="CQI_LONG_METHOD" formId="46a2000d9dd641acab47c18beb57b9d0" /></td>
			<bu:td cssClass="dec" colNo="CQI_LONG_METHOD" formId="46a2000d9dd641acab47c18beb57b9d0" style="height:80px;" colspan="5"><bu:ui colNo="CQI_LONG_METHOD" style="width: 100%;height: 100%;" formId="46a2000d9dd641acab47c18beb57b9d0" dataId="${dataId}" formIndex="1"/></bu:td>
		</tr>
	</table>
...
<bu:script viewId="eff44bdefc554a9a88c257a7a006749c" />
...
<script type="text/javascript">
  ...
  document.forms.editForm.action = "${path}buss/bussModel_exeFunc.ms?funcMId=e1f9483bfa0b4e53b65d44ef06d168a7";
