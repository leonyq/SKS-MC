	...
	<form id="addForm" name="addForm" action="${path}buss/bussModel_addAjaxComm.ms?<s:property value='%{@com.more.fw.core.common.method.Constants@FUNC_CODE}' />=<s:property value='%{FUNC_CODE_2}' />" method="post" <bu:formet exeid="%{exeid}" />
            ...
            <div class="hd">
			    ...
			    <div class="optn">
			        ...
			        <button type="button" onclick="productScarp();"><i class="ico ico-scrap"></i><dict:lang value="报废/拆解" /></button><!--ico-bf-->
			        <button type="button" onclick="productKeyp();"><i class="ico ico-save"></i><dict:lang value="替换组件"/></button>
...
<div class="mod" style="width:843px;margin-right:10px">
<div class="mod-hd">		
...
<div class="mod-hd" style="height:70px;border-bottom: none;">
	...
	<input type="hidden" id="paraMap1_WT_PROJECT_ID" name="paraMap1@0#WT_PROJECT_ID" />
		...
		<tr>
		    <td class="name" style=""/><span class="dot">*</span><bu:uitn colNo="WT_WORK_STATION" formId="b80d6492859243b498458c992ab04063" /></td>
			<bu:td cssClass="dec" style="/*width:200px;*/" colNo="WT_WORK_STATION" formId="b80d6492859243b498458c992ab04063" ><bu:ui colNo="WT_WORK_STATION" formId="b80d6492859243b498458c992ab04063"  value="%{WT_WORK_STATION}" formIndex="1" /></bu:td>
		
			<td class="name" style=""/><span class="dot">*</span><bu:uitn colNo="WT_SN" formId="b80d6492859243b498458c992ab04063" /></td>
			...
			<td class="name" style="width:84px;"/><bu:uitn colNo="WT_MO_NUMBER" formId="b80d6492859243b498458c992ab04063" /></td>
			<bu:td cssClass="dec" style="/*width:200px;*/" colNo="WT_MO_NUMBER" formId="b80d6492859243b498458c992ab04063" ><bu:ui colNo="WT_MO_NUMBER" disabled="disabled" formId="b80d6492859243b498458c992ab04063" value="%{WT_MO_NUMBER}" formIndex="1" /></bu:td>
		...
		<tr>
			...
			<td class="dec"><input type="text" class=" input isSubmit " id="MODEL_SPEC" name="MODEL_SPEC" disabled="disabled" /></td>
		</tr>
	</table>
</div>
		<input type="hidden" name="formId" id="formId1" value='831b2dbf0dfb494695b7ce66538a1234'/>
		<input type="hidden" name="formId" id="formId2" value='831b2dbf0dfb494695b7ce66538a5678'/>
		<input type="hidden" name="formId" id="formId2" value='831b2dbf0dfb494695b7ce66538a9999'/>		
<div class="js-tab">
  ...
  <div class="panel datagrid datagrid-div1" >
					<div class="datagrid-div2 datagrid-div6 datagrid-view"
						...
						<div class="datagrid-body datagrid-div3 scroll" id="datagrid-body"
							style="height:100px;"  onscroll="ajaxTableScroll(this,'1')">
...
<div class="mod-hd" style="height:170px;border-bottom: none;">
	...
	<input type="hidden" id="errorArr" name="errorArr" value="" />
		<tr>
			...
			<bu:td cssClass="dec" style="width:200px;" colNo="WR_REASON_CODE" formId="64cf42dca7eb43a4b7f80b8e10749008" ><bu:ui colNo="WR_REASON_CODE" formId="64cf42dca7eb43a4b7f80b8e10749008" value="%{WR_REASON_CODE}" formIndex="2" style="width:200px;"/></bu:td>
			...
			<td class="name" style="width:84px;"/><span class="dot">*</span><bu:uitn colNo="WR_REPAIR_METHOD" formId="64cf42dca7eb43a4b7f80b8e10749008" /></td>
			<bu:td cssClass="dec" style="width:200px;" colNo="WR_REPAIR_METHOD" formId="64cf42dca7eb43a4b7f80b8e10749008" ><bu:ui colNo="WR_REPAIR_METHOD" formId="64cf42dca7eb43a4b7f80b8e10749008" value="%{WR_REPAIR_METHOD}" formIndex="2" style="width:200px;"/></bu:td>
		...
		<tr>
			...
			<bu:td cssClass="dec" colspan="5" colNo="WR_MEMO" formId="64cf42dca7eb43a4b7f80b8e10749008" ><bu:ui colNo="WR_MEMO" formId="64cf42dca7eb43a4b7f80b8e10749008" value="%{WR_MEMO}" style="width:100%;" rows="3" formIndex="2" /></bu:td>
...
top.$('script').each(function(i,item){ 
	...
	function init(){
		...
		$("#allSelect").click(function(){
    			if($("#allSelect").attr("checked") == "checked"){
        			$("input[name='isSelect0']").attr("checked","checked");
    			}else{
        			$("input[name='isSelect0']").removeAttr("checked","checked");
    			}
			});
	...
	function productAddError() {
				...
				var STATION = $("#paraMap1_WT_WORK_STATION").val();
				...
				var url = "${path}buss/bussModel.ms?exeid=d746c7b2e81b4c1180641f257ddf00c2&weSn="+ sn+"&piframeId="+piframeId+"&dataAuth="+dataAuth+"&WT_WORK_STATION="+STATION;
						

				showPopWinFp(url, 450, 300, "", "<dict:lang value="添加不良"/>",
						"add", "");
	}
	...
	function productDelError() {
	     var selCount=0;
	     var ids="";
		  $("input[name='isSelect0']:checked").each(function(i) {
		        selCount++;
				var seqs = $(this).val();
				if(ids=='')
				ids=$("#ID"+seqs).val();
	...
	function productKeyp() {
				...
				showPopWinFp(url, 700, 350, "", "<dict:lang value="替换组件"/>",
						"add", "");
	}
	...
	function clearSn(){
	   ...
	   //$("#paraMap1_WT_MO_NUMBER").val("");//制令单号清空
	   //$("#paraMap1_WT_MODEL_CODE").val("");//制令单号清空
	   $("#MODEL_NAME").val("");
	   $("#MODEL_SPEC").val("");
	}
		...
		success: function(data){
		   ...
		   if(data.ajaxList!=null&&data.ajaxList.length>0){
			...
			for(var i=0;i<pList.length;i++){ 				  
 			//	   $("#nextGroup").append("<option value='"+pList[i].AKEY+"'>"+pList[i].AVAL+"<option>"); 
	...
	function addRepair(){
		  ...
		  if(selCount==0){
		    ...
		    $("input[name='isSelect0']:checked").each(function(i) {
		        ...
		        var repairState=$("#REPAIR_STATE"+inputSeqs);
		        repairState.html("");
	   ...
	   function errorJudge()
		...
		showPopWinFp(url, 700, 460,"","<dict:lang value="误判"/>","add","");
	}
	...
	function queryErrorList(key,flag){
		...
		$("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a1234 tbody").empty();
		$("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a5678 tbody").empty();
		var getProUrl="${path}buss/bussModel_exeFunc.ms?funcMId=2c766b94e0d1460fa68fb3270c189c91";
	  $.ajax({
		type: "POST",
	    dataType: "json",
	    async:false,
		...
		success: function(data){
				...
				if(data.ajaxList != null && data.ajaxList != ""){
					...
					for(var i=0,j=data.ajaxList.length;i<j;i++){
						...
						tbodyStr+="<tr class='datagrid-row' id='"+(i+1)+"' style='cursor: pointer;' onclick=\"\">"
								...
								+"<td class=\"datagrid-cell\" style=\"width:30px;text-align:center; \" ><input type='checkbox' name='isSelect0' value='"+i+"'  onclick=\"\"></td>";
								...
								tbodyStr += "<td class=\"datagrid-cell \" style=\"width:130px;\">"+nullToEmpty(pList[i].NAME)+"</td>";
						...
						tbodyStr2+="<tr class='datagrid-row' id='tr2"+(i+1)+"' style='cursor: pointer;' onclick=\"showMethodNum('"+nullToEmpty(pList[i].WE_ERROR_CODE)+"');\">"
								...
								tbodyStr2 += "<td class=\"datagrid-cell \" style=\"width:130px;\">"+nullToEmpty(pList[i].NAME)+"</td>";
								tbodyStr2 +="</tr>";
					}
				}
				$("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a1234 tbody").html(tbodyStr);
				$("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a5678 tbody").html(tbodyStr2);
				$("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a1234 tr:odd").addClass("tr-hover");//奇数行
				$("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a5678 tr:odd").addClass("tr-hover");//奇数行
                ...
                $("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a1234 tr").off("click").on("click",function(){
                    $('#error_img').removeAttr('src');
                    $('#error_img').attr('src','up_load/aoiImg/'+$(this).find('.we_error_img').val());
                ...
                $("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a1234 tr").off("dblclick").on("dblclick",function(){  
    	             $('.div_draw .zoom').click();
                });
                ///结束
			},
	...
	//点击不良代码获取维修信息
	function showMethodNum(errorCode){
				...
				success: function(data){	
						...
						if(null != data.ajaxList){
							...
							for(var i = 0;i < rccList.length; i++){
								...
								tbodyStr3 += "<td class=\"datagrid-cell \" style=\"width:140px;\">"+nullToEmpty(rccList[i].METHOD_NAME)+"</td>";
								tbodyStr3 += "<td class=\"datagrid-cell \" style=\"width:140px;\">"+nullToEmpty(rccList[i].METHODNUM)+"</td>";
                                
								tbodyStr3 +="</tr>";
							}
							$("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a9999 tbody").html(tbodyStr3);
            				$("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a9999 tr:odd").addClass("tr-hover");//奇数行
            				
            				clickTr('datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a9999');
	...
	var groupCode=localStorage.getItem("GROUP_CODE");//工序值
	if(workStationName==null || workStationName==""){	
        var tempWorkStationName=$("#paraMap1_WT_WORK_STATION_SHOW").val();
        localStorage.setItem("WORK_STATION_NAME",tempWorkStationName);
	}else{
	    $("#paraMap1_WT_WORK_STATION_SHOW").val(workStationName);
	}
	if(groupCode==null || groupCode==""){	
        var tempWorkStationName=$("#GROUP_CODE").val();
        localStorage.setItem("GROUP_CODE",tempWorkStationName);
	}else{
	    $("#GROUP_CODE").val(groupCode);
	}
	if(workStationVal==null || workStationVal==""){	
        var tempWorkStationVal=$("#paraMap1_WT_WORK_STATION").val();
        localStorage.setItem("WORK_STATION_NAME",tempWorkStationVal);
	}else{
	    $("#paraMap1_WT_WORK_STATION").val(workStationVal);
	}
	function changeVal(){
	    ...
	    localStorage.removeItem("WORK_STATION_NAME");
 		...
 		var tempWorkStationName=$("#paraMap1_WT_WORK_STATION_SHOW").val();
 		var tempWorkStationVal=$("#paraMap1_WT_WORK_STATION").val();
 		var groupCode=$("#GROUP_CODE").val();//工序值
	...
	var pcbViewer;
	$(function(){
	    //$('#paraMap1_WT_SN_SHOW').next("img").css("left","230px");
	    ...
	    $('#paraMap1_WT_MODEL_CODE').attr("readonly","readonly");
	     $("#paraMap1_WT_MO_NUMBER").attr("class","input isSubmit _VAL_NULL  readonly _VAL_OjbsData  isaddSubmit");
		 $("#paraMap1_WT_MODEL_CODE").attr("class"," input isSubmit _VAL_NULL  readonly _VAL_OjbsData  isaddSubmit ");
