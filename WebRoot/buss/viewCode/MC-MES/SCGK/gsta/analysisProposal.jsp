  ...
  <h3 class="tit"><dict:lang value="提案信息" /></h3>	
	...
	<table class="basic-table" >
        ...
        <tr>
			...
			<bu:td cssClass="dec" colNo="CIP_BENEFIT_ANALYSIS" formId="ff8f5a5bddcf4021aa945e5a217e6552" style="height:80px;" colspan="5"><bu:ui colNo="CIP_BENEFIT_ANALYSIS" style="width: 100%;height: 100%;" formId="ff8f5a5bddcf4021aa945e5a217e6552" dataId="${dataId}" formIndex="1"/></bu:td>
		</tr>
...
function editCal(){
  ...
  document.forms.editForm.action = "${path}buss/bussModel_exeFunc.ms?funcMId=771416816de249dba9227ba7cbbad7b4";
