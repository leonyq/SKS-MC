...
<body style="overflow: auto;">
	<div id="div1">
		<div style="width:100%;border:0px solid;position: relative;" id="headInformation"></div>
	</div>
	<div id="div2">
		<div style="width:100%;border:0px solid;position: relative;" id="bodyInformation"></div>
	</div>
	<div id="div3">
	<div style="width:100%;border:0px solid;position: relative;"id="footInformation"></div>
	</div>
	<script>
	localStorage.printResult=1;	
	 ...
	 var buttomSourceArray;
    	...
    	$("#div1").css("width",bodyWidth);
    	$("#div2").css("width",bodyWidth);
    	$("#div3").css("width",bodyWidth);
    	
    	$("#footInformation").css("width",bodyWidth);
    	$("#bodyInformation").css("width",bodyWidth);
    	$("#headInformation").css("width",bodyWidth);
		...
		for(var i=0;i<topSourceArray.length;i++){
			if(topSourceArray[i].nodeType!="middle"){
				...
				var html="<div class='"+classStyle+"' style='position:absolute;left:"+nodeX+"px;top:"+nodeY+"px;width:"+nodeWidth+"px;height:"+nodeHeight+"px;'>"+dataSource+"</div>";
			}
			localStorage.topMaxHeight=MaxHeight;
		...
		function addButtomInfo(MaxHeight){
			...
			var buttomMaxHeight=0;
				for(var i=0;i<buttomSourceArray.length;i++){
					...
					var tempMaxHeight=nodeY+nodeHeight;
					if(tempMaxHeight>MaxHeight){
						MaxHeight=tempMaxHeight;
					}
					var classStyle="";
					...
					if(buttomSourceArray[i].nodeY-buttomMargin>buttomMaxHeight){
						buttomMaxHeight=buttomSourceArray[i].nodeY-buttomMargin;
					}
				...
				localStorage.buttomMaxHeight=buttomMaxHeight;
				localStorage.printResult=2;
		...
		function addValueInfo(resultList,topValue,maxValue,columnData){
			...
			if(maxValue==1){
				html="<table style='margin-top:"+topValue+"px;margin-left:"+nodeWidth+"px; font-size:"+fontSize+" ;border:1;cellspacing:0;table-layout: fixed' id='"+tableIdNext+"'><thead><tr>";
			}else{
				var height=topValue;
				...
				html="<table style=style='margin-top:"+10+"px;margin-left:"+nodeWidth+"px;font-size:"+fontSize+" ;border:1;cellspacing:0;table-layout: fixed' id='"+tableIdNext+"'><tr>";
			}
		...
		function addValueInfoSecond(resultList,topValue,maxValue,columnData){
			...
			if(maxValue==1){
				html="<table style='margin-top:"+topValue+"px;margin-left:"+leftMargin+"px; border:1;cellspacing:0;' id='"+tableIdNext+"'><tr>";
			}else{
				var height=topValue;
				for(var i=1;i<maxValue;i++){
					var tableId="#table"+i;
				...
				html="<table style='top:"+height+"px;border:1;margin-left:"+leftMargin+"px;cellspacing:0;' id='"+tableIdNext+"'><tr>";
			}
