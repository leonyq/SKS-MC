...
<body>
    <div class="content-in">
		...
		<bu:table cssClass="datagrid-htable fixedTable datagrid-div6 datagrid-htable-kz" id="datagrid-htable831b2dbf0dfb494695b7ce66538a8536" >
		...
		<bu:tr cssClass="datagrid-header-row datagrid-title-ajax" id="datagrid-title-ajax">
			...
			<td class="datagrid-cell" style="width:120px;"><bu:uitn colNo="T2#WID_ERP_FLAG" formId="831b2dbf0dfb494695b7ce66538a8536" /></td>
...
function showItemDetail(itemId){  
	...
	var startTime = $(document.getElementById('T2#WID_CREATE_TIME_BEGIN')).val();
    var endTime =   $(document.getElementById('T2#WID_CREATE_TIME_END')).val();
    //alert(startTime);
	util.showLoading("处理中...");
	$.ajax({
			    type: "POST",
				...
				success: function(data){
						...
						if(null != data.ajaxPage.dataList){
							...
							//	$("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a1234 tr:last").append("<td class='datagrid-cell datagrid-cell-2' style='width:30px;text-align: center;'><input type='checkbox' name='isSelect1'/></td>");
								$("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a1234 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:150px;text-align: center;' title='"+rccList[i].WID_DOC_NUM+"'><span onclick='itemJump1(\""+rccList[i].WID_DOC_NUM+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].WID_DOC_NUM+"</span></td>");
								$("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a1234 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:250px;text-align: center;' title='"+rccList[i].WID_ITEM_SN+"'><span onclick='itemJump3(\""+rccList[i].WID_ITEM_SN+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].WID_ITEM_SN+"</span></td>");
								$("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a1234 tr:last").append("<td class='datagrid-cell datagrid-cell-5' style='width:150px;text-align: center;' title='"+rccList[i].WID_ITEM_CODE+"'><span onclick='itemJump2(\""+rccList[i].WID_ITEM_CODE+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].WID_ITEM_CODE+"</span></td>");
...
function SearchItemInfo(paginationImpl,url){ 
	var isFirstLoad = firstLoadThisPage(paginationImpl);
    	...
    	var dataAuth=$("#DATA_AUTH_"+itemId).val();
    	var docStatus = $("#state_"+itemId).val();
    	var beginTime = $(document.getElementById('T2#WID_CREATE_TIME_BEGIN')).val();
        var endTime =   $(document.getElementById('T2#WID_CREATE_TIME_END')).val();
    	util.showLoading("处理中...");
    	$.ajax({
			    type: "POST",
				...
				success: function(data){
						...
						if(null != data.ajaxPage.dataList){
							...
							for(var i = 0;i < rccList.length; i++){
								...
								$("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a5678 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:150px;text-align: center;' title='"+rccList[i].WID_DOC_NUM+"'><span onclick='itemJump1(\""+rccList[i].WID_DOC_NUM+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].WID_DOC_NUM+"</span></td>");
								$("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a5678 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:250px;text-align: center;' title='"+rccList[i].WID_ITEM_SN+"'><span onclick='itemJump3(\""+rccList[i].WID_ITEM_SN+"\")' style='display: inline;border-bottom: 1px solid #004098;'>"+rccList[i].WID_ITEM_SN+"</span></td>");
...
function createTableModel(ms,formId){
    ...
    if(formId=='831b2dbf0dfb494695b7ce66538a8536'){<%--FM-盘点单物料信息--%>
        ...
        $.each(uiTxt,function(i,v){
            ...
            arrHtml.push("<span colno='WII_DOC_NUM' class='"+ms.uiClass(formId, 'WII_DOC_NUM')+"' onclick='itemJump1(\""+v['WII_DOC_NUM']+"\")' style='display: inline;border-bottom: 1px solid #004098;' "+ms.uiEvent(formId, 'WII_DOC_NUM')+" title='"+ms.titleAttr(formId,'WII_DOC_NUM','IS_TITLE_ATTR',v)+"' >"+v['WII_DOC_NUM']+"</span>")
            ...
            arrHtml.push("<span colno='WII_ITEM_CODE' class='"+ms.uiClass(formId, 'WII_ITEM_CODE')+"' onclick='itemJump2(\""+v['WII_ITEM_CODE']+"\")' style='display: inline;border-bottom: 1px solid #004098;' "+ms.uiEvent(formId, 'WII_ITEM_CODE')+" title='"+ms.titleAttr(formId,'WII_ITEM_CODE','IS_TITLE_ATTR',v)+"' >"+v['WII_ITEM_CODE']+"</span>")
            arrHtml.push("<input type='hidden' id='DATA_AUTH_ID_"+v['ID']+"' value='"+v['DATA_AUTH_ID']+"' /> </td>");
            arrHtml.push("<td colno='T2#WID_ERP_FLAG' class='datagrid-cell "+ms.tdClass(formId, 'T2#WID_ERP_FLAG')+"' style='width:120px;text-align:center;"+ms.tdStyle(formId, 'T2#WID_ERP_FLAG')+"' "+ms.tdEvent(formId, 'T2#WID_ERP_FLAG')+">")
...
function init(){
                    ...
                    //$(document.getElementById('T2#WPD_DELIVERY_DATE_END')).val(timeEndString());
                     ...
                     var jumpId = $("#jumpId").val();  
              		if(jumpId!=""){
                  $("#WII_DOC_NUM").val(jumpId);
                  
                  } 
                  if(jumpId==""){
                     var datetime = new Date();
                     $(document.getElementById('T2#WID_CREATE_TIME_BEGIN')).val(timeBeginString());
                    $(document.getElementById('T2#WID_CREATE_TIME_END')).val(timeEndString());
                    }
...
function itemJump1(obj){
      winOptMethod.jump("ef9072a6a9d74e3dbb30235c4fa3935d","F10254","jumpId",obj);
}  
