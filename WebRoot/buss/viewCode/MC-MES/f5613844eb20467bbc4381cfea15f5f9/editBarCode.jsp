...
$(function (){
	...
	var type_s1 = $("#paraMapObj_TBR_ANALYTIC_TYPE").val();
    ...
    $('#paraMapObj_TBR_SEPARATOR').bind('keyup', function () {
            //console.log("Ssssssssssss");
	            var calwStart=$("#paraMapObj_TBR_SEPARATOR");
             if(/^\d+$/.test(this.value)){
             	this.value='';
               
             	_alertValMsg($('#paraMapObj_TBR_SEPARATOR'),"<dict:lang value="不能为数字" />");
             }
         });
