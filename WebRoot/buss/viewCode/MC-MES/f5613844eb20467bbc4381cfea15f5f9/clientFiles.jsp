...
<body scroll="auto" style="overflow: auto;" >
    <div class="content-in">
		...
		<div class="datagrid-div datagrid-div6 datagrid-view-ajax" id="datagrid-view-ajax4d5275f6a24f44119737918a3136a935" style="">
		<div class="datagrid-header">
		<div class="datagrid-header-inner" id="datagrid-header-inner4d5275f6a24f44119737918a3136a935">
		<bu:table cssClass="datagrid-htable fixedTable datagrid-div6 datagrid-htable-kz" id="datagrid-htable4d5275f6a24f44119737918a3136a935" >
		...
		<bu:tr cssClass="datagrid-header-row datagrid-title-ajax" id="datagrid-title-ajax">
			...
			<td class="datagrid-cell" style="width:200px;"><bu:uitn colNo="DATA_AUTH" formId="4d5275f6a24f44119737918a3136a935" /></td>
			...
			<td class="datagrid-cell" style="width:90px;"><bu:uitn colNo="STATUS" formId="4d5275f6a24f44119737918a3136a935" /></td>
			...
			<td class="datagrid-cell" style="width:120px;"><bu:uitn colNo="MEMO" formId="4d5275f6a24f44119737918a3136a935" /></td>
		...
		<table class="datagrid-btable fixedTable dblClick"  id="datagrid-btable-ajax4d5275f6a24f44119737918a3136a935" >
...
function createTableModel(ms,formId){
    ...
    if(formId=='4d5275f6a24f44119737918a3136a935'){<%--客户档案--%>
        $.each(uiTxt,function(i,v){
            ...
            arrHtml.push("<span colno='CUSTOMER' class='"+ms.uiClass(formId, 'CUSTOMER')+"' style='"+ms.uiStyle(formId, 'CUSTOMER')+"' "+ms.uiEvent(formId, 'CUSTOMER')+" title='"+v['CUSTOMER']+"'>"+v['CUSTOMER']+"</span>")
            arrHtml.push("</td>");
            arrHtml.push("<td colno='STATUS' class='datagrid-cell "+ms.tdClass(formId, 'STATUS')+"' style='width:70px;text-align:center;"+ms.tdStyle(formId, 'STATUS')+"' "+ms.tdEvent(formId, 'STATUS')+">")
            arrHtml.push("<span colno='STATUS' class='"+ms.uiClass(formId, 'STATUS')+"' style='"+ms.uiStyle(formId, 'STATUS')+"' "+ms.uiEvent(formId, 'STATUS')+"  title='"+v['STATUS']+"'>"+v['STATUS']+"</span>")
            arrHtml.push("</td>");
            ...
            arrHtml.push("<span colno='CUST_ABBREVIATION' class='"+ms.uiClass(formId, 'CUST_ABBREVIATION')+"' style='"+ms.uiStyle(formId, 'CUST_ABBREVIATION')+"' "+ms.uiEvent(formId, 'CUST_ABBREVIATION')+" title='"+v['CUST_ABBREVIATION']+"' >"+v['CUST_ABBREVIATION']+"</span>")
            arrHtml.push("</td>");
            ...
            arrHtml.push("<span colno='CUST_BOM' class='"+ms.uiClass(formId, 'CUST_BOM')+"' style='"+ms.uiStyle(formId, 'CUST_BOM')+"' "+ms.uiEvent(formId, 'CUST_BOM')+" title='"+v['CUST_BOM']+"'>"+v['CUST_BOM']+"</span>")
            arrHtml.push("</td>");
            ...
            arrHtml.push("<span colno='CUSTOMER_GRADE' class='"+ms.uiClass(formId, 'CUSTOMER_GRADE')+"' style='"+ms.uiStyle(formId, 'CUSTOMER_GRADE')+"' "+ms.uiEvent(formId, 'CUSTOMER_GRADE')+" title='"+v['CUSTOMER_GRADE']+"'>"+v['CUSTOMER_GRADE']+"</span>")
            arrHtml.push("</td>");
            arrHtml.push("<td colno='MEMO' class='datagrid-cell "+ms.tdClass(formId, 'MEMO')+"' style='width:120px;"+ms.tdStyle(formId, 'MEMO')+"' "+ms.tdEvent(formId, 'MEMO')+">")
            arrHtml.push("<span colno='MEMO' class='"+ms.uiClass(formId, 'MEMO')+"' style='"+ms.uiStyle(formId, 'MEMO')+"' "+ms.uiEvent(formId, 'MEMO')+" title='"+v['MEMO']+"' >"+v['MEMO']+"</span>")
            arrHtml.push("</td>");
