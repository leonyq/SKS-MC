...
<body scroll="auto" style="overflow: auto;" >
    <div class="content-in">
		...
		<bu:table cssClass="datagrid-htable fixedTable datagrid-div6 datagrid-htable-kz" id="datagrid-htable2ea95967d56649819c804bb7f19c6cbc"  style="min-width:1030px;">
    ...
    if(formId=='2ea95967d56649819c804bb7f19c6cbc'){<%--标签模板--%>
        $.each(uiTxt,function(i,v){
            ...
            if($("#"+formId).find(".left-datagrid-title-ajax").length>0){
                ...
                arrHtml.push("<span colno='MODEL_NAME' class='"+ms.uiClass(formId, 'MODEL_NAME')+"' style='"+ms.uiStyle(formId, 'MODEL_NAME')+"' "+ms.uiEvent(formId, 'MODEL_NAME')+" title='"+ms.titleAttr(formId,'MODEL_NAME','IS_TITLE_ATTR',v)+"'>"+v['MODEL_NAME']+"</span>")
                arrHtml.push("</td>");
                ...
                arrHtml.push("<span colno='MODEL_TYPE' class='"+ms.uiClass(formId, 'MODEL_TYPE')+"' style='"+ms.uiStyle(formId, 'MODEL_TYPE')+"' "+ms.uiEvent(formId, 'MODEL_TYPE')+" title='"+ms.titleAttr(formId,'MODEL_TYPE','IS_TITLE_ATTR',v)+"'>"+v['MODEL_TYPE']+"</span>")
                arrHtml.push("</td>");
