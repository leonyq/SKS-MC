...
<body>
    ...
    <jsp:param name="modelName" value="VIEW_TYPE_11" />
      <jsp:param name="location" value="editForm" />
		...
		<bu:set name="paraMapObj" value="${dataId}" formId="54f084d81df04b1d8bc3b151e21734fc" type="edit" />
	<table class="basic-table" >
	...
	<input type="hidden" name="paraMap1@__DATA_COUNT__" value="1" />
		<s:set name="_$viewId" value="'f2a60e8931d84aeb8c6acae4ef5dc90f'" />
		...
		<tr>
			...
			<td class="dec" style="width:230px;" ><bu:ui colNo="SUPPLIER_CODE" formId="54f084d81df04b1d8bc3b151e21734fc" dataId="${dataId}" formIndex="1" style=" width:230px;"/></td>
		</tr>
		<tr>
			<td class="name" /><span class="dot">*</span><bu:uitn colNo="SUPPLIER_NAME" formId="54f084d81df04b1d8bc3b151e21734fc" /></td>
			<td class="dec" ><bu:ui colNo="SUPPLIER_NAME" formId="54f084d81df04b1d8bc3b151e21734fc" dataId="${dataId}" formIndex="1"  style=" width:230px;"/></td>
		</tr>
		<tr>
			<td class="name" /><bu:uitn colNo="SUPPLIER_SHORTNAME" formId="54f084d81df04b1d8bc3b151e21734fc" /></td>
			<td class="dec" ><bu:ui colNo="SUPPLIER_SHORTNAME" formId="54f084d81df04b1d8bc3b151e21734fc" dataId="${dataId}" formIndex="1"  style=" width:230px;"/></td>
		</tr>
		<tr>
			<td class="name" /><bu:uitn colNo="TBR_ID" formId="54f084d81df04b1d8bc3b151e21734fc" /></td>
			<td class="dec"><bu:ui colNo="TBR_ID" formId="54f084d81df04b1d8bc3b151e21734fc" dataId="${dataId}" formIndex="1"  style=" width:230px;"/></td>
		</tr>
	</table>
...
<jsp:include page="/plf/page/mesdemo/commCode/commCode.jsp">
      <jsp:param name="modelName" value="VIEW_TYPE_11" />
       <jsp:param name="location" value="jsLoading" />
         ...
         <bu:submit viewId="f2a60e8931d84aeb8c6acae4ef5dc90f" />
         <bu:script viewId="f2a60e8931d84aeb8c6acae4ef5dc90f" />
	<script type="text/javascript">
			var parentWindow;
			$(function(){
        ...
        var TBR_ID = $('#paraMapObj_TBR_ID').val();
		//重置	
		function resetForm(){
			$("#editForm")[0].reset();
		    $('#paraMapObj_TBR_ID option').each(function(){
		        if($(this).val()==TBR_ID){
		            $(this).attr('selected','true');
		        }
		    });
		    $("#paraMapObj_TBR_ID").trigger("chosen:updated");			
		}
