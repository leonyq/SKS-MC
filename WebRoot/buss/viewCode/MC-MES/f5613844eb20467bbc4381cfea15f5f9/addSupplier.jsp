...
<head>
	...
	<script type = "text/javascript">
	function chenckSuCode(){
	    var suCode = $("#suCode").val();
	    var zmnumReg= /^[\u2E80-\u9FFF]+$/;
	    if(suCode!=""&&zmnumReg.test(suCode)){
	        $('#addForm')[0].reset()
	        alert("供应商编号不能输入中文，请重新输入");
	        return false;
	    }
	}
	</script>
...
<body>
	...
	<input type="hidden" name="paraMap1@__DATA_COUNT__" value="1" />
		...
		<tr>
			...
			<td class="dec" style="width:230px;" ><bu:ui colNo="SUPPLIER_CODE" formId="54f084d81df04b1d8bc3b151e21734fc" value="%{SUPPLIER_CODE}" formIndex="1"  id="suCode"  onblur="chenckSuCode()" style="width:230px;"/></td>
		</tr>
		<tr>
