		...
		<div class="user-drop" id="picList" style="height:calc(100% - 41px);">
			...
			<s:iterator value="dataList" id="picdto" status="index">
				...
				<div class="item">
					<div>
						<img alt=""
							src="${path}buss/images/app/${picdto.picName};"
	...
	<script type="text/javascript">
		...
		function commit(thisObj) {
			...
			if(a=="img0"){
			    ...
			    parentPicIdId = parentWindows.document.getElementById('serverfileName2');//通过父iframe找到图片ID这个输入框
			...
			if(a=="img3"){
			    parentPicIdId = parentWindows.document.getElementById('serverfileName3');//通过父iframe找到图片ID这个输入框
			    parentPicUrlId = parentWindows.document.getElementById('img3');//通过父iframe找到图片URL
			   }else{
			    parentPicIdId = parentWindows.document.getElementById('serverfileName4');//通过父iframe找到图片ID这个输入框
			    parentPicUrlId = parentWindows.document.getElementById('img4');//通过父iframe找到图片URL
			    }
			}
