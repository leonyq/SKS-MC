    ...
    <div class="content-in">
		...
		<bu:search viewId="5e29164c5c934fb5a96ac7bc8a303161" />
               ...
               <form id="listForm" name="listForm" action="" method="post">
					...
					<DIV class="content1" id="content" style="margin-top: 0PX;">
	    						...
	    						<div class="datagrid-header" style="width:100%;">
	    							<div class="datagrid-header-inner head1" style="width:100%;" >
	    								<table  class="datagrid-htable fixedTable  " id="datagrid-htable" style="width:100%;">
	    									...
	    									<!--	<td class="datagrid-cell" style="width:300px;" ><dict:lang value="组织机构" /></td > -->
				...
				<div class="dialog dialog-s1" id="addTextInfo" style="display:none;z-index:2147483647;margin-left:180px;left:16px;top:80px;width:900px;height:560px;">
					<div class="dialog-hd">
					<h3 class="tit">
					<dict:lang value="新增功能模块" />
						...
						<div class="dialog-bd-div" style="width:100%;height:calc(100% - 130px);">
                	...
                	if(null!=data.ajaxList){
                	   ...
                	   for(var i=0;i<rccList.length;i++){
						   ...
						   $("#textTbody tr:last").append("<td class='datagrid-cell datagrid-cell-1' style='width:30px;text-align: center;'>"+trCount+"</td>");
							...
							//$("#textTbody tr:last").append("<td class='datagrid-cell datagrid-cell-2' style='width:140px;text-align: center;' title='"+rccList[i].DATA_AUTH+"'>"+rccList[i].DATA_AUTH+"</td>");
...
function delReal(){
        var saveTestInfoUrl = "${path}buss/bussModel_exeFunc.ms?FUNC_CODE=F13172&funcMId=c6198876afde4c94a8d85bb1871d3c9a";
	           ...
	           success:function(data){		
                	...
                	if(null!=data.ajaxList){
                	   ...
                	   for(var i=0;i<rccList.length;i++){
						...
						//	$("#addHomeInfo tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:300px;text-align: center;'>"+rccList[i].DATA_AUTH+"<input type='hidden' name='DATA_AUTH' value='"+rccList[i].DATA_AUTH+"'/></td>"); 
						    $("#addHomeInfo tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:300px;text-align: center;'>"+rccList[i].MENU_ID+"<input type='hidden' name='MOUDLE_NAME' value='"+rccList[i].TAS_MENU_ID+"'/></td>");
							$("#addHomeInfo tr:last").append("<td class='datagrid-cell datagrid-cell-5' style='width:300px;text-align: center;'>"+rccList[i].MOUDLE_NAME+"<input type='hidden' name='MOUDLE_NAME' value='"+rccList[i].TAS_MOUDLE_ID+"'/></td>");
							$("#addHomeInfo tr:last").append("<td class='datagrid-cell datagrid-cell-6' style='width:300px;text-align: center;'>"+rccList[i].TAS_FUN_NAME+"<input type='hidden' name='TAS_FUN_NAME' value='"+rccList[i].TAS_FUN_NAME+"'/></td>");
							$("#addHomeInfo tr:last").append("<td class='datagrid-cell datagrid-cell-7' style='width:300px;text-align: center;'>"+rccList[i].SHOW_TYPE+"<input type='hidden' name='SHOW_TYPE' value='"+rccList[i].TAS_SHOW_TYPE+"'/></td>");
