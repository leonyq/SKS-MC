		...
		<!--
			...
			-->
				...
				<div id="div_showData" style="display: none;margin-top:8px;">
					<div style="height:28px; ">
					    <div style="float:left;width:260px;height:28px;line-height:28px;margin-left:10px;"  disabled="disabled">
							    正常SQL用例：
	 ...
	 /*
		...
		*/
		...
		$("#processAnaly").live("click",function(){//存储过程解析按钮
		    ...
		    data: {
		        "paraMap.dataInner" : innerData,
		        "paraMap.dataType" : type,
		        "paraMap.resultName" : resultName
		    },
	...
	function init() {//页面初始化数值
	 ...
	 var analysisFlag;
		...
		//	sqlContext=$("#oracle_sql").text();
			...
			var getItemUrl = "${path}buss/bussModel_exeFunc.ms?funcMId=28e2aa1e3b764191a0291903a048ff27&formId=%{formId}";
			$.ajax({
				type: "POST",
				dataType: "json",
				url: getItemUrl,
