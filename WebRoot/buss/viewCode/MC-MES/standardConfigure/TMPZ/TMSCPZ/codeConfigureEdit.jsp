...
<body>
	...
	<input type="hidden" name="paraMap1@__DATA_COUNT__" value="1" />
		<s:set name="_$viewId" value="'e031ba3badb545ed94100845e02af378'" />
		...
		<div class="mod-bd" style="margin-top:5px;border-bottom: none;">
			<div class="panel datagrid datagrid-div1">
				<div class="datagrid-div2 datagrid-div6 datagrid-view"  id="datagrid-view">
					...
					<table class="datagrid-htable fixedTable dlist-table table-line"  id="datagrid-btable-ajax0f6bc25a04cd4de5932d12813912b902" > <!--datagrid-btable fixedTable dblClick -->
			...
			<div class="mod" style="display:inline-block;width:320px;float:left;">
    			<table class="basic-table" style="width:320px;margin-top:3px;height: 35px;">
    				...
    				<tr style="">
            			...
            			<br/>&nbsp;&nbsp;&nbsp;2、若配置类型为SQL，请按下列格式输入数据源：SELECT 字段1,字段2... FROM 表 WHERE 字段1={参数},参数外面不能加单引号，允许传入多个参数,解析结果只能返回一个查询列
...
<script>
				...
				success: function(data){
					...
					if(null != data.ajaxList) {
					    ...
					    for(var i = 0; i < rccList.length; i++) {
                            ...
                            codeSegentSel = "<select id='codeSegentSel_"+i+"' name='CODE_SEGENT'  onchange='onChangeCodeSegent("+i+");' class=' input isSubmit _VAL_OjbsData dept_select' style='width:120px;display: none;'>"+ codeSegentOption +"</select>";			
                			fillTypeSel = "<select id='fillTypeSel_"+i+"' name='FILL_TYPE' class=' input isSubmit _VAL_OjbsData dept_select' style='width:100px;display: none;'>"+ fillTypeOption +"</select>";
    						itemValSel1="<select id='itemValSel_"+i+"' name='ITEM_VALUE' class=' input isSubmit _VAL_OjbsData dept_select' style='width:120px;display: none;'>"+ itemValOption1 +"</select>";
		                    itemValSel2="<select id='itemValSel_"+i+"' name='ITEM_VALUE' class=' input isSubmit _VAL_OjbsData dept_select' style='width:120px;display: none;'>"+ itemValOption2 +"</select>";	
    						...
    						if(rccList[i].CODE_SEGENT=="1"){
                    			...
                    			$("#addItemList tr:last").append("<td style='width: 30px;text-align: center;'><input id='"+i+"'  name='delCheckbox' type='checkbox' /></td>");
                    			
                                $("#addItemList tr:last").append("<td id='td1_"+i+"' style='width: 120px;'>"+codeSegentSel+"</td>");
                                $("#addItemList tr:last").append("<td id='td2_"+i+"' style='width: 120px;overflow: visible;padding:0;'><input class=' input isSubmit'  style='width: 100px;display:none;' id='itemVal_"+INDEX+"' name='ITEM_VALUE' value=''/></td>");//<input class=' input isSubmit'  style='width: 100px;display:none;' id='itemVal_"+INDEX+"' name='ITEM_VALUE' value=''/>
                                ...
                                if(rccList[i].START_RESET=="Y"){
                                    $("#addItemList tr:last").append("<td id='td7_"+i+"' style='width: 100px;text-align: center;padding:0;'><input type='checkbox' name='START_RESET' id='startReset_"+i+"' checked='checked'/></td>");
                                }else if(rccList[i].START_RESET=="N"){
                                    $("#addItemList tr:last").append("<td id='td7_"+i+"' style='width: 100px;text-align: center;padding:0;'><input type='checkbox' name='START_RESET' id='startReset_"+i+"'/></td>");
                                }
                                $("#addItemList tr:last").append("<td id='td8_"+i+"' style='width: 100px;text-align: center;overflow: visible;padding:0;' ><button id='configureBtn_"+i+"' class='setDataCol' type='button' onclick='popItemDiv("+i+");' ></button><input style='width: 100px;display:none;' id='configureType_"+i+"' name='CONFIGURE_TYPE' value='"+rccList[i].CONFIGURE_TYPE+"'/><input style='width: 100px;display:none;' id='configureVal_"+i+"' name='CONFIGURE_VAL' value=\""+rccList[i].CONFIGURE_VAL+"\"/></td>");
                                $("#addItemList tr:last").append("<td id='td9_"+i+"' style='width: 176px;text-align: center;padding:0;' class='operation'><p style='width:176px;'><span style='width:24px;' onclick='toTop(this)'></span><span style='width:24px;' onclick='toPrev(this)'></span><span style='width:24px;' onclick='toNext(this)'></span><span style='width:24px;' onclick='toBottom(this)'></span></p></td>");
                                
                    			mySetChosen();//设置下拉框样式
                    			
                    			//if(rccList[i].START_RESET=="Y"){
                    			//    $("#startReset_"+i).prop("checked","checked");
                                //}
    						    ...
    						    //文本
    						    tempInput="<input class=' input isSubmit'  style='width: 120px;' id='itemVal_"+i+"' name='ITEM_VALUE' value='"+rccList[i].ITEM_VALUE+"'/>";
    						    $("#addItemList").append("<tr id='trr_"+i+"' name='trname' style='height:30px;' ></tr>");
                    			$("#addItemList tr:last").append("<td id='' style='width: 30px;text-align: center;'></td>");
                    			$("#addItemList tr:last").append("<td style='width: 30px;text-align: center;'><input id='"+i+"' name='delCheckbox'  type='checkbox' /></td>");
                                ...
                                $("#addItemList tr:last").append("<td id='td6_"+i+"' style='width: 100px;overflow: visible;padding:0;'><input class=' input isSubmit'   style='width: 100px;display:none;' id='startSeq_"+i+"' name='START_SEQ' value=''/></td>");
                                if(rccList[i].START_RESET=="Y"){
                                    $("#addItemList tr:last").append("<td id='td7_"+i+"' style='width: 100px;text-align: center;padding:0;'><input type='checkbox' checked='checked' name='START_RESET' id='startReset_"+i+"' /></td>");
                                }else if(rccList[i].START_RESET=="N"){
                                    $("#addItemList tr:last").append("<td id='td7_"+i+"' style='width: 100px;text-align: center;padding:0;'><input type='checkbox' name='START_RESET' id='startReset_"+i+"' /></td>");
                                }
                                ...
                                $("#addItemList tr:last").append("<td id='td3_"+i+"' style='width: 80px;overflow: visible;padding:0;' ><input class=' input isSubmit'   style='width: 80px;' id='itemLen_"+i+"' name='ITEM_LEN' value='"+rccList[i].ITEM_LEN+"'/></td>");
                                $("#addItemList tr:last").append("<td id='td4_"+i+"' style='width: 100px;overflow: visible;padding:0;' >"+fillTypeSel+"</td>");
                                $("#addItemList tr:last").append("<td id='td5_"+i+"' style='width: 100px;overflow: visible;padding:0;' ><input class=' input isSubmit'   style='width: 100px;' id='fillChar_"+i+"' name='FILL_CHAR' value='"+rccList[i].FILL_CHAR+"'/></td>");
                                $("#addItemList tr:last").append("<td id='td6_"+i+"' style='width: 100px;overflow: visible;padding:0;'><input class=' input isSubmit'   style='width: 100px;' id='startSeq_"+i+"' name='START_SEQ' value='"+rccList[i].START_SEQ+"'/></td>");
                                if(rccList[i].START_RESET=="Y"){
                                    $("#addItemList tr:last").append("<td id='td7_"+i+"' style='width: 100px;text-align: center;padding:0;'><input type='checkbox' checked='checked' name='START_RESET' id='startReset_"+i+"' /></td>");
                                }else if(rccList[i].START_RESET=="N"){
                                    $("#addItemList tr:last").append("<td id='td7_"+i+"' style='width: 100px;text-align: center;padding:0;'><input type='checkbox' name='START_RESET' id='startReset_"+i+"' /></td>");
		...
		function editInfo(){
		    ...
		    if($("#paraMapObj_CCC_CONFIGURE_TYPE").val()==""){
				_alertValMsg($("#paraMapObj_CCC_CONFIGURE_TYPE_chosen"), "<dict:lang value="该项不能为空" />");
				return;
			}	
            $("#conType").val($("#paraMapObj_CCC_CONFIGURE_TYPE").val());
			if($("#paraMapObj_CCC_CONFIGURE_CODE").val()==""){
				_alertValMsg($("#paraMapObj_CCC_CONFIGURE_CODE"), "<dict:lang value="该项不能为空" />");
				return;
			}
			if($("#paraMapObj_CCC_CONFIGURE_NAME").val()==""){
				_alertValMsg($("#paraMapObj_CCC_CONFIGURE_NAME"), "<dict:lang value="该项不能为空" />");
				return;
			}
            ...
            if($("#paraMapObj_CCC_CONFIGURE_TYPE").val()=="3"){
            ...
            document.forms.editForm.action = "${path}buss/bussModel_exeFunc.ms?funcMId=f4f32f45a4fb4a7daf991f2f494072b2";
