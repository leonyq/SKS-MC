...
<body>
	...
	<input type="hidden" name="cfmId" id="cfmId" value="0" />
		<s:set name="_$viewId" value="'ac95d2b863814e1a9ca6fdfbf32f3ab2'" />
		<s:set name="_$formId_1" value="'1355857367cc4b2bb5a807aae7d37a48'" />
		<s:set name="_$type" value="'edit'"/>
	<tr>
		    <bu:ui colNo="ID" formId="1355857367cc4b2bb5a807aae7d37a48" dataId="${dataId}" formIndex="1" style="display:none" id="paraMap1_rewardId"/>
			<td class="name" style="width:120px;"/><span class="dot">*</span><bu:uitn colNo="REWARD_CODE" formId="1355857367cc4b2bb5a807aae7d37a48" 	/></td>
		...
		<td>&nbsp;</td>
			<td class="name" style="width:120px;"/><span class="dot">*</span><bu:uitn colNo="REWARD_DATE" formId="1355857367cc4b2bb5a807aae7d37a48" /></td>
	    ...
	    <td>&nbsp;</td>		
			<td class="name" style="width:120px;"/><span class="dot">*</span><bu:uitn colNo="REWARD_NAME" formId="1355857367cc4b2bb5a807aae7d37a48" /></td>
	...
	<tr>
			<td class="name" /><span class="dot">*</span><bu:uitn colNo="REWARD_USER_ID" formId="1355857367cc4b2bb5a807aae7d37a48" /></td>
        ...
        <td>&nbsp;</td>			
	        <td class="name" style="width:90px;"/><bu:uitn colNo="REWARD_TYPE" formId="1355857367cc4b2bb5a807aae7d37a48" /></td>
		...
		<td>&nbsp;</td>
            <td class="name" style="width:90px;"/><bu:uitn colNo="REWARD_FILE_NAME" formId="1355857367cc4b2bb5a807aae7d37a48" /></td>
			<bu:td cssClass="dec-self" colNo="REWARD_FILE_NAME" formId="1355857367cc4b2bb5a807aae7d37a48" ><bu:ui colNo="REWARD_FILE_NAME"  name="upFile"  formId="1355857367cc4b2bb5a807aae7d37a48" dataId="${dataId}" formIndex="1" style="width: 200px;"/></bu:td>
	</tr>
	</tr>
	<tr>
            <td class="name" style="width:90px;"/><span class="dot">*</span><bu:uitn colNo="REWARD_CONTENT" formId="1355857367cc4b2bb5a807aae7d37a48" /></td>
	...
	<tr>
			<td class="name-four" style="width:90px;"/><bu:uitn colNo="REMARK" formId="1355857367cc4b2bb5a807aae7d37a48" /></td>
...
<script type="text/javascript">
	...
	function popWorkDiv(showId, backId) {
		...
		$("#" + showId).show();
		$("#" + backId).show();
		$("#" + backId)	.attr('style'	,'display:block');
   ...
   /* //员工表格重新排序
	...
	function getEmployeeUrl(){
        var url="${path}buss/bussModel_exeFunc.ms?funcMId=eec55ba6edcc4911a6ff12bbfb76ec80"; 
        return url;
    }
	...
	$(document).ready(function () {
        ...
        var data = {"rewardId":$("#paraMap1_rewardId").val()};
        //console.log(data)
	    var	userIds	= ""
    	$.ajax({
		type: "post",
		...
		success: function(data) {
	        ...
	        for (var i = 0; i < data.length; i ++) {
    			...
    			$("#showZJFront tr:last").append("<td class='datagrid-cell' style='width:30px; text-align:center;'><span><input type='checkbox' style='cursor: pointer;'></span></td>");
    			$("#showZJFront tr:last").append("<td class='datagrid-cell' style='width:285px; text-align:center;'>" + data[i].LOGIN_NAME + " </td>");
    			$("#showZJFront tr:last").append("<td class='datagrid-cell' style='width:285px;text-align:center;'>" + data[i].NAME + " </td>");
    			$("#showZJFront tr:last").append("<td class='datagrid-cell' style='width:285px;text-align:center;'>" + data[i].DEPT_NAME + " </td>");
