...
<head>
    <title>
		<dict:lang value="ldg测试数据权限view模型	" />
    </title>
...
<body scroll="auto" style="overflow: auto;" >
    <div class="content-in">
        <div class="dlist">
            <div class="hd">
		<bu:func viewId="f56c5b9d14e6490bad424b29c200e8ee" />
            </div>
            <div class="bd">
		...
		<bu:search viewId="f56c5b9d14e6490bad424b29c200e8ee" />
                   </form>
		...
		<bu:submit viewId="f56c5b9d14e6490bad424b29c200e8ee" />
      <jsp:include page="/plf/page/mesdemo/commCode/commCode.jsp">
           <jsp:param name="modelName" value="VIEW_TYPE_17" />
           <jsp:param name="location" value="beforeJsLoad" />
      </jsp:include>
		<bu:script viewId="f56c5b9d14e6490bad424b29c200e8ee" />
