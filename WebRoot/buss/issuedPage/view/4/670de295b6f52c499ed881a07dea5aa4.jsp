...
<head>
    ...
    <%@ include file="/plf/page/common/buss/listCommJs.jsp"%>
		<bu:header formId ="a84cbcdf655c412fb9a1baec7fd6db96"/>
...
<body scroll="auto" style="overflow: auto;" >
    <div class="content-in">
        <div class="dlist">
            <div class="hd">
		<bu:func viewId="6f7d266cba2c4186b5aedd8654809d0e" />
            </div>
            <div class="bd">
		...
		<bu:search viewId="6f7d266cba2c4186b5aedd8654809d0e" />
                   </form>
		...
		<input type="hidden" name="formPagea84cbcdf655c412fb9a1baec7fd6db96" id="formPagea84cbcdf655c412fb9a1baec7fd6db96" value="${formPagea84cbcdf655c412fb9a1baec7fd6db96}"/>
		<input type="hidden" name="formId" id="formId1" value='a84cbcdf655c412fb9a1baec7fd6db96'/>
		<input type="hidden" id="subRelColIds" name="subRelColIds" value='null'/>
		<input type="hidden" id="subFormIds" name="subFormIds" value='null'/>
		<div class="panel-ajax datagrid datagrid-div1"  id="a84cbcdf655c412fb9a1baec7fd6db96">
		<div class="datagrid-div2 datagrid-div6 datagrid-view-ajax" id="datagrid-view-ajaxa84cbcdf655c412fb9a1baec7fd6db96" style="">
		<div class="datagrid-header">
		<div class="datagrid-header-inner" id="datagrid-header-innera84cbcdf655c412fb9a1baec7fd6db96">
		<bu:table cssClass="datagrid-htable fixedTable datagrid-div6 datagrid-htable-kz" id="datagrid-htablea84cbcdf655c412fb9a1baec7fd6db96">
		<s:set name="_$type" value="'view'" />
		<tbody class="isParentsTitle">
		<bu:tr cssClass="datagrid-header-row datagrid-title-ajax" id="datagrid-title-ajax">
			<td class="datagrid-cell" style="width:30px; text-align:center;" ><bu:thSeq  formId="a84cbcdf655c412fb9a1baec7fd6db96" i18n="1"/></td>
			<td class="datagrid-cell" style="width:30px; text-align:center"><span><input type="checkbox" id="selectAll_a84cbcdf655c412fb9a1baec7fd6db96" onclick="_selectAjaxTableAllData(this,'a84cbcdf655c412fb9a1baec7fd6db96')" style="cursor: pointer;"title="全选"/></span></td>
			<td class="datagrid-cell"><bu:uitn colNo="SNO" formId="a84cbcdf655c412fb9a1baec7fd6db96" /></td>
			<td class="datagrid-cell"><bu:uitn colNo="NAME" formId="a84cbcdf655c412fb9a1baec7fd6db96" /></td>
			<td class="datagrid-cell"><bu:uitn colNo="SEX" formId="a84cbcdf655c412fb9a1baec7fd6db96" /></td>
			<td class="datagrid-cell"><bu:uitn colNo="AGE" formId="a84cbcdf655c412fb9a1baec7fd6db96" /></td>
			<td class="datagrid-cell"><bu:uitn colNo="NATION" formId="a84cbcdf655c412fb9a1baec7fd6db96" /></td>
			<td class="datagrid-cell"><bu:uitn colNo="XUELI" formId="a84cbcdf655c412fb9a1baec7fd6db96" /></td>
			<td class="datagrid-cell"><bu:uitn colNo="HOBBY" formId="a84cbcdf655c412fb9a1baec7fd6db96" /></td>
			<td class="datagrid-cell"><bu:uitn colNo="BIRTH" formId="a84cbcdf655c412fb9a1baec7fd6db96" /></td>
			<td class="datagrid-cell"><bu:uitn colNo="PHOME" formId="a84cbcdf655c412fb9a1baec7fd6db96" /></td>
			<td class="datagrid-cell"><bu:uitn colNo="SCORE" formId="a84cbcdf655c412fb9a1baec7fd6db96" /></td>
			<td class="datagrid-cell"><bu:uitn colNo="PROVINCE" formId="a84cbcdf655c412fb9a1baec7fd6db96" /></td>
			<td class="datagrid-cell"><bu:uitn colNo="CITY" formId="a84cbcdf655c412fb9a1baec7fd6db96" /></td>
			<td class="datagrid-cell"><bu:uitn colNo="PHOTO" formId="a84cbcdf655c412fb9a1baec7fd6db96" /></td>
			<td class="datagrid-cell"><bu:uitn colNo="WENJIAN" formId="a84cbcdf655c412fb9a1baec7fd6db96" /></td>
			<td class="datagrid-cell"><bu:uitn colNo="ZHUCE" formId="a84cbcdf655c412fb9a1baec7fd6db96" /></td>
			<td class="datagrid-cell"><bu:uitn colNo="BEIZHU" formId="a84cbcdf655c412fb9a1baec7fd6db96" /></td>
			<td class="datagrid-cell"><bu:uitn colNo="MOREN" formId="a84cbcdf655c412fb9a1baec7fd6db96" /></td>
			<td class="datagrid-cell"><bu:uitn colNo="WU_NAME" formId="a84cbcdf655c412fb9a1baec7fd6db96" /></td>
			<td class="datagrid-cell"><bu:uitn colNo="WU_CODE" formId="a84cbcdf655c412fb9a1baec7fd6db96" /></td>
			<td class="datagrid-cell"><bu:uitn colNo="WU_SPEC" formId="a84cbcdf655c412fb9a1baec7fd6db96" /></td>
		</bu:tr>
		</tbody>
		</bu:table>
		</div>
		</div>
		<div class="datagrid-body datagrid-div3 datagrid-body-ajax" id="tableDiva84cbcdf655c412fb9a1baec7fd6db96" onscroll="ajaxTableScroll(this,'a84cbcdf655c412fb9a1baec7fd6db96')">
		<table class="datagrid-btable fixedTable dblClick"  id="datagrid-btable-ajaxa84cbcdf655c412fb9a1baec7fd6db96">
		<tbody id="tbody_a84cbcdf655c412fb9a1baec7fd6db96" class="isParents">
		</tbody>
		</table>		</div>
		</div>
		</div>
		<c:if test="${formPagea84cbcdf655c412fb9a1baec7fd6db96==1}">			<div class="center">
			<s:include value="/plf/page/fp/paginationPopMultAx.jsp?listDataFn=listAjaxTable&formId=a84cbcdf655c412fb9a1baec7fd6db96&showLoading=0" />
			</div>
		</c:if>
		</div>
		...
		<bu:submit viewId="6f7d266cba2c4186b5aedd8654809d0e" />
      <jsp:include page="/plf/page/mesdemo/commCode/commCode.jsp">
           <jsp:param name="modelName" value="VIEW_TYPE_17" />
           <jsp:param name="location" value="beforeJsLoad" />
      </jsp:include>
		<bu:script viewId="6f7d266cba2c4186b5aedd8654809d0e" />
...
function createTableModel(ms,formId){
    ...
    if(formId=='a84cbcdf655c412fb9a1baec7fd6db96'){<%--学生信息--%>
