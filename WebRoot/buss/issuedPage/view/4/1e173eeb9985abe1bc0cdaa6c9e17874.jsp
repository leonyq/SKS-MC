...
<body scroll="auto" style="overflow: auto;" >
    <div class="content-in">
		...
		<bu:tr cssClass="datagrid-header-row datagrid-title-ajax" id="datagrid-title-ajax">
			...
			<td class="datagrid-cell" style="width:100px;"><bu:uitn colNo="THA_TIME_TOTAL" formId="776a9d93290b4cef813dc66f100cbe1e" /></td>
			<td class="datagrid-cell" style="width:100px;"><bu:uitn colNo="THA_TIME_MAX" formId="776a9d93290b4cef813dc66f100cbe1e" /></td>
			<td class="datagrid-cell" style="width:120px;"><bu:uitn colNo="THA_CYCLE" formId="776a9d93290b4cef813dc66f100cbe1e" /></td>
			<td class="datagrid-cell" style="width:150px;"><bu:uitn colNo="CTT_BEGIN_TIME" formId="776a9d93290b4cef813dc66f100cbe1e" /></td>
			<td class="datagrid-cell" style="width:150px;"><bu:uitn colNo="CTT_EXPECT_TIME" formId="776a9d93290b4cef813dc66f100cbe1e" /></td>
        ...
        $.each(uiTxt,function(i,v){
            ...
            //arrHtml.push("<span colno='THA_TIN_STATUS' class='"+ms.uiClass(formId, 'THA_TIN_STATUS')+"' style='"+ms.uiStyle(formId, 'THA_TIN_STATUS')+"' "+ms.uiEvent(formId, 'THA_TIN_STATUS')+" >"+1+"</span>")
             if(nowDate.getTime()<ctt_expect_time_todate.getTime()){
                ...
                arrHtml.push("<span style='color:##FFFFFF;width:50px;display: inline-block;background-color:#ff0000' class='state fixedTable dlist-table'>回温中</span>")
       		}else{
       		       //    $(expect_time_name).css("background-color","#980000");
       	           //    $(expect_time_name).text('回温结束'); 
       	       arrHtml.push("<span style='color:##FFFFFF;width:50px;display: inline-block;background-color:#980000' class='state fixedTable dlist-table'>回温结束</span>")
       		}
            ...
            arrHtml.push("</td>");
            arrHtml.push("<td colno='THA_TIME_TOTAL' class='datagrid-cell "+ms.tdClass(formId, 'THA_TIME_TOTAL')+"' style='width:100px;text-align:right;"+ms.tdStyle(formId, 'THA_TIME_TOTAL')+"' "+ms.tdEvent(formId, 'THA_TIME_TOTAL')+">")
            ...
            arrHtml.push("</td>");
            arrHtml.push("<td colno='THA_TIME_MAX' class='datagrid-cell "+ms.tdClass(formId, 'THA_TIME_MAX')+"' style='width:100px;text-align:right;"+ms.tdStyle(formId, 'THA_TIME_MAX')+"' "+ms.tdEvent(formId, 'THA_TIME_MAX')+">")
            ...
            arrHtml.push("</td>");
            arrHtml.push("<td colno='CTT_EXPECT_TIME' class='datagrid-cell "+ms.tdClass(formId, 'CTT_EXPECT_TIME')+"' style='width:150px;text-align:center;"+ms.tdStyle(formId, 'CTT_EXPECT_TIME')+"' "+ms.tdEvent(formId, 'CTT_EXPECT_TIME')+">")
            ...
            arrHtml.push("</td>");
            arrHtml.push("<td colno='CTT_END_TIME' class='datagrid-cell "+ms.tdClass(formId, 'CTT_END_TIME')+"' style='width:130px;text-align:center;"+ms.tdStyle(formId, 'CTT_END_TIME')+"' "+ms.tdEvent(formId, 'CTT_END_TIME')+">")
            ...
            arrHtml.push("</td>");
            arrHtml.push("<td colno='CTT_OPERATOR' class='datagrid-cell "+ms.tdClass(formId, 'CTT_OPERATOR')+"' style='text-align:center;"+ms.tdStyle(formId, 'CTT_OPERATOR')+"' "+ms.tdEvent(formId, 'CTT_OPERATOR')+">")
