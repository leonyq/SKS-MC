...
<body scroll="auto" style="overflow: auto;" >
    <div class="content-in">
		...
		<bu:tr cssClass="datagrid-header-row datagrid-title-ajax" id="datagrid-title-ajax">
			...
			<td class="datagrid-cell" style="width:140px;"><bu:uitn colNo="CFI_FIX_SN" formId="c3a183e393ea4dfabb15712f9dba1873" /></td>
			<td class="datagrid-cell"  ><bu:uitn colNo="CFI_FIX_STATUS" formId="c3a183e393ea4dfabb15712f9dba1873" /></td>
			<td class="datagrid-cell"  ><bu:uitn colNo="CFI_ITEM_TYPE" formId="c3a183e393ea4dfabb15712f9dba1873" /></td>
			<td class="datagrid-cell"  ><bu:uitn colNo="CFI_ITEM_CODE" formId="c3a183e393ea4dfabb15712f9dba1873" /></td>
			<td class="datagrid-cell"  ><bu:uitn colNo="CFI_ASSISTANTTOOLNAME" formId="c3a183e393ea4dfabb15712f9dba1873" /></td>
			<td class="datagrid-cell"  ><bu:uitn colNo="CFI_ASSISTANTTOOLSPEC" formId="c3a183e393ea4dfabb15712f9dba1873" /></td>
			<td class="datagrid-cell"  ><bu:uitn colNo="CFI_MT_TYPE" formId="c3a183e393ea4dfabb15712f9dba1873" /></td>
			<td class="datagrid-cell"  style="width:140px;"><bu:uitn colNo="CFI_MT_VAULE" formId="c3a183e393ea4dfabb15712f9dba1873" /></td>
			<td class="datagrid-cell"  ><bu:uitn colNo="CFI_MT_REMIND" formId="c3a183e393ea4dfabb15712f9dba1873" /></td>
			<td class="datagrid-cell"  style="width:140px;"><bu:uitn colNo="CFI_INSTOCK_TIME" formId="c3a183e393ea4dfabb15712f9dba1873" /></td>
			<td class="datagrid-cell"  ><bu:uitn colNo="CFI_INSTOCK_MAN" formId="c3a183e393ea4dfabb15712f9dba1873" /></td>
    ...
    if(formId=='c3a183e393ea4dfabb15712f9dba1873'){<%--FM-制具信息--%>
        $.each(uiTxt,function(i,v){
            ...
            //    arrHtml.push("<input type='hidden' id='PM_STATUS_"+v.ID+"' value='"+uiRaw[i].CFI_FIX_STATUS+"' />");
                ...
                arrHtml.push("<td colno='CFI_FIX_SN' class='datagrid-cell "+ms.tdClass(formId, 'CFI_FIX_SN')+"' style='width:140px;"+ms.tdStyle(formId, 'CFI_FIX_SN')+"' "+ms.tdEvent(formId, 'CFI_FIX_SN')+">")
                ...
                arrHtml.push("</td>");
                arrHtml.push("<td colno='CFI_MT_VAULE' class='datagrid-cell "+ms.tdClass(formId, 'CFI_MT_VAULE')+"' style='width:140px;"+ms.tdStyle(formId, 'CFI_MT_VAULE')+"' "+ms.tdEvent(formId, 'CFI_MT_VAULE')+">")
                ...
                arrHtml.push("</td>");
                arrHtml.push("<td colno='CFI_INSTOCK_TIME' class='datagrid-cell "+ms.tdClass(formId, 'CFI_INSTOCK_TIME')+"' style='width:140px;"+ms.tdStyle(formId, 'CFI_INSTOCK_TIME')+"' "+ms.tdEvent(formId, 'CFI_INSTOCK_TIME')+">")
