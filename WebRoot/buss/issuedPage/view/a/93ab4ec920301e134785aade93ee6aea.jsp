...
function createTableModel(ms,formId){
    ...
    if(formId=='e09e1f47e824490d80ba2717d25498d3'){<%--辅料制具料号信息--%>
        $.each(uiTxt,function(i,v){
            ...
            arrHtml.push("</td>");
            arrHtml.push("<td colno='FIX_MT_CYCLE' class='datagrid-cell "+ms.tdClass(formId, 'FIX_MT_CYCLE')+"' style='width:120px;text-align:right;"+ms.tdStyle(formId, 'FIX_MT_CYCLE')+"' "+ms.tdEvent(formId, 'FIX_MT_CYCLE')+">")
            ...
            arrHtml.push("</td>");
            arrHtml.push("<td colno='FIX_MT_REMIND' class='datagrid-cell "+ms.tdClass(formId, 'FIX_MT_REMIND')+"' style='width:110px;text-align:right;"+ms.tdStyle(formId, 'FIX_MT_REMIND')+"' "+ms.tdEvent(formId, 'FIX_MT_REMIND')+">")
            ...
            arrHtml.push("</td>");
            arrHtml.push("<td colno='TIN_USE_TIME' class='datagrid-cell "+ms.tdClass(formId, 'TIN_USE_TIME')+"' style='text-align:right;"+ms.tdStyle(formId, 'TIN_USE_TIME')+"' "+ms.tdEvent(formId, 'TIN_USE_TIME')+">")
