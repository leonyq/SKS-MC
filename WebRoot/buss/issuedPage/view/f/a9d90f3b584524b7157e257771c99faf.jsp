...
<body scroll="auto" style="overflow: auto;" >
    <div class="content-in">
		...
		<bu:table cssClass="datagrid-htable fixedTable datagrid-div6 datagrid-htable-kz" id="datagrid-htable167639778c8f4ee08caad77b61e5081c"  style="min-width:1200px;">
		...
		<bu:tr cssClass="datagrid-header-row datagrid-title-ajax" id="datagrid-title-ajax">
			...
			<td class="datagrid-cell" style="width:110px;"><bu:uitn colNo="CM_NAME" formId="167639778c8f4ee08caad77b61e5081c" /></td>
			...
			<td class="datagrid-cell" style="width:110px;"><bu:uitn colNo="CM_MODEL_NAME" formId="167639778c8f4ee08caad77b61e5081c" /></td>
			...
			<td class="datagrid-cell" style="width:150px;"><bu:uitn colNo="CREATE_TIME" formId="167639778c8f4ee08caad77b61e5081c" /></td>
			<td class="datagrid-cell"><bu:uitn colNo="CREATE_USER" formId="167639778c8f4ee08caad77b61e5081c" /></td>
		...
		<table class="datagrid-btable fixedTable"  id="datagrid-btable-ajax167639778c8f4ee08caad77b61e5081c" style="min-width:1180px;">
    ...
    if(formId=='167639778c8f4ee08caad77b61e5081c'){<%--料站表--%>
        $.each(uiTxt,function(i,v){
            ...
            if($("#"+formId).find(".left-datagrid-title-ajax").length>0){
                ...
                arrHtml.push("<td colno='CM_SN' class='datagrid-cell "+ms.tdClass(formId, 'CM_SN')+"' style='width:150px;"+ms.tdStyle(formId, 'CM_SN')+"' "+ms.tdEvent(formId, 'CM_SN')+">")
                ...
                arrHtml.push("</td>");
                arrHtml.push("<td colno='CM_NAME' class='datagrid-cell "+ms.tdClass(formId, 'CM_NAME')+"' style='width:110px;"+ms.tdStyle(formId, 'CM_NAME')+"' "+ms.tdEvent(formId, 'CM_NAME')+">")
                ...
                arrHtml.push("</td>");
                arrHtml.push("<td colno='CM_MODEL_CODE' class='datagrid-cell "+ms.tdClass(formId, 'CM_MODEL_CODE')+"' style='width:150px;"+ms.tdStyle(formId, 'CM_MODEL_CODE')+"' "+ms.tdEvent(formId, 'CM_MODEL_CODE')+">")
                arrHtml.push("<span colno='CM_MODEL_CODE' class='"+ms.uiClass(formId, 'CM_MODEL_CODE')+"' style='"+ms.uiStyle(formId, 'CM_MODEL_CODE')+"' "+ms.uiEvent(formId, 'CM_MODEL_CODE')+" >"+v['CM_MODEL_CODE']+"</span>")
                arrHtml.push("</td>");
                arrHtml.push("<td colno='CM_MODEL_STANDARD' class='datagrid-cell "+ms.tdClass(formId, 'CM_MODEL_STANDARD')+"' style='width:150px;"+ms.tdStyle(formId, 'CM_MODEL_STANDARD')+"' "+ms.tdEvent(formId, 'CM_MODEL_STANDARD')+">")
                ...
                arrHtml.push("</td>");
                arrHtml.push("<td colno='CM_MODEL_NAME' class='datagrid-cell "+ms.tdClass(formId, 'CM_MODEL_NAME')+"' style='width:110px;"+ms.tdStyle(formId, 'CM_MODEL_NAME')+"' "+ms.tdEvent(formId, 'CM_MODEL_NAME')+">")
                ...
                arrHtml.push("</td>");
                arrHtml.push("<td colno='CREATE_TIME' class='datagrid-cell "+ms.tdClass(formId, 'CREATE_TIME')+"' style='width:150px;"+ms.tdStyle(formId, 'CREATE_TIME')+"' "+ms.tdEvent(formId, 'CREATE_TIME')+">")
