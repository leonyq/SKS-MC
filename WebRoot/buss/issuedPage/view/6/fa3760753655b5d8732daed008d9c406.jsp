...
<body scroll="auto" style="overflow: auto;" >
    <div class="content-in">
		...
		<bu:table cssClass="datagrid-htable fixedTable datagrid-div6 datagrid-htable-kz" id="datagrid-htable62aabb92147842e1983bcfcda04f9a1d" style="min-width:1370px;">
...
function createTableModel(ms,formId){
    ...
    if(formId=='62aabb92147842e1983bcfcda04f9a1d'){<%--FM-辅料履历信息表--%>
        $.each(uiTxt,function(i,v){
            ...
            arrHtml.push("</td>");
            arrHtml.push("<td colno='CTO_OPERATE_TYPE' class='datagrid-cell "+ms.tdClass(formId, 'CTO_OPERATE_TYPE')+"' style='width:120px;text-align:center;"+ms.tdStyle(formId, 'CTO_OPERATE_TYPE')+"' "+ms.tdEvent(formId, 'CTO_OPERATE_TYPE')+">")
            ...
            arrHtml.push("</td>");
            arrHtml.push("<td colno='CTO_ITEM_TYPE' class='datagrid-cell "+ms.tdClass(formId, 'CTO_ITEM_TYPE')+"' style='width:120px;;text-align:center;"+ms.tdStyle(formId, 'CTO_ITEM_TYPE')+"' "+ms.tdEvent(formId, 'CTO_ITEM_TYPE')+">")
            ...
            arrHtml.push("</td>");
            arrHtml.push("<td colno='CTO_OPERATE_TIME' class='datagrid-cell "+ms.tdClass(formId, 'CTO_OPERATE_TIME')+"' style='width:150px;text-align:center;"+ms.tdStyle(formId, 'CTO_OPERATE_TIME')+"' "+ms.tdEvent(formId, 'CTO_OPERATE_TIME')+">")
            ...
            arrHtml.push("</td>");
            arrHtml.push("<td colno='CTO_OPEATOR' class='datagrid-cell "+ms.tdClass(formId, 'CTO_OPEATOR')+"' style=';text-align:center;"+ms.tdStyle(formId, 'CTO_OPEATOR')+"' "+ms.tdEvent(formId, 'CTO_OPEATOR')+">")
