...
<script type="text/javascript">
               ...
               function setTableWidth(formId){
                ...
                function init(){
                    ...
                    getFormIdInitChildPage();
                    initTableWidth();
                    console.log(timeBeginString())
                     $("#WOI_DELIVERY_DATE_BEGIN").val(timeBeginString());
                    $("#WOI_DELIVERY_DATE_END").val(timeEndString());
                    $(document.getElementById('T2#WOD_DOC_TYPE')).val('DJ12');
					...
					success: function(data){
							...
							if(null != data.ajaxPage.dataList){
								...
								//	$("#datagrid-btable-ajaxbc3be8856f4f4b09bd75be3a5f1c5b02 tr:last").append("<td class='datagrid-cell datagrid-cell-2' style='width:200px;text-align: left;' title='"+rccList[i].DATA_AUTH+"'>"+rccList[i].DATA_AUTH+"</td>");
									$("#datagrid-btable-ajaxbc3be8856f4f4b09bd75be3a5f1c5b02 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:210px;text-align: left;' title='"+rccList[i].ITEM_SN+"'>"+rccList[i].ITEM_SN+"</td>");
									$("#datagrid-btable-ajaxbc3be8856f4f4b09bd75be3a5f1c5b02 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:150px;text-align: left;' title='"+rccList[i].ITEM_CODE+"'>"+rccList[i].ITEM_CODE+"</td>");
					...
					success: function(data){
							...
							if(null != data.ajaxPage.dataList){
								...
								for(var i = 0;i < rccList.length; i++){
									...
									$("#datagrid-btable-ajaxbc3be8856f4f4b09bd75be3a5f1c5b03 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:210px;text-align: left;' title='"+rccList[i].ITEM_SN+"'>"+rccList[i].ITEM_SN+"</td>");
									$("#datagrid-btable-ajaxbc3be8856f4f4b09bd75be3a5f1c5b03 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:150px;text-align: left;' title='"+rccList[i].ITEM_CODE+"'>"+rccList[i].ITEM_CODE+"</td>");
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(type==1){
                ...
                var url = "${path}buss/bussModel_exeFunc.ms?FUNC_CODE=F6854&funcMId=eabb689a83f241e18e07f337e8ad61c2&formId=bc3be8856f4f4b09bd75be3a5f1c5b5f&dataId="+dateId+"&iframeId="+_currentFrame;			
