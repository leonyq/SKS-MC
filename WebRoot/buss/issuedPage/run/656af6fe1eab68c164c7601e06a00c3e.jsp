...
<body  scroll="auto" style="overflow: auto;">
    <div class="content-in">
		...
		<bu:tr cssClass="datagrid-header-row datagrid-title-ajax" id="datagrid-title-ajax">
			...
			<td class="datagrid-cell" style="width:200px;"><bu:uitn colNo="DATA_AUTH" formId="013c4606017841b6b4e7f01e2a32d0a6" /></td>
    ...
    if(formId=='013c4606017841b6b4e7f01e2a32d0a6'){<%--物料信息--%>
        $.each(uiTxt,function(i,v){
            ...
            if($("#"+formId).find(".left-datagrid-title-ajax").length>0){
                ...
                arrHtml.push("<span colno='CI_ITEM_TYPE' class='"+ms.uiClass(formId, 'CI_ITEM_TYPE')+"' style='"+ms.uiStyle(formId, 'CI_ITEM_TYPE')+"' "+ms.uiEvent(formId, 'CI_ITEM_TYPE')+" title='"+v.CI_ITEM_TYPE+"'>"+v['CI_ITEM_TYPE']+"</span>")
                arrHtml.push("</td>");
                ...
                arrHtml.push("<span colno='CI_ITEM_GENRE' class='"+ms.uiClass(formId, 'CI_ITEM_GENRE')+"' style='"+ms.uiStyle(formId, 'CI_ITEM_GENRE')+"' "+ms.uiEvent(formId, 'CI_ITEM_GENRE')+" title='"+v.CI_ITEM_GENRE+"'>"+v['CI_ITEM_GENRE']+"</span>")
                arrHtml.push("</td>");
                arrHtml.push("<td colno='CI_MIN_PACK' class='datagrid-cell "+ms.tdClass(formId, 'CI_MIN_PACK')+"' style='width:90px;text-align:right;"+ms.tdStyle(formId, 'CI_MIN_PACK')+"' "+ms.tdEvent(formId, 'CI_MIN_PACK')+">")
                arrHtml.push("<span colno='CI_MIN_PACK' class='"+ms.uiClass(formId, 'CI_MIN_PACK')+"' style='"+ms.uiStyle(formId, 'CI_MIN_PACK')+"' "+ms.uiEvent(formId, 'CI_MIN_PACK')+" title='"+v.CI_MIN_PACK+"'>"+v['CI_MIN_PACK']+"</span>")
                arrHtml.push("</td>");
