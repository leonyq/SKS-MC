		...
		success: function(data){
						...
						if(null != data.ajaxPage.dataList){
							...
							for(var i = 0;i < rccList.length; i++){
								...
								$("#datagrid-btable-ajax0b6208aca3fe40d5bc66a4c230c31234 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:250PX;text-align: center;' title='"+rccList[i].WSI_ITEM_CODE+"'>"+rccList[i].WSI_ITEM_CODE+"</td>");
		...
		success: function(data){
						...
						if(null != data.ajaxPage.dataList){
							...
							for(var i = 0;i < rccList.length; i++){
								...
								$("#datagrid-btable-ajax0b6208aca3fe40d5bc66a4c230c31234 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:150px;text-align: center;' title='"+rccList[i].WSI_ITEM_CODE+"'>"+rccList[i].WSI_ITEM_CODE+"</td>");
						...
						if(null != data.ajaxPage.dataList){
							...
							for(var i = 0;i < rccList.length; i++){
								...
								var backgroudColor = (i+1)%2 == 0 ? "tr-hover" : "";
			 					...
			 					+"<span colno='WSI_ITEM_SN' title='"+rccList[i].WSI_ITEM_SN+"'>"+rccList[i].WSI_ITEM_SN+"</span>"
			 					+"</td>"
			 					...
			 					+"<span colno='WSI_ITEM_CODE' title='"+rccList[i].WSI_ITEM_CODE+"'>"+rccList[i].WSI_ITEM_CODE+"</span>"
			 					+"</td>"
			 					...
			 					+"<span colno='WSI_DOC_NUM' title='"+rccList[i].WSI_DOC_NUM+"'>"+rccList[i].WSI_DOC_NUM+"</span>"
			 					+"</td>"
			 					+"<td colno='WSI_CONNECT_DOC' class='datagrid-cell' style='width:120px;'>"
			 					+"<span colno='WSI_CONNECT_DOC' title='"+rccList[i].WSI_CONNECT_DOC+"'>"+rccList[i].WSI_CONNECT_DOC+"</span>"
			 					+"</td>"
