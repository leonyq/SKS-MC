               ...
               <form id="listForm" name="listForm" action="" method="post">
					...
					<DIV id="container" style="padding:0 2px;box-sizing: border-box;">
						<DIV class="hd">
							...
							<UL class="tab-list tab" style="display:none;"> 
								<LI id="tag1"><A class=""
						...
						<dict:selectDict id="itemGenre" name="itemGenre" dictCode="MAIN_MENU"  dictValue="%{userDto.MAIN_MENU}"  style="cursor: pointer;width:230px;" onchange="getInfo(this.value);this.blur();" /> 
	...
	$("#textTbody :checkbox").each(function(){
			if($(this).attr("checked")){
				if (!$("#"+trId+$(this).attr("id")).length) {
					...
					$("#"+tableId+" tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:200px;text-align: center;'>"+$("#MOUDLE_NAME"+$(this).attr("id")).val()+"<input type='hidden'  name='MOUDLE_NAME' value='"+$("#MOUDLE_NAME_R"+$(this).attr("id")).val()+"'/></td>");
					$("#"+tableId+" tr:last").append("<td class='datagrid-cell datagrid-cell-5' style='width:200px;text-align: center;'>"+$("#TAS_FUN_NAME"+$(this).attr("id")).val()+"<input type='hidden'  name='TAS_FUN_NAME' value='"+$("#TAS_FUN_NAME"+$(this).attr("id")).val()+"'/></td>");
					$("#"+tableId+" tr:last").append("<td class='datagrid-cell datagrid-cell-6' style='width:120px;text-align: center;'>"+$("#SHOW_TYPE"+$(this).attr("id")).val()+"<input type='hidden'  name='SHOW_TYPE' value='"+$("#SHOW_TYPE_R"+$(this).attr("id")).val()+"'/></td>");
					$("#"+tableId+" tr:last").append("<td class='datagrid-cell datagrid-cell-6' style='width:120px;text-align: center;'>"+$("#SHOW_TYPE"+$(this).attr("id")).val()+"<input type='hidden'  name='SHOW_TYPE' value='"+$("#SHOW_TYPE_R"+$(this).attr("id")).val()+"'/></td>");
...
function saveMoudle(type){//首页  1/仓储   4   产量  2/品质   3 /预警 5
	...
	if(len>0){
		document.forms.submit_Form.action="${path}buss/bussModel_exeFunc.ms?funcMId=aa68adcf08dc47e6982ea093e30939f8";
...
function delReal(){
	document.forms.submit_Form.action="${path}buss/bussModel_exeFunc.ms?funcMId=c6198876afde4c94a8d85bb1871d3c9a";
	document.forms.submit_Form.submit();
	$("#submitTable").empty();
}
//加载首页/仓储   页面信息
                	...
                	if(null!=data.ajaxList){
                	   ...
                	   for(var i=0;i<rccList.length;i++){
						   ...
						   $("#"+tbodyId+" tr:last").append("<td class='datagrid-cell datagrid-cell-1' style='width:30px;text-align: center;'>"+(i+1)+"</td>");
						    ...
						    $("#"+tbodyId+" tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:200px;text-align: center;'>"+rccList[i].MENU_ID+"<input type='hidden' name='MOUDLE_NAME' value='"+rccList[i].TAS_MENU_ID+"'/></td>");
	           ...
	           success:function(data){		
                	...
                	if(null!=data.ajaxList){
                	   ...
                	   for(var i=0;i<rccList.length;i++){
						   ...
						   $("#"+tbodyId+" tr:last").append("<td class='datagrid-cell datagrid-cell-1' style='width:30px;text-align: center;'>"+(i+1)+"</td>");
							$("#"+tbodyId+" tr:last").append("<td class='datagrid-cell datagrid-cell-2' style='width:30px;text-align: center;'><input value='"+rccList[i].ID+"' type='checkbox' name='isSelect1'/></td>");
							$("#"+tbodyId+" tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='text-align: center;'>"+rccList[i].MENU_ID+"<input type='hidden' name='MOUDLE_NAME' value='"+rccList[i].TAS_MENU_ID+"'/></td>");
							$("#"+tbodyId+" tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='text-align: center;'>"+rccList[i].MOUDLE_NAME+"<input type='hidden' name='MOUDLE_NAME' value='"+rccList[i].TAS_MOUDLE_ID+"'/></td>");
