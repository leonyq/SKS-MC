...
function listAjaxTable(formId){
               ...
               function setTableWidth(formId){
                ...
                function init(){
                    ...
                    getFormIdInitChildPage();
                    initTableWidth();
                     $("#T2#WPD_DELIVERY_DATE_BEGIN").val(timeBeginString());
                    $("#T2#WPD_DELIVERY_DATE_END").val(timeEndString());
				...
				success: function(data){
						...
						if(null != data.ajaxPage.dataList){
							...
							//	$("#datagrid-btable-ajax2f1adeb396c4403b8fea545ec6313333 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:250px;text-align: center;' title='"+rccList[i].DATAAUTH+"'>"+rccList[i].DATAAUTH+"</td>");
								$("#datagrid-btable-ajax2f1adeb396c4403b8fea545ec6313333 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:250px;text-align: center;' title='"+rccList[i].WRD_ITEM_SN+"'>"+rccList[i].WRD_ITEM_SN+"</td>");
								$("#datagrid-btable-ajax2f1adeb396c4403b8fea545ec6313333 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:150px;text-align: center;' title='"+rccList[i].WRD_ITEM_CODE+"'>"+rccList[i].WRD_ITEM_CODE+"</td>");
								...
								$("#datagrid-btable-ajax2f1adeb396c4403b8fea545ec6313333 tr:last").append("<td class='datagrid-cell datagrid-cell-8' style='width:150px;' title='"+rccList[i].WRD_CONNECT_DOC+"'>"+rccList[i].WRD_CONNECT_DOC+"</td>");
				...
				success: function(data){
						...
						if(null != data.ajaxPage.dataList){
							...
							if(rccList[i].DATAAUTH==null)  rccList[i].DATAAUTH="";
								...
								$("#datagrid-btable-ajax2f1adeb396c4403b8fea545ec6312222 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:250px;text-align: center;' title='"+rccList[i].WRD_ITEM_SN+"'>"+rccList[i].WRD_ITEM_SN+"</td>");
								$("#datagrid-btable-ajax2f1adeb396c4403b8fea545ec6312222 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:150px;text-align: center;' title='"+rccList[i].WRD_ITEM_CODE+"'>"+rccList[i].WRD_ITEM_CODE+"</td>");
								...
								$("#datagrid-btable-ajax2f1adeb396c4403b8fea545ec6312222 tr:last").append("<td class='datagrid-cell datagrid-cell-8' style='width:150px;' title='"+rccList[i].WRD_CONNECT_DOC+"'>"+rccList[i].WRD_CONNECT_DOC+"</td>");
...
function searchReceive(){
    var url = "${path}buss/bussModel_exeFunc.ms?funcMId=1cecf99756374f169826d43f21dba101";
    var dataAuth = $("#DATA_AUTH").val();
	var itemCode = $.trim($("#WRI_ITEM_CODE_SHOW").val());
	var docNum = $.trim($("#WRI_DOC_NUM").val());
	//var supCode = $(document.getElementById('T2#WRD_SUP_CODE')).val();
