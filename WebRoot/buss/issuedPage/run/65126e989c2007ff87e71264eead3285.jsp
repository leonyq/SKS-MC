        ...
        <div class="dlist">
            ...
            <div class="bd">
                <div class="search-box">
                   <div class="group">
                   <div class="name"><dict:lang value="工艺名称"/></div>
                   <div class="dec"><input id="CT_NAME" type="text" class="input"></div>
                   </div>
                   <div class="group">
                   <div class="name"><dict:lang value="机种料号"/></div>
                   <div class="dec"><select id="MITEM_CODE" class = "IS_SELECT_FILTER dept_select"></select></div> 
                   </div>
 			...
 			success: function(data){
              ...
              if(null != reslist){
                  for(var i=0;i<reslist.length;i++){
                    ...
                    $("#tbody_tab3 tr:last").append("<td class='datagrid-cell' style='width:160px; text-align:left;'>"+(reslist[i].CTI_MODEL_CODE==null?"":reslist[i].CTI_MODEL_CODE)+"</td>");
                    ...
                    $("#tbody_tab3 tr:last").append("<td class='datagrid-cell' style='width:160px; text-align:left;'>"+(reslist[i].CTI_ITEM_CODE==null?"":reslist[i].CTI_ITEM_CODE)+"</td>");
