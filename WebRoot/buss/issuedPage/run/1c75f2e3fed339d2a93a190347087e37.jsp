				...
				success: function(data){
						...
						if(null != data.ajaxPage.dataList){
							...
							for(var i=0;i<rccList.length;i++){
								...
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9703 tbody:last").append("<tr id='tr1_"+i+"' ></tr>");
								...
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9703 tr:last").append("<td class='datagrid-cell datagrid-cell-2' style='width:30px;text-align: center;'><input id='"+(trCount+1)+"' type='checkbox' name='isSelect2'/></td>");
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9703 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:150px;text-align: center;'>"+rccList[i].CI_ITEM_CODE+"<input type='hidden' id='CI_ITEM_CODE"+(trCount+1)+"' value='"+rccList[i].CI_ITEM_CODE+"'/></td>");
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9703 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:180px;text-align: center;'>"+rccList[i].CI_ITEM_NAME+"<input type='hidden' id='CI_ITEM_NAME"+(trCount+1)+"' value='"+rccList[i].CI_ITEM_NAME+"'/></td>");
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9703 tr:last").append("<td class='datagrid-cell datagrid-cell-5' style='width:150px;text-align: center;'>"+rccList[i].CI_ITEM_SPEC+"<input type='hidden' id='CI_ITEM_SPEC"+(trCount+1)+"' value='"+rccList[i].CI_ITEM_SPEC+"'/></td>");
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9703 tr:last").append("<td class='datagrid-cell datagrid-cell-6' style='width:150px;text-align: center;'>"+rccList[i].SUPPLIER_NAME+"</td>");
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9703 tr:last").append("<td class='datagrid-cell datagrid-cell-7' style='width:100px;text-align: center;'>"+rccList[i].ITEM_TYPE+"<input type='hidden' id='CI_MIN_PACK"+(trCount+1)+"' value='"+rccList[i].CI_MIN_PACK+"'/></td>");
								trCount++;
							}
						...
						pageFun(data.ajaxPage,"formId1");
							...
							clickTr('datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9703');
				...
				success: function(data){
						...
						if(null != data.ajaxPage.dataList){
							...
							for(var i=0;i<rccList.length;i++){
								...
								if(rccList[i].ITEM_TYPE==null) rccList[i].ITEM_TYPE="";
								if(rccList[i].CI_MIN_PACK==null) rccList[i].CI_MIN_PACK="0";
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9703 tbody:last").append("<tr id='tr1_"+((currentPage-1)*pageRecord+(i+1))+"' ></tr>");
...
function addItemList(showId,backId){
	...
	$("#itemTbody :checkbox").each(function(){
			if($(this).attr("checked")){
					...
					$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9702 tbody:last").append("<tr id='trr"+(trrCount+1)+"' ></tr>");
					$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9702 tr:last").append("<td class='datagrid-cell datagrid-cell-1' style='width:30px;text-align: center;'>"+(len+1)+"<input type='hidden' name='itemId' value=''/></td>");
					$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9702 tr:last").append("<td class='datagrid-cell datagrid-cell-2' style='width:30px;text-align: center;'><input type='checkbox' name='isSelect1'/></td>");
					$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9702 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:150px;text-align: center;'>"+$("#CI_ITEM_CODE"+$(this).attr("id")).val()+"<input type='hidden' name='CI_ITEM_CODE' value='"+$("#CI_ITEM_CODE"+$(this).attr("id")).val()+"'/></td>");
					$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9702 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:120px;text-align: center;'>"+$("#CI_ITEM_NAME"+$(this).attr("id")).val()+"</td>");
					$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9702 tr:last").append("<td class='datagrid-cell datagrid-cell-5' style='width:120px;text-align: center;'>"+$("#CI_ITEM_SPEC"+$(this).attr("id")).val()+"</td>");
					$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9702 tr:last").append("<td class='datagrid-cell datagrid-cell-6' style='width:90px;text-align: center;padding:0;'><input type='text' style='width: 90px;padding:0;text-align: right;' maxlength='9' class='_VAL_NULL input isSubmit' id='PLAN_NUM_"+(trrCount+1)+"' name='PLAN_NUM' value=''/></td>");
					$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9702 tr:last").append("<td class='datagrid-cell datagrid-cell-7' style='width:102px;text-align: center;padding:0;'><input type='text' style='width: 102px;padding:0;text-align: right;' maxlength='9' class=' input isSubmit' id='CI_MIN_PACK_"+(trrCount+1)+"' name='MIN_PACK' value='"+$("#CI_MIN_PACK"+$(this).attr("id")).val()+"'/></td>");
					$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9702 tr:last").append("<td class='datagrid-cell datagrid-cell-8' style='width:90px;text-align: center;padding:0;'><input type='text' style='width: 90px;padding:0;text-align: right;' maxlength='9' class=' input isSubmit' id='GIFT_NUM_"+(trrCount+1)+"' name='GIFT_NUM' value='0'/></td>");
					$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9702 tr:last").append("<td class='datagrid-cell datagrid-cell-9' style='width:70px;text-align: center;padding:0;'><input type='text' style='width: 70px;padding:0;text-align: right;' maxlength='9' class='_VAL_NULL input isSubmit' id='ITEM_SEQ_"+(trrCount+1)+"' name='ITEM_SEQ' value='0'/></td>");
					$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9702 tr:last").append("<td class='datagrid-cell datagrid-cell-10' style='width:160px;text-align: center;padding:0;'><input type='text' style='width: 160px;padding:0;' maxlength='50' class=' input isSubmit' id='WPI_PO_"+(trrCount+1)+"' name='WPI_PO' value=''/></td>");
					$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9702 tr:last").append("<td class='datagrid-cell datagrid-cell-11' style='width:120px;padding:0;'>"+wmsSel+"</td>");
					$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9702 tr:last").append("<td class='datagrid-cell datagrid-cell-12' style='width:120px;text-align: center;padding:0;'><input style='width: 120px;padding:0;' name='WRI_DELIVERY_DATE' class=' input isSubmit  _VAL_OjbsData WdateNomorl' onfocus='WdatePicker({skin:\"blue\",dateFmt:\"yyyy-MM-dd\"})'/></td>");
					$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9702 tr:last").append("<td class='datagrid-cell datagrid-cell-13' style='width:120px;text-align: center;padding:0;'><input type='text' class=' input isSubmit' maxlength='50' style='width: 120px;padding:0;text-align: right;' id='WRI_LOT_NO_"+(trrCount+1)+"' name='WRI_LOT_NO'/></td>");
					$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9702 tr:last").append("<td class='datagrid-cell datagrid-cell-14' style='width:150px;text-align: center;padding:0;'><input style='width: 100%;padding:0;' name='WRI_PRODUCE_DATE' class=' input isSubmit  _VAL_OjbsData WdateNomorl' onfocus='WdatePicker({skin:\"blue\",dateFmt:\"yyyy-MM-dd\"})'/></td>");
					...
					_tongLineColor(tableTrJs);
					clickTr('datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9702');	
...
function delRow(){
	...
	util.showLoading("处理中...");
		  $.ajax({
				type: "POST",
			    dataType: "json",
			    url: "buss/bussModel_exeFunc.ms?funcMId=61aa13d52939454287af58e843aaa400",
			    data: {
			        "checkId":delId
			    },
				success: function(data){
						...
						if(null != data){
							...
							if(data.returnMsg=="addError"){
								$("#delIds").val(delId);
								//删除行
								$("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9702 :checkbox").each(function(){
									if($(this).attr("checked")){
								...
								reSort("datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9702");
								var tableTrJs = $("#datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9702 tbody tr");
								_tongLineColor(tableTrJs);
								clickTr('datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9702');
								defTableWidthRewrite('24b1b1adf7b54d90865c4b39ac6f9702');
...
<div class="js-tab">
	...
	<input type="hidden" name="paraMap1@__DATA_COUNT__" value="1" />
		<s:set name="_$viewId" value="'6d2b02bf6b614c1cb564b0e5fb801953'" />
		...
		<tr>
			...
			<td class="name" /><bu:uitn colNo="T2#WRD_DOC_TYPE" formId="24b1b1adf7b54d90865c4b39ac6f971e" /></td>
			<bu:td cssClass="dec" colNo="T2#WRD_DOC_TYPE" formId="24b1b1adf7b54d90865c4b39ac6f971e" ><bu:ui colNo="T2#WRD_DOC_TYPE" style="width:200px;" formId="24b1b1adf7b54d90865c4b39ac6f971e" dataId="${dataId}" formIndex="1" /></bu:td>
			
			<td class="name" /><bu:uitn colNo="T2#WRD_DISPATCH_SN" formId="24b1b1adf7b54d90865c4b39ac6f971e" /></td>
			<bu:td cssClass="dec" style="width:200px;" colNo="T2#WRD_DISPATCH_SN" formId="24b1b1adf7b54d90865c4b39ac6f971e" ><bu:ui colNo="T2#WRD_DISPATCH_SN" style="width:200px;" formId="24b1b1adf7b54d90865c4b39ac6f971e" dataId="${dataId}" formIndex="1" /></bu:td>
		
		</tr>
		<tr>
			<td class="name" /><span class="dot">*</span><bu:uitn colNo="T2#WPD_DELIVERY_DATE" formId="24b1b1adf7b54d90865c4b39ac6f971e" /></td>
			...
			<bu:td cssClass="dec" colNo="T2#WRD_URGENT_FLAG" formId="24b1b1adf7b54d90865c4b39ac6f971e" ><bu:ui colNo="T2#WRD_URGENT_FLAG" formId="24b1b1adf7b54d90865c4b39ac6f971e" dataId="${dataId}" formIndex="1" /></bu:td>
			
			<td class="name" /><bu:uitn colNo="T2#WRD_CUST_CODE" formId="24b1b1adf7b54d90865c4b39ac6f971e" /></td>
			<bu:td cssClass="dec" colNo="T2#WRD_CUST_CODE" formId="24b1b1adf7b54d90865c4b39ac6f971e" ><bu:ui colNo="T2#WRD_CUST_CODE" style="width:200px;" formId="24b1b1adf7b54d90865c4b39ac6f971e" dataId="${dataId}" formIndex="1" /></bu:td>
					...
					<div class="panel datagrid datagrid-div1">
    					<div class="datagrid-div2 datagrid-div6 datagrid-view"  id="datagrid-view">
    						...
    						<div class="datagrid-body datagrid-div3 scroll2"   style="height:340px;">
    							<table class="datagrid-htable fixedTable dlist-table table-line" style="table-layout:fixed;"  id="datagrid-btable-ajax24b1b1adf7b54d90865c4b39ac6f9703">
    								<tbody id="itemTbody" >
    								</tbody>
    							</table>
    						</div>
...
<bu:script viewId="6d2b02bf6b614c1cb564b0e5fb801953" />
...
function getItem(){
	...
	var temps;
			$.ajax({
				type: "POST",
			    dataType: "json",
			    url: "buss/bussModel_exeFunc.ms?funcMId=4df28c380ad54dcf81f10de621ea220f",
			    data: {
...
function clickTr(tableId){
  ...
  document.forms.editForm.action = "${path}buss/bussModel_exeFunc.ms?funcMId=a42b06bbea504b48ac1485d31842f037";
  document.forms.editForm.submit();
}            
