...
<input type="hidden" name="infoId2" value="${dataMap.infoId}"/>
				...
				<jsp:param name="location" value="editForm" />
					...
					<div class="hd" id="headerDiv" style="margin-top: 0px; margin-bottom: 0px; height: 35px; background-color: rgb(246,245,247);">
						...
						<div class="optn" style="margin-top: -6px;">
							...
							<button id="multiSampleLoad" type="button" onclick="multiSampleLoadInfo();"><i class="ico ico-save"></i><dict:lang value="加载" /></button>
							...
							<DIV class="content1" id="content">
								...
								<div>
									...
									<div style="width: 300px; height: 210px;display: inline-block;">
											<div class="panel datagrid datagrid-div1" name="itemTable" id="itemTable6">
												<div class="datagrid-div22 datagrid-div6 datagrid-view" id="datagrid-header1" style="width:630px;overflow-x: auto;height: 205px;">
													<div class="datagrid-header datagrid-header2">
														<div class="datagrid-header-inner head5" id="datagrid-header-inner" style="overflow:hidden;">
														<table  class="datagrid-htable fixedTable datagrid-div6 datagrid-htable-kz  " id="datagrid-htable831b2dbf0dfb494695b7ce66538a1236">
																<tbody>
																		<tr class="datagrid-header-row thcolor">
																		<td class="datagrid-cell Sssss" style="width:30px; text-align:center;"></td>
																		<td class="datagrid-cell" style="width:30px; text-align:center"><span>
													...
													<div class="datagrid-body datagrid-div3 scroll5" style="height: 175px;overflow: auto;">
														<table class="datagrid-btable fixedTable dblClick "  id="datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a1235" >
								...
								<!--	<div class="panel-ajax1 datagrid datagrid-div1" style="margin-top:10px;">-->
									...
									<tr class="datagrid-header-row thcolor">
												...
												<div class="datagrid-body datagrid-div3 scroll6" style="height: 174px;overflow: auto;">
													<table class="datagrid-btable fixedTable dblClick "  id="datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a1236" >
														<tbody class="" id="itemDetailBody7" style="display: none;">
															 <c:forEach items="${dataMap.testItemList}" var="item" varStatus="status">
																<tr>
																	...
																	<td class="datagrid-cell" style="width:30px; text-align:center;"><input id="table7Checkbox${item.ROWNUM}"  type="checkbox" checked="checked" style="cursor: pointer;" value="${item.ROWNUM}"></td>
																	<td class="datagrid-cell" style="width:120px;text-align:center;">
																		${item.ITEM_TYPE_NAME}
																	</td> 
																	<td class="datagrid-cell" style="width:120px;text-align:center;display:none;">
																	...
																	<td class="datagrid-cell" style="width:150px;">
																		<input style="width:139px;" class="isSubmit input" type="text" id="MULIT_memo" name="memo" />
																	</td>
																	<td class="datagrid-cell" style="width:120px;display: none;">${item.QII_ITEM_SN}</td>
																	<td class="datagrid-cell" style="width:120px;display: none;">${item.ITEM_CLASS}</td>
																	<td class="datagrid-cell" style="width:120px;display: none;"></td>
										...
										<div class="datagrid-div22 datagrid-div6 datagrid-view" id="datagrid-header1">
											<div class="datagrid-header datagrid-header2" >
												<div class="datagrid-header-inner head7" >
													<table  class="datagrid-htable fixedTable datagrid-div6 datagrid-htable-kz  " id="datagrid-htable831b2dbf0dfb494695b7ce66538a1237">
									<tbody>
									<tr class="datagrid-header-row thcolor">
																...
																<td class="datagrid-cell" style="width:129px;"><dict:lang value="物料/产品SN" /></td>
											...
											<div class="datagrid-body datagrid-div3 scroll7" style="height: 434px;overflow: auto;">
													...
													<tbody class="" id="itemDetailBody4">
														<c:forEach items="${dataMap.tagList3}" var="item" varStatus="status">
															<tr id="${item.ID}" name="${item.ID}">
																...
																<td class="datagrid-cell" style="width:129px;">${item.QIP_SN}</td> 
	...
	<script type="text/javascript">
		...
		if($("input[name='paraMapObj.T2#CUSTOMER']").val()!=""){
			...
			//console.log($("#paraMapObj_T3#SUPPLIER_NAME").val()); 
		}else{
		...
		//	clickTr("itemDetailBody2");
			...
			$("#paraMapObj_QII_INSEPCT_RESULT_chosen").attr("disabled","true");
			$("#paraMapObj_QII_INSEPCT_RESULT").attr("disabled","true");
			//console.log($("#itemDetailBody3").html());
...
　　　　　　		var qipSn = $.trim($("#paraMapObj_QIP_SN").val());
					...
					var getTestItemUrl="${path}buss/bussModel_exeFunc.ms?funcMId=bfa39cf6c9ff4b819efcf8a8c22e347a&formId=%{formId}";
                    var jsondata = { "qipSn": qipSn, "inspectSn":inspectSn,"infoId":infoId};
			        jQuery.ajax({
			 			type: "POST",
			 	   		dataType: "json",
...
　　			});
        ...
        var url = "${path}buss/bussModel_exeFunc.ms?funcMId=0de8268194ec4ba5838d160a276bdec1&formId=%{formId}";
	SearchItemInfo(paginationImpl,url);
		 			...
		 			success: function(data){
		 				...
		 				if(dataList.length==0){
			 				...
			 				for(var i=0;i<dataList.length;i++){
								...
								$("#itemDetailBody5").append("<tr class='itemDetail' id='"+item.ID+"' name='"+item.ID+"'></tr>");
		...
		function delInfo(){
			...
			var jsondata = { "infoId":infoId,"inspectSn":inspectSn,"sampleSns": sampleSns};
		...
		*/
		function getItemInfo(){
		    var loadItemInfoUrl="${path}buss/bussModel_exeFunc.ms?funcMId=0de8268194ec4ba5838d160a276bdec1&formId=%{formId}";
					...
					success: function(data){
						if(null != data.ajaxPage.dataList){
							...
							for(var i = 0;i < rccList.length; i++){
								...
								//console.log(rccList[i].QIP_TEST_RESULT);
								...
								$("#itemDetailBody4 tr:last").append("<td class='datagrid-cell datagrid-cell-2' title='"+rccList[i].QIP_SN+"' style='width: 129px;'>"+rccList[i].QIP_SN+"</td>");
	...
	function SearchItemInfo(paginationImpl,url){
		...
		function searchItemInfo(paginationImpl){
        var url = "${path}buss/bussModel_exeFunc.ms?funcMId=a8d2ea46fc844298ac684ab9cba5dbc3&formId=%{formId}";
	SearchItemInfo(paginationImpl,url);
}
  ...
  document.forms.editForm.submit();
		...
		function multiSampleLoadInfo(){
			...
			var jsondata = { "mulitSampleSn":mulitSampleSn,"inspectSn":inspectSn,"infoId": infoId};
					...
					if(data.ajaxList.length==0){
						...
						for(var k=0;k<mulitSampleTestNum;k++){
							...
							for(var i = 0;i < rccList.length; i++){
								...
								console.log(rccList[i].QII_SUBSET_SN);
								console.log(subsetNum);
								console.log(j==subsetNum);
		...
		function onClickMulitSampleInfo(index){
			...
			var inspectSn = $("#paraMapObj_QII_INSPECT_SN").val();
			var infoId=$("#infoId").val();
            var jsondata = { "mulitSampleSn": mulitSampleSn, "inspectSn":inspectSn,"infoId":infoId,"subsetMulitSampleSn":tempMulitSampleSn};
