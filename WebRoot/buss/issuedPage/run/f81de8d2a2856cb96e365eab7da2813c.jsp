		...
		function addLoadPoint(showId,backId){
			...
			if(addWay2=="0"){
                    ...
                    var text = $(this).children("td:nth-child(3)").text();//td:nth-child(3) 第三列 
    			     	if(text==table){
    			     	  // var texts = $(this).children("td:nth-child(5)").text();//td:nth-child(4) 第三列 		
		                    ...
		                    var texts = $(this).children("td:nth-child(7)").text();
			   ...
			   if(nums>0){
				...
				$("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a1234 tr:last").append("<td class='datagrid-cell datagrid-cell-2' style='width:350px;' name='CDL_TABLE' align='left' >"+$("#CDL_TABLE").val()+"</td>");
				$("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a1234 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:350px;' name='CDL_LOADPOINT' align='left' >"+$("#CDL_LOADPOINT").val()+"</td>");
				$("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a1234 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:350px;' name='TRACK_TYPES' align='left' style='width:147px;'>"+$('#TRACK_TYPE option:selected').text()+"<input type='hidden' id='TRACK_TYPE_"+trCount+"'  name='TRACK_TYPE' value='"+$("#TRACK_TYPE").val()+"' /></td>");
				$("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a1234 tr:last").append("<td class='datagrid-cell datagrid-cell-5' style='width:350px;' name='CDL_MEMO' align='left'><div>"+$("#CDL_MEMO").val()+"</div></td>");
			...
			//2018-6-21 当料站值小于等于1 时 对于轨道的判断
				if(loadPointCount<=1){
							 ...
							 $("#addLoadPoint tr").each(function(i){  
                                var text1 = $(this).children("td:nth-child(3)").text();//td:nth-child(3) 第三列 
                			     	...
                			     	if(text1==table1){
                                       ...
                                       var texts1 = $(this).children("td:nth-child(7)").text(); 	        						
					...
					$("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a1234 tr:last").append("<td class='datagrid-cell datagrid-cell-0' style='width:30px;text-align: center;'>"+$("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a1234 tr").length+"</td>");
					$("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a1234 tr:last").append("<td class='datagrid-cell datagrid-cell-1' style='width:30px;text-align: center'><input type='checkbox' value='"+trCount+"' name='isSelect1'/></td>");
					$("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a1234 tr:last").append("<td class='datagrid-cell datagrid-cell-2' style='width:350px;'name='CDL_TABLE' align='left' >"+$("#CDL_TABLE1").val()+"</td>");
					$("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a1234 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:350px;'name='CDL_LOADPOINT' align='left' >"+$("#CDL_LOADPOINT_PREFIX").val()+$("#CDL_STAR").val()+"</td>");
					$("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a1234 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:350px;'name='TRACK_TYPE' align='left' style='width:147px;'>"+$('#TRACK_TYPE1 option:selected').text()+"<input type='hidden' id='TRACK_TYPE_"+trCount+"'  name='TRACK_TYPE' value='"+$("#TRACK_TYPE1").val()+"'/></td>");
					$("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a1234 tr:last").append("<td class='datagrid-cell datagrid-cell-5' style='width:350px;'name='CDL_MEMO' align='left'>"+$("#CDL_MEMO1").val()+"</td>");
    			 ...
    			 $("#addLoadPoint tr").each(function(i){  
                    var text = $(this).children("td:nth-child(3)").text();//td:nth-child(3) 第三列 
    			     	if(text==table1){
                           ...
                           var text1 = $(this).children("td:nth-child(7)").text();  							
				...
				_alertValMsg(TRACK_TYPES,"<dict:lang value="相同的Table里轨道必须相同" />");
			       return 	false;
					...
					for(var i=1;i<=loadPointCount;i++){
						...
						$("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a1234 tr:last").append("<td class='datagrid-cell datagrid-cell-1' style='width:30px;text-align: center'><input type='checkbox' value='"+trCount+"' name='isSelect1'/></td>");
						$("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a1234 tr:last").append("<td class='datagrid-cell datagrid-cell-2' style='width:350px;' name='CDL_TABLE' align='left' >"+$("#CDL_TABLE1").val()+"</td>");
						$("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a1234 tr:last").append("<td class='datagrid-cell datagrid-cell-3' style='width:350px;' name='CDL_LOADPOINT' align='left' >"+$("#CDL_LOADPOINT_PREFIX").val()+(parseInt($("#CDL_STAR").val())+i-1)+"</td>");
						$("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a1234 tr:last").append("<td class='datagrid-cell datagrid-cell-4' style='width:350px;' name='TRACK_TYPE' align='left' style='width:147px;'>"+$('#TRACK_TYPE1 option:selected').text()+"<input type='hidden' id='TRACK_TYPE_"+trCount+"' name='TRACK_TYPE' value='"+$("#TRACK_TYPE1").val()+"'/></td>");
						$("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a1234 tr:last").append("<td class='datagrid-cell datagrid-cell-5' style='width:350px;' name='CDL_MEMO' align='left' >"+$("#CDL_MEMO1").val()+"</td>");
					//	$("#loadPoint tr:last").append("<td class='datagrid-cell datagrid-cell-6' style='display:none;' id='TRACK_TYPES_"+trCount+"' >"+$("#TRACK_TYPE1").val()+"</td>");
						var tableTrJs = $("#datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a1234 tbody tr");
		...
		<input type="hidden" id="comp" name="comp" value=''/>
			<div class="datagrid-header">
				...
				<table  class="datagrid-htable fixedTable datagrid-div6 datagrid-htable-kz  " id="datagrid-htable831b2dbf0dfb494695b7ce66538a1234">
						...
						<td class="datagrid-cell" align="center" style="350px;"><dict:lang value="Table" /></td >
						<td class="datagrid-cell" align="center" style="350px;"><dict:lang value="料站位" /></td >
						<td class="datagrid-cell" align="center" style="350px;"><dict:lang value="轨道" /></td >
						<td class="datagrid-cell" align="center" style="350px;"><dict:lang value="说明" /></td >
		...
		<table class="datagrid-btable fixedTable dblClick "  id="datagrid-btable-ajax831b2dbf0dfb494695b7ce66538a1234" >
					...
					<c:forEach items="${dataList}" var="cdlList" varStatus="str">
								<tr id="${cdlList.rownum}" name="${cdlList.rownum}">
									...
									<td class="datagrid-cell datagrid-cell-2" style="width:350px;">${cdlList.cdl_table}</td>
									<td class="datagrid-cell datagrid-cell-3" style="width:350px;">${cdlList.cdl_loadpoint}</td>
									<td class="datagrid-cell datagrid-cell-4" style="width:350px;">${cdlList.dict}</td>
									<td class="datagrid-cell datagrid-cell-5" style="width:350px;">${cdlList.cdl_memo}</td>
