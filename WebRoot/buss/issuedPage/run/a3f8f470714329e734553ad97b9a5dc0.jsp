...
<body>
	...
	<input type="hidden" name="paraMap1@__DATA_COUNT__" value="1" />
        ...
        <tr>
            ...
            <td class="name" style="width: 100px;text-align: right;"><dict:lang value="报工工序"/></td>
            <td class="dec" style="width: 120px;text-align: left;">
                <select id="colFace" name="col_FINISH_GROUP" class="dept_select"></select>
            </td>
            <td class="name" style="width: 100px;text-align: right;"><dict:lang value="报工数量"/></td>
            <td class="dec" style="width: 120px;text-align: left;">
