...
<body scroll="auto" >
          ...
          <div class="content-in">
              <div class="dlist">
                  <div class="hd">
                  <div>
		<bu:func viewId="4fbecd75acdc4781ac4a5393a0cc5d21" />
                    </div>
                  </div>
                  <div class="bd" id="bd">
		...
		<bu:search viewId="4fbecd75acdc4781ac4a5393a0cc5d21" />
						</form>
		...
		<form id="listForm" name="listForm" action="${path}buss/bussModel.ms" method="post">
			<input type="hidden" name="exeid" value="${exeid}" />
			<s:hidden name="%{@com.more.fw.core.common.method.Constants@FUNC_CODE}" />
		<bu:form viewId="4fbecd75acdc4781ac4a5393a0cc5d21" formId="013c4606017841b6b4e7f01e2a32d0a6" list="dataList" formidFirstId="013c4606017841b6b4e7f01e2a32d0a6" relColIds="" currentPage="${page.currentPage}" pageRecord="${page.pageRecord}" subFormIds="" subRelColIds="" />
  ...
  <% }}%></div>
		...
		<bu:submit viewId="4fbecd75acdc4781ac4a5393a0cc5d21" />
		<bu:script viewId="4fbecd75acdc4781ac4a5393a0cc5d21" />
