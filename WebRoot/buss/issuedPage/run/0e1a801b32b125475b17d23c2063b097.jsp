			...
			<td style="width:200px;" >
				<div id="leftPanel"  ondrop="dropNo(event)" ondragover="allowDropNo(event)" style="border: 1px solid #E4E4E4;height: 450px;">
				    ...
				    <div class="attribute" id="paramPanel">
				        ...
				        <ul>
				            <li class='node-class-next'><label class="checkbox inline"><input type="checkbox" id="startProcedure" onClick="updateObject()"  >开始工序</label></li>
				            <li class='node-class-next'><label class="checkbox inline"><input type="checkbox" id="endProcedure" onClick="updateObject()">结束工序</label></li>
				            ...
				            <li><span>显示文字</span><input type="text" id="pLabel" disabled='disabled'></li>
