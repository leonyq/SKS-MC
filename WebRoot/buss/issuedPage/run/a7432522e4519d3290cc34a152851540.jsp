...
<body>
	...
	<input type="hidden" name="paraMap1@__DATA_COUNT__" value="1" />
		...
		<tr>
			...
			<bu:td cssClass="dec" colNo="PTD_LIST_TEMPLATE" formId="4c1b1d56bcd8473885dea36a3d2f5c5a" ><bu:ui colNo="PTD_LIST_TEMPLATE" style="width:200px;" formId="4c1b1d56bcd8473885dea36a3d2f5c5a" value="%{PTD_LIST_TEMPLATE}" formIndex="1" /></bu:td>
	...
	function addPack(){
	    if(!val.valNullData()){
			...
			var tempHtml = "<tr id='tr_"+packLevel+"'>"+
				...
				"<td class='datagrid-cell datagrid-cell-14' style='text-align: center;'>"+listAddress2+"</td>"+
				"</tr>";
				//isLablePrint
				//<input name='labelRule' type='hidden' value='"+$("#paraMap1_PTD_LABLE_RULE").val()+"'>
				//<input name='listTemp' type='hidden' value='"+$("#paraMap1_PTD_LIST_TEMPLATE").val()+"'>
			...
			parentWindow.clickTr("packInfo");
			var tableTrJs = parentWindow.$("#packInfo tbody tr");
