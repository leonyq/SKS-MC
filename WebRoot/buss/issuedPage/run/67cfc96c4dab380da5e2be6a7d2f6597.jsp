...
function createTableModel(ms,formId){
    ...
    if(formId=='f961ef99b03c4536a66dc8f3ddcca076'){<%--FM-采购单明细信息--%>
        $.each(uiTxt,function(i,v){
            ...
            arrHtml.push("<span colno='WPD_PO' class='"+ms.uiClass(formId, 'WPD_PO')+"' style='"+ms.uiStyle(formId, 'WPD_PO')+"' "+ms.uiEvent(formId, 'WPD_PO')+" title='"+ms.titleAttr(formId,'WPD_PO','IS_TITLE_ATTR',v)+"' >"+v['WPD_PO']+"</span>")
            arrHtml.push("</td>");
            ...
            arrHtml.push("<span colno='WPD_ITEM_CODE' class='"+ms.uiClass(formId, 'WPD_ITEM_CODE')+"' style='"+ms.uiStyle(formId, 'WPD_ITEM_CODE')+"' "+ms.uiEvent(formId, 'WPD_ITEM_CODE')+" title='"+ms.titleAttr(formId,'WPD_ITEM_CODE','IS_TITLE_ATTR',v)+"' >"+v['WPD_ITEM_CODE']+"</span>")
            arrHtml.push("</td>");
