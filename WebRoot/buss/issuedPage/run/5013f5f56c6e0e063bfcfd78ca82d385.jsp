...
utilsFp.confirmIcon(3,"","","", "error:下线失败",0,"","");
...
function createTableModel(ms,formId){
    ...
    if(formId=='dab546190c604b8b9ff1e67e1d20ab72'){<%--制令单上线设备--%>
        $.each(uiTxt,function(i,v){
            ...
            arrHtml.push("</td>");
            arrHtml.push("<td colno='PDO_DEVICE_SN' class='datagrid-cell "+ms.tdClass(formId, 'PDO_DEVICE_SN')+"' style='width:120px;"+ms.tdStyle(formId, 'PDO_DEVICE_SN')+"' "+ms.tdEvent(formId, 'PDO_DEVICE_SN')+">")
            arrHtml.push("<span colno='PDO_DEVICE_SN' class='"+ms.uiClass(formId, 'PDO_DEVICE_SN')+"' style='"+ms.uiStyle(formId, 'PDO_DEVICE_SN')+"' "+ms.uiEvent(formId, 'PDO_DEVICE_SN')+" title='"+v['PDO_DEVICE_SN']+"' >"+v['PDO_DEVICE_SN']+"</span>")
            arrHtml.push("</td>");
            ...
            arrHtml.push("</td>");
            arrHtml.push("<td colno='PDO_NUMBER' class='datagrid-cell "+ms.tdClass(formId, 'PDO_NUMBER')+"' style='width:120px;"+ms.tdStyle(formId, 'PDO_NUMBER')+"' "+ms.tdEvent(formId, 'PDO_NUMBER')+">")
            arrHtml.push("<span colno='PDO_NUMBER' class='"+ms.uiClass(formId, 'PDO_NUMBER')+"' style='"+ms.uiStyle(formId, 'PDO_NUMBER')+"' "+ms.uiEvent(formId, 'PDO_NUMBER')+" title='"+v['PDO_NUMBER']+"' >"+v['PDO_NUMBER']+"</span>")
            arrHtml.push("</td>");
            ...
            arrHtml.push("</td>");
            arrHtml.push("<td colno='PDO_MODEL_CODE' class='datagrid-cell "+ms.tdClass(formId, 'PDO_MODEL_CODE')+"' style='width:120px;"+ms.tdStyle(formId, 'PDO_MODEL_CODE')+"' "+ms.tdEvent(formId, 'PDO_MODEL_CODE')+">")
            arrHtml.push("<span colno='PDO_MODEL_CODE' class='"+ms.uiClass(formId, 'PDO_MODEL_CODE')+"' style='"+ms.uiStyle(formId, 'PDO_MODEL_CODE')+"' "+ms.uiEvent(formId, 'PDO_MODEL_CODE')+" title='"+v['PDO_MODEL_CODE']+"' >"+v['PDO_MODEL_CODE']+"</span>")
            arrHtml.push("</td>");
